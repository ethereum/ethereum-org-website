---
title: Procuring open digital infrastructure
metaTitle: Procuring open digital infrastructure | ethereum.org
description: Procurement questions for public-interest Ethereum systems, covering sovereignty, privacy, inclusion, governance, and continuity.
lang: en
template: static
sidebarDepth: 2
...
Procurement should assess more than a provider’s present capabilities. For long-lived public infrastructure, assess whether people and institutions can inspect, govern, replace, and recover the systems they depend on.
...
Open infrastructure does not remove the need for institutional capability. A public body that cannot specify, inspect, and govern its deployment may simply recreate vendor dependency at a different layer.
