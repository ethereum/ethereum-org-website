...
To deploy your smart contract to the test network, you'll need some fake ETH. To get ETH on the Sepolia network, go to a Sepolia faucet and enter your Sepolia account address. Note that Sepolia faucets can be a bit unreliable recently - see the [test networks page](/developers/docs/networks/#sepolia) for a list of options to try:
...
```javascript
REACT_APP_ALCHEMY_KEY = wss://eth-sepolia.ws.alchemyapi.io/v2/<key>
```
...
If you skipped Part 3 of this tutorial, you can use the HelloWorld contract with address [0x6f3f635A9762B47954229Ea479b4541eAF402A6A](https://sepolia.etherscan.io/address/0x6f3f635a9762b47954229ea479b4541eaf402a6a#code). Its ABI can be found [here](https://sepolia.etherscan.io/address/0x6f3f635a9762b47954229ea479b4541eaf402a6a#code).
...
To sign a transaction on the Ethereum blockchain, we’ll need some fake Eth. To get Eth you can go to the [FaucETH](https://fauceth.komputing.org) and enter your Sepolia account address, click “Request funds”, then select “Ethereum Testnet Sepolia” in the dropdown and finally click “Request funds” button again. You should see Eth in your MetaMask account soon after!
