...
This solution was chosen by both [Optimism](https://docs.optimism.io/op-stack/protocol/overview) and [Arbitrum](https://developer.offchainlabs.com/docs/rollup_basics#intro-to-rollups).
