---
title: Adding Reports
description: Guidelines for suggesting research reports to ethereum.org
lang: en
---
...
### Suggest a report {#suggest-a-report}
...
Report links are periodically checked. Broken links or retracted publications will be removed. If you notice that a publisher has moved a report to a new URL, [create an issue](https://github.com/ethereum/ethereum-org-website/issues/new?template=content-suggestion.yml) or send an email to [website@ethereum.org](mailto:website@ethereum.org).
