...
Dans de nombreux pays, l’inflation est un problème urgent, souvent accompagné d’un accès limité aux devises étrangères. Les personnes se trouvant dans ces situations luttent pour préserver leur patrimoine, car elles sont contraintes de conserver des économies qui se déprécient rapidement.
...
- **Sotheby's :** cette organisation commercialise des œuvres d'art, des bijoux et des objets de collection, et autorise les paiements en Ethereum et en d'autres cryptomonnaies.
...
Les cartes crypto en auto-conservation fonctionnent comme si vous utilisiez votre propre sac à dos au lieu d'enfermer votre argent dans le coffre-fort de quelqu'un d'autre. Avec une carte traditionnelle, une banque ou un dépositaire détient vos fonds et les libère lorsque vous dépensez. Avec les cartes en auto-conservation, vous gardez le contrôle de vos actifs en permanence — sans intermédiaire — tout en pouvant payer sans contact ou par carte pour un café, des courses ou même un vol.

Ces cartes sont directement liées à des portefeuilles non dépositaires ou à des comptes de contrat intelligent, ce qui permet aux utilisateurs de dépenser des ETH et des stablecoins dans des situations quotidiennes sans renoncer à la propriété. Contrairement aux cartes dépositaires, qui exigent que les utilisateurs déposent des fonds auprès d'un tiers, les cartes en auto-conservation permettent des paiements dans le monde réel, comme avec Visa et Mastercard, tout en préservant le contrôle sur la chaîne.

### Exemples {#crypto-cards-examples}

- **Carte MetaMask :** liée au portefeuille MetaMask, cette carte de débit Mastercard permet aux utilisateurs de dépenser des ETH, des stablecoins et d'autres jetons pris en charge. Elle prend en charge Apple Pay et Google Pay, inclut des récompenses de cashback en crypto et offre des options de rendement.

- **Carte Tuyo :** une carte Visa basée sur un contrat intelligent qui convertit automatiquement la crypto en USDC pour les dépenses partout où Visa est acceptée. Les utilisateurs conservent la garde de leurs actifs, avec un accès à des fonctionnalités de rendement, de trading et de dépenses.

- **Gnosis Pay :** la première carte Visa en auto-conservation liée à un compte intelligent Gnosis Safe. Les utilisateurs dépensent leur crypto directement depuis leur portefeuille sans frais de gaz, de change ou de retrait. La personnalisation de la carte via Ethereum Name Service (ENS) est également prise en charge.

- **Carte Ether.Fi Cash :** intégrée au protocole de staking d'ether.fi, cette carte permet aux utilisateurs de dépenser tout en gardant leurs ETH en staking. Les paiements sont gérés via des contrats intelligents, maintenant l'auto-conservation même lors des dépenses.

### Comparaison des cartes crypto en auto-conservation {#crypto-card-custody-comparison}

| **Carte crypto**              | **Auto-conservation** | **Non-autonome** | **Remarques clés**                                                                                      |
| ----------------------------- | :-------------------: | :--------------: | ------------------------------------------------------------------------------------------------------- |
| Carte MetaMask                |           ✅           |         ✅        | Le portefeuille reste dans MetaMask ; retrait automatique au moment du paiement.        |
| Carte Tuyo                    |           ✅           |         ✅        | Le portefeuille intelligent convertit en USDC ; l'utilisateur conserve le contrôle.     |
| Gnosis Pay                    |           ✅           |         ✅        | Liée au Gnosis Safe de l'utilisateur ; pas de transfert de garde lors de l'utilisation. |
| Ether.Fi Cash |           ✅           |         ✅        | L'ETH reste en staking ; le contrat intelligent contrôle l'accès aux dépenses.          |

> **Remarque :** le terme \"auto-conservation\" fait référence aux portefeuilles contrôlés par l'utilisateur, où celui-ci a un accès et un contrôle total sur ses fonds.
> Le terme \"non dépositaire\" fait référence aux portefeuilles où les fonds sont gérés sans la garde d'un tiers, souvent par le biais de contrats intelligents.
> Bien que toutes les cartes en auto-conservation soient non dépositaires, toutes les cartes non dépositaires ne sont pas en auto-conservation.

## Micropaiements pour les sites web et les agents (x402) {#x402}

[x402](https://www.x402.org/) est une norme de paiement ouverte qui apporte des paiements natifs par utilisation au web. En utilisant des [stablecoins](/stablecoins/) sur des [réseaux de couche 2 Ethereum](/layer-2/) à faible coût, la norme x402 permet aux humains et aux machines de payer de manière économique pour une action unique, comme la lecture d'un article de presse ou l'appel d'une API, plutôt que de gérer des clés d'API, des abonnements ou de \"payer\" en prêtant attention à la publicité.

- **Suppression des murs de paiement et des connexions :** au lieu de créer un compte et de partager des informations personnelles pour lire un article de presse, votre portefeuille peut payer les quelques centimes nécessaires pour le déverrouiller.
- **Paiements pour les agents d'IA :** x402 permet à des logiciels autonomes (\"agents d'IA\") de payer les données et les appels d'API dont ils ont besoin pour fonctionner, sans intervention humaine.

### Fonctionnement de la norme de paiement x402 {#x402-how}

Lorsqu'un client demande une ressource, le serveur envoie un code d'erreur `402 Payment Required` ainsi que des instructions de paiement (prix, compte, et quels jetons et chaînes sont pris en charge).

- Votre [portefeuille](/wallets/) détecte la demande et gère le paiement (souvent en un seul clic pour l'approbation, ou automatiquement en utilisant une allocation pré-approuvée).
- Les [agents d'IA](/ai-agents/) ayant accès à des soldes de portefeuille pré-approuvés peuvent détecter automatiquement le prix et payer instantanément pour accéder à des données ou des services.
- Le client doit disposer de l'un des stablecoins pris en charge dans son portefeuille, mais n'a pas besoin d'avoir des ETH pour les [frais de gaz](/gas/).

Cela débloque une nouvelle économie \"de machine à machine\" où les agents d'IA peuvent acheter des ressources par eux-mêmes, et où les services d'API peuvent être accessibles plus efficacement.

Le message signé est ensuite transmis au serveur. Les serveurs utilisent généralement un [facilitateur x402](https://x402.gitbook.io/x402/core-concepts/facilitator) pour gérer la complexité de la blockchain (envoi de la transaction, obtention du paiement, facilitation des frais de gaz, etc.), ce qui signifie que les développeurs peuvent facilement accepter les micropaiements en crypto sans gérer l'infrastructure de paiement.
...
Cette tendance séduit particulièrement les travailleurs à distance et les nomades numériques, qui peuvent profiter de paiements sans frontières et, potentiellement, de taux de change avantageux.
...
Fondamentalement, Ethereum est une plateforme décentralisée qui permet des transactions sécurisées, rapides et transparentes. Cependant, de nombreux éléments la distinguent des méthodes de paiement traditionnelles. Découvrons les avantages qui font des paiements en Ethereum un véritable bouleversement :
...
Avec Ethereum, tout le monde peut voir comment l'argent circule et comment les coûts sont mis en œuvre, contrairement aux organisations traditionnelles où la plupart de ces éléments restent inconnus.
