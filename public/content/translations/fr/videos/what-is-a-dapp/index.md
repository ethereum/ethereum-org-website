---
title: "Qu'est-ce qu'une dapp ? Application décentralisée sur la chaîne de blocs"
description: "Une introduction aux applications décentralisées (dapps) et en quoi elles diffèrent des applications traditionnelles."
lang: fr
...
breadcrumb: "Qu'est-ce qu'une dapp ?"
---
...
*Cette transcription est une copie accessible de la [transcription originale de la vidéo](https://www.youtube.com/watch?v=F50OrwV6Uk8) publiée par district0x Network. Elle a été légèrement modifiée pour en faciliter la lecture.*

#### Qu'est-ce qu'une dapp ? (0:01) {#what-is-a-dapp-001}
...
#### Comment fonctionnent les dapps (0:29) {#how-dapps-work-029}
...
#### Avantages en matière de sécurité (1:10) {#security-benefits-110}
...
#### Créer des dapps sur Ethereum (1:23) {#building-dapps-on-ethereum-123}
...
#### Exemple : Ethlance (1:43) {#example-ethlance-143}
