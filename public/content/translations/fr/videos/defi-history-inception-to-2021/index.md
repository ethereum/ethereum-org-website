---
title: "DeFi : de sa création à 2021 et au-delà"
description: "Une histoire de la finance décentralisée (DeFi) depuis ses débuts jusqu'à l'été de la DeFi de 2020 et au-delà."
lang: fr
...
format: explainer
author: Finematics
breadcrumb: "Histoire de la DeFi"
---
...
*Cette transcription est une copie accessible de la [transcription originale de la vidéo](https://www.youtube.com/watch?v=qFBYB4W2tqU) publiée par Finematics. Elle a été légèrement modifiée pour en faciliter la lecture.*

#### Les origines de la DeFi (0:00) {#the-origins-of-defi-000}
...
#### MakerDAO et la naissance du prêt DeFi (1:28) {#makerdao-and-the-birth-of-defi-lending-128}
...
#### L'ère des ICO et les premiers échanges (2:42) {#the-ico-era-and-early-exchanges-242}
...
#### Le modèle utilisateur-contrat (4:52) {#the-user-to-contract-model-452}
...
#### La période de calme et Uniswap (5:20) {#the-quiet-period-and-uniswap-520}
...
#### Le Jeudi Noir (8:07) {#black-thursday-807}
...
#### L'été de la DeFi (9:37) {#defi-summer-937}
...
#### Yearn Finance et YFI (10:48) {#yearn-finance-and-yfi-1048}
...
#### L'ère de la DeFi alimentaire (11:44) {#the-food-defi-era-1144}
...
#### Le jeton Uniswap et les métriques clés (14:16) {#the-uniswap-token-and-key-metrics-1416}
...
#### L'hiver de la DeFi et la reprise (15:30) {#defi-winter-and-recovery-1530}
...
#### Perspectives pour 2021 et au-delà (16:56) {#looking-ahead-to-2021-and-beyond-1656}
