...
![Comment configurer Sepolia comme votre réseau sur MetaMask Mobile](./goerliMetamask.gif)
...
![Comment trouver le hachage de votre transaction et l'ID de votre jeton ERC-721](./findNFTEtherscan.png)

Vous devrez peut-être actualiser plusieurs fois pour voir votre NFT — mais il sera là <Emoji text="😄" size={1} /> !
