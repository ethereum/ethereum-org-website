...
Cette solution a été choisie à la fois par [Optimism](https://docs.optimism.io/op-stack/protocol/overview) et [Arbitrum](https://developer.offchainlabs.com/docs/rollup_basics#intro-to-rollups).
