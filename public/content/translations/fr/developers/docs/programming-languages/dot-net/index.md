...
description: "Apprenez à développer pour Ethereum en utilisant des projets et des outils basés sur .NET"
lang: fr
incomplete: true
---
...
- [Découvrez comment déployer facilement des contrats intelligents Ethereum à l'aide de C# et VisualStudio](https://koukia.ca/deploy-ethereum-smart-contracts-using-c-and-visualstudio-5be188ae928c)
...
Si vous êtes nouveau sur Nethermind et avez besoin d'aide pour démarrer, rejoignez notre [Discord](https://discord.gg/PaCMRFdvWT). Nos développeurs sont à votre disposition pour répondre à vos questions. N'hésitez pas à ouvrir une PR ou à signaler tout problème sur le [dépôt GitHub de Nethermind](https://github.com/NethermindEth/nethermind).
