...
![Champ d'envoi pour l'adresse de cryptomonnaie](./send.png) <br/>
...
![Bouton permettant à l'utilisateur de se connecter au site Web avec un portefeuille](./connect1.png)
...
![Sélection dans une liste de portefeuilles avec lesquels se connecter](./connect2.png)
