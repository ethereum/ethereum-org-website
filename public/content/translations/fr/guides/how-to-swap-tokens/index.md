...
Quelques plateformes d'échange populaires :
...
La plateforme d'échange calculera automatiquement combien de jetons vous obtiendrez.

![Common interface for swapping](./swap2.png)

## 4. Confirmez la transaction {#4-confirm-the-transaction}

Passez en revue les détails de la transaction. Vérifiez le taux de change et tous les autres frais pour éviter les mauvaises surprises.
...
Vous pouvez suivre la progression de la transaction sur n'importe quel explorateur de chaîne de blocs. Ce processus ne devrait pas prendre plus de 10 minutes.

Vous recevrez automatiquement les jetons échangés dans votre portefeuille une fois la transaction traitée.
<br />
...
C'est la différence entre le taux de change attendu et le taux réel.
