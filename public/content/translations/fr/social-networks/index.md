...
Les réseaux sociaux décentralisés sont des plateformes [basées sur la chaîne de blocs](/glossary/#blockchain) qui permettent aux utilisateurs d'échanger des informations ainsi que de publier et de distribuer du contenu à des publics. Parce que ces applications fonctionnent sur la chaîne de blocs, elles sont capables d'être décentralisées et résistantes à la censure et au contrôle abusif.
...
Les réseaux sociaux décentralisés sont une classe d'[applications décentralisées (dapps)](/apps/) — des applications propulsées par des [contrats intelligents](/glossary/#smart-contract) déployés sur la chaîne de blocs. Le code du contrat sert de backend pour ces applications et définit leur logique métier.

Les plateformes de médias sociaux traditionnelles s'appuient sur des bases de données pour stocker les informations des utilisateurs, le code des programmes et d'autres formes de données. Mais cela crée des points de défaillance uniques et introduit des risques importants. Par exemple, les serveurs de Facebook ont tristement [été hors ligne pendant des heures](https://www.npr.org/2021/10/05/1043211171/facebook-instagram-whatsapp-outage-business-impact) en octobre 2021, coupant les utilisateurs de la plateforme.
...
1. Les réseaux sociaux décentralisés sont résistants à la censure et ouverts à tous. Cela signifie que **les utilisateurs ne peuvent pas être bannis**, exclus de la plateforme ou restreints arbitrairement.

2. Les réseaux sociaux décentralisés sont **construits sur des idéaux open source** et rendent le code source des applications disponible pour une inspection publique. En éliminant la mise en œuvre d'algorithmes opaques courants dans les médias sociaux traditionnels, les réseaux sociaux basés sur la chaîne de blocs peuvent aligner les intérêts des utilisateurs et des créateurs de plateformes.
...
[MINDS](https://www.minds.com/) est l'un des réseaux sociaux décentralisés les plus utilisés. Il fonctionne comme Facebook et a déjà accumulé des millions d'utilisateurs.

Les utilisateurs utilisent le jeton [ERC-20](/glossary/#erc-20) natif de la plateforme, le $MIND, pour payer des articles. Les utilisateurs peuvent également gagner des jetons $MIND en publiant du contenu populaire, en contribuant à l'écosystème et en parrainant d'autres personnes sur la plateforme.
...
- [Les médias sociaux décentralisés expliqués](https://www.youtube.com/watch?v=UdT2lpcGvcQ) — _Coinmarketcap_
- [La chaîne de blocs DeSo veut décentraliser les médias sociaux](https://www.youtube.com/watch?v=SG2HUiVp0rE) — _Bloomberg Technology_
- [L'avenir des médias sociaux décentralisés avec Balaji Srinivasan, Vitalik Buterin, Juan Benet](https://www.youtube.com/watch?v=DTxE9KV3YrE) — _ETHGlobal_
