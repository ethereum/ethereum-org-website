...
summaryPoints:
  ...
  - "N'importe qui peut créer des mods, des bots ou des jeux entièrement nouveaux qui se branchent sur les mêmes données ouvertes sur chaîne"
  - "Les L2 spécialement conçus permettent un jeu en temps réel avec des frais moins élevés, tandis que les cadres de développement de jeux rendent la création de jeux sur chaîne plus accessible que jamais"
buttons:
