...
## Aperçu de l'écosystème de jeu d'Ethereum
- **Couches 2 (l2) :** Avec des frais moins élevés et des temps de transaction courts, les l2 d'Ethereum sont devenues un endroit courant pour le lancement de jeux. Le paysage des l2 continue d'évoluer, avec des écosystèmes de jeu Web3 de premier plan comme Ronin (à l'origine une chaîne latérale pour Axie Infinity) passant récemment à une architecture de couche 2 (l2) d'Ethereum, héritant des garanties de sécurité d'Ethereum tout en conservant son infrastructure optimisée pour le jeu. Les l2 actuelles de premier plan pour le jeu incluent : [Ronin](https://www.roninchain.com/), [Starknet](https://www.starknet.io/), [Abstract](https://abs.xyz/) et [Base](https://www.base.org/).
...
- **Genres de jeux :** Certains genres de jeux s'alignent naturellement avec les propriétés uniques de la chaîne de blocs Ethereum : **état persistant**, **logique vérifiable** et **économies appartenant aux joueurs**. Les développeurs abordent l'intégration différemment. Certains créent des jeux entièrement onchain où toute la logique et l'état vivent sur la chaîne de blocs, tandis que d'autres utilisent la chaîne de blocs de manière minimale pour la propriété d'actifs comme les cosmétiques NFT. Les développeurs découvrent quels types de gameplay bénéficient le plus de l'architecture onchain, notamment :
   1. **Exploration de donjons (Dungeon Crawlers) et Roguelikes :** Les donjons à mort permanente entièrement onchain de Loot Survivor avec des scores élevés vérifiables, Maze of Gains d'Onchain Heroes ainsi que sa refonte sur le thème d'Axie appelée Axie: Den of Mysteries, qui combinent l'exploration de labyrinthes avec des mécaniques de finance décentralisée (DeFi).
   2. **MMO :** Le MMO saisonnier de type « risk-to-earn » Gold Rush de Cambria avec des mécaniques de JcJ et d'extraction, où chaque pas en dehors des zones sûres comporte de véritables enjeux. Le jeu de stratégie MMO entièrement onchain de ForTheKingdom, proposant des guerres de factions à grande échelle. Axie Infinity: Atia's Legacy, un MMO onchain sur Ronin où les joueurs s'affrontent dans des donjons JcE et des batailles JcJ avec de véritables enjeux. 
   3. **Stratégie 4X et Grande Stratégie :** Conquest.eth, un jeu de conquête spatiale et de diplomatie sans permission où les joueurs stakent des jetons sur des planètes pour produire des flottes et former des alliances, dans un jeu qui s'exécute pour toujours onchain. Realms apporte les mécaniques 4X d'[Eternum](/apps/eternum/) dans un univers fantastique, où les joueurs contrôlent des Royaumes (NFT de terrains) pour extraire des ressources, construire des armées et s'engager dans une diplomatie complexe au sein d'une économie entièrement dirigée par les joueurs. Dark Forest a été le pionnier du genre avec des mécaniques de brouillard de guerre basées sur des preuves à divulgation nulle de connaissance (ZK-proof) et est actuellement maintenu en tant que fork communautaire par DFArchon.
   4. **Stratégie et Tactique :** Realms inclut les matchs de stratégie intenses basés sur des buy-ins d'une heure de Blitz, et l'autobattler Asphodel: Prologue récemment lancé sur le réseau principal Ethereum.
   ...
   6. **Arènes compétitives :** Duel Arena de Cambria, où les joueurs stakent des ETH sur des duels à mort 1c1 rapides. AveForge, une arène de combat de mechas compétitive où les joueurs pilotent des mechas personnalisables.
