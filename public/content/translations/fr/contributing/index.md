...
Ethereum.org est un projet open source avec **plus de 12 000** contributeurs qui aident à traduire, rédiger, concevoir et maintenir le site Web.
...
## Réclamer votre jeton de réussite onchain (OAT) {#oat}

Si votre contribution est fusionnée dans ethereum.org, vous aurez la possibilité de réclamer un badge spécial sur [Galxe](https://app.galxe.com/quest/ethereumorg). Un jeton de réussite onchain (OAT) est une preuve que vous avez contribué à rendre l'écosystème un peu plus génial.
