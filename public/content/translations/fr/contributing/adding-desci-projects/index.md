...
- **Code/données open source** - L'ouverture du code et des données est un principe fondamental de DeSci, les projets DeSci ne doivent donc pas être en code source fermé. La base de code doit être accessible et idéalement ouverte aux PR.
- **Les projets DeSci doivent être manifestement décentralisés** - Cela pourrait inclure d'être gouverné par une DAO, ou de construire avec une pile technologique décentralisée comprenant des portefeuilles non dépositaires. Cela implique vraisemblablement des contrats intelligents vérifiables sur Ethereum.
- **Informations honnêtes et précises sur la liste** - Il est attendu que toute suggestion d'inscription de projet soit accompagnée d'informations honnêtes et précises. Les produits dont les informations d'ajout sont falsifiées (par exemple, déclarer que votre produit est « open source » alors qu'il ne l'est pas) seront supprimés.
...
Ethereum.org est maintenu par la communauté open source et nous comptons sur la communauté pour nous aider à tenir le site à jour. Si vous remarquez que des informations sur les projets listés doivent être mises à jour, veuillez ouvrir une « Issue » ou une « Pull Récent » sur notre GitHub.
