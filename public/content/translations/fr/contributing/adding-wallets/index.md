...
# Ajouter des portefeuilles {#adding-wallets}
...
- **Un produit dont la sécurité a été testée** - que ce soit par le biais d'un audit, d'une équipe de sécurité interne, d'un code open source ou d'une autre méthode, la sécurité de votre portefeuille doit être fiable. Cela réduit les risques pour nos utilisateurs et nous montre que vous prenez la sécurité au sérieux.
...
- **Axé sur Ethereum** - Un portefeuille doit offrir une expérience principalement axée sur Ethereum. Cela signifie qu'Ethereum (ou n'importe quelle L2) est défini comme le réseau par défaut, que les actifs ERC sont correctement pris en charge et que les fonctionnalités sont alignées sur l'écosystème Ethereum. Les portefeuilles qui donnent la priorité dans l'interface utilisateur aux couches 1 alternatives ne seront pas répertoriés.

### Suppressions de produits {#product-removals}
...
### Autres critères : les atouts {#the-nice-to-haves}
...
- **WalletConnect** - les utilisateurs peuvent se connecter aux dapps en utilisant WalletConnect.
...
- **NFT** - les utilisateurs sont en mesure de visualiser et d'interagir avec leurs NFT dans le portefeuille.
...
- **Échanges** - les utilisateurs peuvent échanger des jetons via le portefeuille.
- **Réseaux multichaînes** - votre portefeuille permet aux utilisateurs d'accéder à plusieurs réseaux blockchain par défaut.
- **Réseaux de couche 2** - votre portefeuille permet aux utilisateurs d'accéder par défaut aux réseaux de couche 2.
- **Personnalisation des frais de gaz** - votre portefeuille permet aux utilisateurs de personnaliser les frais de gaz pour leurs transactions (frais de base, frais de priorité, frais maximum).
- **Support ENS** - votre portefeuille permet aux utilisateurs d'envoyer des transactions à des noms ENS.
- **Support ERC-20** - votre portefeuille permet aux utilisateurs d'importer des contrats de jetons ERC-20, ou interroge et affiche automatiquement les jetons ERC-20.
- **Acheter des cryptomonnaies** - votre portefeuille aide les utilisateurs à acheter directement des cryptomonnaies et facilite leurs premiers pas.
...
ethereum.org est maintenu par la communauté open source et nous comptons sur la communauté pour nous aider à le maintenir à jour. Si vous remarquez des informations sur les portefeuilles répertoriés qui doivent être mises à jour, veuillez [ouvrir une issue](https://github.com/ethereum/ethereum-org-website/issues/new?assignees=&labels=wallet+%3Apurse%3A&template=suggest_wallet.yaml) ou faire une [pull request](https://github.com/ethereum/ethereum-org-website/pulls) !
