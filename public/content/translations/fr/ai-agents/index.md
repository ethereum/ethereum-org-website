...
- <strong>Fonctionnalité onchain robuste :</strong> Permet aux agents IA d’exécuter des transactions, d’interagir avec des contrats intelligents, de fournir de la liquidité et de collaborer entre protocoles.
