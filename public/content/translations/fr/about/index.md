...
- Augmenter l'engagement des utilisateurs via des fonctionnalités telles que des sondages, des quiz et des intégrations Web3
- Garder le site Web léger et performant
...
- Améliorer la rétention des contributeurs grâce à l'engagement, aux remerciements et aux récompenses
- Donner aux membres de la communauté les moyens d'apporter des contributions de plus en plus importantes
- Faciliter une plus grande diversité de contributions : code, contenu, design, traduction, modération
- Garder la base de code moderne, propre et bien documentée
...
Nous avons un [guide de style](/contributing/style-guide/) pour standardiser certains aspects de la rédaction de contenu afin de rendre le processus de contribution plus fluide.
