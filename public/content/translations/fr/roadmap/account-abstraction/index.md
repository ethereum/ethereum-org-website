...
La plupart des utilisateurs interagissent avec Ethereum en utilisant des **[comptes externes (EOA)](/glossary/#eoa)**. Cela limite la façon dont les utilisateurs peuvent interagir avec Ethereum. Par exemple, cela rend difficile l’exécution de lots de transactions et oblige les utilisateurs à toujours conserver un solde ETH pour payer les frais de transaction.
...
- si vous avez la clé privée, vous pouvez faire _n'importe quoi_ dans le respect des règles de la machine virtulle Ethereum (EVM)
...
## Au-delà des phrases de récupération {#beyond-seed-phrases}
...
Dans le cadre de la mise à niveau Pectra d’Ethereum, l’EIP-7702 est prévu pour le 7 mai 2025. L'EIP-4337 a été largement adopté, [avec plus de 26 millions de comptes intelligents déployés et plus de 170 millions de UserOperations traitées](https://www.bundlebear.com/erc4337-overview/all).
...
- [« La voie vers l'abstraction de compte » de Vitalik](https://notes.ethereum.org/@vbuterin/account_abstraction_roadmap#Transaction-inclusion-lists)
- [Le blog de Vitalik sur les portefeuilles à récupération sociale](https://vitalik.eth.limo/general/2021/01/11/recovery.html)
