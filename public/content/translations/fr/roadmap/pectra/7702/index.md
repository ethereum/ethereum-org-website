...
**address** est la délégation (bytecode déjà déployé qui sera utilisé par l'EOA)
...
- Peuvent exiger que la fonction d'initialisation ne soit appelée que depuis [EntryPoint](https://github.com/eth-infinitism/account-abstraction/releases/tag/v0.8.0)
...
Étant donné que les portefeuilles mettront sur liste blanche des contrats de délégation spécifiques pour l'EIP-7702, les applications décentralisées (dapps) ne devraient pas s'attendre à demander directement des autorisations EIP-7702. Au lieu de cela, l'intégration devrait se faire via des interfaces de portefeuille standardisées :
...
> Remarque : Il n'existe pas de méthode standardisée pour que les dapps demandent directement des signatures d'autorisation EIP-7702. Les dapps doivent s'appuyer sur des interfaces de portefeuille spécifiques comme l'ERC-6900 pour tirer parti des fonctionnalités de l'EIP-7702.
