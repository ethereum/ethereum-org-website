...
<AlertContent>
<AlertDescription>
La mise à niveau Pectra n'est qu'une étape dans les objectifs de développement à long terme d'Ethereum. Apprenez-en plus sur [la feuille de route du protocole](/roadmap/) et les [mises à niveau précédentes](/ethereum-forks/).
</AlertDescription>
</AlertContent>
</Alert>
...
<AlertContent>
<AlertDescription>
Pour en savoir plus sur la façon dont Pectra vous affecte spécifiquement en tant qu'utilisateur, développeur ou validateur Ethereum, consultez la <a href="https://epf.wiki/#/wiki/pectra-faq">FAQ Pectra</a>.
</AlertDescription>
</AlertContent>
</Alert>
