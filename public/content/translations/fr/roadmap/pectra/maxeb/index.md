...
Un validateur choisit d’adopter le changement maxEB en convertissant ses identifiants de retrait de **Type 1** vers **Type 2**. Cela peut être fait sur la [Plateforme de lancement (Actions du validateur)](https://launchpad.ethereum.org/validator-actions) après la mise en service de la fourche majeure Pectra. Comme pour la conversion de **Type 0** → **Type 1**, passer de **Type 1** → **Type 2** est un processus irréversible.
...
| Consolideth.app | https://consolideth.app/ [GitHub](https://github.com/Stakely/consolideth) | Oui, licences MIT               | [Stakely](https://stakely.io/)                 | Non                                                                                                                                                 | UI Web, hébergée par Stakely et prête à être auto-hébergée gratuitement. | Prend en charge les connexions aux portefeuilles principaux, y compris Safe avec WalletConnect. |
