---
title: "Che cos'è una dapp? Applicazione decentralizzata sulla blockchain"
description: "Un'introduzione alle applicazioni decentralizzate (dapp) e in cosa differiscono dalle app tradizionali."
lang: it
...
*Questa trascrizione è una copia accessibile della [trascrizione originale del video](https://www.youtube.com/watch?v=F50OrwV6Uk8) pubblicata da district0x Network. È stata leggermente modificata per facilitarne la lettura.*

#### Che cos'è una dapp? (0:01) {#what-is-a-dapp-001}
...
#### Come funzionano le dapp (0:29) {#how-dapps-work-029}
...
#### Vantaggi in termini di sicurezza (1:10) {#security-benefits-110}
...
#### Creare dapp su Ethereum (1:23) {#building-dapps-on-ethereum-123}
...
#### Esempio: Ethlance (1:43) {#example-ethlance-143}
