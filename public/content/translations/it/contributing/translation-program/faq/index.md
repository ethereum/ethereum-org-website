---
title: Guida alla traduzione di ethereum.org
metaTitle: Domande frequenti (FAQ) sul Programma di Traduzione
lang: it
...
Il Programma di Traduzione di ethereum.org ne è un'estensione ed è organizzato con una filosofia simile.

L'obiettivo del Programma di Traduzione è rendere i contenuti di Ethereum accessibili a tutti, indipendentemente dalle lingue parlate. Consente inoltre a qualsiasi persona bilingue di partecipare all'ecosistema di Ethereum e contribuire in modo accessibile.

Per questo motivo, il Programma di Traduzione è aperto e volontario, e la partecipazione non è soggetta a retribuzione. Se dovessimo retribuire i traduttori per il numero di parole che traducono, potremmo invitare a partecipare al Programma di Traduzione solo coloro che hanno un'esperienza di traduzione sufficiente (traduttori professionisti). Ciò renderebbe il Programma di Traduzione esclusivo e ci impedirebbe di raggiungere gli obiettivi delineati, in particolare: consentire a tutti di partecipare e farsi coinvolgere nell'ecosistema.

Facciamo ogni sforzo per consentire ai nostri collaboratori di avere successo nell'ecosistema di Ethereum; sono in atto molti incentivi non monetari come: [l'offerta di POAP](/contributing/translation-program/acknowledgements/#poap) e un [certificato di traduttore](/contributing/translation-program/acknowledgements/#certificate), oltre all'organizzazione delle [Classifiche di Traduzione](/contributing/translation-program/acknowledgements/) e [l'elenco di tutti i nostri traduttori sul sito](/contributing/translation-program/contributors/).

## Come traduco le stringhe con `<HTML tags>`? {#tags}
...
- Traduci il testo all'interno dei tag ma non i tag stessi. Qualsiasi cosa in `<` e `>` non deve essere tradotta o rimossa.
...
Se vuoi segnalare una stringa in particolare che richiede attenzione, sentiti libero di inviare un commento.
...
_Per nomi (marchi, aziende, persone) e nuovi termini tecnici (Beacon Chain, catene di shard, ecc.)_
...
Per garantire un certo livello di qualità e coerenza nelle nostre traduzioni, collaboriamo con [Acolad](https://www.acolad.com/), uno dei maggiori fornitori di servizi linguistici a livello globale. Acolad conta 20.000 linguisti professionisti, il che significa che possono fornire revisori professionisti per ogni lingua e tipo di contenuto di cui abbiamo bisogno.

Il processo di revisione è semplice; una volta che un insieme di contenuti è tradotto al 100%, ordiniamo una revisione per quel blocco di contenuti. Il processo di revisione si svolge direttamente in Crowdin. Una volta completata la revisione, aggiorniamo il sito web con i contenuti tradotti.
...
Per suggerire nuovi contenuti per ethereum.org, puoi [creare una issue](https://github.com/ethereum/ethereum-org-website/issues) su GitHub. Se aggiunto, il contenuto verrà scritto in inglese e tradotto in altre lingue utilizzando Crowdin.

Prevediamo di aggiungere il supporto per l'aggiunta di contenuti non in inglese nel prossimo futuro.

## Contattaci {#contact}

Grazie per aver letto tutto questo. Speriamo che ti aiuti a inserirti nel nostro programma. Sentiti libero di unirti al nostro [canale di traduzione su Discord](https://discord.gg/ethereum-org) per fare domande e collaborare con altri traduttori, o contattaci all'indirizzo translations@ethereum.org!