...
I portafogli cambiano rapidamente su Ethereum. Abbiamo cercato di creare un quadro equo per la valutazione su ethereum.org, ma i criteri di inserimento cambieranno e si evolveranno nel tempo.
...
- **Un portafoglio "live" da oltre sei mesi OPPURE rilasciato da un gruppo con una comprovata esperienza**: questa è un'altra indicazione di sicurezza. Sei mesi sono un buon lasso di tempo per individuare bug critici e vulnerabilità. Richiediamo sei mesi per aiutare a filtrare i fork che vengono rapidamente abbandonati come progetti.
...
- **Transazioni EIP-1559 (tipo 2)**: il tuo portafoglio deve supportare le transazioni EIP-1559 (tipo 2) per le transazioni sulla Mainnet di Ethereum.
...
- **Incentrato su Ethereum**: un portafoglio deve fornire un'esperienza incentrata principalmente su Ethereum. Ciò significa che Ethereum (o qualsiasi layer 2 (l2)) è impostato come rete predefinita, gli asset ERC sono adeguatamente supportati e le funzionalità sono allineate con l'ecosistema di Ethereum. I portafogli che danno priorità nell'interfaccia utente a layer 1 alternativi non verranno elencati. 
...
- **Supporto per portafoglio hardware**: gli utenti possono connettere il proprio portafoglio hardware per firmare le transazioni.
- **WalletConnect**: gli utenti possono connettersi alle applicazioni decentralizzate (dapp) utilizzando WalletConnect.
...
- **Staking**: gli utenti sono in grado di mettere in staking direttamente tramite il portafoglio.
- **Swap**: gli utenti sono in grado di effettuare swap di token tramite il portafoglio.
- **Reti multichain**: il tuo portafoglio supporta l'accesso degli utenti a più reti blockchain per impostazione predefinita.
- **Reti layer 2**: il tuo portafoglio supporta l'accesso degli utenti alle reti layer 2 (l2) per impostazione predefinita.
...
- **Supporto ERC-20**: il tuo portafoglio consente agli utenti di importare contratti di token ERC-20, oppure interroga e visualizza automaticamente i token ERC-20.
- **Acquisto di cripto**: il tuo portafoglio supporta gli utenti nell'acquisto diretto e nell'inserimento nel mondo delle cripto.
...
- **Multisig**: il tuo portafoglio supporta firme multiple per firmare una transazione.
- **Recupero sociale**: il tuo portafoglio supporta i tutori e un utente può recuperare il proprio portafoglio se perde la propria frase seme utilizzando questi tutori.
...
- **Risorse educative/documentazione**: il tuo prodotto dovrebbe avere un'esperienza di inserimento ben progettata per aiutare ed educare gli utenti. Oppure prove di contenuti pratici come articoli o video.
...
- verificare che non ci siano prodotti suggeriti che soddisfano i nostri criteri più di quelli attualmente elencati
