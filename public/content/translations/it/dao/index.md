...
Contengono delle tesoriere integrate, a cui nessuno ha l'autorità di accedere senza l'approvazione del gruppo. Le decisioni sono governate da proposte e votazioni per garantire che tutti nell'organizzazione abbiano voce in capitolo e che tutto avvenga in modo trasparente [on-chain](/glossary/#onchain).
...
| OAD                                                                                                                                                            | Organizzazione tradizionale                                                                                                                   |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
...
[ENS](https://claim.ens.domains/delegate-ranking) – I titolari di ENS possono delegare i propri voti a membri impegnati della comunità perché li rappresentino.
...
[Nouns](https://nouns.wtf) – Nella DAO Nouns, una transazione viene eseguita automaticamente se viene raggiunto il quorum di voti e la maggioranza vota a favore, a condizione che non venga posto il veto da parte dei fondatori.

### Governance multifirma {#governance-example}

Sebbene le DAO possano avere migliaia di membri con diritto di voto, i fondi possono trovarsi in un [portafoglio](/glossary/#wallet) condiviso da 5-20 membri attivi della comunità, che sono fidati e di solito "doxxati" (identità pubbliche note alla comunità). Dopo un voto, i firmatari [multisig](/glossary/#multisig) eseguono la volontà della comunità.
...
[CityDAO](https://citizen.citydao.io/) – CityDAO ha usato la legge sulle DAO del Wyoming per acquistare 40 acri di terreno vicino al Parco Nazionale di Yellowstone.

## Adesione a una DAO {#dao-membership}
...
Solitamente del tutto [senza permessi](/glossary/#permissionless), a seconda del token utilizzato. Per lo più, questi token di governance possono essere scambiati senza permessi su un [exchange decentralizzato](/glossary/#dex). Altri, invece, devono esser guadagnati fornendo liquidità o altri tipi di "Proof of Work". In entrambi i casi, la semplice detenzione del token garantisce l'accesso al voto.

_Di solito usato per governare ampi protocolli decentralizzati e/o i token stessi._

#### Un esempio famoso {#token-example}

[MakerDAO](https://makerdao.com) – Il token MKR di MakerDAO è ampiamente disponibile sugli exchange decentralizzati e chiunque può acquistarli per ottenere potere di voto sul futuro del protocollo Maker.
...
_Tipicamente utilizzate per lo sviluppo e la governance decentralizzati di protocolli e [dApp](/glossary/#dapp), ma si adattano bene anche a una vasta gamma di organizzazioni come enti di beneficenza, collettivi di lavoratori, club di investimento, ecc._

#### Un esempio famoso {#reputation-example}

[DXdao](https://DXdao.eth.limo) – DXdao era un collettivo sovrano globale che ha costruito e governato protocolli e applicazioni decentralizzate dal 2019. Ha sfruttato la governance basata sulla reputazione e il [consenso olografico](/glossary/#holographic-consensus) per coordinare e gestire i fondi, il che significa che nessuno poteva pagare per influenzarne il futuro o la governance.
...
- [Avvia una Governor DAO con Tally](https://www.tally.xyz/get-started)
...
- [Cos'è una DAO?](https://aragon.org/dao) – [Aragon](https://aragon.org/)
- [Casa delle DAO](https://wiki.metagame.wtf/docs/great-houses/house-of-daos) – [Metagame](https://wiki.metagame.wtf/)
- [Cos'è una DAO e a cosa serve?](https://daohaus.substack.com/p/-what-is-a-dao-and-what-is-it-for) – [DAOhaus](https://daohaus.club/)
- [Come avviare una comunità digitale basata su una DAO](https://daohaus.substack.com/p/four-and-a-half-steps-to-start-a) – [DAOhaus](https://daohaus.club/)
...
- [Le DAO non sono aziende: dove conta la decentralizzazione nelle organizzazioni autonome, di Vitalik](https://vitalik.eth.limo/general/2022/09/20/daos.html)
- [DAO, DAC, DA e altro ancora: una guida terminologica incompleta](https://blog.ethereum.org/2014/05/06/daos-dacs-das-and-more-an-incomplete-terminology-guide) - [Blog di Ethereum](https://blog.ethereum.org)

### Video {#videos}

- [Cos'è una DAO nelle cripto?](https://youtu.be/KHm0uUPqmVE)
