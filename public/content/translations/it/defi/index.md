...
alt: Un logo Eth fatto di mattoncini lego.
sidebarDepth: 2
summaryPoints:
  - "Un'alternativa globale e aperta all'attuale sistema finanziario."
  - "Prodotti che ti permettono di assumere prestiti, risparmiare, investire, fare trading e altro ancora."
  - "Basata su una tecnologia open source con cui chiunque può programmare."
---

La DeFi è un sistema finanziario aperto e globale costruito per l'era di Internet: un'alternativa a un sistema opaco, strettamente controllato e tenuto insieme da infrastrutture e processi vecchi di decenni. Ti offre controllo e visibilità sul tuo denaro. Ti offre esposizione ai mercati globali e alternative alla tua valuta locale o alle opzioni bancarie. I prodotti della DeFi aprono i servizi finanziari a chiunque abbia una connessione a Internet e sono in gran parte di proprietà e gestiti dai loro utenti. Finora, decine di miliardi di dollari in cripto sono fluiti attraverso le applicazioni della DeFi e il numero cresce ogni giorno.
...
## DeFi vs finanza tradizionale {#defi-vs-tradfi}

Uno dei modi migliori per comprendere il potenziale della DeFi è capire i problemi che esistono oggi.

- Ad alcune persone non è concesso l'accesso per aprire un conto bancario o utilizzare servizi finanziari.
- La mancanza di accesso ai servizi finanziari può impedire alle persone di essere assumibili.
- I servizi finanziari possono impedirti di essere pagato.
- Un costo nascosto dei servizi finanziari sono i tuoi dati personali.
- I governi e le istituzioni centralizzate possono chiudere i mercati a piacimento.
- Gli orari di trading sono spesso limitati agli orari di lavoro di un fuso orario specifico.
- I trasferimenti di denaro possono richiedere giorni a causa di processi umani interni.
- C'è un sovrapprezzo sui servizi finanziari perché le istituzioni intermediarie hanno bisogno della loro fetta.
...
| Controlli dove va il tuo denaro e come viene speso.                                              | Devi fidarti che le società non gestiscano male il tuo denaro, ad esempio prestandolo a mutuatari a rischio.                                      |
| I trasferimenti di fondi avvengono in pochi minuti.                                                              | I pagamenti possono richiedere giorni a causa di processi manuali.                                                                                |
| L'attività delle transazioni è pseudonima.                                                              | L'attività finanziaria è strettamente legata alla tua identità.                                                                      |
| La DeFi è aperta a chiunque.                                                                            | Devi fare richiesta per utilizzare i servizi finanziari.                                                                                      |
| I mercati sono sempre aperti.                                                                       | I mercati chiudono perché i dipendenti hanno bisogno di pause.                                                                                   |
| È basata sulla trasparenza: chiunque può guardare i dati di un prodotto e ispezionare come funziona il sistema. | Le istituzioni finanziarie sono libri chiusi: non puoi chiedere di vedere la loro cronologia dei prestiti, un registro dei loro asset gestiti e così via. |
...
- [Assumere prestiti di fondi con collaterale](#lending-2)
- [Assumere prestiti senza collaterale](#flash-loans)
- [Iniziare a risparmiare in cripto](#saving)
...
La volatilità delle criptovalute è un problema per molti prodotti finanziari e per la spesa in generale. La comunità della DeFi ha risolto questo problema con le stablecoin. Il loro valore rimane ancorato a un altro asset, di solito una valuta popolare come il dollaro.

Monete come DAI o USDC hanno un valore che rimane entro pochi centesimi di dollaro. Questo le rende perfette per guadagnare o per la vendita al dettaglio. Molte persone in America Latina hanno usato le stablecoin come un modo per proteggere i propri risparmi in un periodo di grande incertezza con le valute emesse dai loro governi.
...
### Assunzione di prestito {#lending}

L'assunzione di prestito di denaro da fornitori decentralizzati si presenta in due varianti principali.

- Peer-to-peer, il che significa che un mutuatario assumerà un prestito direttamente da uno specifico prestatore.
- Basata su pool, in cui i prestatori forniscono fondi (liquidità) a un pool da cui i mutuatari possono assumere prestiti.

<ButtonLink href="/apps/categories/defi">
  Vedi le dapp di assunzione di prestito
</ButtonLink>

Ci sono molti vantaggi nell'utilizzare un prestatore decentralizzato...

#### Assunzione di prestito con privacy {#borrowing-privacy}

Oggi, il prestito e l'assunzione di prestito di denaro ruotano tutti attorno agli individui coinvolti. Le banche hanno bisogno di sapere se è probabile che tu ripaghi un prestito prima di concederlo.

Il prestito decentralizzato funziona senza che nessuna delle parti debba identificarsi. Invece, il mutuatario deve fornire un collaterale che il prestatore riceverà automaticamente se il prestito non viene ripagato. Alcuni prestatori accettano persino [NFT](/glossary/#nft) come collaterale. Gli NFT sono un atto di proprietà di un asset unico, come un dipinto. [Maggiori informazioni sugli NFT](/nft/)

Questo ti permette di assumere prestiti di denaro senza controlli del credito o senza dover fornire informazioni private.
...
I prestiti lampo sono una forma più sperimentale di prestito decentralizzato che ti permette di assumere prestiti senza collaterale o senza fornire alcuna informazione personale.
...
I fondi che vengono spesso utilizzati sono detenuti in pool di liquidità (grandi pool di fondi utilizzati per l'assunzione di prestito). Se non vengono utilizzati in un dato momento, questo crea un'opportunità per qualcuno di assumere in prestito questi fondi, condurre affari con essi e ripagarli per intero letteralmente nello stesso momento in cui vengono presi in prestito.

Questo significa che molta logica deve essere inclusa in una transazione molto su misura. Un semplice esempio potrebbe essere qualcuno che usa un prestito lampo per prendere in prestito la maggior quantità possibile di un asset a un prezzo, in modo da poterlo vendere su un exchange diverso dove il prezzo è più alto.
...
Per poter fare l'esempio sopra nel mondo della finanza tradizionale, avresti bisogno di un'enorme quantità di denaro. Queste strategie per fare soldi sono accessibili solo a chi ha già una ricchezza esistente. I prestiti lampo sono un esempio di un futuro in cui avere denaro non è necessariamente un prerequisito per fare denaro.

<ButtonLink isSecondary href="https://aave.com/docs/aave-v3/guides/flash-loans">
  Maggiori informazioni sui prestiti lampo
</ButtonLink>

<Divider />

### Iniziare a risparmiare con le cripto {#saving}

#### Prestito {#lending-2}

Puoi guadagnare interessi sulle tue cripto prestandole e vedere i tuoi fondi crescere in tempo reale. In questo momento i tassi di interesse sono molto più alti di quelli che potresti ottenere presso la tua banca locale (se sei abbastanza fortunato da potervi accedere). Ecco un esempio:

- Presti i tuoi 100 DAI, una [stablecoin](/stablecoins/), a un prodotto come Aave.
- Ricevi 100 Aave Dai (aDai), che è un token che rappresenta i tuoi DAI prestati.
- I tuoi aDai aumenteranno in base ai tassi di interesse e potrai vedere il tuo saldo crescere nel tuo portafoglio. A seconda dell'[APR](/glossary/#apr), il saldo del tuo portafoglio indicherà qualcosa come 100,1234 dopo pochi giorni o persino ore!
- Puoi prelevare una quantità di DAI regolari pari al tuo saldo di aDai in qualsiasi momento.
...
Ci sono opzioni più avanzate per i trader a cui piace avere un po' più di controllo. Ordini limite, contratti perpetui, trading con margine e altro ancora sono tutti possibili. Con il trading decentralizzato hai accesso alla liquidità globale, il mercato non chiude mai e hai sempre il controllo dei tuoi asset.

Quando usi un exchange centralizzato devi depositare i tuoi asset prima dello scambio e fidarti che se ne prendano cura. Mentre i tuoi asset sono depositati, sono a rischio poiché gli exchange centralizzati sono bersagli attraenti per gli hacker.
...
Questo significa che il Progetto A, con le sue 100 donazioni da 1 dollaro, potrebbe finire con più fondi del Progetto B con una singola donazione da 10.000 dollari (a seconda delle dimensioni del pool di matching).
...
### Aggregatori e gestori di portafoglio {#aggregators}

Con così tante cose in corso, avrai bisogno di un modo per tenere traccia di tutti i tuoi investimenti, prestiti e scambi. Ci sono una miriade di prodotti che ti permettono di coordinare tutte le tue attività della DeFi da un unico posto. Questa è la bellezza dell'architettura aperta della DeFi. I team possono costruire interfacce in cui non solo puoi vedere i tuoi saldi tra i vari prodotti, ma puoi anche utilizzare le loro funzionalità. Potresti trovarlo utile man mano che esplori di più la DeFi.
...
La DeFi è un movimento open source. I protocolli e le applicazioni della DeFi sono tutti aperti affinché tu possa ispezionarli, farne un fork e innovarli. A causa di questo stack a livelli (condividono tutti la stessa blockchain di base e gli stessi asset), i protocolli possono essere mescolati e abbinati per sbloccare opportunità di combinazioni uniche.
...
- [Linee guida per la valutazione del rischio della DeFi dell'EEA](https://entethalliance.org/specs/defi-risks/) – Una panoramica supportata dal settore su come identificare e valutare i rischi chiave nei protocolli della DeFi.

### Video {#videos}

- [Finematics - educazione alla finanza decentralizzata](https://finematics.com/) – _Video sulla DeFi_
