...
## Sicurezza crypto 101 {#crypto-security}

### Approfondisci le tue conoscenze {#level-up-your-knowledge}
...
### Non condividere le tue chiavi private {#protect-private-keys}
...
### Controlla due volte le transazioni prima di inviarle {#double-check-transactions}
...
È una buona pratica, interagendo con un contratto intelligente, leggere il messaggio della transazione prima di firmare.

### Imposta i limiti di spesa del contratto intelligente {#spend-limits}
...
[Come revocare l'accesso del contratto intelligente ai tuoi fondi crypto](/guides/how-to-revoke-token-access/)
...
### Phishing tramite annunci di Twitter {#ad-phishing}

![Phishing tramite link di Twitter](./twitterPhishingScam.png)

Esiste un metodo per lo spoofing della funzionalità di anteprima (dispiegamento) dei link di Twitter (anche noto come X), per ingannare gli utenti nel pensare che stiano visitando un sito web legittimo. Questa tecnica sfrutta il meccanismo di Twitter per generare le anteprime degli URL condivisi nei tweet e mostra, ad esempio, _da ethereum.org_ (come mostrato sopra), quando in realtà si viene reindirizzati a un sito dannoso.
...
Una delle truffe più comuni in criptovaluta è la truffa del giveaway. La truffa del giveaway può assumere molte forme, ma l'idea generale è che se invii ETH all'indirizzo del portafoglio fornito, riceverai il doppio degli ETH trasferiti._Per questa ragione è conosciuta anche come la truffa del 2 per 1._
...
Il giveaway di celebrità è un altro dei più comuni tipi di truffa del giveaway. I truffatori prenderanno un'intervista video registrata o il discorso di una conferenza tenuto da una celebrità e lo trasmetteranno in livestream su YouTube, facendo sembrare che la celebrità stia tenendo un'intervista video in diretta per approvare un giveaway di criptovaluta.

Vitalik Buterin è il più usato in questa truffa, ma vengono usate anche molte altre persone di spicco del mondo crypto (ad es. Elon Musk o Charles Hoskinson). L'inclusione di una persona nota dà allo streaming live dei truffatori un senso di legittimità (sembra strano, ma se ne parla Vitalik, dovrebbe essere tutto ok).
...
<AlertContent>
<AlertDescription>
    Attenzione: sebbene le truffe in stile "supporto" avvengano comunemente su Discord, possono essere prevalenti anche su qualsiasi applicazione di chat in cui si discute di crypto, inclusa l'e-mail.
</AlertDescription>
</AlertContent>
</Alert>
...
In vista de [La Fusione](/roadmap/merge/), i truffatori hanno approfittato della confusione attorno al termine 'Eth2' per cercare di indurre gli utenti a riscattare i loro ETH per un token 'ETH2'. Non esiste alcun 'ETH2' e non è stato introdotto alcun altro token legittimo con La Fusione. Gli ETH che possedevi prima de La Fusione, sono gli stessi ETH adesso. **Non è necessario intraprendere alcuna azione relativa ai propri ETH per il passaggio da proof-of-work a proof-of-stake**.
...
_Nota: esistono token/ticker derivati che possono rappresentare ETH in staking (ad es. rETH da Rocket Pool, stETH da Lido, ETH2 da Coinbase), ma non sono qualcosa verso cui è necessario "migrare"._
...
[Ulteriori informazioni su come evitare le truffe di phishing](https://support.mycrypto.com/staying-safe/mycrypto-protips-how-not-to-get-scammed-during-ico)

### Truffe dei broker di trading crypto {#broker-scams}
...
### Truffe delle pool di mining crypto {#mining-pool-scams}
...
[Uomo perde 200.000$ in una truffa di una pool di mining](https://www.reddit.com/r/CoinBase/comments/r0qe0e/scam_or_possible_incredible_payout/)
...
[Ulteriori informazioni sulle truffe degli airdrop](https://www.youtube.com/watch?v=LLL_nQp1lGk)
...
Un altro errore comune è l'uso di password che possono essere facilmente indovinate o scoperte attraverso l'[ingegneria sociale](https://wikipedia.org/wiki/Social_engineering_\(security\)). Includere nella password il nome da nubile di tua madre, i nomi dei tuoi figli o animali domestici, o date di nascita incrementerà il rischio di violazioni.
...
[Ulteriori informazioni sulla creazione di password complesse](https://terranovasecurity.com/how-to-create-a-strong-password-in-7-easy-steps/)

### Usa password uniche per ogni cosa {#use-unique-passwords}

Una password forte rivelata in una violazione di dati non è più una password forte. Il sito web [Have I Been Pwned](https://haveibeenpwned.com) ti permette di verificare se i tuoi account sono stati coinvolti in qualche violazione di dati pubblici. In tal caso, **cambia immediatamente quelle password**. L'utilizzo di password univoche per ogni conto riduce il rischio che gli hacker ottengano l'accesso a tutti i tuoi conti in caso di compromissione di una delle tue password.
...
<AlertContent>
<AlertDescription>
    L'uso di un gestore di password si occupa di creare password complesse e uniche e di ricordarle! Consigliamo <strong>vivamente</strong> di usarne uno, e la maggior parte sono gratuiti!
</AlertDescription>
</AlertContent>
</Alert>
...
- O controlla altri [gestori di password consigliati](https://www.privacytools.io/secure-password-manager)

### Usa l'autenticazione a due fattori {#two-factor-authentication}

Talvolta, ti potrebbe essere richiesto di autenticare la tua identità tramite prove univoche. Questi sono noti come **fattori**. I tre fattori principali sono:
...
#### Per restare al sicuro: {#browser-extension-safety}
...
[Ulteriori informazioni sui rischi delle estensioni del browser](https://www.kaspersky.co.uk/blog/browser-extensions-security/12750/)
...
- [Fino a 3 milioni di dispositivi infettati da componenti aggiuntivi per Chrome ed Edge infettati da malware](https://arstechnica.com/information-technology/2020/12/up-to-3-million-devices-infected-by-malware-laced-chrome-and-edge-add-ons/) - _Dan Goodin_
...
### Sicurezza crypto {#reading-crypto-security}

- [Proteggere se stessi e i propri fondi](https://support.mycrypto.com/staying-safe/protecting-yourself-and-your-funds) - _MyCrypto_
- [Problemi di sicurezza nei software comuni di comunicazione crypto](https://docs.salusec.io/untitled/web3-penetration-test/risks-in-social-media) - _Salus_
...
- [Sicurezza crypto: Password e autenticazione](https://www.youtube.com/watch?v=m8jlnZuV1i4) - _Andreas M. Antonopoulos_

### Formazione sulle truffe {#reading-scam-education}

- [Guida: come identificare i token truffa](/guides/how-to-id-scam-tokens/)
- [Stare al sicuro: truffe comuni](https://support.mycrypto.com/staying-safe/common-scams) - _MyCrypto_
- [Evitare le truffe](https://bitcoin.org/en/scams) - _Bitcoin.org_
- [Thread di Twitter sulle email e i messaggi di phishing crypto più comuni](https://twitter.com/tayvano_/status/1516225457640787969) - _Taylor Monahan_
