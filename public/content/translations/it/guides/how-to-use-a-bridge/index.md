...
Puoi saperne di più sui diversi progetti e sui link importanti nella nostra [pagina sui layer 2](/layer-2/).

## 2. Vai al ponte selezionato {#2-go-to-the-selected-bridge}

Alcuni layer 2 popolari sono:
...
## 4. Specifica l'importo e sposta i fondi {#4-specify-the-amount-and-move-the-funds}

Controlla l'importo che otterrai in cambio sulla rete layer 2 e le commissioni per evitare spiacevoli sorprese.
...
## 6. Attendi che i tuoi fondi vengano spostati {#6-wait-for-your-funds-to-be-moved}

Questo processo non dovrebbe richiedere più di 10 minuti.

## 7. Aggiungi la rete layer 2 selezionata al tuo portafoglio (opzionale) {#7-add-the-selected-layer-2-network-to-your-wallet-optional}
...
### E se avessi dei fondi su un exchange? {#what-if-i-have-funds-on-an-exchange}
