...
Dato che i portafogli inseriranno in whitelist specifici contratti di delega per l'EIP-7702, le dapp non dovrebbero aspettarsi di richiedere direttamente le autorizzazioni EIP-7702. Invece, l'integrazione dovrebbe avvenire attraverso interfacce standardizzate del portafoglio:
...
Utilizzando queste interfacce, le dapp possono accedere alle funzionalità degli smart account fornite dall'EIP-7702 senza gestire direttamente le deleghe, garantendo compatibilità e sicurezza tra diverse implementazioni di portafogli.

> Nota: Non esiste un metodo standardizzato per le dapp per richiedere direttamente le firme di autorizzazione EIP-7702. Le dapp devono fare affidamento su interfacce specifiche del portafoglio come l'ERC-6900 per sfruttare le funzionalità dell'EIP-7702.
...
Ad esempio, il [SafeEIP7702Proxy](https://docs.safe.global/advanced/eip-7702/7702-safe) dimostra come un proxy possa essere utilizzato per inizializzare e gestire in modo sicuro le deleghe in account compatibili con l'EIP-7702.
...
Il fornitore di hardware inserisce in whitelist i contratti di delega noti e implementa il loro supporto nell'app companion software. Si raccomanda di scegliere un contratto con pieno supporto per l'ERC-4337.

Gli EOA delegati a uno diverso verranno gestiti come EOA standard.
#### Delega personalizzata

Il fornitore di hardware implementa il proprio contratto di delega e lo aggiunge agli elenchi, implementandone il supporto nell'app companion software. Si raccomanda di creare un contratto con pieno supporto per l'ERC-4337.
