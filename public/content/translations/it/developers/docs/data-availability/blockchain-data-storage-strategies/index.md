...
A partire dalla [biforcazione Dencun](https://github.com/ethereum/consensus-specs/tree/master/specs/deneb/beacon-chain.md) la blockchain di Ethereum include [EIP-4844](https://eips.ethereum.org/EIPS/eip-4844), che si aggiunge ai blob di dati di Ethereum con una vita limitata (inizialmente circa [18 giorni](https://github.com/ethereum/consensus-specs/tree/master/specs/deneb/p2p-interface.md#configuration)). Questi blob sono stimati separatamente dal [gas di esecuzione](/developers/docs/gas), sebbene utilizzino un meccanismo simile. Sono un modo economico per pubblicare dati temporanei.
...
| ------------------------------ | ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| Blob di EIP-4844               | Offchain           | Garanzia di Ethereum per [~18 giorni](https://github.com/ethereum/consensus-specs/tree/master/specs/deneb/p2p-interface.md#configuration) | Solo l'hash è disponibile                                           |                                                                                     |
