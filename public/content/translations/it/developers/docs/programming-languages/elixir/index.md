...
<FeaturedText>Scopri come sviluppare per Ethereum usando progetti e strumenti basati su Elixir.</FeaturedText>
...
- [Ethers — Una libreria Web3 di prima classe per Ethereum in Elixir](https://medium.com/@alisinabh/announcing-ethers-a-first-class-ethereum-web3-library-for-elixir-1d64e9409122)
...
- [Smart contract di Ethereum ed Elixir](https://medium.com/agile-alpha/ethereum-smart-contracts-and-elixir-c7c4b239ddb4)

## Progetti e strumenti in Elixir {#elixir-projects-and-tools}
...
- [ethers](https://github.com/ExWeb3/elixir_ethers) - _Una libreria Web3 completa per interagire con gli smart contract su Ethereum usando Elixir_
...
- [ex_keccak](https://github.com/ExWeb3/ex_keccak) - _Libreria Elixir per calcolare gli hash Keccak SHA3-256 usando un crate Rust tiny-keccak integrato tramite NIF_
...
- [exw3](https://github.com/hswick/exw3) - _Client RPC di Ethereum ad alto livello per Elixir_
...
Il [canale #ethereum sullo Slack di Elixir](https://elixir-lang.slack.com/archives/C5RPZ3RJL) ospita una community in rapida crescita ed è la risorsa dedicata per le discussioni su uno qualsiasi dei progetti sopra citati e sugli argomenti correlati.