...
<FeaturedText>Scopri come sviluppare per Ethereum usando progetti e strumenti basati su Ruby.</FeaturedText>
...
- [ethereum.rb](https://github.com/EthWorks/ethereum.rb) - _Client Ethereum in Ruby che usa l'interfaccia JSON-RPC per inviare transazioni, creare e interagire con i contratti, oltre a un utile toolkit per lavorare con il nodo Ethereum_
