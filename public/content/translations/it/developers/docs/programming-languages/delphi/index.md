...
- [Connettere Delphi alla Mainnet di Ethereum](https://medium.com/@svanas/connecting-delphi-to-the-ethereum-main-net-5faf1feffd83)
- [Connettere Delphi agli smart contract](https://medium.com/@svanas/connecting-delphi-to-smart-contracts-3146b12803a1)

**Vuoi saltare la configurazione per ora e passare direttamente agli esempi?**

- [Uno smart contract in 3 minuti e Delphi - Parte 1](https://medium.com/@svanas/a-3-minute-smart-contract-and-delphi-61d998571d)
- [Uno smart contract in 3 minuti e Delphi - Parte 2](https://medium.com/@svanas/a-3-minute-smart-contract-and-delphi-part-2-446925faa47b)

## Articoli di livello intermedio {#intermediate-articles}

- [Generare una firma di un messaggio firmato da Ethereum in Delphi](https://medium.com/@svanas/generating-an-ethereum-signed-message-signature-in-delphi-75661ce5031b)
...
- [Fare lo swap di un token con un altro in Delphi](https://svanas.medium.com/swap-one-token-for-another-in-delphi-bcb999c47f7)
