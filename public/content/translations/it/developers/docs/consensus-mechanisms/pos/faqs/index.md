...
## Cos'è la proof-of-stake {#what-is-proof-of-stake}
...
## Come si distingue il proof-of-stake dal proof-of-work? Confronto con la proof-of-work {#comparison-to-proof-of-work}
...
## Il proof-of-stake rende Ethereum più economico? La PoS rende Ethereum più economico? {#does-pos-make-ethereum-cheaper}
...
## Cosa sono i nodi, i client e i validatori? Cosa sono nodi, client e validatori? {#what-are-nodes-clients-and-validators}
...
No. Un utente su BitcoinTalk [ha proposto l'idea di base della proof-of-stake](https://bitcointalk.org/index.php?topic=27787.0) come aggiornamento di Bitcoin nel 2011. Erano undici anni prima che fosse pronto all'implementazione sulla Rete Principale di Ethereum. Alcune altre catene hanno implementato il proof-of-stake prima di Ethereum, ma non il meccanismo specifico di Ethereum (noto come Gasper).

## Cosa rende speciale il proof-of-stake di Ethereum? Perché la PoS di Ethereum è speciale? {#why-is-ethereum-pos-special}
...
## Riceverò un taglio? Subirò uno slashing? {#will-i-get-slashed}
...
[Maggiori informazioni sul problema del nothing-at-stake](https://vitalik.eth.limo/general/2017/12/31/pos_faq.html#what-is-the-nothing-at-stake-problem-and-how-can-it-be-fixed)
...
[Maggiori informazioni sulla separazione propositore-costruttore](https://notes.ethereum.org/@fradamt/H1TsYRfJc#Original-basic-scheme)
...
## Ethereum è la sola blockchain di proof-of-stake? Ethereum è l'unica blockchain PoS? {#is-ethereum-the-only-pos-blockchain}
