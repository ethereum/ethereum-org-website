...
description: Scopri gli IDE basati sul Web e desktop per lo sviluppo di Ethereum, inclusi Remix, VS Code e i plugin più diffusi.
lang: it
---
...
**[Remix](https://remix.ethereum.org/)** - **_IDE basato sul web con analisi statica integrata e una macchina virtuale blockchain di prova_**
...
- [Forum di aiuto](https://forum.chainide.com/)

**[Replit (Solidity Starter - Beta)](https://replit.com/@replit/Solidity-starter-beta)** - **_Un ambiente di sviluppo personalizzabile per Ethereum con ricarica rapida, controllo degli errori e supporto di prima classe per la rete di test_**

- [Documentazione](https://docs.replit.com/)

**[Tenderly Sandbox](https://sandbox.tenderly.co/)** - **_Un ambiente di prototipazione veloce in cui puoi scrivere, eseguire ed effettuare il debug di contratti intelligenti nel browser, usando Solidity e JavaScript_**
...
Gli IDE più diffusi hanno plugin integrati che migliorano l'esperienza di sviluppo per Ethereum. Come minimo, forniscono l'evidenziazione della sintassi per i [linguaggi dei contratti intelligenti](/developers/docs/smart-contracts/languages/).
...
**Remix Desktop -** **_Prova Remix IDE sulla tua macchina locale_**

- [Scarica](https://github.com/ethereum/remix-desktop/releases)
...
- [Solidity + Hardhat for VS Code](https://marketplace.visualstudio.com/items?itemName=NomicFoundation.hardhat-solidity) - Supporto per Solidity e Hardhat dal team di Hardhat
...
- [IDE di Ethereum](https://www.alchemy.com/list-of/web3-ides-on-ethereum) _- Elenco di Alchemy degli IDE di Ethereum_
