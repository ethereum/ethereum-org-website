...
_Non ci sono segreti sulla blockchain_. Tutto ciò che viene pubblicato sulla blockchain è aperto alla lettura di tutti. Questo è necessario, perché la blockchain si basa sul fatto che chiunque possa verificarla. Tuttavia, i giochi spesso si basano su uno stato segreto. Ad esempio, il gioco del [campo minato](<https://en.wikipedia.org/wiki/Minesweeper_(video_game)>) non ha assolutamente senso se si può semplicemente andare su un esploratore di blocchi e vedere la mappa.
