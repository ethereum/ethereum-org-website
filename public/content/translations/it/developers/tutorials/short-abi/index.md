...
In generale, la sintassi di un opcode in Yul è `<nome opcode>(<primo valore stack, se presente>,<secondo valore stack, se presente>...)`.
...
Questo ha il vantaggio aggiuntivo di spostare il valore a destra del campo, quindi è il valore stesso invece del valore moltiplicato per 256<sup>qualcosa</sup>.
