...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Possiedi i tuoi asset!** Solo tu puoi venderli o scambiarli.                                                                                                                              | **Noleggi un asset** da un'organizzazione e ti può essere sottratto.                                                                                                                              |
| Gli NFT sono **digitalmente unici**, non esistono due NFT uguali.                                                                                                                           | **Spesso una copia non può essere distinta** dall'originale.                                                                                                                                      |
| La proprietà di un NFT è archiviata sulla blockchain e chiunque può **verificarla pubblicamente**.                                                                                          | L'accesso ai registri di proprietà di oggetti digitali è **controllato da istituzioni**: devi fidarti della loro parola.                                                          |
| Gli NFT sono [contratti intelligenti](/glossary/#smart-contract) su Ethereum. Ciò significa che **possono essere facilmente utilizzati in altri contratti intelligenti** e app su Ethereum! | Le aziende con oggetti digitali di solito **richiedono la propria infrastruttura a "giardino recintato"**.                                                                                        |
| I **creatori di contenuti possono vendere il proprio lavoro ovunque** e possono accedere a un mercato globale.                                                                              | I creatori si affidano all'infrastruttura e alla distribuzione delle piattaforme che utilizzano. Questi sono spesso soggetti a termini di utilizzo e **restrizioni geografiche**. |
| I creatori di NFT **possono mantenere i diritti di proprietà** sul proprio lavoro e programmare le royalty direttamente nel contratto NFT.                                                  | Le piattaforme, come i servizi di **streaming musicale, trattengono la maggior parte dei profitti dalle vendite**.                                                                                |
...
Oppure, prendiamo ad esempio un biglietto per un evento sportivo. Proprio come l'**organizzatore di un evento può scegliere quanti biglietti vendere**, il creatore di un NFT può decidere quante repliche esistano. A volte queste sono repliche esatte, come 5000 biglietti di ingresso generici. Altre volte, ne sono coniati svariati di molto simili, ma ognuno lievemente differente, come un biglietto con un posto assegnato. Questi possono essere acquistati e venduti tra pari senza pagare i gestori dei biglietti e l'acquirente ha sempre la certezza dell'autenticità del biglietto controllando l'indirizzo del contratto.

Su ethereum.org, gli **NFT sono usati per dimostrare che le persone hanno contribuito in modo significativo** al nostro repository di Github (programmato il sito, scritto o modificato un articolo...), tradotto i nostri contenuti, o partecipato alle nostre call con la community, e abbiamo persino il nostro nome di dominio NFT. Se contribuisci a ethereum.org, puoi richiedere un NFT [POAP](/glossary/#poap). Alcuni incontri nel mondo delle criptovalute hanno usato i POAP come biglietti. [Maggiori informazioni su come contribuire](/contributing/#poap).

![POAP di ethereum.org](./poap.png)

Questo sito web ha anche un nome di dominio alternativo basato su NFT, **ethereum.eth**. Il nostro indirizzo `.org` è gestito centralmente da un provider del sistema dei nomi di dominio (DNS), mentre ethereum`.eth` è registrato su Ethereum tramite il Servizio del Nome di Ethereum (ENS). Ed è posseduto e gestito da noi. [Controlla il nostro record ENS](https://app.ens.domains/name/ethereum.eth)
...
Inoltre, il creatore del contratto può aggiungere regole aggiuntive. Potrebbero limitare il numero di un certo NFT che può essere creato o decidere di ottenere una piccola commissione di royalty ogni volta che l'NFT cambia di mano.

### Sicurezza degli NFT {#nft-security}

La sicurezza di Ethereum deriva dalla [proof-of-stake](/glossary/#pos). Il sistema è progettato per disincentivare economicamente le azioni malevole, rendendo Ethereum a prova di manomissione. Questo è ciò che rende possibili gli NFT. Una volta che il [blocco](/glossary/#block) contenente la tua transazione NFT diventa [finalizzato](/glossary/#finality), costerebbe a un utente malintenzionato milioni di ETH per modificarlo. Chiunque esegua il software di Ethereum potrebbe immediatamente rilevare la manomissione malevola di un NFT, e l'utente malevolo sarebbe penalizzato economicamente ed espulso.
...
- [Guida per principianti agli NFT](https://linda.mirror.xyz/df649d61efb92c910464a4e74ae213c4cab150b9cbcc4b7fb6090fc77881a95d) – _Linda Xie, gennaio 2020_
