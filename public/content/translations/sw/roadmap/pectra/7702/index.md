...
Aina hii mpya ya muamala inaleta orodha ya uidhinishaji. Kila tuple ya uidhinishaji katika orodha inafafanuliwa kama

```
[ chain_id, address, nonce, y_parity, r, s ]
```

**address** ni ukaimishaji (msimbo wa baiti ambao tayari umesambazwa utakaotumiwa na EOA)
...
(**y_parity, r, s**) ni sahihi ya tuple ya uidhinishaji, inayofafanuliwa kama keccak(0x05 || rlp ([chain_id ,address, nonce])) na ufunguo wa siri wa EOA ambayo uidhinishaji unatumika (pia inaitwa mamlaka)
...
**Muundo Bila Ruhusa na Unaostahimili Udhibiti**: Ethereum inathamini ushiriki bila ruhusa. Mkataba wa ukaimishaji LAZIMA USIWEKE msimbo mgumu au kutegemea mpeleka-taarifa au huduma yoyote "inayoaminika" pekee. Hii itaharibu akaunti ikiwa mpeleka-taarifa atatoka mtandaoni. Vipengele kama vile ukusanyaji wa mafungu (k.m., idhinisha+transferFrom) vinaweza kutumiwa na EOA yenyewe bila mpeleka-taarifa. Kwa wasanidi wa programu wanaotaka kutumia vipengele vya hali ya juu vinavyowezeshwa na EIP-7702 (Udhanifu wa Gesi, Utoaji Unaohifadhi Faragha) utahitaji mpeleka-taarifa. Ingawa kuna usanifu tofauti wa wapeleka-taarifa, pendekezo letu ni kutumia [vifungashaji vya ERC-4337](https://www.erc4337.io/bundlers) vinavyoelekeza angalau kwenye [entry point 0.8](https://github.com/eth-infinitism/account-abstraction/releases/tag/v0.8.0) kwa sababu:
...
- Vinaweza kuhitaji kitendakazi cha init kiitwe pekee kutoka kwenye [EntryPoint](https://github.com/eth-infinitism/account-abstraction/releases/tag/v0.8.0)
...
Kwa kuwa mikoba itaidhinisha mikataba maalum ya ukaimishaji kwa EIP-7702, dapps hazipaswi kutarajia kuomba uidhinishaji wa EIP-7702 moja kwa moja. Badala yake, ujumuishaji unapaswa kutokea kupitia miingiliano sanifu ya mkoba:
...
- **ERC-6900**: Inaruhusu dapps kutumia uwezo wa akaunti janja za kawaida, kama vile funguo za kipindi na urejeshaji wa akaunti, kupitia moduli zinazosimamiwa na mkoba.
...
> Kumbuka: Hakuna mbinu sanifu kwa dapps kuomba sahihi za uidhinishaji za EIP-7702 moja kwa moja. Dapps lazima zitegemee miingiliano maalum ya mkoba kama ERC-6900 ili kunufaika na vipengele vya EIP-7702.
...
**Uhifadhi wa Faragha**: Ingawa faragha mnyororoni ni ndogo, mkataba wa ukaimishaji unapaswa kujitahidi kupunguza ufichuaji wa data na uwezekano wa kuunganishwa. Hili linaweza kufikiwa kwa kusaidia vipengele kama vile malipo ya gesi katika tokeni za ERC-20 (ili watumiaji wasihitaji kudumisha salio la umma la ETH, ambalo linaboresha faragha na uzoefu wa mtumiaji) na funguo za kipindi cha mara moja (ambazo zinapunguza utegemezi kwenye ufunguo mmoja wa muda mrefu). Kwa mfano, EIP-7702 inawezesha kulipa gesi kwa tokeni kupitia miamala iliyofadhiliwa, na utekelezaji mzuri utarahisisha kujumuisha walipiaji kama hao bila kuvujisha taarifa zaidi kuliko inavyohitajika. Zaidi ya hayo, ukaimishaji nje ya mnyororo wa idhini fulani (kwa kutumia sahihi zinazothibitishwa mnyororoni) unamaanisha miamala michache mnyororoni na ufunguo wa msingi wa mtumiaji, kusaidia faragha. Akaunti zinazohitaji kutumia mpeleka-taarifa zinalazimisha watumiaji kufichua anwani zao za IP. Mempool za Umma zinaboresha hili, wakati muamala/Operesheni ya Mtumiaji inaposambaa kupitia mempool huwezi kujua kama ilitoka kwenye IP iliyoituma, au ilipitishwa tu kupitia hiyo kupitia itifaki ya p2p.

**Upanuzi na Usalama wa Moduli**: Utekelezaji wa akaunti unapaswa kupanuka ili uweze kubadilika na vipengele vipya na maboresho ya usalama. Uwezo wa kuboresha unawezekana kiasili na EIP-7702 (kwa kuwa EOA inaweza kukaimisha kwenye mkataba mpya siku zijazo ili kuboresha mantiki yake). Zaidi ya uwezo wa kuboresha, muundo mzuri unaruhusu moduli – k.m., moduli za kuingiza kwa mipango tofauti ya sahihi au sera za matumizi – bila kuhitaji kusambaza upya kabisa. Zana ya Akaunti ya Alchemy ni mfano mzuri, inayoruhusu wasanidi programu kusakinisha moduli za uthibitishaji (kwa aina tofauti za sahihi kama ECDSA, BLS, n.k.) na moduli za utekelezaji kwa mantiki maalum. Ili kufikia unyumbufu na usalama zaidi katika akaunti zinazowezeshwa na EIP-7702, wasanidi programu wanahimizwa kukaimisha kwenye mkataba wa uwakilishi badala ya moja kwa moja kwenye utekelezaji maalum. Mbinu hii inaruhusu uboreshaji usio na mshono na moduli bila kuhitaji uidhinishaji wa ziada wa EIP-7702 kwa kila mabadiliko.
...
Kwa mfano, [SafeEIP7702Proxy](https://docs.safe.global/advanced/eip-7702/7702-safe) inaonyesha jinsi uwakilishi unavyoweza kutumiwa kuanzisha na kusimamia ukaimishaji kwa usalama katika akaunti zinazoendana na EIP-7702.

Hasara za Muundo wa Uwakilishi:

- **Kutegemea wahusika wa nje**: Inabidi utegemee timu ya nje kutoboresha kwenye mkataba usio salama.
