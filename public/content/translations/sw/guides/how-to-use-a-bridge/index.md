...
Unaweza kujifunza zaidi kuhusu miradi tofauti na viungo muhimu kwenye [ukurasa wetu wa tabaka la 2 (l2)](/layer-2/).

## 2. Nenda kwenye daraja lililochaguliwa {#2-go-to-the-selected-bridge}

Baadhi ya matabaka ya 2 (l2) maarufu ni:
...
- [Daraja la mtandao wa Boba](https://hub.boba.network/)
...
## 4. Taja kiasi na uhamishe fedha {#4-specify-the-amount-and-move-the-funds}

Kagua kiasi ambacho utapata kama mrejesho kwenye mtandao wa tabaka la 2 (l2) na ada ili kuepuka mshangao usiofurahisha.
...
## 6. Subiri fedha zako zihamishwe {#6-wait-for-your-funds-to-be-moved}

Mchakato huu haupaswi kuchukua zaidi ya dakika 10.

## 7. Ongeza mtandao wa tabaka la 2 (l2) uliochaguliwa kwenye mkoba wako (si lazima) {#7-add-the-selected-layer-2-network-to-your-wallet-optional}

Unaweza kutumia [chainlist.org](https://chainlist.org) kupata maelezo ya RPC ya mtandao. Mara tu mtandao unapoongezwa na muamala kukamilika, unapaswa kuona tokeni kwenye mkoba wako.
<br />
...
### Vipi ikiwa nina fedha kwenye soko la kubadilishia fedha? {#what-if-i-have-funds-on-an-exchange}
