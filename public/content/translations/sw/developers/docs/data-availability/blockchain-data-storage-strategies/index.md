...
Kuanzia na [hardfork ya Dencun](https://github.com/ethereum/consensus-specs/blob/master/specs/deneb/beacon-chain.md) mnyororo wa bloku wa Ethereum unajumuisha [EIP-4844](https://eips.ethereum.org/EIPS/eip-4844), ambayo inaongeza blobu za data kwenye Ethereum zenye muda mfupi wa kuishi (awali takriban [siku 18](https://github.com/ethereum/consensus-specs/blob/master/specs/deneb/p2p-interface.md#configuration)). Blobu hizi huwekewa bei tofauti na [gesi ya utekelezaji](/developers/docs/gas), ingawa kwa kutumia mfumo unaofanana. Ni njia rahisi ya kuchapisha data ya muda.
...
| ------------------------ | ------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------ | ------------------------------------------------------------------------- |
| Blobu za EIP-4844        | Offchain            | Dhamana ya Ethereum kwa [~siku 18](https://github.com/ethereum/consensus-specs/blob/master/specs/deneb/p2p-interface.md#configuration) | Hashi pekee ndiyo inapatikana                                      |                                                                           |
