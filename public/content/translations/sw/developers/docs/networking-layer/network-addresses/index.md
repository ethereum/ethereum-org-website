...
Enode ni njia ya kutambua nodi ya Ethereum kwa kutumia muundo wa anwani ya URL. Kitambulisho cha nodi cha heksadesimali kimesimbwa katika sehemu ya jina la mtumiaji la URL kikitenganishwa na mwenyeji kwa kutumia alama ya @. Uainishaji unafafanua tu jina la mwenyeji kama anwani ya IP; hata hivyo, wateja wengi (kama vile Geth na Besu) pia wanakubali jina la DNS hapa na kulitatua kuwa anwani ya IP wakati wa kuanza. Hii ni tabia mahususi kwa mteja badala ya kuwa sehemu ya kiwango. Lango katika sehemu ya jina la mwenyeji ni lango la kusikiliza la TCP. Ikiwa malango ya TCP na UDP (ugunduzi) yanatofautiana, lango la UDP hubainishwa kama kigezo cha hoja "discport".
