---
title: Ukaimishaji wa uwekaji dhamana (kuweka hisa kama huduma)
description: Muhtasari wa jinsi ya kuanza na ukaimishaji wa uwekaji dhamana
lang: sw
template: staking
...
Ikiwa una 32 ETH za kuweka dhamana, lakini hujisikii vizuri kushughulika na maunzi, huduma za ukaimishaji wa uwekaji dhamana zinakuruhusu kukabidhi upande wa kiufundi huku ukipata zawadi za asili za kitalu cha Ethereum.

<Grid>
  <Card title="Your own validator" icon={<MonitorCheck />} description="Weka 32 ETH zako mwenyewe ili kuwezesha seti yako ya funguo za kusaini ambazo zitashiriki katika mwafaka wa Ethereum. Fuatilia maendeleo yako ukitumia dashibodi ili kutazama zawadi hizo za ETH zikijilimbikiza." />
  <Card title="Easy to start" icon={<Flag />} description="Sahau kuhusu vipimo vya maunzi, usanidi, matengenezo ya nodi na uboreshaji. Watoa huduma wanakuruhusu kutoa sehemu ngumu kwa kupakia vitambulisho vyako vya kusaini, na kuwaruhusu kuendesha mthibitishaji kwa niaba yako, kwa gharama ndogo." />
  <Card title="Limit your risk" icon={<ShieldHalf />} description="Ukiwa na huduma zisizo za udhamini unadhibiti funguo zinazowezesha utoaji au hamisho la fedha zilizowekwa dhamana. Hizi ni tofauti na funguo za kusaini, na zinaweza kuhifadhiwa kando ili kupunguza (lakini sio kuondoa) hatari yako kama mweka dhamana." />
</Grid>
...
## Wigo wa ukaimishaji {#the-delegation-spectrum}

Watoa huduma hutofautiana katika funguo wanazokushikilia, na kila ufunguo wanaoshikilia ni kitu ambacho lazima uwaamini nacho.
...
_Vitambulisho vya uondoaji_ vya mthibitishaji hubaki vikielekezwa kwenye anwani unayoidhibiti. Zawadi na fedha zilizotolewa zinaweza tu kwenda huko (tazama sehemu ya muundo wa uaminifu hapa chini).
...
- Kiasi kikubwa cha ETH kilichowekwa dhamana chini ya waendeshaji wachache wa kubadilishana huchangia katika uwekaji dhamana wa kati, na chaguzi za wateja za waendeshaji hawa huathiri afya ya mtandao. Kuweka dhamana kwa njia inayoweka udhibiti zaidi mikononi mwako, au kuchagua watoa huduma ambao kwa dhahiri wanaendesha wateja wachache, hufanya mengi zaidi kwa uthabiti wa Ethereum.
...
- **Muundo wa ada ukoje?** Huduma hutoza ada ya kila mwezi au asilimia ya zawadi. Angalia jinsi ada zinavyoingiliana na wakati wa kupumzika na adhabu: nani anabeba gharama ikiwa mwendeshaji hafanyi vizuri, na ikiwa dhamana au bima yoyote inatolewa.
- **Mwendeshaji anaendesha wateja gani?** Mwendeshaji anayeendesha wengi wa [wateja wa utekelezaji au wateja wa mwafaka](/developers/docs/nodes-and-clients/client-diversity/) huweka dhamana yako na mtandao kwenye hatari ya kushindwa kwa uhusiano ikiwa mteja huyo ana hitilafu. Pendelea watoa huduma wanaoandika matumizi ya wateja wachache.
- **Je, huduma iko wazi na imekaguliwa?** Watoa huduma wanaweza kuendesha programu ya ziada karibu na wateja wa kawaida wa Ethereum ambayo sio chanzo wazi au inayoweza kukaguliwa. Tafuta ukaguzi wa umma, historia iliyoanzishwa ya uendeshaji, na rekodi safi ya ukataji.
...
<AlertContent>
<AlertDescription>
**Baadhi ya watoa huduma wanaweza kuendesha mthibitishaji wako kwa kutumia teknolojia ya kithibitishaji kilichosambazwa (DVT)**, wakigawanya ufunguo wa kusaini kwenye nodi nyingi ili hakuna mashine au mwendeshaji mmoja aliye hatua ya kushindwa. [Zaidi kuhusu teknolojia ya kithibitishaji kilichosambazwa (DVT)](/staking/dvt/)
</AlertDescription>
</AlertContent>
</Alert>
...
## Gundua watoa huduma za uwekaji dhamana {#saas-providers}

Hapa chini kuna baadhi ya watoa huduma za kuweka hisa kama huduma wanaopatikana. Tumia viashiria vilivyo hapo juu kukusaidia kukuongoza kupitia huduma hizi.
...
Ndiyo. Kila mthibitishaji ana funguo za _kusaini_ na _vitambulisho vya uondoaji_ tofauti. Ili mthibitishaji athibitishe hali ya mnyororo, ashiriki katika kamati za usawazishaji na kupendekeza vitalu, funguo za kusaini lazima zipatikane kwa urahisi na kiteja cha mthibitishaji. Hizi lazima ziunganishwe kwenye mtandao kwa namna fulani, na hivyo kwa asili huchukuliwa kuwa funguo "moto". Funguo zinazodhibiti fedha zilizotolewa huwekwa kando kwa sababu za kiusalama.

Vitambulisho vya uondoaji huteua anwani ya tabaka la utekelezaji ambayo zawadi za uwekaji dhamana na fedha zilizotolewa huenda. Zana za kisasa za uwekaji zinakuruhusu kuweka anwani hii wakati wa kuweka, kama kitambulisho cha kawaida (0x01) au cha kujumuisha (0x02), na inapaswa kuwa anwani unayoidhibiti, hasa iliyolindwa katika hifadhi baridi. Hii inalinda fedha zako hata kama mtu mwingine anadhibiti funguo zako za kusaini za mthibitishaji, na tangu uboreshaji wa Pectra pia inakuruhusu kujitoa kwenye mthibitishaji moja kwa moja kutoka kwenye anwani hiyo.

Wathibitishaji waliowekwa katika siku za mwanzo za mtandao bila anwani ya utoaji wa utekelezaji hutumia funguo za utoaji za BLS za zamani, na lazima wasaini ujumbe wa mara moja unaotangaza anwani ya utoaji kabla ya utoaji kuanza. Hii inahusisha kuzalisha upya funguo za utoaji kutoka kwenye kirai cha mbegu cha mnemonic kilichoundwa wakati wa usanidi.

**Hakikisha unahifadhi nakala ya kirai cha mbegu hiki kwa usalama au hutaweza kuzalisha funguo zako za utoaji wakati utakapofika.**

Wasiliana na mtoa huduma wako kwa usaidizi kuhusu jinsi ya kuandaa mthibitishaji wako.
</ExpandableCard>

<ExpandableCard title="Ninaweza kutoa lini?" eventCategory="SaasStaking" eventName="clicked when can I withdraw">
Jinsi utoaji unavyofanya kazi inategemea aina ya kitambulisho cha uondoaji cha mthibitishaji wako. Kwa wathibitishaji wa kawaida (0x01), salio lolote zaidi ya 32 ETH hufagiliwa kiotomatiki kwenye anwani ya utoaji mara kwa mara kila baada ya siku chache. Kwa wathibitishaji wanaojumuisha (0x02), zawadi hujumuishwa kwenye salio la mthibitishaji hadi 2048 ETH, na kutoa chini ya hapo kunahitaji kuanzisha utoaji wa kiasi kutoka kwenye anwani yako ya utoaji, ambayo inagharimu gesi.
...
Ikiwa mtoa huduma anashikilia vitambulisho vya uondoaji (kama ilivyo kwa uwekaji dhamana wa udhamini na kubadilishana), hakuna njia ya kiwango cha itifaki kwako kurejesha fedha kwa kujitegemea; suluhisho lako ni mdogo kwa michakato ya mtoa huduma mwenyewe.
</ExpandableCard>
...
Kwa kutumia mtoa huduma wa uwekaji dhamana aliyekaimishwa, unakabidhi uendeshaji wa nodi yako kwa mtu mwingine. Hii inakuja na hatari ya utendaji duni wa nodi, ambayo haiko chini ya udhibiti wako. Katika tukio ambalo mthibitishaji wako amekatwa, adhabu ya awali kulingana na salio la mthibitishaji wako inatumika (iliyofanywa kuwa ndogo sana katika uboreshaji wa Pectra), na mthibitishaji wako anatolewa kwa nguvu kutoka kwenye seti ya wathibitishaji.
