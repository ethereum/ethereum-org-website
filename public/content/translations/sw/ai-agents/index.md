...
summaryPoints:
  ...
  - "Inadhibiti mikoba na fedha mnyororoni"
  - "Huajiri binadamu au ajenti wengine kwa kazi"
buttons:
...
Ajenti wa akili bandia ni programu za kompyuta zinazotumia akili bandia kufanya kazi au kufanya maamuzi yao wenyewe. Wanajifunza kutokana na data, kukabiliana na mabadiliko, na kushughulikia kazi ngumu. Wanafanya kazi bila kusimama na wanaweza kugundua fursa papo hapo.

### Jinsi ajenti wa akili bandia wanavyofanya kazi na minyororo ya vitalu {#how-ai-agents-work-with-blockchains}
...
- <strong>Utendaji thabiti mnyororoni:</strong> Huwawezesha Ajenti wa Akili Bandia kutekeleza miamala, kuingiliana na mikataba mahiri, kutoa ukwasi, na kushirikiana katika itifaki mbalimbali.

Mambo haya yanabadilisha ajenti wa akili bandia kutoka boti rahisi kuwa mifumo inayobadilika, inayojiboresha yenyewe ambayo inatoa thamani kubwa katika sekta nyingi:

<Grid>
  <Card title="DeFi Inayojiendesha" emoji=":money_with_wings:" description="Maajenti wa akili bandia hufuatilia kwa karibu mienendo ya soko, hutekeleza biashara, na kusimamia potifolio — na kufanya ulimwengu tata wa DeFi kufikika kwa urahisi zaidi."/>
  <Card title="Uchumi mpya wa ajenti wa akili bandia" emoji="🌎" description="Maajenti wa akili bandia wanaweza kuajiri maajenti wengine (au binadamu) wenye ujuzi tofauti ili kuwafanyia kazi maalum." />
  <Card title="Usimamizi wa hatari" emoji="🛠️" description="Kwa kufuatilia shughuli za miamala, maajenti wa akili bandia wanaweza kusaidia kugundua utapeli na kulinda mali zako za kidijitali vizuri na haraka zaidi." />
</Grid>
...
- **Kutobadilika mnyororoni** kunahakikisha uthibitisho huu unaweza kurejelewa, kurudiwa, na kuaminiwa na mkataba au ajenti yeyote
...
Vidhibiti hivi vinawezesha usambazaji wa ajenti wanaojitegemea ambao wana mipaka maalum.
...
- **Sajili ya utambulisho** kwa ajili ya vitambulisho vya ajenti vinavyobebeka, vinavyostahimili udhibiti
- **Sajili ya sifa** kwa ajili ya ishara za maoni zilizosanifiwa katika programu zote
- **Sajili ya uthibitishaji** kwa ajili ya kuomba uthibitishaji wa kujitegemea (zkML, TEE, utekelezaji upya uliowekewa dhamana)
...
<strong>Kuonekana kwa kwanza kwa Luna kama mgeni wa podikasti</strong>

<VideoWatch slug="ai-agents-interview-luna" />

## Mikoba inayodhibitiwa na ajenti {#agent-controlled-wallets}

Ajenti kama Luna au AIXBT wanadhibiti mkoba wao wenyewe mnyororoni ([mkoba wa AIXBT](https://clusters.xyz/aixbt), [mkoba wa Luna](https://zapper.xyz/account/0x0d177181e3763b20d47dc3a72dd584368bd8bf43)) unaowawezesha kuwatuza mashabiki na kushiriki katika shughuli za kiuchumi.

Wakati wa kampeni ya kijamii ya X ya Luna #LunaMuralChallenge, Luna alichagua na kuwatuza washindi kupitia mkoba wake wa Base — ikiashiria <strong>tukio la kwanza la akili bandia kuajiri binadamu kwa ajili ya tuzo ya kripto</strong>.
...
## Dhibiti mkoba wako kwa kutumia amri za soga {#control-your-wallet-using-chat-commands}

Unaweza kuruka miingiliano tata ya fedha zilizogatuliwa (DeFi) na kusimamia kripto yako kwa amri rahisi za soga.

Mbinu hii angavu inafanya miamala kuwa ya haraka, rahisi, na isiyokabiliwa na makosa kama vile kutuma fedha kwenye anwani isiyo sahihi au kulipa ada kupita kiasi.

<AiAgentProductLists list="chat" />

## Ajenti wa akili bandia dhidi ya boti za akili bandia {#ai-agents-vs-ai-bots}

Tofauti kati ya ajenti wa akili bandia na boti za akili bandia wakati mwingine inaweza kuchanganya, kwani zote mbili hufanya vitendo vya kiotomatiki kulingana na data inayoingia.

- Boti za akili bandia ni kama wasaidizi wa kiotomatiki — Zinafuata maagizo maalum, yaliyopangwa mapema ili kufanya kazi za kawaida.
- Ajenti wa akili bandia ni zaidi kama masahaba wenye akili — Wanajifunza kutokana na uzoefu, kukabiliana na taarifa mpya, na kufanya maamuzi wao wenyewe.

|                     | Ajenti wa akili bandia                                                              | Boti za akili bandia                                     |
| ------------------- | ---------------------------------------------------------------------- | ------------------------------------------- |
| **Mwingiliano**    | Mgumu, unaobadilika, unaojitegemea                                         | Rahisi, upeo uliobainishwa mapema, uliowekwa kwa msimbo        |
| **Kujifunza**        | Hujifunza mfululizo, inaweza kufanya majaribio na kukabiliana na data mpya kwa wakati halisi | Hufanya kazi kwenye data iliyofunzwa mapema au sheria zisizobadilika |
| **Kukamilisha kazi** | Inalenga kufikia malengo mapana zaidi                                     | Inalenga kazi maalum pekee              |

## Ingia kwa undani {#dive-deeper}

<AiAgentProductLists list="dive-deeper" />

## Unaweza kuunda ajenti wako mwenyewe wa akili bandia {#you-can-build-your-own-ai-agent}
