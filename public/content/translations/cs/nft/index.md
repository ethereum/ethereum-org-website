...
summaryPoints:
  ...
  - "Poháněno chytrými kontrakty na blockchainu Etherea."
---
...
### Srovnání {#nft-comparison}

| Internet s NFT                                                                                                         | Dnešní internet                                                                                                                                     |
| ----------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Vlastníte svá aktiva!** Pouze vy je můžete prodat nebo swapovat.                                                                    | **Aktivum si pronajímáte** od nějaké organizace a může vám být odebráno.                                                                            |
| NFT jsou **digitálně jedinečná**, žádná dvě NFT nejsou stejná.                                                                    | **Kopii často nelze rozeznat** od originálu.                                                                                   |
| Vlastnictví NFT je uloženo na blockchainu, aby si ho mohl kdokoli **veřejně ověřit**.                                                   | Přístup k záznamům o vlastnictví digitálních položek je **kontrolován institucemi** – musíte jim věřit na slovo.                                 |
| NFT jsou [chytré kontrakty](/glossary/#smart-contract) na Ethereu. To znamená, že je **lze snadno použít v jiných chytrých kontraktech** a aplikacích na Ethereu! | Společnosti s digitálními položkami obvykle **vyžadují vlastní uzavřenou infrastrukturu**.                                                                 |
| **Tvůrci obsahu mohou prodávat svá díla kdekoli** a mají přístup na globální trh.                                           | Tvůrci spoléhají na infrastrukturu a distribuci platforem, které používají. Ty často podléhají podmínkám použití a **geografickým omezením**. |
| Tvůrci NFT si **mohou ponechat vlastnická práva** ke svému vlastnímu dílu a naprogramovat licenční poplatky přímo do kontraktu NFT.     | Platformy, jako jsou hudební **streamovací služby, si ponechávají většinu zisků z prodeje**.                                                                |

## K čemu se NFT používají? {#nft-use-cases}

NFT se používají k mnoha věcem, včetně:

- prokázání účasti na události
- potvrzení o absolvování kurzu
- vlastnitelné předměty do her
- digitální umění
- tokenizace [aktiv reálného světa](/real-world-assets/)
- prokázání vaší online identity
- omezení přístupu k obsahu
- prodej vstupenek
- decentralizovaná internetová doménová jména
- zajištění v [decentralizovaných financích (DeFi)](/glossary/#defi)

Možná jste umělec, který chce sdílet své dílo pomocí NFT, aniž by ztratil kontrolu a obětoval své zisky zprostředkovatelům. Můžete vytvořit nový kontrakt a specifikovat počet NFT, jejich vlastnosti a odkaz na nějaké konkrétní umělecké dílo. Jako umělec **můžete do chytrého kontraktu naprogramovat licenční poplatky**, které by vám měly být vyplaceny (např. převod 5 % z prodejní ceny majiteli kontraktu při každém převodu NFT). Můžete také vždy dokázat, že jste NFT vytvořili, protože vlastníte [peněženku](/glossary/#wallet), která kontrakt nasadila. Vaši kupující mohou snadno dokázat, že vlastní **autentické NFT** z vaší sbírky, protože jejich [adresa](/glossary/#address) peněženky je spojena s tokenem ve vašem chytrém kontraktu. Mohou jej používat napříč ekosystémem Etherea s jistotou jeho pravosti.

<Alert variant="update">
<AlertEmoji text=":eyes:"/>
<AlertContent className="justify-between flex-row items-center">
  <div>Prozkoumejte, kupte nebo vytvořte své vlastní NFT umění/sběratelské předměty...</div>
...
## Jak NFT fungují? {#how-nfts-work}

NFT, stejně jako jakékoli digitální položky na blockchainu Etherea, jsou vytvářeny prostřednictvím speciálního počítačového programu založeného na Ethereu, který se nazývá „chytrý kontrakt“. Tyto kontrakty se řídí určitými pravidly, jako jsou standardy [ERC-721](/glossary/#erc-721) nebo [ERC-1155](/glossary/#erc-1155), které určují, co kontrakt může dělat.

Chytrý kontrakt NFT umí několik klíčových věcí:

- **Vytvářet NFT:** Může vytvářet nová NFT.
- **Přiřazovat vlastnictví:** Udržuje přehled o tom, kdo vlastní jaká NFT, tím, že je propojuje s konkrétními adresami na Ethereu.
- **Dát každému NFT ID:** Každé NFT má číslo, které ho činí jedinečným. Navíc jsou k němu obvykle připojeny nějaké informace (metadata), které popisují, co NFT představuje.

Když někdo „vytvoří“ nebo „vyrazí“ (mintuje) NFT, v podstatě říká chytrému kontraktu, aby mu dal vlastnictví konkrétního NFT. Tyto informace jsou bezpečně a veřejně uloženy na blockchainu.

Kromě toho může tvůrce kontraktu přidat další pravidla. Může omezit, kolik určitých NFT lze vytvořit, nebo rozhodnout, že by měl dostat malý licenční poplatek, kdykoli NFT změní majitele.
