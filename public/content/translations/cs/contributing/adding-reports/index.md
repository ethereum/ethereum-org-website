...
- **Podstatný obsah o Ethereu** - Zpráva musí podstatně pojednávat o technologii Etherea, ekonomice, bezpečnosti, správě nebo ekosystému, případně pokrývat širší politické, regulační a finanční prostředí ve vztahu k Ethereu. Letmá zmínka o Ethereu v širší krypto zprávě nestačí.
- **Důvěryhodný zdroj** - Upřednostňují se zprávy ze zdrojů s prokazatelnými zkušenostmi ve výzkumu. Patří sem akademické instituce, výzkumné firmy, průmyslové skupiny, nadace a zavedené vývojářské organizace. Pokud je vydavatel méně známý, uveďte v popisu vašeho PR kontext vysvětlující jeho důvěryhodnost a odbornost.
- **Veřejně přístupné** - Zpráva musí být volně přístupná bez paywallu. Zprávy v PDF za registračními branami nejsou přijímány.
- **Přesné informace** - Technická a datová tvrzení by měla být ověřitelná. Zprávy obsahující prokazatelné faktické chyby nebo názory nebudou zařazeny.

#### Výhodou {#nice-to-haves}

- **Aktuálnost** - Upřednostňují se novější zprávy. Zprávy starší než 2 roky pravděpodobně nebudou přidány, pokud nemají historický význam.
- **Původní výzkum** - Zprávy obsahující původní data, analýzy nebo modelování mají přednost před shrnutími stávajících veřejných informací.
