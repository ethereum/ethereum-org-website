...
<CardContainer>
  <EmojiCard
    ...
    title="Překládejte ethereum.org"
    description="Překládejte obsah ethereum.org do svého jazyka a pomozte více lidem seznámit se s Ethereem."
  />
  <EmojiCard
    emoji=':trophy:'
    title="Vyhrajte ceny"
    description="Vyhrajte podíl na odměnách na základě své pozice v žebříčku."
  />
  <EmojiCard
    emoji=':bulb:'
    title="Poznejte Ethereum"
    description="Poznávejte Ethereum, zatímco překládáte a soutěžíte o ceny."
  />
</CardContainer>
...
![Obrázek komunity a zeměkoule](./participate.png)

<TwoColumnContent>
  <CardContent>
    <h3 className="mt-6 mb-3">Kdo se může zúčastnit?</h3>
    Každý, komu je více než 18 let, je rodilým mluvčím alespoň jednoho jiného jazyka než angličtiny a ovládá angličtinu.
  </CardContent>
  <CardContent>
    <h3 className="mt-6 mb-3">Musím být překladatel?</h3>
...
<TwoColumnContent>
  <CardContent>
  <h3 className="mt-6 mb-3">Kolik času musím věnovat?</h3>
  ...
  <CardContent>
    <h3 className="mt-6 mb-3">Musím se vyznat v Ethereu?</h3>
