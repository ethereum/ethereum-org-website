...
- [Přidat produkt](/contributing/adding-products/) – Přidejte decentralizovanou aplikaci (dapp) nebo peněženku na příslušnou stránku
- [Přidat vývojářské nástroje](/contributing/adding-developer-tools/) – Přidejte vývojářský nástroj na příslušnou stránku
- [Přidat vrstvu 2 (l2)](/contributing/adding-layer-2s/) – Přidejte vrstvu 2 (l2) na příslušnou stránku
- [Přidat stakingový produkt nebo službu](/contributing/adding-staking-products/) – Přidejte projekt, který usnadňuje sólo staking, společný staking nebo staking jako službu
- [Přidat peněženku](/contributing/adding-wallets/) – Přidejte peněženku na stránku [najít peněženky](/wallets/find-wallet/)
...
K nárokování OAT byste měli používat pouze peněženky s vlastní správou. Nepoužívejte účty na burzách ani jiné účty, ke kterým nevlastníte soukromé klíče, protože vám neumožní přístup k vašim OAT a jejich správu.

## Nárokujte si svůj GitPOAP {#claim-gitpoap}

GitPOAP také automaticky rozpozná váš sloučený příspěvek a umožní vám vyrazit si samostatný unikátní POAP pro přispěvatele přímo na jejich platformě!
