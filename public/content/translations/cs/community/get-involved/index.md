...
description: Jak se zapojit do komunity Etherea.
lang: cs
---
...
Pokud nejste vývojář, může být těžké zjistit, kde v Ethereu začít. Zde je několik návrhů spolu se zdroji pro konkrétní profesní zaměření.

### Uspořádejte setkání (meetup) ve svém městě {#meetups}
...
- ethereum.org udržuje překladatelský program, který překládá webové stránky a další zdroje do mnoha různých jazyků
...
### Podpořte projekty {#support-projects}
...
„DAO“ jsou decentralizované autonomní organizace. Tyto skupiny využívají technologii Etherea k usnadnění organizace a spolupráce. Například pro kontrolu členství, hlasování o návrzích nebo správu sdružených aktiv. Ačkoli jsou DAO stále experimentální, nabízejí vám příležitosti najít skupiny, se kterými se ztotožňujete, najít spolupracovníky a zvýšit svůj vliv na komunitu Etherea. [Více o DAO](/dao/)

- [DAOSquare](https://daosquare.io/) [@DAOSquare](https://twitter.com/DAOSquare) – _Propagace konceptu DAO v netechnických oborech a pomoc lidem vytvářet hodnotu prostřednictvím DAO_
...
- [dOrg](https://dOrg.tech) [@dOrg_tech](https://twitter.com/dOrg_tech) – _Kolektiv nezávislých vývojářů Web3 fungující jako DAO_
...
- [MetaCartel Ventures](https://metacartel.xyz) [@VENTURE_DAO](https://twitter.com/VENTURE_DAO) – _Rizikový kapitál pro krypto projekty v rané fázi (pre-seed)_
