...
Většina zavedených IDE má vytvořené pluginy pro vylepšení zážitku z vývoje na Ethereu. Přinejmenším poskytují zvýrazňování syntaxe pro [jazyky chytrých kontraktů](/developers/docs/smart-contracts/languages/).
...
**JetBrains IDE (IntelliJ IDEA atd.) -** **_Nezbytné nástroje pro vývojáře softwaru a týmy_**
