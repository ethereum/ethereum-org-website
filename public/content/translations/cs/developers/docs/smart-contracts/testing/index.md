...
##### 1. Porozumějte obchodní logice a pracovnímu postupu vašeho kontraktu {#integration-testing-for-smart-contracts}
...
##### 2. Vyhodnoťte všechny předpoklady související s prováděním kontraktu {#property-based-testing-for-smart-contracts}
...
##### 3. Měřte pokrytí kódu {#static-analysis}
...
##### 4. Používejte dobře vyvinuté testovací frameworky {#dynamic-analysis}
...
### Integrační testování {#running-property-based-tests}
...
### Testování založené na vlastnostech (Property-based testing) {#manual-testing-for-smart-contracts}
...
#### Statická analýza {#testing-on-local-blockchain}
...
#### Dynamická analýza {#testing-contracts-on-testnets}
...
### Pokyny pro spouštění testování založeného na vlastnostech pro chytré kontrakty {#testing-vs-formal-verification}
...
## Manuální testování chytrých kontraktů {#testing-vs-audits-bug-bounties}
...
### Testování kontraktů na lokálním blockchainu {#testing-tools-and-libraries}
...
### Testování kontraktů na testnetech {#unit-testing-tools}
...
## Testování vs. formální verifikace {#property-based-testing-tools}
...
## Testování vs. audity a programy bug bounty {#static-analysis-tools}
...
## Testovací nástroje a knihovny {#dynamic-analysis-tools}

### Nástroje pro jednotkové testování {#related-tutorials}
...
### Nástroje pro testování založené na vlastnostech {#further-reading}

#### Nástroje pro statickou analýzu {#tutorials}
...
## Tutoriály: Testování chytrých kontraktů na Ethereu
