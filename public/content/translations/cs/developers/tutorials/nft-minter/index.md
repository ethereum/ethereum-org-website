...
### Volání funkce pro ražení

Obvykle tato funkce pro ražení vyžaduje, abyste předali dvě proměnné jako parametry: první je `recipient`, která specifikuje adresu, jež obdrží vaše čerstvě vyražené NFT, a druhou je `tokenURI` daného NFT, což je řetězec, který odkazuje na JSON dokument popisující metadata NFT.

Metadata NFT jsou tím, co mu skutečně vdechuje život, protože mu umožňují mít vlastnosti, jako je název, popis, obrázek (nebo jiné digitální aktivum) a další atributy. Zde je [příklad tokenURI](https://gateway.pinata.cloud/ipfs/QmSvBcb4tjdFpajGJhbFAWeK3JAxCdNQLQtr6ZdiSi42V2), který obsahuje metadata NFT.

V tomto návodu se zaměříme na část 2, volání funkce pro ražení chytrého kontraktu pro NFT pomocí našeho uživatelského rozhraní v Reactu.

Budete potřebovat chytrý kontrakt pro NFT standardu ERC-721 nasazený na podporovaném testnetu, jako je Sepolia. Pokud byste si chtěli nasadit vlastní, doporučujeme průvodce od Alchemy pro [nasazení chytrého kontraktu na síť Sepolia](https://www.alchemy.com/docs/how-to-deploy-a-smart-contract-to-the-sepolia-testnet).

Skvělé, teď když rozumíme tomu, jak tvorba NFT funguje, pojďme si naklonovat naše startovací soubory!
...
Přejděte na stránku „Create App“ na vašem řídicím panelu Alchemy tak, že najedete myší na „Apps“ v navigačním panelu a kliknete na „Create App“.

Pojmenujte svou aplikaci (my jsme zvolili „My First NFT!“), přidejte krátký popis, vyberte „Staging“ pro prostředí (Environment) používané pro evidenci vaší aplikace a jako vaši síť zvolte „Sepolia“.

Klikněte na „Create app“ a to je vše! Vaše aplikace by se měla objevit v tabulce níže.

Skvělé, takže teď, když jsme vytvořili naši HTTP URL adresu pro Alchemy API, zkopírujte si ji do schránky...
...
Pravděpodobně byste se chtěli pochlubit NFT vyraženými prostřednictvím vaší dapp ve vaší peněžence – takže se určitě podívejte na náš rychlý návod [Jak si zobrazit NFT ve vaší peněžence](/developers/tutorials/how-to-view-nft-in-metamask/)!
