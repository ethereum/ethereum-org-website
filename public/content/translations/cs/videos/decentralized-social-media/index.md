---
title: "Vysvětlení decentralizovaných sociálních médií"
description: "Vysvětlení decentralizovaných platforem sociálních médií, které využívají technologii blockchain k tomu, aby uživatelům poskytly vlastnictví jejich dat, obsahu a sociálních vazeb, aniž by se spoléhaly na centralizované korporace."
lang: cs
...
Vysvětlení od **CoinMarketCap**, které pokrývá decentralizované platformy sociálních médií, jak se liší od centralizovaných sítí, kompromisy týkající se svobody slova, výhody interoperability a prohlídku předních platforem včetně Mastodon, Minds, Steem, DTube, Audius a Subsocial.
...
Napříč všemi generacemi roste pocit, že sociální média ve skutečnosti nenaplnila svá očekávání. V průběhu let se vyvinula v uzavřené, finančně motivované, centralizované sítě, které jsou neustále bombardovány skandály ohledně soukromí a nekonečnými obviněními z cenzury.

Pokud jde o cenzuru, mluvíme o svobodě slova, a to je jeden ze způsobů, jak mají decentralizované sociální sítě příležitost dělat věci jinak. Svoboda slova je ošemetná. Nechat lidi rozhodnout, co chtějí číst a slyšet a s kým chtějí komunikovat, má zjevné výhody — jako je poskytnutí hlasu utlačovaným, cenzurovaným nebo nevyslyšeným.

Ale když má každý svobodu slova, někdy — zejména na platformách sociálních médií — jste neustále bombardováni zprávami, videi a obrázky, které jsou znepokojivé nebo násilné. Volný ring, kde si každý může dělat, co chce, ve skutečnosti nefunguje. Je potřeba nějaký druh moderování, ale to neznamená, že decentralizované sociální sítě musí moderovat obsah stejným způsobem jako Twitter, Facebook nebo YouTube. Mají příležitost přijít s inovativními způsoby moderování obsahu, které se nespoléhají na centralizovanou kontrolu nebo univerzální pohled na svět.
...
Představte si, že by takto fungovalo posílání e-mailů: pokud byste chtěli poslat e-mail někomu s účtem na Gmailu, musel by mít také Gmail. Takhle e-mail nefunguje, ale takhle fungují sociální média. S decentralizovanými sociálními sítěmi to tak být nemusí. Decentralizované sítě spolu komunikují úplně stejně jako telefony v různých mobilních sítích.
...
Každá instance má své vlastní moderátory, kteří určují pravidla pro své příslušné komunity, včetně toho, jaký obsah je povolen a jaký ne. Uživatelé z jedné komunity mohou snadno komunikovat s uživateli z jiné, nebo mohou zůstat v soukromí. Pokud se vám nelíbí pravidla konkrétní komunity, můžete ji opustit a připojit se k jiné, aniž byste ztratili všechna svá data. Máte také možnosti ztlumit nebo zablokovat jednotlivé uživatele nebo dokonce celé instance.
...
Domovská stránka Minds vypadá hodně jako Facebook, jen s jiným barevným schématem. Můžete zveřejňovat stavy, obrázky, videa a příspěvky na blogu, stejně jako chatovat s přáteli prostřednictvím zpráv nebo videa. Pokud se ostatním uživatelům líbí váš obsah a sdílejí ho, obdržíte nativní tokeny platformy Minds. Tyto tokeny můžete použít k vylepšení svého kanálu nebo k propagaci svého obsahu, abyste oslovili více uživatelů, a lidé mohou přispívat na váš kanál přímo v dolarech, Bitcoinu nebo dokonce Ethereu.
...
Přesto musíme být realističtí. MySpace nezmizel za jediný den — ve skutečnosti je pravděpodobně stále online. Bude to chvíli trvat, než budou všichni vaši přátelé na decentralizovaných sociálních sítích. Ale všechno to začíná tím, že uděláte první krok — vyberete si decentralizovanou sociální síť, která osloví vás a vaše hodnoty, odhodláte se k tomuto kroku do neznáma a pak pozvete své přátele.