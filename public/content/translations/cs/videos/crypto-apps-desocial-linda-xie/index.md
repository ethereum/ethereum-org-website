---
title: "Krypto aplikace a decentralizované sociální sítě"
description: "Linda Xie o decentralizovaných platformách sociálních médií postavených na Ethereu, pokrývající otevřené sociální grafy, integrované peněženky, mini aplikace na Farcasteru a výzvy růstu, kterým čelí krypto sociální sítě."
lang: cs
...
Myslím, že je velmi užitečné nejprve nastínit problémy současných tradičních sociálních sítí. Myslím, že jsme všichni zažili podobný problém, kdy začnete na jedné platformě a pak si musíte vytvořit účet na jiné platformě a začít úplně od nuly. Vaše publikum v takovém scénáři vlastně patří samotné platformě. A když vás z platformy vyhodí nebo je platforma v nějaké zemi zakázána, ztratíte přístup k jakékoli distribuci ke svému publiku. Pro uživatele a tvůrce obsahu je opravdu důležité, aby měli ke svému publiku přístup.
...
Skvělý příklad — máte aplikaci Farcaster a pak máte také aplikaci Base vytvořenou společností Coinbase. Máte podobný počet sledujících, s mírným rozdílem, protože každý klient má vlastní filtrování spamu. Ale dokázala jsem si vybudovat publikum na Farcasteru, okamžitě začít používat aplikaci Base a nemusela jsem začínat od nuly. Je to opravdu magický okamžik, když to zažijete. A stejné to bude i u všech ostatních klientů Farcasteru — Zapper, Uno a několika dalších.
...
Historicky jsme také viděli, jak aplikace jako Reddit změnily ceny svého API a najednou se provozování vašeho podnikání stalo extrémně drahým. Mnoho aplikací v minulosti skončilo, protože si už nemohly dovolit fungovat s novými cenami API Redditu. V komunitě to vyvolalo obrovské pozdvižení. U těchto platforem se to prostě děje znovu a znovu. Mohou vás vyhodit z libovolných důvodů. Nemusí vám sdělit přesný důvod, proč vás vyhodili. A pokud vás prostě vnímají jako konkurenci, mohou vás z platformy odstranit. Osobně jsem mluvila s několika týmy, které to zažily na vlastní kůži.

Jedna věc, která je na decentralizovaných sociálních sítích opravdu úžasná, je to, že stejně jako vy jako uživatel můžete v síti publikovat jednou, můžete v síti také tvořit bez povolení. Vývojáři mohou tvořit bez povolení, aniž by museli chodit za každou platformou a ptát se: „Hej, můžu na vaší platformě stavět?“ Dnes dříve jsem byla u stánku Farcasteru a lidé se ptali, jak se dostat na whitelist, aby mohli na Farcasteru stavět, a já jim mohla prostě říct, že je to nevyžadující povolení — můžete použít jakákoli z těchto dat, začlenit je přímo do své aplikace a nemusíte s týmem vůbec mluvit. To je budoucnost toho, jak by se věci měly budovat.
...
Nyní máte možnost posílat transakce v hodnotě jednoho centu nebo i méně díky L2 sítím a tomu, jak je to levné a rychlé. Existují aplikace jako Tipin a Noise, které vám umožňují automaticky posílat spropitné za každou interakci — sledování, přesdílení (recast), lajknutí příspěvku, odpověď. Můžete si nastavit povolený limit pro částku, kterou chcete darovat. V mém případě jsem si nastavila jeden cent za každé lajknutí něčího příspěvku a na pozadí se to děje automaticky. Pokaždé, když v síti lajknu nějaký obsah, automaticky pošlu uživateli jeden cent.
...
Vývojář jménem Angel to vzal a rozhodl se vytvořit mini aplikaci, kde můžete razit verzi tohoto stvoření Warplet smíchanou s DNA vaší vlastní profilové fotky. NishProf sdílela svého vlastního Warpleta ze své profilové fotky — a více než 49 000 účtů si vygenerovalo svého Warpleta. Stalo se to naprosto virálním. Angel si díky vytvoření této mini aplikace dokázal za pouhých pár dní vydělat téměř 100 000 dolarů. Opravdu to ukazuje, že když máte integrovanou peněženku, kde může kdokoli snadno provést transakci, můžete jako tvůrce vydělávat na budování aplikací, které se v sociálním feedu stanou virálními.
...
Chci však opravdu zdůraznit — v krypto prostoru pracuji už 11 let, od raných dob Bitcoinu. Můžete to porovnat s něčím jako je zlato — podívejte se, jak daleko se Bitcoin dostal. Můžete se také podívat na decentralizované finance (DeFi) a veškerou celkovou uzamčenou hodnotu (TVL) a objem swapů a podívat se, jak moc to vyrostlo. To vše je velmi dobře možné díky komunitě, tvůrcům a uživatelům. Velmi silně věřím, že sociální sítě projdou v krypto prostoru další fází růstu, protože to prostě dává smysl. Je to lepší zážitek pro uživatele, lepší zážitek pro tvůrce a nyní můžete vytvářet věci, které dříve prostě neexistovaly. Jak se krypto stává více mainstreamovým, doufejme, že porosteme s ním.

Konkrétně u Farcasteru jsme zjistili, že lidi opravdu oslovila integrovaná peněženka, takže se do těchto funkcí opravdu opíráme. Onboarding nekrypto účastníků je něco, s čím se potýká každá krypto aplikace — pokud jste úplný nováček, musíte pochopit, co je to peněženka a jak udržet věci v bezpečí. Od raných dob jsme se hodně zlepšili, ale ve srovnání s tradičními spotřebitelskými zážitky máme stále co zlepšovat.

Problémem je také spam. Ten existuje i na centralizovaných sociálních platformách — na Twitteru pravděpodobně sami zažíváte, jak těžké je poznat, co je skutečný účet. Na úrovni Farcasteru můžete mít buď spamové služby, které pomáhají klientům provádět filtrování na úrovni protokolu, nebo si klient může provádět vlastní filtrování spamu.
...
L2 sítě jsou toho kritickou součástí, díky nimž jsou transakce opravdu levné a rychlé — můžete vidět zážitky, jako je mikrospropitné, o kterém jsme mluvili dříve. Klíčové jsou také integrované peněženky — chci opravdu zdůraznit, o kolik lepší zážitek to je při používání spotřebitelských aplikací. Tolik z nás zažilo, že nás to vyhodilo do peněženky, museli jsme se vracet zpět a někdy to nefungovalo. S integrovanými peněženkami zůstáváte v prostředí aplikace a dochází k mnohem menšímu úbytku uživatelů.

Nové stavební bloky, jako jsou mini aplikace a agenti, jsou zcela nové věci, které můžete používat a které jsme dříve v takovém měřítku nutně neviděli. A velkou meta událostí, která se děje mimo samotné krypto, je to, o kolik se zlepšila umělá inteligence (AI) — nyní můžete vytvářet aplikace pomocí promptů. To opravdu snižuje náklady a bariéru pro lidi, aby mohli skutečně tvořit. Máme služby jako Neynar, které vám umožňují vytvářet mini aplikace pro Farcaster, aniž byste museli být vývojářem.

Kam to všechno směřuje — myslím, že e-mail je opravdu dobrá analogie. Když posíláte e-maily, nemusíte si vytvářet účet na AOL, abyste mohli mluvit s někým, kdo má e-mail na AOL. Můžete používat Gmail, Yahoo, Outlook, cokoli chcete, a všichni spolu můžete komunikovat na úrovni protokolu. Myslím si, že přesně takhle by se měly vyvíjet decentralizované sociální sítě — všechna tato síťová data, celý tento sociální graf na úrovni protokolu a každý klient může stavět nad tím s funkcemi specifickými pro svou uživatelskou základnu. Mohli by mít různé algoritmy, různé funkce na základě toho, co se jejich uživatelům skutečně líbí.
...
**Linda Xie:** To je dobrá otázka. Myslím, že je na nás, abychom vytvořili zážitky, které jsou lepší než stávající tradiční zážitky. Krypto umožní věci, které na tradičních sociálních platformách doslova ani nemůžete dělat. Přijdete, abyste začali vydělávat krypto, zažijete všechny tyto krypto aplikace postavené na krypto sociálních kolejích. Takže to je způsob, jakým přitahujeme pozornost — pokud jste opravdu skvělý tvůrce a chcete distribuci, krypto bude způsob, jakým můžete vydělávat, a sociální sítě budou způsobem, jakým se vaše aplikace bude distribuovat. Jako uživatel můžete dostávat spoustu spropitného za zveřejňování dobrého obsahu, což na tradičních platformách nedostáváte. Prostě si myslím, že vytvoříte lepší zážitek.

**Moderátor:** Farcaster nedávno získal Clanker, a to poskytuje alternativní zdroj příjmů. Jak se díváte na reklamy v rámci decentralizované sociální sítě, jako je Farcaster?
...
**Moderátor:** Jako někdo, kdo se v kryptu pohybuje už opravdu dlouho — co vás žene kupředu? Máte nějakou radu pro někoho, kdo právě teď začíná objevovat?

**Linda Xie:** Myslím, že je to udělat krok zpět a uvědomit si, jak neuvěřitelná tato technologie je. Mohu vlastnit své vlastní peníze. Mohu je poslat komukoli jinému na světě a nemusím žádat o povolení. Žádná centralizovaná platforma si z toho nebere nějaký extrémní poplatek a podíl. Všechny tyto technologie se rozšiřují do decentralizovaných financí (DeFi) a sociálních sítí — představte si, jak moc tyto věci mění život. Skutečnost, že můžeme být součástí této přední linie práce na této technologii, mě žene kupředu každý den. Je to plné šílenství a vzestupů i pádů, ale nakonec, jaký je to úžasný okamžik v čase, že můžeme trávit čas prací na tomto. Přála bych si být součástí raných dob internetu, ale měla jsem velké štěstí, že jsem mohla dělat krypto.

**Moderátor:** Moc děkuji, Lindo.