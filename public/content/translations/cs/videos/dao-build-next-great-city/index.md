---
title: "Mohla by DAO postavit další skvělé město?"
description: "Scott Fitsimones sdílí, jak by decentralizované autonomní organizace (DAO) mohly být klíčem ke koordinaci komunitně řízeného rozvoje a budování dalšího skvělého města."
lang: cs
...
format: presentation
author: TED
breadcrumb: "DAO a města"
---

Prezentace TED od experimentálního urbanisty **Scotta Fitsimonese** o tom, jak by decentralizované autonomní organizace (DAO) mohly koordinovat komunitně řízený rozvoj, od sdružování kryptoměn a nákupu pozemků až po správu sdílených zdrojů prostřednictvím hlasování založeného na blockchainu.
...
Ale co kdybychom mohli začít v menším, jako opravdu v malém? A prostě jen napsat na Twitter. Přesně to jsem udělal, protože mi to umožnilo najít lidi po celém světě, kteří byli ochotni mi s tím pomoci. S mými novými internetovými přáteli jsme založili skupinový chat, dali dohromady kryptoměnu, prozkoumali lokality a o tři měsíce později jsme koupili 40 akrů půdy poblíž Yellowstonského národního parku ve Wyomingu.
...
V tradiční společnosti spolupracuje generální ředitel s vedením na stanovení směru a rozpočtů a předává priority dolů po organizační struktuře k realizaci. V DAO fungují členové jako sobě rovní – přispívají kapitálem, navrhují projekty, pracují na nich a rozhodují jako skupina. Řízení shora dolů je nahrazeno pravidly založenými na blockchainu, která jsou zakódována v chytrých kontraktech. Například financování projektu, pokud projde návrh.
...
CityDAO patřilo mezi první DAO, která měla dost odvahy na to, aby koupila pozemek. A když už mluvíme o byrokracii, v současném systému nám to trvalo více než měsíc. Museli jsme najít agenta, koordinovat prohlídky, podávat nabídky, čekat na protinabídky, složit zálohu, založit LLC (společnost s ručením omezeným) a vyplnit papírování.
...
Komunitu obvykle zakládají na serveru pro skupinový chat, přičemž nejběžnější je Discord. My používáme Discord pro týdenní komunitní hovory, kde lidé mohou sdílet nápady a debatovat o návrzích. Na serveru jsou vytvořeny kanály pro jednotlivé týmy a projekty. Místo formálního šéfa má každý tým zvoleného facilitátora, který pořádá pravidelné schůzky.
...
DAO se někdy označují jako skupinové chaty s bankovním účtem. A já vím, co si myslíte: „Scotte, sdílet bankovní účet s mým partnerem je už tak dost těžké. Teď mi říkáš, že ho musím sdílet s 5 000 lidmi na internetu?“ No, není to tak zlé. Blockchain to pomáhá vyřešit.
...
Hlasovali jsme pro získání Parcely 0 poblíž Cody ve Wyomingu – vybrané proto, že je blízko letiště, má na místě studnu pro přístup k vodě a samozřejmě kvůli nejdůležitějšímu kritériu ze všech: je blízko Kanyeho Westa.
...
ConstitutionDAO vybralo přes 47 milionů dolarů za sedm dní ve snaze koupit originální kopii Ústavy USA. Obvykle trvá déle než sedm dní jen založit společnost a otevřít si bankovní účet. Krause House kupuje tým NBA a LinksDAO golfové hřiště. Členové DAO se pravděpodobně budou moci podílet na klíčových věcech, jako je to, kdo bude tým trénovat nebo kde se golfové hřiště postaví.

PleasrDAO sbírá umění a digitální aktiva, jako jsou NFT. Nedávno zakoupili jedinou existující kopii nevydaného alba Wu-Tang Clan a členové DAO jsou nyní jediní lidé na světě, kteří si ho mohou legálně poslechnout. VectorDAO je kolektiv designérů, který otřásá modelem agentur, kde členové DAO získávají vlastnický podíl v každém projektu, na kterém pracují.
...
A zatímco tradiční firemní struktury jsou prověřené bojem, DAO jsou novým typem subjektu, který se může ocitnout v neprobádaných regulačních vodách. Aby pomohly vyřešit některé z těchto problémů, státy jako Wyoming zavádějí zákony, které DAO uznávají – a my jsme vlastně jeden z těchto zákonů využili k nákupu našeho prvního pozemku v CityDAO. Proto je to ve Wyomingu.

Jakmile vychytáme mouchy, DAO mají potenciál zvýšit ekonomické příležitosti a umožnit více lidem podílet se na výhodách vlastnictví. Věci jako nemovitosti, sportovní týmy a výtvarné umění – věci, které by typicky vlastnil jediný jednotlivec s vysokým čistým jměním – dnes DAO kupují a demokratizují.

Představte si, že by další sociální síť nebo aplikace pro sdílení jízd byla DAO. A pokaždé, když byste zveřejnili hodnotný obsah nebo jezdili dlouho do noci, získali byste malé kousky vlastnictví v této platformě. A protože vlastnictví v DAO znamená hlasovací práva, můžete svou novou hlasovací sílu využít k navrhování změn na platformě, pokud si myslíte, že existuje spravedlivější nebo lepší způsob, jak věci dělat.

Zemědělství nám umožnilo žít ve městech. Internet nám umožnil sdílet informace globálně. A dnes nám DAO umožňují spolupracovat, důvěřovat si a spravedlivěji se koordinovat při řešení rozsáhlejších problémů než kdykoli předtím. A možná DAO dokonce dokáže postavit další skvělé město.