...
Zejména výhody škálování — jak pro l1, tak pro l2. Fusaka představuje něco zásadně nového se svou technologií EIP-7594 PeerDAS. Více dat znamená více blobů, což znamená větší kapacitu pro rollupy. Tato data jsou dnes omezujícím faktorem, pokud jde o věci, které rollupy od Etherea potřebují.

Pokud dokážeme snížit omezení dostupnosti dat, můžeme snížit omezení toho, co lze na Ethereu postavit. Získáte vlastnosti Etherea odolné vůči cenzuře v samotné dostupnosti dat.
...
### Kapacita gasu na l1 (1:45) {#l1-gas-capacity-145}

Některé z dalších upgradů Fusaka — jako jsou limity velikosti bloku a velikosti transakce — nám umožní zvýšit limit plynu. Jde v podstatě o zvýšení kapacity, počtu transakcí, které lze zpracovat, při zachování těchto opravdu nízkých poplatků.

Vše je o snaze vytvořit prostředí, které škáluje celý ekosystém Etherea. Nejenže je spolehlivé a má 100% dostupnost, ale dokáže přinášet novinky s vysokou rychlostí.

### Pohled do budoucna (2:08) {#looking-ahead-208}

Naše práce nekončí a to je definitivní duch Etherea. Fusaka učiní vrstvu 2 (l2) škálovatelnou a poté uzavře tuto kapitolu a otevře dveře další kapitole — kterou je škálování l1.

Co přijde dál? Se škálováním teprve začínáme. Nikdy nebyl lepší okamžik se zapojit než právě teď. Škálovat l1, škálovat l2 a zjednodušit uživatelskou zkušenost.