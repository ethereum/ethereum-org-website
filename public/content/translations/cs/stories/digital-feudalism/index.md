---
title: "Vyhlášení nezávislosti na digitálním feudalismu"
description: "Když herní studia vypnou servery, zruší licence a přepíšou pravidla, hráči přijdou o všechno. Onchain hraní nabízí cestu ke svobodě."
...
Hnutí [„Stop Killing Games“](https://en.wikipedia.org/wiki/Stop_Killing_Games) existuje proto, že hráči už toho mají dost. 
...
## Co se stane, když hráči ovládají své světy {#what-happens-when-players-control-their-worlds}
...
Duch [onchain hraní](/gaming/) je duchem open-source.

Když Unity zradilo herní vývojáře zavedením poplatků za běhové prostředí (Runtime Fees), [Godot Engine](https://godotengine.org/) nabídl alternativu.

Nyní onchain enginy jako [Dojo](https://dojoengine.org/) nabízejí herním studiím alternativu k vydávání her na centralizovaných serverech.
...
Začalo to [projektem Loot](https://www.lootproject.com/), za kterým stojí [Dom Hofmann](https://domhofmann.com/).

8 000 seznamů fantasy vybavení s otázkou: „Co kdybychom vytvořili duševní vlastnictví (IP), které by nepatřilo nikomu?“

- Hráčské decentralizované autonomní organizace (DAO) jako [Realms.World](https://linktr.ee/Realms.World) se staly správci.
- Tvůrci jako [Cartridge](https://cartridge.gg/) to proměnili ve skutečnost.
- Enginy jako [Dojo](https://dojoengine.org/) dělají světy ve výchozím nastavení otevřené.
...
Zahrajte si [Loot Survivor](https://www.deathmountain.gg/lootsurvivor). 
...
## Jak nechat krypto zmizet {#making-crypto-disappear}
...
Nástroje jako [Cartridge Controller](https://docs.cartridge.gg/controller/overview) mění celý zážitek.
...
## Svět, který vám nikdo nemůže vzít {#a-world-that-cant-be-taken-away}
...
## Vyhlášení nezávislosti {#declaring-independence}
