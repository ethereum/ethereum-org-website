...
- Pokud máte privátní klíč, můžete dělat cokoliv v rámci pravidel Virtuálního stroje Etherea (EVM).
...
**Poznámka**: Přijetí peněženek s chytrými kontrakty ERC-4337 můžete sledovat [přes tento panel](https://www.bundlebear.com/erc4337-overview/all).
