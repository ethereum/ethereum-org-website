...
<AlertContent>
<AlertDescription>
Този преход към доказателство-за-залог промени начина, по който се издава етер. Научете повече за [издаването на етер преди и след сливането](/roadmap/merge/issuance/).
</AlertDescription>
</AlertContent>
</Alert>
