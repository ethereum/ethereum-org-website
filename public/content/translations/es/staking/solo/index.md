...
<CardGrid>
  ...
  <Card title="Seguridad de la red" emoji="🔐" description="Hacer staking desde casa es la forma de mayor impacto. Al ejecutar un validador en tu propio hardware, fortaleces la robustez, descentralización y seguridad del protocolo de Ethereum." />
</CardGrid>
...
<ExpandableCard title="¿Sufriré slashing si me desconecto? (tldr: No.)">
