...
<CardGrid>
  <Card title="Gana ETH" emoji="💸" description="Gana recompensas en ETH directamente del protocolo cuando tu validador esté en línea, sin que ningún intermediario se lleve una comisión." />
  ...
  <Card title="Seguridad de la red" emoji="🔐" description="Hacer staking en casa es la forma de mayor impacto. Al ejecutar un validador con tu propio hardware, fortaleces la robustez, la descentralización y la seguridad del protocolo de Ethereum." />
</CardGrid>
