...
<CardGrid>
  <Card title="Gana ETH" emoji="💸" description="Obtén recompensas en ETH directamente del protocolo cuando tu validador esté conectado, sin comisiones de intermediarios." />
  ...
  <Card title="Seguridad de la red" emoji="🔐" description="El staking doméstico es la forma más efectiva de hacer staking. Al ejecutar un validador con tu propio hardware en casa, refuerzas la solidez, la descentralización y la seguridad del protocolo de Ethereum." />
</CardGrid>
...
<ExpandableCard title="Disponibilidad confiable" eventCategory="SoloStaking" eventName="clicked reliable uptime">
