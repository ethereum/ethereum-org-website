...
<CardGrid>
  <Card title="Gana ETH" emoji="💸" description="Obtén recompensas en ETH directamente del protocolo cuando tu validador esté en línea, sin comisiones de intermediarios." />
  ...
  <Card title="Seguridad de la red" emoji="🔐" description="El staking en casa es la forma de mayor impacto para hacer staking. Al ejecutar un validador en tu propio hardware en casa, fortaleces la robustez, la descentralización y la seguridad del protocolo de Ethereum." />
</CardGrid>
...
<ExpandableCard title="Disponibilidad fiable" eventCategory="SoloStaking" eventName="clicked reliable uptime">
...
<ExpandableCard title="¿Sufriré slashing si me desconecto? (resumen: no)">
