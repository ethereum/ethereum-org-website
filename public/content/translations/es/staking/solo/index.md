...
<CardGrid>
  <Card title="Gana ETH" emoji="💸" description="Gana recompensas en ETH directamente del protocolo cuando tu validador esté en línea, sin comisiones de intermediarios." />
  <Card title="Control total" emoji="🎛️" description="Conserva tus propias claves. Elige la combinación de clientes y hardware que te permita minimizar tu riesgo y contribuir de la mejor manera a la salud y seguridad de la red. Los servicios de staking de terceros toman estas decisiones por ti, y no siempre toman las decisiones más seguras." />
  <Card title="Seguridad de la red" emoji="🔐" description="El staking doméstico es la forma de hacer staking de mayor impacto. Al ejecutar un validador en tu propio hardware en casa, fortaleces la robustez, la descentralización y la seguridad del protocolo de Ethereum." />
</CardGrid>
...
<ExpandableCard title="¿Cómo evito el slashing?">
...
<ExpandableCard title="¿Puedo usar un VPS (servidor virtual privado)?">
