...
<CardGrid>
  <Card title="Gana ETH" emoji="💸" description="Gana recompensas en ETH directamente del protocolo cuando tu validador esté en línea, sin que los intermediarios se lleven una comisión." />
  <Card title="Control total" emoji="🎛️" description="Conserva tus propias claves. Elige la combinación de clientes y hardware que te permita minimizar tu riesgo y contribuir mejor a la salud y seguridad de la red. Los servicios de staking de terceros toman estas decisiones por ti, y no siempre eligen la opción más segura." />
  <Card title="Seguridad de la red" emoji="🔐" description="Hacer staking desde casa es la forma de staking con mayor impacto. Al ejecutar un validador en tu propio hardware, fortaleces la solidez, la descentralización y la seguridad del protocolo de Ethereum." />
</CardGrid>
