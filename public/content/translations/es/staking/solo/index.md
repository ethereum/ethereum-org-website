...
<CardGrid>
  <Card title="Gana ETH nuevos" emoji="💸" description="Gana recompensas en ETH directamente del protocolo cuando tu validador esté en línea, sin comisiones de intermediarios." />
  ...
  <Card title="Seguridad de la red" emoji="🔐" description="El staking en casa es la forma de staking con mayor impacto. Al ejecutar un validador en tu propio hardware, fortaleces la robustez, la descentralización y la seguridad del protocolo de Ethereum." />
</CardGrid>
