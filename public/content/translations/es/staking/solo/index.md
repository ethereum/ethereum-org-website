...
<CardGrid>
  <Card title="Gana ETH" emoji="💸" description="Obtén recompensas en ETH directamente del protocolo cuando tu validador esté en línea, sin intermediarios que se lleven una comisión." />
  ...
  <Card title="Seguridad de la red" emoji="🔐" description="El staking desde casa es la forma de hacer staking con mayor impacto. Al ejecutar un validador con tu propio hardware en casa, fortaleces la robustez, la descentralización y la seguridad del protocolo de Ethereum." />
</CardGrid>
...
<ExpandableCard title="¿Cómo puedo evitar el slashing?">
...
<ExpandableCard title="¿Qué cliente es mejor?">
