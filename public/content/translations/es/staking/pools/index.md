...
<CardGrid>
  ...
  <Card title="Tokens de staking" emoji=":droplet:" description="Muchos pools de staking ofrecen un token que representa un derecho sobre tu ETH en staking y las recompensas que genera. Esto te permite utilizar tu ETH en staking, p. ej., como colateral en aplicaciones DeFi." />
</CardGrid>
