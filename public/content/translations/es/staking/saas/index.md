...
<CardGrid>
  <Card title="Tu propio validador" emoji=":desktop_computer:" description="Deposita 32 ETH para activar tu propio conjunto de claves de firma, que participará en el consenso de Ethereum. Supervisa tu progreso con los paneles para ver cómo se acumulan tus recompensas de ETH." />
  <Card title="Inicio fácil" emoji="🏁" description="Olvídate de las especificaciones de hardware, la configuración, el mantenimiento y las actualizaciones del nodo. Los proveedores de SaaS te permiten externalizar la parte difícil subiendo tus credenciales de firma para que ejecuten un validador en tu nombre por un pequeño costo." />
