...
### <Emoji text=":two:" size={1} /> &nbsp;Participe en la investigación a través de encuestas {#answer-surveys}
...
### <Emoji text=":three:" size={1} /> &nbsp;Encuentre problemas relacionados con el diseño en el sitio web y repórtelos {#report-design-issues}
...
### <Emoji text=":four:" size={1} /> &nbsp;Proponga cambios de diseño {#propose-design-changes}
...
### <Emoji text=":five:" size={1} /> &nbsp;Construyamos el Sistema de Diseño juntos {#Contribute-to-design-system}
...
### <Emoji text=":six:" size={1} /> &nbsp;Escriba contenido relacionado con el diseño en el sitio web {#write-design-articles}
...
### <Emoji text=":seven:" size={1} /> &nbsp;Cree nuevas ilustraciones {#prepare-illustrations}
