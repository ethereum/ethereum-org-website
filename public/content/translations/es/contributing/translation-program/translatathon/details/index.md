...
- Para empezar a contribuir, únase al [proyecto de ethereum.org en Crowdin](https://crowdin.com/project/ethereum-org)
...
- Si desea traducir a un idioma que no está disponible, póngase en contacto con el [equipo de Ethereum.org](https://crowdin.com/profile/ethdotorg) en Crowdin o envíenos un correo electrónico a translations@ethereum.org y añadiremos idiomas de destino adicionales previa solicitud.
...
- Cada cadena tiene un indicador de estado que muestra si está _Traducida_, _Sin traducir_ o _Aprobada_. Si una cadena de origen ya tiene una traducción sugerida en su idioma, no es necesario que la traduzca.
- También puede filtrar las cadenas en el editor para mostrar _Sin traducir primero_ o _Solo sin traducir_.

Para obtener una guía detallada sobre cómo navegar y utilizar el editor de Crowdin, recomendamos que todos los participantes del Translatathon lean nuestra guía [Cómo traducir](/contributing/translation-program/how-to-translate/).

También puede encontrar algunos consejos y buenas prácticas consultando nuestra [guía de estilo de traducción](/contributing/translation-program/translators-guide/).
...
## Contenido del ecosistema {#ecosystem-content}
...
- [Tutoriales para desarrolladores de Ethereum.org](https://crowdin.com/project/33388446abbe9d7aa21e42e49bba7f97)

- [CLI de depósito de EthStaker](https://crowdin.com/project/ethstaker-deposit-cli)

- [Documentos de Eth Docker](https://crowdin.com/project/eth-docker-docs)

- [Documentación de Remix IDE](https://crowdin.com/project/remix-translation)
