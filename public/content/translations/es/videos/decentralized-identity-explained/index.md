---
title: "Explicación de la identidad descentralizada"
description: "Una explicación sobre cómo la identidad descentralizada otorga a los usuarios más control sobre su identidad digital y mantiene la información personal en Internet más segura mediante credenciales basadas en la cadena de bloques."
lang: es
...
breadcrumb: "Identidad descentralizada"
---

Una explicación de **Microsoft Security** sobre cómo la identidad descentralizada otorga a los usuarios más control sobre sus credenciales digitales, que abarca los problemas con los identificadores digitales actuales, cómo funcionan las credenciales verificables y los identificadores descentralizados, y lo que esto significa para la privacidad en línea.
...
¿Por qué no? En primer lugar, no existe un mecanismo estándar para emitir tarjetas digitales. Para emitir tarjetas o credenciales digitales universalmente aceptables, necesitamos identificadores digitales que las personas puedan poseer independientemente de cualquier entidad, organización o institución. Actualmente, utilizamos direcciones de correo electrónico y números de teléfono como identificadores para acceder a sitios web y aplicaciones. Pero nuestro acceso a estos identificadores, y a nuestra información personal, está a merced de los proveedores de servicios que pueden revocarlos en cualquier momento.
...
Lo mejor de todo es que estas tarjetas digitales son privadas. Esto pone a Alice en control exclusivo de su identidad digital: ella toma las decisiones al respecto. Las credenciales verificables facilitarán mantener el control y ayudarán a desbloquear una Internet más confiable que respete la privacidad de todos nosotros.