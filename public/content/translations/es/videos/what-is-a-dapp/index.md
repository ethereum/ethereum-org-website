---
title: "¿Qué es una dapp? Aplicación descentralizada en la cadena de bloques"
description: "Una introducción a las aplicaciones descentralizadas (dapps) y en qué se diferencian de las aplicaciones tradicionales."
lang: es
...
*Esta transcripción es una copia accesible de la [transcripción original del video](https://www.youtube.com/watch?v=F50OrwV6Uk8) publicada por district0x Network. Ha sido ligeramente editada para facilitar su lectura.*

#### ¿Qué es una dapp? (0:01) {#what-is-a-dapp-001}
...
#### Cómo funcionan las dapps (0:29) {#how-dapps-work-029}
...
#### Beneficios de seguridad (1:10) {#security-benefits-110}
...
#### Construir dapps en Ethereum (1:23) {#building-dapps-on-ethereum-123}
...
#### Ejemplo: Ethlance (1:43) {#example-ethlance-143}
