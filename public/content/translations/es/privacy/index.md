...
- [Zk-kit](https://zkkit.pse.dev/): Un conjunto de bibliotecas (algoritmos, funciones de utilidad y estructuras de datos) que se pueden reutilizar en diferentes proyectos y protocolos de conocimiento cero.
