...
_Sin estándares_, cada token necesitaría un código de integración personalizado. Las funciones `approve` y `transferFrom`, por ejemplo, permiten a los intercambios descentralizados mover tokens en su nombre después de que usted otorgue permiso.

Puede verificar el contrato de un token en <a href="https://eth.blockscout.com/tokens">Etherscan</a> para comprobar qué estándar implementa.
...
```solidity
// Transferir tokens a un destinatario
