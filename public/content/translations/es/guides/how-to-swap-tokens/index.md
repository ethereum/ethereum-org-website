...
Algunos exchanges populares son:
...
El exchange calculará automáticamente cuántos tokens obtendrás.

![Common interface for swapping](./swap2.png)

## 4. Confirma la transacción {#4-confirm-the-transaction}

Revisa los detalles de la transacción. Comprueba el tipo de cambio y cualquier otra tarifa para evitar sorpresas desagradables.

![Common interface for reviewing the transaction](./swap3.png)

## 5. Espera a que se procese la transacción {#5-wait-for-the-transaction-to-be-processed}

Puedes ver el progreso de la transacción en cualquier explorador de la cadena de bloques. Este proceso no debería tardar más de 10 minutos.

Recibirás automáticamente los tokens intercambiados en tu billetera una vez que se procese la transacción.
<br />
...
Es la diferencia entre el tipo de cambio esperado y el tipo de cambio real.
