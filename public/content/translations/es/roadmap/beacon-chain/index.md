...
Y utilizar la prueba de participación como mecanismo de consenso es un componente fundamental para [el Ethereum seguro, ecológico y escalable que tenemos hoy](/roadmap/vision/).
...
- [Más sobre futuras actualizaciones de Ethereum](/roadmap/vision)
