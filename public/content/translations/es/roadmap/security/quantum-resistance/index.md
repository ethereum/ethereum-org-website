...
<ExpandableCard title="¿Por qué Ethereum no puede simplemente reemplazar BLS por un esquema resistente a la computación cuántica?" eventCategory="/roadmap/security/quantum-resistance" eventName="clicked why cant ethereum just replace BLS?">
...
<ExpandableCard title="¿Pueden las computadoras cuánticas robar mi ETH hoy?" eventCategory="/roadmap/security/quantum-resistance" eventName="clicked can quantum computers steal my ETH today?">
...
<ExpandableCard title="¿Cuándo podrían las computadoras cuánticas convertirse en una amenaza?" eventCategory="/roadmap/security/quantum-resistance" eventName="clicked when could quantum computers become a threat?">
...
<ExpandableCard title="¿Necesitaré hacer algo para proteger mi billetera?" eventCategory="/roadmap/security/quantum-resistance" eventName="clicked will I need to do anything?">
...
<ExpandableCard title="¿Qué pasa con mis tokens, NFT y posiciones DeFi?" eventCategory="/roadmap/security/quantum-resistance" eventName="clicked what about tokens NFTs DeFi?">
...
<ExpandableCard title="¿Está Ethereum por detrás de otras cadenas de bloques en esto?" eventCategory="/roadmap/security/quantum-resistance" eventName="clicked is Ethereum behind?">
...
<ExpandableCard title="¿Qué es 'recolectar ahora, descifrar más tarde'?" eventCategory="/roadmap/security/quantum-resistance" eventName="clicked what is harvest now decrypt later?">
