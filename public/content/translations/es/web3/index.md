...
![Arquitectura cliente-servidor, representando Web 1.0](./web1.png)
...
![Arquitectura cliente-servidor, representando Web 2.0](./web2.png)
...
![Arquitectura de nodos descentralizados, representando Web3](./web3.png)
...
Web3 permite la propiedad directa a través de [tokens no fungibles (NFTs)](/glossary/#nft). Nadie, ni siquiera los creadores del juego, tienen el poder de quitarle la propiedad. Y, si deja de jugar, puede vender o intercambiar sus objetos del juego en mercados abiertos y recuperar su valor.
...
- [Por qué importa Web3](https://future.a16z.com/why-web3-matters/) — _Chris Dixon_
