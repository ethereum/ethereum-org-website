...
En la mayoría de los casos, en vez de almacenar todos los datos en cadena, se almacena el hash de dónde los datos se encuentran en una cadena. De esta manera no es necesario escalar toda la cadena para poder mantener la información completa.
