...
Comenzando con la [bifuración dura de Dencun](https://github.com/ethereum/consensus-specs/tree/master/specs/deneb/beacon-chain.md), la cadena de bloques de Ethereum incluye [EIP-4844](https://eips.ethereum.org/EIPS/eip-4844), que agrega blobs de datos en Ethereum con un tiempo de vida limitado (de incialmente unos [18 días](https://github.com/ethereum/consensus-specs/tree/master/specs/deneb/p2p-interface.md#configuration)). Los precios de estos blobs de datos se calculan aparte del [gas de ejecución](/developers/docs/gas), aunque utilizando un mecanismo similar. Son una forma más económica de publicar datos temporales.
...
| ------------------------------------ | ------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------ | --------------------------------------------------------------------------------- |
| Blobs EIP-4844                       | Fuera de la cadena        | Garantiza de Ethereum por [~18 días](https://github.com/ethereum/consensus-specs/tree/master/specs/deneb/p2p-interface.md#configuration) | Solo el hash está disponible                                       |                                                                                   |
