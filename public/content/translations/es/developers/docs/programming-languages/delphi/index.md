...
- [Conectar Delphi a una blockchain local (en memoria)](https://medium.com/@svanas/connecting-delphi-to-a-local-in-memory-blockchain-9a1512d6c5b0)
...
**¿Quiere saltarse la configuración por ahora e ir directamente a los ejemplos?**

- [Un contrato inteligente en 3 minutos y Delphi - Parte 1](https://medium.com/@svanas/a-3-minute-smart-contract-and-delphi-61d998571d)
- [Un contrato inteligente en 3 minutos y Delphi - Parte 2](https://medium.com/@svanas/a-3-minute-smart-contract-and-delphi-part-2-446925faa47b)

## Articulos para usuarios familiarizados {#intermediate-articles}

- [Generar una firma de mensaje de Ethereum en Delphi](https://medium.com/@svanas/generating-an-ethereum-signed-message-signature-in-delphi-75661ce5031b)
...
- [Delphi y el Servicio de Nombres de Ethereum (ENS)](https://medium.com/@svanas/delphi-and-ethereum-name-service-ens-4443cd278af7)
...
- [Intercambiar un token por otro en Delphi](https://svanas.medium.com/swap-one-token-for-another-in-delphi-bcb999c47f7)
