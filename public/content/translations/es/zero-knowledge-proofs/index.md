...
## ¿Por qué necesitamos pruebas de conocimiento cero? Por qué son importantes las pruebas de conocimiento cero {#why-zero-knowledge-proofs-are-important}
...
- Mientras procesa los mensajes, el coordinador omite el voto de Alicia por la `opción B` y solo cuenta el voto por la `opción A`. Por lo tanto, el intento de Bob de colusión con Alice y de manipular el voto en cadena fracasa.
...
[Aprenda más sobre MACI](https://privacy-scaling-explorations.github.io/maci/).
