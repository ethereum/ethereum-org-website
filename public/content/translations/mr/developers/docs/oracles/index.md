...
##### डेटाच्या अचूकतेवर मतदान/स्टेकिंग {#availability}
...
##### शेलिंग पॉइंट यंत्रणा {#good-incentive-compatibility}
...
### चांगली प्रोत्साहन सुसंगतता {#retrieving-financial-data}
...
## स्मार्ट कॉन्ट्रॅक्ट्समध्ये ओरॅकलचे ॲप्लिकेशन्स {#generating-verifiable-randomness}

इथेरियममध्ये ओरॅकलसाठी खालील सामान्य उपयोग-प्रकरणे आहेत:

### आर्थिक डेटा मिळवणे {#getting-outcomes-for-events}
...
### पडताळणी करण्यायोग्य यादृच्छिकता तयार करणे {#automating-smart-contracts}
...
### घटनांचे परिणाम मिळवणे {#use-blockchain-oracles}
...
### स्मार्ट कॉन्ट्रॅक्ट्स स्वयंचलित करणे {#further-reading}
