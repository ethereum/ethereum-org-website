...
##### बहु-स्वाक्षरी वॉलेट्स वापरणे {#use-require-assert-revert}
...
### 2. कॉन्ट्रॅक्ट ऑपरेशन्सचे रक्षण करण्यासाठी require(), assert(), आणि revert() स्टेटमेंट्स वापरा {#test-smart-contracts-and-verify-code-correctness}
...
### 3. स्मार्ट कॉन्ट्रॅक्ट्सची चाचणी घ्या आणि कोडच्या अचूकतेची पडताळणी करा {#get-independent-code-reviews}
...
### 4. तुमच्या कोडच्या स्वतंत्र पुनरावलोकनासाठी विचारा {#audits}
...
#### बग बाउन्टीज {#follow-smart-contract-development-best-practices}
...
### 5. स्मार्ट कॉन्ट्रॅक्ट विकासादरम्यान सर्वोत्तम पद्धतींचे अनुसरण करा {#implement-disaster-recovery-plans}
...
### 6. मजबूत आपत्ती पुनर्प्राप्ती योजना लागू करा {#contract-upgrades}
...
#### कॉन्ट्रॅक्ट अपग्रेड्स {#emergency-stops}
...
#### आपत्कालीन थांबे (Emergency stops) {#event-monitoring}
...
#### घटना निरीक्षण (Event monitoring) {#design-secure-governance-systems}
...
### 7. सुरक्षित प्रशासन प्रणाली डिझाइन करा {#reduce-code-complexity}
...
### 8. कोडमधील गुंतागुंत कमीत कमी करा {#mitigate-common-smart-contract-vulnerabilities}
...
### 9. सामान्य स्मार्ट कॉन्ट्रॅक्ट असुरक्षांपासून बचाव करा {#reentrancy}

#### पुनर्प्रवेश (Reentrancy) {#integer-underflows-and-overflows}
...
##### पुनर्प्रवेश हल्ले कसे टाळावे {#oracle-manipulation}
...
#### इंटिजर अंडरफ्लो आणि ओव्हरफ्लो {#smart-contract-security-resources-for-developers}
...
##### इंटिजर अंडरफ्लो आणि ओव्हरफ्लो कसे टाळावे {#code-analysis-tools}
...
#### ओरॅकल फेरफार (Oracle manipulation) {#smart-contract-monitoring-tools}
...
##### ओरॅकल फेरफार कसे टाळावे {#smart-contract-administration-tools}
...
## डेव्हलपर्ससाठी स्मार्ट कॉन्ट्रॅक्ट सुरक्षा संसाधने {#smart-contract-auditing-services}

### स्मार्ट कॉन्ट्रॅक्ट्सचे विश्लेषण करण्यासाठी आणि कोडच्या अचूकतेची पडताळणी करण्यासाठी टूल्स {#bug-bounty-platforms}
...
### स्मार्ट कॉन्ट्रॅक्ट्सचे निरीक्षण करण्यासाठी टूल्स {#common-smart-contract-vulnerabilities-and-exploits}
...
### स्मार्ट कॉन्ट्रॅक्ट्सच्या सुरक्षित प्रशासनासाठी टूल्स {#challenges-for-learning-smart-contract-security}
...
### स्मार्ट कॉन्ट्रॅक्ट ऑडिटिंग सेवा {#smart-contract-security-best-practices}
...
### बग बाउन्टी प्लॅटफॉर्म्स {#tutorials-on-smart-contract-security}
