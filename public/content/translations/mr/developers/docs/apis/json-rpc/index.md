...
- `value`: `क्वांटिटी` - (पर्यायी) या व्यवहारासह पाठवलेल्या व्हॅल्यूचा पूर्णांक.
- `input`: `डेटा` - (पर्यायी) पद्धतीच्या स्वाक्षरीचा हॅश आणि एन्कोड केलेले पॅरामीटर्स. तपशीलांसाठी Solidity डॉक्युमेंटेशनमधील [Ethereum Contract ABI](https://docs.soliditylang.org/en/latest/abi-spec.html) पहा.
