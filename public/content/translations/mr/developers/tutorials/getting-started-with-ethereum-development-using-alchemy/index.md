...
इथेरियम डेव्हलपमेंटला सुरुवात करण्यासाठी हे नवशिक्यांसाठीचे मार्गदर्शक आहे. या ट्युटोरिअलसाठी आम्ही [Alchemy](https://www.alchemy.com/) वापरणार आहोत, जे Maker, 0x, MyEtherWallet, Dharma आणि Kyber यांसारख्या 70% आघाडीच्या ब्लॉकचेन ॲप्समधील लाखो वापरकर्त्यांना सक्षम करणारे एक प्रमुख ब्लॉकचेन डेव्हलपर प्लॅटफॉर्म आहे. Alchemy आपल्याला इथेरियम चेनवरील API एंडपॉईंटचा ॲक्सेस देईल जेणेकरून आपण ट्रान्झॅक्शन्स वाचू आणि लिहू शकू.
...
- `method`: ETH API पद्धत. [API संदर्भ पहा.](/developers/docs/apis/json-rpc/)
...
सध्याची गॅसची किंमत मिळवण्यासाठी तुम्ही कमांड लाईनवरून चालवू शकता असे एक उदाहरण येथे आहे:
...
_**टीप:** `https://eth-mainnet.alchemyapi.io/v2/demo` ला तुमच्या स्वतःच्या API की `https://eth-mainnet.alchemyapi.io/v2/**your-api-key` ने बदला._
...
**_टीप:_** खालील स्क्रिप्ट्स **नोड कॉन्टेक्स्टमध्ये** चालवणे किंवा **फाईलमध्ये सेव्ह करणे** आवश्यक आहे, कमांड लाईनवरून चालवणे नाही. जर तुमच्याकडे आधीपासूनच Node किंवा npm इन्स्टॉल केलेले नसेल, तर [Node.js इन्स्टॉलेशन सूचनांचे](https://nodejs.org/en/download/) अनुसरण करा.

अनेक [Web3 लायब्ररी](/developers/docs/apis/javascript/) आहेत ज्या तुम्ही Alchemy सोबत इंटिग्रेट करू शकता, तथापि, आम्ही [Alchemy Web3](https://github.com/alchemyplatform/alchemy-web3) वापरण्याची शिफारस करतो, जे web3.js साठी एक ड्रॉप-इन रिप्लेसमेंट आहे, जे Alchemy सोबत अखंडपणे काम करण्यासाठी तयार आणि कॉन्फिगर केले आहे. हे स्वयंचलित रिट्राय आणि मजबूत WebSocket सपोर्ट यांसारखे अनेक फायदे प्रदान करते.

AlchemyWeb3.js इन्स्टॉल करण्यासाठी, **तुमच्या प्रोजेक्ट डिरेक्टरीमध्ये जा** आणि चालवा:
...
Alchemy च्या नोड इन्फ्रास्ट्रक्चरशी संवाद साधण्यासाठी, NodeJS मध्ये चालवा किंवा हे JavaScript फाईलमध्ये जोडा:
...
पुढे काय करावे हे माहित नाही? तुमचा पहिला स्मार्ट कॉन्ट्रॅक्ट डिप्लॉय करण्याचा प्रयत्न करा आणि आमच्या [हॅलो वर्ल्ड स्मार्ट कॉन्ट्रॅक्ट मार्गदर्शकामध्ये](/developers/tutorials/hello-world-smart-contract/) काही Solidity प्रोग्रामिंगचा प्रत्यक्ष अनुभव घ्या, किंवा अधिक उदाहरणांसाठी [Alchemy चे डॉक्स](https://www.alchemy.com/docs/) एक्सप्लोर करत राहा.
