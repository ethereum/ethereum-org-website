...
साधारणपणे, या मिंटिंग फंक्शनसाठी तुम्हाला पॅरामीटर्स म्हणून दोन व्हेरिएबल्स पास करणे आवश्यक असते, पहिले `recipient`, जे तुमचा नव्याने मिंट केलेला NFT प्राप्त करणारा पत्ता निर्दिष्ट करते आणि दुसरे NFT चे `tokenURI`, एक स्ट्रिंग जी NFT च्या मेटाडेटाचे वर्णन करणाऱ्या JSON डॉक्युमेंटमध्ये रिझॉल्व्ह होते.

NFT चा मेटाडेटा खरोखरच त्याला जिवंत करतो, ज्यामुळे त्याला नाव, वर्णन, प्रतिमा (किंवा भिन्न डिजिटल मालमत्ता) आणि इतर गुणधर्म असू शकतात. येथे [tokenURI चे एक उदाहरण](https://gateway.pinata.cloud/ipfs/QmSvBcb4tjdFpajGJhbFAWeK3JAxCdNQLQtr6ZdiSi42V2) आहे, ज्यामध्ये NFT चा मेटाडेटा आहे.

या ट्युटोरिअलमध्ये, आम्ही भाग 2 वर लक्ष केंद्रित करणार आहोत, आमच्या React UI चा वापर करून NFT स्मार्ट कॉन्ट्रॅक्ट मिंटिंग फंक्शन कॉल करणे.

तुम्हाला Sepolia सारख्या सपोर्टेड टेस्टनेटवर प्रस्थापित केलेल्या ERC-721 NFT स्मार्ट कॉन्ट्रॅक्टची आवश्यकता असेल. जर तुम्हाला स्वतः एक प्रस्थापित करायचे असेल, तर आम्ही Alchemy च्या [Sepolia वर स्मार्ट कॉन्ट्रॅक्ट प्रस्थापित करणे](https://www.alchemy.com/docs/how-to-deploy-a-smart-contract-to-the-sepolia-testnet) या मार्गदर्शकाची शिफारस करतो.
...
या ट्युटोरिअलसाठी, आम्ही मेटामास्क वापरू, जे तुमच्या इथेरियम खात्याचा पत्ता व्यवस्थापित करण्यासाठी ब्राउझरमधील एक व्हर्च्युअल वॉलेट आहे. जर तुम्हाला इथेरियमवरील व्यवहार कसे काम करतात याबद्दल अधिक समजून घ्यायचे असेल, तर [हे पेज](/developers/docs/transactions/) तपासा.

तुम्ही [येथे](https://metamask.io/download) मोफत मेटामास्क डाउनलोड करू शकता आणि खाते तयार करू शकता. जेव्हा तुम्ही खाते तयार करत असाल, किंवा जर तुमच्याकडे आधीपासूनच खाते असेल, तर Sepolia सारख्या सपोर्टेड टेस्ट नेटवर्कवर स्विच करण्याची खात्री करा \(जेणेकरून आम्ही खऱ्या पैशांशी व्यवहार करत नाही\).
### फॉसेटमधून इथर जोडा

आमचे NFTs मिंट करण्यासाठी (किंवा इथेरियम ब्लॉकचेनवर कोणत्याही व्यवहारांवर स्वाक्षरी करण्यासाठी), आम्हाला काही बनावट ETH ची आवश्यकता असेल. टेस्टनेट ETH मिळवण्यासाठी, [Alchemy Sepolia फॉसेट](https://www.alchemy.com/faucets/ethereum-sepolia) सारखा मेंटेन केलेला फॉसेट वापरा आणि तुमचा Sepolia खाते पत्ता एंटर करा. त्यानंतर थोड्याच वेळात तुम्हाला तुमच्या मेटामास्क खात्यात ETH दिसेल!
आपली शिल्लक तिथे आहे की नाही हे पुन्हा तपासण्यासाठी, [Alchemy च्या सँडबॉक्स टूल](https://sandbox.alchemy.com/?network=ETH_SEPOLIA&method=eth_getBalance&body.id=1&body.jsonrpc=2.0&body.method=eth_getBalance&body.params%5B0%5D=&body.params%5B1%5D=latest) चा वापर करून [eth_getBalance](https://www.alchemy.com/docs/chains/ethereum/ethereum-api-endpoints/eth-get-balance) विनंती करूया. हे आपल्या वॉलेटमधील ETH ची रक्कम परत करेल. तुम्ही तुमचा मेटामास्क खाते पत्ता टाकल्यानंतर आणि “Send Request” वर क्लिक केल्यानंतर, तुम्हाला असा प्रतिसाद दिसेल:

```text
{"jsonrpc": "2.0", "id": 0, "result": "0xde0b6b3a7640000"}
```

**टीप:** हा निकाल Wei मध्ये आहे, ETH मध्ये नाही. Wei हे इथरचे सर्वात लहान मूल्य म्हणून वापरले जाते. Wei मधून ETH मध्ये रूपांतरण असे आहे: 1 ETH = 10¹⁸ Wei. त्यामुळे जर आपण 0xde0b6b3a7640000 चे दशांश (decimal) मध्ये रूपांतर केले तर आपल्याला 1\*10¹⁸ मिळते जे 1 ETH च्या बरोबरीचे आहे.
...
एकदा तुम्ही Alchemy खाते तयार केले की, तुम्ही ॲप तयार करून API की जनरेट करू शकता. हे आम्हाला Sepolia टेस्ट नेटवर्कला विनंत्या करण्याची अनुमती देईल.

तुमच्या Alchemy डॅशबोर्डमधील “Create App” पेजवर जाण्यासाठी नॅव्हिगेशन बारमधील “Apps” वर होव्हर करा आणि “Create App” वर क्लिक करा.

तुमच्या ॲपला नाव द्या (आम्ही "My First NFT!" निवडले आहे), एक छोटे वर्णन द्या, तुमच्या ॲपच्या बुककीपिंगसाठी वापरल्या जाणाऱ्या एन्वायरमेंटसाठी “Staging” निवडा आणि तुमच्या नेटवर्कसाठी “Sepolia” निवडा.

“Create app” वर क्लिक करा आणि झाले! तुमचे ॲप खालील टेबलमध्ये दिसले पाहिजे.

उत्तम! आता आपण आपला HTTP Alchemy API URL तयार केला आहे, तो तुमच्या क्लिपबोर्डवर कॉपी करा...

...आणि नंतर तो आपल्या `.env` फाइलमध्ये जोडूया. एकूणच, तुमची .env फाइल अशी दिसली पाहिजे:
...
आता आपल्याकडे आपला कॉन्ट्रॅक्ट ABI आणि आपली Alchemy API की आहे, आपण [Alchemy Web3](https://github.com/alchemyplatform/alchemy-web3) वापरून आपले स्मार्ट कॉन्ट्रॅक्ट लोड करण्यास तयार आहोत.
...
## तुमचा NFT एका लाइव्ह वेबसाइटवर प्रस्थापित करा
वापरकर्त्यांना संवाद साधण्यासाठी तुमचा प्रोजेक्ट लाइव्ह करण्यासाठी तयार आहात? तुमचा Minter एका लाइव्ह वेबसाइटवर प्रस्थापित करण्यासाठी [React प्रस्थापना डॉक्युमेंटेशन](https://create-react-app.dev/docs/deployment/) तपासा.
...
कदाचित, तुम्हाला तुमच्या dapp द्वारे मिंट केलेले NFTs तुमच्या वॉलेटमध्ये दाखवायला आवडेल — त्यामुळे आमचे छोटे ट्युटोरिअल [तुमच्या वॉलेटमध्ये तुमचा NFT कसा पाहायचा](/developers/tutorials/how-to-view-nft-in-metamask/) नक्की तपासा!
