...
तुमच्या वॉलेटमध्ये ETH असल्याची खात्री करण्यासाठी, चला [Alchemy च्या composer टूलचा](https://composer.alchemyapi.io/?composer_state=%7B%22network%22%3A0%2C%22methodName%22%3A%22eth_getBalance%22%2C%22paramValues%22%3A%5B%22%22%2C%22latest%22%5D%7D) वापर करून [eth_getBalance](https://docs.alchemyapi.io/alchemy/documentation/alchemy-api-reference/json-rpc#eth_getbalance) विनंती करूया. हे आमच्या वॉलेटमधील ETH ची रक्कम परत करेल. अधिक जाणून घेण्यासाठी [composer टूल कसे वापरावे यावरील Alchemy चे छोटे ट्युटोरिअल](https://youtu.be/r6sjRxBZJuU) पहा.
...
अरे वा! आपले बनावट पैसे तिथे आहेत.

### पायरी 6: आपला प्रोजेक्ट इनिशियलाइझ करा {#step-6-initialize-our-project}

प्रथम, आपल्याला आपल्या प्रोजेक्टसाठी एक फोल्डर तयार करावे लागेल. तुमच्या कमांड लाइनवर जा आणि खालील प्रविष्ट करा.
...
आता आपण आपल्या प्रोजेक्ट फोल्डरमध्ये आहोत, आपण प्रोजेक्ट इनिशियलाइझ करण्यासाठी `npm init` वापरू.

> जर तुम्ही अद्याप npm इन्स्टॉल केले नसेल, तर [Node.js आणि npm इन्स्टॉल करण्यासाठी या सूचनांचे](https://docs.alchemyapi.io/alchemy/guides/alchemy-for-macs#1-install-nodejs-and-npm) अनुसरण करा.

या ट्युटोरिअलच्या उद्देशासाठी, तुम्ही इनिशियलायझेशन प्रश्नांची उत्तरे कशी देता याने काही फरक पडत नाही. संदर्भासाठी आम्ही ते कसे केले ते येथे आहे:
...
package.json ला मान्यता द्या आणि आपण पुढे जाण्यास तयार आहोत!
...
> व्यवहार पाठवण्याबद्दल अधिक जाणून घेण्यासाठी, Web3 वापरून व्यवहार पाठवण्यावरील [हे ट्युटोरिअल](https://www.alchemy.com/docs/hello-world-smart-contract#step-11-connect-metamask--alchemy-to-your-project) पहा.
...
Ethers.js ही एक लायब्ररी आहे जी [प्रमाणित JSON-RPC पद्धतींना](https://docs.alchemyapi.io/alchemy/documentation/alchemy-api-reference/json-rpc) अधिक वापरकर्ता-अनुकूल पद्धतींसह रॅप करून इथेरियमशी संवाद साधणे आणि विनंत्या करणे सोपे करते.
...
येथे तुम्हाला काही JSON-RPC पद्धती दिसतील ज्या Hardhat/Ethers ने आपल्यासाठी अंतर्गत तयार केल्या आहेत जेव्हा आपण `.deploy()` फंक्शन कॉल केले. येथील दोन महत्त्वाच्या पद्धती म्हणजे [`eth_sendRawTransaction`](https://docs.alchemyapi.io/alchemy/documentation/alchemy-api-reference/json-rpc#eth_sendrawtransaction), जी आपले कॉन्ट्रॅक्ट गोर्ली चेनवर लिहिण्याची विनंती आहे, आणि [`eth_getTransactionByHash`](https://docs.alchemyapi.io/alchemy/documentation/alchemy-api-reference/json-rpc#eth_gettransactionbyhash), जी हॅश दिल्यावर आपल्या व्यवहाराबद्दल माहिती वाचण्याची विनंती आहे. व्यवहार पाठवण्याबद्दल अधिक जाणून घेण्यासाठी, [Web3 वापरून व्यवहार पाठवण्यावरील आमचे ट्युटोरिअल](/developers/tutorials/sending-transactions-using-web3-and-alchemy/) पहा.
...
- [Alchemy Web3](https://docs.alchemy.com/alchemy/documentation/alchemy-web3) API वापरून तुमच्या स्मार्ट कॉन्ट्रॅक्टमधून डेटा वाचणे
...
तर तुम्हाला आठवत असेल की या ट्युटोरिअलच्या भाग 2 मध्ये, आम्ही आमच्या स्मार्ट कॉन्ट्रॅक्टमधून वाचण्यासाठी आमची [Alchemy Web3 की कशी वापरली होती](https://docs.alchemy.com/alchemy/tutorials/hello-world-smart-contract/interacting-with-a-smart-contract#step-1-install-web3-library)? चेनमधून वाचण्यासाठी तुम्हाला तुमच्या dapp मध्ये देखील Alchemy Web3 की ची आवश्यकता असेल.
...
[Alchemy Web3](https://github.com/alchemyplatform/alchemy-web3) हे [Web3.js](https://docs.web3js.org/) भोवती एक रॅपर आहे, जे वर्धित API पद्धती आणि इतर महत्त्वपूर्ण फायदे प्रदान करते जेणेकरून Web3 डेव्हलपर म्हणून तुमचे जीवन सोपे होईल. हे कमीत कमी कॉन्फिगरेशन आवश्यक असण्यासाठी डिझाइन केले आहे जेणेकरून तुम्ही ते तुमच्या ॲपमध्ये लगेच वापरण्यास सुरुवात करू शकता!

त्यानंतर, तुमच्या प्रोजेक्ट डिरेक्टरीमध्ये [dotenv](https://www.npmjs.com/package/dotenv) पॅकेज इन्स्टॉल करा, जेणेकरून आमची API की फेच केल्यानंतर ती स्टोअर करण्यासाठी आमच्याकडे एक सुरक्षित जागा असेल.

```text
npm install dotenv --save
```

आमच्या dapp साठी, **आम्ही आमच्या HTTP API की ऐवजी आमची Websockets API की वापरणार आहोत**, कारण यामुळे आम्हाला एक लिसनर सेट करण्याची अनुमती मिळेल जो स्मार्ट कॉन्ट्रॅक्टमध्ये स्टोअर केलेला संदेश बदलल्यावर शोधून काढेल.

एकदा तुमच्याकडे तुमची API की आली की, तुमच्या रूट डिरेक्टरीमध्ये एक `.env` फाइल तयार करा आणि त्यात तुमचा Alchemy Websockets url जोडा. त्यानंतर, तुमची `.env` फाइल अशी दिसावी:

```javascript
REACT_APP_ALCHEMY_KEY = wss://eth-goerli.ws.alchemyapi.io/v2/<की>
```

आता, आम्ही आमच्या dapp मध्ये आमचा Alchemy Web3 एंडपॉइंट सेट करण्यासाठी तयार आहोत! चला आमच्या `interact.js` वर परत जाऊया, जी आमच्या `util` फोल्डरमध्ये नेस्ट केलेली आहे आणि फाइलच्या शीर्षस्थानी खालील कोड जोडूया:
...
वर, आम्ही प्रथम आमच्या `.env` फाइलमधून Alchemy की इम्पोर्ट केली आणि नंतर आमचा Alchemy Web3 एंडपॉइंट स्थापित करण्यासाठी आमची `alchemyKey` `createAlchemyWeb3` ला पास केली.

हा एंडपॉइंट तयार झाल्यावर, आता आमचे स्मार्ट कॉन्ट्रॅक्ट लोड करण्याची वेळ आली आहे!
...
जर तुम्ही [या ट्युटोरिअल सिरीजच्या भाग 1](https://docs.alchemy.com/alchemy/tutorials/hello-world-smart-contract#step-10-write-our-contract) मध्ये आम्ही लिहिलेल्या `HelloWorld.sol` फाइलचा विचार केला, तर तुम्हाला आठवेल की `UpdatedMessages` नावाचा एक स्मार्ट कॉन्ट्रॅक्ट इव्हेंट आहे जो आमच्या स्मार्ट कॉन्ट्रॅक्टचे `update` फंक्शन इन्व्होक झाल्यानंतर एमिट केला जातो (ओळी 9 आणि 27 पहा):
...
आमचा बॅलन्स तिथे आहे हे पुन्हा तपासण्यासाठी, चला [Alchemy चे composer टूल](https://composer.alchemyapi.io/?composer_state=%7B%22network%22%3A0%2C%22methodName%22%3A%22eth_getBalance%22%2C%22paramValues%22%3A%5B%22%22%2C%22latest%22%5D%7D) वापरून एक [eth_getBalance](https://docs.alchemyapi.io/alchemy/documentation/alchemy-api-reference/json-rpc#eth_getbalance) विनंती करूया. हे आमच्या वॉलेटमधील Eth ची रक्कम परत करेल. तुम्ही तुमचा मेटामास्क खाते पत्ता प्रविष्ट केल्यानंतर आणि "Send Request" वर क्लिक केल्यानंतर, तुम्हाला असा प्रतिसाद दिसेल:

```text
{"jsonrpc": "2.0", "id": 0, "result": "0xde0b6b3a7640000"}
```

**टीप:** हा निकाल wei मध्ये आहे eth मध्ये नाही. Wei हे इथरचे सर्वात लहान मूल्य म्हणून वापरले जाते. wei चे eth मध्ये रूपांतरण असे आहे: 1 eth = 10¹⁸ wei. त्यामुळे जर आपण 0xde0b6b3a7640000 चे दशांश मध्ये रूपांतर केले तर आपल्याला 1\*10¹⁸ मिळते जे 1 eth च्या बरोबरीचे आहे.
