...
பாதுகாப்பு சமூகத்தில் [ஃபஸ்ஸிங்](https://wikipedia.org/wiki/Fuzzing) என்பது நன்கு அறியப்பட்ட ஒரு நுட்பமாகும். நிரலில் உள்ள பிழைகளைக் கண்டறிய அதிகமாகவோ அல்லது குறைவாகவோ சீரற்ற உள்ளீடுகளை உருவாக்குவதை இது கொண்டுள்ளது. பாரம்பரிய மென்பொருளுக்கான ஃபஸ்ஸர்கள் ([AFL](http://lcamtuf.coredump.cx/afl/) அல்லது [LibFuzzer](https://llvm.org/docs/LibFuzzer.html) போன்றவை) பிழைகளைக் கண்டறியும் திறமையான கருவிகளாக அறியப்படுகின்றன.
...
- புதிய உள்ளீடுகளை உருவாக்க அறியப்பட்ட உள்ளீடுகளைப் பயன்படுத்துதல்: செல்லுபடியாகும் உள்ளீட்டின் பெரிய தரவுத்தொகுப்பிற்கான அணுகல் உங்களிடம் இருந்தால், உங்கள் ஃபஸ்ஸர் அதன் உருவாக்கத்தை முதலிலிருந்து தொடங்குவதற்குப் பதிலாக, அவற்றிலிருந்து புதிய உள்ளீடுகளை உருவாக்க முடியும். இவை பொதுவாக _விதைகள் (seeds)_ என்று அழைக்கப்படுகின்றன.

### பண்பு அடிப்படையிலான ஃபஸ்ஸிங் {#property-based-fuzzing}

எக்கிட்னா ஒரு குறிப்பிட்ட ஃபஸ்ஸர் குடும்பத்தைச் சேர்ந்தது: [QuickCheck](https://wikipedia.org/wiki/QuickCheck)-ஆல் பெரிதும் ஈர்க்கப்பட்ட பண்பு அடிப்படையிலான ஃபஸ்ஸிங். செயலிழப்புகளைக் கண்டறிய முயற்சிக்கும் கிளாசிக் ஃபஸ்ஸருக்கு மாறாக, எக்கிட்னா பயனர் வரையறுத்த மாறிலிகளை (invariants) உடைக்க முயற்சிக்கும்.
...
### எக்கிட்னா மூலம் ஒரு பண்பைச் சோதித்தல் {#testing-a-property-with-echidna}

எக்கிட்னா மூலம் ஒரு திறன் ஒப்பந்தத்தை எவ்வாறு சோதிப்பது என்பதைப் பார்ப்போம். இலக்கு பின்வரும் திறன் ஒப்பந்தம் ஆகும் [`token.sol`](https://github.com/crytic/building-secure-contracts/blob/master/program-analysis/echidna/example/token.sol):
...
- அது வெற்றிகரமாக இருந்தால் `true` என்பதை வழங்க வேண்டும்
...
- ஒரு பண்பு `false` என்பதை வழங்க அல்லது பிழையை எறிய வழிவகுக்கும் எந்தவொரு பரிவர்த்தனைகளையும் புகாரளிக்கும்.
...
[`token.sol`](https://github.com/crytic/building-secure-contracts/blob/master/program-analysis/echidna/example/token.sol) பண்பைச் செயல்படுத்துகிறது மற்றும் வில்லையிலிருந்து மரபுரிமையாகப் பெறுகிறது.

### ஒரு ஒப்பந்தத்தைத் தொடங்குதல் {#initiate-a-contract}

எக்கிட்னாவிற்கு வாதம் இல்லாத ஒரு [ஆக்கி](/developers/docs/smart-contracts/anatomy/#constructor-functions) தேவை. உங்கள் ஒப்பந்தத்திற்கு ஒரு குறிப்பிட்ட தொடக்கநிலை தேவைப்பட்டால், நீங்கள் அதை ஆக்கியில் செய்ய வேண்டும்.

எக்கிட்னாவில் சில குறிப்பிட்ட முகவரிகள் உள்ளன:

- `0x00a329c0648769A73afAc7F9381E08FB43dBEA72` இது ஆக்கியை அழைக்கிறது.
...
### எக்கிட்னாவை இயக்குதல் {#run-echidna}
...
இலக்கு பின்வரும் திறன் ஒப்பந்தம் ஆகும்:
...
இந்தச் சிறிய எடுத்துக்காட்டு ஒரு நிலை மாறியை மாற்ற ஒரு குறிப்பிட்ட பரிவர்த்தனைகளின் வரிசையைக் கண்டறிய எக்கிட்னாவைக் கட்டாயப்படுத்துகிறது.
இது ஒரு ஃபஸ்ஸருக்குக் கடினமானது ([மேண்டிகோர்](https://github.com/trailofbits/manticore) போன்ற குறியீட்டுச் செயலாக்கக் கருவியைப் பயன்படுத்தப் பரிந்துரைக்கப்படுகிறது).
...
### எக்கிட்னாவை இயக்குதல் {#run-echidna-1}
...
## எக்கிட்னா மூலம் Solidity-இன் உறுதிப்படுத்துதலை (assert) எவ்வாறு சோதிப்பது {#how-to-test-soliditys-assert-with-echidna}
...
### ஒரு உறுதிப்படுத்துதலை எழுதுதல் {#write-an-assertion}
...
### எக்கிட்னாவை இயக்குதல் {#run-echidna-2}

உறுதிப்படுத்துதல் தோல்விச் சோதனையை இயக்க, ஒரு [எக்கிட்னா உள்ளமைவுக் கோப்பை](https://github.com/crytic/echidna/wiki/Config) `config.yaml` உருவாக்கவும்:
...
### உறுதிப்படுத்துதல்களை எப்போது, எப்படிப் பயன்படுத்துவது {#when-and-how-use-assertions}
...
- `f` என்பது `internal` அல்லது `external` என அறிவிக்கப்பட்டால் அது தோல்வியடையும்.
- `f`-ஐ அழைக்க எந்த வாதங்களைப் பயன்படுத்த வேண்டும் என்பது தெளிவாக இல்லை.
- `f` மீளமைக்கப்பட்டால், பண்பு தோல்வியடையும்.

பொதுவாக, உறுதிப்படுத்துதல்களை எவ்வாறு பயன்படுத்துவது என்பது குறித்து [ஜான் ரெகரின் பரிந்துரையைப்](https://blog.regehr.org/archives/1091) பின்பற்றப் பரிந்துரைக்கிறோம்:

- உறுதிப்படுத்துதல் சரிபார்ப்பின் போது எந்தப் பக்க விளைவையும் கட்டாயப்படுத்த வேண்டாம். எடுத்துக்காட்டாக: `assert(ChangeStateAndReturn() == 1)`
- வெளிப்படையான அறிக்கைகளை உறுதிப்படுத்த வேண்டாம். எடுத்துக்காட்டாக `assert(var >= 0)` இதில் `var` என்பது `uint` என அறிவிக்கப்பட்டுள்ளது.
...
### சுருக்கம்: உறுதிப்படுத்துதல் சரிபார்ப்பு {#summary-assertion-checking}
...
## எக்கிட்னா கார்பஸைச் சேகரித்தல் மற்றும் மாற்றுதல் {#collecting-and-modifying-an-echidna-corpus}

எக்கிட்னா மூலம் பரிவர்த்தனைகளின் கார்பஸை (corpus) எவ்வாறு சேகரிப்பது மற்றும் பயன்படுத்துவது என்பதைப் பார்ப்போம். இலக்கு பின்வரும் திறன் ஒப்பந்தம் ஆகும் [`magic.sol`](https://github.com/crytic/building-secure-contracts/blob/master/program-analysis/echidna/example/magic.sol):
...
இந்தச் சிறிய எடுத்துக்காட்டு ஒரு நிலை மாறியை மாற்றக் குறிப்பிட்ட மதிப்புகளைக் கண்டறிய எக்கிட்னாவைக் கட்டாயப்படுத்துகிறது. இது ஒரு ஃபஸ்ஸருக்குக் கடினமானது
([மேண்டிகோர்](https://github.com/trailofbits/manticore) போன்ற குறியீட்டுச் செயலாக்கக் கருவியைப் பயன்படுத்தப் பரிந்துரைக்கப்படுகிறது).
இதைச் சரிபார்க்க நாம் எக்கிட்னாவை இயக்கலாம்:
...
மற்றும் ஒரு [எக்கிட்னா உள்ளமைவுக் கோப்பு](https://github.com/crytic/echidna/wiki/Config) `config.yaml`:
...
எக்கிட்னாவால் இன்னும் சரியான மேஜிக் மதிப்புகளைக் கண்டறிய முடியவில்லை, ஆனால் அது சேகரித்த கார்பஸை நாம் பார்க்கலாம்.
...
### கார்பஸுக்கு விதையிடுதல் {#seeding-a-corpus}
...
### எக்கிட்னாவை இயக்குதல் {#run-echidna-3}
...
- காட்டப்படும் எரிவாயு என்பது [HEVM](https://github.com/dapphub/dapptools/tree/master/src/hevm#hevm-) வழங்கிய மதிப்பீடாகும்.
