---
title: "ஒரு Solidity ஸ்மார்ட் ஒப்பந்தத்திலிருந்து ERC-20 டோக்கன்களின் பரிமாற்றங்கள் மற்றும் ஒப்புதல்"
description: "Solidity-ஐப் பயன்படுத்தி ERC-20 டோக்கன் பரிமாற்றங்கள் மற்றும் ஒப்புதல்களைக் கையாளும் ஒரு DEX ஸ்மார்ட் ஒப்பந்தத்தை உருவாக்குங்கள்."
author: "jdourlens"
...
முந்தைய பயிற்சியில் Ethereum பிளாக்செயினில் [Solidity-இல் உள்ள ஒரு ERC-20 டோக்கனின் உடற்கூறியல்](/developers/tutorials/understand-the-erc-20-token-smart-contract/) பற்றிப் படித்தோம். இந்தக் கட்டுரையில், Solidity மொழியைப் பயன்படுத்தி ஒரு டோக்கனுடன் தொடர்புகொள்ள ஒரு ஸ்மார்ட் ஒப்பந்தத்தை எவ்வாறு பயன்படுத்தலாம் என்பதைப் பார்ப்போம்.

இந்த ஸ்மார்ட் ஒப்பந்தத்திற்காக, புதிதாகப் பயன்படுத்தப்பட்ட [ERC-20 டோக்கனுக்கு](/developers/docs/standards/tokens/erc-20/) ஈதரை (ether) ஒரு பயனர் வர்த்தகம் செய்யக்கூடிய ஒரு உண்மையான மாதிரி பரவலாக்கப்பட்ட பரிமாற்றத்தை (decentralized exchange) உருவாக்குவோம்.
...
```python
# ### ஊடாடும் பிரவுனி கன்சோலில் பைதான்...

# DEX-ஐ நிலைநிறுத்தவும்
dex = DEX.deploy({'from':account1})

# ஈதரை டோக்கனாக மாற்ற buy செயல்பாட்டை அழைக்கவும்
# 1e18 என்பது wei-யில் குறிப்பிடப்படும் 1 ஈதர் ஆகும்
dex.buy({'from': account2, 1e18})

# ERC20 டோக்கனுக்கான நிலைநிறுத்தப்பட்ட முகவரியைப் பெறவும்
# இது DEX ஒப்பந்தம் உருவாக்கத்தின் போது நிலைநிறுத்தப்பட்டது
# dex.token() டோக்கனுக்கான நிலைநிறுத்தப்பட்ட முகவரியை வழங்குகிறது
token = ERC20Basic.at(dex.token())

# டோக்கனின் approve செயல்பாட்டை அழைக்கவும்
# dex முகவரியை செலவிடுபவராக அங்கீகரிக்கவும்
# மேலும் இது உங்களின் எத்தனை டோக்கன்களை செலவிட அனுமதிக்கப்படுகிறது
...
நீங்கள் ஒரு பரிவர்த்தனையைச் செய்தவுடன், உங்கள் ஒப்பந்தத்தில் செய்யப்பட்ட [பரிவர்த்தனைகளுக்காகக் காத்திருந்து அவற்றைப் பற்றிய விவரங்களைப் பெற](https://ethereumdev.io/waiting-for-a-transaction-to-be-mined-on-ethereum-with-js/) ஒரு JavaScript பயிற்சி எங்களிடம் உள்ளது, மேலும் உங்களிடம் ABI இருக்கும் வரை [டோக்கன் பரிமாற்றங்கள் அல்லது வேறு ஏதேனும் நிகழ்வுகளால் உருவாக்கப்பட்ட நிகழ்வுகளை டிகோட் செய்வதற்கான பயிற்சியும்](https://ethereumdev.io/how-to-decode-event-logs-in-javascript-using-abi-decoder/) உள்ளது.
