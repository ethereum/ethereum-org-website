...
வலதுபுறத்தில் காட்டப்பட்டுள்ளபடி [Web3 இல் உள்ள நிகழ்வை](https://docs.web3js.org/api/web3/class/Contract#events) நாம் கவனிக்கலாம், ஆனால் இதற்குச் சில பல நிகழ்வுகளைக் கையாள வேண்டியிருக்கும்.
...
## துணை வரைபடத்தை எவ்வாறு உருவாக்குவது {#how-to-create-a-subgraph}
...
வசதிக்காக நீங்கள் mustache போன்ற டெம்ப்ளேட் கருவியைப் பயன்படுத்த விரும்பலாம். பின்னர் நீங்கள் ஒரு `subgraph.template.yaml` ஐ உருவாக்கி, சமீபத்திய நிலைநிறுத்தங்களின் அடிப்படையில் முகவரிகளைச் செருகலாம். மிகவும் மேம்பட்ட உதாரண அமைப்பிற்கு, [ஆவே துணை வரைபடக் களஞ்சியத்தைப்](https://github.com/aave/aave-protocol/tree/master/thegraph) பார்க்கவும்.
...
உறவுகளை வரையறுக்க நீங்கள் உருப்படிகளை வகையாகவும் பயன்படுத்தலாம். நமது எடுத்துக்காட்டில், வீரருக்கும் பந்தயங்களுக்கும் இடையே 1-க்கு-பல (1-to-many) உறவை வரையறுக்கிறோம். ! என்பது மதிப்பு காலியாக இருக்க முடியாது என்பதைக் குறிக்கிறது. முழுமையான ஆவணங்களை [இங்கே](https://thegraph.com/docs/en/developing/creating-a-subgraph/#the-subgraph-manifest) காணலாம்.
...
முழுமையான ஆவணங்களை இங்கே காணலாம்: https://thegraph.com/docs/en/developing/creating-a-subgraph/#writing-mappings. மேப்பிங் கோப்பில் லாக்கிங் வெளியீட்டையும் நீங்கள் சேர்க்கலாம், [இங்கே](https://thegraph.com/docs/en/subgraphs/developing/creating/graph-ts/api/#api-reference) பார்க்கவும்.
...
### Graph Explorer: வழங்கப்பட்ட சேவை {#graph-explorer-the-hosted-service}

வழங்கப்பட்ட சேவையைப் பயன்படுத்துவதே எளிதான வழியாகும். துணை வரைபடத்தை நிலைநிறுத்த [இங்கே](https://thegraph.com/docs/en/deploying/deploying-a-subgraph-to-hosted/) உள்ள வழிமுறைகளைப் பின்பற்றவும். பல திட்டங்களுக்கு நீங்கள் [எக்ஸ்ப்ளோரரில்](https://thegraph.com/explorer/) ஏற்கனவே உள்ள துணை வரைபடங்களைக் கண்டறியலாம்.

![The Graph-Explorer](./thegraph-explorer.png)

### உங்கள் சொந்த கணுவை இயக்குதல் {#running-your-own-node}

மாற்றாக நீங்கள் உங்கள் சொந்த கணுவை இயக்கலாம். ஆவணங்கள் [இங்கே](https://github.com/graphprotocol/graph-node#quick-start) உள்ளன. வழங்கப்பட்ட சேவையால் ஆதரிக்கப்படாத பிணையத்தைப் பயன்படுத்துவது இதைச் செய்வதற்கான ஒரு காரணமாக இருக்கலாம். தற்போது ஆதரிக்கப்படும் பிணையங்களை [இங்கே காணலாம்](https://thegraph.com/docs/en/developing/supported-networks/).

## பரவலாக்கப்பட்ட எதிர்காலம் {#the-decentralized-future}

புதிதாக வரும் நிகழ்வுகளுக்கான ஸ்ட்ரீம்களையும் GraphQL ஆதரிக்கிறது. இவை தற்போது திறந்த பீட்டாவில் உள்ள [Substreams](https://thegraph.com/docs/en/substreams/) மூலம் வரைபடத்தில் ஆதரிக்கப்படுகின்றன.

[2021](https://thegraph.com/blog/mainnet-migration/) இல் The Graph பரவலாக்கப்பட்ட குறியீட்டுப் பிணையமாக மாறுவதைத் தொடங்கியது. இந்தப் பரவலாக்கப்பட்ட குறியீட்டுப் பிணையத்தின் கட்டமைப்பைப் பற்றி [இங்கே](https://thegraph.com/docs/en/network/explorer/) நீங்கள் மேலும் படிக்கலாம்.
