...
உங்கள் பணப்பையில் ETH இருப்பதை இருமுறை சரிபார்க்க, [Alchemy-யின் composer கருவியைப்](https://composer.alchemyapi.io/?composer_state=%7B%22network%22%3A0%2C%22methodName%22%3A%22eth_getBalance%22%2C%22paramValues%22%3A%5B%22%22%2C%22latest%22%5D%7D) பயன்படுத்தி ஒரு [eth_getBalance](https://docs.alchemyapi.io/alchemy/documentation/alchemy-api-reference/json-rpc#eth_getbalance) கோரிக்கையைச் செய்வோம். இது நமது பணப்பையில் உள்ள ETH அளவை வழங்கும். மேலும் அறிய, [composer கருவியை எவ்வாறு பயன்படுத்துவது என்பது குறித்த Alchemy-யின் சிறிய டுடோரியலைப்](https://youtu.be/r6sjRxBZJuU) பார்க்கவும்.

உங்கள் மெட்டாமேஸ்க் கணக்கு முகவரியை உள்ளிட்டு **Send Request** என்பதைக் கிளிக் செய்யவும். கீழே உள்ள குறியீட்டுத் துணுக்கைப் போன்ற ஒரு பதிலைக் காண்பீர்கள்.
...
அப்பாடா! நமது போலி பணம் அனைத்தும் அங்கு உள்ளது.

### படி 6: நமது திட்டத்தைத் தொடங்கவும் {#step-6-initialize-our-project}
...
இப்போது நாம் நமது திட்டக் கோப்புறைக்குள் இருப்பதால், திட்டத்தைத் தொடங்க `npm init` ஐப் பயன்படுத்துவோம்.

> நீங்கள் இன்னும் npm-ஐ நிறுவவில்லை என்றால், [Node.js மற்றும் npm-ஐ நிறுவ இந்த வழிமுறைகளைப் பின்பற்றவும்](https://docs.alchemyapi.io/alchemy/guides/alchemy-for-macs#1-install-nodejs-and-npm).
...
Ethers.js என்பது [நிலையான JSON-RPC முறைகளை](https://docs.alchemyapi.io/alchemy/documentation/alchemy-api-reference/json-rpc) அதிக பயனர் நட்பு முறைகளுடன் மூடுவதன் மூலம் எத்திரியத்துடன் தொடர்புகொள்வதையும் கோரிக்கைகளைச் செய்வதையும் எளிதாக்கும் ஒரு நூலகமாகும்.
...
நாம் `.deploy()` செயல்பாட்டை அழைத்தபோது Hardhat/Ethers நமக்காக உட்புறமாக உருவாக்கிய சில JSON-RPC முறைகளை இங்கே காண்பீர்கள். இங்குள்ள இரண்டு முக்கியமான முறைகள் [`eth_sendRawTransaction`](https://docs.alchemyapi.io/alchemy/documentation/alchemy-api-reference/json-rpc#eth_sendrawtransaction), இது கோர்லி சங்கிலியில் நமது ஒப்பந்தத்தை எழுதுவதற்கான கோரிக்கையாகும், மற்றும் [`eth_getTransactionByHash`](https://docs.alchemyapi.io/alchemy/documentation/alchemy-api-reference/json-rpc#eth_gettransactionbyhash), இது ஹாஷ் கொடுக்கப்பட்ட நமது பரிவர்த்தனை பற்றிய தகவல்களைப் படிப்பதற்கான கோரிக்கையாகும். பரிவர்த்தனைகளை அனுப்புவது பற்றி மேலும் அறிய, [Web3-ஐப் பயன்படுத்தி பரிவர்த்தனைகளை அனுப்புவது குறித்த நமது டுடோரியலைப்](/developers/tutorials/sending-transactions-using-web3-and-alchemy/) பார்க்கவும்.
...
- [Alchemy Web3](https://docs.alchemy.com/alchemy/documentation/alchemy-web3) API-ஐப் பயன்படுத்தி உங்கள் திறன் ஒப்பந்தத்திலிருந்து தரவைப் படிப்பது
...
#### எத்திரியம் சங்கிலியுடன் API இணைப்பை ஏற்படுத்தவும் {#establish-an-api-connection-to-the-ethereum-chain}

இந்த வழிகாட்டியின் பகுதி 2-இல், [எங்கள் திறன் ஒப்பந்தத்திலிருந்து படிக்க எங்கள் Alchemy Web3 திறவுகோலை](https://docs.alchemy.com/alchemy/tutorials/hello-world-smart-contract/interacting-with-a-smart-contract#step-1-install-web3-library) எவ்வாறு பயன்படுத்தினோம் என்பது நினைவிருக்கிறதா? சங்கிலியிலிருந்து படிக்க உங்கள் dapp-இலும் ஒரு Alchemy Web3 திறவுகோல் தேவைப்படும்.

உங்களிடம் அது ஏற்கனவே இல்லையென்றால், முதலில் உங்கள் `starter-files`-இன் மூலக் கோப்பகத்திற்குச் சென்று உங்கள் முனையத்தில் பின்வருவனவற்றை இயக்குவதன் மூலம் [Alchemy Web3](https://github.com/alchemyplatform/alchemy-web3)-ஐ நிறுவவும்:

```text
npm install @alch/alchemy-web3
```

[Alchemy Web3](https://github.com/alchemyplatform/alchemy-web3) என்பது [Web3.js](https://docs.web3js.org/)-ஐச் சுற்றியுள்ள ஒரு ரேப்பர் (wrapper) ஆகும், இது மேம்பட்ட API முறைகள் மற்றும் பிற முக்கியமான நன்மைகளை வழங்கி Web3 டெவலப்பராக உங்கள் வாழ்க்கையை எளிதாக்குகிறது. இது குறைந்தபட்ச உள்ளமைவு தேவைப்படும் வகையில் வடிவமைக்கப்பட்டுள்ளது, எனவே நீங்கள் அதை உடனடியாக உங்கள் செயலியில் பயன்படுத்தத் தொடங்கலாம்!

பின்னர், உங்கள் திட்டக் கோப்பகத்தில் [dotenv](https://www.npmjs.com/package/dotenv) தொகுப்பை நிறுவவும், இதனால் எங்கள் API திறவுகோலைப் பெற்ற பிறகு அதைச் சேமிக்க ஒரு பாதுகாப்பான இடம் கிடைக்கும்.

```text
npm install dotenv --save
```

எங்கள் dapp-க்கு, எங்கள் HTTP API திறவுகோலுக்குப் பதிலாக **எங்கள் Websockets API திறவுகோலைப் பயன்படுத்துவோம்**, ஏனெனில் திறன் ஒப்பந்தத்தில் சேமிக்கப்பட்டுள்ள செய்தி மாறும்போது அதைக் கண்டறியும் ஒரு கேட்பானை அமைக்க இது எங்களை அனுமதிக்கும்.

உங்கள் API திறவுகோலைப் பெற்றவுடன், உங்கள் மூலக் கோப்பகத்தில் ஒரு `.env` கோப்பை உருவாக்கி, அதில் உங்கள் Alchemy Websockets url-ஐச் சேர்க்கவும். அதன் பிறகு, உங்கள் `.env` கோப்பு இப்படி இருக்க வேண்டும்:

```javascript
REACT_APP_ALCHEMY_KEY = wss://eth-goerli.ws.alchemyapi.io/v2/<திறவுகோல்>
```

இப்போது, எங்கள் dapp-இல் எங்கள் Alchemy Web3 இறுதிப்புள்ளியை (endpoint) அமைக்க நாங்கள் தயாராக உள்ளோம்! எங்கள் `util` கோப்புறைக்குள் உள்ளமைக்கப்பட்டுள்ள எங்கள் `interact.js`-க்குத் திரும்பிச் சென்று, கோப்பின் மேற்புறத்தில் பின்வரும் குறியீட்டைச் சேர்ப்போம்:
...
மேலே, நாங்கள் முதலில் எங்கள் `.env` கோப்பிலிருந்து Alchemy திறவுகோலை இறக்குமதி செய்தோம், பின்னர் எங்கள் Alchemy Web3 இறுதிப்புள்ளியை நிறுவ எங்கள் `alchemyKey`-ஐ `createAlchemyWeb3`-க்கு அனுப்பினோம்.

இந்த இறுதிப்புள்ளி தயாரானவுடன், எங்கள் திறன் ஒப்பந்தத்தை ஏற்றுவதற்கான நேரம் இது!
...
[இந்த வழிகாட்டித் தொடரின் பகுதி 1](https://docs.alchemy.com/alchemy/tutorials/hello-world-smart-contract#step-10-write-our-contract)-இல் நாங்கள் எழுதிய `HelloWorld.sol` கோப்பை நீங்கள் நினைத்துப் பார்த்தால், எங்கள் திறன் ஒப்பந்தத்தின் `update` சார்பு அழைக்கப்பட்ட பிறகு உமிழப்படும் (emitted) `UpdatedMessages` என்ற திறன் ஒப்பந்த நிகழ்வு இருப்பதை நீங்கள் நினைவுகூருவீர்கள் \(வரிகள் 9 மற்றும் 27-ஐப் பார்க்கவும்\):
...
எங்கள் இருப்பு அங்கு உள்ளதா என்பதை இருமுறை சரிபார்க்க, [Alchemy-இன் composer கருவியைப்](https://composer.alchemyapi.io/?composer_state=%7B%22network%22%3A0%2C%22methodName%22%3A%22eth_getBalance%22%2C%22paramValues%22%3A%5B%22%22%2C%22latest%22%5D%7D) பயன்படுத்தி ஒரு [eth_getBalance](https://docs.alchemyapi.io/alchemy/documentation/alchemy-api-reference/json-rpc#eth_getbalance) கோரிக்கையை மேற்கொள்வோம். இது எங்கள் பணப்பையில் உள்ள ETH அளவை வழங்கும். உங்கள் மெட்டாமேஸ்க் கணக்கு முகவரியை உள்ளிட்டு “Send Request”-ஐக் கிளிக் செய்த பிறகு, இது போன்ற ஒரு பதிலைக் காண்பீர்கள்:

```text
{"jsonrpc": "2.0", "id": 0, "result": "0xde0b6b3a7640000"}
```

**குறிப்பு:** இந்த முடிவு wei-இல் உள்ளது, eth-இல் அல்ல. Wei என்பது ஈதரின் மிகச்சிறிய மதிப்பாகப் பயன்படுத்தப்படுகிறது. wei-இலிருந்து eth-க்கு மாற்றுவது: 1 eth = 10¹⁸ wei. எனவே 0xde0b6b3a7640000-ஐ தசமமாக மாற்றினால் 1\*10¹⁸ கிடைக்கும், இது 1 eth-க்குச் சமம்.
