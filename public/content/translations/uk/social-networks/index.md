...
Децентралізовані соціальні мережі - це клас [децентралізованих додатків (dapps)](/apps/) - додатків, що працюють на основі [розумних контрактів](/glossary/#smart-contract), розгорнутих на блокчейні. Код контракту служить основою для цих програм і визначає їх бізнес-логіку.
