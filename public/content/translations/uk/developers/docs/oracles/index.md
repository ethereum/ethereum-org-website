...
##### Голосування/стейкінг щодо точності даних {#availability}
...
##### Механізми фокальної точки (точки Шеллінга) {#good-incentive-compatibility}
...
### Доступність {#applications-of-oracles-in-smart-contracts}
...
### Хороша сумісність стимулів {#retrieving-financial-data}
...
## Застосування оракулів у смарт-контрактах {#generating-verifiable-randomness}

Нижче наведено поширені варіанти використання оракулів в Етеріумі:

### Отримання фінансових даних {#getting-outcomes-for-events}
...
### Генерація випадковості, яку можна перевірити {#automating-smart-contracts}
...
### Отримання результатів для подій {#use-blockchain-oracles}
...
### Автоматизація смарт-контрактів {#further-reading}
