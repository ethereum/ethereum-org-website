...
![Схема налаштування клієнта](./diagram.png)
...
#### Готові рішення (plug-and-play) {#plug-and-play}
...
## Розгортання вузла {#spinning-up-node}
...
### Кероване налаштування {#automatized-setup}
...
### Робота з вузлом {#operating-the-node}
...
#### Підтримка вузла в мережі {#keeping-node-online}
...
#### Запуск додаткових сервісів {#running-additional-services}
