...
#### Отримання програмного забезпечення клієнта {#getting-the-client}
...
#### Робота клієнта виконання {#running-an-execution-client}
...
#### Робота клієнта консенсусу {#running-a-consensus-client}
...
#### Створення служб клієнтів {#creating-client-services}
