...
#### 3. Кросчейн-виклики контрактів {#cross-chain-contract-calls}
...
## Як оптимістичні ролапи масштабують Етеріум? {#scaling-ethereum-with-optimistic-rollups}
...
### Переваги та недоліки оптимістичних ролапів {#optimistic-rollups-pros-and-cons}
...
### Візуальне пояснення оптимістичних ролапів {#optimistic-video}
