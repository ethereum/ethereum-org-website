...
##### Генерація доказів {#entries-and-exits}
...
##### Перевірка доказів {#zk-rollups-and-evm-compatibility}
...
### Входи та виходи {#how-do-zk-rollup-fees-work}
...
## ZK-ролапи та сумісність з EVM {#scaling-ethereum-with-zk-rollups}
...
## Як працюють комісії ZK-ролапів? {#transaction-data-compression}
...
## Як ZK-ролапи масштабують Етеріум? {#recursive-proofs}

### Стиснення даних транзакцій {#zk-rollups-pros-and-cons}
...
### Переваги та недоліки ZK-ролапів {#zkevm-projects}
...
### Візуальне пояснення ZK-ролапів {#further-reading-on-zk-rollups}
...
## Хто працює над zkEVM? {#tutorials}
