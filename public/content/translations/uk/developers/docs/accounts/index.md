...
## Огляд акаунта {#an-account-examined}
...
## Зовнішньо керовані акаунти та пари ключів {#externally-owned-accounts-and-key-pairs}
...
## Додаткове читання {#further-reading}
