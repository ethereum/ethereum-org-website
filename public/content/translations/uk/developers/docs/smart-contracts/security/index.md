...
##### Використання гаманців з мультипідписом {#use-require-assert-revert}
...
### 2. Використовуйте оператори require(), assert() та revert() для захисту операцій контракту {#test-smart-contracts-and-verify-code-correctness}
...
### 3. Тестуйте смарт-контракти та перевіряйте правильність коду {#get-independent-code-reviews}
...
### 4. Зверніться за незалежною перевіркою вашого коду {#audits}
...
#### Програми винагород за виявлення помилок (Bug bounties) {#follow-smart-contract-development-best-practices}
...
### 5. Дотримуйтесь найкращих практик під час розробки смарт-контрактів {#implement-disaster-recovery-plans}
...
### 6. Впроваджуйте надійні плани аварійного відновлення {#contract-upgrades}
...
#### Оновлення контрактів {#emergency-stops}
...
#### Аварійні зупинки {#event-monitoring}
...
#### Моніторинг подій {#design-secure-governance-systems}
...
### 7. Проєктуйте безпечні системи управління {#reduce-code-complexity}
...
### 8. Зведіть складність коду до мінімуму {#mitigate-common-smart-contract-vulnerabilities}
...
### 9. Захищайтеся від поширених вразливостей смарт-контрактів {#reentrancy}

#### Повторний вхід {#integer-underflows-and-overflows}
...
##### Як запобігти атакам повторного входу {#oracle-manipulation}
...
#### Недостачі та переповнення цілих чисел {#smart-contract-security-resources-for-developers}
...
##### Як запобігти недостачам і переповненням цілих чисел {#code-analysis-tools}
...
#### Маніпулювання оракулом {#smart-contract-monitoring-tools}
...
##### Як запобігти маніпулюванню оракулом {#smart-contract-administration-tools}
...
## Ресурси з безпеки смарт-контрактів для розробників {#smart-contract-auditing-services}

### Інструменти для аналізу смарт-контрактів та перевірки правильності коду {#bug-bounty-platforms}
...
### Інструменти для моніторингу смарт-контрактів {#common-smart-contract-vulnerabilities-and-exploits}
...
### Інструменти для безпечного адміністрування смарт-контрактів {#challenges-for-learning-smart-contract-security}
...
### Сервіси аудиту смарт-контрактів {#smart-contract-security-best-practices}
...
### Платформи bug bounty {#tutorials-on-smart-contract-security}
