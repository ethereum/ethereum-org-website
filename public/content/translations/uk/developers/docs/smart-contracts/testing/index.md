...
##### 1. Зрозумійте бізнес-логіку та робочий процес вашого контракту {#integration-testing-for-smart-contracts}
...
##### 2. Оцініть усі припущення, пов'язані з виконанням контракту {#property-based-testing-for-smart-contracts}
...
##### 3. Вимірюйте покриття коду {#static-analysis}
...
##### 4. Використовуйте добре розроблені фреймворки для тестування {#dynamic-analysis}
...
### Інтеграційне тестування {#running-property-based-tests}
...
### Тестування на основі властивостей {#manual-testing-for-smart-contracts}
...
#### Статичний аналіз {#testing-on-local-blockchain}
...
#### Динамічний аналіз {#testing-contracts-on-testnets}
...
### Рекомендації щодо проведення тестування на основі властивостей для смарт-контрактів {#testing-vs-formal-verification}
...
## Ручне тестування смарт-контрактів {#testing-vs-audits-bug-bounties}
...
### Тестування контрактів на локальному блокчейні {#testing-tools-and-libraries}
...
### Тестування контрактів у тестових мережах {#unit-testing-tools}
...
## Тестування та формальна верифікація {#property-based-testing-tools}
...
## Тестування, аудити та програми винагород за знайдені помилки (bug bounties) {#static-analysis-tools}
...
## Інструменти та бібліотеки для тестування {#dynamic-analysis-tools}

### Інструменти для модульного тестування {#related-tutorials}
...
### Інструменти для тестування на основі властивостей {#further-reading}

#### Інструменти статичного аналізу {#tutorials}
