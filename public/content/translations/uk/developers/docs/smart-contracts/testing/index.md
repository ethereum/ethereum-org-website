...
Запуск тестування на основі властивостей зазвичай починається з визначення властивості (наприклад, відсутність [цілочисельних переповнень](https://github.com/ConsenSysDiligence/mythril/wiki/Integer-Overflow)) або набору властивостей, які ви хочете перевірити в смарт-контракті. Вам також може знадобитися визначити діапазон значень, у межах яких програма може генерувати дані для вхідних транзакцій під час написання тестів властивостей.
...
- **[Символічне виконання смарт-контрактів за допомогою Mythril](https://github.com/ConsenSysDiligence/mythril/blob/develop/docs/source/tutorial.rst)**
...
- **[Mythril](https://github.com/ConsenSysDiligence/mythril)** — _інструмент оцінки байт-коду EVM для виявлення вразливостей контракту за допомогою аналізу забруднення, конколічного аналізу та перевірки потоку керування._
