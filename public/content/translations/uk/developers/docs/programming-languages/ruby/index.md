---
title: Етеріум для розробників на Ruby
description: Дізнайтеся, як розробляти для Етеріуму, використовуючи проєкти та інструменти на базі Ruby.
lang: uk
incomplete: false
---

<FeaturedText>Дізнайтеся, як розробляти для Етеріуму, використовуючи проєкти та інструменти на базі Ruby.</FeaturedText>
...
- [Блокчейн-застосунок на Ruby](https://www.nopio.com/blog/blockchain-app-ruby/)
- [Використання Ruby, підключеного до Етеріуму, для виконання смарт-контракту](https://titanwolf.org/Network/Articles/Article?AID=87285822-9b25-49d5-ba2a-7ad95fff7ef9)
