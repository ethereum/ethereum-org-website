...
- [Взаємодія .NET та смарт-контрактів блокчейну Етеріуму за допомогою Nethereum](https://medium.com/my-blockchain-development-daily-journey/interfacing-net-and-ethereum-blockchain-smart-contracts-with-nethereum-2fa3729ac933), також доступно [китайською](https://medium.com/my-blockchain-development-daily-journey/%E4%BD%BF%E7%94%A8nethereum%E9%80%A3%E6%8E%A5-net%E5%92%8C%E4%BB%A5%E5%A4%AA%E7%B6%B2%E5%8D%80%E5%A1%8A%E9%8F%88%E6%99%BA%E8%83%BD%E5%90%88%E7%B4%84-4a96d35ad1e1)
...
- [Nethereum Playground](https://playground.nethereum.com/) — взаємодійте з Етеріумом та дізнайтеся, як використовувати Nethereum через браузер.
...
- [Генерація коду за допомогою Nethereum та VS Code](https://docs.nethereum.com/docs/smart-contracts/code-generation/)
- [Unity та Етеріум: навіщо і як](https://www.raywenderlich.com/5509-unity-and-ethereum-why-and-how)
- [Створення Web API ASP.NET Core для децентралізованих застосунків (dapps) Етеріуму](https://tech-mint.com/blockchain/create-asp-net-core-web-api-for-ethereum-dapps/)
- [Фреймворк Nethereum MUD для структурованих ончейн-застосунків](https://docs.nethereum.com/docs/mud-framework/overview/)
- [Обробка блокчейну в Nethereum](https://docs.nethereum.com/docs/data-and-indexing/guide-blockchain-processing)
...
- [Nethereum Blazor](https://github.com/Nethereum/NethereumBlazor) — _легкий оглядач блокчейну та простий гаманець у вигляді SPA на .NET Wasm_
- [Wonka Business Rules Engine](https://github.com/Nethereum/Wonka) — _механізм бізнес-правил (як для платформи .NET, так і для платформи Етеріум), який за своєю суттю керується метаданими_
...
- [TestChains](https://github.com/Nethereum/TestChains) — _попередньо налаштовані ланцюги розробки .NET для швидкого реагування (доказ авторитету (PoA))_
