---
title: "Етеріум для Java-розробників"
description: "Дізнайтеся, як розробляти для Етеріуму, використовуючи проєкти та інструменти на базі Java"
lang: uk
incomplete: true
---

<FeaturedText>Дізнайтеся, як розробляти для Етеріуму, використовуючи проєкти та інструменти на базі Java</FeaturedText>
...
- [Керування сховищем у застосунку Java за допомогою IPFS](https://kauri.io/article/3e8494f4f56f48c4bb77f1f925c6d926/managing-storage-in-a-java-application-with-ipfs)
- [Керування токенами ERC-20 у Java за допомогою Web3j](https://kauri.io/article/d13e911bbf624108b1d5718175a5e0a0/manage-erc20-tokens-in-java-with-web3j)
...
- [Використання Eventeum для створення кешу даних смарт-контракту на Java](https://kauri.io/article/fe81ee9612eb4e5a9ab72790ef24283d/using-eventeum-to-build-a-java-smart-contract-data-cache)

## Проєкти та інструменти Java {#java-projects-and-tools}

- [Web3j (Бібліотека для взаємодії з клієнтами Етеріуму)](https://github.com/web3j/web3j)
- [ethers-kt (Асинхронна високопродуктивна бібліотека Kotlin/Java/Android для блокчейнів на базі EVM.)](https://github.com/Kr1ptal/ethers-kt)
