---
title: Етеріум для розробників на Python
description: Дізнайтеся, як розробляти для Етеріуму, використовуючи проєкти та інструменти на базі Python
lang: uk
incomplete: true
---

<FeaturedText>Дізнайтеся, як розробляти для Етеріуму, використовуючи проєкти та інструменти на базі Python</FeaturedText>
...
## Архівні статті {#archived-articles}

- [Розгорніть власний токен ERC-20 за допомогою Python та Brownie](https://betterprogramming.pub/python-blockchain-token-deployment-tutorial-create-an-erc20-77a5fd2e1a58)
...
- [Yearn Finance](https://yearn.finance/) та [репозиторій контрактів сховищ Yearn](https://github.com/yearn/yearn-vaults)
...
- [Alpha Finance](https://alphaventuredao.io/), відомий завдяки Alpha Homora, використовує [Brownie для тестування та розгортання смарт-контрактів](https://github.com/AlphaFinanceLab/alpha-staking-contract)

## Обговорення у спільноті Python {#python-community-contributors}

- [Discord спільноти Python для Етеріуму](https://discord.gg/9zk7snTfWe) для обговорення Web3.py та інших фреймворків Python
- [Discord Vyper](https://discord.gg/SdvKC79cJk) для обговорення програмування смарт-контрактів на Vyper
