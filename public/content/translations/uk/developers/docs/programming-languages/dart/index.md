---
title: "Етеріум для розробників на Dart"
description: "Дізнайтеся, як розробляти для Етеріуму за допомогою мови Dart"
lang: uk
incomplete: true
---
...
- [Flutter та блокчейн — Hello World Dapp](https://www.geeksforgeeks.org/flutter-and-blockchain-hello-world-dapp/) проведе вас через усі кроки для початку роботи:
  1.  Написання смарт-контракту на [Solidity](https://soliditylang.org/)
  2.  Написання інтерфейсу користувача на Dart
- [Створення мобільного децентралізованого застосунку (dapp) за допомогою Flutter](https://medium.com/dash-community/building-a-mobile-dapp-with-flutter-be945c80315a) набагато коротший, що може бути краще, якщо ви вже знаєте основи
- Якщо ви віддаєте перевагу навчанню за допомогою відео, ви можете переглянути [Створення вашого першого блокчейн-застосунку на Flutter](https://www.youtube.com/watch?v=3Eeh3pJ6PeA), яке триває близько години
- Якщо ви нетерплячі, вам може сподобатися [Створення децентралізованого блокчейн-застосунку за допомогою Flutter та Dart на Етеріумі](https://www.youtube.com/watch?v=jaMFEOCq_1s), яке триває лише близько двадцяти хвилин
