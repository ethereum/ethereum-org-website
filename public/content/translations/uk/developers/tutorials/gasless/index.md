...
На цьому етапі ви вже повинні вміти створювати взаємодію без сплати за газ для користувачів вашого децентралізованого застосунку (dapp), ціною певної централізації.

Однак це працює лише зі смарт-контрактами, які підтримують ERC-712. Наприклад, щоб переказати токен ERC-20, необхідно, щоб власник підписав транзакцію, а не просто повідомлення. Найпростіше рішення — зробити так, щоб активи належали не адресі EOA, а окремому контракту (проста форма [абстракції облікового запису](/roadmap/account-abstraction/)). Ви можете прочитати більше про це [у наступному посібнику](/developers/tutorials/gasless-token).
