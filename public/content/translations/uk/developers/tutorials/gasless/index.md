...
Однак це працює лише зі смарт-контрактами, які підтримують ERC-712. Наприклад, щоб переказати токен ERC-20, необхідно, щоб транзакцію підписав власник, а не просто повідомлення. Рішенням є [абстракція облікового запису (ERC-4337)](https://docs.erc4337.io/index.html). Я сподіваюся написати про це майбутній посібник.
