...
![Знімок панелі інструментів Grafana для моніторингу Geth (панель 1)](./grafana1.png)
...
![Знімок панелі інструментів Grafana для моніторингу Geth (панель 2)](./grafana2.png)

Джерел даних ще не створено; натисніть "Додати джерело даних", щоб його визначити.

![Знімок панелі інструментів Grafana для моніторингу Geth (панель 3)](./grafana3.png)

Для цього налаштування виберіть "InfluxDB" і продовжуйте.

![Знімок панелі інструментів Grafana для моніторингу Geth (панель 4)](./grafana4.png)
...
![Знімок панелі інструментів Grafana для моніторингу Geth (панель 5)](./grafana5.png)
...
![Знімок панелі інструментів Grafana для моніторингу Geth (панель 6)](./grafana6.png)
...
![Знімок панелі інструментів Grafana для моніторингу Geth (панель 7)](./grafana7.png)
...
![Знімок панелі інструментів Grafana для моніторингу Geth (панель 8)](./grafana8.png)
