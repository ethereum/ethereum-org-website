...
### SAML для людей з Ethereum {#saml-for-ethereum-people}
...
### Ethereum для людей з SAML {#ethereum-for-saml-people}
...
## Використання підписів Ethereum {#using-ethereum-signatures}
...
## Отримання адреси електронної пошти {#getting-the-email-address}
