...
Тут ми маємо два таких теги: `<Greeter />` (який фактично містить HTML-код, що взаємодіє з контрактом) та [`<HTML-PLACEHOLDER-HTMLTAG-8d9513 />` для горизонтальної лінії](https://www.w3schools.com/tags/tag_hr.asp).
