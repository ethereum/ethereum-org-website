...
Ви можете скористатися [chainlist.org](https://chainlist.org), щоб знайти RPC-дані мережі. Після додавання мережі та завершення транзакції ви побачите токени у своєму гаманці. <br />
