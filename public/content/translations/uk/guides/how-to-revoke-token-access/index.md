...
У цьому посібнику ви дізнаєтеся, як переглянути список усіх [смарт-контрактів](/glossary/#smart-contract), яким ви надали доступ до своїх коштів, і як їх скасувати.

Іноді зловмисники вбудовують у смартконтракти бекдори, що дають можливість отримати доступ до коштів необізнаних користувачів, які взаємодіють зі смартконтрактом. Часто трапляється, що такі платформи просять у користувача дозвіл витратити **необмежену кількість токенів**, щоб у майбутньому заощадити невелику кількість [газу](/glossary/#gas), але це пов’язано з підвищеним ризиком.

Щойно платформа отримує необмежені права доступу до токена у вашому [гаманці](/glossary/#wallet), вона може витратити всі ці токени, навіть якщо ви вивели свої кошти з її платформи на свій гаманець. Зловмисники все ще можуть отримати доступ до ваших коштів і вивести їх на свої гаманці, не залишивши вам жодних можливостей для відновлення.
...
- [Revoke](https://revoke.cash/) (декілька мереж)
- [Unrekt](https://app.unrekt.net/) (декілька мереж)
- [EverRevoke](https://everrise.com/everrevoke/) (декілька мереж)
...
Ні, це не вплине на жодну з ваших стратегій [DeFi](/glossary/#defi). Ви збережете свої позиції та й далі отримуватимете винагороди тощо.
