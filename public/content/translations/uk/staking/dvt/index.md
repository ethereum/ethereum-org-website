...
summaryPoints:
  ...
  - Інфраструктура промислового рівня, яка сьогодні використовується соло-стейкерами, сервісами стейкінгу та пулами для спільного стейкінгу
---
...
![Діаграма, що показує, як єдиний ключ валідатора розділяється на частки ключа та розподіляється між кількома вузлами з різними компонентами.](./dvt-cluster.png)
...
## DVT у промисловій експлуатації {#dvt-in-production}
