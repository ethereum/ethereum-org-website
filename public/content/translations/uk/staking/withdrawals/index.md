...
<AlertContent>
<AlertDescription>
<strong>Кожному обліковому запису валідатора можна призначити лише одну адресу для виведення й лише один раз.</strong> Після того, як адресу вибрано й надіслано на рівень консенсусу, це рішення не можна скасувати або змінити. Двічі перевірте право власності та правильність наданої адреси перед її надсиланням.
</AlertDescription>
</AlertContent>
</Alert>
...
eventName="read more">
Ні, процес надання облікових даних для виведення є одноразовим, і адресу не можна змінити після надсилання.
</ExpandableCard>
