...
**Виведення коштів зі стейкінгу** — це переказ ETH з облікового запису валідатора на рівні консенсусу Ethereum (Beacon Chain) на рівень виконання, на якому з ними можна здійснювати транзакції.

**Виплати винагород** за баланс понад 32 ETH будуть автоматично та регулярно надсилатися на адресу для виведення, пов'язану з кожним валідатором, після того, як користувач її надасть. Користувачі також можуть **повністю вийти зі стейкінгу**, розблокувавши повний баланс свого валідатора.
...
### Як підготуватися? Як можна конвертувати Eth після хардфорку? {#how-do-i-prepare}

<WithdrawalsTabComparison />

### Важливі повідомлення {#important-notices}
...
<AlertEmoji text="⚠️"/>
<AlertContent>
<AlertDescription><strong>Кожному обліковому запису валідатора можна призначити лише одну адресу для виведення й лише один раз.</strong> Після того, як адресу вибрано й надіслано на рівень консенсусу, це рішення не можна скасувати або змінити. Двічі перевірте право власності та правильність наданої адреси перед її надсиланням.
</AlertDescription>
</AlertContent>
</Alert>
...
Після позначення облікового запису для повного виведення коштів та надання відповідних даних для виведення користувачу потрібно лише чекати. Пропоненти блоків автоматично й безперервно обходять облікові записи на наявність коштів, що відповідають критеріям виведення, і баланс вашого облікового запису буде повністю переказано (що також відомо як «повне виведення») під час наступного <a href="#validator-sweeping" customEventOptions={{ eventCategory: "Anchor link", eventAction: "Exiting staking entirely (sweep)", eventName: "click" }}>обходу</a>.

## Коли було ввімкнено виведення коштів зі стейкінгу? {#when}

Функціонал виведення було активовано в межах оновлення Shanghai/Capella, яке відбулося **12 квітня 2023 року**.
...
- [Докладніше про дорожню карту Ethereum](/roadmap/)
...
### Обхід валідаторів {#validator-sweeping}
...
<AlertContent>
<AlertDescription>
Уявіть аналоговий годинник. Стрілка годинника вказує на годину, рухається в одному напрямку, не пропускає жодної години й зрештою повертається на початок після досягнення останнього числа.<br/><br/>
Тепер уявіть, що замість чисел від 1 до 12 годинник має числа від 0 до N <em>(загальна кількість облікових записів валідаторів, які коли-небудь були зареєстровані на рівні консенсусу, понад 500 000 станом на січень 2023 року).</em><br/><br/>
Стрілка на годиннику вказує на наступного валідатора, якого потрібно перевірити на наявність коштів, що відповідають критеріям для виведення. Стрілка починає з 0 і просувається повним колом, не пропускаючи жодного облікового запису. Коли буде досягнуто останній валідатор, цикл розпочнеться з початку.
</AlertDescription>
</AlertContent>
</Alert>

#### Перевірка можливості виведення з облікового запису {#checking-an-account-for-withdrawals}
...
1. **Чи надано адресу для виведення коштів?** Якщо адреса для виведення коштів не надана, обліковий запис пропускається, і виведення не ініціюється.
2. **Чи валідатор вийшов зі стейкінгу і чи доступне виведення?** Якщо валідатор повністю вийшов зі стейкінгу, і ми досягли епохи, коли його обліковий запис вважається «доступним для виведення», буде оброблено повне виведення коштів. Це переведе весь залишковий баланс на адресу виведення коштів.
3. **Чи досяг ефективний баланс максимального значення 32?** Якщо обліковий запис має облікові дані для виведення, не повністю вийшов зі стейкінгу та має винагороди понад 32, що очікують на виведення, буде оброблено часткове виведення, у межах якого на адресу користувача для виведення переказуються лише винагороди понад 32.
...
Цей підхід до виведення коштів під час стейкінгу не вимагає, щоб стейкери надсилали транзакції вручну для запиту на виведення певної суми ETH. Це означає, що **немає потреби в газі (комісії за транзакцію)**, а виведення коштів також не конкурує за наявний простір у блоках на рівні виконання.
...
<ExpandableCard
title="Надавши адресу для виведення, чи можу я змінити її на іншу?"
eventCategory="FAQ"
eventAction="Once I have provided a withdrawal address, can I change it to an alternative withdrawal address?"
eventName="read more">
Ні, процес надання облікових даних для виведення є одноразовим, і адресу не можна змінити після надсилання. </ExpandableCard>
...
eventName="read more">
Коли адресу виведення встановлено на рівні виконання, облікові дані виведення для цього валідатора змінюються назавжди. Це означає, що старі облікові дані більше не працюватимуть, а нові будуть спрямовані до облікового запису на виконавчому рівні.
...
Якщо ви є учасником [пулу для стейкінгу](/staking/pools/) або володієте токенами для стейкінгу, зверніться до свого провайдера за детальною інформацією про те, як обробляються виведення коштів зі стейкінгу, оскільки кожен сервіс працює по-різному.

Загалом, користувачі повинні мати змогу повернути основні поставлені ETH або змінити постачальника стейкінгу, яким вони користуються. Якщо певний пул стає надто великим, кошти можуть бути виведені, викуплені та знову застосовані з <a href="https://rated.network/">меншим постачальником</a>. Або, якщо ви накопичили достатньо ETH, ви можете [займатися стейкінгом з дому](/staking/solo/).

</ExpandableCard>

<ExpandableCard
title="Чи виплати винагород (часткове виведення) відбуваються автоматично?"
eventCategory="FAQ"
...
eventName="read more">
Виведення коштів спроєктовано так, щоб вони виконувались автоматично, переказуючи будь-яку кількість ETH, яка не бере активної участі у стейкінгу. Це, зокрема, повний баланс для облікових записів, які завершили процес виходу.

Неможливо вручну запитати конкретну суму ETH для виведення. </ExpandableCard>

<ExpandableCard
title="Я керую валідатором. Де я можу знайти більше інформації про ввімкнення виведення коштів?"
eventCategory="FAQ"
eventAction="I operate a validator. Де я можу знайти більше інформації про ввімкнення виведення коштів?"
eventName="read more">
...
Щоб спершу випробувати свої налаштування в тестовій мережі, відвідайте <a href="https://hoodi.launchpad.ethereum.org">Стартову платформу стейкінгу в тестовій мережі Hoodi</a>, щоб розпочати.
...
eventName="read more">
Ні. Після виходу валідатора й повного зняття його балансу будь-які додаткові кошти, внесені на цей валідатор, автоматично будуть переведені на адресу для виведення під час наступного проходження валідатора. Для повторного стейкінгу ETH потрібно активувати новий валідатор. </ExpandableCard>

## Для подальшого читання {#further-reading}

- [Виведення коштів на стартовій платформі стейкінгу](https://launchpad.ethereum.org/withdrawals)
- [EIP-4895: Примусове виведення коштів із Beacon Chain як операції](https://eips.ethereum.org/EIPS/eip-4895)
- [PEEPanEIP #94: Виведення застейканих ETH (тестування) з Potuz і Hsiao-Wei Wang](https://www.youtube.com/watch?v=G8UstwmGtyE)
- [PEEPanEIP № 68: EIP-4895: Примусове виведення коштів з Beacon Chain як операції з Alex Stokes](https://www.youtube.com/watch?v=CcL9RJBljUs)
