...
- [Zk-kit](https://zkkit.pse.dev/): Набір бібліотек (алгоритмів, допоміжних функцій та структур даних), які можна повторно використовувати в різних проєктах і протоколах з нульовим розголошенням.
