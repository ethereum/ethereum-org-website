...
Оновлення Прага-Електра ("Пектра") містило кілька вдосконалень протоколу Етеріум, спрямованих на покращення досвіду для всіх користувачів, мереж рівня 2 (l2), стейкерів та операторів вузлів.

Стейкінг отримав оновлення завдяки акаунтам валідаторів із компаундуванням та покращеному контролю над застейканими коштами за допомогою адреси виведення на рівні виконання. EIP-7251 збільшив максимальний ефективний баланс для одного валідатора до 2048, покращуючи ефективність капіталу для стейкерів. EIP-7002 дозволив акаунту виконання безпечно ініціювати дії валідатора, включаючи вихід або виведення частини коштів, що покращило досвід для стейкерів ETH, водночас допомагаючи посилити підзвітність операторів вузлів.

Інші частини оновлення були зосереджені на покращенні досвіду для звичайних користувачів. EIP-7702 надав можливість звичайному акаунту, що не є смарт-контрактом ([EOA](/glossary/#eoa)), виконувати код подібно до смарт-контракту. Це відкрило безмежні нові функціональні можливості для традиційних акаунтів Етеріум, такі як пакетування транзакцій, спонсорування газу, альтернативна автентифікація, програмований контроль витрат, механізми відновлення акаунтів та багато іншого.
...
<ul>
  ...
  <li><a href="https://eips.ethereum.org/EIPS/eip-7840">EIP-7840</a> - <em>Додавання розкладу блобів до конфігураційних файлів рівня виконання</em></li>
</ul>
...
- [Ознайомтеся зі специфікаціями оновлення Електра](https://github.com/ethereum/consensus-specs/tree/master/specs/electra/)
