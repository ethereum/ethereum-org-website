...
Web3 став універсальним терміном для концепції нового, кращого інтернету. По суті, Web3 використовує блокчейн, криптовалюти й NFT, щоб повернути владу користувачам завдяки праву власності. [У дописі у Twitter 2020 року](https://x.com/himgajria/status/1266415636789334016) прозвучало найкраще формулювання: мережа Web1 була лише для читання, Web2 — для читання та написання, Web3 дасть змогу читати, писати й володіти.
