...
sidebarDepth: 2
summaryPoints:
  - "Глобальна відкрита альтернатива наявній фінансовій системі."
  - "Продукти, що дають змогу позичати, заощаджувати, інвестувати, торгувати тощо."
  - "На основі технології з відкритим вихідним кодом, з якою програмувати може кожен."
---
