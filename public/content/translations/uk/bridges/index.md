...
<InfoBanner shouldCenter emoji=":bulb:">
  Ви також можете зробити все зазначене вище за допомогою [централізованого обмінника](/get-eth/). Але якщо ваші кошти вже не перебувають на біржі, це передбачає кілька кроків, і вам, імовірно, краще скористатися мостом.
</InfoBanner>
