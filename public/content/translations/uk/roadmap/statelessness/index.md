...
<ExpandableCard title="Чому нормально мати менше пропонувальників блоків?" eventCategory="/roadmap/statelessness" eventName="clicked why is it OK to rely on fewer block proposers?">
...
<ButtonLink variant="outline-color" href="https://notes.ethereum.org/WUUUXBKWQXORxpFMlLWy-w#So-why-is-it-ok-to-have-expensive-proposers">Читайте більше в нотатках Данкрада</ButtonLink>
</ExpandableCard>
...
zkEVM для перевірки L1 є взаємодоповнювальною технологією, яка може ще більше покращити бездержавну перевірку. Замість того, щоб просто перевіряти свідків, валідатори могли б перевіряти доказ із нульовим розголошенням того, що весь блок був виконаний правильно -- забезпечуючи криптографічну впевненість без повторного виконання транзакцій.
