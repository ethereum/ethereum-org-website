...
Непротокольні відносини між пропонентами та розробниками також створюють «гарячий шлях» під час перевірки блоків, що змушує [валідаторів](/glossary/#validator) поспішати з розповсюдженням і виконанням транзакцій у межах 2-секундного вікна, обмежуючи обсяг даних, які може обробляти мережа.
...
ePBS зменшує залежність від додаткового стороннього програмного забезпечення та дозволяє Ethereum безпечно обробляти значно більші обсяги даних (наприклад, більше блобів для [layer 2](/glossary/#layer-2) ), не створюючи навантаження на мережу.
