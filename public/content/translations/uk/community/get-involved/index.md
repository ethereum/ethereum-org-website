...
Маєте досвід у математиці, криптографії чи економіці? Вас може зацікавити передова робота, що ведеться в екосистемі Етеріуму:
...
Якщо ви не розробник, може бути важко зрозуміти, з чого почати в Етеріумі. Ось кілька пропозицій, а також ресурси для конкретних професійних напрямків.

### Організуйте мітап у своєму місті {#meetups}

- Не знаєте, з чого почати? Мережа [BUIDL network](https://consensys.net/developers/buidlnetwork/) може допомогти.
...
### Допоможіть покращити перекладений контент про Етеріум
...
Приєднуйтесь до тисяч операторів вузлів, допомагаючи ще більше децентралізувати Етеріум.
...
«DAO» — це децентралізовані автономні організації. Ці групи використовують технологію Етеріуму для сприяння організації та співпраці. Наприклад, для контролю членства, голосування за пропозиції або управління спільними активами. Хоча DAO все ще є експериментальними, вони пропонують вам можливості знайти групи, з якими ви себе ідентифікуєте, знайти співавторів і збільшити свій вплив на спільноту Етеріуму. [Більше про DAO](/dao/)

- [DAOSquare](https://daosquare.io/) [@DAOSquare](https://twitter.com/DAOSquare) — _Просування концепції DAO в нетехнічних сферах та допомога людям у створенні цінності через DAO_
- [Developer DAO](https://www.developerdao.com/) [@developer_dao](https://twitter.com/developer_dao) — _Спільнота розробників, які вірять у колективну власність на інтернет_
...
- [LexDAO](https://lexdao.org) [@lex_DAO](https://twitter.com/lex_DAO) — _Юридична інженерія_
- [MetaCartel Ventures](https://metacartel.xyz) [@VENTURE_DAO](https://twitter.com/VENTURE_DAO) — _Венчурний фонд для криптопроєктів на стадії pre-seed_
