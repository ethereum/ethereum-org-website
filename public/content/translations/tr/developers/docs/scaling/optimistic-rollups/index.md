...
##### Rollup'a giriş {#evm-compatibility}
...
##### Rollup'tan çıkış {#cross-chain-contract-calls}
...
#### 2. EVM uyumluluğu {#how-do-optimistic-rollup-fees-work}
...
#### 3. Zincirler arası sözleşme çağrıları {#scaling-ethereum-with-optimistic-rollups}
...
## İyimser rollup ücretleri nasıl çalışır? {#optimistic-rollups-pros-and-cons}
...
## İyimser rolluplar Ethereum'u nasıl ölçeklendirir? {#optimistic-video}
...
### İyimser rollupların artıları ve eksileri {#further-reading-on-optimistic-rollups}
...
### İyimser rollupların görsel bir açıklaması {#tutorials}
...
## Eğitimler: Ethereum'da iyimser rolluplar ve köprüler
