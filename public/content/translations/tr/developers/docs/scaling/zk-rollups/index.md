...
##### Kanıt üretimi {#entries-and-exits}
...
##### Kanıt doğrulaması {#zk-rollups-and-evm-compatibility}
...
### Girişler ve çıkışlar {#how-do-zk-rollup-fees-work}
...
## ZK-rollup'lar ve EVM uyumluluğu {#scaling-ethereum-with-zk-rollups}
...
## ZK-rollup ücretleri nasıl çalışır? {#transaction-data-compression}
...
## ZK-rollup'lar Ethereum'u nasıl ölçeklendirir? {#recursive-proofs}

### İşlem verisi sıkıştırma {#zk-rollups-pros-and-cons}
...
### Özyinelemeli kanıtlar {#zk-video}
...
### ZK-rollup'ların artıları ve eksileri {#zkevm-projects}
...
### ZK-rollup'ların görsel bir açıklaması {#further-reading-on-zk-rollups}
...
## Kimler bir zkEVM üzerinde çalışıyor? {#tutorials}
...
## ZK-rollup'lar hakkında daha fazla okuma
...
## Eğiticiler: Ethereum'da gizlilik ve sıfır bilgi
