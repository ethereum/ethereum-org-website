...
##### Çoklu imza cüzdanlarını kullanma {#use-require-assert-revert}
...
### 2. Sözleşme işlemlerini korumak için require(), assert() ve revert() ifadelerini kullanın {#test-smart-contracts-and-verify-code-correctness}
...
### 3. Akıllı sözleşmeleri test edin ve kod doğruluğunu onaylayın {#get-independent-code-reviews}
...
### 4. Kodunuzun bağımsız bir incelemesini isteyin {#audits}
...
#### Hata ödülleri {#follow-smart-contract-development-best-practices}
...
### 5. Akıllı sözleşme geliştirme sırasında en iyi uygulamaları izleyin {#implement-disaster-recovery-plans}
...
### 6. Sağlam felaket kurtarma planları uygulayın {#contract-upgrades}
...
#### Sözleşme yükseltmeleri {#emergency-stops}
...
#### Acil durdurmalar {#event-monitoring}
...
#### Olay izleme {#design-secure-governance-systems}
...
### 7. Güvenli yönetişim sistemleri tasarlayın {#reduce-code-complexity}
...
### 8. Koddaki karmaşıklığı minimuma indirin {#mitigate-common-smart-contract-vulnerabilities}
...
### 9. Yaygın akıllı sözleşme güvenlik açıklarına karşı savunun {#reentrancy}

#### Yeniden giriş (Reentrancy) {#integer-underflows-and-overflows}
...
##### Yeniden giriş saldırıları nasıl önlenir {#oracle-manipulation}
...
#### Tamsayı taşmaları (underflow ve overflow) {#smart-contract-security-resources-for-developers}
...
##### Tamsayı taşmaları nasıl önlenir {#code-analysis-tools}
...
#### Kâhin (Oracle) manipülasyonu {#smart-contract-monitoring-tools}
...
##### Kâhin manipülasyonu nasıl önlenir {#smart-contract-administration-tools}
...
## Geliştiriciler için akıllı sözleşme güvenlik kaynakları {#smart-contract-auditing-services}

### Akıllı sözleşmeleri analiz etme ve kod doğruluğunu onaylama araçları {#bug-bounty-platforms}
...
### Akıllı sözleşmeleri izleme araçları {#common-smart-contract-vulnerabilities-and-exploits}
...
### Akıllı sözleşmelerin güvenli yönetimi için araçlar {#challenges-for-learning-smart-contract-security}
...
### Akıllı sözleşme denetim hizmetleri {#smart-contract-security-best-practices}
...
### Hata ödül platformları {#tutorials-on-smart-contract-security}
...
### Bilinen akıllı sözleşme güvenlik açıkları ve istismarlarının yayınları
...
### Akıllı sözleşme güvenliğini öğrenmek için mücadeleler
...
### Akıllı sözleşmeleri güvence altına almak için en iyi uygulamalar
...
### Akıllı sözleşme güvenliği üzerine eğitimler
