...
Farklı dillerin farklı dilbilgisi kuralları, gelenekleri ve kelime dizilimi vardır. Çeviri yaparken, lütfen hedef dillerde cümlelerin nasıl yapılandırıldığına dikkat edin ve zayıf cümle yapısına ve okunabilirliğe yol açabileceğinden İngilizce kaynağı kelimesi kelimesine çevirmekten kaçının.
...
Resmi hitap kullanmak, gayriresmi veya kırıcı görünmekten kaçınmamızı sağlar ve ziyaretçinin yaşına ve cinsiyetine bakılmaksızın işe yarar.
...
Bazı sayfalar, 'title', 'lang', 'description', 'sidebar' vb. gibi sayfa üzerinde meta veriler içerir.

Yeni sayfaları Crowdin'e yüklerken çevirmenlerin asla çevirmemesi gereken içeriği gizliyoruz, bu da Crowdin'de çevirmenlerin görebildiği tüm meta verilerin çevrilmesi gerektiği anlamına gelir.

Kaynak metnin 'en' olduğu herhangi bir dizeyi çevirirken lütfen özellikle dikkatli olun. Bu, sayfanın mevcut olduğu dili temsil eder ve [diliniz için ISO dil koduna](https://www.andiamo.co.uk/resources/iso-language-codes/) çevrilmelidir. Bu dizeler her zaman hedef dile özgü yazı alfabesiyle değil, Latin karakterleri kullanılarak çevrilmelidir.
...
Bazı dizeler harici makalelerin başlıklarını içerir. Geliştirici belgeleri sayfalarımızın çoğu, daha fazla okuma için harici makalelere bağlantılar içerir. Sayfayı kendi dillerinde görüntüleyen ziyaretçiler için daha tutarlı bir kullanıcı deneyimi sağlamak amacıyla, makalenin diline bakılmaksızın makale başlıklarını içeren dizelerin çevrilmesi gerekir.

Bu dizelerin çevirmenler için nasıl göründüğüne ve bunların nasıl belirleneceğine dair bazı örnekleri aşağıda bulabilirsiniz (makalelere bağlantılar çoğunlukla bu sayfaların en altında, 'Daha fazla okuma' bölümünde bulunabilir):
...
**Genellikle bir şeylerin yanlış olduğu veya çeviride kaynak metnin önemli bir parçasının eksik olduğu anlamına geldikleri için bu uyarıları asla göz ardı etmeyin.**
...
2. 'HTML tags displaying' (HTML etiketlerinin görüntülenmesi) bölümüne aşağı kaydırın
...
Bu seçeneği belirlediğinizde, tam etiket metni artık gösterilmeyecek ve yerini bir sayı alacaktır.
Çeviri yaparken, bu etikete tıklamak tam etiketi otomatik olarak çeviri alanına kopyalayacaktır.
...
Kaynak metin ayrıca yalnızca sayılar içeren kısaltılmış etiketler de içerir, bu da işlevlerinin hemen belli olmadığı anlamına gelir. Tam olarak hangi işleve hizmet ettiklerini görmek için bu etiketlerin üzerine gelebilirsiniz.
...
Web sitesi, diğer içeriklerden farklı şekilde çevrilmesi gereken çok sayıda buton içerir.

Buton metni, çoğu dizeyle bağlantılı bağlam ekran görüntüleri görüntülenerek veya düzenleyicide ''button'' (buton) ifadesini içeren bağlam kontrol edilerek belirlenebilir.

Biçimlendirme uyuşmazlıklarını önlemek için buton çevirileri mümkün olduğunca kısa olmalıdır. Ek olarak, buton çevirileri emir kipinde olmalıdır, yani bir komut veya istek sunmalıdır.
...
Kapsayıcılığın bir başka biçimi de belirli bir ülkeye, ırka veya bölgeye özgü değil, küresel bir kitle için çeviri yapmaya çalışmaktır.

Son olarak, dil tüm kitleler ve yaşlar için uygun olmalıdır.

## Dile özgü çeviriler {#language-specific-translations}

Çeviri yaparken, kaynaktan kopyalamak yerine dilinizde kullanılan dilbilgisi kurallarına, geleneklere ve biçimlendirmeye uymak önemlidir. Kaynak metin, diğer birçok dil için geçerli olmayan İngilizce dilbilgisi kurallarını ve geleneklerini takip eder.
...
- İngilizcede başlıklardaki ve isimlerdeki tüm kelimeleri, ayları ve günleri, dil isimlerini, tatilleri vb. büyük harfle yazmak yaygındır. Diğer birçok dilde, farklı büyük harf kullanım kuralları olduğundan bu dilbilgisi açısından yanlıştır.
- Bazı dillerde ayrıca İngilizcede büyük harfle yazılmayan şahıs zamirlerinin, isimlerin ve belirli sıfatların büyük harfle yazılmasına ilişkin kurallar vardır.
...
- İngilizce ve diğer diller arasındaki boşluk bırakmadaki bazı yaygın farklılıklar:
  - Ölçü birimlerinden ve para birimlerinden önce boşluk (ör. USD, EUR, kB, MB)
...
- Bazı dillerde her yeni satırın ilk kelimesinin büyük harfle yazılması gerekirken, diğerlerinde yeni satırlar küçük harflerle başlamalıdır. Birçok dilin ayrıca her satırın uzunluğuna bağlı olarak listelerde büyük harf kullanımı hakkında farklı kuralları vardır.
...
- Tarihleri çevirirken, dile bağlı olarak bir dizi husus ve farklılık vardır. Bunlar arasında tarih biçimi, ayırıcı, büyük harf kullanımı ve baştaki sıfırlar bulunur. Ayrıca tam uzunluktaki ve sayısal tarihler arasında da farklılıklar vardır.
...
- Farklı biçimler, gelenekler ve dönüştürmeler nedeniyle para birimlerini çevirmek zor olabilir. Genel bir kural olarak, lütfen para birimlerini kaynakla aynı tutun. Okuyucunun yararına yerel para biriminizi ve dönüşümü parantez içine ekleyebilirsiniz.
- Farklı dillerde para birimlerinin yazımındaki temel farklılıklar arasında sembol yerleşimi, ondalık virgüllere karşı ondalık noktalar, boşluk bırakma ve kısaltmalara karşı semboller yer alır.
...
- Genel bir kural olarak, lütfen ölçü birimlerini kaynağa göre tutun. Ülkeniz farklı bir sistem kullanıyorsa, dönüşümü parantez içine ekleyebilirsiniz.
- Ölçü birimlerinin yerelleştirilmesinin yanı sıra, dillerin bu birimlere nasıl yaklaştığı konusundaki farklılıklara dikkat etmek de önemlidir. Temel fark, dile bağlı olarak farklı olabilen sayı ve birim arasındaki boşluktur. Bunun örnekleri arasında 100kB'a karşı 100 kB veya 50ºF'ye karşı 50 ºF yer alır.
