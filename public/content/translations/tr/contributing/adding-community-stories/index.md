...
- **Coğrafi ve tematik çeşitlilik** - Yeterince temsil edilmeyen bölgelerden gelen ve yeterince temsil edilmeyen kullanım durumlarını kapsayan hikayelere öncelik verilir.
- **Multimedya** - Video, ses veya fotoğraf eşliğindeki hikayeler teşvik edilir.
- **Açık kaynak ve sığınak değerleri** - Açık kaynaklı veya sığınak teknolojilerinin sansür direncini, açık erişimi, finansal katılımı, gizliliği veya güvenliği nasıl sağladığını gösteren hikayelere özellikle değer verilir.

### Öne çıkan bir hikaye nasıl eklenir {#how-to-add-featured-story}
...
### Bir hikayeyle katkıda bulunmanın diğer yolları {#other-ways-to-contribute}
...
- Öne çıkan hikayeler, olgusal ayrıntıların değişmesi durumunda güncellenebilir.
- Kısa formatlı hikayeler uygunluk ve doğruluk açısından incelenir.
- Hikayeler sayfası, `community-stories` olarak etiketlenmiş yeni video girişlerini otomatik olarak alır.