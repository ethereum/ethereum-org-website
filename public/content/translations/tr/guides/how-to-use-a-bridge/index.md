...
Ağın RPC ayrıntılarını bulmak için [chainlist.org](https://chainlist.org) adresini kullanabilirsiniz. Ağ eklendiğinde ve işlem sonlandığında, token'ları cüzdanınızda görmelisiniz. <br />
