...
Merkeziyetsiz sosyal ağlar, kullanıcıların bilgi alışverişinde bulunmalarının yanı sıra kitlelere içerik yayınlamalarına ve dağıtmalarına olanak tanıyan [blokzincir tabanlı](/glossary/#blockchain) platformlardır. Bu uygulamalar blokzincir üzerinde çalıştığı için merkeziyetsiz olma, sansüre ve haksız kontrole karşı dirençli olma kapasitesine sahiptir.
...
Merkeziyetsiz sosyal ağlar, blokzincir üzerinde dağıtılan [akıllı sözleşmeler](/glossary/#smart-contract) tarafından desteklenen uygulamalar olan bir [merkeziyetsiz uygulama (dapp)](/apps/) sınıfıdır. Sözleşme kodu, bu uygulamalar için arka uç görevi görür ve iş mantıklarını tanımlar.

Geleneksel sosyal medya platformları, kullanıcı bilgilerini, program kodunu ve diğer veri biçimlerini depolamak için veritabanlarına güvenir. Ancak bu, tek hata noktaları yaratır ve önemli riskler getirir. Örneğin, Facebook'un sunucuları Ekim 2021'de kötü şöhretli bir şekilde [saatlerce çevrimdışı kaldı](https://www.npr.org/2021/10/05/1043211171/facebook-instagram-whatsapp-outage-business-impact) ve kullanıcıların platformla bağlantısını kesti.
...
1. Merkeziyetsiz sosyal ağlar sansüre karşı dirençlidir ve herkese açıktır. Bu, **kullanıcıların yasaklanamayacağı**, platformdan atılamayacağı veya keyfi olarak kısıtlanamayacağı anlamına gelir.

2. Merkeziyetsiz sosyal ağlar **açık kaynak idealleri üzerine inşa edilmiştir** ve uygulamaların kaynak kodunu halkın denetimine sunar. Blokzincir tabanlı sosyal ağlar, geleneksel sosyal medyada yaygın olan şeffaf olmayan algoritmaların uygulanmasını ortadan kaldırarak kullanıcıların ve platform yaratıcılarının çıkarlarını uyumlu hale getirebilir.
...
[MINDS](https://www.minds.com/), en çok kullanılan merkeziyetsiz sosyal ağlardan biridir. Facebook gibi çalışır ve şimdiden milyonlarca kullanıcıya ulaşmıştır.

Kullanıcılar, öğeler için ödeme yapmak amacıyla platformun yerel [ERC-20](/glossary/#erc-20) Token'ı olan $MIND'ı kullanır. Kullanıcılar ayrıca popüler içerikler yayınlayarak, ekosisteme katkıda bulunarak ve başkalarını platforma yönlendirerek $MIND Token'ları kazanabilirler.

### Farcaster {#farcaster}

[Farcaster](https://farcaster.xyz/), kullanıcıların "cast"leri paylaşmasına ve keşfetmesine olanak tanıyan, X ve Reddit'e benzer "yeterince merkeziyetsiz" bir sosyal ağdır. İşlemleri nispeten ucuz tutmak için Optimism L2 ağı üzerine inşa edilmiştir.
...
- [Merkeziyetsiz Sosyal Medya Açıklandı](https://www.youtube.com/watch?v=UdT2lpcGvcQ) — _Coinmarketcap_
- [DeSo Blokzinciri Sosyal Medyayı Merkeziyetsizleştirmek İstiyor](https://www.youtube.com/watch?v=SG2HUiVp0rE) — _Bloomberg Technology_
- [Balaji Srinivasan, Vitalik Buterin ve Juan Benet ile Merkeziyetsiz Sosyal Medyanın Geleceği](https://www.youtube.com/watch?v=DTxE9KV3YrE) — _ETHGlobal_
