...
# Ethereum desteği {#support}

## Resmî Ethereum desteği {#official-support}
...
Ethereum'un merkeziyetsiz yapısını anlamak çok önemlidir çünkü **Ethereum için resmî destek olduğunu iddia eden herkes muhtemelen sizi dolandırmaya çalışıyordur!** Dolandırıcılara karşı en iyi koruma, kendinizi eğitmek ve güvenliği ciddiye almaktır.
...
Resmi desteğin olmamasına rağmen, Ethereum ekosistemindeki birçok grup, topluluk ve proje yardımcı olmaktan mutluluk duyar ve bu sayfada birçok faydalı bilgi ve kaynak bulabilirsiniz. Başka sorularınız mı var? [ethereum.org Discord](https://discord.gg/ethereum-org) topluluğuna katılın, yardım etmeye çalışacağız.
...
[MetaMask'ta bekleyen bir işlemi hızlandırma veya iptal etme](https://metamask.zendesk.com/hc/en-us/articles/360015489251-How-to-speed-up-or-cancel-a-pending-transaction)
...
Doğrulayıcı olmak için Ethereum para yatırma sözleşmesine 32 ETH yatırmanız ve bir doğrulayıcı düğümü kurmanız gerekir. Daha fazla bilgiye [hisseleme sayfalarımızdan](/staking) ve [hisseleme başlama noktasından](https://launchpad.ethereum.org/) ulaşabilirsiniz.

## Merkeziyetsiz uygulamalar oluşturma {#building-support}
...
[Ethereum geliştirici kaynakları](/developers/) bölümümüzde belgelere ve geliştirme kılavuzlarına da ulaşabilirsiniz.

### Araçlar {#dapp-tooling}
...
Ayrıca [buradan bir düğümün nasıl çalıştırılacağını öğrenebilirsiniz](/developers/docs/nodes-and-clients/run-a-node/).
