...
[Katman 1 (L1) ölçeklendikçe](/roadmap/scaling/), oyunlar Ethereum Ana Ağı'na geri dönmeye başlıyor. Bunun bir örneği, Temmuz 2026'da Ethereum L1'de piyasaya sürülen tamamen zincir içi bir oyun olan [Asphodel: Prologue](https://play.asphodel.io/)'dur. Ancak çoğu oyun, daha düşük ücretlerden yararlanmak için hala L2 çözümlerini kullanmaktadır.
...
- **Oyun türleri:** Belirli oyun türleri, Ethereum blokzincirinin benzersiz özellikleriyle doğal olarak uyumludur: **kalıcı durum**, **doğrulanabilir mantık** ve **oyuncuların sahip olduğu ekonomiler**. Geliştiriciler entegrasyona farklı yaklaşırlar. Bazıları tüm mantığın ve durumun blokzincirde yaşadığı tamamen zincir içi oyunlar inşa ederken, diğerleri blokzinciri NFT kozmetikleri gibi varlık sahipliği için minimum düzeyde kullanır. Geliştiriciler, hangi tür oynanışların zincir içi mimariden en çok fayda sağladığını keşfediyorlar, bunlar arasında şunlar yer alıyor:
   1. **Zindan Keşif Oyunları (Dungeon Crawlers) ve Roguelike'lar:** Loot Survivor'ın doğrulanabilir yüksek skorlara sahip tamamen zincir içi kalıcı ölüm (permadeath) zindanları, Onchain Heroes'un Maze of Gains'i ve labirent keşfini DeFi mekanikleriyle birleştiren Axie: Den of Mysteries adlı Axie temalı yeniden giydirilmiş (reskin) versiyonu.
   2. **MMO'lar:** Cambria'nın güvenli bölgelerin dışındaki her adımın gerçek riskler taşıdığı, PvP ve çıkarma (extraction) mekaniklerine sahip sezonluk kazanmak için risk al (risk-to-earn) MMO'su Gold Rush. ForTheKingdom'ın büyük ölçekli fraksiyon savaşları içeren tamamen zincir içi MMO strateji oyunu. Oyuncuların PvE zindanlarında ve gerçek riskler taşıyan PvP savaşlarında mücadele ettiği Ronin üzerinde zincir içi bir MMO olan Axie Infinity: Atia's Legacy. 
   3. **4X Strateji ve Büyük Strateji:** Oyuncuların filolar üretmek ve ittifaklar kurmak için gezegenlerde token'ları stake ettiği, sonsuza kadar zincir içi çalışan izinsiz bir uzay fethi ve diplomasi oyunu olan Conquest.eth. Realms, [Eternum'un](/apps/eternum/) 4X mekaniklerini, oyuncuların tamamen oyuncu odaklı bir ekonomi içinde kaynak madenciliği yapmak, ordular kurmak ve karmaşık diplomasiye girmek için Diyarları (arazi NFT'leri) kontrol ettiği bir fantezi ortamına taşıyor. Dark Forest, ZK ispatlı savaş sisi mekanikleriyle bu türe öncülük etti ve şu anda DFArchon tarafından bir topluluk çatallanması olarak sürdürülüyor.
   4. **Strateji ve Taktik:** Realms, Blitz'in yoğun 1 saatlik katılım (buy-in) tabanlı strateji maçlarını içerir ve Asphodel: Prologue otomatik savaşçısı (autobattler) yakın zamanda Ethereum Ana Ağı'nda piyasaya sürüldü.
   5. **Takas Kart Oyunları:** Showdown, takas kart oyunu stratejisini pokerin yoğunluğuyla birleştirir. Axie Infinity Classic, satranç, poker ve Pokemon'un birleşimidir ve milyonlarca oyuncuya ulaşan ilk Web3 oyunudur.
   6. **Rekabetçi Arenalar:** Oyuncuların ölümüne hızlı tempolu 1v1 düellolarda ETH stake ettiği Cambria'nın Duel Arena'sı. Oyuncuların özelleştirilebilir mecha'lara pilotluk yaptığı rekabetçi bir mecha savaş arenası olan AveForge.
