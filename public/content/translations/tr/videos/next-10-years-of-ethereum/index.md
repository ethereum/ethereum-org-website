---
title: "Ethereum'un önümüzdeki 10 yılı"
description: "Fede Fernández, Ethereum'un evrimini, Latin Amerika'daki altyapı inşasını ve ekosistemin önümüzdeki on yılını tanımlayacak temel değerleri ele alıyor."
lang: tr
...
breadcrumb: "Önümüzdeki 10 Yıl"
---

Lambda'nın kurucusu ve çeşitli Ethereum girişimlerinin kurucu ortağı olan **Fede Fernández**'in Devconnect Buenos Aires'te kişisel yolculuğunu, Latin Amerika'daki altyapı inşasını ve Ethereum'un önümüzdeki on yılını tanımlayacak temel değerleri ele aldığı bir konuşma.
...
Bu, AWS veya Google Cloud'a karşı büyük bir avantaj sağlar, çünkü bu bilgisayarın içinde gerçekleşen her şey doğrulanabilirdir. Bence — güven açısından adeta küçük bir tanrı gibidir, çünkü ekonomik teşviklere, kapitalizme ve matematiğe güveniyorsanız, üzerinde gerçekleşen her şey doğrudur. Bunun AWS'ye karşı bir avantajı vardır çünkü AWS ve Google güvene dayalıdır ve güven sarsılabilir. Geçen gün Twitter'da Bing'i hackleyip filmleri değiştiren bir adam hakkında bir şey okudum — Bing'de "en iyi 10 film hangisi" diye aratırsanız, adam sistemi hacklemiş ve listeyi değiştirmiş. Sadece Bing'in söylediği her şeyin doğru olduğuna güvenmek zorundasınız ve bu durumda Bing hacklenmişti. Ethereum'da, her şey hacklenmediği sürece bu gerçekleşemez ve bu çok zordur çünkü birden fazla ekibi, birden fazla uygulamayı hacklemeniz gerekir ve bu herkes tarafından görülebilir.
...
Bu, küresel tarafsızlık yaratır. Çinli bir geliştirici, Rus bir yatırımcı, Amerikalı bir fon ve Arjantinli bir kullanıcı aynı oyun alanına sahiptir. Doğrulanabilir bilgisayarı kullanmayı seçiyoruz. Oraya para koyabiliriz, sanat eseri koyabiliriz ve ona sahip olduğumuzu biliriz. Başka hiç kimseye bağımlı değiliz. Bu, diğer her şeyi inşa edebilmek için temel hakları verir. Ethereum'dan önce internetin mülkiyet hakları yoktu.
...
**Performans.** Lambda'nın Ethereum yürütme istemcisi üzerinde çalışıyoruz. Birkaç dakika önce ekibimin performans açısından Reth'e %10 yaklaşmayı başardığını öğrendim. Buna bir yıl önce çalışmaya başladık, bu yüzden yaptığımız işten son derece gurur duyuyorum. Ancak kontrol ederseniz, Nethermind, Go Ethereum (Geth) ve bizim istemcimiz dışında, diğer istemcilerin çoğunun performans açısından bazı zorlukları var. Bunu insanları eleştirmek için söylemiyorum — bir kıyaslama (benchmark) çalıştırırsanız bunu görebilirsiniz. Doğrulayıcı gereksinimlerini değiştirmediğimiz sürece, Solana gibi şeylerle rekabet etmeye devam etmek için ihtiyacımız olan rakamlara ulaşmak zor olacak.

Ethereum'un farklı uygulamalara sahip doğrulanabilir bir bilgisayar olarak var olan tek Protokol olduğuna inanıyorum. Arjantin'de Ethereum'un çekirdeği üzerinde çalışan 100'den fazla geliştiriciden oluşan bir ekibimiz var. Avrupa'da ekiplerimiz var, ABD'de ekiplerimiz var, Asya'da ekiplerimiz var. Başka hiçbir Blokzincir veya doğrulanabilir bilgisayar buna sahip değil. Ancak üç yıl boyunca gaz limiti artırmamaya karar verdik. Yavaş olmaya karar verdik. Bence doğrulanabilir olabiliriz ve insanlar olan biten her şeyi kontrol edebilirken, aynı zamanda gaz limiti artırmaya devam edebiliriz. Bu birkaç ay öncesine kadar tabu bir konuydu. Dankrad, ben ve diğer pek çok kişi rekabette kazanmaya devam edebilmemiz için daha hızlı olmak adına baskı yapmaya çalışıyorduk. Diğer yürütme istemcileri arayı kapatmalı, çünkü eğer kapatmazlarsa onları bekleyemeyiz. Ethereum, üzerinde inşa eden ekiplerin herhangi birinden daha büyüktür.

Ayrıca Doğrulayıcı gereksinimlerinin artması gerektiğine inanıyorum. Ethereum'un amacının herkesin kendi evinde bir Doğrulayıcı çalıştırabilmesi olduğundan emin değilim. Bence 1.000 veya 2.000 dolar ödeyebiliyorlarsa herkes bunu yapabilmeli ya da birkaç dolarla doğrulama ve onaylama yapabilmeliler. Ancak gereksinimlerin, herkesin 50 dolarlık bir Raspberry Pi üzerinde çalıştırabileceği kadar düşük olmasını istediğimizden tamamen emin değilim. Bir diğer sorun da durum büyümesidir — eğer gaz limiti artırırsak, durum çok fazla büyüyecektir.

**Ölçeklenebilirlik.** Benim bakış açıma göre bu, evde staking yapmakla değil, doğrulanabilirlikle ilgilidir. Bence gaz limiti 100 kat artırmalıyız. Ne kadar ucuzlarsak, o kadar çok insan onu kullanacaktır. Tıpkı internette olduğu gibi — internet hızlandığında insanlar YouTube veya yayın platformları gibi şeyler yaratmaya başladılar.
...
İlk sorun: "biz zaten kazandık." Bu kendi kendine dayatılan bir durgunluktur. Rehavet, büyüme ve öz farkındalık eksikliğine yol açar ve yeni hırslı insanları uzak tutar. 20 yaşlarında pek çok gencin bana "Solana'ya gidiyorum çünkü orada daha fazla hırs görüyorum" dediğini gördüm. Bence hırslı olmalıyız. Biraz tunç çağı zihniyetine ihtiyacımız var — buradayız, kazanmak istiyoruz, rekabeti yenmek istiyoruz. Intel'in kurucusu "Sadece Paranoyaklar Hayatta Kalır" adında bir kitap yazdı. O öldü ve sonra Intel'in hisselerine bakın — düştü. Devasa bir şey olan Intel bile NVIDIA ve AMD'ye kıyasla düşüşte. Aynı şey MySpace, BlackBerry ve birçok harika şirket ve Protokol için de oldu.
...
Bu, üzerinde çalışan insanlara kaba davranmamız gerektiği anlamına gelmez — minnettar olmalıyız. Ancak bilim ve mühendislik, bazı şeyleri geride bırakmamız gerektiği anlamına gelir. Ethereum Vakfı (EF) liderlik değişiminin bu durum olduğuna inanıyorum. EF'nin neden bir sorun olduğunu söylemek için bir görüşmeye katılmak üzere Signal üzerinden birden fazla kişiyle koordine olmam gerekti ve herkes bana "Fede, ben de böyle düşünüyorum ama süreci bozmak istemiyorum" diyordu. Bilim ve mühendislik, olayları açıkça tartışabilmemiz gerektiği anlamına gelir.
...
Bir Ethereum katman 1 (L1) istemcisi oluşturduk. Üzerinde çalışan 40 kişimiz var. Katman 2 (L2) için Succinct'in SP1, RISC Zero ve CISC'sini kullanıyoruz. Lambda ile kendi ZKVM'mizi inşa ediyoruz ve İsrail ile Belçika'dan kriptograflarla işbirliği yapıyoruz. Fransız ortaklarımızla güvenlik denetimleri yapıyoruz. Doğrulayıcı ekonomisi üzerine Robust Incentives ile çalışıyoruz. Maiden ile gizlilik üzerine çalışıyoruz. Merkeziyetsiz yapay zeka üzerinde çalışıyoruz. Lambda Commit Boost üzerinde çalışıyoruz. Yarın sabitcoin'lerle ilgili ilginç bir şey başlatıyoruz.
...
**Fede Fernández:** Mutlu. Çok mutluyum. Annemin burada olmasına çok seviniyorum — umarım ne halt ettiğimi ve Ethereum'un ne olduğunu anlayabilir. Kiliseden gelen ve Ethereum hakkında pek bir şey bilmeyen ortaklarımız olduğu için mutluyum. Aslında kiliseden bazı arkadaşlarla Devcon'a gittik. Gelecek bazı ünlü sanatçılarımız var. Ne yaptığımızı göstermek için pek çok insanı davet ettik — bizi diğer işlerden tanıyan insanları. Her şeyi dünyaya gösterebildiğim için çok mutluyum.

**Sunucu:** Çok gurur duyuyor olmalı. İlk soru: Belirtilen girişimlerden hangileri şu anda sizin için en önemlisi?

**Fede Fernández:** Lean Ethereum. Bence Justin Drake'in yaptığı şey — bakın, ben çok açık sözlü bir insanım. Önceki memin büyük bir hayranı değildim. Neydi o? Adını hatırlayamıyorum.

**Sunucu:** Ultrasonik para (Ultrasound money).

**Fede Fernández:** Evet, ultrasonik para. Neden bilmiyorum — büyük bir hayranı değildim. Justin bunu çok zorladı. Justin'i her zaman sevmişimdir ama bu bana hitap etmedi. Lean Ethereum, benim bakış açıma göre bir katedral gibi. Onu Cambridge'de görmeye gittim. Katedrallerden birinin içinde yürüyorduk, onu çok yakından izliyorduk. Bana, "Hey, sence 500 yıl sonra insanlar Ethereum'un tasarımını bu katedral gibi görecekler mi?" dedi. Ben de "Evet ve sen de mimarlarından birisin" dedim. Yaptığı işten son derece gurur duyuyorum ve bunun bir parçası olduğum için çok minnettarım.

**Sunucu:** Ethereum gökyüzündeki bir katedraldir — bu çok havalı. Teknik bir soru: Sizce yakın gelecekte gaz limitlerini ne kadar artırabiliriz?

**Fede Fernández:** Ucuz sunucular şu anda pek çok şeyi halledebiliyor. Her şeyden önce, Nethermind'ın mühendislik yeteneklerine hayranım. Son birkaç aydır çalışmalarını kontrol ediyoruz — inanılmaz. Microsoft'un pek sevmediğim bir dili olan C# ile çalışıyorlar — Java'dan daha çok seviyorum ama yine de. Çok fazla megagaz elde etmeyi başarıyorlar. Benim bakış açıma göre en hızlı uygulama onlar, sonra Go Ethereum (Geth), sonra biz. Bence iyi bir sunucuyla 300 veya 400 megagaza ulaşabilirsiniz. Orange Pi gibi daha ucuz bir şeyle şu anda muhtemelen 200 megagaz. Ancak gelecek değişikliklerle birlikte, önümüzdeki birkaç yıl içinde kolayca bir gigagaza yaklaşmamız gerektiğini düşünüyorum.

**Sunucu:** Kurumlardan hükümetlere ve uygulama oluşturucularına kadar pek çok farklı insanla çalışıyorsunuz. Hepsiyle ortak bulduğunuz şey nedir? Ethereum'u temsil ettiğinizde, özellikle yeni insanlara açıklarken kendinizi her zaman neye yönelirken buluyorsunuz?

**Fede Fernández:** Kralların kızlarıyla, başkanlarla, büyük milyarderlerle konuşmak zorunda kaldım — Libra gibi şeyler uluslararası alana yayıldığında, kurumlar ve itibar inşa etmiş insanlar bu işlere bulaşmaktan endişe duyuyorlar. Bence Justin Drake, Vitalik ve Ethereum topluluğundaki herkesin çok iyi yaptığı şey uzun vadeye odaklanmak. Ethereum'un ne olduğunu her zaman çok iyi anlamıyorlar ama bunun ciddi bir şey olduğunu biliyorlar. İneklerin (nerd) olduğu yer burasıdır — ve inekler her zaman güvenilirdir çünkü sadece para dışındaki şeylerle motive olurlar. Ethereum'u gelecekte kazanacak ciddi bir şey olarak gördüklerini fark ediyorum.

**Sunucu:** İzleyiciler arasındaki genç bir oluşturucu için ne önerirsiniz? Özellikle sizin iş alanınızla ilgileniyorlarsa?
