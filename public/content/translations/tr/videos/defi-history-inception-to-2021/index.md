---
title: "DeFi: Başlangıcından 2021 ve ötesine"
description: "Başlangıcından 2020 DeFi Yazı ve ötesine kadar merkeziyetsiz finansın tarihi."
lang: tr
...
format: explainer
author: Finematics
breadcrumb: "DeFi Tarihi"
---

**Finematics** tarafından hazırlanan, merkeziyetsiz finansın (DeFi) Ethereum üzerindeki ilk deneylerinden 2020'nin patlayıcı DeFi Yazı'na kadar olan tarihinin izini süren; önemli protokolleri, dönüm noktalarını, piyasa olaylarını ve DeFi'ın 2021 ve sonrasında nereye gittiğini kapsayan bir açıklayıcı.
...
DeFi'ın kökeni 2009'a dayanır. Bitcoin'i ilk DeFi protokolü olarak düşünmeyebilirsiniz, ancak aslında tüm endüstrinin başlangıcıydı. Bitcoin ilk kez insanların bir dijital varlığa gerçekten sahip olmalarına ve onu tamamen kontrol etmelerine olanak tanıdı; herhangi bir finansal aracıya ihtiyaç duymadan dünya çapında değer gönderilmesini sağladı. Bu, tüm DeFi ekosisteminin temelini attı.
...
Ne yazık ki borsa 2017'nin sonunda hacklendi. Bilgisayar korsanı EtherDelta'nın ön yüzüne (frontend) erişim sağladı ve trafiği bir kimlik avı sitesine yönlendirerek kullanıcıları yaklaşık sekiz yüz bin dolar dolandırdı. Bunun da ötesinde, EtherDelta'nın kurucusu 2018'de SEC tarafından düzenlenmemiş bir menkul kıymetler borsası işletmekle suçlandı ve bu da tabuta çakılan son çivi oldu.

2017 boyunca, Ethereum için ilk büyük kullanım durumlarından biri olan ICO'lar yaygınlaştı. Yeni projeler, geleneksel yöntemleri kullanarak para toplamak yerine, bunun karşılığında kendi token'larını sunmaya başladı. Merkeziyetsiz fon toplama fikri teoride kötü olmasa da, birkaç sayfalık bir teknik inceleme (white paper) dışında gösterecek hiçbir şeyi olmayan, aşırı abartılmış birçok projenin çok fazla para toplamasıyla sonuçlandı.

ICO bolluğu içinde, bugün DeFi olarak sınıflandıracağımız projeler de vardı. ICO döneminin en dikkate değer DeFi projelerinden bazıları şunlardı:

- **Aave** — borç verme ve borç alma
- **Synthetix** (önceden Havven olarak biliniyordu) — türevler için bir likidite protokolü
- **Ren** (önceden Republic Protocol) — blokzincirler arası likiditeye erişim sağlamak için bir protokol
- **Kyber Network** — bir zincir içi likidite protokolü
- **0x** — varlıkların eşler arası değişimi için açık bir protokol
- **Bancor** — başka bir zincir içi likidite protokolü
...
2 Kasım 2018'de Uniswap'ın ilk sürümü Ethereum Ana Ağı'nda yayımlandı. Bu, yaratıcısı Hayden Adams'ın bir yılı aşkın çalışmasının doruk noktasıydı. Uniswap açıkça DeFi'daki en önemli projelerden biridir. EtherDelta'nın aksine Uniswap, kullanıcıdan sözleşmeye modelinden yararlanarak likidite havuzları ve otomatik piyasa yapıcılar konsepti üzerine inşa edildi. Uniswap'ın ilk sürümü tamamen Ethereum Vakfı'ndan alınan bir hibe ile finanse edildi.
...
Çeşitli kredilerdeki teminatlarını artırmaya ve farklı varlıklar arasında ticaret yapmaya çalışan çok sayıda kullanıcının bir sonucu olarak, Ethereum gaz ücretleri o zamanlar için gerçekten yüksek olan 200 Gwei'nin üzerine dramatik bir şekilde fırladı.

En çok etkilenen protokollerden biri Maker oldu. Kullanıcıların ETH teminatlarının değer kaybetmesinin neden olduğu tasfiye dalgası, tasfiyelerden sorumlu dış aktörler olan koruyucu botların (keeper bots), açık artırmaya çıkarılan ETH teminatı için sıfır DAI teklif edebilmesiyle sonuçlandı. Bu, daha sonra ek MakerDAO MKR token'ları yaratılıp açık artırmaya çıkarılarak karşılanan yaklaşık dört milyon dolar değerinde bir ETH açığına yol açtı.
...
Bu model, teşvik edilen likidite havuzlarına akan paranın kilitlenmiş toplam değer (tvl) olarak 600 milyon doları aşmasıyla DeFi topluluğundan büyük destek gördü. Token fiyatının kendisi, Uniswap'ta ilk listelendiğinde yaklaşık altı dolardan, iki aydan kısa bir süre sonra token başına otuz bin doların üzerine çıkarak parabolik koşusuna başladı.
...
Yam token'ları YFI ruhuyla dağıtıldı ve protokol hızla büyük miktarda likidite çekmeye başladı. COMP, LEND, LINK, MKR, SNX ve YFI sahiplerini token'larını Yam platformunda stake ettikleri için ödüllendirerek güçlü DeFi topluluklarında ilgi oluşturmayı amaçladı.

Lansmandan sadece bir gün sonra, protokolde yarım milyar dolarlık kilitlenmiş toplam değer (tvl) varken, yeniden tabanlama (rebase) mekanizmasında kritik bir hata bulundu. Hata, likidite sağlayıcılarının yalnızca bir kısmını etkiledi, ancak bu, protokolü daha sonra yeniden başlatma girişimlerine rağmen insanların Yam'a olan ilgisini kaybetmesi için yeterliydi.

Ardından, Ağustos 2020'nin sonunda anonim bir ekip tarafından başlatılan SushiSwap geliyor. Protokol, Uniswap'ın likidite sağlayıcılarını SUSHI token'larıyla teşvik ederek Uniswap'tan likidite çekmeyi amaçlayan yeni bir vampir saldırısı konsepti sundu. SushiSwap bir milyar dolar değerinde likidite çekmeyi başardı. Ana SushiSwap geliştiricisi Chef Nomi'nin elindeki tüm SUSHI token'larını satmasıyla yaşanan bazı dramlardan sonra, protokol sonunda Uniswap'ın likiditesinin büyük bir kısmını kendi yeni platformlarına taşımayı başardı.
...
DeFi Yazı boyunca tüm temel metrikler dramatik bir şekilde iyileşti:

- Uniswap'ın aylık hacmi Nisan 2020'de 169 milyon dolardan Eylül 2020'de 15 milyar doların üzerine çıktı; bu neredeyse 100 katlık devasa bir artıştı
...
DeFi ekosisteminin hala çok aktif olmasına ve geliştiricilerin yeni protokoller inşa etmeye devam etmesine rağmen, olumsuz duyarlılık Eylül ve Ekim ayları boyunca sürdü. DeFi piyasası nihayet Kasım ayının başlarında dibi buldu ve en iyi DeFi protokollerinden bazıları sadece birkaç ay önceki tüm zamanların en yüksek seviyelerinden yüzde 70 ila 90 daha düşük işlem gördü.

Yüzde 50'den fazla hızlı bir toparlanmanın ardından DeFi piyasası yeniden yükseliş trendine girdi. İlginç bir şekilde, DeFi kışı boyunca Uniswap hacmi 2020'nin başlarındakinden çok daha yüksek kalmaya devam etti. Ayrıca, DeFi'da kilitlenmiş toplam değer (tvl) yukarı yönlü eğilimini sürdürerek yıl sonunda 15 milyar doları aştı. Tüm bunlar, 2020 boyunca DeFi endüstrisine musallat olan çok sayıda hack olayına rağmen gerçekleşti: bZx, Harvest, Acropolis, Pickle ve Cover bunlardan sadece birkaçı.
...
Yeni, daha geleneksel varlıkları DeFi'a getirmek (bunları tokenize ederek veya sentetik versiyonlarını yaratarak) tamamen yeni fırsatlar da yaratacaktır. Katman 2 (l2) üzerindeki DeFi, Ethereum 2.0 üzerindeki DeFi, Bitcoin üzerindeki DeFi ve diğer zincirlerdeki DeFi arasındaki rekabet de büyük bir rol oynayacaktır. Birlikte çalışabilirlik protokolleri ve zincirler arası likidite gerçekten önemli hale gelebilir.

Kredi yetki devri, eksik teminatlandırılmış veya teminatsız krediler gibi diğer alanlar da araştırılmaktadır. Tüm bunlar 2021 ve sonrasında netleşecektir.