...
Verkle ağaçları `(anahtar,değer)` çiftleridir; burada anahtarlar 31 baytlık bir _gövdeden_ ve tek baytlık bir _son ekten_ oluşan 32 baytlık öğelerdir. Bu anahtarlar _uzantı_ düğümleri ve _iç_ düğümler halinde düzenlenir. Uzatma düğümleri, farklı eklere sahip 256 tohum için tek bir kökü temsil eder. İç düğümlerin de 256 tohumu vardır, ancak bunlar diğer uzantı düğümleri olabilir. Verkle ağacı ile Merkle ağacı yapısı arasındaki temel fark, Verkle ağacının çok daha düz olmasıdır, yani bir yaprağı köke bağlayan daha az ara düğüm vardır ve bu nedenle kanıt oluşturmak için daha az veri gerekir.
...
[Guillaume Ballet'nin Condrieu Verkle test ağını açıklamasını izleyin](https://www.youtube.com/watch?v=cPLHFBeC0Vg) (Condrieu test ağının iş ispatı olduğunu ve artık yerini Verkle Gen Devnet 6 test ağının aldığını unutmayın).
...
- [Hepimiz İçin Verkle Ağaçları](https://web.archive.org/web/20250124132255/https://research.2077.xyz/verkle-trees)
...
- ["Verkle ağaçları Ethereum'u nasıl yalın ve güçlü yapar", Guillaume Ballet, Devcon 6](https://www.youtube.com/watch?v=Q7rStTKwuYs)
- [Piper Merriam, ETHDenver 2020: Durumsuz istemciler üzerine](https://www.youtube.com/watch?v=0yiZJNciIJ4)
