...
Validator-Konten müssen eine Abhebungsadresse angeben, bevor sie auf angesammelte Netzwerk-Belohnungen zugreifen und diese abheben oder eine vollständige Abhebung beim Austritt aus dem Staking durchführen können.
...
Die Angabe einer Abhebungsadresse ist erforderlich, bevor _überhaupt_ Gelder aus dem Guthaben eines Validator-Kontos transferiert werden können.

Benutzer, die vollständig aus dem Staking austreten und ihr gesamtes Guthaben zurückziehen möchten, müssen einen „freiwilligen Austritt“ initiieren. Dies kann auf zwei Arten erfolgen:
...
| Anzahl der Abhebungen | Zeit bis zum Abschluss |
| :-------------------: | :--------------: |
|        400.000        |     3,5 Tage     |
|        500.000        |     4,3 Tage     |
|        600.000        |     5,2 Tage     |
...
<ExpandableCard
title="Sobald ich eine Abhebungsadresse angegeben habe, kann ich sie in eine alternative Abhebungsadresse ändern?"
eventCategory="FAQ"
...
<ExpandableCard
title="Wie hebe ich vom Staking ab, wenn ich über einen Anbieter oder Staking-Pool stake oder mit Liquid-Staking-Token teilnehme?"
eventCategory="FAQ"
...
<ExpandableCard
title="Erfolgt das Beanspruchen von Netzwerk-Belohnungen (teilweise Abhebungen) automatisch?"
eventCategory="FAQ"
