...
<CardGrid>
  <Card title="Ihr eigener Validator" emoji=":desktop_computer:" description="Zahlen Sie Ihre eigenen 32 ETH ein, um Ihr eigenes Set von Signaturschlüsseln zu aktivieren, die am Ethereum-Konsens teilnehmen werden. Überwachen Sie Ihren Fortschritt mit Dashboards, um zu sehen, wie sich diese ETH-Belohnungen ansammeln." />
  <Card title="Einfacher Start" emoji="🏁" description="Vergessen Sie Hardware-Spezifikationen, Einrichtung, Wartung des Blockchain-Knotens und Upgrades. SaaS-Anbieter ermöglichen es Ihnen, den schwierigen Teil auszulagern, indem Sie Ihre eigenen Signaturdaten hochladen, sodass diese gegen geringe Kosten einen Validator in Ihrem Namen betreiben können." />
  <Card title="Begrenzen Sie Ihr Risiko" emoji=":shield:" description="In vielen Fällen müssen Benutzer den Zugriff auf die Schlüssel nicht aufgeben, die das Abheben oder Überweisen von gestakten Geldern ermöglichen. Diese unterscheiden sich von den Signaturschlüsseln und können separat gespeichert werden, um Ihr Risiko als Staker zu begrenzen (aber nicht zu eliminieren)." />
</CardGrid>
