...
- **Welche Clients führt der Betreiber aus?** Ein Betreiber, der Mehrheits-[Ausführungs- oder Konsens-Clients](/developers/docs/nodes-and-clients/client-diversity/) ausführt, setzt sowohl deinen Stake als auch das Netzwerk einem korrelierten Ausfall aus, wenn dieser Client einen Fehler aufweist. Bevorzuge Anbieter, die die Nutzung von Minderheits-Clients dokumentieren.
