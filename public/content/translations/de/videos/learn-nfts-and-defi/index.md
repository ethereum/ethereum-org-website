---
title: "Was sind NFTs und wie können sie in dezentralisierten Finanzen (DeFi) genutzt werden?"
description: "Verstehen Sie die Funktionsweise von nicht-fungiblen Token (NFTs) auf Ethereum und wie sie in dezentralisierten Finanz-Apps (DeFi) verwendet werden."
lang: de
...
format: explainer
author: Finematics
breadcrumb: "NFTs und DeFi"
---

Ein Erklärvideo von **Finematics**, das die Funktionsweise von nicht-fungiblen Token (NFTs) auf Ethereum behandelt und zeigt, wie sie sich mit dezentralisierten Finanzen (DeFi) überschneiden, einschließlich Token-Standards, Anwendungsfällen und NFT-besicherter Kreditvergabe.
...
Wenn es jedoch um nicht-fungible Vermögenswerte geht, ist jede Einheit einzigartig und kann nicht direkt durch eine andere ersetzt werden. Ein gutes Beispiel ist ein Flugticket. Auch wenn Flugtickets ähnlich aussehen mögen, trägt jedes einen anderen Passagiernamen, ein anderes Ziel, eine andere Abflugzeit und eine andere Sitzplatznummer. Der Versuch, ein Flugticket gegen ein anderes zu tauschen, könnte zu ernsthaften Problemen führen.
...
- **Einzigartig** – jeder NFT hat unterschiedliche Eigenschaften, die normalerweise in den Metadaten des Tokens gespeichert sind
- **Nachweislich knapp** – es gibt normalerweise eine begrenzte Anzahl von NFTs, wobei ein extremes Beispiel nur eine einzige Kopie ist; die Anzahl der Token kann auf der Blockchain verifiziert werden
- **Unteilbar** – die meisten NFTs können nicht in kleinere Stückelungen aufgeteilt werden, sodass Sie keinen Bruchteil Ihres NFTs kaufen oder transferieren können
...
**ERC-20** ist ein bekannter Standard zur Erstellung von Token auf der Ethereum-Blockchain. Beispiele hierfür sind Stablecoins wie USDT oder DAI sowie DeFi-Token wie LEND, YFI, SNX und UNI. ERC-20 ermöglicht die Erstellung fungibler Token – alle unter diesem Standard erstellten Token sind völlig ununterscheidbar. Es spielt keine Rolle, ob Sie USDT von einem Freund oder von einer Börse erhalten; der Wert jedes Tokens ist derselbe.

**ERC-721** ist der Standard zur Erstellung von nicht-fungiblen Token. Er ermöglicht die Erstellung von Verträgen, die unterscheidbare Token mit unterschiedlichen Eigenschaften hervorbringen. Ein bekanntes Beispiel sind die berühmten CryptoKitties – ein Spiel, das das Sammeln und Züchten virtueller Kätzchen ermöglicht.
...
Weitere Beispiele sind Marktplätze für digitale Kunst wie Rarible und SuperRare und sogar Aggregatoren von Marktplätzen wie OpenSea. Ein weiteres Beispiel für etwas Knappes, das als NFTs dargestellt werden kann, sind Domainnamen – zum Beispiel der Ethereum Name Service mit der Endung .eth und Unstoppable Domains mit der Endung .crypto.
...
Das klingt vielversprechend, aber es gibt ein Problem. Bei Standard-DeFi-Plattformen für Kreditvergabe und Kreditaufnahme wie Compound oder Aave kann der Wert der bereitgestellten Sicherheiten durch die Integration von Preis-Orakeln leicht gemessen werden. Diese aggregieren Preise aus mehreren liquiden Quellen, wie zentralisierten und dezentralen Börsen. Wenn es um NFTs geht, sind die Märkte für bestimmte Token sehr oft illiquide, was den Preisfindungsprozess schwierig macht.

Um dieses Problem besser zu verstehen, stellen Sie sich vor, jemand kauft ein seltenes CryptoKitty für 10 ETH. Dieser NFT wird später als Sicherheit verwendet, und der Kreditnehmer zieht 1.700 DAI – unter der Annahme, dass 10 ETH 3.500 Dollar wert sind und dieser spezielle NFT einen Beleihungsauslauf von 50 % hat. Wenn danach niemand anderes bereit ist, dieses spezielle CryptoKitty zu kaufen, ist der Markt für diesen NFT illiquide oder gar nicht vorhanden. Die einzige Annahme ist, dass der NFT immer noch denselben Betrag wert ist, für den er zuletzt verkauft wurde – was keine sichere Annahme ist, da sich der Wert von NFTs ziemlich dramatisch ändern kann.
