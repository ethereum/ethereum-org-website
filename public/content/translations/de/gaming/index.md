...
Gaming auf Ethereum gibt es in verschiedenen Formen, von Spielen, die die Blockchain für bestimmte Funktionen nutzen, bis hin zu solchen, bei denen die gesamte Spielwelt Onchain existiert. Die Ethereum-Blockchain kann in Spielen in verschiedenen Kapazitäten genutzt werden. Spiele können ihre Währungen als übertragbare Token oder andere In-Game-Assets (Charaktere, Ausrüstung, Haustiere usw.) in Form von [nicht-fungiblen Token (NFTs)](/nft/) speichern. Spiele können auch Smart Contracts nutzen, um ihre Logik, Regeln und ihren Zustand Onchain zu hosten. Solche Spiele werden allgemein als „vollständig Onchain-basierte Spiele“ bezeichnet.

Das Ethereum-Ökosystem umfasst auch [Layer-2-Blockchains (L2s)](/layer-2/learn/), die die Sicherheitsgarantien des Ethereum Mainnet erben, während sie die Skalierbarkeit von Ethereum erweitern und spezialisierte Anwendungsfälle unterstützen. L2-Netzwerke können Onchain-Spielen und ihren Communitys aufgrund ihrer schnelleren Bestätigungszeiten und niedrigeren Gebühren zusätzliche Vorteile bieten, wodurch das Gameplay zugänglicher wird.

Da [Layer 1 (L1) skaliert](/roadmap/scaling/), beginnen Spiele, auf das Ethereum Mainnet zurückzukehren. Ein Beispiel ist [Asphodel: Prologue](https://play.asphodel.io/), ein vollständig Onchain-basiertes Spiel, das im Juli 2026 auf Ethereum L1 gestartet ist. Die meisten Spiele nutzen jedoch weiterhin L2-Lösungen, um von niedrigeren Gebühren zu profitieren.
## Aufstieg des Ethereum-Gamings {#rise-of-ethereum-gaming}

Traditionelle MMOs wie EVE Online, World of Warcraft, MapleStory und RuneScape haben bewiesen, dass virtuelle Wirtschaftssysteme realen Wert generieren können. Spieler farmten Gold als Einkommen, die Wirtschaft von EVE spiegelte reale Finanzsysteme wider, und die Mod-Kultur (Counter-Strike, DotA 2, Minecraft-Server) zeigte, dass Spieler auf bestehenden Welten aufbauen wollten. Sogar Vitaliks [berühmte Frustration über einen Nerf in World of Warcraft](https://youtu.be/Letsfuhpobw?t=140) wurde zu einem frühen Symbol für die Probleme mit geschlossenen Gaming-Ökosystemen. Aber die Studios kontrollierten alles; sie konnten Konten sperren, Server abschalten oder das Eigentum an von Spielern erstellten Inhalten beanspruchen.

Als Ethereum startete, **sahen Spieledesigner eine Gelegenheit, Welten zu erschaffen, die nicht abgeschaltet werden konnten**. [Wie Ronan Sandford, der Schöpfer von Conquest.eth, es ausdrückte](https://ronan.eth.limo/blog/infinite-games/): „Von dem Tag an, als ich auf Ethereum stieß, war ich von der Idee fasziniert, Spiele zu entwickeln, die unabhängig von ihrem Schöpfer laufen und sich weiterentwickeln.“
...
- **Layer 2s:** Mit günstigeren Gebühren und kurzen Transaktionszeiten wurden Ethereum L2s zu einem üblichen Ort für den Start von Spielen. Die L2-Landschaft entwickelt sich weiter, wobei führende Web3-Gaming-Ökosysteme wie Ronin (ursprünglich eine Sidechain für Axie Infinity) kürzlich zur Ethereum-Layer-2-Architektur übergegangen sind, wodurch sie die Sicherheitsgarantien von Ethereum erben und gleichzeitig ihre für Gaming optimierte Infrastruktur beibehalten. Zu den derzeit führenden L2s für Gaming gehören: [Ronin](https://www.roninchain.com/), [Starknet](https://www.starknet.io/), [Abstract](https://abs.xyz/) und [Base](https://www.base.org/).
- **Infrastruktur:** Um die Entwicklung von Onchain-Spielen zu erleichtern, gibt es eine Reihe von Tool-Stacks; [Cartridge](https://cartridge.gg/) (bietet Sitzungsschlüssel, gaslose Transaktionen über Paymaster und WebAuthn-basierte Authentifizierung durch den Cartridge Controller), [Dojo](https://dojoengine.org/) (ein beweisbares Spiele-Framework mit nativer Unterstützung für Kontoabstraktion), [MUD](https://mud.dev/) (eine EVM-basierte Onchain-Spiele-Engine). Andere, wie [Proof of Play](https://proofofplay.com/) und [Thirdweb](https://thirdweb.com/), ermöglichen es Entwicklern, Spiele mit Web2-ähnlichen Benutzererfahrungen zu entwickeln.
- **Gaming-Communitys:** Das Gaming-Ökosystem von Ethereum wird von Gaming-Gilden unterstützt, darunter ([YGG](https://x.com/YieldGuild), [MANA Gaming](https://x.com/ManaGamingBR), [WASD](https://x.com/WASD_0x), [LegacyGG](https://x.com/Lgc_GG), [Gaming Grid](https://x.com/GamingGridx) und [OLAGG](https://x.com/OLAGuildGames)) für die Zusammenarbeit von Spielern, Erkennungsplattformen wie [GAM3S.GG](https://games.gg/) und Medien wie [Gaming Daily](https://x.com/GamingDailyx) für Spielanalysen und Ökosystem-Berichterstattung. Einige decken all dies ab, wie [FOCGERS](https://x.com/FOCGERS).
- **Spielgenres:** Bestimmte Spielgenres passen natürlich zu den einzigartigen Eigenschaften der Ethereum-Blockchain: **dauerhafter Zustand**, **verifizierbare Logik** und **spielergesteuerte Wirtschaftssysteme**. Entwickler gehen die Integration unterschiedlich an. Einige entwickeln vollständig Onchain-basierte Spiele, bei denen die gesamte Logik und der Zustand auf der Blockchain leben, während andere die Blockchain nur minimal für den Besitz von Assets wie NFT-Kosmetika nutzen. Entwickler entdecken, welche Arten von Gameplay am meisten von der Onchain-Architektur profitieren, darunter:
   1. **Dungeon Crawler & Roguelikes:** Die vollständig Onchain-basierten Permadeath-Dungeons von Loot Survivor mit verifizierbaren Highscores, Maze of Gains von Onchain Heroes sowie dessen Axie-Themen-Reskin namens Axie: Den of Mysteries, die Labyrinth-Erkundung mit Mechaniken der Dezentralisierten Finanzen (DeFi) kombinieren.
   2. **MMOs:** Cambrias saisonales Risk-to-Earn-MMO Gold Rush mit PvP- und Extraktionsmechaniken, bei dem jeder Schritt außerhalb sicherer Zonen echte Einsätze birgt. Das vollständig Onchain-basierte MMO-Strategiespiel ForTheKingdom mit groß angelegten Fraktionskriegen. Axie Infinity: Atia's Legacy, ein Onchain-MMO auf Ronin, in dem sich Spieler durch PvE-Dungeons und PvP-Kämpfe mit echten Einsätzen kämpfen.
   3. **4X-Strategie & Grand Strategy:** Conquest.eth, ein erlaubnisfreies Spiel um Weltraumeroberung und Diplomatie, bei dem Spieler Token auf Planeten staken, um Flotten zu produzieren und Allianzen zu bilden, in einem Spiel, das für immer Onchain läuft. Realms bringt die 4X-Mechaniken von [Eternum](/apps/eternum/) in ein Fantasy-Setting, in dem Spieler Realms (Land-NFTs) kontrollieren, um Ressourcen abzubauen, Armeen aufzubauen und komplexe Diplomatie innerhalb einer vollständig spielergesteuerten Wirtschaft zu betreiben. Dark Forest leistete Pionierarbeit in diesem Genre mit Nebel-des-Krieges-Mechaniken durch Zero-Knowledge-Beweise (ZK-Proofs) und wird derzeit als Community-Fork von DFArchon gepflegt.
   4. **Strategie & Taktik:** Realms umfasst die intensiven 1-stündigen Buy-in-basierten Strategiematches von Blitz, und der Autobattler Asphodel: Prologue wurde kürzlich im Ethereum Mainnet gestartet.
   5. **Sammelkartenspiele:** Showdown kombiniert Sammelkartenspiel-Strategie mit der Intensität von Poker. Axie Infinity Classic ist eine Kombination aus Schach, Poker und Pokémon und das erste Web3-Spiel, das Millionen von Spielern erreichte.
...
## Merkmale von Onchain-Spielen {#features-of-onchain-games}
...
Nicht-fungible Token repräsentieren einzigartige digitale Assets mit unterschiedlichen Eigenschaften und Eigentumsnachweisen, die Onchain gespeichert sind. Ethereum beherbergt das größte NFT-Ökosystem, wobei [OpenSea](https://opensea.io/) der dominierende Allzweck-Marktplatz für den kettenübergreifenden Handel mit Gaming-NFTs bleibt. Jüngste Entwicklungen zeigen, dass sich NFTs über statische Sammlerstücke wie die Axies von Axie Infinity hinaus zu dynamischen, funktionalen digitalen Assets entwickeln, die zum Spielen von Onchain-Spielen verwendet werden können.
...
## Entwicklung von Verbesserungen der Spieler-UX {#evolution-of-player-ux-improvements}

### Interoperabilität und kettenübergreifendes Spielen {#interoperability-and-cross-chain-play}
...
2. **Richte deine Krypto-Wallet ein** – Spieler benötigen eine Wallet, um digitale In-Game-Assets zu verwalten und sich (in einigen Fällen) bei Spielen anzumelden. [Finde hier eine Wallet](/wallets/find-wallet/).
3. **Lade deine Wallet auf** – Erwirb etwas Ether (ETH) oder Token, die für das L2-Netzwerk relevant sind, auf dem du spielen möchtest. [Erfahre hier, wo du ETH bekommst](/get-eth/). 
