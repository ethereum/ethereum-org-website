...
ENS-Namen für Wallets und Verträge schützen vor diesen Arten von Angriffen. Wie bei DNS-Spoofing-Angriffen können auch ENS-Spoofing-Angriffe vorkommen, jedoch bemerkt ein Benutzer einen Rechtschreibfehler in einem ENS-Namen viel eher als eine kleine Änderung an einer hexadezimalen Adresse.

### Bessere UX für Wallets und Explorer {#better-ux}

Wenn ein Smart Contract mit einem ENS-Namen konfiguriert wurde, ist es für Apps wie Wallets und Blockchain-Explorer möglich, ENS-Namen für Smart Contracts anstelle von hexadezimalen Adressen anzuzeigen. Dies bietet eine erhebliche Verbesserung der Benutzererfahrung (UX) für die Benutzer.
...
4. Setzen Sie den Reverse-Eintrag des Vertrags auf das ENS, damit der Name über seine Adresse gefunden werden kann
...
- **Setzen Sie Reverse-Einträge**, um Verträge mit ENS-Namen zu verknüpfen, für die Sichtbarkeit in Apps wie Wallets und Blockchain-Explorern.
...
- [Smart Contracts mit ENS benennen](https://docs.ens.domains/web/naming-contracts/)
- [Smart Contracts mit Enscribe benennen](https://www.enscribe.xyz/docs).