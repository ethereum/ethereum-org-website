...
Nutzen Sie Ethereum, um dezentrale Anwendungen (oder „Dapps“) zu erstellen, die die Vorteile von Kryptowährung und Blockchain-Technologie nutzen. Diese Dapps können vertrauenswürdig sein, was bedeutet, dass sie, sobald sie auf Ethereum bereitgestellt wurden, immer wie programmiert ausgeführt werden. Sie können digitale Vermögenswerte steuern, um neue Arten von Finanzanwendungen zu erstellen. Sie können dezentral sein, was bedeutet, dass keine einzelne Entität oder Person sie kontrolliert und sie fast unmöglich zu zensieren sind.

Erstellen Sie dezentrale Anwendungen auf Ethereum und interagieren Sie mit Smart Contracts unter Verwendung der Programmiersprache Delphi!
...
- [Generierung einer Ethereum-signierten Nachrichtensignatur in Delphi](https://medium.com/@svanas/generating-an-ethereum-signed-message-signature-in-delphi-75661ce5031b)
...
- [Delphi und der Ethereum Name Service (ENS)](https://medium.com/@svanas/delphi-and-ethereum-name-service-ens-4443cd278af7)
...
- [Tausch eines Tokens gegen einen anderen in Delphi](https://svanas.medium.com/swap-one-token-for-another-in-delphi-bcb999c47f7)
