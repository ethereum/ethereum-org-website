...
<FeaturedText>Erfahren Sie, wie Sie mit Rust-basierten Projekten und Tools für Ethereum entwickeln</FeaturedText>

Nutzen Sie Ethereum, um dezentrale Anwendungen (oder "Dapps") zu erstellen, die die Vorteile von Kryptowährung und Blockchain-Technologie nutzen. Diese Dapps können vertrauenswürdig sein, was bedeutet, dass sie, sobald sie auf Ethereum bereitgestellt wurden, immer wie programmiert ausgeführt werden. Sie können digitale Vermögenswerte kontrollieren, um neue Arten von Finanzanwendungen zu schaffen. Sie können dezentral sein, was bedeutet, dass keine einzelne Entität oder Person sie kontrolliert und sie fast unmöglich zu zensieren sind.
...
- [Erstellen Sie einen dezentralen Chat mit JavaScript und Rust](https://medium.com/perlin-network/build-a-decentralized-chat-using-javascript-rust-webassembly-c775f8484b52)
- [Erstellen Sie eine dezentrale Todo-App mit Vue.js & Rust](https://medium.com/@jjmace01/build-a-decentralized-todo-app-using-vue-js-rust-webassembly-5381a1895beb)
...
- [Lighthouse](https://github.com/sigp/lighthouse) - _Schneller Ethereum-Konsensschicht-Client_
- [Ethereum WebAssembly](https://ewasm.readthedocs.io/en/mkdocs/) - _Vorgeschlagenes Redesign der Ethereum-Smart-Contract-Ausführungsschicht unter Verwendung einer deterministischen Teilmenge von WebAssembly_
- [oasis_std](https://docs.rs/oasis-std/latest/oasis_std/index.html) - _OASIS-API-Referenz_
- [Solaris](https://github.com/paritytech/sol-rs) - _Unit-Test-Umgebung für Solidity-Smart-Contracts unter Verwendung der nativen Parity-Client-EVM._
...
- [Alloy](https://alloy.rs) - _Leistungsstarke, gut getestete und dokumentierte Bibliotheken zur Interaktion mit Ethereum und anderen EVM-basierten Chains._
...
- [Reth](https://github.com/paradigmxyz/reth) Reth (kurz für Rust Ethereum) ist eine neue Ethereum-Vollknoten-Implementierung
...
- [Stylus](https://github.com/OffchainLabs/stylus) - _Rust-SDK zum Erstellen von Smart Contracts auf Arbitrum_
