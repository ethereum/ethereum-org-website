...
<FeaturedText>Erfahren Sie, wie Sie mit .NET-basierten Projekten und Tools für Ethereum entwickeln</FeaturedText>
...
- [Playground](https://playground.nethereum.com/) - Interagieren Sie mit Ethereum und lernen Sie, wie Sie Nethereum über den Browser verwenden.
  - Kontostand abfragen [C#](https://playground.nethereum.com/csharp/id/1001) [VB.NET](https://playground.nethereum.com/vb/id/2001)
  - ERC20 Smart Contract-Guthaben abfragen [C#](https://playground.nethereum.com/csharp/id/1005) [VB.NET](https://playground.nethereum.com/vb/id/2004)
  - Ether auf ein Konto überweisen [C#](https://playground.nethereum.com/csharp/id/1003) [VB.NET](https://playground.nethereum.com/vb/id/2003)
  - ... Und mehr!

## Artikel für Fortgeschrittene {#intermediate-articles}

- [Nethereum Arbeitsbuch/Beispielliste](https://docs.nethereum.com/en/latest/Nethereum.Workbooks/docs/)
...
- [Nethereum Block-Verarbeitung](https://nethereum.readthedocs.io/en/latest/nethereum-block-processing-detail/), mit [C# Playground-Beispiel](https://playground.nethereum.com/csharp/id/1025)
