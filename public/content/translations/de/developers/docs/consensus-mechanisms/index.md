...
Der Begriff 'Konsensmechanismus' wird umgangssprachlich oft verwendet, um sich auf Protokolle wie Proof-of-Stake, Proof-of-Work oder den Autoritätsnachweis (PoA) zu beziehen. Dies sind jedoch nur Komponenten in Konsensmechanismen, die vor [Sybil-Angriffen](/glossary/#sybil-attack) schützen. Konsensmechanismen sind der komplette Stack an Ideen, Protokollen und Anreizen, die es einer verteilten Gruppe von Nodes ermöglichen, sich auf den Zustand einer Blockchain zu einigen.
