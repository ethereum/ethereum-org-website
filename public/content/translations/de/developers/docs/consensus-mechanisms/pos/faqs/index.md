...
description: "Häufig gestellte Fragen zu Proof-of-Stake (PoS) bei Ethereum."
lang: de
---
...
- [Mehr zur Verteidigung von Ethereums Proof-of-Stake gegen Angreifer](/developers/docs/consensus-mechanisms/pos/attack-and-defense)
...
## Was sind Knoten, Clients und Validatoren? {#what-are-nodes-clients-and-validators}
...
- [Mehr zu Knoten und Clients](/developers/docs/nodes-and-clients)
- [Mehr zum Staking](/staking)

## Ist Proof-of-Stake eine neue Idee? {#is-pos-new}

Nein. Ein Benutzer auf BitcoinTalk [schlug die Grundidee von Proof-of-Stake](https://bitcointalk.org/index.php?topic=27787.0) 2011 als Upgrade für Bitcoin vor. Es dauerte elf Jahre, bis es bereit war, im Ethereum Mainnet implementiert zu werden. Einige andere Chains implementierten Proof-of-Stake früher als Ethereum, aber nicht den spezifischen Mechanismus von Ethereum (bekannt als Gasper).
...
## Kann Ethereums Proof-of-Stake-System durch einen 51%-Angriff attackiert werden? {#pos-51-attack}
...
## Warum kann ich nur ETH staken? {#why-can-i-only-stake-eth}
...
## Was ist der Merge? {#what-is-the-merge}
...
[Mehr zum Merge](/roadmap/merge)

## Was sind Liveness und Safety? {#what-are-liveness-and-safety}
