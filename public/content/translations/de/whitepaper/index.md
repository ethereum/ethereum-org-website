...
![Ethereum-Zustandsübergang](./ethereum-state-transition.png)
...
<ol>
  <li>
    Für jeden Input in <code>TX</code>:
    <ul>
    <li>
  ...
  <li>
    Gibt <code>S</code> zurück, wobei alle Eingabe-UTXOs entfernt und alle Ausgabe-UTXOs hinzugefügt wurden.
  </li>
</ol>
...
![Ether-Zustandsübergang](./ether-state-transition.png)
...
![Ethereum apply-Blockdiagramm](./ethereum-apply-block-diagram.png)
...
gegenseitig auf.<sup>[Wie?](https://web.archive.org/web/20250427212319/https://github.com/ethereum/wiki/issues/447#issuecomment-316972260#issuecomment-316972260)</sup>
