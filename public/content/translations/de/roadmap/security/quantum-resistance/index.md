...
<ExpandableCard title="Warum kann Ethereum BLS nicht einfach durch ein quantensicheres Verfahren ersetzen?" eventCategory="/roadmap/security/quantum-resistance" eventName="clicked why cant ethereum just replace BLS?">
...
<ExpandableCard title="Können Quantencomputer heute meine ETH stehlen?" eventCategory="/roadmap/security/quantum-resistance" eventName="clicked can quantum computers steal my ETH today?">
...
<ExpandableCard title="Wann könnten Quantencomputer zu einer Bedrohung werden?" eventCategory="/roadmap/security/quantum-resistance" eventName="clicked when could quantum computers become a threat?">
...
<ExpandableCard title="Muss ich etwas tun, um meine Wallet zu schützen?" eventCategory="/roadmap/security/quantum-resistance" eventName="clicked will I need to do anything?">
...
<ExpandableCard title="Was ist mit meinen Token, NFTs und DeFi-Positionen?" eventCategory="/roadmap/security/quantum-resistance" eventName="clicked what about tokens NFTs DeFi?">
...
<ExpandableCard title="Ist Ethereum anderen Blockchains in dieser Hinsicht hinterher?" eventCategory="/roadmap/security/quantum-resistance" eventName="clicked is Ethereum behind?">
...
<ExpandableCard title="Was ist 'harvest now, decrypt later'?" eventCategory="/roadmap/security/quantum-resistance" eventName="clicked what is harvest now decrypt later?">
