...
**Jeder kann kostenlos ein Ethereum-Konto erstellen.** Sie müssen lediglich eine Krypto-Wallet-App installieren. Wallets erstellen und verwalten Ihr Ethereum-Konto. Sie können Transaktionen senden, Ihre Kontostände überprüfen und Sie mit anderen auf Ethereum aufgebauten Anwendungen verbinden.

Mit einer Wallet können Sie sich auch sofort bei Token-Börsen, Spielen und [NFT](/glossary/#nft)-Marktplätzen anmelden. Es ist keine individuelle Registrierung erforderlich, ein Konto wird für alle auf Ethereum aufgebauten Anwendungen gemeinsam genutzt.
...
<AlertContent className="flex-row justify-between items-center">
  <div><b>Wallet installiert?</b><br/>Erfahren Sie, wie Sie sie verwenden.</div>
...
Interessiert an anderen Anleitungen? Werfen Sie einen Blick auf unsere: [Schritt-für-Schritt-Anleitungen](/guides/)
