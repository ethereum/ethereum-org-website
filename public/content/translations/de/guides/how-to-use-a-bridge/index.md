...
- eine Krypto-Wallet haben – wenn nicht, folgen Sie dieser Anleitung, um [ein Ethereum-Konto zu erstellen](/guides/how-to-create-an-ethereum-account/)
- Laden Sie Ihre Krypto-Wallet auf

## 1. Bestimmen Sie, welches Layer-2-Netzwerk Sie verwenden möchten

Mehr über die verschiedenen Projekte und wichtige Links erfahren Sie auf unserer [Layer-2-Seite](/layer-2/).

## 2. Gehen Sie zu der ausgewählten Brücke

Einige beliebte Layer-2-Lösungen sind:

- [Arbitrum-kettenübergreifende Brücke](https://portal.arbitrum.io/bridge?l2ChainId=42161)
- [Optimism-kettenübergreifende Brücke](https://app.optimism.io/bridge/deposit)
- [Boba Network-kettenübergreifende Brücke](https://hub.boba.network/)
...
![Gemeinsame Schnittstelle zum Überbrücken von Tokens](./bridge1.png)
...
![Gemeinsame Schnittstelle zum Überbrücken von Tokens](./bridge2.png)

## 5. Bestätigen Sie die Transaktion in Ihrer Wallet

Für die Abwicklung der Transaktion müssen Sie eine Gebühr (genannt [Gas](/glossary/#gas)) in Form von ETH bezahlen.

![Gemeinsame Schnittstelle zum Überbrücken von Tokens](./bridge3.png)
...
Sie können [chainlist.org](http://chainlist.org) verwenden, um die RPC-Details des Netzwerks zu finden. Sobald das Netzwerk hinzugefügt wurde und die Transaktion abgeschlossen ist, sollten Sie die Token in Ihrer Wallet sehen. <br />
...
Sie können möglicherweise direkt von einer Börse auf einige Layer 2 abheben. Weitere Informationen finden Sie im Abschnitt „Auf Layer 2 wechseln“ auf unserer [Layer-2-Seite](/layer-2/).
