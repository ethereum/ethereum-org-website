...
## सार
EIP-7702 एक EOA में कोड जोड़ने के लिए एक तंत्र को परिभाषित करता है। यह प्रस्ताव EOAs, जो कि पुराने इथेरियम खाते हैं, को अल्पकालिक कार्यक्षमता सुधार प्राप्त करने की अनुमति देता है, जिससे एप्लिकेशन की उपयोगिता बढ़ती है। यह एक नए लेन-देन प्रकार: 4 का उपयोग करके पहले से तैनात किए गए कोड (already deployed code) के लिए एक पॉइंटर सेट करके किया जाता है।

यह नया लेन-देन प्रकार एक प्राधिकरण सूची (authorization list) पेश करता है। सूची में प्रत्येक प्राधिकरण ट्यूपल (authorization tuple) को इस प्रकार परिभाषित किया गया है:
...
**chain_id** प्राधिकरण को एक विशिष्ट चेन (या सभी चेनों के लिए 0) पर लॉक करता है
...
**अनुमति-रहित और सेंसरशिप-प्रतिरोधी डिज़ाइन**: इथेरियम अनुमति-रहित भागीदारी को महत्व देता है। एक प्रत्यायोजन अनुबंध को किसी भी एकल "विश्वसनीय" रिलेयर या सेवा को हार्ड-कोड या उस पर निर्भर नहीं होना चाहिए। यदि रिलेयर ऑफ़लाइन हो जाता है तो यह खाते को बेकार (brick) कर देगा। बैचिंग (जैसे, approve+transferFrom) जैसी सुविधाओं का उपयोग EOA द्वारा स्वयं बिना किसी रिलेयर के किया जा सकता है। एप्लिकेशन डेवलपर्स के लिए जो EIP-7702 (गैस अमूर्तन, गोपनीयता-संरक्षण निकासी) द्वारा सक्षम उन्नत सुविधाओं का उपयोग करना चाहते हैं, आपको एक रिलेयर की आवश्यकता होगी। हालांकि विभिन्न रिलेयर आर्किटेक्चर हैं, हमारी सिफारिश कम से कम [एंट्री पॉइंट 0.8](https://github.com/eth-infinitism/account-abstraction/releases/tag/v0.8.0) को इंगित करने वाले [ERC-4337 बंडलर](https://www.erc4337.io/bundlers) का उपयोग करने की है क्योंकि:

- वे रिलेइंग के लिए मानकीकृत इंटरफेस प्रदान करते हैं
- अंतर्निहित पेमास्टर सिस्टम शामिल करते हैं
...
- यह अपेक्षा कर सकते हैं कि init फ़ंक्शन को केवल [EntryPoint](https://github.com/eth-infinitism/account-abstraction/releases/tag/v0.8.0) से कॉल किया जाए

दूसरे शब्दों में, कोई भी लेन-देन प्रायोजक/रिलेयर के रूप में कार्य करने में सक्षम होना चाहिए जब तक कि वे खाते से आवश्यक वैध हस्ताक्षर या उपयोगकर्ता संचालन (UserOperation) प्रदान करते हैं। यह सेंसरशिप प्रतिरोध सुनिश्चित करता है: यदि किसी कस्टम बुनियादी ढांचे की आवश्यकता नहीं है, तो उपयोगकर्ता के लेन-देन को गेटकीपिंग रिले द्वारा मनमाने ढंग से ब्लॉक नहीं किया जा सकता है। उदाहरण के लिए, [मेटामास्क का प्रत्यायोजन टूलकिट](https://github.com/MetaMask/delegation-framework/releases/tag/v1.3.0) स्पष्ट रूप से किसी भी चेन पर किसी भी ERC-4337 बंडलर या पेमास्टर के साथ काम करता है, बजाय इसके कि मेटामास्क-विशिष्ट सर्वर की आवश्यकता हो।

**वॉलेट इंटरफेस के माध्यम से विकेंद्रीकृत एप्लिकेशन (dapp) एकीकरण**:

यह देखते हुए कि वॉलेट EIP-7702 के लिए विशिष्ट प्रत्यायोजन अनुबंधों को श्वेतसूची (whitelist) में डालेंगे, विकेंद्रीकृत एप्लिकेशन (dapp) को सीधे EIP-7702 प्राधिकरणों का अनुरोध करने की अपेक्षा नहीं करनी चाहिए। इसके बजाय, एकीकरण मानकीकृत वॉलेट इंटरफेस के माध्यम से होना चाहिए:

- **ERC-5792 (`wallet_sendCalls`)**: विकेंद्रीकृत एप्लिकेशन (dapp) को वॉलेट से बैच किए गए कॉल निष्पादित करने का अनुरोध करने में सक्षम बनाता है, जिससे लेन-देन बैचिंग और गैस अमूर्तन जैसी कार्यक्षमताएं सुविधाजनक होती हैं।

- **ERC-6900**: विकेंद्रीकृत एप्लिकेशन (dapp) को वॉलेट-प्रबंधित मॉड्यूल के माध्यम से मॉड्यूलर स्मार्ट खाता क्षमताओं, जैसे सत्र कुंजी (session keys) और खाता पुनर्प्राप्ति का लाभ उठाने की अनुमति देता है。

इन इंटरफेस का उपयोग करके, विकेंद्रीकृत एप्लिकेशन (dapp) सीधे प्रत्यायोजन का प्रबंधन किए बिना EIP-7702 द्वारा प्रदान की गई स्मार्ट खाता कार्यक्षमताओं तक पहुंच सकते हैं, जिससे विभिन्न वॉलेट कार्यान्वयनों में अनुकूलता और सुरक्षा सुनिश्चित होती है।

> नोट: विकेंद्रीकृत एप्लिकेशन (dapp) के लिए सीधे EIP-7702 प्राधिकरण हस्ताक्षरों का अनुरोध करने की कोई मानकीकृत विधि नहीं है। EIP-7702 सुविधाओं का लाभ उठाने के लिए विकेंद्रीकृत एप्लिकेशन (dapp) को ERC-6900 जैसे विशिष्ट वॉलेट इंटरफेस पर निर्भर रहना चाहिए।
...
उदाहरण के लिए, [SafeEIP7702Proxy](https://docs.safe.global/advanced/eip-7702/7702-safe) प्रदर्शित करता है कि EIP-7702-संगत खातों में प्रत्यायोजन को सुरक्षित रूप से इनिशियलाइज़ और प्रबंधित करने के लिए प्रॉक्सी का उपयोग कैसे किया जा सकता है।

प्रॉक्सी पैटर्न के नुकसान:

- **बाहरी अभिनेताओं पर निर्भरता**: आपको किसी असुरक्षित अनुबंध में अपग्रेड न करने के लिए किसी बाहरी टीम पर निर्भर रहना होगा।
...
#### सामान्य प्रत्यायोजन
हार्डवेयर प्रदाता ज्ञात प्रत्यायोजन अनुबंधों को श्वेतसूची (whitelist) में डालता है और सॉफ़्टवेयर सहयोगी (software companion) में उनके समर्थन को लागू करता है। पूर्ण ERC-4337 समर्थन वाले अनुबंध को चुनने की अनुशंसा की जाती है。

किसी भिन्न अनुबंध को प्रत्यायोजित किए गए EOAs को मानक EOAs के रूप में नियंत्रित किया जाएगा।
#### कस्टम प्रत्यायोजन
हार्डवेयर प्रदाता अपना स्वयं का प्रत्यायोजन अनुबंध लागू करता है और इसे सूचियों में जोड़ता है, साथ ही सॉफ़्टवेयर सहयोगी (software companion) में इसके समर्थन को लागू करता है। पूर्ण ERC-4337 समर्थन के साथ एक अनुबंध बनाने की अनुशंसा की जाती है。
