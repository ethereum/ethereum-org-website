...
description: जानें कि कैसे ज़ीरो-नॉलेज प्रमाण एथेरियम ब्लॉक निष्पादन को सत्यापित कर सकते हैं, जिससे उच्च थ्रूपुट और कम क्लाइंट आवश्यकताएं सक्षम होती हैं।
lang: hi
---

# L1 ब्लॉक सत्यापन के लिए zkEVM {#zkevm-l1}

zkEVM एक ऐसी तकनीक है जो एथेरियम ब्लॉक निष्पादन को सत्यापित करने के लिए [ज़ीरो-नॉलेज प्रमाणों](/zero-knowledge-proofs/) का उपयोग करती है। प्रत्येक [क्लाइंट](/glossary/#validator) को एक ब्लॉक में सभी लेनदेन को फिर से निष्पादित करने की आवश्यकता के बजाय, एक एकल विशेष कर्ता (जिसे "प्रूवर" कहा जाता है) ब्लॉक को निष्पादित करता है और एक क्रिप्टोग्राफिक प्रमाण उत्पन्न करता है कि निष्पादन सही था। कोई भी नोड तब इस प्रमाण को सत्यापित कर सकता है—एक ऐसी प्रक्रिया जो सभी लेनदेन को फिर से निष्पादित करने की तुलना में कई गुना सस्ती है।
...
आज, एथेरियम "N-of-N" सत्यापन मॉडल का उपयोग करता है: प्रस्तावित स्थिति परिवर्तन सही हैं, यह सत्यापित करने के लिए प्रत्येक क्लाइंट को स्वतंत्र रूप से प्रत्येक ब्लॉक में प्रत्येक लेनदेन को फिर से निष्पादित करना होगा। हालांकि यह दृष्टिकोण अधिकतम रूप से विश्वासहीन (trustless) है, यह एक बुनियादी बाधा उत्पन्न करता है।

समस्या यह है कि एथेरियम का थ्रूपुट इस बात से सीमित है कि औसत क्लाइंट क्या संसाधित कर सकता है। [गैस की सीमा](/glossary/#gas-limit) बढ़ाने से प्रति ब्लॉक अधिक लेनदेन की अनुमति मिलेगी, लेकिन इससे क्लाइंट के लिए हार्डवेयर आवश्यकताएं भी बढ़ जाएंगी। यह विकेंद्रीकरण के लिए खतरा है—यदि क्लाइंट चलाने के लिए महंगे हार्डवेयर की आवश्यकता होती है, तो नेटवर्क को सुरक्षित करने में कम लोग भाग ले सकते हैं।

zkEVM इस समझौते से बाहर निकलने का एक रास्ता प्रदान करता है। "हर कोई फिर से निष्पादित करता है" से "एक साबित करता है, हर कोई सत्यापित करता है" में स्थानांतरित होकर, एथेरियम क्लाइंट हार्डवेयर आवश्यकताओं को बढ़ाए बिना सुरक्षित रूप से गैस की सीमा बढ़ा सकता है।
...
जब सत्यापन सस्ता होता है, तो गैस की सीमा सुरक्षित रूप से बढ़ सकती है। यह नेटवर्क क्षमता का विस्तार करता है और उच्च मांग की अवधि के दौरान शुल्क को स्थिर करने में मदद करता है। वर्तमान गैस की सीमा आंशिक रूप से क्लाइंट हार्डवेयर द्वारा विवश है—zkEVM इस बाधा को दूर करता है।

### मजबूत विकेंद्रीकरण {#stronger-decentralization}

zkEVM सत्यापन के साथ, सत्यापनकर्ता को लेनदेन निष्पादित करने के बजाय केवल प्रमाणों को सत्यापित करने की आवश्यकता होती है। यह क्लाइंट चलाने के लिए हार्डवेयर आवश्यकताओं को नाटकीय रूप से कम करता है, जिससे अधिक लोग नेटवर्क को सुरक्षित करने में भाग ले सकते हैं। अधिक क्लाइंट विविधता एथेरियम के सेंसरशिप प्रतिरोध और लचीलेपन को मजबूत करती है।

ध्यान दें कि प्रमाणन के लिए स्वयं महत्वपूर्ण कम्प्यूटेशनल संसाधनों की आवश्यकता होती है, जो वर्तमान क्लाइंट हार्डवेयर से अधिक है। हालांकि, सत्यापन के विपरीत, प्रमाणन को उसी तरह विकेन्द्रीकृत होने की आवश्यकता नहीं है: प्रति ब्लॉक केवल एक सही प्रमाण की आवश्यकता होती है, और कोई भी इसे जल्दी से सत्यापित कर सकता है। प्रूवर बाजारों, प्रमाण एकत्रीकरण और हार्डवेयर त्वरण में अनुसंधान का उद्देश्य यह सुनिश्चित करना है कि प्रमाणन कुछ बड़े ऑपरेटरों के बीच केंद्रित होने के बजाय प्रतिस्पर्धी और सुलभ बना रहे।
