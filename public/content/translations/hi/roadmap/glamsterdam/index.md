...
<AlertContent>
<AlertTitle>
ग्लैमस्टर्डम 2026 की चौथी तिमाही (Q4) के लिए नियोजित एक आगामी इथेरियम अपग्रेड है
</AlertTitle>
<AlertDescription>
...
## ग्लैमस्टर्डम में सुधार {#improvements-in-glamsterdam}

<Alert variant="info">
<AlertContent>
<AlertDescription>
नोट: यह लेख ग्लैमस्टर्डम में शामिल करने के लिए निर्धारित EIPs के चयन पर प्रकाश डालता है। डेवनेट (devnets) में परीक्षण किए जा रहे अतिरिक्त निर्धारित प्रस्तावों में EIP-7610, EIP-7688, EIP-7778, EIP-7843, EIP-7976, EIP-7981, EIP-8024, EIP-8246 और EIP-8282 शामिल हैं। नवीनतम स्थिति अपडेट के लिए, [Forkcast पर ग्लैमस्टर्डम अपग्रेड](https://forkcast.org/upgrade/glamsterdam) देखें।

यदि आप कोई ऐसा EIP जोड़ना चाहते हैं जिस पर ग्लैमस्टर्डम के लिए विचार किया जा रहा है, लेकिन उसे अभी तक इस पृष्ठ पर नहीं जोड़ा गया है, तो [यहां ethereum.org में योगदान करने का तरीका जानें](/contributing/)।
</AlertDescription>
</AlertContent>
</Alert>
...
- प्रसंस्करण को गति देना (समानांतरकरण): नेटवर्क द्वारा डेटा निर्भरताओं को रिकॉर्ड करने के तरीके को पुनर्गठित करना, ताकि यह धीमी, एक-एक करके अनुक्रम के बजाय एक ही समय में कई लेन-देन को सुरक्षित रूप से संसाधित कर सके।
- क्षमता का विस्तार करना: ब्लॉक बनाने और सत्यापित करने के भारी काम को विभाजित करना, जिससे नेटवर्क को धीमा हुए बिना बड़ी मात्रा में डेटा प्रसारित करने के लिए अधिक समय मिल सके।
...
सत्यापक कर्तव्यों और निकास प्रक्रियाओं में सुधार बड़े पैमाने पर कटौती (mass-slashing) घटनाओं के दौरान नेटवर्क स्थिरता सुनिश्चित करते हैं और स्टेकर्स के अपना स्टेक स्थानांतरित करने की गति को तेज़ करते हैं। ये सुधार नेटवर्क को अधिक स्थिर बनाते हैं और यह सुनिश्चित करते हैं कि सभी प्रतिभागियों, बड़े और छोटे, के साथ उचित व्यवहार किया जाए।
...
### निकास और समेकन मंथन बढ़ाएं {#increase-exit-and-consolidation-churn}

- निकास क्षमता को एक निश्चित दर पर सीमित करने के बजाय, स्टेक किए गए ETH की कुल मात्रा के साथ स्केल करने की अनुमति देकर स्टेकिंग निकासी के समय को काफी कम करता है
- सत्यापक समेकन को उनकी अपनी समर्पित कतार क्षमता देता है, जिससे बड़े, अधिक कुशल सत्यापकों में संक्रमण तेज हो जाता है
- सावधानीपूर्वक विश्लेषण किए गए सुरक्षा मापदंडों के माध्यम से नेटवर्क सुरक्षा बनाए रखता है

इथेरियम की मंथन सीमा उस दर पर एक सुरक्षा सीमा है जिस पर सत्यापक अपने स्टेक किए गए ETH के साथ प्रवेश कर सकते हैं, निकास कर सकते हैं, या विलय (समेकन) कर सकते हैं, ताकि यह सुनिश्चित हो सके कि नेटवर्क की सुरक्षा कभी अस्थिर न हो। आज, निकास और सक्रियण एक ही सीमित सीमा साझा करते हैं, इसलिए उच्च मांग की अवधि के दौरान स्टेकर्स को अपना ETH निकालने के लिए लंबे समय तक इंतजार करना पड़ सकता है। समेकन, जहां सत्यापक 2,048 ETH तक के बड़े सत्यापकों में विलय करते हैं ([पेक्ट्रा अपग्रेड](/roadmap/pectra) द्वारा सक्षम), भी इस सीमित क्षमता के लिए प्रतिस्पर्धा करते हैं, जिसका अर्थ है कि वर्तमान दर पर पूर्ण सत्यापक सेट को समेकित करने में वर्षों लग जाएंगे।

**निकास और समेकन मंथन बढ़ाएं (या EIP-8061)** इन सीमाओं को अलग-अलग लेन में पुनर्गठित करता है:

- सत्यापक सक्रियण अपनी मौजूदा सीमित सीमा को अपरिवर्तित रखते हैं
- निकास अब सीमित नहीं हैं और इसके बजाय स्टेक किए गए ETH की कुल मात्रा के साथ स्केल करते हैं
- समेकन को अपनी समर्पित क्षमता मिलती है, जो संयुक्त सक्रियण-निकास सीमा के आकार की लगभग आधी होती है

वर्तमान स्टेकिंग स्तरों पर, यह निकास क्षमता को लगभग 4 गुना और समेकन क्षमता को लगभग 2 गुना बढ़ा देता है, जिसका अर्थ है कि स्टेकर्स उच्च-मांग की अवधि के दौरान अपना ETH बहुत तेज़ी से निकाल सकते हैं और नेटवर्क अधिक तेज़ी से एक छोटे, अधिक कुशल सत्यापक सेट में परिवर्तित हो जाता है।

चूंकि स्टेक नेटवर्क के अंदर और बाहर तेज़ी से जा सकता है, यह परिवर्तन उस समय को लगभग आधा कर देता है जिसके लिए एक नोड ऑफ़लाइन रह सकता है, इससे पहले कि उसे सुरक्षित रूप से नेटवर्क में फिर से शामिल होने के लिए एक हालिया विश्वसनीय जाँच-बिंदु की आवश्यकता हो (कमजोर व्यक्तिनिष्ठता अवधि, लगभग 15.7 दिनों से लगभग 7 दिनों तक)। नेटवर्क सुरक्षा बनाए रखने को सुनिश्चित करने के लिए इस ट्रेड-ऑफ़ का सावधानीपूर्वक विश्लेषण किया गया था।

**संसाधन**: [EIP-8061 तकनीकी विशिष्टता](https://eips.ethereum.org/EIPS/eip-8061)
...
- अधिकतम अनुबंध आकार बढ़ाएं (या EIP-7954) डेवलपर्स को बड़े एप्लिकेशन तैनात करने की अनुमति देता है, जिससे अधिकतम अनुबंध आकार सीमा लगभग 24KiB से बढ़कर 64KiB हो जाती है।
...
- स्थिति निर्माण गैस लागत में वृद्धि (या EIP-8037) और स्थिति-एक्सेस गैस लागत अपडेट (या EIP-8038) नए स्थिरता मॉडल पेश करते हैं जो कुछ अनुबंध तैनाती लागतों को बदल देंगे, क्योंकि नए खाते या स्थायी भंडारण बनाने पर बनाए गए डेटा के आकार के आधार पर एक नया मानकीकृत निश्चित शुल्क होगा।
