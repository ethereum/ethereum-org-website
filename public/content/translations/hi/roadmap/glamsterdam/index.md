---
title: ग्लैमस्टरडैम
description: "ग्लैमस्टरडैम प्रोटोकॉल अपग्रेड के बारे में जानें"
lang: hi
---

# ग्लैमस्टरडैम {#glamsterdam}

<Alert variant="update">
<AlertContent>
<AlertTitle>
ग्लैमस्टरडैम 2026 की पहली छमाही के लिए नियोजित एक आगामी एथेरियम अपग्रेड है
</AlertTitle>
<AlertDescription>
ग्लैमस्टरडैम अपग्रेड एथेरियम के दीर्घकालिक विकास लक्ष्यों में केवल एक कदम है। [प्रोटोकॉल रोडमैप](/roadmap/) और [पिछले अपग्रेड](/ethereum-forks/) के बारे में और जानें।
</AlertDescription>
</AlertContent>
</Alert>

[एथेरियम का](/) आगामी ग्लैमस्टरडैम अपग्रेड स्केलिंग की अगली पीढ़ी के लिए मार्ग प्रशस्त करने के लिए डिज़ाइन किया गया है। ग्लैमस्टरडैम का नाम "Amsterdam" (निष्पादन परत अपग्रेड, जिसका नाम पिछले Devconnect स्थान के नाम पर रखा गया है) और "Gloas" (सहमति परत अपग्रेड, जिसका नाम एक तारे के नाम पर रखा गया है) के संयोजन से रखा गया है।

[Fusaka](/roadmap/fusaka/) अपग्रेड में हुई प्रगति के बाद, ग्लैमस्टरडैम नेटवर्क द्वारा लेनदेन को संसाधित करने और अपने बढ़ते डेटाबेस को प्रबंधित करने के तरीके को पुनर्गठित करके L1 को स्केल करने पर ध्यान केंद्रित करता है, जो मौलिक रूप से अपडेट करता है कि एथेरियम ब्लॉक कैसे बनाता और सत्यापित करता है।

जबकि Fusaka ने मूलभूत परिशोधन पर ध्यान केंद्रित किया, ग्लैमस्टरडैम विभिन्न नेटवर्क प्रतिभागियों के बीच कर्तव्यों के पृथक्करण को स्थापित करके, और उच्च-थ्रूपुट समानांतरकरण के लिए [स्टेट](/glossary/#state) तैयार करने के लिए डेटा को संभालने के अधिक कुशल तरीकों को पेश करके "स्केल L1" और "स्केल ब्लब्स" उद्देश्यों को आगे बढ़ाता है।

ये सुधार यह सुनिश्चित करते हैं कि एथेरियम अधिक गतिविधि को संभालते हुए तेज़, किफायती और विकेन्द्रीकृत बना रहे, जबकि घर पर [नोड्स](/glossary/#node) चलाने वाले लोगों के लिए हार्डवेयर आवश्यकताओं को प्रबंधनीय बनाए रखा जाए।

<YouTube id="GgKveVMLnoo" />

## ग्लैमस्टरडैम के लिए विचाराधीन सुधार {#improvements-in-glamsterdam}

<Alert variant="info">
<AlertContent>
<AlertDescription>
ध्यान दें: यह लेख वर्तमान में ग्लैमस्टरडैम में शामिल करने के लिए विचाराधीन EIPs के चयन पर प्रकाश डालता है। नवीनतम स्थिति अपडेट के लिए, [Forkcast पर ग्लैमस्टरडैम अपग्रेड](https://forkcast.org/upgrade/glamsterdam) देखें।

यदि आप ग्लैमस्टरडैम के लिए विचाराधीन एक EIP जोड़ना चाहते हैं, लेकिन अभी तक इस पृष्ठ पर नहीं जोड़ा गया है, तो [यहां ethereum.org में योगदान करने का तरीका जानें](/contributing/)।
</AlertDescription>
</AlertContent>
</Alert>

ग्लैमस्टरडैम अपग्रेड तीन मुख्य लक्ष्यों पर केंद्रित है:
...
संक्षेप में, ग्लैमस्टरडैम यह सुनिश्चित करने के लिए संरचनात्मक परिवर्तन पेश करेगा कि जैसे-जैसे नेटवर्क की क्षमता बढ़ती है, यह टिकाऊ बना रहे और प्रदर्शन उच्च बना रहे।

## L1 को स्केल करें और समानांतर प्रसंस्करण करें {#scale-l1}

सार्थक L1 स्केलिंग के लिए ऑफ-प्रोटोकॉल विश्वास धारणाओं और सीरियल निष्पादन बाधाओं से दूर जाने की आवश्यकता है। ग्लैमस्टरडैम कुछ ब्लॉक-निर्माण कर्तव्यों के पृथक्करण को स्थापित करके और नई डेटा संरचनाओं को पेश करके इसे संबोधित करता है जो नेटवर्क को समानांतर प्रसंस्करण के लिए तैयार करने की अनुमति देते हैं।
...
वर्तमान में, ब्लॉक प्रस्तावित करने और बनाने की प्रक्रिया में ब्लॉक प्रस्तावक और ब्लॉक बिल्डर के बीच एक हैंड-ऑफ शामिल है। प्रस्तावक और बिल्डर के बीच का संबंध मुख्य एथेरियम प्रोटोकॉल का हिस्सा नहीं है, इसलिए यह विश्वसनीय तृतीय-पक्ष मिडलवेयर, सॉफ़्टवेयर (रिले) और संस्थाओं के बीच ऑफ-प्रोटोकॉल विश्वास पर निर्भर करता है।
...
ऑफ-प्रोटोकॉल मिडलवेयर और रिले को इन-प्रोटोकॉल मैकेनिक्स से बदलकर, ePBS विश्वास निर्भरता को कम करता है और एथेरियम को नेटवर्क पर दबाव डाले बिना बहुत बड़ी मात्रा में डेटा (जैसे [परत 2](/glossary/#layer-2) के लिए अधिक ब्लॉब्स) को सुरक्षित रूप से संसाधित करने की अनुमति देता है।
...
BALs द्वारा सक्षम समानांतर डिस्क रीड एक ऐसे भविष्य की ओर एक महत्वपूर्ण कदम होगा जहां एथेरियम एक साथ कई लेनदेन को संसाधित कर सकता है, जिससे नेटवर्क की गति में काफी वृद्धि होगी।
...
जैसे-जैसे एथेरियम नेटवर्क तेजी से बढ़ता है, यह सुनिश्चित करना महत्वपूर्ण है कि इसका उपयोग करने की लागत एथेरियम को चलाने वाले हार्डवेयर पर होने वाले टूट-फूट से मेल खाती है। नेटवर्क को सुरक्षित रूप से स्केल करने और अधिक लेनदेन को संसाधित करने के लिए अपनी समग्र क्षमता सीमाओं को बढ़ाने की आवश्यकता है।

### स्टेट निर्माण गैस लागत में वृद्धि {#state-creation-gas-cost-increase}

- यह सुनिश्चित करता है कि नए खाते या स्मार्ट अनुबंध बनाने के लिए शुल्क एथेरियम के डेटाबेस पर उनके द्वारा डाले गए दीर्घकालिक बोझ को सटीक रूप से दर्शाते हैं
...
एथेरियम पर स्टेट बनाने वाली कुछ क्रियाएं, जैसे नए खाते बनाना या बड़े स्मार्ट अनुबंधों को तैनात करना, नेटवर्क के नोड्स पर उनके द्वारा लिए जाने वाले स्थायी भंडारण स्थान की तुलना में अपेक्षाकृत कम लागत वाली रही हैं, उदाहरण के लिए, अनुबंध परिनियोजन भंडारण स्लॉट बनाने की तुलना में प्रति बाइट काफी सस्ता है।

समायोजन के बिना, यदि नेटवर्क 100M गैस की सीमा तक स्केल करता है, तो एथेरियम का स्टेट प्रति वर्ष लगभग 200 GiB बढ़ सकता है, जो अंततः सामान्य हार्डवेयर से आगे निकल जाएगा।
...
डेटा भंडारण का अधिक सटीक और अनुमानित रूप से मूल्य निर्धारण करने से एथेरियम को डेटाबेस को ब्लोट किए बिना अपनी गति और क्षमता को सुरक्षित रूप से बढ़ाने में मदद मिलेगी। यह स्थिरता नोड ऑपरेटरों को आने वाले वर्षों के लिए (अपेक्षाकृत) किफायती हार्डवेयर का उपयोग जारी रखने की अनुमति देगी, जिससे नेटवर्क के विकेंद्रीकरण को बनाए रखने के लिए घर पर स्टेकिंग सुलभ रहेगी।
...
- जब एप्लिकेशन एथेरियम पर स्थायी रूप से संग्रहीत जानकारी (स्टेट-एक्सेस ओपकोड) को पढ़ते या अपडेट करते हैं, तो गैस लागत बढ़ाता है ताकि इन कमांडों के लिए आवश्यक गणना कार्य का सटीक मिलान हो सके
...
जैसे-जैसे एथेरियम का स्टेट बढ़ा है, पुराने डेटा को खोजने और पढ़ने का कार्य ("स्टेट एक्सेस") नोड्स के लिए संसाधित करने के लिए भारी और धीमा हो गया है। इन कार्यों के लिए शुल्क समान रहे हैं, भले ही अब जानकारी देखना (गणना शक्ति के मामले में) थोड़ा अधिक महंगा है।
...
स्टेट-एक्सेस की लागत को संरेखित करने से एथेरियम को और अधिक लचीला बनाने में भी मदद मिलती है। क्योंकि ये भारी डेटा-रीडिंग क्रियाएं कृत्रिम रूप से सस्ती हैं, एक दुर्भावनापूर्ण हमलावर नेटवर्क की शुल्क सीमा तक पहुंचने से पहले एक ही ब्लॉक में हजारों जटिल डेटा अनुरोधों के साथ नेटवर्क को स्पैम कर सकता है, जिससे संभावित रूप से नेटवर्क रुक सकता है या क्रैश हो सकता है (एक सेवा-से-इनकार हमला)। दुर्भावनापूर्ण इरादे के बिना भी, यदि नेटवर्क डेटा पढ़ना बहुत सस्ता है, तो डेवलपर्स को कुशल एप्लिकेशन बनाने के लिए आर्थिक रूप से प्रोत्साहित नहीं किया जाता है।

स्टेट-एक्सेस क्रियाओं का अधिक सटीक मूल्य निर्धारण करके एथेरियम आकस्मिक या जानबूझकर मंदी के खिलाफ अधिक लचीला हो सकता है, जबकि नेटवर्क लागत को हार्डवेयर लोड के साथ संरेखित करना भविष्य में गैस की सीमा में वृद्धि के लिए एक अधिक स्थायी आधार साबित होता है।
...
- एथेरियम को सुचारू रूप से और भरोसेमंद रूप से चालू रखता है, बड़े पैमाने पर स्लैशिंग घटना के मामले में गंभीर ठहराव को रोकता है
...
- एथेरियम की मुख्य सुरक्षा सीमाओं को बदलने या नेटवर्क को कमजोर करने से बचने के लिए सख्त सुरक्षा बनाए रखता है

[पेक्ट्रा अपग्रेड](/roadmap/pectra) के बाद से एथेरियम सत्यापनकर्ताओं के लिए अधिकतम प्रभावी शेष राशि 32 ETH से बढ़कर 2,048 ETH हो गई है, एक तकनीकी खामी उच्च-शेष सत्यापनकर्ताओं को समेकन कतार के माध्यम से छोटे सत्यापनकर्ताओं की तुलना में तेजी से नेटवर्क से बाहर निकलने की अनुमति देती है।
...
- एथेरियम की मंथन सीमा उस दर पर एक सुरक्षा सीमा है जिस पर सत्यापनकर्ता अपने दांव पर लगे ETH में प्रवेश कर सकते हैं, बाहर निकल सकते हैं, या विलय (समेकित) कर सकते हैं, यह सुनिश्चित करने के लिए कि नेटवर्क की सुरक्षा कभी भी अस्थिर न हो
...
एथेरियम के ग्लैमस्टरडैम अपग्रेड का उद्देश्य उपयोगकर्ता अनुभव में सुधार करना, डेटा खोज क्षमता को बढ़ाना और सिंक विफलताओं को रोकने के लिए बढ़ते संदेश आकारों को संभालना है। यह नेटवर्क के स्केलिंग के साथ तकनीकी अड़चनों को रोकते हुए ऑनचेन क्या हो रहा है, इसे ट्रैक करना आसान बनाता है।
...
- छोटे हस्तांतरण को और अधिक किफायती बनाता है, जिससे एथेरियम की व्यवहार्यता एक नियमित विनिमय माध्यम के रूप में बढ़ती है

आज सभी एथेरियम लेनदेन पर एक समान आधार गैस शुल्क है, भले ही इसे संसाधित करना कितना भी सरल या जटिल क्यों न हो। **आंतरिक लेनदेन गैस कम करें (या EIP-2780)** उस आधार शुल्क को कम करने का प्रस्ताव करता है ताकि मौजूदा खातों के बीच एक मानक ETH हस्तांतरण **71% तक सस्ता** हो सके।
...
यदि किसी उपयोगकर्ता के पास आज कई एथेरियम Virtual Machine (EVM)-संगत श्रृंखलाओं में खातों के साथ एक स्मार्ट अनुबंध वॉलेट है, तो वे अक्सर विभिन्न नेटवर्कों पर पूरी तरह से अलग पते के साथ समाप्त होते हैं। यह न केवल भ्रामक है, बल्कि इससे धन की आकस्मिक हानि भी हो सकती है।

**नियतात्मक फैक्टरी प्रीडिप्लॉय (या EIP-7997)** डेवलपर्स को एथेरियम मेननेट, परत 2 (L2) नेटवर्क, और बहुत कुछ सहित कई EVM श्रृंखलाओं में एक ही पते पर अपने विकेंद्रीकृत अनुप्रयोगों और स्मार्ट अनुबंध वॉलेट को तैनात करने का एक देशी, अंतर्निहित तरीका देता है। यदि अपनाया जाता है, तो यह उपयोगकर्ता को प्रत्येक भाग लेने वाली श्रृंखला पर एक ही पता रखने की अनुमति देगा, जिससे संज्ञानात्मक भार और उपयोगकर्ता त्रुटि की संभावना में काफी कमी आएगी।
...
जैसे-जैसे हम एथेरियम द्वारा किए जा सकने वाले काम की मात्रा बढ़ाते हैं, उन कार्यों के लिए रसीदों की सूचियां (इन लेनदेन के डेटा रिकॉर्ड) इतनी बड़ी होती जा रही हैं कि वे संभावित रूप से नेटवर्क के नोड्स को एक-दूसरे के साथ डेटा सिंक करने का प्रयास करते समय विफल कर सकती हैं।
...
यह परिवर्तन भारी गतिविधि की अवधि के दौरान नेटवर्क सिंक विफलताओं को रोकेगा। अंततः, यह एथेरियम को अपनी ब्लॉक क्षमता बढ़ाने और भविष्य में प्रति ब्लॉक अधिक लेनदेन संसाधित करने का मार्ग प्रशस्त करता है, बिना श्रृंखला को सिंक करने वाले भौतिक हार्डवेयर पर भारी पड़े।
...
- [Forkcast: ग्लैमस्टरडैम](https://forkcast.org/upgrade/glamsterdam)
- [ग्लैमस्टरडैम मेटा EIP](https://eips.ethereum.org/EIPS/eip-7773)
- [2026 के लिए प्रोटोकॉल प्राथमिकताएँ अपडेट ब्लॉग घोषणा](https://blog.ethereum.org/2026/02/18/protocol-priorities-update-2026)
- [द डेली ग्वेई रिफ्यूल पॉडकास्ट - पोस्ट-क्वांटम एथेरियम, ग्लैमस्टरडैम आ रहा है](https://www.youtube.com/watch?v=qx9sd50uQjQ)

## अक्सर पूछे जाने वाले प्रश्न {#faq}

### ग्लैमस्टरडैम हार्ड फोर्क के बाद ETH को कैसे परिवर्तित किया जा सकता है? {#how-can-eth-be-converted-after-the-hardfork}

- **आपके ETH के लिए कोई कार्रवाई आवश्यक नहीं है**: ग्लैमस्टरडैम अपग्रेड के बाद आपके ETH को बदलने या अपग्रेड करने की कोई आवश्यकता नहीं है। आपके खाते का बैलेंस वही रहेगा, और हार्ड फोर्क के बाद आपके पास वर्तमान में मौजूद ETH उसी रूप में उपलब्ध रहेगा।
...
### क्या ग्लैमस्टरडैम अपग्रेड सभी एथेरियम नोड्स और सत्यापनकर्ताओं को प्रभावित करता है? {#does-the-glamsterdam-upgrade-affect-all-ethereum-nodes-and-validators}

हां, ग्लैमस्टरडैम अपग्रेड के लिए [निष्पादन क्लाइंट और सहमति क्लाइंट](/developers/docs/nodes-and-clients/) दोनों के लिए अपडेट की आवश्यकता है। क्योंकि यह अपग्रेड एनश्राइंड प्रस्तावक-बिल्डर सेपरेशन (ePBS) का परिचय देता है, नोड ऑपरेटरों को यह सुनिश्चित करने की आवश्यकता होगी कि उनके क्लाइंट नेटवर्क द्वारा ब्लॉक बनाने, मान्य करने और प्रमाणित करने के नए तरीकों को संभालने के लिए अपडेट किए गए हैं।

सभी मुख्य इथेरियम क्लाइंट उच्च प्राथमिकता के रूप में चिह्नित हार्ड फोर्क का समर्थन करने वाले संस्करण जारी करेंगे। आप क्लाइंट गिटहब रिपॉजिटरी, उनके [डिस्कॉर्ड चैनलों](https://ethstaker.org/support), [ईथस्टेकर डिस्कॉर्ड](https://dsc.gg/ethstaker) में इन रिलीज़ की उपलब्धता के साथ बने रह सकते हैं, या प्रोटोकॉल अपडेट के लिए एथेरियम ब्लॉग की सदस्यता ले सकते हैं।
...
### एक स्टेकर के रूप में, मुझे ग्लैमस्टरडैम अपग्रेड के लिए क्या करने की आवश्यकता है? {#as-a-staker-what-do-i-need-to-do-for-the-glamsterdam-upgrade}

हर नेटवर्क अपग्रेड की तरह, सुनिश्चित करें कि आप अपने क्लाइंट्स को ग्लैमस्टरडैम समर्थन के साथ चिह्नित नवीनतम संस्करणों में अपडेट करें। रिलीज़ के बारे में सूचित होने के लिए मेलिंग सूची और [EF ब्लॉग पर प्रोटोकॉल घोषणाओं](https://blog.ethereum.org/category/protocol) में अपडेट का पालन करें।

मेननेट पर ग्लैमस्टरडैम सक्रिय होने से पहले अपने सेटअप को मान्य करने के लिए, आप टेस्टनेट पर एक सत्यापनकर्ता चला सकते हैं। टेस्टनेट फोर्क की घोषणा मेलिंग सूची और ब्लॉग में भी की जाती है।

### ग्लैमस्टरडैम L1 स्केलिंग के लिए क्या सुधार शामिल करेगा? {#what-improvements-will-glamsterdam-include-for-l1-scaling}

हेडलाइन सुविधा ePBS (EIP-7732) है, जो नेटवर्क लेनदेन को मान्य करने के भारी कार्य को सहमति तक पहुंचने के कार्य से अलग करती है। यह डेटा प्रसार विंडो को 2 सेकंड से लगभग 9 सेकंड तक बढ़ाता है, जिससे एथेरियम की बहुत अधिक लेनदेन थ्रूपुट को सुरक्षित रूप से संभालने और परत 2 नेटवर्क के लिए अधिक डेटा ब्लॉब्स को समायोजित करने की क्षमता अनब्लॉक हो जाती है।

### क्या ग्लैमस्टरडैम एथेरियम (परत 1) पर शुल्क कम करेगा? {#will-glamsterdam-lower-fees-on-ethereum-layer-1}

हां, ग्लैमस्टरडैम सबसे अधिक संभावना रोजमर्रा के उपयोगकर्ताओं के लिए शुल्क कम करेगा! आंतरिक लेनदेन गैस को कम करें (या EIP-2780) ETH भेजने के लिए आधार शुल्क को कम करता है, जिससे ETH रोजमर्रा के भुगतानों के लिए उपयोग करने के लिए बहुत सस्ता हो जाता है।

इसके अलावा, दीर्घकालिक स्थिरता के लिए, ग्लैमस्टरडैम ब्लॉक-स्तरीय एक्सेस सूचियों (BALs) का परिचय देता है। यह समानांतर प्रसंस्करण को सक्षम बनाता है और L1 को भविष्य में उच्च समग्र गैस की सीमाओं को सुरक्षित रूप से संभालने के लिए तैयार करता है, जो क्षमता बढ़ने पर प्रति-लेनदेन गैस लागत को कम करने की संभावना है।

### क्या ग्लैमस्टरडैम के बाद मेरे मौजूदा स्मार्ट अनुबंधों में कोई बदलाव होगा? {#will-my-smart-contracts-change}

मौजूदा अनुबंध ग्लैमस्टरडैम के बाद सामान्य रूप से काम करते रहेंगे। डेवलपर्स को संभवतः कई नए उपकरण मिलेंगे और उन्हें अपने गैस उपयोग की समीक्षा करनी चाहिए:
...
### ग्लैमस्टरडैम नोड भंडारण और हार्डवेयर आवश्यकताओं को कैसे प्रभावित करेगा? {#how-will-glamsterdam-affect-node-storage-and-hardware-requirements}

ग्लैमस्टरडैम के लिए विचाराधीन कई EIP स्टेट वृद्धि के प्रदर्शन क्लिफ को संबोधित करते हैं:
...
- eth/70 आंशिक ब्लॉक रसीद सूचियां (या EIP-7975) नोड्स को पेजिनेटेड ब्लॉक रसीदें अनुरोध करने की अनुमति देती हैं, जो एथेरियम के स्केलिंग के साथ क्रैश और सिंक को रोकने के लिए डेटा-भारी ब्लॉक रसीद सूचियों को छोटे टुकड़ों में तोड़ती हैं।
