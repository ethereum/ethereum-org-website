---
title: "विकेंद्रीकृत वित्त (डीफाई)"
...
डीफाई एक खुली और वैश्विक वित्तीय प्रणाली है जिसे इंटरनेट युग के लिए बनाया गया है - एक ऐसी प्रणाली का विकल्प जो अपारदर्शी है, दृढ़तापूर्वक नियंत्रित है, और दशकों पुरानी बुनियादी सुविधाओं और प्रक्रियाओं द्वारा एक साथ रखी गई है। यह आपको आपके पैसे पर नियंत्रण और दृश्यता प्रदान करता है। यह आपको वैश्विक बाजारों और आपकी स्थानीय मुद्रा या बैंकिंग विकल्पों के विकल्प प्रदान करता है। डीफाई उत्पाद इंटरनेट कनेक्शन वाले किसी भी व्यक्ति के लिए वित्तीय सेवाएं खोलते हैं और उनका स्वामित्व और रखरखाव बड़े पैमाने पर उनके उपयोगकर्ताओं द्वारा किया जाता है। अब तक अरबों डॉलर मूल्य की क्रिप्टो डीफाई एप्लिकेशन के माध्यम से प्रवाहित हुई है और यह आंकड़े हर दिन बढ़ रहे हैं।

## डीफाई क्या है? {#what-is-defi}

डीफाई वित्तीय उत्पादों और सेवाओं के लिए एक सामूहिक शब्द है जो इथेरियम का उपयोग करने वाले किसी भी व्यक्ति के लिए पहुंच योग्य है – इंटरनेट कनेक्शन वाला कोई भी व्यक्ति। डीफाई के साथ, बाजार हमेशा खुले रहते हैं और कोई केंद्रीकृत प्राधिकरण नहीं होता है जो भुगतान को रोक सकता है या आपको किसी भी चीज़ तक पहुंच से वंचित कर सकता है। सेवाएं जो पहले धीमी थीं और मानवीय त्रुटि के जोखिम में थीं, अब स्वचालित और सुरक्षित हैं क्योंकि उन्हें कोड द्वारा नियंत्रित किया जाता है जिसका कोई भी निरीक्षण कर सकता है और जांच कर सकता है।

वहाँ एक तेजी से बढ़ती क्रिप्टो अर्थव्यवस्था है, जहाँ आप उधार दे सकते हैं, उधार ले सकते हैं, लंबी/छोटी, ब्याज कमा सकते हैं, और बहुत कुछ कर सकते हैं। क्रिप्टो-प्रेमी अर्जेंटीनावासियों ने बढ़ती मुद्रास्फीति से बचने के लिए डीफाई का उपयोग किया है। कंपनियों ने अपने कर्मचारियों को उनके वेतन का वास्तविक समय में प्रसारण शुरू कर दिया है। कुछ लोगों ने तो बिना किसी व्यक्तिगत पहचान के ही लाखों डॉलर का कर्ज निकाल लिया और चुका दिया।

<YouTube id="H-O3r2YMWJ4" />

## डीफाई बनाम पारंपरिक वित्त {#defi-vs-tradfi}

डीफाई की क्षमता को देखने का एक सबसे अच्छा तरीका आज की समस्याओं को समझना है।
...
| डीफाई सभी के लिए खुला है।                                                                                             | आपको वित्तीय सेवाओं का उपयोग करने के लिए आवेदन करना होगा।                                                                                  |
...
<AlertContent className="flex-row justify-between items-center">
  <div>
अगर आप इथेरियम में नए हैं, तो डीफाई एप्लिकेशन्स के लिए हमारे सुझावों का अन्वेषण करें।
</div>
  <ButtonLink href="/apps/categories/defi">
    डीफाई डैप्स एक्सप्लोर करें
  </ButtonLink>
...
## डीफाई के साथ आप क्या कर सकते हैं? {#defi-use-cases}
...
एक ब्लॉकचेन के रूप में, इथेरियम को सुरक्षित और वैश्विक तरीके से लेन-देन भेजने के लिए डिज़ाइन किया गया है। बिटकॉइन की तरह, इथेरियम भी विश्वभर में पैसे भेजने को एक ईमेल भेजने की तरह आसान बनाता है। बस अपने प्राप्तकर्ता का [ईएनएस नाम](/glossary/#ens) (जैसे bob.eth) या अपने वॉलेट से उनके खाते का पता दर्ज करें और आपका भुगतान मिनटों में (आमतौर पर) सीधे उनके पास चला जाएगा। भुगतान भेजने या प्राप्त करने के लिए, आपको एक [वॉलेट](/wallets/) की आवश्यकता होगी।
...
क्रिप्टोकरेंसी की अस्थिरता बहुत सारे वित्तीय उत्पादों और सामान्य खर्चों के लिए एक समस्या है। डीफाई समुदाय ने स्थिर मुद्राओं से इस समस्या को हल किया है। उनका मूल्य एक दूसरे संपत्ति से जुड़ा रहता है, आमतौर पर डॉलर जैसी लोकप्रिय मुद्रा के साथ।
...
विकेंद्रीकृत ऋण किसी भी पक्ष की पहचान बताए बिना काम करता है। इसके बजाय, उधारकर्ता को संपार्श्विक रखना होगा जो ऋणदाता को स्वचालित रूप से प्राप्त होगा यदि उनका ऋण चुकाया नहीं गया है। कुछ ऋणदाता [एनएफटीज़](/glossary/#nft) को संपार्श्विक के रूप में भी स्वीकार करते हैं। एनएफटी एक पेंटिंग की तरह एक अद्वितीय संपत्ति का एक दस्तावेज है। [एनएफटीज़ के बारे में और जानें](/nft/)
...
- आप अपने 100 Dai, एक [स्थिर मुद्रा](/stablecoins/), आवे जैसे किसी प्रोडक्ट को उधार देते हैं।
- आपको 100 आवे Dai (aDai) प्राप्त होता है, जो आपके उधार दिए गए Dai का प्रतिनिधित्व करने वाला एक टोकन है।
...
पूलटुगेदर जैसी नो-लॉस लॉटरी पैसे बचाने का एक मज़ेदार और नया तरीका है।
...
इथेरियम पर हजारों टोकन हैं। विकेंद्रीकृत एक्सचेंज (DEX) आपको जब चाहें विभिन्न टोकन का व्यापार करने की सुविधा देते हैं। आप कभी भी अपने संपत्तियों का नियंत्रण नहीं छोड़ते हैं। यह किसी अन्य देश की यात्रा के समय मुद्रा एक्सचेंज का उपयोग करने की तरह है। लेकिन डीफाई संस्करण कभी बंद नहीं होता। बाज़ार साल के 24/7, 365 दिन खुले रहते हैं और प्रौद्योगिकी गारंटी देती है कि व्यापार स्वीकार करने के लिए हमेशा कोई न कोई होगा।

उदाहरण के लिए, अगर आप नो-लॉस लॉटरी पूलटुगेदर (ऊपर वर्णित) का उपयोग करना चाहते हैं, तो आपको Dai या USDC जैसे टोकन की आवश्यकता होगी। ये DEX आपको अपने ETH को उन टोकन के लिए स्वैप करने और काम पूरा होने पर फिर से वापस करने की अनुमति देते हैं।
...
एक अच्छा उदाहरण [डीफाई Pulse Index fund (DPI)](https://defipulse.com/blog/defi-pulse-index/) है। यह एक ऐसा फंड है जो यह सुनिश्चित करने के लिए स्वचालित रूप से पुनर्संतुलन करता है कि आपके पोर्टफोलियो में हमेशा बाजार पूंजीकरण द्वारा शीर्ष डीफाई टोकन शामिल हों। आपको कभी भी किसी भी विवरण का प्रबंधन नहीं करना पड़ता है और आप जब चाहें फंड से निकाल सकते हैं।
...
इतना कुछ होने के साथ, आपको अपने सभी निवेशों, ऋणों और ट्रेडों पर नज़र रखने का एक तरीका चाहिए। ऐसे कई उत्पाद हैं जो आपको एक ही स्थान से अपनी सभी डीफाई गतिविधि का समन्वय करने देते हैं। यह डीफाई की खुली वास्तुकला की सुंदरता है। टीम इंटरफेस का निर्माण कर सकती है जहां आप न केवल उत्पादों में अपना संतुलन देख सकते हैं, आप उनकी सुविधाओं का भी उपयोग कर सकते हैं। जैसा कि आप डीफाई के बारे में अधिक पता लगाते हैं, आपको यह उपयोगी लग सकता है।
...
## डीफाई कैसे काम करता है? {#how-defi-works}

डीफाई उन सेवाओं को प्रदान करने के लिए क्रिप्टोकरेंसी और स्मार्ट अनुबंधों का उपयोग करता है जिनमें मध्यस्थों की आवश्यकता नहीं होती है। आज की वित्तीय दुनिया में, वित्तीय संस्थान लेनदेन के गारंटर के रूप में कार्य करते हैं। इससे इन संस्थानों को अत्यधिक शक्ति मिलती है क्योंकि आपका पैसा उनके माध्यम से प्रवाहित होता है। साथ ही दुनिया भर में अरबों लोग बैंक खाते तक भी पहुंच नहीं पा सकते हैं।

डीफाई में, एक स्मार्ट अनुबंध लेनदेन में वित्तीय संस्थान की जगह लेता है। एक स्मार्ट अनुबंध एक प्रकार का इथेरियम खाता है जो धन रख सकता है और कुछ शर्तों के आधार पर उन्हें भेज/धनवापसी कर सकता है। कोई भी उस स्मार्ट अनुबंध को बदल नहीं सकता है जब यह लाइव होता है – यह हमेशा प्रोग्राम के अनुसार चलेगा।
...
## एथेरियम और डीफाई {#ethereum-and-defi}

इथेरियम कई कारणों से डीफाई के लिए एकदम सही नींव है:

- कोई भी इथेरियम या उस पर आश्रित स्मार्ट अनुबंधों का मालिक नहीं है – यह हर किसी को डीफाई का उपयोग करने का अवसर देता है। इसका मतलब यह भी है कि कोई भी आप पर लागू नियमों को नहीं बदल सकता है।
- डीफाई उत्पाद पर्दे के पीछे एक ही भाषा बोलते हैं: इथेरियम। इसका मतलब है कि कई उत्पाद एक साथ निर्बाध रूप से काम करते हैं। आप एक प्लेटफ़ॉर्म पर टोकन उधार दे सकते हैं और ब्याज वाले टोकन को एक अलग बाज़ार में एक पूरी तरह से अलग एप्लिकेशन पर एक्सचेंज कर सकते हैं। यह आपके बैंक में लॉयल्टी पॉइंट्स को कैश करने में सक्षम होने जैसा है।
...
आप परतों में डीफाई के बारे में सोच सकते हैं:
...
ध्यान दें: अधिकांश डीफाई [ERC-20 मानक](/glossary/#erc-20) का उपयोग करता है। डीफाई में एप्लिकेशन, ETH के लिए रैपर का उपयोग करते हैं जिसे रैप्ड ईथर (WETH) कहा जाता है। [रैप्ड ईथर के बारे में ज़्यादा जानें](/wrapped-eth)।

## डीफाई बनाएँ {#build-defi}

डीफाई एक ओपन-सोर्स गतिविधि है। डीफाई प्रोटोकॉल और एप्लिकेशन आपके लिए निरीक्षण, फोर्क और नवाचार करने के लिए खुले हैं। इस स्तरित स्टैक के कारण (वे सभी एक ही आधार ब्लॉकचेन और संपत्ति साझा करते हैं), प्रोटोकॉल को अद्वितीय कॉम्बो अवसरों को अनलॉक करने के लिए मिश्रित और मिलान किया जा सकता है।
...
### डीफाई डेटा {#defi-data}

- [डीफाई Prime](https://defiprime.com/)
- [डीफाई Llama](https://defillama.com/)

### डीफाई लेख {#defi-articles}

- [डीफाई के लिए एक शुरुआती गाइड](https://blog.coinbase.com/a-beginners-guide-to-decentralized-finance-defi-574c68ff43c4) – _सिड कोएल्हो-प्रभु, 6 जनवरी, 2020_
- [EEA डीफाई जोखिम मूल्यांकन दिशानिर्देश](https://entethalliance.org/specs/defi-risks/) – डीफाई प्रोटोकॉल में प्रमुख जोखिमों की पहचान और मूल्यांकन कैसे करें, इस पर उद्योग-समर्थित अवलोकन।
...
- [डीफाई Llama डिस्कॉर्ड सर्वर](https://discord.defillama.com/)
- [डीफाई Pulse डिस्कॉर्ड सर्वर](https://discord.gg/Gx4TCTk)
