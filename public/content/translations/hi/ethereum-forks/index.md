...
प्राग-इलेक्ट्रा ("पेक्ट्रा") अपग्रेड में इथेरियम प्रोटोकॉल में कई सुधार शामिल थे जिनका उद्देश्य सभी उपयोगकर्ताओं, लेयर 2 (l2) नेटवर्क, स्टेकिंग करने वालों और नोड ऑपरेटरों के लिए अनुभव को बेहतर बनाना था।

स्टेकिंग को कंपाउंडिंग सत्यापक खातों के साथ एक अपग्रेड मिला, और निष्पादन निकासी पते का उपयोग करके स्टेक किए गए फंड पर बेहतर नियंत्रण प्राप्त हुआ। EIP-7251 ने एक एकल सत्यापक के लिए अधिकतम प्रभावी शेष को बढ़ाकर 2048 कर दिया, जिससे स्टेकिंग करने वालों के लिए पूंजी दक्षता में सुधार हुआ। EIP-7002 ने एक निष्पादन खाते को सुरक्षित रूप से सत्यापक क्रियाओं को ट्रिगर करने में सक्षम बनाया, जिसमें निकास, या फंड के कुछ हिस्सों की निकासी शामिल है, जिससे ETH स्टेकिंग करने वालों के अनुभव में सुधार हुआ, जबकि नोड ऑपरेटरों के लिए जवाबदेही को मजबूत करने में मदद मिली।

अपग्रेड के अन्य हिस्सों ने नियमित उपयोगकर्ताओं के अनुभव को बेहतर बनाने पर ध्यान केंद्रित किया। EIP-7702 ने एक नियमित गैर-स्मार्ट-अनुबंध खाते ([EOA](/glossary/#eoa)) के लिए एक स्मार्ट अनुबंध के समान कोड निष्पादित करने की क्षमता प्रदान की। इसने पारंपरिक इथेरियम खातों के लिए असीमित नई कार्यक्षमता को अनलॉक किया, जैसे कि लेन-देन बैचिंग, गैस प्रायोजन, वैकल्पिक प्रमाणीकरण, प्रोग्राम करने योग्य खर्च नियंत्रण, खाता पुनर्प्राप्ति तंत्र और बहुत कुछ।
...
<ul>
  ...
  <li><a href="https://eips.ethereum.org/EIPS/eip-7685">EIP-7685</a> - <em>सामान्य उद्देश्य निष्पादन परत अनुरोध</em></li>
...
<ul>
  ...
  <li><a href="https://eips.ethereum.org/EIPS/eip-2935">EIP-2935</a> - <em>स्थिति में ऐतिहासिक ब्लॉक हैश सहेजें</em></li>
