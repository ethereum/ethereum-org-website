...
description: "एथेरियम पर विकेन्द्रीकृत विज्ञान का अवलोकन"
lang: hi
template: use-cases
emoji: ":microscope:"
sidebarDepth: 2
...
विकेंद्रीकृत विज्ञान (DeSci) एक आंदोलन है जिसका उद्देश्य [वेब3](/glossary/#web3) स्टैक का उपयोग करके वैज्ञानिक ज्ञान के वित्त पोषण, निर्माण, समीक्षा, क्रेडिट, भंडारण और प्रसार के लिए सार्वजनिक बुनियादी ढांचे का निर्माण करना है।
...
विकेंद्रीकृत विज्ञान अधिक विविध वित्तपोषण स्रोतों ([डीएओज़](/glossary/#dao), [द्विघात दान](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=2003531) से लेकर क्राउडफंडिंग और अधिक तक), अधिक सुलभ डेटा और विधियों, और पुनरुत्पादन के लिए प्रोत्साहन प्रदान करने की अनुमति देता है।
...
| ------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| धन का वितरण द्विघात दान या डीएओज़ जैसे तंत्र का उपयोग करके **जनता द्वारा निर्धारित किया जाता है**।                                            | छोटे, बंद, **केंद्रीकृत समूह** धन के वितरण को नियंत्रित करते हैं।                                                       |
...
| [वेब3](/glossary/#web3) तकनीक का उपयोग करके प्रयोगशाला सेवाओं को साझा करना आसान और अधिक पारदर्शी बनाया गया है।                              | प्रयोगशाला संसाधनों को साझा करना अक्सर **धीमा और अपारदर्शी** होता है।                                                   |
| **प्रकाशन के लिए नए मॉडल** विकसित किए जा सकते हैं जो विश्वास, पारदर्शिता और सार्वभौमिक पहुंच के लिए वेब3 प्रिमिटिव का उपयोग करते हैं।       | आप स्थापित मार्गों के माध्यम से प्रकाशन करते हैं जिन्हें अक्सर **अकुशल, पक्षपाती और शोषक** माना जाता है।                |
...
DeSci, पारंपरिक शिक्षाविदों को डिजिटल दुनिया में शामिल करने के लिए वैज्ञानिक टूलसेट का निर्माण कर रहा है। नीचे उपयोग के मामलों का एक नमूना दिया गया है जिसे वेब3 वैज्ञानिक समुदाय को पेश कर सकता है।
...
वेब3 में डाओ और वेब3 द्वारा विकसित विभिन्न प्रोत्साहन मॉडल के साथ प्रयोग करके इस टूटे हुए फंडिंग मॉडल को बाधित करने की क्षमता है। [पूर्वव्यापी सार्वजनिक सामान का वित्त पोषण](https://medium.com/ethereum-optimism/retroactive-public-goods-funding-33c9b7d00f0c), [द्विघात वित्त पोषण](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=2003531), [डाओ शासन](https://www.antler.co/blog/daos-and-web3-governance-the-promise-implications-and-challenges-ahead) और [टोकनाइज्ड प्रोत्साहन संरचनाएं](https://cdixon.org/2017/05/27/crypto-tokens-a-breakthrough-in-open-network-design) कुछ वेब3 उपकरण हैं जो विज्ञान वित्त पोषण में क्रांति ला सकते हैं।

### IP स्वामित्व और विकास {#ip-ownership}

पारंपरिक विज्ञान में बौद्धिक संपदा (IP) एक बड़ी समस्या है: विश्वविद्यालयों में अटके रहने या बायोटेक में अनुपयोगिता होने से लेकर मूल्य निर्धारण में बेहद कठिन होने तक। हालांकि, डिजिटल संपत्तियों (जैसे वैज्ञानिक डेटा या लेख) का स्वामित्व कुछ ऐसा है जिसे वेब3 [नॉन-फंजिबल टोकन (एनएफटीज़)](/glossary/#nft) का उपयोग करके असाधारण रूप से अच्छा करता है।

जिस तरह से एनएफटी भविष्य के लेनदेन के लिए राजस्व को मूल निर्माता को वापस भेज सकता है, उसी तरह आप शोधकर्ताओं, शासी निकायों (जैसे डाओ), या यहां तक ​​कि उन विषयों को पुरस्कृत करने के लिए पारदर्शी मूल्य अनुदान श्रृंखला स्थापित कर सकते हैं जिनका डेटा एकत्र किया गया है।

[IP-एनएफटीज़](https://medium.com/molecule-blog/ip-nfts-for-researchers-a-new-biomedical-funding-paradigm-91312d8d92e6) किए जा रहे शोध प्रयोगों के विकेंद्रीकृत डेटा रिपॉजिटरी की कुंजी के रूप में भी काम कर सकते हैं, और एनएफटी और [डीफाई](/glossary/#defi) वित्तीयकरण (फ्रैक्शनलाइजेशन से लेकर लेंडिंग पूल और मूल्य मूल्यांकन तक) में प्लग इन कर सकते हैं। यह मूल रूप से ऑनचेन संस्थाओं जैसे कि डीएओज़ जैसे [VitaDAO](https://www.vitadao.com/) को सीधे ऑनचेन शोध करने की अनुमति देता है।
...
वेब3 पैटर्न का उपयोग करके वैज्ञानिक डेटा को बहुत अधिक सुलभ बनाया जा सकता है, और वितरित भंडारण अनुसंधान को प्रलयकारी घटनाओं से बचने में सक्षम बनाता है।
...
वेब3 डेटा समाधान उपरोक्त परिदृश्यों का समर्थन करते हैं और वास्तव में ओपन साइंस के लिए आधार प्रदान करते हैं, जहां शोधकर्ता बिना एक्सेस अनुमति या शुल्क के सार्वजनिक सामान बना सकते हैं। आईपीएफएस, आरवीव और फाइलकॉइन जैसे वेब3 सार्वजनिक डेटा समाधान विकेंद्रीकरण के लिए अनुकूलित हैं। उदाहरण के लिए, dClimate, वैश्विक स्तर पर जलवायु और मौसम का डाटा प्रदान करता है जिसमें मौसम केंद्र और जलवायु का अनुमान लगाने वाले मॉडल का भी डाटा शामिल है।
...
- [OceanDAO: डाओ डेटा से संबंधित विज्ञान के लिए शासित वित्त पोषण](https://oceanprotocol.com/)
- [Opscientia: खुले विकेंद्रीकृत विज्ञान वर्कफ़्लोज़](https://opsci.io/research/)
- [Bio.xyz: अपने बायोटेक डाओ या DeSci परियोजना के लिए वित्त पोषित करें](https://www.bio.xyz/)
...
- [मॉलिक्यूल के बायोफार्मा IP-एनएफटीज़ - एक तकनीकी विवरण](https://www.molecule.xyz/blog/molecules-biopharma-ip-nfts-a-technical-description)
...
- [वैज्ञानिक प्रकाशन टूट गया है। क्या वेब3 इसे ठीक कर सकता है?](https://www.youtube.com/watch?v=WkvzYgCvWj8)
...
- [पेज डोनर - वेब3 और ब्लॉकचेन के साथ ओपन साइंस को टूल करना](https://www.youtube.com/watch?v=nC-2QWQ-lgw&t=17s)
