...
इथिरीयम के शीर्ष पर विकेन्द्रीकृत अनुप्रयोगों का निर्माण करें और माइक्रोसॉफ्ट टैकनोलजी स्टैक से टूल और भाषाओं का उपयोग करते हुए स्मार्ट अनुबंधों के साथ बातचीत करें - डॉट नेट फ्रेमवर्क / डॉट नेट कोर के पार VSCode और विज़ुअल स्टूडियो जैसे टूलिंग पर C #, # Visual Basic डॉट नेट, F # का समर्थन करें। / डॉट नेट मानक। मिनट में माइक्रोसॉफ्ट Azure ब्लॉकचेन का उपयोग करके एज़्योर पर एक इथिरीयम ब्लॉकचेन तैनात करें। .नेट के प्यार को इथिरीयम में लाओ!
...
- [सप्लाई चेन ट्रैकिंग सिस्टम को लागू करने के लिए Nethereum वेब3 का उपयोग करना](http://blog.pomiager.com/post/using-nethereum-web3-to-implement-a-supply-chain-traking-system4)
...
- [Nethereum Blazor](https://github.com/Nethereum/NethereumBlazor) - _एक डॉट नेट Wasm SPA लाइट ब्लॉकचेन एक्सप्लोरर और सरल वॉलेट_
...
- [नेदरमाइंड](https://github.com/NethermindEth/nethermind) - _Linux, Windows, MacOS के लिए एक डॉट नेट कोर इथेरियम क्लाइंट_
...
Nethereum में, हम अधिकतर [Gitter](https://gitter.im/Nethereum/Nethereum) पर समय बिताते हैं, जहां प्रश्न पूछने/उत्तर देने, सहायता प्राप्त करने, या बस आराम करने के लिए सभी का स्वागत है। [Nethereum गिटहब रिपॉजिटरी](https://github.com/Nethereum) पर बेझिझक PR करें या कोई समस्या खोलें, या बस हमारे कई साइड/सैंपल प्रोजेक्ट्स को ब्राउज़ करें। आप हमें [डिस्कॉर्ड](https://discord.gg/jQPrR58FxX) पर भी ढूँढ़ सकते हैं!

यदि आप नेदरमाइंड में नए हैं और आरंभ करने में सहायता की आवश्यकता है, तो हमारे [डिस्कॉर्ड](http://discord.gg/PaCMRFdvWT) से जुड़ें। हमारे डेवलपर्स आपके सवालों के जवाब देने के लिए हाथ पर हैं। [नेदरमाइंड गिटहब रिपॉजिटरी](https://github.com/NethermindEth/nethermind) पर PR खोलने या कोई भी समस्या उठाने में संकोच न करें।
