...
<FeaturedText>जावा-आधारित प्रोजेक्ट्स और टूलिंग का उपयोग करके एथेरियम के लिए डेवलप करना सीखें</FeaturedText>
...
- [Web3J (एथेरियम क्लाइंट्स के साथ इंटरैक्ट करने के लिए लाइब्रेरी)](https://github.com/web3j/web3j)
...
- [Mahuta (आईपीएफएस देव टूल्स)](https://github.com/ConsenSys/mahuta)
