...
_[एथेरियम EVM इलस्ट्रेटेड](https://takenobu-hs.github.io/downloads/ethereum_evm_illustrated.pdf) से अनुकूलित आरेख_
...
इस मामले में [अनुबंध का स्रोत कोड](https://etherscan.io/address/0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48#code) ईथरस्कैन पर अपलोड कर दिया गया है, इसलिए हम जानते हैं कि फ़ंक्शन `transfer(address,uint256)` है।
