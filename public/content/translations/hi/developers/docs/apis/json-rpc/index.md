...
एक आंतरिक एपीआई का उपयोग नोड के भीतर अंतर-ग्राहक संचार के लिए भी किया जाता है - अर्थात, यह सर्वसम्मति क्लाइंट और निष्पादन क्लाइंट को डेटा स्वैप करने में सक्षम बनाता है। इसे 'इंजन API' कहा जाता है और विनिर्देश [गिटहब](https://github.com/ethereum/execution-apis/blob/main/src/engine/common.md) पर उपलब्ध हैं।

## निष्पादन क्लाइंट विनिर्देश {#spec}

[गिटहब पर पूरा JSON-RPC API विनिर्देश पढ़ें](https://github.com/ethereum/execution-apis)। यह API [Execution API वेबपेज](https://ethereum.github.io/execution-apis/) पर प्रलेखित है और इसमें सभी उपलब्ध विधियों को आज़माने के लिए एक इंस्पेक्टर शामिल है।
...
इस पेज पर हम कमांड लाइन टूल, [curl](https://curl.se) का उपयोग करके अलग-अलग JSON_RPC API एंडपॉइंट का उपयोग करने के तरीके के उदाहरण प्रदान करते हैं। ये व्यक्तिगत एंडपॉइंट उदाहरण नीचे [Curl उदाहरण](#curl-examples) सेक्शन में दिए गए हैं। पेज में आगे, हम गेथ नोड, JSON_RPC API और curl का उपयोग करके एक स्मार्ट अनुबंध को संकलित और तैनात करने के लिए एक [एंड-टू-एंड उदाहरण](#usage-example) भी प्रदान करते हैं।
...
- `1`: एथेरियम मेननेट
- `11155111`: सेपोलिया टेस्टनेट
- `560048` : हूडी टेस्टनेट
...
वर्तमान एथेरियम प्रोटोकॉल संस्करण लौटाता है। ध्यान दें कि यह तरीका [गेथ में उपलब्ध नहीं है](https://github.com/ethereum/go-ethereum/pull/22064#issuecomment-788682924)।
...
वेई में प्रति गैस वर्तमान मूल्य का अनुमान देता है। उदाहरण के लिए, बेसु क्लाइंट पिछले 100 ब्लॉकों की जांच करता है और डिफ़ॉल्ट रूप से औसत गैस इकाई मूल्य लौटाता है।
...
वेब3 लाइब्रेरी के साथ आने वाले गेथ कंसोल का उपयोग गणना करने के लिए किया जा सकता है:
...
निम्नलिखित एक सीधा-सादा स्मार्ट अनुबंध है जिसे `Multiply7` कहा जाता है जिसे एक एथेरियम नोड पर JSON-RPC इंटरफ़ेस का उपयोग करके तैनात किया जाएगा। यह ट्यूटोरियल मानता है कि पाठक पहले से ही एक गेथ नोड चला रहा है। नोड और क्लाइंट के बारे में अधिक जानकारी [यहां](/developers/docs/nodes-and-clients/run-a-node) उपलब्ध है। गैर-गेथ क्लाइंट के लिए HTTP JSON-RPC कैसे शुरू करें, यह देखने के लिए कृपया व्यक्तिगत [क्लाइंट](/developers/docs/nodes-and-clients/) दस्तावेज़ीकरण देखें। अधिकांश क्लाइंट `localhost:8545` पर सेवा देने के लिए डिफ़ॉल्ट होते हैं।
...
सबसे पहली बात यह सुनिश्चित करना है कि HTTP RPC इंटरफ़ेस सक्षम है। इसका मतलब है कि हम स्टार्टअप पर गेथ को `--http` फ्लैग प्रदान करते हैं। इस उदाहरण में हम एक निजी विकास श्रृंखला पर गेथ नोड का उपयोग करते हैं। इस दृष्टिकोण का उपयोग करके हमें वास्तविक नेटवर्क पर ईथर की आवश्यकता नहीं है।
...
चूंकि संख्याएं हेक्स एन्कोडेड होती हैं, इसलिए शेष राशि को हेक्स स्ट्रिंग के रूप में वेई में लौटाया जाता है। यदि हम शेष राशि को ईथर में एक संख्या के रूप में चाहते हैं तो हम गेथ कंसोल से web3 का उपयोग कर सकते हैं।
