...
एक सॉफ्टवेयर एप्लिकेशन को एथेरियम ब्लॉकचेन के साथ इंटरैक्ट करने के लिए (यानी, ब्लॉकचेन डेटा पढ़ना और/या नेटवर्क पर लेनदेन भेजना), उसे एक एथेरियम नोड से कनेक्ट होना चाहिए।

इस उद्देश्य के लिए, प्रत्येक एथेरियम क्लाइंट [JSON-RPC](/developers/docs/apis/json-rpc/) विनिर्देश को लागू करता है, इसलिए [विधियों](/developers/docs/apis/json-rpc/#json-rpc-methods) का एक समान सेट है जिस पर एप्लिकेशन भरोसा कर सकते हैं।
...
[एथेरियम स्टैक](/developers/docs/ethereum-stack/) और [एथेरियम क्लाइंट](/developers/docs/nodes-and-clients/) को समझना मददगार हो सकता है।
...
- [गिटहब](https://github.com/BlockPILabs)
...
**इन्फ्यूरा -** **_एक सेवा के रूप में एथेरियम API।_**

- [infura.io](https://infura.io)
- [प्रलेखन](https://docs.infura.io/api)
- [गिटहब](https://github.com/INFURA)
...
**Rivet -** **_ओपन सोर्स सॉफ्टवेयर द्वारा संचालित एक सेवा के रूप में एथेरियम और एथेरियम क्लासिक APIs।_**

- [rivet.cloud](https://rivet.cloud)
- [प्रलेखन](https://rivet.cloud/docs/)
- [गिटहब](https://github.com/openrelayxyz/ethercattle-deployment)

**Zmok -** **_JSON-RPC/WebSockets API के रूप में स्पीड-ओरिएंटेड एथेरियम नोड्स।_**

- [zmok.io](https://zmok.io/)
- [गिटहब](https://github.com/zmok-io)
...
- [एथेरियम API संदर्भ](https://docs.chainstack.com/reference/ethereum-getting-started)
...
**Figment द्वारा DataHub -** **_Ethereum मेननेट और टेस्टनेट के साथ वेब3 API सेवाएं।_**

- [DataHub](https://www.figment.io/)
- [प्रलेखन](https://docs.figment.io/)

**मोरालिस -** **_एंटरप्राइज़-ग्रेड EVM API प्रदाता।_**

- [moralis.io](https://moralis.io)
- [प्रलेखन](https://docs.moralis.io/)
- [गिटहब](https://github.com/MoralisWeb3)
...
- [गिटहब](https://github.com/nftport/)
...
- [गिटहब](https://github.com/Tokenview)
