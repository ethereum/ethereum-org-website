...
- एथेरियम नेटवर्क से कनेक्ट करने और अनुबंधों को डिप्लॉय करने
  के लिए कॉन्फ़िगरेशन, चाहे वह स्थानीय रूप से चल रहे इंस्टेंस के लिए हो, या एथेरियम के
  सार्वजनिक नेटवर्कों में से एक के लिए हो।
- विकेंद्रीकृत ऐप वितरण - आईपीएफएस जैसे स्टोरेज
  विकल्पों के साथ एकीकरण।

## पूर्वापेक्षाएं {#prerequisites}

फ्रेमवर्क में जाने से पहले, हम अनुशंसा करते हैं कि आप पहले हमारे [डैप्स](/developers/docs/dapps/) और [एथेरियम स्टैक](/developers/docs/ethereum-stack/) का परिचय पढ़ें।

## उपलब्ध फ्रेमवर्क {#available-frameworks}

**फाउंड्री** - **_Foundry, एथेरियम एप्लिकेशन डेवलपमेंट के लिए एक अत्यंत तेज, पोर्टेबल और मॉड्यूलर टूलकिट है_**

- [फाउंड्री इंस्टॉल करें](https://book.getfoundry.sh/)
- [फाउंड्री बुक](https://book.getfoundry.sh/)
- [टेलीग्राम पर फाउंड्री कम्युनिटी चैट](https://t.me/foundry_support)
- [Awesome फाउंड्री](https://github.com/crisgarner/awesome-foundry)

**हार्डहैट -** **_पेशेवरों के लिए एथेरियम डेवलपमेंट वातावरण।_**
...
**Create Eth App -** **_एक कमांड से एथेरियम-संचालित ऐप्स बनाएँ। चुनने के लिए UI फ्रेमवर्क और डीफाई टेम्प्लेट की एक विस्तृत पेशकश के साथ आता है।_**

- [गिटहब](https://github.com/paulrberg/create-eth-app)
- [टेम्प्लेट्स](https://github.com/PaulRBerg/create-eth-app/tree/develop/templates)

**Scaffold-Eth -** **_Ethers.js + हार्डहैट + वेब3 के लिए रिएक्ट कंपोनेंट और हुक: स्मार्ट अनुबंधों द्वारा संचालित विकेंद्रीकृत एप्लिकेशन बनाने के लिए आपको जो कुछ भी चाहिए।_**

- [गिटहब](https://github.com/scaffold-eth/scaffold-eth-2)

**टेंडरली -** **_वेब3 डेवलपमेंट प्लेटफॉर्म जो ब्लॉकचेन डेवलपर को स्मार्ट अनुबंध बनाने, टेस्ट करने, डीबग करने, मॉनिटर करने और संचालित करने और डैप UX को बेहतर बनाने में सक्षम बनाता है।_**

- [वेबसाइट](https://tenderly.co/)
- [प्रलेखन](https://docs.tenderly.co/)

**द ग्राफ -** **_ब्लॉकचेन डेटा को कुशलतापूर्वक क्वेरी करने के लिए द ग्राफ।_**

- [वेबसाइट](https://thegraph.com/)
- [ट्यूटोरियल](/developers/tutorials/the-graph-fixing-web3-data-querying/)

**अल्केमी -** **_Ethereum डेवलपमेंट प्लेटफॉर्म।_**

- [alchemy.com](https://www.alchemy.com/)
- [गिटहब](https://github.com/alchemyplatform)
- [डिस्कॉर्ड](https://discord.com/invite/alchemyplatform)

**NodeReal -** **_Ethereum डेवलपमेंट प्लेटफॉर्म।_**

- [Nodereal.io](https://nodereal.io/)
- [गिटहब](https://github.com/node-real)
...
**Crossmint -** **_एंटरप्राइज-ग्रेड वेब3 डेवलपमेंट प्लेटफॉर्म, जो आपको सभी प्रमुख EVM चेन्स (और अन्य) पर एनएफटी एप्लिकेशन बनाने की अनुमति देता है।_**
...
- [गिटहब](https://github.com/eth-brownie/brownie)
- **Brownie का रखरखाव वर्तमान में नहीं किया जा रहा है**

**ओपनज़ेपेलिन SDK -** **_द अल्टीमेट स्मार्ट अनुबंध टूलकिट: आपको स्मार्ट अनुबंधों को डेवलप करने, कंपाइल करने, अपग्रेड करने, डिप्लॉय करने और उनके साथ इंटरैक्ट करने में मदद करने के लिए टूल का एक सूट।_**

- [ओपनज़ेपेलिन Defender SDK](https://docs.openzeppelin.com/defender/sdk)
- [गिटहब](https://github.com/OpenZeppelin/openzeppelin-sdk)
- [कम्युनिटी फोरम](https://forum.openzeppelin.com/c/support/17)
- **ओपनज़ेपेलिन SDK का डेवलपमेंट समाप्त हो गया है**

**Catapulta -** **_मल्टी-चेन स्मार्ट अनुबंध डिप्लॉयमेंट टूल, ब्लॉक एक्सप्लोरर में वेरिफ़िकेशन को स्वचालित करता है, डिप्लॉय किए गए स्मार्ट अनुबंधों का ट्रैक रखता है और डिप्लॉयमेंट रिपोर्ट शेयर करता है, फाउंड्री और हार्डहैट प्रोजेक्ट्स के लिए प्लग-एंड-प्ले।_**

- [वेबसाइट](https://catapulta.sh/)
- [प्रलेखन](https://catapulta.sh/docs)
- [Github](https://github.com/catapulta-sh)

**GoldRush (Covalent द्वारा संचालित) -** **_GoldRush डेवलपर, विश्लेषकों और उद्यमों के लिए सबसे व्यापक ब्लॉकचेन डेटा API सुइट प्रदान करता है। चाहे आप डीफाई डैशबोर्ड, एक वॉलेट, एक ट्रेडिंग बॉट, एक AI एजेंट या एक अनुपालन प्लेटफॉर्म बना रहे हों, डेटा API आपको आवश्यक ऑन-चेन डेटा के लिए तेज, सटीक और डेवलपर-अनुकूल एक्सेस प्रदान करते हैं_**
...
- [गिटहब](https://github.com/Ackee-Blockchain/wake)
...
- [गिटहब](https://github.com/uport-project/veramo)
