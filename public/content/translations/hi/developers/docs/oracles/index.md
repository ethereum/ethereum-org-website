---
title: "ओरेकल्स"
description: "Oracles वास्तविक दुनिया के डेटा तक पहुंच के साथ एथेरियम स्मार्ट अनुबंध प्रदान करते हैं, अधिक उपयोग-मामलों को अनलॉक करते हैं और उपयोगकर्ताओं के लिए अधिक मूल्य प्रदान करते हैं।"
lang: hi
---
...
यह पेज मानता है कि पाठक एथेरियम की बुनियादी बातों से परिचित है, जिसमें [नोड्स](/developers/docs/nodes-and-clients/), [सहमति तंत्र](/developers/docs/consensus-mechanisms/), और [EVM](/developers/docs/evm/) शामिल हैं। आपको [स्मार्ट अनुबंधों](/developers/docs/smart-contracts/) और [स्मार्ट अनुबंध एनाटॉमी](/developers/docs/smart-contracts/anatomy/) की भी अच्छी समझ होनी चाहिए, विशेष रूप से [इवेंट्स](/glossary/#events) की।
...
ओरेकल्स विभिन्न प्रकारों में आते हैं, जिनमें _immediate-read_, _publish-subscribe_, और _request-response_ शामिल हैं, जिनमें से बाद के दो एथेरियम स्मार्ट अनुबंधों में सबसे लोकप्रिय हैं। यहां हम संक्षेप में प्रकाशन-सदस्यता और अनुरोध-प्रतिक्रिया मॉडल का वर्णन करते हैं।
...
डीफाई में लोकप्रिय “प्राइस ओरेकल्स” (जैसा कि उन्हें अक्सर कहा जाता है) में चेनलिंक प्राइस फ़ीड्स, Compound प्रोटोकॉल का [ओपन प्राइस फ़ीड](https://compound.finance/docs/prices), यूनिस्वैप का [टाइम-वेटेड एवरेज प्राइसेस (TWAPs)](https://docs.uniswap.org/contracts/v2/concepts/core-concepts/oracles), और [Maker Oracles](https://docs.makerdao.com/smart-contract-modules/oracle-module) शामिल हैं।
...
**[चेनलिंक](https://chain.link/)** - _Chainlink विकेन्द्रीकृत ओरेकल नेटवर्क किसी भी ब्लॉकचेन पर उन्नत स्मार्ट अनुबंधों का समर्थन करने के लिए छेड़छाड़-प्रूफ़ इनपुट, आउटपुट और गणना प्रदान करते हैं।_

**[RedStone Oracles](https://redstone.finance/)** - _RedStone एक विकेन्द्रीकृत मॉड्यूलर ओरेकल है जो गैस-अनुकूलित डेटा फ़ीड प्रदान करता है। यह उभरती हुई संपत्तियों, जैसे लिक्विड स्टेकिंग टोकन (LSTs), लिक्विड रीस्टेकिंग टोकन (LRTs), और बिटकॉइन स्टेकिंग डेरिवेटिव्स के लिए मूल्य फ़ीड की पेशकश करने में माहिर है।_
...
**[टेलर](https://tellor.io/)** - _Tellor आपके स्मार्ट अनुबंध के लिए एक पारदर्शी और अनुमति रहित ओरेकल प्रोटोकॉल है ताकि जब भी उसे आवश्यकता हो तो वह आसानी से कोई भी डेटा प्राप्त कर सके।_
...
**[API3 डाओ](https://www.api3.org/)** - _API3 डाओ प्रथम-पक्षीय ओरेकल समाधान प्रदान कर रहा है जो स्मार्ट अनुबंधों के लिए एक विकेन्द्रीकृत समाधान में अधिक स्रोत पारदर्शिता, सुरक्षा और मापनीयता प्रदान करता है।_
...
- [एथेरियम पर एक ब्लॉकचेन ओरेकल लागू करना](https://medium.com/@pedrodc/implementing-a-blockchain-oracle-on-ethereum-cedc7e26b49e) – _Pedro Costa_
...
- [सॉलिडिटी में एथेरियम की वर्तमान कीमत कैसे प्राप्त करें](https://blog.chain.link/fetch-current-crypto-price-data-solidity/) — _Chainlink_
- [ओरेकल डेटा का उपभोग करना](https://docs.chroniclelabs.org/Developers/tutorials/Remix) — _Chronicle_

**उदाहरण प्रोजेक्ट्स**

- [सॉलिडिटी में एथेरियम के लिए पूर्ण चेनलिंक स्टार्टर प्रोजेक्ट](https://github.com/hackbg/chainlink-fullstack) — _HackBG_
