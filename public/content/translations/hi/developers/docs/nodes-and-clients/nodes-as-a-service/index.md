...
ये सेवाएं आमतौर पर एक API कुंजी प्रदान करती हैं जिसका उपयोग आप ब्लॉकचेन से लिखने और पढ़ने के लिए कर सकते हैं। वे अक्सर मेननेट के अलावा [एथेरियम टेस्टनेट](/developers/docs/networks/#ethereum-testnets) तक पहुंच भी शामिल करते हैं।
...
- [**अल्केमी**](https://alchemy.com/)
  - [डॉक्स](https://www.alchemy.com/docs/)
  - विशेषताएँ
    - प्रति माह 300M कंप्यूट इकाइयों के साथ सबसे बड़ा फ़्री टियर (\~30M getLatestBlock अनुरोध)
    - पॉलीगॉन, स्टार्कनेट, ऑप्टिमिज़्म, आर्बिट्रम के लिए मल्टीचैन सपोर्ट
    - सबसे बड़े एथेरियम dapps और डीफाई लेनदेन की मात्रा का ~70% पॉवरिंग
    - अल्केमी अलर्ट के माध्यम से रीयल-टाइम वेबहुक अलर्ट
    - शानदार-इन-क्लास सपोर्ट और विश्वसनीयता / स्थिरता
    - अल्केमी का एनएफटी API
    - रिक्वेस्ट एक्सप्लोरर, Mempool वॉचर और कम्पोज़र के साथ डैशबोर्ड
    - इंटिग्रेटेड टेस्टनेट फोसेट तक पहुंच
    - 18k यूज़र के साथ सक्रिय डिस्कॉर्ड बिल्डर समुदाय
...
- [**Allnodes**](https://www.allnodes.com/)
  ...
  - विशेषताएँ
    ...
    - क्रेडिट कार्ड, पेपैल या क्रिप्टो से भुगतान करें
...
- [**कलैडो**](https://kaleido.io/)
  ...
  - विशेषताएँ
    ...
    - अनुकूलन योग्य क्लाइंट और एल्गोरिदम (गेथ, कोरम और बेसु || PoA, IBFT और Raft)
...
- [**क्विकनोड**](https://www.quicknode.com)
  - [डॉक्स](https://www.quicknode.com/docs/)
  - विशेषताएँ
    - 24/7 तकनीकी सहायता और डेव डिस्कॉर्ड समुदाय
    - भू-संतुलित, मल्टी क्लाउड/मेटल, लो-लेटेंसी नेटवर्क
    - मल्टीचैन सपोर्ट (ऑप्टिमिज़्म, आर्बिट्रम, पॉलीगॉन + 11 अन्य)
...
- [**टेंडरली**](https://tenderly.co/web3-gateway)
  - [डॉक्स](https://docs.tenderly.co/web3-gateway/web3-gateway)
  - विशेषताएँ
    - प्रति माह 25 मिलियन टेंडरली यूनिट सहित फ़्री टियर
    ...
    - टेंडरली के विकास, डिबगिंग और परीक्षण उपकरणों के साथ पूरी तरह इंटीग्रेटेड
    - लेनदेन सिमुलेशन
    - उपयोग विश्लेषण और फ़िल्टरिंग
    - आसान पहुँच कुंजी प्रबंधन
    - चैट, ईमेल और डिस्कॉर्ड के माध्यम से समर्पित इंजीनियरिंग सपोर्ट

- [**Tokenview**](https://services.tokenview.io/)
  - [डॉक्स](https://services.tokenview.io/docs?type=nodeService)
  - विशेषताएँ
    - 24/7 तकनीकी सहायता और डेव टेलीग्राम समुदाय
    ...
    - एनएफटी डेटा API और वेबहुक अलर्ट
    - क्रिप्टो में भुगतान करें
...
- [अल्केमी का उपयोग करके एथेरियम डेवलपमेंट के साथ शुरुआत करना](/developers/tutorials/getting-started-with-ethereum-development-using-alchemy/)
- [web3 और अल्केमी का उपयोग करके लेनदेन भेजने के लिए गाइड](/developers/tutorials/sending-transactions-using-web3-and-alchemy/)
