...
| ------------------------------------------------------------------------------------------- | ------------------------ | --------------------- | ---------------------- | ---------------------------------------------------------------------------------- | -------------- |
| [गेथ](https://geth.ethereum.org/)                                                          | Go                       | लिनक्स, Windows, macOS | मेननेट, सेपोलिया, हुडी | [स्नैप](#snap-sync), [फुल](#full-sync)                                             | आर्काइव, छंटाई |
| [नेदरमाइंड](https://www.nethermind.io/)                                                    | C#, डॉट नेट | लिनक्स, Windows, macOS | मेननेट, सेपोलिया, हुडी | [स्नैप](#snap-sync) (बिना सर्विंग के), फास्ट, [फुल](#full-sync) | आर्काइव, छंटाई |
| [बेसु](https://besu.hyperledger.org/en/stable/)                                             | जावा                     | लिनक्स, Windows, macOS | मेननेट, सेपोलिया, हुडी | [स्नैप](#snap-sync), [फास्ट](#fast-sync), [फुल](#full-sync)                        | आर्काइव, छंटाई |
| [एरिगॉन](https://github.com/ledgerwatch/erigon)                                             | Go                       | लिनक्स, Windows, macOS | मेननेट, सेपोलिया, हुडी | [फुल](#full-sync)                                                                  | आर्काइव, छंटाई |
| [रेथ](https://reth.rs/)                                                                    | रस्ट                     | लिनक्स, Windows, macOS | मेननेट, सेपोलिया, हुडी | [फुल](#full-sync)                                                                  | आर्काइव, छंटाई |
| [EthereumJS](https://github.com/ethereumjs/ethereumjs-monorepo) _(बीटा)_ | टाइपस्क्रिप्ट               | लिनक्स, Windows, macOS | सेपोलिया, हुडी         | [फुल](#full-sync)                                                                  | छंटाई की गई    |
...
Hyperledger बेसु सार्वजनिक और अनुमति प्राप्त नेटवर्क के लिए एक एंटरप्राइज़-ग्रेड एथेरियम क्लाइंट है। यह ट्रेसिंग से लेकर GraphQL तक सभी एथेरियम मेननेट सुविधाओं को चलाता है, इसकी व्यापक निगरानी है और यह खुले सामुदायिक चैनलों और एंटरप्राइज़ के लिए वाणिज्यिक SLA दोनों के माध्यम से कंसेंसिस द्वारा सपोर्ट करता है। यह जावा में लिखा गया है और Apache 2.0 लाइसेंस प्राप्त है।
...
| ------------------------------------------------------------- | ---------- | --------------------- | ---------------------------------------------------- |
| [लाइटहाउस](https://lighthouse.sigmaprime.io/)               | रस्ट       | लिनक्स, Windows, macOS | बीकन चेन, हुडी, पिर्मोंट, सेपोलिया, और अधिक          |
| [लोडस्टार](https://lodestar.chainsafe.io/)                    | टाइपस्क्रिप्ट | लिनक्स, Windows, macOS | बीकन चेन, हुडी, सेपोलिया, और अधिक                    |
| [निंबस](https://nimbus.team/)                                | Nim        | लिनक्स, Windows, macOS | बीकन चेन, हुडी, सेपोलिया, और अधिक                    |
| [प्रिज़्म](https://prysm.offchainlabs.com/docs/)                 | Go         | लिनक्स, Windows, macOS | बीकन चेन, ग्नोसिस, हुडी, पिर्मोंट, सेपोलिया, और अधिक |
| [टेकु](https://consensys.net/knowledge-base/ethereum-2/teku/) | जावा       | लिनक्स, Windows, macOS | बीकन चेन, ग्नोसिस, हुडी, सेपोलिया, और अधिक           |
| [Grandine](https://docs.grandine.io/)                         | रस्ट       | लिनक्स, Windows, macOS | बीकन चेन, हुडी, सेपोलिया, और अधिक                    |
