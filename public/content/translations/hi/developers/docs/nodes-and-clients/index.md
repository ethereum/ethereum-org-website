...
- ईथरस्कैन द्वारा [नोड्स का नक्शा](https://etherscan.io/nodetracker)
...
एथेरियम अभी तक लाइट नोड्स की एक बड़ी आबादी का सपोर्ट नहीं करता है, लेकिन लाइट नोड सपोर्ट एक ऐसा क्षेत्र है जो निकट भविष्य में तेजी से विकसित होने की उम्मीद है। विशेष रूप से, [निंबस](https://nimbus.team/), [Helios](https://github.com/a16z/helios), और [LodeStar](https://lodestar.chainsafe.io/) जैसे क्लाइंट्स वर्तमान में लाइट नोड्स पर बहुत अधिक केंद्रित हैं।
...
- आप अपने खुद के नोड के साथ एथेरियम वॉलेट का उपयोग कर सकते हैं। आप dapps का अधिक सुरक्षित और निजी रूप से उपयोग कर सकते हैं, क्योंकि आपको अपने पते और शेष राशि को बिचौलियों को लीक नहीं करना पड़ेगा। सभी चीज़ों की अपने ग्राहकों के साथ जाँच की जा सकती है। [मेटामास्क](https://metamask.io), [Frame](https://frame.sh/), और [कई अन्य वॉलेट्स](/wallets/find-wallet/) RPC-इंपोर्टिंग की पेशकश करते हैं, जिससे वे आपके नोड का उपयोग कर सकते हैं।
...
| ------------------------------------------------------------------------------------------- | ------------------------ | --------------------- | ---------------------- | ---------------------------------------------------------------------------------- | -------------- |
| [गेथ](https://geth.ethereum.org/)                                                          | Go                       | लिनक्स, विंडोज, मैकओएस | मेननेट, सेपोलिया, हुडी | [स्नैप](#snap-sync), [फुल](#full-sync)                                             | आर्काइव, छंटाई |
| [नेदरमाइंड](https://www.nethermind.io/)                                                    | C#, डॉट नेट | लिनक्स, विंडोज, मैकओएस | मेननेट, सेपोलिया, हुडी | [स्नैप](#snap-sync) (बिना सर्विंग के), फास्ट, [फुल](#full-sync) | आर्काइव, छंटाई |
| [बेसु](https://besu.hyperledger.org/en/stable/)                                             | जावा                     | लिनक्स, विंडोज, मैकओएस | मेननेट, सेपोलिया, हुडी | [स्नैप](#snap-sync), [फास्ट](#fast-sync), [फुल](#full-sync)                        | आर्काइव, छंटाई |
| [एरिगॉन](https://github.com/ledgerwatch/erigon)                                             | Go                       | लिनक्स, विंडोज, मैकओएस | मेननेट, सेपोलिया, हुडी | [फुल](#full-sync)                                                                  | आर्काइव, छंटाई |
| [रेथ](https://reth.rs/)                                                                    | रस्ट                     | लिनक्स, विंडोज, मैकओएस | मेननेट, सेपोलिया, हुडी | [फुल](#full-sync)                                                                  | आर्काइव, छंटाई |
| [एथेरियम जेएस](https://github.com/ethereumjs/ethereumjs-monorepo) _(बीटा)_ | टाइपस्क्रिप्ट               | लिनक्स, विंडोज, मैकओएस | सेपोलिया, हुडी         | [फुल](#full-sync)                                                                  | छंटाई की गई    |
...
हाइपरलेजर बेसु सार्वजनिक और अनुमति प्राप्त नेटवर्क के लिए एक एंटरप्राइज़-ग्रेड एथेरियम क्लाइंट है। यह ट्रेसिंग से लेकर ग्राफक्यूएल तक सभी एथेरियम मेननेट सुविधाओं को चलाता है, इसकी व्यापक निगरानी है और यह खुले सामुदायिक चैनलों और एंटरप्राइज़ के लिए वाणिज्यिक SLA दोनों के माध्यम से कंसेंसिस द्वारा सपोर्ट करता है। यह जावा में लिखा गया है और Apache 2.0 लाइसेंस प्राप्त है।

बेसु का विस्तृत [प्रलेखन](https://besu.hyperledger.org/en/stable/) आपको इसकी विशेषताओं और सेटअप के सभी विवरणों के माध्यम से मार्गदर्शन करेगा।

### एरिगॉन {#erigon}

एरिगॉन, जिसे पहले टर्बो-गेथ के नाम से जाना जाता था, गो एथेरियम के फ़ोर्क के रूप में गति और डिस्क-स्पेस दक्षता की ओर उन्मुख था। एरिगॉन एथेरियम का पूरी तरह से फिर से वास्तुशिल्प कार्यान्वयन है, जो वर्तमान में गो में लिखा गया है लेकिन विकास के तहत अन्य भाषाओं में कार्यान्वयन के साथ है। एरिगॉन का लक्ष्य एथेरियम का तेज़, अधिक मॉड्यूलर और अधिक अनुकूलित कार्यान्वयन प्रदान करना है। यह 3 दिनों से कम समय में लगभग 2TB डिस्क स्थान का उपयोग करके एक फ़ुल आर्काइव नोड सिंक कर सकता है।

### Go एथेरियम {#geth}

गो एथेरियम (संक्षेप में गेथ) एथेरियम प्रोटोकॉल के मूल कार्यान्वयन में से एक है। वर्तमान में, यह यूज़र और डिवलपर्स के लिए सबसे बड़े यूज़र आधार और विभिन्न प्रकार के टूलींग के साथ सबसे व्यापक क्लाइंट है। यह गो में लिखा गया है, पूरी तरह से खुला स्रोत और GNU LGPL v3 के तहत लाइसेंस प्राप्त है।

गेथ के बारे में इसके [प्रलेखन](https://geth.ethereum.org/docs/) में और जानें।

### नेदरमाइंड {#nethermind}

नेदरमाइंड एक एथेरियम कार्यान्वयन है जिसे C# डॉट नेट टेक स्टैक के साथ बनाया गया है, जिसे LGPL-3.0 के साथ लाइसेंस प्राप्त है, जो ARM सहित सभी प्रमुख प्लेटफ़ार्मों पर चल रहा है। यह इसके साथ शानदार परफ़ॉर्मेंस प्रदान करता है:

- एक कस्टमाइज़ की गई वर्चुअल मशीन
- स्टेट एक्सेस
- नेटवर्किंग और समृद्ध विशेषताएं जैसे Prometheus/ग्रफाना डैशबोर्ड, seq एंटरप्राइज़ लॉगिंग सपोर्ट, JSON-RPC ट्रेसिंग और एनालिटिक्स प्लगइन्स।

नेदरमाइंड के पास [विस्तृत प्रलेखन](https://docs.nethermind.io), मजबूत देव समर्थन, एक ऑनलाइन समुदाय और प्रीमियम उपयोगकर्ताओं के लिए 24/7 सहायता उपलब्ध है।

### रेथ {#reth}

रेथ (रस्ट एथेरियम के लिए छोटा) एक एथेरियम फ़ुल नोड कार्यान्वयन है जो यूज़र के अनुकूल, बहुत ज़्यादा मॉड्यूलर, तेज और कुशल होने पर केंद्रित है। रेथ मूल रूप से Paradigm द्वारा बनाया और आगे बढ़ाया गया था, और Apache और MIT लाइसेंस के तहत लाइसेंस प्राप्त है।

रेथ उत्पादन के लिए तैयार है, और मिशन-महत्वपूर्ण वातावरण जैसे स्टेकिंग या हाई-अपटाइम सेवाओं में उपयोग के लिए सही है। उपयोग के मामलों में अच्छी परफ़ॉर्मेंस देता है जहां RPC, MEV, इंडेक्सिंग, सिमुलेशन और P2P गतिविधियों जैसे महान मार्जिन के साथ बेहतरीन परफ़ॉर्मेंस की आवश्यकता होती है।

[रेथ बुक](https://reth.rs/), या [रेथ गिटहब रिपो](https://github.com/paradigmxyz/reth?tab=readme-ov-file#reth) को देखकर और जानें।
...
| ------------------------------------------------------------- | ---------- | --------------------- | ---------------------------------------------------- |
| [लाइटहाउस](https://lighthouse.sigmaprime.io/)               | रस्ट       | लिनक्स, विंडोज, मैकओएस | बीकन चेन, हुडी, पिर्मोंट, सेपोलिया, और अधिक          |
| [लोडस्टार](https://lodestar.chainsafe.io/)                    | टाइपस्क्रिप्ट | लिनक्स, विंडोज, मैकओएस | बीकन चेन, हुडी, सेपोलिया, और अधिक                    |
| [निंबस](https://nimbus.team/)                                | निम        | लिनक्स, विंडोज, मैकओएस | बीकन चेन, हुडी, सेपोलिया, और अधिक                    |
| [प्रिज़्म](https://prysm.offchainlabs.com/docs/)                 | Go         | लिनक्स, विंडोज, मैकओएस | बीकन चेन, ग्नोसिस, हुडी, पिर्मोंट, सेपोलिया, और अधिक |
| [टेकु](https://consensys.net/knowledge-base/ethereum-2/teku/) | जावा       | लिनक्स, विंडोज, मैकओएस | बीकन चेन, ग्नोसिस, हुडी, सेपोलिया, और अधिक           |
| [ग्रैंडाइन](https://docs.grandine.io/)                         | रस्ट       | लिनक्स, विंडोज, मैकओएस | बीकन चेन, हुडी, सेपोलिया, और अधिक                    |

### लाइटहाउस {#lighthouse}

लाइटहाउस Apache-2.0 लाइसेंस के तहत रस्ट में लिखा गया एक सर्वसम्मति ग्राहक कार्यान्वयन है। यह सिग्मा प्राइम द्वारा बनाए रखा गया है और बीकन चेन उत्पत्ति के बाद से स्थिर और उत्पादन के लिए तैयार है। यह विभिन्न एंटरप्राइज़, स्टेकिंग पूल और व्यक्तियों द्वारा भरोसा किया जाता है। इसका उद्देश्य डेस्कटॉप PC से परिष्कृत स्वचालित डिप्लॉयमेंट तक, वातावरण की एक विस्तृत सीरीजत़ में सुरक्षित, प्रदर्शनकारी और इंटरऑपरेबल होना है।

प्रलेखन [लाइटहाउस बुक](https://lighthouse-book.sigmaprime.io/) में पाया जा सकता है

### लोडस्टार {#lodestar}

लोडस्टार LGPL-3.0 लाइसेंस के तहत टाइपस्क्रिप्ट में लिखा गया एक उत्पादन-तैयार सर्वसम्मति ग्राहक कार्यान्वयन है। यह ChainSafe सिस्टम्स द्वारा बनाए रखा जाता है और एकल-स्टेकर्स, डिवलपर्स और शोधकर्ताओं के लिए आम सहमति ग्राहकों में सबसे नया है। लोडस्टार में एक बीकन नोड और सत्यापनकर्ता क्लाइंट होता है जो एथेरियम प्रोटोकॉल के जावास्क्रिप्ट कार्यान्वयन द्वारा संचालित होता है। लोडस्टार का उद्देश्य लाइट क्लाइंट के साथ एथेरियम उपयोगिता में सुधार करना, डिवलपर्स के एक बड़े समूह तक पहुंच का विस्तार करना और ईकोसिस्टम की विविधता में और योगदान करना है।

अधिक जानकारी [लोडस्टार वेबसाइट](https://lodestar.chainsafe.io/) पर मिल सकती है

### निंबस {#nimbus}

निंबस, Apache-2.0 लाइसेंस के तहत निम में लिखा गया एक सर्वसम्मति ग्राहक कार्यान्वयन है। यह एकल-स्टेकर्स और स्टेकिंग पूल द्वारा उपयोग में उत्पादन के लिए तैयार एक क्लाइंट है। निंबस को संसाधन दक्षता के लिए डिज़ाइन किया गया है, जिससे स्थिरता या इनाम प्रदर्शन से समझौता किए बिना, संसाधन-प्रतिबंधित उपकरणों और एंटरप्राइज़ संबंधी बुनियादी ढांचे पर समान आसानी से चलना आसान हो जाता है। एक लाइट संसाधन पदचिह्न का मतलब है कि नेटवर्क तनाव में होने पर क्लाइंट के पास सुरक्षा का अधिक मार्जिन होता है।
...
टेकु मूल बीकन चेन उत्पत्ति वाले क्लाइंट में से एक है। सामान्य लक्ष्यों (सुरक्षा, मजबूती, स्थिरता, प्रयोज्यता, प्रदर्शन) के साथ, टेकु का उद्देश्य विशेष रूप से सभी विभिन्न सर्वसम्मति वाले ग्राहक संबंधी मानकों का पूरी तरह से पालन करना है।

टेकु बहुत लचीले परिनियोजन विकल्प प्रदान करता है। बीकन नोड और सत्यापनकर्ता क्लाइंट को एक ही प्रक्रिया के रूप में एक साथ चलाया जा सकता है, जो सिंगल स्टेकर्स के लिए बेहद सुविधाजनक है, या परिष्कृत स्टेकिंग संचालन के लिए नोड्स को अलग से चलाया जा सकता है। इसके अलावा, टेकु साइनिंग कुंजी सुरक्षा और स्लैशिंग सुरक्षा के लिए [Web3Signer](https://github.com/ConsenSys/web3signer/) के साथ पूरी तरह से इंटरऑपरेबल है।

टेकु, जावा में लिखा गया है और Apache 2.0 लाइसेंस प्राप्त है। इसे कंसेंसिस में प्रोटोकॉल टीम द्वारा विकसित किया गया है जो बेसु और Web3Signer के लिए भी ज़िम्मेदार है। [टेकु डॉक्स](https://docs.teku.consensys.net/en/latest/) में और जानें।

### ग्रैंडाइन {#grandine}

ग्रैंडाइन एक सर्वसम्मति वाले क्लाइंट से संबंधित कार्यान्वयन है, जिसे GPL-3.0 लाइसेंस के तहत रस्ट में लिखा गया है। इसका रखरखाव ग्रैंडाइन कोर टीम द्वारा किया जाता है और यह तेज़, बेहतर परफ़ॉर्मेंस वाला और हल्का है। यह रास्पबेरी पाई जैसे कम संसाधन वाले उपकरणों पर चलने वाले सिंगल स्टेकरों से लेकर हज़ारों सत्यापनकर्ताओं को चलाने वाले बड़े संस्थागत स्टेकर्स तक, विभिन्न प्रकार के स्टेकर्स के लिए उपयुक्त है।
...
[ऑप्टिमिस्टिक सिंक पर और अधिक](https://github.com/ethereum/consensus-specs/blob/master/sync/optimistic.md)
