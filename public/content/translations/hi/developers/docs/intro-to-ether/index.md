...
इस पेज को बेहतर ढंग से समझने में आपकी मदद करने के लिए, हम आपको पहले [एथेरियम का परिचय](/developers/docs/intro-to-ethereum/) पढ़ने की सलाह देते हैं।
...
पहली क्रिप्टोकरेंसी बिटकॉइन थी, जिसे सातोशी नाकामोटो ने बनाया था। 2009 में बिटकॉइन की रिलीज़ के बाद से, लोगों ने कई अलग-अलग ब्लॉकचेन में हजारों क्रिप्टोकरेंसी बनाई हैं।

## ईथर क्या है? {#what-is-ether}

**ईथर (ETH)** वह क्रिप्टोकरेंसी है जिसका इस्तेमाल एथेरियम नेटवर्क पर कई कामों के लिए किया जाता है। मूल रूप से, यह लेन-देन शुल्क के लिए भुगतान का एकमात्र स्वीकार्य रूप है, और [मर्ज](/roadmap/merge) के बाद, Mainnet पर ब्लॉकों को मान्य करने और प्रस्तावित करने के लिए ईथर की आवश्यकता होती है। ईथर का उपयोग [डीफाई](/defi) उधार बाज़ारों में कोलेट्रल के प्राथमिक रूप के रूप में, एनएफटी मार्केटप्लेस में खाते की एक इकाई के रूप में, सेवाओं को करने या वास्तविक दुनिया के सामान बेचने के लिए अर्जित भुगतान के रूप में, और बहुत कुछ के रूप में भी किया जाता है।

एथेरियम डेवलपर्स को [**विकेंद्रीकृत अनुप्रयोग (डैप्स)**](/developers/docs/dapps) बनाने की अनुमति देता है, जो सभी कंप्यूटिंग शक्ति का एक पूल साझा करते हैं। यह साझा पूल परिमित है, इसलिए एथेरियम को यह निर्धारित करने के लिए एक मैकेनिज्म की आवश्यकता है कि इसका उपयोग कौन करता है। अन्यथा, एक dapp गलती से या दुर्भावनापूर्ण रूप से सभी नेटवर्क संसाधनों का उपभोग कर सकता है, जो दूसरों को इसे एक्सेस करने से ब्लॉक कर देगा।
...
एथेरियम और ईथर को लेकर [अक्सर भ्रम होता है](https://abcnews.go.com/Business/bitcoin-slumps-week-low-amid-renewed-worries-chinese/story?id=78399845) — जब लोग "एथेरियम की कीमत" का उल्लेख करते हैं, तो वे ईथर की कीमत का वर्णन कर रहे होते हैं।
...
Wei ईथर की सबसे छोटी संभव मात्रा है, और इसके परिणामस्वरूप, कई तकनीकी कार्यान्वयन, जैसे कि [एथेरियम Yellowpaper](https://ethereum.github.io/yellowpaper/paper.pdf), Wei में सभी गणनाओं को आधार बनाएंगे।
...
एथेरियम पर प्रत्येक लेन-देन में एक `value` फ़ील्ड होता है, जो प्रेषक के पते से प्राप्तकर्ता के पते पर भेजने के लिए, wei में मूल्यवर्गित ईथर की मात्रा को निर्दिष्ट करता है।
...
[ईथरस्कैन](https://etherscan.io) और [ब्लॉकस्काउट](https://eth.blockscout.com) वेब-आधारित एप्लिकेशन के ज़रिए एड्रेस बैलेंस की जाँच करने के लिए लोकप्रिय टूल हैं। उदाहरण के लिए, [यह ब्लॉकस्काउट पेज](https://eth.blockscout.com/address/0xde0B295669a9FD93d5F28D9Ec85E40f4cb697BAe) एथेरियम फाउंडेशन का बैलेंस दिखाता है। खाते की शेष राशि को वॉलेट का उपयोग करके या सीधे नोड्स से अनुरोध करके भी क्वेरी की जा सकती है।

## आगे की रीडिंग {#further-reading}

- [ईथर और एथेरियम को परिभाषित करना](https://www.cmegroup.com/education/courses/introduction-to-ether/defining-ether-and-ethereum.html) – _CME Group_
- [एथेरियम व्हाइटपेपर](/whitepaper/): एथेरियम के लिए मूल प्रस्ताव। इस दस्तावेज़ में ईथर का विवरण और इसके निर्माण के पीछे की प्रेरणाएँ शामिल हैं।
