...
##### प्रमाण निर्माण {#entries-and-exits}
...
##### प्रमाण सत्यापन {#zk-rollups-and-evm-compatibility}
...
### प्रविष्टियाँ और निकास {#how-do-zk-rollup-fees-work}
...
## ZK-रोलअप्स और EVM संगतता {#scaling-ethereum-with-zk-rollups}
...
## ZK-रोलअप शुल्क कैसे काम करते हैं? {#transaction-data-compression}
...
## ZK-रोलअप्स इथेरियम को कैसे स्केल करते हैं? {#recursive-proofs}

### लेन-देन डेटा संपीड़न {#zk-rollups-pros-and-cons}
...
### ZK-रोलअप्स के फायदे और नुकसान {#zkevm-projects}
...
### ZK-रोलअप्स की एक दृश्य व्याख्या {#further-reading-on-zk-rollups}
...
## zkEVM पर कौन काम कर रहा है? {#tutorials}
