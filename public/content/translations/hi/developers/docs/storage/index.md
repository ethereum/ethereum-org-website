...
आईपीएफएस फ़ाइलों, वेबसाइटों, अनुप्रयोगों और डेटा को संग्रहीत करने और एक्सेस करने के लिए एक वितरित प्रणाली है। इसमें एक अंतर्निहित प्रोत्साहन योजना नहीं है, लेकिन इसके बजाय लंबी अवधि की दृढ़ता के लिए ऊपर दिए गए किसी भी अनुबंध-आधारित प्रोत्साहन समाधान के साथ इसका उपयोग किया जा सकता है। आईपीएफएस पर डेटा जारी रखने का एक और तरीका एक पिनिंग सेवा के साथ काम करना है, जो आपके लिए आपके डेटा को "पिन" करेगा। आप अपना खुद का आईपीएफएस नोड भी चला सकते हैं और अपने और / या अन्य के डेटा को मुफ्त में जारी रखने के लिए नेटवर्क में योगदान कर सकते हैं!

- [आईपीएफएस](https://docs.ipfs.io/concepts/what-is-ipfs/)
- [पिनाटा](https://www.pinata.cloud/) _(आईपीएफएस पिनिंग सेवा)_
- [web3.storage](https://web3.storage/) _(आईपीएफएस/फाइलकॉइन पिनिंग सेवा)_
- [इन्फ्यूरा](https://infura.io/product/ipfs) _(आईपीएफएस पिनिंग सेवा)_
- [आईपीएफएस Scan](https://ipfs-scan.io) _(आईपीएफएस पिनिंग एक्सप्लोरर)_
- [4EVERLAND](https://www.4everland.org/)_（आईपीएफएस पिनिंग सेवा）_
- [फाइलबेस](https://filebase.com) _(आईपीएफएस पिनिंग सेवा)_
- [Spheron Network](https://spheron.network/) _(आईपीएफएस/फाइलकॉइन पिनिंग सेवा)_
...
**आईपीएफएस - _इंटरप्लेनेटरी फ़ाइल सिस्टम एथेरियम के लिए एक विकेंद्रीकृत भंडारण और फ़ाइल संदर्भ प्रणाली है।_**

- [Ipfs.io](https://ipfs.io/)
- [प्रलेखन](https://docs.ipfs.io/)
- [गिटहब](https://github.com/ipfs/ipfs)

**Storj DCS - _डेवलपर्स के लिए सुरक्षित, निजी और S3-संगत विकेंद्रीकृत क्लाउड ऑब्जेक्ट भंडारण।_**

- [Storj.io](https://storj.io/)
- [प्रलेखन](https://docs.storj.io/)
- [गिटहब](https://github.com/storj/storj)
...
- [गिटहब](https://github.com/SiaFoundation/)

**फाइलकॉइन - _Filecoin को आईपीएफएस के पीछे की टीम ने ही बनाया था। यह आईपीएफएस के आदर्शों के ऊपर एक प्रोत्साहन परत है।_**

- [Filecoin.io](https://filecoin.io/)
- [प्रलेखन](https://docs.filecoin.io/)
- [गिटहब](https://github.com/filecoin-project/)

**आरवीव - _Arweave डेटा संग्रहीत करने के लिए एक dStorage प्लेटफ़ॉर्म है।_**

- [Arweave.org](https://www.arweave.org/)
- [प्रलेखन](https://docs.arweave.org/info/)
- [आरवीव](https://github.com/ArweaveTeam/arweave/)
...
- [गिटहब](https://github.com/0chain/)

**Crust Network - _Crust, आईपीएफएस के ऊपर एक dStorage प्लेटफ़ॉर्म है।_**

- [Crust.network](https://crust.network)
- [प्रलेखन](https://wiki.crust.network)
- [गिटहब](https://github.com/crustio)

**स्वार्म - _एथेरियम वेब3 स्टैक के लिए एक वितरित भंडारण प्लेटफ़ॉर्म और सामग्री वितरण सेवा।_**

- [EthSwarm.org](https://www.ethswarm.org/)
- [प्रलेखन](https://docs.ethswarm.org/)
- [गिटहब](https://github.com/ethersphere/)

**OrbitDB - _IPFS के ऊपर एक विकेंद्रीकृत पियर-टू-पियर डेटाबेस।_**

- [OrbitDB.org](https://orbitdb.org/)
- [प्रलेखन](https://github.com/orbitdb/field-manual/)
- [गिटहब](https://github.com/orbitdb/orbit-db/)

**Aleph.im - _विकेंद्रीकृत क्लाउड प्रोजेक्ट (डेटाबेस, फ़ाइल भंडारण, कंप्यूटिंग और DID)। ऑफचैन और ऑनचेन पीयर-टू-पीयर तकनीक का एक अनूठा मिश्रण। आईपीएफएस और मल्टी-चेन संगतता।_**

- [Aleph.im](https://aleph.cloud/)
- [प्रलेखन](https://docs.aleph.cloud/)
- [गिटहब](https://github.com/aleph-im/)

**Ceramic - _डेटा-समृद्ध और आकर्षक अनुप्रयोगों के लिए उपयोगकर्ता-नियंत्रित आईपीएफएस डेटाबेस भंडारण।_**

- [Ceramic.network](https://ceramic.network/)
- [प्रलेखन](https://developers.ceramic.network/)
- [गिटहब](https://github.com/ceramicnetwork/js-ceramic/)

**फाइलबेस - _S3-संगत विकेंद्रीकृत भंडारण और जियो-रिडंडेंट आईपीएफएस पिनिंग सेवा। फाइलबेस के माध्यम से आईपीएफएस पर अपलोड की गई सभी फ़ाइलें दुनिया भर में 3x प्रतिकृति के साथ स्वचालित रूप से फाइलबेस इंफ्रास्ट्रक्चर में पिन हो जाती हैं।_**

- [Filebase.com](https://filebase.com/)
- [प्रलेखन](https://docs.filebase.com/)
- [गिटहब](https://github.com/filebase)

**4EVERLAND - _एक वेब 3.0 क्लाउड कंप्यूटिंग प्लेटफॉर्म जो भंडारण, कंप्यूट और नेटवर्किंग कोर क्षमताओं को एकीकृत करता है, S3 संगत है और आईपीएफएस और आरवीव जैसे विकेंद्रीकृत भंडारण नेटवर्कों पर सिंक्रोनस डेटा भंडारण प्रदान करता है।_**

- [4everland.org](https://www.4everland.org/)
- [प्रलेखन](https://docs.4everland.org/)
- [गिटहब](https://github.com/4everland)

**कलैडो - _क्लिक-बटन आईपीएफएस नोड्स के साथ एक ब्लॉकचेन-एज़-ए-सर्विस प्लेटफॉर्म_**

- [कलैडो](https://kaleido.io/)
- [प्रलेखन](https://docs.kaleido.io/kaleido-services/ipfs/)
- [गिटहब](https://github.com/kaleido-io)
...
- [गिटहब](https://github.com/spheronFdn)
