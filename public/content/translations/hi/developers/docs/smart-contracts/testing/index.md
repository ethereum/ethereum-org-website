...
##### 1. अपने अनुबंध के व्यावसायिक लॉजिक और वर्कफ़्लो को समझें {#integration-testing-for-smart-contracts}
...
##### 2. अनुबंध निष्पादन से संबंधित सभी मान्यताओं का मूल्यांकन करें {#property-based-testing-for-smart-contracts}
...
##### 3. कोड कवरेज को मापें {#static-analysis}
...
##### 4. अच्छी तरह से विकसित परीक्षण फ्रेमवर्क का उपयोग करें {#dynamic-analysis}
...
### एकीकरण परीक्षण (Integration testing) {#running-property-based-tests}
...
### संपत्ति-आधारित परीक्षण (Property-based testing) {#manual-testing-for-smart-contracts}
...
#### स्थैतिक विश्लेषण {#testing-on-local-blockchain}
...
### स्मार्ट अनुबंधों के लिए संपत्ति-आधारित परीक्षण चलाने के लिए दिशानिर्देश {#testing-vs-formal-verification}
...
## स्मार्ट अनुबंधों के लिए मैनुअल परीक्षण {#testing-vs-audits-bug-bounties}
...
### स्थानीय ब्लॉकचेन पर अनुबंधों का परीक्षण {#testing-tools-and-libraries}
...
### टेस्टनेट पर अनुबंधों का परीक्षण {#unit-testing-tools}
...
## परीक्षण बनाम औपचारिक सत्यापन {#property-based-testing-tools}
...
## परीक्षण बनाम ऑडिट और बग बाउंटी {#static-analysis-tools}
...
## परीक्षण उपकरण और लाइब्रेरी {#dynamic-analysis-tools}

### यूनिट परीक्षण उपकरण {#related-tutorials}
...
### संपत्ति-आधारित परीक्षण उपकरण {#further-reading}

#### स्थैतिक विश्लेषण उपकरण {#tutorials}
