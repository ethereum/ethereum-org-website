...
description: "ईएनएस के साथ एथेरियम स्मार्ट अनुबंधों के नामकरण के लिए सर्वोत्तम प्रथाएँ"
lang: hi
---
...
यह [एथेरियम Name Service](https://ens.domains/) द्वारा संभव हुआ है जो एथेरियम पतों के लिए एक विकेन्द्रीकृत नामकरण सेवा प्रदान करता है। यह उसी तरह है जैसे डोमेन नेम सर्विस (DNS) इंटरनेट के यूज़र्स को `104.18.176.152` जैसे आईपी पते के बजाय ethereum.org जैसे नाम का उपयोग करके नेटवर्क पतों तक पहुंचने में सक्षम बनाता है।
...
## अनुबंधों के लिए ईएनएस नामकरण कैसे काम करता है {#how-ens-naming-works}
...
1. एक पैरेंट ईएनएस डोमेन (जैसे `myapp.eth`) को पंजीकृत या नियंत्रित करें
2. एक सबडोमेन बनाएं (जैसे `v1.myapp.eth`)
3. सबडोमेन के `पता` रिकॉर्ड को अनुबंध पते पर सेट करें
4. अनुबंध के रिवर्स रिकॉर्ड को ईएनएस पर सेट करें ताकि नाम उसके पते के माध्यम से पाया जा सके
...
स्मार्ट अनुबंधों के नामकरण के लिए दो दृष्टिकोण हैं। या तो कुछ मैन्युअल चरणों के साथ [ईएनएस App](https://app.ens.domains) का उपयोग करना, या [Enscribe](https://www.enscribe.xyz) का उपयोग करना। इनकी रूपरेखा नीचे दी गई है।

### मैन्युअल ईएनएस सेटअप {#manual-ens-setup}

[ईएनएस App](https://app.ens.domains) का उपयोग करके, डेवलपर मैन्युअल रूप से उप-नाम बना सकते हैं और फॉरवर्ड पता रिकॉर्ड सेट कर सकते हैं। हालांकि, वे ईएनएस ऐप के माध्यम से नाम के लिए रिवर्स रिकॉर्ड सेट करके स्मार्ट अनुबंध के लिए एक प्राथमिक नाम सेट नहीं कर सकते हैं। मैन्युअल कदम उठाने होंगे जो [ईएनएस docs](https://docs.ens.domains/web/naming-contracts/) में शामिल हैं।

### Enscribe {#enscribe}

[Enscribe](https://www.enscribe.xyz) ईएनएस के साथ स्मार्ट अनुबंध नामकरण को सरल बनाता है, और स्मार्ट अनुबंधों में यूज़र के विश्वास को बढ़ाता है। यह प्रदान करता है:
...
- वॉलेट और ब्लॉकचेन एक्सप्लोरर जैसे ऐप्स में दृश्यता के लिए अनुबंधों को ईएनएस नामों से जोड़ने के लिए **रिवर्स रिकॉर्ड सेट करें**।
...
- **स्वामित्व में परिवर्तन**: ईएनएस रिकॉर्ड को एथेरियम पर एनएफटी के रूप में दर्शाया जाता है, जहां एक विशिष्ट `.eth` डोमेन के मालिक के पास संबंधित एनएफटी होता है। इसलिए यदि कोई अलग खाता इस एनएफटी का स्वामित्व ले लेता है, तो नया मालिक किसी भी ईएनएस रिकॉर्ड को अपनी इच्छानुसार संशोधित कर सकता है।
...
- [ईएनएस के साथ स्मार्ट अनुबंधों का नामकरण](https://docs.ens.domains/web/naming-contracts/)
