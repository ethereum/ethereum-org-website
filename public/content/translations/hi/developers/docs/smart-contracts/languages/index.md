...
अधिक अनुभवी डेवलपर भी युल का उपयोग करना चाह सकते हैं, जो [एथेरियम वर्चुअल मशीन](/developers/docs/evm/) के लिए एक मध्यवर्ती भाषा है, या युल+, जो युल का एक एक्सटेंशन है।
...
- [सॉलिडिटी गिटर चैटरूम](https://gitter.im/ethereum/solidity) जो [सॉलिडिटी Matrix चैटरूम](https://matrix.to/#/#ethereum_solidity:gitter.im) से जुड़ा है
...
- यह [EVM](/developers/docs/evm) और [Ewasm](https://github.com/ewasm), एक एथेरियम फ्लेवर्ड वेबअसेंबली, का समर्थन करता है और इसे दोनों प्लेटफॉर्मों के लिए एक प्रयोग करने योग्य सामान्य भाजक के रूप में डिज़ाइन किया गया है।
...
- [युल प्रलेखन](https://docs.soliditylang.org/en/latest/yul.html)
- [युल+ प्रलेखन](https://github.com/fuellabs/yulp)
- [युल+ परिचय पोस्ट](https://medium.com/@fuellabs/introducing-yul-a-new-low-level-language-for-ethereum-aa64ce89512f)
...
यदि आप पहले से ही स्मार्ट अनुबंधों में अच्छी तरह से अनुभवी हैं, तो युल में एक पूर्ण ERC20 कार्यान्वयन [यहां](https://solidity.readthedocs.io/en/latest/yul.html#complete-erc20-example) पाया जा सकता है।
...
### युल और युल+ के बारे में क्या बढ़िया है? {#yul-advantages}
