...
एक dapp में अपने बैकएंड पर कॉल करने के लिए किसी भी भाषा (ऐप की तरह) में लिखा गया फ़्रंटएंड कोड और यूज़र इंटरफ़ेस हो सकता है। इसके अलावा, इसके फ्रंटएंड को [आईपीएफएस](https://ipfs.io/) जैसे विकेन्द्रीकृत भंडारण पर होस्ट किया जा सकता है।
...
**स्कैफोल्ड-ईटीएच _- एक ऐसे फ्रंटएंड का उपयोग करके सॉलिडिटी के साथ शीघ्रता से प्रयोग करें जो आपके स्मार्ट अनुबंध के अनुकूल हो।_**
...
- [गिटहब](https://github.com/oneclickdapp/oneclickdapp-v1)
...
- [गिटहब](https://github.com/abunsen/etherflow)
...
**Crossmint _- स्मार्ट अनुबंधों को तैनात करने, क्रेडिट-कार्ड और क्रॉस-चेन भुगतान सक्षम करने और एनएफटीज़ बनाने, वितरित करने, बेचने, संग्रहीत करने और संपादित करने के लिए API का उपयोग करने हेतु एंटरप्राइज़-ग्रेड वेब3 विकास प्लेटफ़ॉर्म।_**
