---
title: "स्मार्ट अनुबंधों में बग खोजने के लिए मैंटिकोर का उपयोग कैसे करें"
...
## मैंटिकोर के तहत चल रहा है {#running-under-manticore}

हम देखेंगे कि मैंटिकोर API के साथ एक स्मार्ट अनुबंध का पता कैसे लगाया जाए। लक्ष्य निम्नलिखित स्मार्ट अनुबंध [`example.sol`](https://github.com/crytic/building-secure-contracts/blob/master/program-analysis/manticore/examples/example.sol) है:
...
अतिरिक्त जानकारी के बिना, मैंटिकोर नए सिम्बॉलिक
ट्रांजैक्शन के साथ अनुबंध को तब तक एक्सप्लोर करेगा जब तक कि वह अनुबंध पर नए पाथ एक्सप्लोर नहीं कर लेता। मैंटिकोर एक विफल ट्रांजैक्शन के बाद नए ट्रांजैक्शन नहीं चलाता है (उदाहरण के लिए: एक रिवर्ट के बाद)।
...
यदि डेटा सिम्बॉलिक है, तो मैंटिकोर लेनदेन निष्पादन के दौरान अनुबंध के सभी कार्यों का पता लगाएगा। यह समझने के लिए कि फ़ंक्शन चयन कैसे काम करता है, [हैंड्स ऑन द एथरनॉट सीटीएफ](https://blog.trailofbits.com/2017/11/06/hands-on-the-ethernaut-ctf/) लेख में फॉलबैक फंक्शन की व्याख्या देखना सहायक होगा।
...
एक्सप्लोरेशन को रोकने के लिए [m.finalize()](https://manticore.readthedocs.io/en/latest/evm.html?highlight=finalize#manticore.ethereum.ManticoreEVM.finalize) का उपयोग करें। इस विधि को कॉल करने के बाद कोई और लेनदेन नहीं भेजा जाना चाहिए और मैंटिकोर एक्सप्लोर किए गए प्रत्येक पाथ के लिए टेस्ट केस उत्पन्न करता है।

### सारांश: मैंटिकोर के तहत चलाना {#summary-running-under-manticore}
