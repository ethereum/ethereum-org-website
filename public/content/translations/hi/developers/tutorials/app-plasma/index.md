...
क्लाइंट-साइड कोड के लिए, हम [Vite](https://vite.dev/), [रिएक्ट](https://react.dev/), [वीएम](https://viem.sh/), और [वैग्मी](https://wagmi.sh/) का उपयोग करने जा रहे हैं। ये उद्योग-मानक उपकरण हैं; यदि आप इनसे परिचित नहीं हैं, तो आप [इस ट्यूटोरियल](/developers/tutorials/creating-a-wagmi-ui-for-your-contract/) का उपयोग कर सकते हैं।

सर्वर का अधिकांश भाग [Node](https://nodejs.org/en) का उपयोग करके जावास्क्रिप्ट में लिखा गया है। ज़ीरो-नॉलेज भाग [Noir](https://noir-lang.org/) में लिखा गया है। हमें संस्करण `1.0.0-beta.10` की आवश्यकता है, इसलिए [निर्देशानुसार Noir इंस्टॉल करने](https://noir-lang.org/docs/getting_started/quick_start) के बाद, चलाएँ:
...
1. सुनिश्चित करें कि आपके पास [Node](https://nodejs.org/en/download) और [Noir](https://noir-lang.org/install) इंस्टॉल हैं। अधिमानतः, उन्हें macOS, लिनक्स, या [WSL](https://learn.microsoft.com/en-us/windows/wsl/install) जैसे UNIX सिस्टम पर इंस्टॉल करें।
...
Noir [रस्ट](https://www.rust-lang.org/) से प्रेरित है। वेरिएबल, डिफ़ॉल्ट रूप से, स्थिरांक होते हैं। इस तरह हम वैश्विक कॉन्फ़िगरेशन स्थिरांक को परिभाषित करते हैं। विशेष रूप से, `ACCOUNT_NUMBER` हमारे द्वारा संग्रहीत खातों की संख्या है।
...
[noir.js](https://www.npmjs.com/package/@noir-lang/noir_js) लाइब्रेरी जावास्क्रिप्ट कोड और Noir कोड के बीच इंटरफ़ेस करती है।
