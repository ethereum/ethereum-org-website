---
title: "इन्फ्लक्सडीबी और ग्रफाना के साथ गेथ की निगरानी"
description: "प्रदर्शन को ट्रैक करने और समस्याओं की पहचान करने के लिए इन्फ्लक्सडीबी और ग्रफाना का उपयोग करके अपने गेथ नोड के लिए निगरानी सेट करें।"
author: "मारियो हैवेल"
...
- गेथ के मेट्रिक्स के सुइट का यह वीडियो अवलोकन देखें: [Péter Szilágyi द्वारा एक एथेरियम इंफ्रास्ट्रक्चर की निगरानी](https://www.youtube.com/watch?v=cOBab8IJMYI)।
...
- [इन्फ्लक्सडीबी](https://www.influxdata.com/get-influxdb/) (पुश मॉडल)
- [Telegraf](https://www.influxdata.com/get-influxdb/)
- [ग्रफाना](https://www.grafana.com/)
- [Datadog](https://www.datadoghq.com/)
- [Chronograf](https://www.influxdata.com/time-series-platform/chronograf/)

[गेथ Prometheus Exporter](https://github.com/hunterlong/gethexporter) भी है, जो इन्फ्लक्सडीबी और ग्रफाना के साथ पहले से कॉन्फ़िगर किया गया एक विकल्प है।
...
## इन्फ्लक्सडीबी सेट करना {#setting-up-influxdb}

सबसे पहले, आइए इन्फ्लक्सडीबी डाउनलोड और इंस्टॉल करें। विभिन्न डाउनलोड विकल्प [Influxdata रिलीज़ पेज](https://portal.influxdata.com/downloads/) पर मिल सकते हैं। अपने एनवायरमेंट के अनुकूल एक चुनें।
...
अब आप इस यूज़र के साथ [इन्फ्लक्सडीबी शेल](https://docs.influxdata.com/influxdb/v1.8/tools/shell/) में प्रवेश करने के लिए influx क्लाइंट का उपयोग कर सकते हैं।

```
influx -username 'username' -password 'password'
```

इसके शेल में इन्फ्लक्सडीबी के साथ सीधे संवाद करते हुए, आप geth मेट्रिक्स के लिए डेटाबेस और यूज़र बना सकते हैं।
...
## ग्रफाना सेट करना {#setting-up-grafana}

अगला कदम ग्रफाना इंस्टॉल करना है जो डेटा को ग्राफिक रूप से इंटरप्रेट करेगा। ग्रफाना प्रलेखन में अपने एनवायरमेंट के लिए इंस्टॉलेशन प्रक्रिया का पालन करें। सुनिश्चित करें कि आप OSS संस्करण इंस्टॉल करें यदि आप अन्यथा नहीं चाहते हैं।
...
गेथ निगरानी डैशबोर्ड के लिए, [इस डैशबोर्ड](https://grafana.com/grafana/dashboards/13877/) की आईडी कॉपी करें और इसे ग्रफाना में "आयात पृष्ठ" में पेस्ट करें। डैशबोर्ड को सहेजने के बाद, यह इस तरह दिखना चाहिए:

![](./grafana8.png)

आप अपने डैशबोर्ड को संशोधित कर सकते हैं। प्रत्येक पैनल को संपादित, स्थानांतरित, हटाया या जोड़ा जा सकता है। आप अपने कॉन्फ़िगरेशन बदल सकते हैं। यह आप पर निर्भर है! डैशबोर्ड कैसे काम करते हैं, इसके बारे में अधिक जानने के लिए, [ग्रफाना का प्रलेखन](https://grafana.com/docs/grafana/latest/dashboards/) देखें।
