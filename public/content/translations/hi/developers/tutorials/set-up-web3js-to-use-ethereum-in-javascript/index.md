...
इस ट्यूटोरियल में, हम देखेंगे कि एथेरियम ब्लॉकचेन के साथ इंटरैक्ट करने के लिए [web3.js](https://web3js.readthedocs.io/) के साथ कैसे शुरुआत करें। वेब3.जेएस का उपयोग फ्रंटएंड और बैकएंड दोनों में ब्लॉकचेन से डेटा पढ़ने या लेनदेन करने और यहां तक कि स्मार्ट अनुबंध डिप्लॉय करने के लिए भी किया जा सकता है।
...
फिर वेब3.जेएस को नोड.जेएस स्क्रिप्ट या Browserify फ्रंटएंड प्रोजेक्ट में आयात करने के लिए, आप जावास्क्रिप्ट की निम्न पंक्ति का उपयोग कर सकते हैं:

```js
const Web3 = require("web3")
```

अब जब हमने प्रोजेक्ट में लाइब्रेरी को शामिल कर लिया है तो हमें इसे शुरू करने की आवश्यकता है। आपके प्रोजेक्ट को ब्लॉकचेन के साथ संचार करने में सक्षम होना चाहिए। अधिकांश एथेरियम लाइब्रेरी RPC कॉल के माध्यम से [नोड](/developers/docs/nodes-and-clients/) के साथ संचार करती हैं। हमारे वेब3 प्रदाता को शुरू करने के लिए, हम प्रदाता के URL को कंस्ट्रक्टर के रूप में पास करके एक वेब3 इंस्टेंस को इंस्टैंशिएट करेंगे। यदि आपके कंप्यूटर पर कोई नोड या [गनाचे इंस्टेंस चल रहा है](https://ethereumdev.io/testing-your-smart-contract-with-existing-protocols-ganache-fork/), तो यह इस तरह दिखेगा:
...
यह परीक्षण करने के लिए कि हमने अपने वेब3 इंस्टेंस को सही ढंग से कॉन्फ़िगर किया है, हम `getBlockNumber` फ़ंक्शन का उपयोग करके नवीनतम ब्लॉक नंबर प्राप्त करने का प्रयास करेंगे। यह फ़ंक्शन एक पैरामीटर के रूप में कॉलबैक स्वीकार करता है और एक पूर्णांक के रूप में ब्लॉक नंबर लौटाता है।
...
आप [आधिकारिक web3.js प्रलेखन](https://docs.web3js.org/) में वेब3 इंस्टेंस पर उपलब्ध सभी फ़ंक्शन देख सकते हैं।
...
[ईथर्स.जेएस](https://docs.ethers.io/) जैसे web3.js के विकल्प मौजूद हैं और आमतौर पर उपयोग किए जाते हैं। अगले ट्यूटोरियल में हम देखेंगे कि [ब्लॉकचेन पर नए आने वाले ब्लॉकों को आसानी से कैसे सुनें और देखें कि उनमें क्या है](https://ethereumdev.io/listening-to-new-transactions-happening-on-the-blockchain/)।
