...
यहां, एक इंटरफ़ेस के रूप में प्रस्तुत किया गया है, वे फ़ंक्शन हैं जिन्हें एक ERC-20 को लागू करना होगा। यदि आप सुनिश्चित नहीं हैं कि एक इंटरफ़ेस क्या है: [सॉलिडिटी में OOP प्रोग्रामिंग](https://ethereumdev.io/inheritance-in-solidity-contracts-are-classes/) पर हमारा लेख देखें।
...
ERC-20 टोकन मानक का एक और उत्कृष्ट कार्यान्वयन [ओपनज़ेपेलिन ERC-20 कार्यान्वयन](https://github.com/OpenZeppelin/openzeppelin-contracts/tree/master/contracts/token/ERC20) है।
