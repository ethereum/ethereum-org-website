...
description: "टोकन के साथ इंटरैक्ट करते समय ध्यान रखने योग्य बातों की एक चेकलिस्ट"
author: "Trailofbits"
lang: hi
tags: ["Solidity", "स्मार्ट अनुबंध", "सुरक्षा", "टोकन"]
skill: intermediate
breadcrumb: "टोकन एकीकरण"
...
सुविधा के लिए, सभी स्लिथर [यूटिलिटीज़](https://github.com/crytic/slither#tools) को सीधे किसी टोकन पते पर चलाया जा सकता है, जैसे:

[स्लिथर ट्यूटोरियल का उपयोग करना](/developers/tutorials/how-to-use-slither-to-find-smart-contract-bugs/)
...
- **आपने डेवलपर्स से संपर्क किया है।** आपको किसी घटना के बारे में उनकी टीम को सचेत करने की आवश्यकता हो सकती है। [blockchain-security-contacts](https://github.com/crytic/blockchain-security-contacts) पर उपयुक्त संपर्कों की तलाश करें।
...
स्लिथर में एक यूटिलिटी, [slither-check-erc](https://github.com/crytic/slither/wiki/ERC-Conformance) शामिल है, जो कई संबंधित ERC मानकों के प्रति टोकन की अनुरूपता की समीक्षा करती है। यह समीक्षा करने के लिए slither-check-erc का उपयोग करें कि:
...
- **टोकन ज्ञात [ERC-20 रेस कंडीशन](https://github.com/ethereum/EIPs/issues/20#issuecomment-263524729) को कम करता है।** ERC-20 मानक में एक ज्ञात ERC-20 रेस कंडीशन है जिसे हमलावरों को टोकन चुराने से रोकने के लिए कम किया जाना चाहिए।
...
स्लिथर में एक यूटिलिटी, [slither-prop](https://github.com/crytic/slither/wiki/Property-generation) शामिल है, जो यूनिट परीक्षण और सुरक्षा गुण उत्पन्न करती है जो कई सामान्य ERC खामियों की खोज कर सकती है। यह समीक्षा करने के लिए slither-prop का उपयोग करें कि:

- **अनुबंध slither-prop से सभी यूनिट परीक्षणों और सुरक्षा गुणों को पास करता है।** उत्पन्न यूनिट परीक्षण चलाएं, फिर [एकिड्ना](https://github.com/crytic/echidna) और [मैन्टिकोर](https://manticore.readthedocs.io/en/latest/verifier.html) के साथ गुणों की जांच करें।
...
- **अनुबंध अनावश्यक जटिलता से बचता है।** टोकन एक सरल अनुबंध होना चाहिए; जटिल कोड वाले टोकन के लिए उच्च स्तर की समीक्षा की आवश्यकता होती है। जटिल कोड की पहचान करने के लिए स्लिथर के [human-summary printer](https://github.com/crytic/slither/wiki/Printer-documentation#human-summary) का उपयोग करें।
...
- **अनुबंध में केवल कुछ गैर-टोकन-संबंधित फ़ंक्शंस हैं।** गैर-टोकन-संबंधित फ़ंक्शंस अनुबंध में किसी समस्या की संभावना को बढ़ाते हैं। अनुबंध में उपयोग किए गए कोड की व्यापक रूप से समीक्षा करने के लिए स्लिथर के [contract-summary printer](https://github.com/crytic/slither/wiki/Printer-documentation#contract-summary) का उपयोग करें।
- **टोकन का केवल एक पता है।** बैलेंस अपडेट के लिए कई प्रवेश बिंदुओं वाले टोकन पते के आधार पर आंतरिक बहीखाता (bookkeeping) को तोड़ सकते हैं (उदा., `balances[token_address][msg.sender]` वास्तविक बैलेंस को नहीं दर्शा सकता है)।

## मालिक के विशेषाधिकार {#owner-privileges}

- **टोकन अपग्रेड करने योग्य नहीं है।** अपग्रेड करने योग्य अनुबंध समय के साथ अपने नियम बदल सकते हैं। यह निर्धारित करने के लिए कि क्या अनुबंध अपग्रेड करने योग्य है, स्लिथर के [human-summary printer](https://github.com/crytic/slither/wiki/Printer-documentation#contract-summary) का उपयोग करें।
- **मालिक के पास सीमित मिंटिंग क्षमताएं हैं।** दुर्भावनापूर्ण या समझौता किए गए (compromised) मालिक मिंटिंग क्षमताओं का दुरुपयोग कर सकते हैं। मिंटिंग क्षमताओं की समीक्षा करने के लिए स्लिथर के [human-summary printer](https://github.com/crytic/slither/wiki/Printer-documentation#contract-summary) का उपयोग करें, और कोड की मैन्युअल रूप से समीक्षा करने पर विचार करें।
...
## टोकन की कमी (Scarcity) {#token-scarcity}
