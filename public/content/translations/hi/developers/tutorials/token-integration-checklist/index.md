...
सुविधा के लिए, सभी स्लिदर [यूटिलिटीज़](https://github.com/crytic/slither#tools) को सीधे टोकन पते पर चलाया जा सकता है, जैसे:

[स्लिदर का उपयोग करने वाला ट्यूटोरियल](/developers/tutorials/how-to-use-slither-to-find-smart-contract-bugs/)

```bash
slither-check-erc 0xdac17f958d2ee523a2206206994597c13d831ec7 TetherToken
```

इस चेकलिस्ट का पालन करने के लिए, आप टोकन के लिए स्लिदर से यह आउटपुट प्राप्त करना चाहेंगे:
...
स्लिदर में एक यूटिलिटी, [slither-check-erc](https://github.com/crytic/slither/wiki/ERC-Conformance) शामिल है, जो कई संबंधित ERC मानकों के लिए एक टोकन की अनुरूपता की समीक्षा करता है। यह समीक्षा करने के लिए slither-check-erc का उपयोग करें कि:
...
स्लिदर में एक यूटिलिटी, [slither-prop](https://github.com/crytic/slither/wiki/Property-generation) शामिल है, जो यूनिट टेस्ट और सुरक्षा गुण उत्पन्न करता है जो कई सामान्य ERC खामियों को खोज सकता है। यह समीक्षा करने के लिए slither-prop का उपयोग करें कि:

- **अनुबंध slither-prop से सभी यूनिट परीक्षणों और सुरक्षा गुणों को पास करता है।** उत्पन्न यूनिट परीक्षण चलाएं, फिर [एकिड्ना](https://github.com/crytic/echidna) और [मैंटिकोर](https://manticore.readthedocs.io/en/latest/verifier.html) के साथ गुणों की जांच करें।
...
- **अनुबंध अनावश्यक जटिलता से बचता है।** टोकन एक साधारण अनुबंध होना चाहिए; जटिल कोड वाले टोकन के लिए उच्च मानक की समीक्षा की आवश्यकता होती है। जटिल कोड की पहचान करने के लिए स्लिदर के [ह्यूमन-समरी प्रिंटर](https://github.com/crytic/slither/wiki/Printer-documentation#human-summary) का उपयोग करें।
...
- **टोकन अपग्रेड करने योग्य नहीं है।** अपग्रेड करने योग्य अनुबंध समय के साथ अपने नियम बदल सकते हैं। यह निर्धारित करने के लिए कि क्या अनुबंध अपग्रेड करने योग्य है, स्लिदर के [ह्यूमन-समरी प्रिंटर](https://github.com/crytic/slither/wiki/Printer-documentation#contract-summary) का उपयोग करें।
- **मालिक के पास सीमित मिंटिंग क्षमताएं हैं।** दुर्भावनापूर्ण या समझौता किए गए मालिक मिंटिंग क्षमताओं का दुरुपयोग कर सकते हैं। मिंटिंग क्षमताओं की समीक्षा के लिए स्लिदर के [ह्यूमन-समरी प्रिंटर](https://github.com/crytic/slither/wiki/Printer-documentation#contract-summary) का उपयोग करें, और कोड की मैन्युअल रूप से समीक्षा करने पर विचार करें।
