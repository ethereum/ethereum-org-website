---
title: "एनएफटी मिन्टर ट्यूटोरियल"
description: "इस ट्यूटोरियल में, आप एक एनएफटी मिन्टर बनाएँगे और मेटामास्क व वेब3 टूल का उपयोग करके अपने स्मार्ट अनुबंध को रिएक्ट फ्रंटएंड से जोड़कर एक पूर्ण स्टैक डैप बनाना सीखेंगे।"
author: "smudgil"
tags:
  [
    "Solidity",
...
इस ट्यूटोरियल में, हम अपने फ्रंटएंड फ्रेमवर्क के रूप में [रिएक्ट](https://react.dev/) का उपयोग करेंगे। क्योंकि यह ट्यूटोरियल मुख्य रूप से वेब3 विकास पर केंद्रित है, हम रिएक्ट की बुनियादी बातों को समझने में ज्यादा समय नहीं बिताएँगे। इसके बजाय, हम अपने प्रोजेक्ट में कार्यक्षमता लाने पर ध्यान केंद्रित करेंगे।

एक पूर्वापेक्षा के रूप में, आपको रिएक्ट की शुरुआती स्तर की समझ होनी चाहिए—पता होना चाहिए कि कंपोनेंट्स, प्रॉप्स, useState/useEffect, और बेसिक फंक्शन कॉलिंग कैसे काम करते हैं। यदि आपने पहले इनमें से किसी भी शब्द के बारे में नहीं सुना है, तो आप इस [रिएक्ट ट्यूटोरियल का परिचय](https://react.dev/learn/tutorial-tic-tac-toe) देख सकते हैं। अधिक विज़ुअल शिक्षार्थियों के लिए, हम नेट निंजा द्वारा इस उत्कृष्ट [पूर्ण आधुनिक रिएक्ट ट्यूटोरियल](https://www.youtube.com/playlist?list=PL4cUxeGkcC9gZD-Tvwfod2gaISzfRiP9d) वीडियो श्रृंखला की अत्यधिक अनुशंसा करते हैं।

और अगर आपके पास पहले से नहीं है, तो आपको इस ट्यूटोरियल को पूरा करने और ब्लॉकचेन पर कुछ भी बनाने के लिए निश्चित रूप से एक अल्केमी खाते की आवश्यकता होगी। [यहां](https://alchemy.com/) एक निःशुल्क खाते के लिए साइन अप करें।

बिना किसी और देरी के, चलिए शुरू करते हैं!

## एनएफटीज़ बनाना 101 {#making-nfts-101}
...
### एथेरियम ब्लॉकचेन पर एक एनएफटी स्मार्ट अनुबंध प्रकाशित करें {#publish-nft}
...
एक एनएफटी का मेटाडेटा वास्तव में वही है जो इसे जीवंत करता है, जिससे इसमें नाम, विवरण, छवि (या अलग डिजिटल संपत्ति), और अन्य विशेषताओं जैसे गुण होते हैं। यहाँ [tokenURI का एक उदाहरण](https://gateway.pinata.cloud/ipfs/QmSvBcb4tjdFpajGJhbFAWeK3JAxCdNQLQtr6ZdiSi42V2) है, जिसमें एनएफटी का मेटाडेटा है।
...
इस ट्यूटोरियल में हम जिस ERC-721 एनएफटी स्मार्ट अनुबंध को कॉल करेंगे, उसका [लिंक यहाँ है](https://www.alchemy.com/docs/how-to-create-an-nft)। यदि आप यह जानना चाहते हैं कि हमने इसे कैसे बनाया, तो हम आपको हमारे दूसरे ट्यूटोरियल, [\"एक एनएफटी कैसे बनाएँ\"](https://www.alchemy.com/docs/how-to-create-an-nft) को देखने की अत्यधिक अनुशंसा करते हैं।
...
सबसे पहले, इस प्रोजेक्ट के लिए स्टार्टर फाइलें प्राप्त करने के लिए [nft-minter-tutorial गिटहब रिपॉजिटरी](https://github.com/alchemyplatform/nft-minter-tutorial) पर जाएं। इस रिपॉजिटरी को अपने स्थानीय परिवेश में क्लोन करें।
...
ऐसा करने से आपके ब्राउज़र में http://localhost:3000/ खुल जाना चाहिए, जहाँ आप हमारे प्रोजेक्ट के लिए फ्रंटएंड देखेंगे। इसमें 3 फ़ील्ड होने चाहिए: आपके एनएफटी की संपत्ति के लिए एक लिंक इनपुट करने की जगह, आपके एनएफटी का नाम दर्ज करें, और एक विवरण प्रदान करें।
...
रिएक्ट स्थिति चर या स्थिति हुक के बारे में कभी नहीं सुना? [इन](https://legacy.reactjs.org/docs/hooks-state.html) दस्तावेज़ों को देखें।
...
इस ट्यूटोरियल के लिए, हम मेटामास्क का उपयोग करेंगे, जो ब्राउज़र में एक वर्चुअल वॉलेट है जिसका उपयोग आपके एथेरियम खाते के पते को प्रबंधित करने के लिए किया जाता है। यदि आप एथेरियम पर लेनदेन कैसे काम करते हैं, इसके बारे में और समझना चाहते हैं, तो [इस पृष्ठ](/developers/docs/transactions/) को देखें।

आप [यहां](https://metamask.io/download) मुफ्त में मेटामास्क खाता डाउनलोड और बना सकते हैं। जब आप एक खाता बना रहे हों, या यदि आपके पास पहले से ही एक खाता है, तो ऊपरी दाएँ कोने में “रोपस्टेन टेस्ट नेटवर्क” पर स्विच करना सुनिश्चित करें (ताकि हम वास्तविक धन के साथ काम न करें)।

### एक फोसेट से ईथर जोड़ें {#add-ether-from-faucet}

हमारे एनएफटीज़ को मिंट करने के लिए (या एथेरियम ब्लॉकचेन पर किसी भी लेनदेन पर हस्ताक्षर करने के लिए), हमें कुछ नकली Eth की आवश्यकता होगी। Eth प्राप्त करने के लिए आप [रोपस्टेन फोसेट](https://www.alchemy.com/faucets/ethereum-sepolia) पर जा सकते हैं और अपना रोपस्टेन खाता पता दर्ज कर सकते हैं, फिर “Send रोपस्टेन Eth” पर क्लिक करें। आपको जल्द ही अपने मेटामास्क खाते में Eth दिखना चाहिए!
...
## मेटामास्क को अपने UI से कनेक्ट करें {#connect-metamask-to-your-UI}
...
## एनएफटी मेटाडेटा 101 {#nft-metadata-101}
...
आईपीएफएस पर हमारे मेटाडेटा को संग्रहीत करने के लिए, हम [पिनाटा](https://pinata.cloud/) का उपयोग करेंगे, जो एक सुविधाजनक आईपीएफएस API और टूलकिट है। अगले चरण में, हम ठीक से समझाएंगे कि यह कैसे करना है!

## आईपीएफएस पर अपने मेटाडेटा को पिन करने के लिए पिनाटा का उपयोग करें {#use-pinata-to-pin-your-metadata-to-IPFS}

यदि आपके पास [पिनाटा](https://pinata.cloud/) खाता नहीं है, तो [यहां](https://app.pinata.cloud/auth/signup) एक निःशुल्क खाते के लिए साइन अप करें और अपने ईमेल और खाते को सत्यापित करने के लिए चरणों को पूरा करें।

### अपनी पिनाटा API कुंजी बनाएँ {#create-pinata-api-key}
...
सौभाग्य से, पिनाटा के पास [आईपीएफएस पर JSON डेटा अपलोड करने के लिए विशेष रूप से एक API](https://docs.pinata.cloud/api-reference/endpoint/ipfs/pin-json-to-ipfs#pin-json) है और axios के साथ एक सुविधाजनक जावास्क्रिप्ट उदाहरण है जिसका हम कुछ मामूली संशोधनों के साथ उपयोग कर सकते हैं।
...
जैसा कि हमने पहले उल्लेख किया है, इस ट्यूटोरियल में हम [इस मौजूदा एनएफटी स्मार्ट अनुबंध](https://www.alchemy.com/docs/how-to-create-an-nft) का उपयोग करेंगे; हालाँकि, यदि आप यह जानना चाहते हैं कि हमने इसे कैसे बनाया, या खुद एक बनाना चाहते हैं, तो हम आपको हमारे दूसरे ट्यूटोरियल, [\"एक एनएफटी कैसे बनाएँ\"](https://www.alchemy.com/docs/how-to-create-an-nft) को देखने की अत्यधिक अनुशंसा करते हैं।
...
### अपनी अल्केमी API कुंजी बनाएँ {#create-alchemy-api}

यदि आपके पास पहले से अल्केमी खाता नहीं है, तो [यहां निःशुल्क साइन अप करें।](https://alchemy.com/?a=eth-org-nft-minter)
...
अब जब हमारे पास हमारा अनुबंध ABI और हमारी अल्केमी API कुंजी है, तो हम [अल्केमी वेब3](https://github.com/alchemyplatform/alchemy-web3) का उपयोग करके अपना स्मार्ट अनुबंध लोड करने के लिए तैयार हैं।

### अपना अल्केमी वेब3 एंडपॉइंट और अनुबंध सेट अप करें {#setup-alchemy-endpoint}

सबसे पहले, यदि आपके पास यह पहले से नहीं है, तो आपको टर्मिनल में होम डायरेक्टरी `nft-minter-tutorial` पर नेविगेट करके [अल्केमी वेब3](https://github.com/alchemyplatform/alchemy-web3) इंस्टॉल करना होगा:
...
### मेटाडेटा को आईपीएफएस पर अपलोड करें {#upload-metadata-to-ipfs}
...
try {
  ...
  return {
    success: true,
    status:
      "✅ Etherscan पर अपने लेनदेन की जाँच करें: https://sepolia.etherscan.io/tx/" +
      txHash,
  }
} catch (error) {
  return {
...
## अपने एनएफटी को एक लाइव वेबसाइट पर तैनात करें {#deploy-your-NFT}
...
संभवतः, आप अपने वॉलेट में अपने डैप के माध्यम से बनाए गए एनएफटीज़ को दिखाने में सक्षम होना चाहेंगे - इसलिए हमारे त्वरित ट्यूटोरियल [अपने वॉलेट में अपना एनएफटी कैसे देखें](https://www.alchemy.com/docs/how-to-view-your-nft-in-your-mobile-wallet) को देखना सुनिश्चित करें!

और, हमेशा की तरह, यदि आपके कोई प्रश्न हैं, तो हम [अल्केमी डिस्कॉर्ड](https://discord.gg/gWuC7zB) में मदद के लिए यहाँ हैं। हम यह देखने के लिए इंतजार नहीं कर सकते कि आप इस ट्यूटोरियल से अवधारणाओं को अपनी भविष्य की परियोजनाओं पर कैसे लागू करते हैं!
