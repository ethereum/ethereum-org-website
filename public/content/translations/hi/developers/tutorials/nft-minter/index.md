...
### मिंटिंग फंक्शन को कॉल करें {#minting-function}

आमतौर पर, इस मिंटिंग फंक्शन में आपको पैरामीटर के रूप में दो वेरिएबल पास करने की आवश्यकता होती है, पहला `recipient`, जो उस पते को निर्दिष्ट करता है जो आपके ताज़ा मिंट किए गए NFT को प्राप्त करेगा, और दूसरा NFT का `tokenURI`, एक स्ट्रिंग जो NFT के मेटाडेटा का वर्णन करने वाले JSON दस्तावेज़ को रिज़ॉल्व करती है।
...
इस ट्यूटोरियल में, हम भाग 2 पर ध्यान केंद्रित करने जा रहे हैं, जो हमारे React UI का उपयोग करके मौजूदा NFT के स्मार्ट अनुबंध मिंटिंग फंक्शन को कॉल करना है।

इस ट्यूटोरियल में हम जिस ERC-721 NFT स्मार्ट अनुबंध को कॉल करेंगे, उसका [लिंक यहाँ है](https://ropsten.etherscan.io/address/0x4C4a07F737Bf57F6632B6CAB089B78f62385aCaE)। यदि आप यह सीखना चाहते हैं कि हमने इसे कैसे बनाया, तो हम अत्यधिक अनुशंसा करते हैं कि आप हमारा दूसरा ट्यूटोरियल, ["How to Create an NFT"](https://www.alchemy.com/docs/how-to-create-an-nft) देखें।
...
### मेटामास्क (MetaMask) डाउनलोड करें {#download-metamask}

इस ट्यूटोरियल के लिए, हम मेटामास्क का उपयोग करेंगे, जो आपके इथेरियम खाता पते को प्रबंधित करने के लिए ब्राउज़र में उपयोग किया जाने वाला एक वर्चुअल वॉलेट है। यदि आप इस बारे में अधिक समझना चाहते हैं कि इथेरियम पर लेन-देन कैसे काम करता है, तो [इस पेज](/developers/docs/transactions/) को देखें।

आप [यहाँ](https://metamask.io/download) मुफ़्त में मेटामास्क खाता डाउनलोड और बना सकते हैं। जब आप एक खाता बना रहे हों, या यदि आपके पास पहले से एक खाता है, तो सुनिश्चित करें कि ऊपर दाईं ओर "Ropsten Test Network" पर स्विच करें \(ताकि हम असली पैसे से लेन-देन न कर रहे हों\)।

### फॉसेट से ईथर जोड़ें {#add-ether-from-faucet}

हमारे NFT को मिंट करने (या इथेरियम ब्लॉकचेन पर किसी भी लेन-देन पर हस्ताक्षर करने) के लिए, हमें कुछ नकली ETH की आवश्यकता होगी। ETH प्राप्त करने के लिए आप [रॉप्स्टन फॉसेट](https://faucet.ropsten.be/) पर जा सकते हैं और अपना रॉप्स्टन खाता पता दर्ज कर सकते हैं, फिर "Send Ropsten Eth" पर क्लिक करें। आपको जल्द ही अपने मेटामास्क खाते में ETH दिखाई देना चाहिए!

### अपना बैलेंस जांचें {#check-your-balance}

यह दोबारा जांचने के लिए कि हमारा बैलेंस वहाँ है, आइए [Alchemy के कंपोज़र टूल](https://composer.alchemyapi.io/?composer_state=%7B%22network%22%3A0%2C%22methodName%22%3A%22eth_getBalance%22%2C%22paramValues%22%3A%5B%22%22%2C%22latest%22%5D%7D) का उपयोग करके एक [eth_getBalance](https://docs.alchemyapi.io/alchemy/documentation/alchemy-api-reference/json-rpc#eth_getbalance) अनुरोध करें। यह हमारे वॉलेट में ETH की मात्रा लौटाएगा। अपना मेटामास्क खाता पता इनपुट करने और "Send Request" पर क्लिक करने के बाद, आपको इस तरह की प्रतिक्रिया दिखाई देनी चाहिए:
...
फ़्यू! हमारा नकली पैसा सब वहीं है! <Emoji text=":money_mouth_face:" size={1} />
...
एक बार जब आप एक Alchemy खाता बना लेते हैं, तो आप एक ऐप बनाकर एक API कुंजी उत्पन्न कर सकते हैं। यह हमें रॉप्स्टन टेस्ट नेटवर्क पर अनुरोध करने की अनुमति देगा।

नेव बार में "Apps" पर होवर करके और "Create App" पर क्लिक करके अपने Alchemy डैशबोर्ड में "Create App" पेज पर नेविगेट करें।

अपने ऐप को नाम दें हमने "My First NFT!" चुना है, एक संक्षिप्त विवरण प्रदान करें, अपने ऐप बहीखाता (bookkeeping) के लिए उपयोग किए जाने वाले वातावरण के लिए "Staging" चुनें, और अपने नेटवर्क के लिए "Ropsten" चुनें।
...
अब जब हमारे पास अपना अनुबंध ABI और हमारी Alchemy API कुंजी है, तो हम [Alchemy Web3](https://github.com/alchemyplatform/alchemy-web3) का उपयोग करके अपने स्मार्ट अनुबंध को लोड करने के लिए तैयार हैं।
...
## अपने NFT को लाइव वेबसाइट पर तैनात करें {#deploy-your-nft}

क्या आप उपयोगकर्ताओं के इंटरैक्ट करने के लिए अपने प्रोजेक्ट को लाइव करने के लिए तैयार हैं? अपने मिंटर को लाइव वेबसाइट पर तैनात करने के लिए [इस ट्यूटोरियल](https://docs.alchemy.com/alchemy/tutorials/nft-minter/how-do-i-deploy-nfts-online) को देखें।
...
संभवतः, आप अपने वॉलेट में अपने विकेंद्रीकृत एप्लिकेशन (dapp) के माध्यम से मिंट किए गए NFT को दिखाना चाहेंगे — इसलिए हमारा त्वरित ट्यूटोरियल [How to View Your NFT in Your Wallet](https://www.alchemy.com/docs/how-to-view-your-nft-in-your-mobile-wallet) देखना सुनिश्चित करें!
