---
title: "वॉफल लाइब्रेरी के साथ सरल स्मार्ट अनुबंध का परीक्षण"
description: "शुरुआती लोगों के लिए ट्यूटोरियल"
author: एवा कोवाल्स्का
...
- आप एक नया जावास्क्रिप्ट या टाइपस्क्रिप्ट प्रोजेक्ट बना सकते हैं
- आपके पास जावास्क्रिप्ट में परीक्षणों का कुछ बुनियादी अनुभव है
- आपने yarn या npm जैसे कुछ पैकेज मैनेजरों का उपयोग किया है
- आपके पास स्मार्ट अनुबंधों और सॉलिडिटी का बहुत ही बुनियादी ज्ञान है
...
अगला, प्रोजेक्ट रूट डायरेक्टरी में वॉफल कॉन्फ़िगरेशन फ़ाइल बनाएँ - `waffle.json` - और फिर वहाँ निम्नलिखित कॉन्फ़िगरेशन पेस्ट करें:
...
सबसे पहले, हम जांचेंगे कि क्या स्प्लिट विधि वास्तव में रिसीवरों के वॉलेट के बैलेंस को बदलती है। यदि हम प्रेषक के खाते से 50 wei विभाजित करते हैं, तो हम उम्मीद करेंगे कि दोनों रिसीवरों का बैलेंस 25 wei बढ़ जाएगा। हम वॉफल के `changeBalances` मैचर का उपयोग करेंगे:
...
अगला, हम परीक्षण करेंगे कि क्या प्रत्येक wei के ट्रांसफर के बाद ट्रांसफर इवेंट उत्सर्जित हुआ था। हम वॉफल से एक और मैचर की ओर रुख करेंगे:
...
आपने वॉफल के साथ स्मार्ट अनुबंधों के परीक्षण की दिशा में अपना पहला बड़ा कदम उठाया है!
