...
## निष्कर्ष {#conclusion}
इस बिंदु पर, आपको कुछ केंद्रीकरण की कीमत पर अपने विकेंद्रीकृत एप्लिकेशन (dapp) उपयोगकर्ताओं के लिए एक गैस-रहित अनुभव बनाने में सक्षम होना चाहिए।

हालाँकि, यह केवल उन स्मार्ट अनुबंधों के साथ काम करता है जो ERC-712 का समर्थन करते हैं। उदाहरण के लिए, किसी ERC-20 टोकन को ट्रांसफर करने के लिए, यह आवश्यक है कि लेन-देन पर केवल एक संदेश के बजाय मालिक द्वारा हस्ताक्षर किए जाएं। सबसे सरल समाधान यह है कि संपत्तियों का स्वामित्व EOA पते के पास न होकर, एक अलग अनुबंध के पास हो ([खाता अमूर्तन](/roadmap/account-abstraction/) का एक सरल रूप)। आप इसके बारे में [अगले ट्यूटोरियल में](/developers/tutorials/gasless-token) अधिक पढ़ सकते हैं।
