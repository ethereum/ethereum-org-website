...
ध्यान दें कि जब हम [ओपनज़ेपेलिन ERC-20 टोकन अनुबंध](https://github.com/OpenZeppelin/openzeppelin-contracts/tree/master/contracts/token/ERC20) का उपयोग करेंगे, तो यह लेख इसे बहुत विस्तार से नहीं समझाता है। आप यह जानकारी [यहां](/developers/tutorials/erc20-annotated-code) पा सकते हैं।

यदि आप पूरा सोर्स कोड देखना चाहते हैं:

1. [रीमिक्स IDE](https://remix.ethereum.org/) खोलें।
...
इससे पहले कि हम सेफ्टी रेल कार्यक्षमता जोड़ सकें, हमें एक ERC-20 अनुबंध की आवश्यकता है। इस लेख में हम [the ओपनज़ेपेलिन Contracts Wizard](https://docs.openzeppelin.com/contracts/5.x/wizard) का उपयोग करेंगे। इसे दूसरे ब्राउज़र में खोलें और इन निर्देशों का पालन करें:
...
5. यह देखने के लिए अनुबंध को संकलित करें, डिप्लॉय करें और उसके साथ प्रयोग करें कि यह एक ERC-20 अनुबंध के रूप में कार्य करता है। अगर आपको रीमिक्स का उपयोग करना सीखना है, तो [इस ट्यूटोरियल का उपयोग करें](https://remix.ethereum.org/?#activate=udapp,solidity,LearnEth)।
