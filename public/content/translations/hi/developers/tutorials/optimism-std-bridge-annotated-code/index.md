...
ऑप्टिमिस्टिक रोलअप, एथेरियम मेननेट (जिसे लेयर 1 या L1 भी कहा जाता है) की तुलना में बहुत कम कीमत पर ट्रांज़ैक्शन को प्रोसेस कर सकते हैं क्योंकि ट्रांज़ैक्शन नेटवर्क पर हर नोड के बजाय केवल कुछ नोड्स द्वारा प्रोसेस किए जाते हैं।
...
इस लेख में हम उस ब्रिज के सोर्स कोड पर जाते हैं यह देखने के लिए कि यह कैसे काम करता है और अच्छी तरह से लिखे गए सॉलिडिटी कोड के उदाहरण के रूप में इसका अध्ययन करते हैं।
...
[ऑप्टिमिज्म का अधिकांश कोड MIT लाइसेंस के तहत जारी किया गया है](https://github.com/ethereum-optimism/optimism/blob/develop/LICENSE)।

```solidity
pragma solidity >0.5.0 <0.9.0;
```

लिखने के समय सॉलिडिटी का नवीनतम संस्करण 0.8.12 है।
...
क्रॉस डोमेन मैसेजिंग उस ब्लॉकचेन पर किसी भी अनुबंध द्वारा सुलभ है जहां यह चल रहा है (या तो एथेरियम मेननेट या ऑप्टिमिज्म)।
...
[स्लिदर](https://github.com/crytic/slither) एक स्टैटिक एनालाइज़र है जिसे ऑप्टिमिज्म हर अनुबंध पर चलाता है ताकि कमजोरियों और अन्य संभावित समस्याओं की तलाश की जा सके।
...
इंटरफ़ेस अन्य अनुबंधों का हिस्सा हो सकते हैं, इसलिए उन्हें सॉलिडिटी संस्करणों की एक विस्तृत श्रृंखला का समर्थन करना होता है।
लेकिन ब्रिज खुद हमारा अनुबंध है, और हम इस बारे में सख्त हो सकते हैं कि यह किस सॉलिडिटी संस्करण का उपयोग करता है।
...
[ओपनज़ेपेलिन की पता उपयोगिताएँ](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/utils/Address.sol)। इसका उपयोग अनुबंध पतों और बाह्य रूप से स्वामित्व वाले खातों (EOA) से संबंधित पतों के बीच अंतर करने के लिए किया जाता है।
...
यह [स्लिदर परीक्षण](https://github.com/crytic/slither/wiki/Detector-Documentation#public-function-that-could-be-declared-external) उन फ़ंक्शन की पहचान करता है जिन्हें अनुबंध कोड से नहीं बुलाया जाता है और इसलिए उन्हें `public` के बजाय `external` घोषित किया जा सकता है।
...
सॉलिडिटी फ़ंक्शन [`abi.encodeWithSelector`](https://docs.soliditylang.org/en/v0.8.12/units-and-global-variables.html#abi-encoding-and-decoding-functions) उस calldata को बनाता है।
...
[ओपनज़ेपेलिन ERC-20 अनुबंध](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/token/ERC20/ERC20.sol)।
...
`_mint` और `_burn` वास्तव में [ओपनज़ेपेलिन ERC-20 अनुबंध](/developers/tutorials/erc20-annotated-code/#the-_mint-and-_burn-functions-_mint-and-_burn) में परिभाषित हैं।
