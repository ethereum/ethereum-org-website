---
title: "परीक्षण के लिए सॉलिडिटी स्मार्ट अनुबंधों को कैसे मॉक करें"
description: "परीक्षण करते समय आपको अपने अनुबंधों का मज़ाक क्यों उड़ाना चाहिए"
author: मार्कस वास
lang: hi
tags: [ "Solidity", "स्मार्ट अनुबंध", "परिक्षण", "मॉक करना" ]
skill: intermediate
...
हम एक उदाहरण ERC-20 अनुबंध का उपयोग करते हैं जिसमें एक प्रारंभिक निजी समय होता है। मालिक निजी यूज़र को प्रबंधित कर सकता है और शुरुआत में केवल उन्हें ही टोकन प्राप्त करने की अनुमति होगी। एक निश्चित समय बीत जाने के बाद, सभी को टोकन का उपयोग करने की अनुमति होगी। यदि आप उत्सुक हैं, तो हम नए ओपनज़ेपेलिन अनुबंध v3 से [`_beforeTokenTransfer`](https://docs.openzeppelin.com/contracts/5.x/extending-contracts#using-hooks) हुक का उपयोग कर रहे हैं।
...
चूंकि हम नए 0.6 सॉलिडिटी संस्करण का उपयोग कर रहे हैं, इसलिए हमें उन फंक्शन के लिए `virtual` कीवर्ड जोड़ना होगा जिन्हें ओवरराइड किया जा सकता है और ओवरराइडिंग फंक्शन के लिए `override` जोड़ना होगा। तो चलिए इन्हें दोनों `isPublic` फंक्शन में जोड़ते हैं।
