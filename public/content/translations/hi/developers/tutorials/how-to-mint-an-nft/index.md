---
title: "एनएफटी की टकसाल कैसे करें (एनएफटी ट्यूटोरियल सीरीज़ का भाग 2/3)"
description: "यह ट्यूटोरियल बताता है कि हमारे स्मार्ट अनुबंध और वेब3 का उपयोग करके एथेरियम ब्लॉकचेन पर एनएफटी की टकसाल कैसे करें।"
author: "सुमी मुद्गिल"
...
"एनएफटी की टकसाल करना" ब्लॉकचेन पर आपके ERC-721 टोकन के एक अद्वितीय उदाहरण को प्रकाशित करने की प्रक्रिया है। [इस एनएफटी ट्यूटोरियल सीरीज़ के भाग 1](/developers/tutorials/how-to-write-and-deploy-an-nft/) से हमारे स्मार्ट अनुबंध का उपयोग करके, आइए अपने वेब3 कौशल को प्रदर्शित करें और एक एनएफटी की टकसाल करें। इस ट्यूटोरियल के अंत में, आप उतने एनएफटी की टकसाल कर पाएँगे जितने आपका दिल (और वॉलेट) चाहे!

आइए शुरू करते हैं!

## चरण 1: वेब3 इंस्टॉल करें {#install-web3}

यदि आपने अपना एनएफटी स्मार्ट अनुबंध बनाने के लिए पहले ट्यूटोरियल का पालन किया है, तो आपके पास पहले से ही ईथर्स.जेएस का उपयोग करने का अनुभव है। वेब3, Ethers के समान है, क्योंकि यह एक लाइब्रेरी है जिसका उपयोग एथेरियम ब्लॉकचेन से अनुरोध करना आसान बनाने के लिए किया जाता है। इस ट्यूटोरियल में हम [अल्केमी वेब3](https://docs.alchemyapi.io/alchemy/documentation/alchemy-web3) का उपयोग करेंगे, जो एक उन्नत वेब3 लाइब्रेरी है जो स्वचालित री-ट्राई और मजबूत वेबसॉकेट सहायता प्रदान करती है।
...
## चरण 4: आईपीएफएस का उपयोग करके अपने एनएफटी के लिए मेटाडेटा कॉन्फ़िगर करें {#config-meta}
...
> _इंटरप्लेनेटरी फ़ाइल सिस्टम (आईपीएफएस) एक वितरित फ़ाइल सिस्टम में डेटा को संग्रहीत और साझा करने के लिए एक विकेन्द्रीकृत प्रोटोकॉल और पीयर-टू-पीयर नेटवर्क है।_

हम अपने एनएफटी एसेट और मेटाडेटा को स्टोर करने के लिए पिनाटा, एक सुविधाजनक आईपीएफएस API और टूलकिट का उपयोग करेंगे, ताकि यह सुनिश्चित हो सके कि हमारा एनएफटी वास्तव में विकेंद्रीकृत है। यदि आपके पास पिनाटा खाता नहीं है, तो [यहाँ](https://app.pinata.cloud) एक निःशुल्क खाते के लिए साइन अप करें और अपना ईमेल सत्यापित करने के लिए चरणों को पूरा करें।
...
- अपलोड करने के बाद, आप "फ़ाइलें" पेज पर तालिका में फ़ाइल की जानकारी देखेंगे। आपको एक CID कॉलम भी दिखाई देगा। आप इसके आगे वाले कॉपी बटन पर क्लिक करके CID कॉपी कर सकते हैं। आप अपना अपलोड यहाँ देख सकते हैं: `https://gateway.pinata.cloud/ipfs/<CID>`। उदाहरण के लिए, हमारे द्वारा आईपीएफएस पर उपयोग की गई छवि आप [यहाँ](https://gateway.pinata.cloud/ipfs/QmZdd5KYdCFApWn7eTZJ1qgJu18urJrP9Yh1TZcZrZxxB5) देख सकते हैं।

विज़ुअल शिक्षार्थियों के लिए, उपरोक्त चरणों का सारांश यहाँ दिया गया है:

![पिनाटा पर अपनी छवि कैसे अपलोड करें](./instructionsPinata.gif)
...
![अपनी nft-metadata.json को पिनाटा पर कैसे अपलोड करें](./uploadPinata.gif)

## चरण 5: अपने अनुबंध का एक उदाहरण बनाएँ {#instance-contract}

अब, हमारे अनुबंध के साथ इंटरैक्ट करने के लिए, हमें अपने कोड में इसका एक उदाहरण बनाने की आवश्यकता है। ऐसा करने के लिए हमें अपने अनुबंध पते की आवश्यकता होगी जिसे हम डिप्लॉयमेंट से या [ब्लॉकस्काउट](https://eth-sepolia.blockscout.com/) से अनुबंध डिप्लॉय करने के लिए आपके द्वारा उपयोग किए गए पते को देखकर प्राप्त कर सकते हैं।

![ईथरस्कैन पर अपना अनुबंध पता देखें](./view-contract-etherscan.png)

उपरोक्त उदाहरण में, हमारा अनुबंध पता 0x5a738a5c5fe46a1fd5ee7dd7e38f722e2aef7778 है।

इसके बाद हम ABI और पते का उपयोग करके अपना अनुबंध बनाने के लिए वेब3 [अनुबंध विधि](https://docs.web3js.org/api/web3-eth-contract/class/Contract) का उपयोग करेंगे। अपनी `mint-nft.js` फ़ाइल में, निम्नलिखित जोड़ें:
...
![पिनाटा पर अपना nft मेटाडेटा हैशकोड कैसे प्राप्त करें](./metadataPinata.gif)_Pinata पर अपना nft मेटाडेटा हैशकोड कैसे प्राप्त करें_
...
इसके बाद, अपने लेनदेन की स्थिति देखने के लिए अपने [अल्केमी मेमपूल](https://dashboard.alchemyapi.io/mempool) पर जाएँ (चाहे वह लंबित हो, माइन किया गया हो, या नेटवर्क द्वारा ड्रॉप कर दिया गया हो)। यदि आपका लेनदेन ड्रॉप हो गया है, तो [ब्लॉकस्काउट](https://eth-sepolia.blockscout.com/) की जाँच करना और अपने लेनदेन हैश को खोजना भी सहायक है।

![ईथरस्कैन पर अपना एनएफटी लेनदेन हैश देखें](./view-nft-etherscan.png)_Etherscan पर अपना एनएफटी लेनदेन हैश देखें_

और बस हो गया! अब आपने एथेरियम ब्लॉकचेन पर एक एनएफटी डिप्लॉय और उसकी टकसाल कर ली है <Emoji text=":money_mouth_face:" size={1} />
...
संभवतः, आप अपने वॉलेट में अपना एनएफटी दिखाना चाहेंगे — तो [भाग 3: अपने वॉलेट में अपना एनएफटी कैसे देखें](/developers/tutorials/how-to-view-nft-in-metamask/) देखना सुनिश्चित करें!
