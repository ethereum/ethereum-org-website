...
उन सभी ने अल्केमी के शक्तिशाली API का उपयोग करके अपने NFTs की टकसाल की। इस ट्यूटोरियल में, हम आपको सिखाएंगे कि \<10 मिनट में यही कैसे करें।
...
हम अपने एनएफटी एसेट और मेटाडेटा को स्टोर करने के लिए Pinata, एक सुविधाजनक आईपीएफएस API और टूलकिट का उपयोग करेंगे, ताकि यह सुनिश्चित हो सके कि हमारा एनएफटी वास्तव में विकेंद्रीकृत है। यदि आपके पास Pinata खाता नहीं है, तो [यहाँ](https://app.pinata.cloud) एक निःशुल्क खाते के लिए साइन अप करें और अपना ईमेल सत्यापित करने के लिए चरणों को पूरा करें।

एक बार जब आप एक खाता बना लेते हैं:

- "फ़ाइलें" पेज पर जाएँ और पेज के ऊपर-बाईं ओर नीले "अपलोड" बटन पर क्लिक करें।

- Pinata पर एक छवि अपलोड करें — यह आपके एनएफटी के लिए छवि संपत्ति होगी। आप एसेट का जो भी चाहें नाम रख सकते हैं
...
इसके बाद, अपने लेनदेन की स्थिति देखने के लिए अपने [अल्केमी मेमपूल](https://dashboard.alchemyapi.io/mempool) पर जाएँ (चाहे वह लंबित हो, माइन किया गया हो, या नेटवर्क द्वारा ड्रॉप कर दिया गया हो)। यदि आपका लेनदेन ड्रॉप हो गया है, तो [Blockscout](https://eth-sepolia.blockscout.com/) की जाँच करना और अपने लेनदेन हैश को खोजना भी सहायक है।
