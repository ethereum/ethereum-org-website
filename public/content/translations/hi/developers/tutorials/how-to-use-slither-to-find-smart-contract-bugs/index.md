---
title: "स्मार्ट अनुबंध बग खोजने के लिए स्लिदर का उपयोग कैसे करें"
description: "स्मार्ट अनुबंधों में स्वचालित रूप से बग खोजने के लिए स्लिथर का उपयोग कैसे करें"
author: Trailofbits
lang: hi
tags: [ "Solidity", "स्मार्ट अनुबंध", "सुरक्षा", "परिक्षण" ]
skill: advanced
...
## स्लिदर का उपयोग कैसे करें {#how-to-use-slither}
...
- [API](#api-basics): पायथन API विवरण
...
डिटेक्टर के अलावा, स्लिदर में अपने [प्रिंटर](https://github.com/crytic/slither#printers) और [उपकरणों](https://github.com/crytic/slither#tools) के माध्यम से कोड समीक्षा की क्षमताएं हैं।

निजी डिटेक्टरों और गिटहब एकीकरण तक पहुंच प्राप्त करने के लिए [crytic.io](https://github.com/crytic) का उपयोग करें।
...
स्लिदर अपने मध्यवर्ती निरूपण (बाद के खंड में चर्चा की गई) के कारण अंतर्निहित [डेटा निर्भरता](https://github.com/crytic/slither/wiki/data-dependency) क्षमताओं के साथ आता है।
...
एक मध्यवर्ती निरूपण (IR) एक ऐसी भाषा है जो मूल भाषा की तुलना में स्टैटिक विश्लेषण के लिए अधिक अनुकूल होती है। स्लिदर सॉलिडिटी को अपने स्वयं के IR में अनुवादित करता है: [SlithIR](https://github.com/crytic/slither/wiki/SlithIR)।
