...
### एथेरियम लोगों के लिए SAML {#saml-for-ethereum-people}
...
### SAML लोगों के लिए एथेरियम {#ethereum-for-saml-people}
...
## एथेरियम हस्ताक्षरों का उपयोग करना {#using-ethereum-signatures}
...
साक्षियाँ प्राप्त करने का सबसे आसान तरीका [ग्राफक्यूएल API](https://docs.attest.org/docs/developer-tools/api) का उपयोग करना है। हम इस क्वेरी का उपयोग करते हैं:
...
- `id`: साक्षी ID। आप इस मान का उपयोग [साक्षी को ऑन-चेन पढ़ने](https://optimism.blockscout.com/address/0x4200000000000000000000000000000000000021?tab=read_proxy&source_address=0x4E0275Ea5a89e7a3c1B58411379D1a0eDdc5b088#0xa3112a64) के लिए कर सकते हैं ताकि यह सत्यापित हो सके कि ग्राफक्यूएल क्वेरी से जानकारी सही है।
