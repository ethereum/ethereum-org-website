...
![ईथरस्कैन से ऑपकोड व्यू](opcode-view.png)
...
2. कॉलडेटा का आकार पढ़ें। आमतौर पर एक एथेरियम कॉन्ट्रैक्ट के लिए कॉल डेटा [ABI (एप्लिकेशन बाइनरी इंटरफ़ेस)](https://docs.soliditylang.org/en/v0.8.10/abi-spec.html) का पालन करता है, जिसके लिए फ़ंक्शन चयनकर्ता के लिए कम से कम चार बाइट्स की आवश्यकता होती है। यदि कॉल डेटा का आकार चार से कम है, तो 0x5E पर जंप करें।
...
| ऑफ़सेट | ऑपकोड      | स्टैक (ऑपकोड के बाद)                                                |
| -----: | ---------- | -------------------------------------------------------------------------------------- |
|     64 | CALLVALUE  | कॉल द्वारा प्रदान किया गया [Wei](/glossary/#wei)। सॉलिडिटी में `msg.value` कहा जाता है |
...
ईथरस्कैन हमें बताता है कि `1C` एक अज्ञात ऑपकोड है, क्योंकि [इसे ईथरस्कैन द्वारा इस सुविधा को लिखने के बाद जोड़ा गया था](https://eips.ethereum.org/EIPS/eip-145) और उन्होंने इसे अपडेट नहीं किया है। एक [अद्यतित ऑपकोड तालिका](https://github.com/wolflo/evm-opcodes) हमें दिखाती है कि यह राइट शिफ्ट है
