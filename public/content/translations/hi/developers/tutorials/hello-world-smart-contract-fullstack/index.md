...
एक बार जब आप एक अल्केमी खाता बना लेते हैं, तो आप एक ऐप बनाकर एक API कुंजी उत्पन्न कर सकते हैं। यह आपको गोअर्ली टेस्टनेट पर अनुरोध करने की अनुमति देगा। यदि आप टेस्टनेट से परिचित नहीं हैं तो आप [एक नेटवर्क चुनने के लिए अल्केमी की गाइड पढ़ सकते हैं](https://www.alchemy.com/docs/choosing-a-web3-network)।
...
अपने ऐप को '_Hello World_' नाम दें और एक संक्षिप्त विवरण लिखें। अपने परिवेश के रूप में **स्टेजिंग** और अपने नेटवर्क के रूप में **गोअर्ली** का चयन करें।

![ऐप व्यू हैलो वर्ल्ड बनाएं](./create-app-view-hello-world.png)

_नोट: **गोअर्ली** का चयन करना सुनिश्चित करें, अन्यथा यह ट्यूटोरियल काम नहीं करेगा।_
...
आप [यहां](https://metamask.io/download) मुफ्त में मेटामास्क खाता डाउनलोड और बना सकते हैं। जब आप एक खाता बना रहे हों, या यदि आपके पास पहले से ही एक खाता है, तो ऊपरी दाएं कोने में "गोअर्ली टेस्ट नेटवर्क" पर स्विच करना सुनिश्चित करें (ताकि हम असली पैसे से काम न कर रहे हों)।

### चरण 4: एक फोसेट से ईथर जोड़ें {#step-4-add-ether-from-a-faucet}

अपने स्मार्ट अनुबंध को टेस्ट नेटवर्क पर डिप्लॉय करने के लिए, आपको कुछ नकली ETH की आवश्यकता होगी। गोअर्ली नेटवर्क पर ETH प्राप्त करने के लिए, गोअर्ली फॉसेट पर जाएं और अपना गोअर्ली खाता पता दर्ज करें। ध्यान दें कि गोअर्ली फॉसेट हाल ही में थोड़े अविश्वसनीय हो सकते हैं - आज़माने के लिए विकल्पों की सूची के लिए [टेस्ट नेटवर्क पेज](/developers/docs/networks/#goerli) देखें:
...
यदि हम [गोअर्ली etherscan](https://goerli.etherscan.io) पर जाते हैं और अपने अनुबंध पते की खोज करते हैं तो हमें यह देखने में सक्षम होना चाहिए कि इसे सफलतापूर्वक डिप्लॉय किया गया है। लेनदेन कुछ इस तरह दिखेगा:
...
उस स्क्रिप्ट को चलाते समय, आप देख सकते हैं कि नया संदेश लोड होने से पहले `Updating the message...` चरण लोड होने में कुछ समय लगता है। यह खनन प्रक्रिया के कारण है; यदि आप लेन-देन को ट्रैक करने के बारे में उत्सुक हैं, जबकि वे खनन किए जा रहे हैं, तो लेन-देन की स्थिति देखने के लिए [अल्केमी mempool](https://dashboard.alchemyapi.io/mempool) पर जाएं। यदि लेन-देन गिरा दिया जाता है, तो [गोअर्ली ईथरस्कैन](https://goerli.etherscan.io) की जाँच करना और अपने लेन-देन हैश की खोज करना भी सहायक होता है।
...
सुनिश्चित करें कि `DEPLOYED_CONTRACT_ADDRESS` गोअर्ली टेस्ट नेटवर्क पर आपके डिप्लॉयड स्मार्ट अनुबंध का पता है। इसके अलावा, अंतिम तर्क (`'Hello World!'`) वही स्ट्रिंग मान होना चाहिए जिसका उपयोग [भाग 1 में डिप्लॉय चरण के दौरान](#write-our-deploy-script) किया गया था।
