---
title: "द ग्राफ: वेब3 डेटा क्वेरी को ठीक करना"
description: "ब्लॉकचेन एक डेटाबेस की तरह है लेकिन SQL के बिना। सारा डेटा वहीं है, लेकिन इसे एक्सेस करने का कोई तरीका नहीं है। आइए मैं आपको दिखाता हूं कि द ग्राफ़ और ग्राफक्यूएल के साथ इसे कैसे ठीक किया जाए।"
author: मार्कस वास
lang: hi
tags:
  [
...
हम दाईं ओर दिखाए गए अनुसार [वेब3 में इवेंट](https://docs.web3js.org/api/web3/class/Contract#events) को सुन सकते हैं, लेकिन इसके लिए कुछ मामलों को संभालने की आवश्यकता होती है।
...
## मैं आपको ग्राफक्यूएल से परिचित कराता हूँ {#let-me-introduce-to-you-graphql}
...
![ग्राफक्यूएल API बनाम REST API](./graphql.jpg)

![](./graphql-query.gif)

दो छवियां काफी हद तक ग्राफक्यूएल के सार को दर्शाती हैं। दाईं ओर की क्वेरी के साथ हम ठीक से परिभाषित कर सकते हैं कि हमें कौन सा डेटा चाहिए, इसलिए वहां हम एक ही अनुरोध में सब कुछ प्राप्त करते हैं और ठीक वही जो हमें चाहिए उससे ज्यादा कुछ नहीं। एक ग्राफक्यूएल सर्वर सभी आवश्यक डेटा को फ़ेच करने का काम करता है, इसलिए फ्रंटएंड उपभोक्ता पक्ष के लिए इसका उपयोग करना अविश्वसनीय रूप से आसान है। [यह एक अच्छी व्याख्या है](https://www.apollographql.com/blog/graphql-explained) कि यदि आप रुचि रखते हैं तो सर्वर वास्तव में क्वेरी को कैसे संभालता है।
...
सुविधा के कारणों से आप मूंछ जैसे टेम्पलेट टूल का भी उपयोग करना चाह सकते हैं। फिर आप एक `subgraph.template.yaml` बनाते हैं और नवीनतम परिनियोजनों के आधार पर पते डालते हैं। एक अधिक उन्नत उदाहरण सेटअप के लिए, उदाहरण के लिए [आवे सबग्राफ रेपो](https://github.com/aave/aave-protocol/tree/master/thegraph) देखें।
...
ग्राफक्यूएल नए आने वाले इवेंट्स के लिए भी स्ट्रीम का समर्थन करता है। ये ग्राफ पर [सबस्ट्रीम](https://thegraph.com/docs/en/substreams/) के माध्यम से समर्थित हैं जो वर्तमान में ओपन बीटा में हैं।
