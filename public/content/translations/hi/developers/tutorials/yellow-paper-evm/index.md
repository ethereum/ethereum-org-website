...
शायद इन्हीं कारणों से, नए [कन्सेंसस लेयर स्पेक्स](https://github.com/ethereum/consensus-specs/blob/dev/tests/core/pyspec/README.md) पायथन में लिखे गए हैं। [पायथन में एक्ज़ीक्यूशन लेयर स्पेक्स](https://ethereum.github.io/execution-specs) हैं, लेकिन वे पूर्ण नहीं हैं। जब तक और जब तक पूरे येलो पेपर का पायथन या इसी तरह की भाषा में अनुवाद नहीं किया जाता, तब तक येलो पेपर सेवा में रहेगा, और इसे पढ़ने में सक्षम होना सहायक है।
