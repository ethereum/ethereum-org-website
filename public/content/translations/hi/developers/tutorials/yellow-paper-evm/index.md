...
## 9 निष्पादन मॉडल (Execution model) {#9-execution-model}
...
## 9.4.2 असाधारण हॉल्टिंग (Exceptional Halting) {#942-exceptional-halt}
...
## 9.4.3 जंप डेस्टिनेशन की वैधता (Jump Destination Validity) {#943-jump-dest-valid}
...
## H.2 निर्देश सेट (Instruction set) {#h2-instruction-set}
...
## 9.5 निष्पादन चक्र (The execution cycle) {#95-exec-cycle}
