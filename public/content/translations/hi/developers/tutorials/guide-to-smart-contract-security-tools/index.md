...
- **[स्लिदर](/developers/tutorials/how-to-use-slither-to-find-smart-contract-bugs/) के साथ स्थैतिक विश्लेषण।** प्रोग्राम के सभी पथों का अनुमान लगाया जाता है और विभिन्न प्रोग्राम प्रस्तुतियों (जैसे, नियंत्रण-प्रवाह-ग्राफ) के माध्यम से एक ही समय में विश्लेषण किया जाता है।
- **[एकिड्ना](/developers/tutorials/how-to-use-echidna-to-test-smart-contracts/) के साथ फ़ज़िंग।** कोड को लेनदेन की छद्म-यादृच्छिक पीढ़ी के साथ निष्पादित किया जाता है। फ़ज़र दी गई संपत्ति का उल्लंघन करने के लिए लेनदेन का एक क्रम खोजने का प्रयास करेगा।
- **[मैंटिकोर](/developers/tutorials/how-to-use-manticore-to-find-smart-contract-bugs/) के साथ प्रतीकात्मक निष्पादन।** एक औपचारिक सत्यापन तकनीक, जो प्रत्येक निष्पादन पथ को एक गणितीय सूत्र में अनुवादित करती है, जिस पर शीर्ष बाधाओं की जाँच की जा सकती है।
...
- **अंकगणितीय संचालन।** अंकगणितीय संचालन की सुदृढ़ता की जाँच करना महत्वपूर्ण है। `SafeMath` का हर जगह उपयोग करना ओवरफ़्लो/अंडरफ़्लो को रोकने के लिए एक अच्छा कदम है, हालांकि, आपको अभी भी अन्य अंकगणितीय खामियों पर विचार करना चाहिए, जिसमें राउंडिंग मुद्दे और अनुबंध को फंसाने वाली खामियां शामिल हैं।
  ...
  - मैंटिकोर यहाँ सबसे अच्छा विकल्प है। एकिड्ना का उपयोग तब किया जा सकता है जब अंकगणित SMT सॉल्वर के दायरे से बाहर हो।

- **विरासत की शुद्धता।** सॉलिडिटी अनुबंध कई विरासतों पर बहुत अधिक निर्भर करते हैं। `super` कॉल से गायब शैडोइंग फ़ंक्शन और गलत व्याख्या किए गए c3 रैखिककरण क्रम जैसी गलतियाँ आसानी से पेश की जा सकती हैं।

  - स्लिदर इन मुद्दों का पता लगाने को सुनिश्चित करने वाला उपकरण है।
...
| एक्सेस कंट्रोल    | स्लिदर, एकिड्ना, मैंटिकोर | [स्लिदर अभ्यास 2](https://github.com/crytic/slither/blob/7f54c8b948c34fb35e1d61adaa1bd568ca733253/docs/src/tutorials/exercise2.md), [एकिड्ना अभ्यास 2](https://github.com/crytic/building-secure-contracts/blob/master/program-analysis/echidna/exercises/Exercise-2.md) |
| अंकगणितीय संचालन  | मैंटिकोर, एकिड्ना          | [एकिड्ना अभ्यास 1](https://github.com/crytic/building-secure-contracts/blob/master/program-analysis/echidna/exercises/Exercise-1.md), [मैंटिकोर अभ्यास 1 - 3](https://github.com/crytic/building-secure-contracts/tree/master/program-analysis/manticore/exercises)      |
| विरासत की शुद्धता | स्लिदर                     | [स्लिदर अभ्यास 1](https://github.com/crytic/slither/blob/7f54c8b948c34fb35e1d61adaa1bd568ca733253/docs/src/tutorials/exercise1.md)                                                                                                                                       |
| बाहरी इंटरैक्शन   | मैंटिकोर, एकिड्ना          |                                                                                                                                                                                                                                                                           |
| मानक अनुरूपता     | स्लिदर, एकिड्ना, मैंटिकोर | [`slither-erc`](https://github.com/crytic/slither/wiki/ERC-Conformance)                                                                                                                                                                                                   |
...
- [बैलेंसर](https://github.com/trailofbits/publications/blob/master/reviews/BalancerCore.pdf)
