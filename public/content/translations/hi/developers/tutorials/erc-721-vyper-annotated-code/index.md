---
title: "वाइपर ERC-721 अनुबंध वॉकथ्रू"
...
[ERC-721](/developers/docs/standards/tokens/erc-721/) मानक का उपयोग नॉन-फंजिबल टोकन (एनएफटी) के स्वामित्व को बनाए रखने के लिए किया जाता है।
...
यह अनुबंध [वाइपर](https://vyper.readthedocs.io/en/latest/index.html) में लिखा गया है, जो एक पायथन-जैसी अनुबंध भाषा है जिसे सॉलिडिटी की तुलना में असुरक्षित कोड लिखना कठिन बनाने के लिए डिज़ाइन किया गया है।
...
वाइपर में टिप्पणियाँ, पायथन की तरह, हैश (`#`) से शुरू होती हैं और लाइन के अंत तक जारी रहती हैं। `@<keyword>` वाली टिप्पणियों का उपयोग [नैटस्पेक](https://vyper.readthedocs.io/en/latest/natspec.html) द्वारा मानव-पठनीय दस्तावेज़ीकरण बनाने के लिए किया जाता है।
...
ERC-721 इंटरफ़ेस वाइपर भाषा में अंतर्निहित है।
[आप कोड परिभाषा यहाँ देख सकते हैं](https://github.com/vyperlang/vyper/blob/master/vyper/builtin_interfaces/ERC721.py)।
इंटरफ़ेस परिभाषा पायथन में लिखी गई है, न कि वाइपर में, क्योंकि इंटरफ़ेस का उपयोग न केवल ब्लॉकचेन के भीतर किया जाता है, बल्कि एक बाहरी क्लाइंट से ब्लॉकचेन में एक लेनदेन भेजते समय भी किया जाता है, जो पायथन में लिखा जा सकता है।
...
[इवेंट्स](https://consensys.io/blog/guide-to-events-and-logs-in-ethereum-smart-contracts) को ब्लॉकचेन के बाहर के उपयोगकर्ताओं और सर्वरों को इवेंट्स के बारे में सूचित करने के लिए उत्सर्जित किया जाता है। ध्यान दें कि इवेंट्स की सामग्री ब्लॉकचेन पर अनुबंधों के लिए उपलब्ध नहीं है।
...
पायथन में, और वाइपर में, आप एक बहु-पंक्ति स्ट्रिंग (`"""` से शुरू और समाप्त होती है) निर्दिष्ट करके और इसे किसी भी तरह से उपयोग न करके भी एक टिप्पणी बना सकते हैं। इन टिप्पणियों में [नैटस्पेक](https://vyper.readthedocs.io/en/latest/natspec.html) भी शामिल हो सकता है।
...
केवल आवश्यक होने पर मान बदलें। स्टेट चर भंडारण में रहते हैं। भंडारण में लिखना EVM (एथेरियम Virtual Machine) द्वारा किए जाने वाले सबसे महंगे परिचालनों में से एक है ([गैस](/developers/docs/gas/) के संदर्भ में)। इसलिए, इसे कम से कम करना एक अच्छा विचार है, यहां तक कि मौजूदा मूल्य लिखने की भी उच्च लागत होती है।
...
वाइपर में एक इवेंट उत्सर्जित करने के लिए आप एक `log` स्टेटमेंट का उपयोग करते हैं ([अधिक जानकारी के लिए यहां देखें](https://vyper.readthedocs.io/en/latest/event-logging.html#event-logging))।
...
सॉलिडिटी के विपरीत, वाइपर में वंशानुक्रम नहीं है। यह कोड को स्पष्ट बनाने और इसलिए सुरक्षित करने के लिए एक जानबूझकर डिजाइन विकल्प है। तो अपना खुद का वाइपर ERC-721 अनुबंध बनाने के लिए आप [यह अनुबंध](https://github.com/vyperlang/vyper/blob/master/examples/tokens/ERC721.vy) लेते हैं और इसे उस व्यावसायिक तर्क को लागू करने के लिए संशोधित करते हैं जो आप चाहते हैं।
