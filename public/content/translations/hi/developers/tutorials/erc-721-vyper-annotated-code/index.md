...
वाइपर में टिप्पणियाँ, पायथन की तरह, हैश (`#`) से शुरू होती हैं और लाइन के अंत तक जारी रहती हैं। `@<keyword>` वाली टिप्पणियों का उपयोग [NatSpec](https://vyper.readthedocs.io/en/latest/natspec.html) द्वारा मानव-पठनीय दस्तावेज़ीकरण बनाने के लिए किया जाता है।
...
पायथन में, और वाइपर में, आप एक बहु-पंक्ति स्ट्रिंग (`"""` से शुरू और समाप्त होती है) निर्दिष्ट करके और इसे किसी भी तरह से उपयोग न करके भी एक टिप्पणी बना सकते हैं। इन टिप्पणियों में [NatSpec](https://vyper.readthedocs.io/en/latest/natspec.html) भी शामिल हो सकता है।
