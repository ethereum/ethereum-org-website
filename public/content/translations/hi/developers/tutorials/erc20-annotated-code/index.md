...
description: "ओपनज़ेपेलिन ERC-20 कॉन्ट्रैक्ट में क्या है और यह वहां क्यों है?"
...
[ओपनज़ेपेलिन सॉलिडिटी ERC20 इम्प्लीमेंटेशन](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/token/ERC20/ERC20.sol), और
...
मेटामास्क जैसा वॉलेट हो, etherscan.io जैसा डैप हो, या लिक्विडिटी पूल जैसा कोई अलग कॉन्ट्रैक्ट हो।
...
यह ओपनज़ेपेलिन से [ERC-20 इंटरफेस](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/token/ERC20/IERC20.sol)
की एक परिभाषा है। यह [मानव पठनीय मानक](https://eips.ethereum.org/EIPS/eip-20) का सॉलिडिटी कोड में अनुवाद है। बेशक,
...
सॉलिडिटी फ़ाइलों में एक लाइसेंस पहचानकर्ता शामिल होना चाहिए। [आप यहां लाइसेंसों की सूची देख सकते हैं](https://spdx.org/licenses/)। यदि आपको एक अलग
...
सॉलिडिटी भाषा अभी भी तेजी से विकसित हो रही है, और नए संस्करण पुराने कोड के साथ संगत नहीं हो सकते हैं
...
कमेंट में `@dev` [नैटस्पेक फॉर्मेट](https://docs.soliditylang.org/en/develop/natspec-format.html) का हिस्सा है, जिसका उपयोग सोर्स कोड से
...
हर नोड द्वारा सत्यापित किया जा सकता है। इसे प्राप्त करने के लिए, प्रत्येक कॉन्ट्रैक्ट का मशीन भाषा कोड और स्टोरेज हर नोड पर उपलब्ध है। हालांकि आपको अपने अनुबंध के लिए सॉलिडिटी
कोड प्रकाशित करने की आवश्यकता नहीं है, लेकिन कोई भी आपको गंभीरता से नहीं लेगा जब तक कि आप स्रोत कोड और सॉलिडिटी का वह संस्करण प्रकाशित नहीं करते जिसके साथ इसे संकलित किया गया था, ताकि इसे
...
जैसा कि नाम से पता चलता है, `balanceOf` एक खाते का बैलेंस लौटाता है। एथेरियम खातों को `address` प्रकार का उपयोग करके सॉलिडिटी में पहचाना जाता है, जो 160 बिट्स रखता है।
...
- `GSN/Context.sol` [ओपनजीएसएन](https://www.opengsn.org/) का उपयोग करने के लिए आवश्यक परिभाषाएं हैं, एक ऐसी प्रणाली जो ईथर के बिना उपयोगकर्ताओं को
  ब्लॉकचेन का उपयोग करने की अनुमति देती है। ध्यान दें कि यह एक पुराना संस्करण है, यदि आप ओपनजीएसएन के साथ एकीकृत करना चाहते हैं
  [इस ट्यूटोरियल का उपयोग करें](https://docs.opengsn.org/javascript-client/tutorial.html)।
- [SafeMath लाइब्रेरी](https://ethereumdev.io/using-safe-math-library-to-prevent-from-overflows/), जो सॉलिडिटी संस्करणों **&lt;0.8.0** के लिए
  अरिथमैटिक ओवरफ़्लो/अंडरफ़्लो को रोकती है। सॉलिडिटी ≥0.8.0 में, अंकगणितीय संचालन स्वचालित रूप से
...
[ओपनजीएसएन](https://opengsn.org/) को तोड़ता है। यदि हम अपने टोकन के साथ ईथरलेस लेनदेन की अनुमति देना चाहते हैं, तो हमें
...
#### ओपनज़ेपेलिन सुरक्षा परिवर्धन {#openzeppelin-safety-additions}
...
दूसरा तरीका बहुत बेहतर है क्योंकि ओपनज़ेपेलिन ERC-20 कोड का पहले ही ऑडिट किया जा चुका है और इसे सुरक्षित दिखाया गया है। जब आप इनहेरिटेंस का उपयोग करते हैं
...
- `uint256` प्रकार के मान रैप अराउंड होते हैं। दूसरे शब्दों में, _0-1=2^256-1_। यदि वह वांछित
  ...
  [सॉलिडिटी 0.8.0](https://docs.soliditylang.org/en/breaking/080-breaking-changes.html) में बदल गया।
...
अब जब आपने देख लिया है कि ओपनज़ेपेलिन ERC-20 अनुबंध कैसे लिखा जाता है, और विशेष रूप से इसे कैसे
