...
description: "JSON-RPC अनुरोध करने और इवेंट्स की सदस्यता लेने के लिए वेबसॉकेट और अल्केमी का उपयोग करने के लिए गाइड।"
author: "एलन हैल्पर्न"
lang: hi
tags: [ "Alchemy", "वेबसॉकेट्स", "क्वेरी करना", "JavaScript" ]
skill: beginner
source: Alchemy docs
...
[अल्केमी वेब3](https://docs.alchemy.com/reference/api-overview) बिना किसी कॉन्फ़िगरेशन के WebSocket विफलताओं और पुन: प्रयासों के लिए स्वचालित रूप से हैंडलिंग जोड़ता है।
...
_नोट: यदि आपके पास अल्केमी खाता है तो आप `demo` को अपनी API की से बदल सकते हैं।_ [यहां एक मुफ्त अल्केमी खाते के लिए साइन अप करें!](https://auth.alchemy.com/signup)_
...
![अपने अल्केमी डैशबोर्ड में अपना वेबसॉकेट URL कहां खोजें](./use-websockets.gif)

[अल्केमी API संदर्भ](https://www.alchemy.com/docs/reference/api-overview) में सूचीबद्ध किसी भी API का उपयोग वेबसॉकेट के माध्यम से किया जा सकता है। ऐसा करने के लिए, उसी पेलोड का उपयोग करें जिसे HTTP POST अनुरोध के मुख्य भाग के रूप में भेजा जाएगा, लेकिन इसके बजाय उस पेलोड को वेबसॉकेट के माध्यम से भेजें।

## वेब3 के साथ {#with-web3}
...
लंबित स्थिति में जोड़े गए सभी लेन-देनों के लिए लेनदेन की जानकारी लौटाता है। यह सदस्यता प्रकार लंबित लेन-देन की सदस्यता लेता है, जो मानक वेब3 कॉल `web3.eth.subscribe("pendingTransactions")` के समान है, लेकिन इसमें यह भिन्न है कि यह केवल लेनदेन हैश के बजाय _पूर्ण लेनदेन जानकारी_ उत्सर्जित करता है।
...
मुफ्त में [अल्केमी के साथ साइन अप करें](https://auth.alchemy.com), [हमारे प्रलेखन](https://www.alchemy.com/docs/) देखें, और नवीनतम समाचारों के लिए, हमें [ट्विटर](https://x.com/AlchemyPlatform) पर फ़ॉलो करें।
