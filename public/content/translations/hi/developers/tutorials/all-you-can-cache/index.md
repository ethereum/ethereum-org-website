...
Yul `uint256` से परे डेटा संरचनाओं का समर्थन नहीं करता है, इसलिए जब आप एक अधिक परिष्कृत डेटा संरचना, जैसे कि मेमोरी बफर `_bytes` का उल्लेख करते हैं, तो आपको उस संरचना का पता मिलता है। सॉलिडिटी `bytes memory` मानों को 32 बाइट शब्द के रूप में संग्रहीत करता है जिसमें लंबाई होती है, उसके बाद वास्तविक बाइट्स होते हैं, इसलिए बाइट नंबर `_start` प्राप्त करने के लिए हमें `_bytes+32+_start` की गणना करने की आवश्यकता है।
...
4. अपने कॉन्फ़िगरेशन के लिए `.env` संपादित करें:
   ...
   | पैरामीटर                                                      | मूल्य                                                                                                                                                                               |
   | ------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
   | MNEMONIC                                                      | एक ऐसे खाते के लिए स्मरक जिसके पास लेनदेन के भुगतान के लिए पर्याप्त ETH है। [आप ऑप्टिमिज़्म Goerli नेटवर्क के लिए मुफ्त ETH यहाँ से प्राप्त कर सकते हैं](https://optimismfaucet.xyz/)। |
   | OPTIMISM_GOERLI_URL | ऑप्टिमिज़्म Goerli का URL। सार्वजनिक एंडपॉइंट, `https://goerli.optimism.io`, दर सीमित है लेकिन यहां हमें जो चाहिए उसके लिए पर्याप्त है                                                 |
