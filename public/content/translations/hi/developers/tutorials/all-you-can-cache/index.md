...
4. अपने कॉन्फ़िगरेशन के लिए `.env` संपादित करें:
   ...
   | पैरामीटर                                                      | मूल्य                                                                                                                                                                               |
   | ------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
   | MNEMONIC                                                      | एक ऐसे खाते के लिए स्मरक जिसके पास लेनदेन के भुगतान के लिए पर्याप्त ETH है। [आप ऑप्टिमिज़्म गोअर्ली नेटवर्क के लिए मुफ्त ETH यहाँ से प्राप्त कर सकते हैं](https://optimismfaucet.xyz/)। |
   | OPTIMISM_GOERLI_URL | ऑप्टिमिज़्म गोअर्ली का URL। सार्वजनिक एंडपॉइंट, `https://goerli.optimism.io`, दर सीमित है लेकिन यहां हमें जो चाहिए उसके लिए पर्याप्त है                                                 |
