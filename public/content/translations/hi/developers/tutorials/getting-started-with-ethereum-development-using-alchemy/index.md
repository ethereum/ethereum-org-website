...
## 3. कमांड लाइन से अनुरोध करें

जेसन-आरपीसी (JSON-RPC) और curl का उपयोग करके Alchemy के माध्यम से इथेरियम ब्लॉकचेन के साथ इंटरैक्ट करें।
...
- `method`: ETH API विधि। [API संदर्भ देखें।](/developers/docs/apis/json-rpc/)
- `params`: विधि में पास करने के लिए मापदंडों की एक सूची।
- `id`: आपके अनुरोध की ID। यह प्रतिक्रिया द्वारा वापस की जाएगी ताकि आप ट्रैक रख सकें कि कौन सी प्रतिक्रिया किस अनुरोध से संबंधित है।
...
_**नोट:** `https://eth-mainnet.alchemyapi.io/v2/demo` को अपनी खुद की API कुंजी `https://eth-mainnet.alchemyapi.io/v2/**your-api-key` से बदलें।_
...
```
## 4. अपना Web3 क्लाइंट सेट करें

**यदि आपके पास एक मौजूदा क्लाइंट है,** तो अपने वर्तमान नोड प्रदाता URL को अपनी API कुंजी के साथ Alchemy URL में बदलें: `“https://eth-mainnet.alchemyapi.io/v2/your-api-key"`

**_नोट:_** नीचे दी गई स्क्रिप्ट को **नोड संदर्भ** में चलाया जाना चाहिए या **किसी फ़ाइल में सहेजा जाना चाहिए**, कमांड लाइन से नहीं चलाया जाना चाहिए। यदि आपके पास पहले से Node या npm स्थापित नहीं है, तो [Node.js स्थापना निर्देशों](https://nodejs.org/en/download/) का पालन करें।

ऐसी कई [Web3 लाइब्रेरी](/developers/docs/apis/javascript/) हैं जिन्हें आप Alchemy के साथ एकीकृत कर सकते हैं, हालांकि, हम [Alchemy Web3](https://github.com/alchemyplatform/alchemy-web3) का उपयोग करने की सलाह देते हैं, जो web3.js के लिए एक ड्रॉप-इन रिप्लेसमेंट है, जिसे Alchemy के साथ निर्बाध रूप से काम करने के लिए बनाया और कॉन्फ़िगर किया गया है। यह स्वचालित पुनर्प्रयास और मजबूत WebSocket समर्थन जैसे कई लाभ प्रदान करता है।

AlchemyWeb3.js स्थापित करने के लिए, **अपनी प्रोजेक्ट निर्देशिका पर जाएं** और चलाएं:
...
Alchemy के नोड बुनियादी ढांचे के साथ इंटरैक्ट करने के लिए, NodeJS में चलाएं या इसे JavaScript फ़ाइल में जोड़ें:
...
```
## 5. अपनी पहली Web3 स्क्रिप्ट लिखें!

अब थोड़ी Web3 प्रोग्रामिंग के साथ व्यावहारिक अनुभव प्राप्त करने के लिए हम एक सरल स्क्रिप्ट लिखेंगे जो इथेरियम मेननेट से नवीनतम ब्लॉक संख्या प्रिंट करती है।

**1. यदि आपने पहले से नहीं किया है, तो अपने टर्मिनल में एक नई प्रोजेक्ट निर्देशिका बनाएं और उसमें cd करें:**
...
**3. `index.js` नाम की एक फ़ाइल बनाएं और निम्नलिखित सामग्री जोड़ें:**
...
async चीज़ों से अपरिचित हैं? इस [Medium पोस्ट](https://medium.com/better-programming/understanding-async-await-in-javascript-1d81bb079b2c) को देखें।
...
**5. अब आपको अपने कंसोल में नवीनतम ब्लॉक संख्या आउटपुट दिखाई देनी चाहिए!**
...
सुनिश्चित नहीं हैं कि आगे क्या करना है? अपना पहला स्मार्ट अनुबंध तैनात करने का प्रयास करें और हमारे [हैलो वर्ल्ड स्मार्ट अनुबंध गाइड](/developers/tutorials/hello-world-smart-contract/) में कुछ Solidity प्रोग्रामिंग के साथ व्यावहारिक अनुभव प्राप्त करें, या अधिक उदाहरणों के लिए [Alchemy के दस्तावेज़](https://www.alchemy.com/docs/) खोजना जारी रखें।
