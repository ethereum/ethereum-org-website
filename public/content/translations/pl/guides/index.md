...
2. [Jak używać portfela](/guides/how-to-use-a-wallet/) — Dowiedz się, jak wysyłać i odbierać tokeny w swoim portfelu oraz jak łączyć go z projektami.

## Podstawy bezpieczeństwa

1. [Jak cofnąć dostęp inteligentnego kontraktu do Twoich środków kryptowalutowych](/guides/how-to-revoke-token-access/) — Jeśli nagle zobaczysz w swoim portfelu transakcję, która nie została przez Ciebie zainicjowana, ten przewodnik nauczy Cię, jak zapobiec takim sytuacjom.

2. [Jak rozpoznać fałszywe tokeny](/guides/how-to-id-scam-tokens/) — Czym są fałszywe tokeny? Co sprawia, że wydają się autentyczne i jak je odróżnić, by ochronić siebie i uniknąć oszustwa?
