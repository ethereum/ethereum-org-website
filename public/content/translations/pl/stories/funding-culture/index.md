...
## PleasrDAO i narodziny własności zbiorowej {#pleasrdao-and-the-rise-of-collective-ownership}

To nie był wieloryb. Były to 23 adresy portfeli, które na poczekaniu założyły DAO, aby połączyć środki i wygrać aukcję. Nazwali się [@PleasrDAO](https://x.com/PleasrDAO).

Ta sprzedaż zapoczątkowała falę zbiorowego tworzenia kapitału, którą odczuwamy do dziś. 
...
## Budowa studia bez strażników dostępu {#building-a-studio-without-gatekeepers}
...
Token ERC-20 był emitowany na krzywej wiązania (bonding curve). Im wcześniej dołączyłeś i im bardziej byłeś zaangażowany, tym więcej zarabiałeś. Głosowania (takie jak wybór imienia głównej bohaterki, Mirai) odbywały się przez Snapshot. 

Uczestnictwo nie tylko było nagradzane, ale pomagało kształtować samą historię.
...
Jedna z rzeczy, z których jestem najbardziej dumna: napisy końcowe. Nie były statyczne, ale aktualizowały się w czasie rzeczywistym.

W zależności od wkładu, fani byli wymieniani jako:
- Producent wykonawczy
- Producent
- Współproducent
- Asystent produkcji (za ostatnie miejsce, lol) 
...
Właśnie wypuściliśmy 5 oryginalnych odcinków pilotażowych z różnych gatunków, każdy autorstwa innego twórcy. Sfinansowane i współprodukowane przez nas.

Jeśli któryś ci się spodoba, możesz sfinansować kolejny odcinek i znaleźć się w napisach końcowych. Są one dostępne na żywo i można je oglądać za darmo na [shibuya.film](https://www.shibuya.film/).

To coś więcej niż tylko zbiór filmów krótkometrażowych. To dowód słuszności koncepcji dla nowego rodzaju ekosystemu rozrywki.

Łącząc streaming z finansowaniem społecznościowym, możemy dać zarówno twórcom, jak i widzom możliwość kształtowania przyszłości opowiadania historii. 

<TweetEmbed id="1921928608039194795" />

## Udowodnienie, że system działa {#proving-the-system-works}

Jeśli chcemy wyrwać się z bańki informacyjnej krypto, możemy to zrobić poprzez kulturę.

Ale treści muszą być na tyle mocne, aby konkurować również poza tą przestrzenią. Kuratela ma znaczenie!

Jeśli wystarczająco wielu z nas dorzuci równowartość ceny kawy, możemy finansować świetne filmy onchain.

Razem możemy udowodnić, że ten system działa, dzięki czemu więcej twórców i fanów będzie chciało dołączyć do Web3. Nie dlatego, że muszą, ale dlatego, że jest to lepsze.
