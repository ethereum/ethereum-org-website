...
![Porównanie zużycia energii Ethereum przed i po Połączeniu: po lewej wieża Eiffla (330 m) symbolizująca wysokie zużycie energii przed Połączeniem, a po prawej mała figurka Lego (4 cm) reprezentująca drastyczną redukcję zużycia energii po Połączeniu](energy_consumption_pre_post_merge.png)
