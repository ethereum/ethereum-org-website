...
# Nieodwołalność pojedynczego slotu {#single-slot-finality}
...
## Kompromis między decentralizacją, czasem i narzutem {#the-decentralization-time-overhead-tradeoff}
...
## Jak jest rola zasady wyboru forka w SSF? Rola zasady wyboru forka {#role-of-the-fork-choice-rule}
...
## Nierozwiązane kwestie {#outstanding-issues}
...
SSF jest w fazie badań. Nie przewiduje się wdrożenia przez kilka lat, prawdopodobnie po innych istotnych uaktualnieniach, takich jak [drzewa Verkle](/roadmap/verkle-trees/) i [Danksharding](/roadmap/danksharding/).

## Dalsza lektura {#further-reading}

- [Vitalik o SSF na EDCON 2022](https://www.youtube.com/watch?v=nPgUKNPWXNI)
- [Notatki Vitalika: Drogi do nieodwołalności pojedynczego slotu](https://notes.ethereum.org/@vbuterin/single_slot_finality)
