...
Jeśli chcesz wziąć udział w [Programie Tłumaczeń](/contributing/translation-program/), prosimy o założenie konta na platformie [Crowdin](https://crowdin.com/project/ethereum-org). Do wszystkiego innego – dodawania lub edytowania treści czy elementów wizualnych na stronie, naprawiania błędów, pracy nad otwartymi zadaniami – będziesz potrzebować konta na [GitHub](https://github.com/).

Wszystkie aktualizacje są wprowadzane poprzez proces Pull Request (PR) na GitHub. Oznacza to, że tworzysz lokalną kopię strony, wprowadzasz zmiany i prosisz o ich scalenie (merge). Jeśli nigdy wcześniej tego nie robiłeś, postępuj zgodnie z instrukcjami na dole naszego [repozytorium GitHub](https://github.com/ethereum/ethereum-org-website).
...
- Skomentowanie zgłoszenia (issue) lub PR na [GitHub](https://github.com/ethereum/ethereum-org-website)
- Wysłanie wiadomości na naszym [serwerze Discord](https://discord.gg/ethereum-org)

Przed rozpoczęciem współtworzenia upewnij się, że znasz:
...
Wnosząc jakikolwiek wkład w postaci treści lub artefaktów do ethereum.org, używaj wyłącznie swoich oryginalnych prac lub treści, do których masz pozwolenie. Wiele projektów w ekosystemie Ethereum korzysta z licencji open-source, które pozwalają na swobodne udostępnianie informacji. Jeśli jednak nie możesz znaleźć takich informacji, nie próbuj dodawać ich do ethereum.org. Wszelkie pull requesty uznane za plagiat zostaną odrzucone.

## Zaczynasz przygodę z open-source? {#new-to-open-source}

W naszym repozytorium GitHub mamy zgłoszenia o niskiej barierze wejścia, specjalnie zaprojektowane dla programistów, którzy dopiero zaczynają pracę z open-source, oznaczone jako [good first issue](https://github.com/ethereum/ethereum-org-website/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22).
...
Do odbierania OAT powinieneś używać wyłącznie portfeli do samodzielnego przechowywania. Nie używaj kont giełdowych ani innych kont, do których nie posiadasz kluczy prywatnych, ponieważ nie pozwolą Ci one na dostęp do Twoich OAT i zarządzanie nimi.

## Odbierz swój GitPOAP {#claim-gitpoap}

GitPOAP również automatycznie rozpozna Twój scalony wkład i pozwoli Ci wybić oddzielny, unikalny POAP dla współtwórców na samej platformie!


### Jak odebrać {#how-to-claim-2}
...
4. Jeśli Twoje konto GitHub się kwalifikuje, będziesz mógł wybić GitPOAP!
