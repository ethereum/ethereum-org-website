...
<FeaturedText>Dowiedz się, jak programować dla Ethereum przy użyciu projektów i narzędzi opartych na Pythonie</FeaturedText>
...
- [Dowiedz się, jak kompilować i wdrażać w Solidity](https://kauri.io/article/973c5f54c4434bb1b0160cff8c695369/understanding-smart-contract-compilation-and-deployment)
- [Raport o stanie Pythona w blockchainie w 2023 r.](https://tradingstrategy.ai/blog/the-state-of-python-in-blockchain-in-2023)

## Artykuły dla początkujących {#beginner-articles}

- [Przegląd Web3.py](https://web3py.readthedocs.io/en/latest/overview.html)
- [Przewodnik po ekosystemie Pythona w Ethereum](https://snakecharmers.ethereum.org/python-ecosystem/)
- [Przewodnik po Ethereum dla programistów (Pythona)](https://snakecharmers.ethereum.org/a-developers-guide-to-ethereum-pt-1/)
- [Prize-Worthy: Przewodnik po hackathonach Ethereum w Pythonie](https://snakecharmers.ethereum.org/prize-worthy/)
...
- [Jak stworzyć kontrakt Ethereum przy użyciu Python Flask?](https://medium.com/coinmonks/how-to-develop-ethereum-contract-using-python-flask-9758fe65976e)
- [Wprowadzenie do Web3.py · Ethereum dla programistów Pythona](https://www.dappuniversity.com/articles/web3-py-intro)
...
- [Tworzenie dapp dla programistów Pythona](https://www.youtube.com/watch?v=tE-8bG35VNw)
...
- [Inteligentne kontrakty Ethereum w Pythonie: (w miarę) kompleksowy przewodnik](https://hackernoon.com/ethereum-smart-contracts-in-python-a-comprehensive-ish-guide-771b03990988)
...
- [Kompilacja, wdrażanie i wywoływanie inteligentnego kontraktu Ethereum za pomocą Pythona](https://yohanes.gultom.id/2018/11/28/compiling-deploying-and-calling-ethereum-smartcontract-using-python/)
- [Analiza inteligentnych kontraktów Solidity za pomocą Slither](https://kauri.io/#collections/DevOps/analyze-solidity-smart-contracts-with-slither/#analyze-solidity-smart-contracts-with-slither)
- [Samouczek Blockchain Fintech: Pożyczanie z użyciem Pythona](https://blog.chain.link/blockchain-fintech-defi-tutorial-lending-borrowing-python/)

## Zarchiwizowane artykuły {#archived-articles}

- [Wdróż własny token ERC-20 za pomocą Pythona i Brownie](https://betterprogramming.pub/python-blockchain-token-deployment-tutorial-create-an-erc20-77a5fd2e1a58)
...
- [Mamba](https://github.com/arjunaskykok/mamba) – _Framework do pisania, kompilacji i wdrażania inteligentnych kontraktów napisanych w języku Vyper_
...
## Projekty wykorzystujące narzędzia w Pythonie {#projects-using-python-tooling}
...
- [Yearn Finance](https://yearn.finance/) i [repozytorium kontraktów skarbca Yearn](https://github.com/yearn/yearn-vaults)
...
- [Alpha Finance](https://alphaventuredao.io/), znane z Alpha Homora, używa [Brownie do testowania i wdrażania inteligentnych kontraktów](https://github.com/AlphaFinanceLab/alpha-staking-contract)

## Dyskusje społeczności Pythona {#python-community-contributors}

- [Discord społeczności Pythona w Ethereum](https://discord.gg/9zk7snTfWe) do dyskusji o Web3.py i innych frameworkach Pythona
- [Discord Vyper](https://discord.gg/SdvKC79cJk) do dyskusji o programowaniu inteligentnych kontraktów w Vyper

## Inne zbiorcze listy {#other-aggregated-lists}
