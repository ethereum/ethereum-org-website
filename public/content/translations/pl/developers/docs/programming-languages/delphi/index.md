...
- [Łączenie Delphi z lokalnym blockchainem (w pamięci)](https://medium.com/@svanas/connecting-delphi-to-a-local-in-memory-blockchain-9a1512d6c5b0)
...
- [Inteligentny kontrakt w 3 minuty i Delphi – Część 1](https://medium.com/@svanas/a-3-minute-smart-contract-and-delphi-61d998571d)
- [Inteligentny kontrakt w 3 minuty i Delphi – Część 2](https://medium.com/@svanas/a-3-minute-smart-contract-and-delphi-part-2-446925faa47b)

## Artykuły dla średniozaawansowanych {#intermediate-articles}

- [Generowanie podpisu wiadomości podpisanej przez Ethereum w Delphi](https://medium.com/@svanas/generating-an-ethereum-signed-message-signature-in-delphi-75661ce5031b)
...
- [Delphi i usługa nazw Ethereum (ENS)](https://medium.com/@svanas/delphi-and-ethereum-name-service-ens-4443cd278af7)
...
- [Zamiana jednego tokenu na inny w Delphi](https://svanas.medium.com/swap-one-token-for-another-in-delphi-bcb999c47f7)
