...
Is iad Sepolia agus Hoodie an dá líonra tástála poiblí atá á gcothabháil ag forbróirí cliant faoi láthair. Is líonra é Sepolia d’fhorbróirí conarthaí agus feidhmchlár chun a bhfeidhmchláir a thástáil. Ligeann líonra Hoodi d’fhorbróirí prótacail uasghráduithe líonra a thástáil, agus ligeann sé do gheallsealbhóirí bailíochtóirí reatha a thástáil.

#### Sepolia {#sepolia}

**Is é Sepolia an líonra tástála réamhshocraithe a mholtar chun feidhmchláir a fhorbairt**. Úsáideann líonra Sepolia sraith bailíochtóiirí ceadúnaithe atá faoi rialú ag foirne cliant & foirne tástála.
...
Is líonra tástála é Hoodi le haghaidh tástála, bailíochtú agus geallchur. Tá líonra Hoodi oscailte d'úsáideoirí ar mian leo bailíochtóir tástála líonra a rith. Dá bhrí sin, ba cheart do gheallsealbhóirí ar mian leo uasghráduithe prótacail a thástáil sula ndéantar iad a imscaradh ar an bpríomhlíonra Hoodi a úsáid.

- Tacar bailíochtóirí oscailte, is féidir le geallsealbhóirí uasghráduithe líonra a thástáil
- Staid mhór, úsáideach chun idirghníomhaíochtaí casta conartha cliste a thástáil
- Níos faide le sioncrónú agus teastaíonn níos mó stórála chun nód a rith

##### Acmhainní

- [Suíomh Gréasáin](https://hoodi.ethpandaops.io/)
- [GitHub](https://github.com/eth-clients/hoodi)
- [Taiscéalaí](https://explorer.hoodi.ethpandaops.io/)
- [Sioncrónú Seicphointe](https://checkpoint-sync.hoodi.ethpandaops.io/)
...
Beidh an líonra tástála Holesky [as feidhm i Meán Fómhair 2025](https://blog.ethereum.org/en/2025/03/18/hoodi-holesky). Ba cheart d’oibreoirí geallchur agus do sholáthraithe bonneagair Hoodi a úsáid le haghaidh tástála bailíochtóra ina ionad.

##### Acmhainní

- [Suíomh Gréasáin](https://holesky.ethpandaops.io/)
...
Chun Bailíochtóir a sheoladh ar Hoodi testnet, bain úsáid as [Hoodi launchpad](https://hoodi.launchpad.ethereum.org/en/).
...
- [Ailceimic Arbitrum Sepolia Faucet](https://www.alchemy.com/faucets/arbitrum-sepolia)
...
- [Liosta Slabhra](https://chainlist.org/) _liosta de líonraí EVM chun sparán agus soláthraithe a nascadh leis an ID Slabhra agus ID Líonra cuí_
- [Slabhraí bunaithe ar EVM](https://github.com/ethereum-lists/chains) _Stór GitHub de mheiteashonraí slabhra a chumhachtaíonn Liosta Slabhra_

## Tuilleadh léitheoireachta {#further-reading}

- [Togra: Saolré Tástála Ethereum Intuartha](https://ethereum-magicians.org/t/proposal-predictable-ethereum-testnet-lifecycle/11575/17)
- [Éabhlóid na nTástálacha Ethereum](https://etherworld.co/2022/08/19/the-evolution-of-ethereum-testnet/)
