...
4. Tugadh isteach **Idirbhearta Cineál 3 (Bloba)** i [EIP-4844](https://eips.ethereum.org/EIPS/eip-4844) mar chuid d'Uasghrádú [Dencun](/history/#dencun) Ethereum. Tá na hidirbhearta seo deartha chun sonraí "bloba" (Réada Móra Dénártha) a láimhseáil ar bhealach níos éifeachtaí, rud a bhaineann go háirithe leas as rollups Sraith 2 trí bhealach a sholáthar chun sonraí a phostáil chuig líonra Ethereum ar chostas níos ísle. Áirítear le hidirbhearta Bloba réimsí breise amhail `blobVersionedHashes`, `maxFeePerBlobGas`, agus `blobGasPrice`. Tosaíonn siad leis an mbeart `0x03`, agus is é `0x3` a luach TransactionType. Léiríonn idirbhearta Bloba feabhas suntasach ar infhaighteacht sonraí agus cumais scálúcháin Ethereum.
