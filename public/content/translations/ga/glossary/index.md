---
title: Gluais Ethereum
description: Gluais neamhiomlán de théarmaí teicniúla agus neamhtheicniúla a bhaineann le Ethereum
lang: ga
---

# Gluais {#ethereum-glossary}
...
_Ar fáil i bpáirt ag [Máistreacht Ethereum](https://github.com/ethereumbook/ethereumbook) ag [Andreas M. Antonopoulos, Gavin Wood ](https://ethereumbook.info) faoi CC-BY-SA_

<Divider />

## Cuir leis an leathanach seo {#contribute-to-this-page}

Ar chaill muid rud éigin? An bhfuil rud éigin mícheart? Cabhraigh linn feabhsú trí chur leis an ngluais seo ar GitHub!

[Foghlaim tuilleadh faoi conas rannchuidiú](/contributing/adding-glossary-terms)
