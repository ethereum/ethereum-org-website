...
속성 기반 테스트 실행은 일반적으로 스마트 컨트랙트에서 검증하려는 속성(예: [정수 오버플로](https://github.com/ConsenSysDiligence/mythril/wiki/Integer-Overflow) 부재) 또는 속성 모음을 정의하는 것으로 시작됩니다. 속성 테스트를 작성할 때 프로그램이 트랜잭션 입력에 대한 데이터를 생성할 수 있는 값의 범위를 정의해야 할 수도 있습니다.
