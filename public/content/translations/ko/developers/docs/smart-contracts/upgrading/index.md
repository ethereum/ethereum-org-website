...
새로운 위성 계약을 구축하고 메인 계약을 새 주소로 구성할 수 있습니다. 이를 통해 스마트 계약의 <em>전략</em>을 변경(즉, 새로운 로직 구현)할 수 있습니다.
...
다이아몬드 패턴의 로직 계약은 <em>패싯</em>으로 알려져 있습니다. 다이아몬드 패턴이 작동하려면 프록시 계약에 [함수 선택자](https://docs.soliditylang.org/en/latest/abi-spec.html#function-selector)를 다른 패싯 주소에 매핑하는 매핑을 만들어야 합니다.
