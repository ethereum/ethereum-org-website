...
다이아몬드 패턴의 로직 컨트랙트는 _패싯(facets)_이라고 합니다. 다이아몬드 패턴이 작동하도록 하려면 프록시 컨트랙트에서 [함수 선택자](https://docs.soliditylang.org/en/latest/abi-spec.html#function-selector)를 다른 패싯 주소에 매핑하는 매핑을 생성해야 합니다.
