...
- [플레이그라운드](https://playground.nethereum.com/) - 브라우저를 통해 이더리움과 상호 작용하고 Nethereum 사용법을 알아보세요.
  - [계정 잔액 조회](https://docs.nethereum.com/docs/core-foundation/guide-query-balance)
  - [ERC-20 스마트 컨트랙트 잔액 조회](https://docs.nethereum.com/docs/smart-contracts/erc20)
  - [계정으로 이더 전송](https://docs.nethereum.com/docs/core-foundation/guide-send-eth)
  - ... 그 외 다수!
...
- [Solidity용 VSCode Codegen 플러그인](https://docs.nethereum.com/docs/aspire-templates/guide-codegen)
- [Unity와 이더리움: 이유와 방법](https://www.raywenderlich.com/5509-unity-and-ethereum-why-and-how)
- [이더리움 dapp을 위한 ASP.NET Core Web API 생성하기](https://tech-mint.com/blockchain/create-asp-net-core-web-api-for-ethereum-dapps/)
...
- [Azure Key 볼트와 Nethereum](https://github.com/Azure-Samples/bc-community-samples/tree/master/akv-nethereum)
- [Nethereum.DappHybrid](https://github.com/Nethereum/Nethereum.DappHybrid)

## .NET 프로젝트, 도구 및 기타 흥미로운 자료 {#dot-net-projects-tools-and-other-fun-stuff}

- [Nethereum 플레이그라운드](https://playground.nethereum.com/) - _브라우저에서 Nethereum 코드 스니펫을 컴파일, 생성 및 실행합니다._
- [Nethereum Codegen Blazor](https://github.com/Nethereum/Nethereum.CodeGen.Blazor) - _Blazor의 UI를 갖춘 Nethereum 코드 생성기(codegen)_
- [Nethereum Blazor](https://github.com/Nethereum/NethereumBlazor) - _.NET Wasm SPA 기반의 가벼운 블록체인 탐색기 및 간단한 지갑_
- [네더마인드](https://github.com/NethermindEth/nethermind) - _Linux, Windows, MacOS를 위한 .NET Core 이더리움 클라이언트_
