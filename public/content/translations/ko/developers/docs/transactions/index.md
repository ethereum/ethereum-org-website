...
콜 데이터를 보려면 <strong>Click to see More</strong>를 사용하세요.
...
Bob의 계정에서 <strong>-1.0042 ETH</strong>가 차감됩니다(Alice를 위한 1 ETH + 가스비 0.0042 ETH).

Alice의 계정에 <strong>+1.0 ETH</strong>가 입금됩니다.
