...
이제 어느 정도의 중앙화를 감수하더라도 탈중앙화 애플리케이션 (dapp) 사용자를 위해 가스비 없는 경험을 제공할 수 있을 것입니다.

하지만 이는 ERC-712를 지원하는 스마트 컨트랙트에서만 작동합니다. 예를 들어, ERC-20 토큰을 전송하려면 단순히 메시지가 아니라 소유자가 직접 트랜잭션에 서명해야 합니다. 가장 간단한 해결책은 자산을 EOA 주소가 아닌 별도의 컨트랙트가 소유하도록 하는 것입니다([계정 추상화](/roadmap/account-abstraction/)의 단순한 형태). 이에 대한 자세한 내용은 [후속 튜토리얼](/developers/tutorials/gasless-token)에서 확인할 수 있습니다.
