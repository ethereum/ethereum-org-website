...
Optimism(또는 다른 L2)에서 L1 자산을 사용하려면 자산을 [브리지](/bridges/#prerequisites)해야 합니다.
이를 달성하는 한 가지 방법은 사용자가 L1에 자산(ETH 및 [ERC-20 토큰](/developers/docs/standards/tokens/erc-20/)이 가장 일반적임)을 락업하고 L2에서 사용할 수 있는 동등한 자산을 받는 것입니다.
