...
여기에는 두 개의 이러한 태그가 있습니다. 하나는 `<Greeter />`(실제로 컨트랙트와 통신하는 HTML 코드를 포함함)이고, 다른 하나는 [수평선을 위한 `<HTML-PLACEHOLDER-HTMLTAG-8d9513 />`](https://www.w3schools.com/tags/tag_hr.asp)입니다.
