...
악의적인 개발자들이 때때로 스마트 계약에 백도어를 만들어, 이를 모르고 상호작용하는 사용자들의 자금에 접근할 수 있게 합니다. 흔히 이러한 플랫폼은 미래에 소량의 [가스](/glossary/#gas) 비용을 절약하기 위해 사용자에게 <strong>무제한 수량의 토큰</strong>을 사용할 권한을 요청하지만, 이는 더 큰 위험을 수반합니다.
