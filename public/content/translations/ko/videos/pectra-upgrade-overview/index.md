...
데브콘 SEA(Devcon SEA)에서 <strong>크리스틴 김(Christine Kim)</strong>이 진행한 프레젠테이션으로, 이더리움의 펙트라 업그레이드에 포함된 EIP, 프로토콜의 변경 사항, 메인넷 활성화 예상 시기, 그리고 범위에서 제외된 EIP에 대해 다룹니다.
