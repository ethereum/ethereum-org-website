...
<strong>오스틴 그리피스(Austin Griffith)</strong>가 ETH.BUILD 시각적 프로그래밍 도구를 사용하여 블록체인 채굴이 어떻게 작동하는지 보여주는 튜토리얼입니다. 오스틴은 작업증명(PoW) 합의, 블록 체이닝, 채굴 난이도, 블록 보상 및 체인의 불변성을 다룹니다.

*이 대본은 오스틴 그리피스가 게시한 [원본 비디오 대본](https://www.youtube.com/watch?v=zcX7OJ-L8XQ)의 접근성 향상 버전입니다. 가독성을 위해 약간 편집되었습니다.*

#### 조정의 문제 (0:00) {#the-problem-of-coordination-000}
...
#### 블록과 논스 (1:04) {#blocks-and-the-nonce-104}
...
#### 작업증명의 실제 작동 (3:00) {#proof-of-work-in-action-300}
...
#### 블록을 체인으로 연결하기 (3:56) {#chaining-blocks-together-356}
...
#### 채굴 난이도 (5:02) {#mining-difficulty-502}
...
#### 이중 지불과 네트워크 전파 (10:00) {#double-spends-and-network-propagation-1000}
...
#### 다수의 채굴자와 합의 (12:27) {#multiple-miners-and-consensus-1227}
...
#### 코인베이스와 블록 보상 (15:33) {#coinbase-and-block-rewards-1533}
...
#### 블록 보상과 인센티브 (16:52) {#block-rewards-and-incentives-1652}
...
#### 블록체인 쿼리 (18:30) {#querying-the-blockchain-1830}
...
#### 체인의 불변성 (19:51) {#chain-immutability-1951}
