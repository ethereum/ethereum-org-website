...
오늘날 모든 이더리움 트랜잭션은 처리의 단순성이나 복잡성에 관계없이 고정된 기본 가스비를 가집니다. \*\*내재적 트랜잭션 가스비 절감(또는 EIP-2780)\*\*은 기존 계정 간의 표준 ETH 이체 비용을 최대 <strong>71% 저렴</strong>하게 만들기 위해 해당 기본 수수료를 줄일 것을 제안합니다.
