...
이 문제에 대한 몇 가지 해결책이 있습니다. 한 가지는 [분산 검증자 기술](https://github.com/ethereum/distributed-validator-specs)인데, 이는 검증자 실행과 관련된 다양한 작업을 중복성을 갖춘 여러 컴퓨터에 분산시켜 공격자가 특정 슬롯에서 블록이 제안되는 것을 방지하기 훨씬 어렵게 만드는 것을 목표로 합니다. 하지만 가장 강력한 해결책은 <strong>단일 비밀 리더 선출(SSLE)</strong>입니다.
