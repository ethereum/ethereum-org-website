...
L1 검증을 위한 zkEVM은 스테이트리스(stateless) 검증을 더욱 향상시킬 수 있는 보완 기술입니다. 검증자는 단순히 위트니스(witness)를 확인하는 대신 전체 블록이 올바르게 실행되었다는 영지식 증명을 검증할 수 있습니다 -- 트랜잭션을 재실행하지 않고도 암호학적 확실성을 제공합니다.
