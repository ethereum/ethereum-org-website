...
<ExpandableCard
title="스테이킹 노드 운영자 및 제공자"
contentPreview="자체 노드 설정을 실행하는 스테이커이거나 노드 인프라 제공자인 경우, 머지 이후에 알아두어야 할 몇 가지 사항이 있습니다."
...
<ExpandableCard
title="비검증 노드 운영자 및 인프라 제공자"
contentPreview="비검증 이더리움 노드를 운영하는 경우, 머지와 함께 나타난 가장 큰 변화는 실행 계층과 합의 레이어 모두에 대한 클라이언트를 실행해야 한다는 요구 사항이었습니다."
id="node-operators">
...
<ExpandableCard
title="dapp 및 스마트 컨트랙트 개발자"
contentPreview="머지는 스마트 컨트랙트 및 dapp 개발자에게 미치는 영향을 최소화하도록 설계되었습니다."
id="developers">
...
contentPreview="거짓입니다. 누구나 자유롭게 자체 검증된 이더리움 사본을 동기화(즉, 노드 실행)할 수 있습니다. 머지 이전에도, 머지 이후에도, 그리고 앞으로도 ETH는 필요하지 않습니다.">
...
<ExpandableCard
title="오해: &quot;머지는 가스 수수료를 줄이는 데 실패했습니다.&quot;"
contentPreview="거짓입니다. 머지는 네트워크 용량의 확장이 아닌 합의 메커니즘의 변경이었으며, 가스 수수료를 낮추기 위한 것이 아니었습니다.">
...
<ExpandableCard
title="오해: &quot;머지로 인해 트랜잭션이 상당히 가속화되었습니다.&quot;"
contentPreview="거짓입니다. 약간의 변화는 있지만, 현재 레이어 1의 트랜잭션 속도는 머지 이전과 거의 동일합니다.">
...
<ExpandableCard
title="오해: &quot;머지로 인해 스테이킹 인출이 가능해졌습니다.&quot;"
contentPreview="거짓입니다. 하지만 그 이후 상하이/카펠라 업그레이드를 통해 스테이킹 인출이 가능해졌습니다.">
...
<ExpandableCard
title="오해: &quot;이제 머지가 완료되고 인출이 가능해졌으므로, 스테이커들이 한 번에 모두 종료할 수 있습니다.&quot;"
contentPreview="거짓입니다. 검증자 종료는 보안상의 이유로 속도가 제한됩니다.">
