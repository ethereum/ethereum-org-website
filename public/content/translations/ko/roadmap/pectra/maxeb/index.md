...
### 참여하면 제안 운이나 보상이 변경되나요? {#change-luck-or-rewards}

아니요. 참여한다고 해서 제안 기회가 줄어들지는 않으며, 검증자 임무와 제안자 선정은 동일하게 유지됩니다. 예를 들어, 32 ETH 검증자 2개를 운영하는 것과 64 ETH 검증자 1개를 운영하는 경우, 블록을 제안하도록 선택되어 보상을 받을 전체 확률은 동일합니다.
