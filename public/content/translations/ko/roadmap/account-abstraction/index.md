...
대부분의 기존 사용자는 <strong>[외부 소유 계정(EOA)](/glossary/#eoa)</strong>을 사용하여 이더리움과 상호작용합니다. 이는 사용자가 이더리움과 상호작용하는데에 어려움이 될 수 있습니다. 예를 들어, 거래를 일괄 처리하기 어렵고 사용자는 거래 수수료를 지불하기 위해 항상 ETH 잔액을 유지해야 합니다.
