...
1. **모든 공개 함수 테스트** -- 엣지 케이스(edge case)와 실패 모드를 포함합니다.
2. 복잡한 수학 연산에는 **퍼징(fuzzing) 사용**.
3. [Smock](https://github.com/defi-wonderland/smock)과 같은 도구를 사용하여 **외부 종속성 모킹(mocking)**.
