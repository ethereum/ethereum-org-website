...
또한 기계 또는 AI 번역을 자동으로 감지하는 도구를 사용하여 **기계 번역 방지 조치**를 실행할 예정입니다.

번역 품질이 점수 계산에 결정적인 역할을 하지는 않지만, **기계 또는 AI 번역을 사용한 것으로 밝혀진 참가자**나 저품질의 부정확한 번역을 제안하는 참가자는 수상 자격이 없습니다!
