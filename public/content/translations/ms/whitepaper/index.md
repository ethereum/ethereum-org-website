...
- **Namecoin** - dicipta pada 2010, [Namecoin](https://namecoin.org/) paling tepat digambarkan sebagai pangkalan data pendaftaran nama terpusat. Dalam protokol yang terpencar seperti Tor, Bitcoin dan Bitmessage, perlu ada beberapa cara untuk mengenal pasti akaun supaya orang lain dapat berinteraksi dengan mereka, tetapi dalam semua penyelesaian yang ada, satu-satunya jenis pengenal pasti yang ada adalah hash pseudo-rawak seperti `1LW79wp5ZBqaHW1jL5TCiBCrhQYtHagUWy`. Sebaiknya, kita ingin berupaya memiliki akaun dengan nama seperti "george". Walau bagaimanapun, masalahnya ialah jika seseorang boleh membuat akaun bernama "george" maka orang lain boleh menggunakan proses yang sama untuk mendaftar "george" untuk diri mereka dan juga menyamar sebagai "george". Satu-satunya penyelesaian ialah paradigma "pertama sekali daftar", di iaitu pendaftar pertama berjaya dan pendaftar kedua gagal - masalah yang sesuai untuk protokol konsensus Bitcoin. Namecoin ialah implementasi sistem pendaftaran nama yang tertua, dan paling berjaya yang menggunakan idea sedemikian.
...
### Akaun Ethereum {#ethereum-accounts}
...
Kontraknya sangat mudah; Semua itu adalah pangkalan data di dalam Ethereum network yang boleh ditambah, tetapi tidak diubahsuai atau dikeluarkan. Sesiapa sahaja boleh mendaftar nama dengan beberapa nilai, dan pendaftaran itu kemudian melekat selama-lamanya. Kontrak pendaftaran nama yang lebih canggih juga akan mempunyai "klausa fungsi" yang membolehkan kontrak lain untuk menanyakannya, serta mekanisme bagi "pemilik" (iaitu pendaftar pertama) nama untuk menukar data atau pemilikan pemindahan. Seseorang juga boleh menambah reputasi dan fungsi web boleh dipercayai di bahagian atas.
...
**8. Pasaran pemencaran dalam rantaian**, menggunakan sistem identiti dan reputasi sebagai asas.
...
- Seorang bapa saudara termasuk dalam blok B mesti mempunyai sifat-sifat berikut:
  - Ia mestilah anak langsung daripada nenek moyang generasi ke-K B, dengan `2 <= k <= 7`.
