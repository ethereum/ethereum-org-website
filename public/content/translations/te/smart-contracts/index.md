...
metaTitle: "స్మార్ట్ కాంట్రాక్టులు: అవి ఏమిటి మరియు వాటి ప్రయోజనాలు ఏమిటి"
...
నిక్ స్జాబో "స్మార్ట్ కాంట్రాక్ట్" అనే పదాన్ని సృష్టించాడు. 1994లో, అతను [భావనకు ఒక పరిచయం](https://www.fon.hum.uva.nl/rob/Courses/InformationInSpeech/CDROM/Literature/LOTwinterschool2006/szabo.best.vwh.net/smart.contracts.html) రాశారు, మరియు 1996లో [స్మార్ట్ కాంట్రాక్టులు ఏమి చేయగలవనే దానిపై అన్వేషణ](https://www.fon.hum.uva.nl/rob/Courses/InformationInSpeech/CDROM/Literature/LOTwinterschool2006/szabo.best.vwh.net/smart_contracts_2.html) రాశారు.

స్జాబో ఒక డిజిటల్ మార్కెట్‌ప్లేస్‌ను ఊహించారు, ఇక్కడ ఆటోమేటిక్, [క్రిప్టోగ్రాఫికల్-సురక్షిత](/glossary/#cryptography) ప్రక్రియలు విశ్వసనీయ మధ్యవర్తులు లేకుండా లావాదేవీలు మరియు వ్యాపార విధులు జరిగేలా చేస్తాయి. Ethereumపై స్మార్ట్ కాంట్రాక్టులు ఈ విజన్‌ను ఆచరణలో పెట్టాయి.

స్మార్ట్ కాంట్రాక్టులను వివరించే ఫైనిమాటిక్స్ చూడండి:

<YouTube id="pWGLtjG-F5c" />

## సాంప్రదాయ కాంట్రాక్టులలో నమ్మకం {#trust-and-contracts}
...
స్మార్ట్ కాంట్రాక్టులు ఆడిట్‌లు మరియు ట్రాకింగ్ కోసం ఉపయోగపడతాయి. Ethereum స్మార్ట్ కాంట్రాక్టులు పబ్లిక్ బ్లాక్‌చెయిన్‌లో ఉన్నందున, ఎవరైనా ఆస్తి బదిలీలు మరియు ఇతర సంబంధిత సమాచారాన్ని తక్షణమే ట్రాక్ చేయవచ్చు. ఉదాహరణకు, మీ చిరునామాకు ఎవరైనా డబ్బు పంపినట్లు మీరు తనిఖీ చేయవచ్చు.
గోప్యతా రక్షణ.
...
అవి గణనలను నిర్వహించగలవు, కరెన్సీని సృష్టించగలవు, డేటాను నిల్వ చేయగలవు, [NFTలను](/glossary/#nft) మింట్ చేయగలవు, కమ్యూనికేషన్‌లను పంపగలవు మరియు గ్రాఫిక్‌లను కూడా రూపొందించగలవు. ఇక్కడ కొన్ని ప్రసిద్ధ, వాస్తవ ప్రపంచ ఉదాహరణలు ఉన్నాయి:
...
- [స్మార్ట్ కాంట్రాక్టులు ప్రపంచాన్ని ఎలా మారుస్తాయి](https://www.youtube.com/watch?v=pA6CGuXEKtQ)
- [డెవలపర్‌ల కోసం స్మార్ట్ కాంట్రాక్టులు](/developers/docs/smart-contracts/)
- [స్మార్ట్-కాంట్రాక్టులు వ్రాయడం నేర్చుకోండి](/developers/learning-tools/)
- [Mastering Ethereum - స్మార్ట్ కాంట్రాక్ట్ అంటే ఏమిటి?](https://github.com/ethereumbook/ethereumbook/blob/openedition/07smart-contracts-solidity.asciidoc#what-is-a-smart-contract)
