...
### ముద్రించే ఫంక్షన్‌ను కాల్ చేయండి

సాధారణంగా, ఈ ముద్రించే ఫంక్షన్‌కు మీరు రెండు వేరియబుల్స్‌ను పారామితులుగా పంపడం అవసరం, మొదటిది `recipient`, ఇది మీరు కొత్తగా ముద్రించిన NFTని స్వీకరించే చిరునామాను నిర్దేశిస్తుంది మరియు రెండవది NFT యొక్క `tokenURI`, ఇది NFT యొక్క మెటాడేటాను వివరించే JSON డాక్యుమెంట్‌కు పరిష్కరించబడే స్ట్రింగ్.

ఒక NFT యొక్క మెటాడేటా నిజంగా దానికి జీవం పోస్తుంది, పేరు, వివరణ, చిత్రం (లేదా వేరే డిజిటల్ ఆస్తి) మరియు ఇతర లక్షణాల వంటి ప్రాపర్టీలను కలిగి ఉండటానికి అనుమతిస్తుంది. NFT యొక్క మెటాడేటాను కలిగి ఉన్న [tokenURI యొక్క ఉదాహరణ](https://gateway.pinata.cloud/ipfs/QmSvBcb4tjdFpajGJhbFAWeK3JAxCdNQLQtr6ZdiSi42V2) ఇక్కడ ఉంది.

ఈ ట్యుటోరియల్‌లో, మేము మా React UIని ఉపయోగించి NFT స్మార్ట్ కాంట్రాక్ట్ ముద్రించే ఫంక్షన్‌ను కాల్ చేయడం అనే 2వ భాగంపై దృష్టి పెట్టబోతున్నాము.

మీకు Sepolia వంటి మద్దతు ఉన్న టెస్ట్‌నెట్‌కు డిప్లాయ్ చేయబడిన ERC-721 NFT స్మార్ట్ కాంట్రాక్ట్ అవసరం. మీరు స్వయంగా ఒకదాన్ని డిప్లాయ్ చేయాలనుకుంటే, [Sepoliaకి స్మార్ట్ కాంట్రాక్ట్‌ను డిప్లాయ్ చేయడం](https://www.alchemy.com/docs/how-to-deploy-a-smart-contract-to-the-sepolia-testnet)పై Alchemy యొక్క గైడ్‌ను మేము సిఫార్సు చేస్తున్నాము.

అద్భుతం, ఇప్పుడు NFTని తయారు చేయడం ఎలా పనిచేస్తుందో మనం అర్థం చేసుకున్నాము కాబట్టి, మన స్టార్టర్ ఫైల్‌లను క్లోన్ చేద్దాం!
...
### మెటామాస్క్‌ని డౌన్‌లోడ్ చేయండి
...
మీరు [ఇక్కడ](https://metamask.io/download) ఉచితంగా మెటామాస్క్ ఖాతాను డౌన్‌లోడ్ చేసి సృష్టించవచ్చు. మీరు ఖాతాను సృష్టిస్తున్నప్పుడు లేదా మీకు ఇప్పటికే ఖాతా ఉంటే, Sepolia వంటి మద్దతు ఉన్న టెస్ట్ నెట్‌వర్క్‌కి మారేలా చూసుకోండి \(తద్వారా మనం నిజమైన డబ్బుతో వ్యవహరించము\).
### ఫాసెట్ నుండి ఈథర్‌ను జోడించండి

మన NFTలను ముద్రించడానికి (లేదా ఎథీరియం బ్లాక్‌చైన్‌లో ఏవైనా లావాదేవీలపై సంతకం చేయడానికి), మనకు కొంత నకిలీ ETH అవసరం. టెస్ట్‌నెట్ ETH పొందడానికి, [Alchemy Sepolia ఫాసెట్](https://www.alchemy.com/faucets/ethereum-sepolia) వంటి నిర్వహించబడుతున్న ఫాసెట్‌ను ఉపయోగించండి మరియు మీ Sepolia ఖాతా చిరునామాను నమోదు చేయండి. ఆ తర్వాత కొద్దిసేపటికే మీ మెటామాస్క్ ఖాతాలో మీరు ETHని చూడవచ్చు!
### మీ బ్యాలెన్స్‌ని తనిఖీ చేయండి

మన బ్యాలెన్స్ అక్కడ ఉందో లేదో ఒకసారి సరిచూసుకోవడానికి, [Alchemy యొక్క శాండ్‌బాక్స్ టూల్](https://sandbox.alchemy.com/?network=ETH_SEPOLIA&method=eth_getBalance&body.id=1&body.jsonrpc=2.0&body.method=eth_getBalance&body.params%5B0%5D=&body.params%5B1%5D=latest)ని ఉపయోగించి [eth_getBalance](https://www.alchemy.com/docs/chains/ethereum/ethereum-api-endpoints/eth-get-balance) అభ్యర్థనను చేద్దాం. ఇది మన వాలెట్‌లోని Eth మొత్తాన్ని అందిస్తుంది. మీరు మీ మెటామాస్క్ ఖాతా చిరునామాను ఇన్‌పుట్ చేసి, "Send Request" క్లిక్ చేసిన తర్వాత, మీరు ఇలాంటి ప్రతిస్పందనను చూడాలి:
...
మీకు ఇప్పటికే Alchemy ఖాతా లేకపోతే, [ఉచితంగా ఇక్కడ సైన్ అప్ చేయండి.](https://alchemy.com/?a=eth-org-nft-minter)

మీరు Alchemy ఖాతాను సృష్టించిన తర్వాత, మీరు ఒక యాప్‌ను సృష్టించడం ద్వారా API కీని రూపొందించవచ్చు. ఇది Sepolia టెస్ట్ నెట్‌వర్క్‌కు అభ్యర్థనలు చేయడానికి మమ్మల్ని అనుమతిస్తుంది.
...
మీ యాప్‌కు పేరు పెట్టండి (మేము "My First NFT!" అని ఎంచుకున్నాము), చిన్న వివరణను అందించండి, మీ యాప్ బుక్‌కీపింగ్ కోసం ఉపయోగించే పర్యావరణం కోసం “Staging” ఎంచుకోండి మరియు మీ నెట్‌వర్క్ కోసం “Sepolia” ఎంచుకోండి.

“Create app” క్లిక్ చేయండి, అంతే! మీ యాప్ దిగువ పట్టికలో కనిపించాలి.

అద్భుతం, ఇప్పుడు మనం మన HTTP Alchemy API URLని సృష్టించాము కాబట్టి, దాన్ని మీ క్లిప్‌బోర్డ్‌కు కాపీ చేయండి...

…ఆపై దాన్ని మన `.env` ఫైల్‌కి జోడిద్దాం. మొత్తంగా, మీ .env ఫైల్ ఇలా ఉండాలి:
...
ఇప్పుడు మన వద్ద మన కాంట్రాక్ట్ ABI మరియు మన Alchemy API కీ ఉన్నాయి కాబట్టి, [Alchemy Web3](https://github.com/alchemyplatform/alchemy-web3)ని ఉపయోగించి మన స్మార్ట్ కాంట్రాక్ట్‌ను లోడ్ చేయడానికి మనం సిద్ధంగా ఉన్నాము.
...
## మీ NFTని లైవ్ వెబ్‌సైట్‌కి డిప్లాయ్ చేయండి

వినియోగదారులు ఇంటరాక్ట్ అవ్వడానికి మీ ప్రాజెక్ట్‌ను లైవ్‌లోకి తీసుకెళ్లడానికి సిద్ధంగా ఉన్నారా? మీ Minterని లైవ్ వెబ్‌సైట్‌కి డిప్లాయ్ చేయడం కోసం [React డిప్లాయ్‌మెంట్ డాక్యుమెంటేషన్](https://create-react-app.dev/docs/deployment/)ను తనిఖీ చేయండి.
...
బహుశా, మీ dapp ద్వారా ముద్రించబడిన NFTలను మీ వాలెట్‌లో ప్రదర్శించగలగాలని మీరు కోరుకుంటారు — కాబట్టి మా శీఘ్ర ట్యుటోరియల్ [మీ వాలెట్‌లో మీ NFTని ఎలా చూడాలి](/developers/tutorials/how-to-view-nft-in-metamask/)ని తప్పకుండా తనిఖీ చేయండి!
