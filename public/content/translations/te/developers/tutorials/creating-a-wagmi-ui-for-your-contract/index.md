...
`a && b` సింటాక్స్ [`a ? b : a`](https://www.w3schools.com/react/react_es6_ternary.asp) కోసం సంక్షిప్త రూపం. అంటే, `a`నిజమైతే అది`b`కు మదింపు చేయబడుతుంది మరియు లేకపోతే అది `a`కు మదింపు చేయబడుతుంది (ఇది `false`, `0`, మొదలైనవి కావచ్చు). ఒక నిర్దిష్ట షరతు నెరవేరినప్పుడు మాత్రమే ఒక కాంపోనెంట్ ప్రదర్శించబడాలని Reactకు చెప్పడానికి ఇది ఒక సులభమైన మార్గం.
