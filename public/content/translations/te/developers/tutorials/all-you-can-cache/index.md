...
4. మీ కాన్ఫిగరేషన్ కోసం `.env`ని సవరించండి:
   ...
   | పారామీటర్           | విలువ                                                                                                                                                               |
   | ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
   | MNEMONIC            | లావాదేవీకి చెల్లించడానికి తగినంత ETH ఉన్న ఖాతా కోసం నిమోనిక్. [మీరు Optimism Goerli నెట్‌వర్క్ కోసం ఉచిత ETHని ఇక్కడ పొందవచ్చు](https://optimismfaucet.xyz/). |
   | OPTIMISM_GOERLI_URL | Optimism Goerliకి URL. పబ్లిక్ ఎండ్‌పాయింట్, `https://goerli.optimism.io`, రేట్ పరిమితం చేయబడింది కానీ ఇక్కడ మనకు అవసరమైన దానికి సరిపోతుంది                                      |
...
5. `index.js`ని రన్ చేయండి.
   ...
   ఈ నమూనా అప్లికేషన్ మొదట WORMకి ఒక ఎంట్రీని వ్రాస్తుంది, కాల్ డేటాను మరియు Etherscanలో లావాదేవీకి లింక్‌ను ప్రదర్శిస్తుంది. ఆపై అది ఆ ఎంట్రీని తిరిగి చదువుతుంది మరియు అది ఉపయోగించే కీని మరియు ఎంట్రీలోని విలువలను (విలువ, బ్లాక్ సంఖ్య మరియు రచయిత) ప్రదర్శిస్తుంది.
...
ఇచ్చిన స్లాట్‌లోకి ఒకసారి మాత్రమే వ్రాయబడుతుంది, కాబట్టి మనం స్లాట్‌లను తిరిగి ఉపయోగించకుండా చూసుకోవడానికి టైమ్‌స్టాంప్‌ను ఉపయోగిస్తాము.
...
కాల్ డేటా హెక్స్ స్ట్రింగ్‌గా ఉండాలని Ethers ఆశిస్తుంది, `0x` తర్వాత సరి సంఖ్యలో హెక్సాడెసిమల్ అంకెలు ఉంటాయి. `key` మరియు `val` రెండూ `0x`తో ప్రారంభమవుతాయి కాబట్టి, మనం ఆ హెడర్‌లను తీసివేయాలి.
