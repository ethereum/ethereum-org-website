...
#### బాహ్యంగా యాక్సెస్ చేయగల ఫంక్షన్‌లు {#pair-external}
...
## పెరిఫెరీ కాంట్రాక్ట్‌లు {#periphery-contracts}
...
#### ద్రవ్యతను జోడించడం {#add-liquidity}
...
#### ద్రవ్యతను తీసివేయడం {#remove-liquidity}
...
### ఫిక్స్‌డ్ పాయింట్ ఫ్రాక్షన్స్ (UQ112x112) {#fixedpoint}
...
### ట్రాన్స్‌ఫర్ హెల్పర్ {#transfer-helper}
