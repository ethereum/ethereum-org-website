...
- `jsonrpc`: జేసన్-ఆర్‌పీసీ వెర్షన్—ప్రస్తుతం, `2.0` మాత్రమే సపోర్ట్ చేయబడుతుంది.
- `method`: ETH API పద్ధతి. [API రిఫరెన్స్ చూడండి.](/developers/docs/apis/json-rpc/)
...
_**గమనిక:** `https://eth-mainnet.alchemyapi.io/v2/demo`ని మీ స్వంత API కీ `https://eth-mainnet.alchemyapi.io/v2/**your-api-key`తో భర్తీ చేయండి._
...
**_గమనిక:_** దిగువ స్క్రిప్ట్‌లు **నోడ్ కాంటెక్స్ట్‌లో** రన్ చేయబడాలి లేదా **ఫైల్‌లో సేవ్ చేయబడాలి**, కమాండ్ లైన్ నుండి రన్ చేయకూడదు. మీకు ఇప్పటికే Node లేదా npm ఇన్‌స్టాల్ చేయబడి ఉండకపోతే, [Node.js ఇన్‌స్టాలేషన్ సూచనలను](https://nodejs.org/en/download/) అనుసరించండి.

మీరు Alchemyతో ఇంటిగ్రేట్ చేయగల అనేక [Web3 లైబ్రరీలు](/developers/docs/apis/javascript/) ఉన్నాయి, అయితే, మేము [Alchemy Web3](https://github.com/alchemyplatform/alchemy-web3)ని ఉపయోగించమని సిఫార్సు చేస్తున్నాము, ఇది Web3.jsకి డ్రాప్-ఇన్ రీప్లేస్‌మెంట్, ఇది Alchemyతో సజావుగా పనిచేయడానికి నిర్మించబడింది మరియు కాన్ఫిగర్ చేయబడింది. ఇది ఆటోమేటిక్ రీట్రైలు మరియు బలమైన WebSocket సపోర్ట్ వంటి బహుళ ప్రయోజనాలను అందిస్తుంది.
...
**1. మీరు ఇప్పటికే చేయకపోతే, మీ టెర్మినల్‌లో కొత్త ప్రాజెక్ట్ డైరెక్టరీని సృష్టించి, దానికి cd చేయండి:**
...
**2. మీరు ఇప్పటికే చేయకపోతే, మీ ప్రాజెక్ట్‌లోకి Alchemy Web3 (లేదా ఏదైనా Web3) డిపెండెన్సీని ఇన్‌స్టాల్ చేయండి:**
...
async విషయాల గురించి తెలియదా? ఈ [Medium పోస్ట్‌ను](https://medium.com/better-programming/understanding-async-await-in-javascript-1d81bb079b2c) చూడండి.

**4. నోడ్ ఉపయోగించి మీ టెర్మినల్‌లో దీన్ని రన్ చేయండి**
...
**వావ్! అభినందనలు! మీరు Alchemyని ఉపయోగించి మీ మొదటి Web3 స్క్రిప్ట్‌ను రాశారు 🎉**

తర్వాత ఏమి చేయాలో తెలియదా? మీ మొదటి స్మార్ట్ కాంట్రాక్ట్‌ను డిప్లాయ్ చేయడానికి ప్రయత్నించండి మరియు మా [హలో వరల్డ్ స్మార్ట్ కాంట్రాక్ట్ గైడ్‌లో](/developers/tutorials/hello-world-smart-contract/) కొంత Solidity ప్రోగ్రామింగ్‌తో ప్రాక్టికల్ అనుభవం పొందండి లేదా మరిన్ని ఉదాహరణల కోసం [Alchemy డాక్యుమెంటేషన్‌ను](https://www.alchemy.com/docs/) అన్వేషించడం కొనసాగించండి.

_[Alchemyలో ఉచితంగా సైన్ అప్ చేయండి](https://auth.alchemy.com/), మా [డాక్యుమెంటేషన్‌ను](https://www.alchemy.com/docs/) చూడండి మరియు తాజా వార్తల కోసం, [Twitter](https://twitter.com/AlchemyPlatform)లో మమ్మల్ని అనుసరించండి_.
