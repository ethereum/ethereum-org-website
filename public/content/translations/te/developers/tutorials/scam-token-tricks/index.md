...
skill: intermediate
breadcrumb: "స్కామ్ టోకెన్ ట్రిక్స్"
...
[ప్రామాణికంలో](https://eips.ethereum.org/EIPS/eip-20) పేర్కొనబడనప్పటికీ, సాధారణంగా కొత్త టోకెన్లను సృష్టించే ఫంక్షన్‌ను [`mint`](/developers/tutorials/erc20-annotated-code/#the-_mint-and-_burn-functions-_mint-and-_burn) అంటారు.
