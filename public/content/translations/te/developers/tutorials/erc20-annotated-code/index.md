...
సాధారణంగా Solidity లో మేము సందేశం పంపినవారి కోసం `msg.sender` ను ఉపయోగిస్తాము. అయితే, అది [OpenGSN](https://opengsn.org/) ను విచ్ఛిన్నం చేస్తుంది. మన టోకెన్‌తో ఈథర్‌లెస్ లావాదేవీలను అనుమతించాలనుకుంటే, మనం `_msgSender()` ను ఉపయోగించాలి. ఇది సాధారణ లావాదేవీల కోసం `msg.sender` ను తిరిగి ఇస్తుంది, కానీ ఈథర్‌లెస్ వాటి కోసం అసలు సంతకం చేసినవారిని తిరిగి ఇస్తుంది మరియు సందేశాన్ని ప్రసారం చేసిన కాంట్రాక్ట్‌ను కాదు.
