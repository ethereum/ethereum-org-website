...
| ----------- | ---------- | ---------- | ---------- | --------------------- | ---------- | ----------------------------------------- |
| `0x00-0x7f` | `0ppppppp` |            |            |                       |            | ఒకే బైట్ స్ట్రింగ్                        |
| `0x80-0xb7` | `10nnnnnn` | `pppppppp` | `...`      |                       |            | చిన్న స్ట్రింగ్ (0-55 బైట్లు)                 |
| `0xb8-0xbf` | `10111NNN` | `nnnnnnnn` | `...`      | `nnnnnnnn`/`pppppppp` | `pppppppp` | పొడవైన స్ట్రింగ్, పొడవు కోసం N+1 బైట్లు, తర్వాత పేలోడ్ |
| `0xc0-0xf7` | `11nnnnnn` | `pppppppp` | `...`      |                       |            | చిన్న జాబితా (0-55 బైట్లు)                   |
| `0xf8-0xff` | `11111NNN` | `nnnnnnnn` | `...`      | `nnnnnnnn`/`pppppppp` | `pppppppp` | పొడవైన జాబితా, పొడవు కోసం N+1 బైట్లు, తర్వాత పేలోడ్ |
