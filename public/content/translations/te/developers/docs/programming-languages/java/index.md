---
title: Java డెవలపర్‌ల కోసం ఎథీరియం
description: Java-ఆధారిత ప్రాజెక్ట్‌లు మరియు టూలింగ్‌ని ఉపయోగించి ఎథీరియం కోసం ఎలా డెవలప్ చేయాలో తెలుసుకోండి
lang: te
incomplete: true
---

<FeaturedText>Java-ఆధారిత ప్రాజెక్ట్‌లు మరియు టూలింగ్‌ని ఉపయోగించి ఎథీరియం కోసం ఎలా డెవలప్ చేయాలో తెలుసుకోండి</FeaturedText>

క్రిప్టోకరెన్సీ మరియు బ్లాక్‌చైన్ టెక్నాలజీ ప్రయోజనాలను ఉపయోగించుకునే వికేంద్రీకృత అప్లికేషన్‌లను (dapp) సృష్టించడానికి ఎథీరియంను ఉపయోగించండి. ఈ dappలు నమ్మదగినవిగా ఉంటాయి, అంటే వాటిని ఎథీరియంకు డిప్లాయ్ చేసిన తర్వాత, అవి ఎల్లప్పుడూ ప్రోగ్రామ్ చేసిన విధంగానే రన్ అవుతాయి. కొత్త రకాల ఆర్థిక అప్లికేషన్‌లను సృష్టించడానికి అవి డిజిటల్ ఆస్తులను నియంత్రించగలవు. అవి వికేంద్రీకృతంగా ఉంటాయి, అంటే ఏ ఒక్క సంస్థ లేదా వ్యక్తి వాటిని నియంత్రించలేరు మరియు వాటిని సెన్సార్ చేయడం దాదాపు అసాధ్యం.
...
- [IPFSతో Java అప్లికేషన్‌లో స్టోరేజీని నిర్వహించడం](https://kauri.io/article/3e8494f4f56f48c4bb77f1f925c6d926/managing-storage-in-a-java-application-with-ipfs)
- [Web3jతో Javaలో ERC20 టోకెన్‌లను నిర్వహించండి](https://kauri.io/article/d13e911bbf624108b1d5718175a5e0a0/manage-erc20-tokens-in-java-with-web3j)
...
- [Java స్మార్ట్ కాంట్రాక్ట్ డేటా కాష్‌ను రూపొందించడానికి Eventeumని ఉపయోగించడం](https://kauri.io/article/fe81ee9612eb4e5a9ab72790ef24283d/using-eventeum-to-build-a-java-smart-contract-data-cache)

## Java ప్రాజెక్ట్‌లు మరియు సాధనాలు {#java-projects-and-tools}

- [Web3j (ఎథీరియం క్లయింట్‌లతో ఇంటరాక్ట్ అవ్వడానికి లైబ్రరీ)](https://github.com/web3j/web3j)
- [ethers-kt (EVM-ఆధారిత బ్లాక్‌చైన్‌ల కోసం అసమాన (async), అధిక-పనితీరు గల Kotlin/Java/Android లైబ్రరీ.)](https://github.com/Kr1ptal/ethers-kt)
