...
ఎథీరియం బ్లాక్‌చైన్‌లో కాంట్రాక్ట్‌ను డిప్లాయ్ చేసినప్పుడు సాధారణంగా కాంట్రాక్ట్ చిరునామా ఇవ్వబడుతుంది. ఈ చిరునామా సృష్టికర్త యొక్క చిరునామా మరియు ఆ చిరునామా నుండి పంపబడిన లావాదేవీల సంఖ్య ("నాన్స్") నుండి వస్తుంది. ఈ విధంగా `CREATE` ఆపరేషన్ చిరునామాను పొందుతుంది.

కాంట్రాక్ట్‌లను [`CREATE2`](https://eips.ethereum.org/EIPS/eip-1014)తో కూడా డిప్లాయ్ చేయవచ్చు, ఇది సృష్టికర్త యొక్క చిరునామా, సృష్టికర్త ఎంచుకునే విలువ ("సాల్ట్") మరియు కాంట్రాక్ట్ సృష్టి కోడ్ యొక్క హాష్ నుండి చిరునామాను పొందుతుంది. ఇందులో నాన్స్ ప్రమేయం ఉండదు, కాబట్టి కాంట్రాక్ట్ ఉనికిలోకి రాకముందే చిరునామాను లెక్కించవచ్చు మరియు ఈలోగా సృష్టికర్త ఎన్ని ఇతర లావాదేవీలను పంపినప్పటికీ అది అలాగే ఉంటుంది. ఇది ఇంకా డిప్లాయ్ చేయబడని కాంట్రాక్ట్‌ను సూచించడాన్ని సాధ్యం చేస్తుంది.
