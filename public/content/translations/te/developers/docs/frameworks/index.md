...
- [Foundry బుక్](https://book.getfoundry.sh/)
...
**Ape -** **_Python డెవలపర్లు, డేటా సైంటిస్టులు మరియు సెక్యూరిటీ ప్రొఫెషనల్స్ కోసం స్మార్ట్ కాంట్రాక్ట్ డెవలప్‌మెంట్ టూల్._**
...
**ethers-kt -** **_EVM-ఆధారిత బ్లాక్‌చైన్‌ల కోసం Async, అధిక-పనితీరు గల Kotlin/Java/Android లైబ్రరీ._**
...
**Crossmint -** **_ఎంటర్‌ప్రైజ్-గ్రేడ్ Web3 డెవలప్‌మెంట్ ప్లాట్‌ఫారమ్, ఇది అన్ని ప్రధాన చైన్‌లు EVM చైన్‌లు (మరియు ఇతర వాటి)పై NFT అప్లికేషన్‌లను నిర్మించడానికి మిమ్మల్ని అనుమతిస్తుంది._**
...
- [ఓపెన్‌జెప్పెలిన్ Defender SDK](https://docs.openzeppelin.com/defender/sdk)
- [GitHub](https://github.com/OpenZeppelin/openzeppelin-sdk)
- [కమ్యూనిటీ ఫోరమ్](https://forum.openzeppelin.com/c/support/17)
- **ఓపెన్‌జెప్పెలిన్ SDK డెవలప్‌మెంట్ ముగిసింది**

**Catapulta -** **_మల్టీ-చైన్ స్మార్ట్ కాంట్రాక్ట్‌ల డిప్లాయ్‌మెంట్ టూల్, బ్లాక్ ఎక్స్‌ప్లోరర్‌లలో వెరిఫికేషన్‌లను ఆటోమేట్ చేస్తుంది, డిప్లాయ్ చేసిన స్మార్ట్ కాంట్రాక్ట్‌లను ట్రాక్ చేస్తుంది మరియు డిప్లాయ్‌మెంట్ రిపోర్ట్‌లను షేర్ చేస్తుంది, Foundry మరియు Hardhat ప్రాజెక్ట్‌ల కోసం ప్లగ్-అండ్-ప్లే._**
...
**Moccasin -** **_Titanoboaపై నిర్మించబడిన, Vyper కోసం వేగవంతమైన, Pythonic స్మార్ట్ కాంట్రాక్ట్ డెవలప్‌మెంట్ మరియు టెస్టింగ్ ఫ్రేమ్‌వర్క్._**

- [డాక్యుమెంటేషన్](https://cyfrin.github.io/moccasin/)
