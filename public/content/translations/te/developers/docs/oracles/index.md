...
##### డేటా ఖచ్చితత్వంపై ఓటింగ్/స్టేకింగ్ {#availability}
...
##### షెల్లింగ్ పాయింట్ యంత్రాంగాలు {#good-incentive-compatibility}
...
### లభ్యత {#applications-of-oracles-in-smart-contracts}
...
### మంచి ప్రోత్సాహక అనుకూలత {#retrieving-financial-data}
...
## స్మార్ట్ కాంట్రాక్ట్‌లలో ఆరకిల్స్ యొక్క అప్లికేషన్‌లు {#generating-verifiable-randomness}

ఎథీరియంలో ఆరకిల్స్ కోసం సాధారణ వినియోగ సందర్భాలు కింద ఇవ్వబడ్డాయి:

### ఆర్థిక డేటాను తిరిగి పొందడం {#getting-outcomes-for-events}
...
### ధృవీకరించదగిన యాదృచ్ఛికతను రూపొందించడం {#automating-smart-contracts}
...
### ఈవెంట్‌ల కోసం ఫలితాలను పొందడం {#use-blockchain-oracles}
...
### స్మార్ట్ కాంట్రాక్ట్‌లను ఆటోమేట్ చేయడం {#further-reading}
