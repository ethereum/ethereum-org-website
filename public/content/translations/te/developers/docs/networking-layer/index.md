...
![Ethereum ఏకాభిప్రాయ క్లయింట్ నెట్‌వర్కింగ్ లేయర్ యొక్క రేఖాచిత్రం](cons_client_net_layer.png)
![Ethereum ఎగ్జిక్యూషన్ క్లయింట్ నెట్‌వర్కింగ్ లేయర్ యొక్క రేఖాచిత్రం](exe_client_net_layer.png)
...
[ఏకాభిప్రాయం లేయర్ నెట్‌వర్క్ స్పెక్స్](https://github.com/ethereum/consensus-specs/blob/master/specs/phase0/p2p-interface.md#enr-structure)
...
[eth1/eth2 సంబంధం](https://ethresear.ch/t/eth1-eth2-client-relationship/7248)
