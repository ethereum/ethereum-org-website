...
## ZK-రోలప్ ఫీజులు ఎలా పనిచేస్తాయి? {#how-do-zk-rollup-fees-work}
...
## ZK-రోల్అప్‌లు ఎథీరియంను ఎలా స్కేల్ చేస్తాయి? {#scaling-ethereum-with-zk-rollups}

### లావాదేవీ డేటా కుదింపు {#transaction-data-compression}
...
### ZK-రోల్అప్‌ల లాభాలు మరియు నష్టాలు {#zk-rollups-pros-and-cons}
...
### ZK-రోల్అప్‌ల దృశ్య వివరణ {#zk-video}
...
## zkEVMపై ఎవరు పనిచేస్తున్నారు? {#zkevm-projects}
...
## ZK-రోల్అప్‌లపై తదుపరి పఠనం {#further-reading-on-zk-rollups}
...
## ట్యుటోరియల్స్: ఎథీరియంలో గోప్యత & శూన్య-జ్ఞాన {#tutorials}
