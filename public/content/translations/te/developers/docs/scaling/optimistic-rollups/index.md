...
##### రోలప్‌లోకి ప్రవేశించడం {#evm-compatibility}
...
##### రోలప్ నుండి నిష్క్రమించడం {#cross-chain-contract-calls}
...
#### 2. EVM అనుకూలత {#how-do-optimistic-rollup-fees-work}
...
#### 3. క్రాస్-చైన్ కాంట్రాక్ట్ కాల్‌లు {#scaling-ethereum-with-optimistic-rollups}
...
## ఆశావాద రోలప్ ఫీజులు ఎలా పనిచేస్తాయి? {#optimistic-rollups-pros-and-cons}
...
## ఆశావాద రోల్అప్‌లు ఎథీరియంను ఎలా స్కేల్ చేస్తాయి? {#optimistic-video}
...
### ఆశావాద రోల్అప్‌ల లాభాలు మరియు నష్టాలు {#further-reading-on-optimistic-rollups}
...
### ఆశావాద రోల్అప్‌ల దృశ్యమాన వివరణ {#tutorials}
