...
# స్థితిరాహిత్యం, స్టేట్ గడువు మరియు చరిత్ర గడువు {#statelessness}
...
- **చరిత్ర గడువు**: X బ్లాక్‌ల కంటే పాత స్టేట్ డేటాను విస్మరించడానికి నోడ్‌లను అనుమతిస్తుంది, కానీ ఎథేరియం క్లయింట్ స్టేట్ డేటాను ఎలా నిర్వహిస్తుందో అది మార్చదు.
- **స్టేట్ గడువు**: తరచుగా ఉపయోగించని స్టేట్ డేటా క్రియారహితం కావడానికి అనుమతిస్తుంది. క్రియారహిత డేటా పునరుత్థానం చేయబడే వరకు క్లయింట్లు దానిని విస్మరించవచ్చు.
- **బలహీన స్థితిరాహిత్యం**: బ్లాక్ ప్రొడ్యూసర్‌లకు మాత్రమే పూర్తి స్టేట్ డేటాకు యాక్సెస్ అవసరం, ఇతర నోడ్‌లు స్థానిక స్టేట్ డేటాబేస్ లేకుండా బ్లాక్‌లను ధృవీకరించగలవు.
- **బలమైన స్థితిరాహిత్యం**: ఏ నోడ్‌లకూ పూర్తి స్టేట్ డేటాకు యాక్సెస్ అవసరం లేదు.

## డేటా గడువు {#data-expiry}

### చరిత్ర గడువు {#history-expiry}
...
- చాలా తక్కువ హార్డ్‌వేర్ అవసరాలతో (ఉదా., ఫోన్‌లలో) అమలు చేయగల నోడ్‌లు
...
### బలహీన స్థితిరాహిత్యం {#weak-statelessness}
...
**బలహీన స్థితిరాహిత్యంలో బ్లాక్‌లను ప్రతిపాదించడానికి పూర్తి స్టేట్ డేటాకు యాక్సెస్ అవసరం కానీ బ్లాక్‌లను ధృవీకరించడానికి స్టేట్ డేటా అవసరం లేదు**

ఇది జరగాలంటే, ఎథేరియం క్లయింట్‌లలో [Verkle చెట్లు](/roadmap/verkle-trees/) ఇప్పటికే అమలు చేయబడి ఉండాలి. Verkle ట్రీలు అనేది Ethereum స్టేట్ డేటాను నిల్వ చేయడానికి ఒక రీప్లేస్‌మెంట్ డేటా స్ట్రక్చర్, ఇది డేటాకు చిన్న, స్థిరమైన సైజు "సాక్షులు" తోటివారి మధ్య పంపబడటానికి మరియు స్థానిక డేటాబేస్‌లకు వ్యతిరేకంగా బ్లాక్‌లను ధృవీకరించడానికి బదులుగా బ్లాక్‌లను ధృవీకరించడానికి ఉపయోగించబడుతుంది. [ప్రతిపాదకుడు-బిల్డర్ వేర్పాటు](/roadmap/pbs/) కూడా అవసరం, ఎందుకంటే ఇది బ్లాక్ బిల్డర్లను మరింత శక్తివంతమైన హార్డ్‌వేర్‌తో ప్రత్యేక నోడ్‌లుగా ఉండటానికి అనుమతిస్తుంది మరియు పూర్తి స్టేట్ డేటాకు యాక్సెస్ అవసరమైనవి అవే.

<ExpandableCard title="తక్కువ బ్లాక్ ప్రతిపాదకులపై ఆధారపడటం ఎందుకు ఫర్వాలేదు?" eventCategory="/roadmap/statelessness" eventName="clicked why is it OK to rely on fewer block proposers?">
...
L1 ధృవీకరణ కోసం zkEVM అనేది ఒక పరిపూరకరమైన సాంకేతికత, ఇది స్టేట్‌లెస్ ధృవీకరణను మరింత మెరుగుపరుస్తుంది. కేవలం విట్‌నెస్‌లను తనిఖీ చేయడానికి బదులుగా, వాలిడేటర్లు మొత్తం బ్లాక్ సరిగ్గా అమలు చేయబడిందని తెలిపే zero-knowledge రుజువును ధృవీకరించవచ్చు -- ఇది లావాదేవీలను మళ్ళీ అమలు చేయకుండానే క్రిప్టోగ్రాఫిక్ నిశ్చయతను అందిస్తుంది.
...
బలహీన స్థితి, చరిత్ర గడువు మరియు రాష్ట్ర గడువు అన్నీ పరిశోధన దశలో ఉన్నాయి మరియు ఇప్పటి నుండి చాలా సంవత్సరాల నుండి రవాణా చేయబడతాయని భావిస్తున్నారు. ఈ ప్రతిపాదనలన్నీ అమలు చేయబడతాయనే గ్యారెంటీ లేదు, ఉదాహరణకు, స్టేట్ ఎక్స్‌పైరీని మొదట అమలు చేస్తే చరిత్ర గడువును కూడా అమలు చేయవలసిన అవసరం లేదు. [Verkle చెట్లు](/roadmap/verkle-trees) మరియు [ప్రతిపాదకుడు-బిల్డర్ వేర్పాటు](/roadmap/pbs) వంటి ఇతర రోడ్‌మ్యాప్ అంశాలు కూడా ఉన్నాయి, అవి ముందుగా పూర్తి చేయబడాలి.

## మరింత సమాచారం {#further-reading}

- [స్థితిరాహిత్య ఎథేరియం అంటే ఏమిటి?](https://stateless.fyi/)
- [వైటలిక్ స్థితిరాహిత్యం AMA](https://www.reddit.com/r/ethereum/comments/o9s15i/impromptu_technical_ama_on_statelessness_and/)
- [స్టేట్ పరిమాణ నిర్వహణ సిద్ధాంతం](https://hackmd.io/@vbuterin/state_size_management)
...
- [స్థితిరాహిత్యం మరియు స్టేట్ గడువుకు మార్గాలు](https://hackmd.io/@vbuterin/state_expiry_paths)
- [EIP-4444 నిర్దేశం](https://eips.ethereum.org/EIPS/eip-4444)
- [EIP-4444 పై అలెక్స్ స్టోక్స్](https://youtu.be/SfDC_qUZaos)
- [స్థితిరాహిత్యంగా వెళ్లడం ఎందుకు అంత ముఖ్యం](https://dankradfeist.de/ethereum/2021/02/14/why-stateless.html)
- [అసలు స్థితిరాహిత్య క్లయింట్ భావన నోట్స్](https://ethresear.ch/t/the-stateless-client-concept/172)
- [స్టేట్ గడువుపై మరింత](https://hackmd.io/@vbuterin/state_size_management#A-more-moderate-solution-state-expiry)
- [స్టేట్ గడువుపై ఇంకా మరింత](https://hackmd.io/@vbuterin/state_expiry_paths#Option-2-per-epoch-state-expiry)
- [స్థితిరాహిత్య ఎథేరియం సమాచార పేజీ](https://stateless.fyi)
