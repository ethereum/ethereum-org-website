...
description: Sebuah gambaran umum tentang aset dunia nyata di Ethereum
lang: id
template: use-cases
emoji: ":house_buildings:"
image: /images/man-and-dog-playing.png
alt: Manusia dan anjing yang sedang bermain.
sidebarDepth: 2
summaryPoint1: Metode untuk mengubah komoditas berharga menjadi token digital.
summaryPoint2: Anda sekarang dapat memiliki sebagian dari objek atau aset kehidupan nyata, daripada harus membeli seluruh bangunan atau barang.
summaryPoint3: Hubungkan keuangan tradisional dengan ekosistem blockchain.
---

Aset dunia nyata (ATMR) merupakan token yang mewakili bentuk kekayaan yang ada, seperti real estat, emas, saham, karya seni, mesin, atau barang koleksi. Melakukan tokenisasi pada item-item ini akan mengubahnya ke dalam bentuk digital, sehingga dapat dibagi-bagi kepada beberapa pemilik dan memudahkan untuk memperdagangkannya.
...
Token RWA tidak memiliki suatu nilai intrinsik. Sebaliknya, mereka mencerminkan nilai item yang mereka wakili, sehingga nilai token berubah seiring dengan nilai item tersebut.
...
Salah satu tantangan RWA, pada tahap awal ini, adalah memastikan hubungan antara objek kehidupan nyata dan representasi digitalnya.

Sinyal positif adalah ketika proyek RWA memberikan bukti cadangan kepada investor, yaitu jaminan bahwa mereka adalah pemilik sah dari objek fisik yang mendukung token digital. Sebut saja Paxos, Tether Gold, atau Courtyard, yang telah disebutkan sebelumnya, yang semuanya menyimpan aset mereka dalam penyimpanan yang aman dan menawarkan opsi kepada pemiliknya untuk menukarkan token dengan aset fisiknya kapan saja.

Keterbatasan lainnya adalah apakah kepemilikan token diakui oleh sistem hukum di seluruh dunia. Dengan kata lain, apakah smart contract dapat ditegakkan di pengadilan, atau dapatkah pemegang token RWA mengklaim kepemilikan atas barang di dunia nyata?

Beberapa pelopor dalam hal menyiapkan kerangka hukum yang secara khusus mengakui tokenisasi termasuk Singapura, Uni Emirat Arab, Hong Kong, dan Swiss, yang memperkenalkan undang-undang pada tahun 2021 yang dijuluki ‘Undang-Undang Blockchain’ untuk mengatur teknologi seperti tokenisasi. Uni Eropa telah memulai proses pengaturan ATMR, sementara di Amerika Serikat, Securities and Exchange Commission diperkirakan akan mengeluarkan panduan mengenai ATMR di masa mendatang.

## Pelajari selengkapnya {#learn-more}

Pelajarilah [smart contract](/smart-contracts/) atau cari tahu lebih lanjut tentang kelas token yang berbeda, [non-fungible token (NFT)](/nft/).
