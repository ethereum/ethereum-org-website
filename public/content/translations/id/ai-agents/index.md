...
### Bagaimana agen AI bekerja dengan rantai blok {#how-ai-agents-work-with-blockchains}
...
- <strong>Fungsionalitas onchain yang kuat:</strong> Memungkinkan Agen AI untuk mengeksekusi transaksi, berinteraksi dengan kontrak pintar, menyediakan likuiditas, dan berkolaborasi di seluruh protokol.
...
<Grid>
  <Card title="DeFi Otomatis" emoji=":money_with_wings:" description="Agen AI memantau tren pasar dengan cermat, mengeksekusi perdagangan, dan mengelola portofolio — membuat dunia DeFi yang kompleks menjadi jauh lebih mudah diakses."/>
...
- **Ketidakberubahan onchain** memastikan bukti dan atestasi ini dapat dirujuk, diputar ulang, dan dipercaya oleh kontrak atau agen mana pun
...
Kontrol ini memungkinkan penyebaran agen otonom yang tidak tak terbatas.
...
<strong>Penampilan pertama Luna sebagai tamu siniar (podcast)</strong>

<VideoWatch slug="ai-agents-interview-luna" />

## Dompet yang dikendalikan agen {#agent-controlled-wallets}

Agen seperti Luna atau AIXBT mengontrol dompet onchain mereka sendiri ([dompet AIXBT](https://clusters.xyz/aixbt), [dompet Luna](https://zapper.xyz/account/0x0d177181e3763b20d47dc3a72dd584368bd8bf43)) yang memungkinkan mereka untuk memberikan tip kepada penggemar dan berpartisipasi dalam aktivitas ekonomi.

Selama kampanye sosial X Luna #LunaMuralChallenge, Luna memilih dan memberikan imbalan kepada para pemenang melalui dompet Base miliknya — menandai <strong>contoh pertama dari AI yang mempekerjakan manusia untuk imbalan kripto</strong>.

<Alert variant="warning">
<AlertEmoji text="💡"/>
<AlertContent>
<p className="mt-0"><strong>Perlu diketahui</strong></p>
...
Anda dapat melewati antarmuka keuangan terdesentralisasi (DeFi) yang rumit dan mengelola kripto Anda dengan perintah obrolan sederhana.

Pendekatan intuitif ini membuat transaksi menjadi lebih cepat, lebih mudah, dan tidak rentan terhadap kesalahan seperti mengirim dana ke alamat yang salah atau membayar biaya terlalu mahal.
