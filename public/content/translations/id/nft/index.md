...
<AlertContent className="justify-between flex-row items-center">
  <div>Jelajahi, beli, atau buat seni/barang koleksi NFT Anda sendiri...
</div>
...
Situs web ini juga memiliki nama domain alternatif yang didukung oleh NFT, **ethereum.eth**. Alamat `.org` kami dikelola secara terpusat oleh penyedia sistem nama domain (DNS), sedangkan ethereum`.eth` terdaftar di Ethereum melalui Ethereum Name Service (ENS). Dan itu dimiliki serta dikelola oleh kami. [Periksa catatan ENS kami](https://app.ens.domains/name/ethereum.eth)

[Lebih lanjut tentang ENS](https://app.ens.domains)
