...
DAO memungkinkan kita untuk bekerja dengan orang-orang yang sepemikiran di seluruh dunia tanpa harus mempercayai seorang pemimpin yang baik hati untuk mengelola dana atau operasi. Tidak ada CEO yang dapat menghabiskan dana sesuka hati atau CFO yang dapat memanipulasi pembukuan. Sebaliknya, aturan berbasis blockchain yang tertanam dalam kode menentukan bagaimana organisasi bekerja dan bagaimana dana dihabiskan.
...
Memulai sebuah organisasi dengan seseorang yang melibatkan pendanaan dan uang membutuhkan banyak kepercayaan pada orang yang bekerja dengan Anda. Namun, sulit untuk mempercayai seseorang yang hanya pernah berinteraksi dengan Anda di internet. Dengan DAO, Anda tidak perlu mempercayai siapa pun di dalam kelompok, cukup kode DAO tersebut, yang 100% transparan dan dapat diverifikasi oleh siapa saja.
...
| ----------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ |
| Biasanya datar, dan sepenuhnya didemokratisasi.                                                                                   | Biasanya hierarkis.                                                                            |
| Pemungutan suara oleh anggota diperlukan agar setiap perubahan dapat diimplementasikan.                                                           | Bergantung pada strukturnya, perubahan dapat dituntut dari satu pihak, atau pemungutan suara dapat ditawarkan.     |
...
| Semua aktivitas transparan dan sepenuhnya publik.                                                                           | Aktivitas biasanya bersifat pribadi, dan terbatas untuk publik.                                        |
...
Tulang punggung DAO adalah [kontrak pintar](/glossary/#smart-contract)-nya, yang menentukan aturan organisasi dan menyimpan perbendaharaan kelompok. Setelah kontrak aktif di [Ethereum](/), tidak ada yang dapat mengubah aturan kecuali melalui pemungutan suara. Jika ada yang mencoba melakukan sesuatu yang tidak tercakup oleh aturan dan logika dalam kode, itu akan gagal. Dan karena perbendaharaan juga ditentukan oleh kontrak pintar, itu berarti tidak ada yang dapat menghabiskan uang tanpa persetujuan kelompok. Ini berarti bahwa DAO tidak memerlukan otoritas pusat. Sebaliknya, kelompok membuat keputusan secara kolektif, dan pembayaran diotorisasi secara otomatis ketika pemungutan suara disahkan.

Hal ini dimungkinkan karena kontrak pintar tahan terhadap gangguan setelah aktif di Ethereum. Anda tidak bisa begitu saja mengedit kode (aturan DAO) tanpa disadari orang karena semuanya bersifat publik.

## Ethereum dan DAO {#ethereum-and-daos}

Ethereum adalah fondasi yang sempurna untuk DAO karena beberapa alasan:

- Konsensus Ethereum sendiri terdesentralisasi dan cukup mapan bagi organisasi untuk mempercayai jaringan tersebut.
...
Ada banyak pertimbangan saat mengelola DAO, seperti bagaimana pemungutan suara dan proposal bekerja.

### Delegasi {#governance-delegation}

Delegasi seperti versi DAO dari demokrasi perwakilan. Pemegang token mendelegasikan suara kepada pengguna yang mencalonkan diri dan berkomitmen untuk mengelola protokol serta tetap mendapat informasi.
...
Pada tahun 1977, Wyoming menemukan LLC, yang melindungi pengusaha dan membatasi tanggung jawab mereka. Baru-baru ini, mereka memelopori hukum DAO yang menetapkan status hukum untuk DAO. Saat ini Wyoming, Vermont, dan Kepulauan Virgin memiliki hukum DAO dalam beberapa bentuk.
...
Biasanya sepenuhnya [tanpa izin](/glossary/#permissionless), tergantung pada token yang digunakan. Sebagian besar token tata kelola ini dapat diperdagangkan tanpa izin di [pertukaran terdesentralisasi](/glossary/#dex). Yang lain harus diperoleh melalui penyediaan likuiditas atau 'proof-of-work' lainnya. Bagaimanapun, hanya dengan memegang token memberikan akses ke pemungutan suara.
...
[MakerDAO](https://makerdao.com) – Token MKR MakerDAO tersedia secara luas di pertukaran terdesentralisasi dan siapa pun dapat membeli untuk memiliki hak suara pada masa depan protokol Maker.

### Keanggotaan berbasis saham {#share-based-membership}

DAO berbasis saham lebih berizin, tetapi masih cukup terbuka. Setiap calon anggota dapat mengajukan proposal untuk bergabung dengan DAO, biasanya menawarkan upeti dengan nilai tertentu dalam bentuk token atau pekerjaan. Saham mewakili hak suara langsung dan kepemilikan. Anggota dapat keluar kapan saja dengan bagian proporsional mereka dari perbendaharaan.
...
Reputasi mewakili bukti partisipasi dan memberikan hak suara dalam DAO. Tidak seperti keanggotaan berbasis token atau saham, DAO berbasis reputasi tidak mentransfer kepemilikan kepada kontributor. Reputasi tidak dapat dibeli, ditransfer, atau didelegasikan; Anggota DAO harus mendapatkan reputasi melalui partisipasi. Pemungutan suara onchain dilakukan tanpa izin dan calon anggota dapat dengan bebas mengajukan proposal untuk bergabung dengan DAO dan meminta untuk menerima reputasi dan token sebagai hadiah sebagai imbalan atas kontribusi mereka.

_Biasanya digunakan untuk pengembangan terdesentralisasi dan tata kelola protokol dan [dapp](/glossary/#dapp), tetapi juga sangat cocok untuk beragam organisasi seperti badan amal, kolektif pekerja, klub investasi, dll._

#### Contoh terkenal {#reputation-example}

[DXdao](https://DXdao.eth.limo) – DXdao adalah kolektif berdaulat global yang membangun dan mengatur protokol dan aplikasi terdesentralisasi sejak 2019. Ini memanfaatkan tata kelola berbasis reputasi dan [konsensus holografik](/glossary/#holographic-consensus) untuk mengoordinasikan dan mengelola dana, yang berarti tidak ada yang bisa membeli jalan mereka untuk memengaruhi masa depan atau tata kelolanya.
...
- [Mulai sebuah koloni](https://colony.io/)
...
- [DAO bukanlah korporasi: di mana desentralisasi dalam organisasi otonom itu penting oleh Vitalik](https://vitalik.eth.limo/general/2022/09/20/daos.html)
...
- [Bisakah DAO Membangun Kota?](https://www.ted.com/talks/scott_fitsimones_could_a_dao_build_the_next_great_city) – [TED](https://www.ted.com/)
