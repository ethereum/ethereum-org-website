---
title: "Apa itu dapp? Aplikasi terdesentralisasi di rantai blok"
description: "Pengantar tentang aplikasi terdesentralisasi (dapp) dan perbedaannya dengan aplikasi tradisional."
lang: id
...
*Transkrip ini adalah salinan yang dapat diakses dari [transkrip video asli](https://www.youtube.com/watch?v=F50OrwV6Uk8) yang dipublikasikan oleh district0x Network. Transkrip ini telah diedit sedikit agar lebih mudah dibaca.*

#### Apa itu dapp? (0:01) {#what-is-a-dapp-001}
...
#### Bagaimana cara kerja dapp (0:29) {#how-dapps-work-029}
...
#### Manfaat keamanan (1:10) {#security-benefits-110}
...
#### Membangun dapp di Ethereum (1:23) {#building-dapps-on-ethereum-123}
...
#### Contoh: Ethlance (1:43) {#example-ethlance-143}
