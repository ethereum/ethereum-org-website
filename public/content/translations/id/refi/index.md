...
**[Pasar karbon sukarela (VCM)](https://climatefocus.com/so-what-voluntary-carbon-market-exactly/)** adalah mekanisme untuk mendanai proyek-proyek yang memberikan dampak positif terverifikasi pada emisi karbon, baik mengurangi emisi yang sedang berlangsung, atau menghilangkan gas rumah kaca yang sudah dipancarkan dari atmosfer. Proyek-proyek ini menerima aset yang disebut "kredit karbon" setelah diverifikasi, yang dapat mereka jual kepada individu dan organisasi yang ingin mendukung aksi iklim.
...
Meskipun perkembangannya selama beberapa dekade terakhir, VCM terus mengalami berbagai masalah:
...
Transisi VCM ke **pasar karbon digital (DCM)** baru berbasis rantai blok mungkin menjadi peluang untuk meningkatkan teknologi yang ada untuk memvalidasi, bertransaksi, dan mengonsumsi kredit karbon. Rantai blok memungkinkan data yang dapat diverifikasi secara publik, akses untuk berbagai pengguna, dan lebih banyak likuiditas.

Proyek-proyek ReFi menggunakan teknologi rantai blok untuk meringankan banyak masalah dari pasar tradisional:

- **Likuiditas terkonsentrasi di sejumlah kecil kumpulan likuiditas** yang dapat diperdagangkan secara bebas oleh siapa saja. Organisasi besar maupun pengguna individu dapat menggunakan kumpulan ini tanpa pencarian manual untuk penjual/pembeli, biaya partisipasi, atau pendaftaran sebelumnya.
- **Semua transaksi dicatat di rantai blok publik**. Jalur yang diambil setiap kredit karbon karena aktivitas perdagangan dapat dilacak selamanya segera setelah tersedia di DCM.
- **Kecepatan transaksi hampir instan**. Mengamankan kredit karbon dalam jumlah besar melalui pasar lama bisa memakan waktu berhari-hari atau berminggu-minggu, tetapi ini dapat dicapai dalam beberapa detik di DCM.
...
1. Registri seperti [Verra](https://verra.org/project/vcs-program/registry-system/) dan [Gold Standard](https://www.goldstandard.org/) memastikan bahwa proyek yang menciptakan kredit karbon dapat diandalkan. Mereka juga mengoperasikan basis data tempat kredit karbon digital berasal dan dapat ditransfer atau dihabiskan (dipensiunkan).

Ada gelombang baru proyek inovatif yang dibangun di atas rantai blok yang mencoba mendisrupsi petahana di sektor ini.

2. Jembatan karbon, alias penoken (tokenizer), menyediakan teknologi untuk mewakili atau mentransfer kredit karbon dari registri tradisional ke dalam DCM. Contoh penting termasuk [Toucan Protocol](https://toucan.earth/), [C3](https://c3.app/), dan [Moss.Earth](https://moss.earth/).
3. Layanan terintegrasi menawarkan kredit penghindaran dan/atau penghapusan karbon kepada pengguna akhir sehingga mereka dapat mengklaim manfaat lingkungan dari suatu kredit dan membagikan dukungan mereka terhadap aksi iklim kepada dunia.
...
- [Laporan terperinci oleh Satuan Tugas untuk Menskalakan Pasar Karbon Sukarela](https://www.iif.com/Portals/1/Files/TSVCM_Report.pdf)
