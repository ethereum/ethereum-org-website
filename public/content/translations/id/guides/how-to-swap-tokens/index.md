...
## 5. Tunggu transaksi diproses {#5-wait-for-the-transaction-to-be-processed}

Anda dapat melihat kemajuan transaksi di penjelajah rantai blok mana pun. Proses ini seharusnya tidak memakan waktu lebih dari 10 menit.
...
<AlertContent className="justify-between flex-row items-center">
  <div>Ingin belajar lebih lanjut?</div>
