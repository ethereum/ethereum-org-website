...
1. **Periksa alamat kontrak**. Token yang sah berasal dari organisasi yang sah, dan Anda dapat melihat alamat kontrak di situs web organisasi tersebut. Misalnya, [untuk `ARB` Anda dapat melihat alamat yang sah di sini](https://docs.arbitrum.foundation/deployment-addresses#token).
