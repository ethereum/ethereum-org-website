...
**Jangan pernah, dengan alasan apa pun, membagikan frasa pemulihan atau kunci privat Anda!**
...
Mengambil tangkapan layar dari frasa benih atau kunci privat Anda mungkin menyinkronkannya ke penyedia data cloud, yang dapat membuatnya dapat diakses oleh peretas. Mendapatkan kunci privat dari cloud adalah vektor serangan yang umum bagi peretas.

### Gunakan dompet perangkat keras {#use-hardware-wallet}

Dompet perangkat keras menyediakan penyimpanan luring (offline) untuk kunci privat. Dompet ini dianggap sebagai opsi dompet paling aman untuk menyimpan kunci privat Anda: kunci privat Anda tidak pernah menyentuh internet dan tetap sepenuhnya lokal di perangkat Anda.

Menyimpan kunci privat secara luring secara masif mengurangi risiko diretas, bahkan jika peretas mendapatkan kendali atas komputer Anda.
...
Versi tingkat tinggi dari hal ini terjadi pada Juli 2020, ketika akun Twitter selebritas dan organisasi terkemuka diretas. Peretas secara bersamaan memposting giveaway Bitcoin di akun yang diretas. Meskipun tweet yang menipu dengan cepat diketahui dan dihapus, para peretas masih berhasil lolos dengan 11 bitcoin (atau $500.000 pada September 2021).
...
- Jangan pernah membagikan kunci privat, frasa benih, atau kata sandi Anda
...
<AlertContent>
<AlertDescription>
    Awas: meskipun penipuan bergaya dukungan umumnya terjadi di Discord, penipuan ini juga dapat lazim terjadi di aplikasi obrolan apa pun tempat diskusi kripto terjadi, termasuk email.
</AlertDescription>
</AlertContent>
</Alert>
...
Pialang perdagangan kripto penipu mengklaim sebagai pialang mata uang kripto spesialis yang akan menawarkan untuk mengambil uang Anda dan berinvestasi atas nama Anda. Setelah penipu menerima dana Anda, mereka mungkin menuntun Anda, meminta Anda mengirim lebih banyak dana, sehingga Anda tidak kehilangan keuntungan investasi lebih lanjut, atau mereka mungkin menghilang sama sekali.

Para penipu ini sering menemukan target dengan menggunakan akun palsu di YouTube untuk memulai percakapan yang tampaknya alami tentang 'pialang' tersebut. Percakapan ini sering kali mendapat banyak suara positif (upvote) untuk meningkatkan legitimasi, tetapi semua suara positif tersebut berasal dari akun bot.

**Jangan memercayai orang asing di internet untuk berinvestasi atas nama Anda. Anda akan kehilangan kripto Anda.**
...
- Lakukan riset Anda tentang staking, pool likuiditas, atau cara lain untuk menginvestasikan kripto Anda
- Jarang, jika pernah, skema semacam itu sah. Jika memang sah, skema itu mungkin akan menjadi arus utama dan Anda pasti sudah mendengarnya.
...
Kesalahan umum adalah menggunakan kombinasi beberapa kata umum yang terkait. Kata sandi seperti ini tidak aman karena rentan terhadap teknik peretasan yang disebut serangan kamus (dictionary attack).
...
<AlertContent>
<AlertDescription>
    Menggunakan pengelola kata sandi akan mengurus pembuatan kata sandi yang kuat dan unik serta mengingatnya! Kami <strong>sangat</strong> menyarankan untuk menggunakannya, dan sebagian besar gratis!
</AlertDescription>
</AlertContent>
</Alert>
...
- Atau periksa [pengelola kata sandi yang direkomendasikan](https://www.privacytools.io/secure-password-manager) lainnya
