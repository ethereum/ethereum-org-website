...
# Keamanan dan pencegahan penipuan Ethereum {#introduction}
...
**Ingat: Tidak ada seorangpun dari ethereum.org yang akan menghubungi Anda. Jangan membalas surel yang mengatasnamakan support resmi Ethereum.**

<Divider />

## Keamanan kripto 101 {#crypto-security}
...
#### Jangan mengambil tangkapan layar dari frasa benih/kunci pribadi Anda {#screenshot-private-keys}
...
Secara tidak sengaja mengirim crypto ke alamat dompet yang salah adalah kesalahan umum. **Transaksi yang dikirim di Ethereum tidak dapat dibatalkan.** Kecuali Anda mengetahui pemilik alamat dan dapat meyakinkan mereka untuk mengirim kembali dana Anda, Anda tidak akan dapat mengambil kembali dana Anda.

Selalu pastikan alamat yang Anda kirim sama persis dengan alamat penerima yang diinginkan sebelum melakukan transaksi.
Sebaiknya, saat berinteraksi dengan kontrak pintar, bacalah pesan transaksi sebelum menandatanganinya.
...
Ada metode untuk memalsukan fitur pratayang tautan (unfurling) Twitter (juga dikenal sebagai X) untuk mungkin menipu pengguna agar berpikir mereka mengunjungi situs web yang sah. Teknik ini mengeksploitasi mekanisme Twitter untuk menghasilkan pratinjau URL yang dibagikan dalam tweet, dan menampilkan _dari ethereum.org_ sebagai contoh (ditunjukkan di atas), padahal sebenarnya mereka dialihkan ke situs jahat.
...
<AlertContent>
<AlertDescription>
    Hati-hati: meskipun penipuan gaya dukungan biasanya terjadi di Discord, penipuan ini juga dapat terjadi di aplikasi obrolan mana pun tempat diskusi kripto berlangsung, termasuk email.
</AlertDescription>
</AlertContent>
</Alert>
...
Menjelang [Penggabungan](/roadmap/merge/), para penipu memanfaatkan kebingungan seputar istilah 'Eth2' untuk mencoba membuat pengguna menukarkan ETH mereka dengan token 'ETH2'. Tidak ada 'ETH2', dan tidak ada token sah lain yang diperkenalkan bersamaan dengan Penggabungan. ETH yang Anda miliki sebelum Penggabungan masih sama dengan ETH yang sekarang. **Tidak ada tindakan yang perlu Anda lakukan terkait ETH Anda untuk memperhitungkan peralihan dari bukti kerja ke bukti-taruhan**.

Penipu mungkin muncul dalam bentuk "bantuan", memberi tahu Anda bahwa jika Anda mendepositkan ETH Anda, Anda akan menerima 'ETH2' kembali. Tidak ada [dukungan resmi Ethereum](/community/support/), dan tidak ada token baru. Jangan pernah membagikan frasa benih dompet Anda dengan siapa pun.

_Catatan: Ada token/ticker turunan yang mungkin mewakili ETH yang dipertaruhkan (misalnya, rETH dari Rocket Pool, stETH dari Lido, ETH2 dari Coinbase), tetapi ini bukanlah sesuatu yang perlu Anda "migrasikan"._
...
[Selengkapnya tentang menghindari penipuan phishing](https://support.mycrypto.com/staying-safe/mycrypto-protips-how-not-to-get-scammed-during-ico)
...
[Pria kehilangan $200rb dalam penipuan pool penambangan](https://www.reddit.com/r/CoinBase/comments/r0qe0e/scam_or_possible_incredible_payout/)
...
[Selengkapnya tentang penipuan airdrop](https://www.youtube.com/watch?v=LLL_nQp1lGk)

<Divider />

## Keamanan web 101 {#web-security}
...
[Selengkapnya tentang membuat kata sandi yang kuat](https://terranovasecurity.com/how-to-create-a-strong-password-in-7-easy-steps/)

### Gunakan kata sandi unik untuk semuanya {#use-unique-passwords}

Kata sandi yang kuat yang telah terungkap dalam pelanggaran data tidak lagi merupakan kata sandi yang kuat. Situs web [Have I Been Pwned](https://haveibeenpwned.com) memungkinkan Anda memeriksa apakah akun Anda terlibat dalam pelanggaran data publik. Jika ya, **segera ubah kata sandi tersebut**. Menggunakan kata sandi yang unik untuk setiap akun mengurangi risiko peretas mendapatkan akses ke semua akun Anda jika salah satu kata sandi tersebut terkompromi.
...
<AlertContent>
<AlertDescription>
    Menggunakan pengelola kata sandi akan membantu Anda membuat kata sandi yang kuat, unik, dan mengingatnya! Kami <strong>sangat</strong> merekomendasikan untuk menggunakannya, dan sebagian besar di antaranya gratis!
</AlertDescription>
</AlertContent>
</Alert>
...
- Atau lihat [pengelola kata sandi lain yang direkomendasikan](https://www.privacytools.io/secure-password-manager)
...
Menggunakan **Autentikasi Dua Faktor (2FA)** memberikan _faktor keamanan_ tambahan untuk akun online Anda. 2FA memastikan bahwa hanya memiliki kata sandi saja tidak cukup untuk mengakses akun. Umumnya, faktor kedua adalah kode 6 digit acak, yang dikenal sebagai **kata sandi sekali pakai berbasis waktu (TOTP)**, yang dapat Anda akses melalui aplikasi autentikator seperti Google Authenticator atau Authy. Ini berfungsi sebagai faktor "sesuatu yang Anda miliki" karena benih yang menghasilkan kode waktunya disimpan di perangkat Anda.
...
[Selengkapnya tentang risiko ekstensi peramban](https://www.kaspersky.co.uk/blog/browser-extensions-security/12750/)
...
- [Hingga 3 juta perangkat terinfeksi oleh add-on Chrome dan Edge yang mengandung malware](https://arstechnica.com/information-technology/2020/12/up-to-3-million-devices-infected-by-malware-laced-chrome-and-edge-add-ons/) - _Dan Goodin_
...
- [Masalah keamanan pada perangkat lunak komunikasi kripto umum](https://docs.salusec.io/untitled/web3-penetration-test/risks-in-social-media) - _Salus_
- [Panduan Keamanan untuk Pemula dan Orang Pintar Sekalipun](https://medium.com/mycrypto/mycryptos-security-guide-for-dummies-and-smart-people-too-ab178299c82e) - _MyCrypto_
...
- [Utas Twitter tentang email dan pesan phishing kripto yang umum](https://twitter.com/tayvano_/status/1516225457640787969) - _Taylor Monahan_
