...
Contoh pertama akan memanggil metode "konstan" dan mengeksekusi metode kontrak pintarnya di EVM tanpa mengirimkan transaksi apa pun. Untuk ini kita akan membaca saldo ERC-20 dari sebuah alamat. [Baca artikel kami tentang token ERC-20](/developers/tutorials/understand-the-erc-20-token-smart-contract/).
