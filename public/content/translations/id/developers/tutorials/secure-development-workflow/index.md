...
tags:
  ...
  - solidity
skill: intermediate
breadcrumb: Daftar periksa keamanan
lang: id
...
- Tinjau kontrak Anda dengan [Slither](https://github.com/crytic/slither). Alat ini memiliki lebih dari 40 detektor bawaan untuk kerentanan umum. Jalankan pada setiap check-in dengan kode baru dan pastikan mendapatkan laporan yang bersih (atau gunakan mode triase untuk membisukan masalah tertentu).
...
- Tinjau pencetak [inheritance-graph](https://github.com/trailofbits/slither/wiki/Printer-documentation#inheritance-graph) dari Slither. Hindari masalah shadowing yang tidak disengaja dan masalah linearisasi C3.
...
- Tinjau pencetak [vars-and-auth](https://github.com/trailofbits/slither/wiki/Printer-documentation#variables-written-and-authorization) dari Slither. Ini melaporkan kontrol akses pada variabel state.
...
- Tentukan properti keamanan di Solidity, untuk digunakan dengan [Echidna](https://github.com/crytic/echidna) dan [Manticore](https://manticore.readthedocs.io/en/latest/verifier.html). Fokus pada mesin state Anda, kontrol akses, operasi aritmatika, interaksi eksternal, dan kesesuaian standar.
...
Terakhir, perhatikan masalah yang tidak dapat dengan mudah ditemukan oleh alat otomatis:

- Kurangnya privasi: semua orang dapat melihat transaksi Anda saat sedang mengantre di dalam pool
- Transaksi front running
- Operasi kriptografi
- Interaksi berisiko dengan komponen keuangan terdesentralisasi (DeFi) eksternal
