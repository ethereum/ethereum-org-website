...
Komunitas Ethereum telah mengadopsi banyak standar yang membantu menjaga proyek (seperti [klien Ethereum](/developers/docs/nodes-and-clients/) dan dompet) tetap interoperabel di seluruh implementasi, dan memastikan kontrak pintar dan aplikasi terdesentralisasi (dapp) tetap dapat disusun.
...
- Jalur Standar: menjelaskan setiap perubahan yang memengaruhi sebagian besar atau semua implementasi Ethereum
- [Jalur Meta](https://eips.ethereum.org/meta): menjelaskan proses di seputar Ethereum atau mengusulkan perubahan pada suatu proses
- [Jalur Informasi](https://eips.ethereum.org/informational): menjelaskan masalah desain Ethereum atau memberikan panduan atau informasi umum kepada komunitas Ethereum
...
- [Jaringan](https://eips.ethereum.org/networking): peningkatan seputar devp2p dan Light Ethereum Subprotocol, serta usulan peningkatan pada spesifikasi protokol jaringan dari whisper dan Swarm.
