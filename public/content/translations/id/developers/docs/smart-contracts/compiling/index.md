...
description: Penjelasan tentang mengapa Anda perlu mengompilasi kontrak pintar dan apa yang sebenarnya dilakukan oleh kompilasi.
lang: id
incomplete: true
---
...
Ini disebut **opcode**. Opcode EVM adalah instruksi tingkat rendah yang dapat dieksekusi oleh Mesin Virtual Ethereum (EVM). Setiap opcode mewakili operasi tertentu, seperti operasi aritmatika, operasi logika, manipulasi data, alur kontrol, dll.

[Lebih lanjut tentang opcode](/developers/docs/evm/opcodes/)
