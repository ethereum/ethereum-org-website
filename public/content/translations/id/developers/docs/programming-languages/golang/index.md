...
- [Panduan Pemrogram Erigon](https://github.com/ledgerwatch/erigon/blob/devel/docs/programmers_guide/guide.md) - _Panduan bergambar termasuk pohon state, multi-bukti, dan pemrosesan transaksi_
...
- [Bekerja dengan Jaringan Privat Ethereum menggunakan Golang dan Geth](https://myhsts.org/tutorial-learn-how-to-work-with-ethereum-private-network-with-golang-with-geth.php)
...
- [Klien Seluler: Pustaka dan Simpul Ethereum Inproc](https://github.com/ethereum/go-ethereum/wiki/Mobile-Clients:-Libraries-and-Inproc-Ethereum-Nodes)
- [Dapp asli: Binding Go ke kontrak Ethereum](https://github.com/ethereum/go-ethereum/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts)
...
- [Erigon](https://github.com/ledgerwatch/erigon) - _Turunan Go Ethereum yang lebih cepat, dengan fokus pada simpul arsip_
- [Golem](https://github.com/golemfactory/golem) - _Golem menciptakan pasar global untuk daya komputasi_
- [Quorum](https://github.com/jpmorganchase/quorum) - _Implementasi berizin dari Ethereum yang mendukung privasi data_
- [Prysm](https://github.com/prysmaticlabs/prysm) - _Implementasi Go Ethereum 'Serenity' 2.0_
- [Eth Tweet](https://github.com/yep/eth-tweet) - _Twitter Terdesentralisasi: Layanan mikroblog yang berjalan di rantai blok Ethereum_
...
- [Open Ethereum Mining Pool](https://github.com/sammy007/open-ethereum-pool) - _Kumpulan penambangan Ethereum sumber terbuka_
- [Dompet HD Ethereum](https://github.com/miguelmota/go-ethereum-hdwallet) - _Derivasi Dompet HD Ethereum di Go_
- [Multi Geth](https://github.com/multi-geth/multi-geth) - _Dukungan untuk banyak jenis jaringan Ethereum_
...
- [SDK Golang Covalent](https://github.com/covalenthq/covalent-api-sdk-go) - _Akses data rantai blok yang efisien melalui SDK Go untuk 200+ rantai blok_
...
- [ConsenSys: Daftar Definitif Perkakas Pengembang Ethereum](https://web.archive.org/web/2023/https://media.consensys.net/an-definitive-list-of-ethereum-developer-tools-2159ce865974) | [Sumber GitHub](https://github.com/ConsenSys/ethereum-developer-tools-list)