...
- [siwe-rails-examples](https://github.com/signinwithethereum/siwe-rails-examples) - _Contoh SIWE menggunakan Ruby on Rails dengan pengontrol kustom_
- [omniauth-siwe](https://github.com/signinwithethereum/omniauth-siwe) - _Strategi OmniAuth untuk Sign In With Ethereum (SIWE)_
- [omniauth-nft](https://github.com/valthon/omniauth-nft) - _Strategi OmniAuth untuk mengautentikasi melalui kepemilikan NFT_
- [ethereum-on-rails](https://github.com/q9f/ethereum-on-rails) - _Templat Ethereum on Rails yang memungkinkan untuk menghubungkan MetaMask ke Ruby on Rails_
...
[Grup Telegram Ethereum Ruby](https://t.me/ruby_eth) adalah tuan rumah bagi komunitas yang berkembang pesat dan merupakan sumber daya khusus untuk diskusi tentang proyek-proyek di atas dan topik terkait.