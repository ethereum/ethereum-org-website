...
description: Cara mendapatkan analitik dan data onchain untuk digunakan dalam dapp Anda
lang: id
---
...
Anda harus memahami konsep dasar [Penjelajah Blok](/developers/docs/data-and-analytics/block-explorers/) agar dapat lebih memahami penggunaannya dalam konteks analitik data. Selain itu, biasakan diri Anda dengan konsep [indeks](/glossary/#index) untuk memahami manfaat yang ditambahkannya pada desain sistem.

Dalam hal dasar-dasar arsitektur, pahami apa itu [API](https://www.wikipedia.org/wiki/API) dan [REST](https://www.wikipedia.org/wiki/Representational_state_transfer), setidaknya secara teori.
...
[The Graph](https://thegraph.com/) adalah protokol pengindeksan yang menyediakan cara mudah untuk meminta data rantai blok melalui API terbuka yang dikenal sebagai subgraf.
...
Ikuti panduan [mulai cepat](https://thegraph.com/docs/en/quick-start/) ini untuk membuat, menyebarkan, dan meminta subgraf dalam waktu 5 menit.
