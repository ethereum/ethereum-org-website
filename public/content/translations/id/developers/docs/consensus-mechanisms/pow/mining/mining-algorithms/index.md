...
Untuk lebih memahami halaman ini, kami sarankan Anda membaca terlebih dahulu tentang [konsensus Bukti Kerja (PoW)](/developers/docs/consensus-mechanisms/pow) dan [penambangan](/developers/docs/consensus-mechanisms/pow/mining).
...
[Hashimoto](http://diyhpl.us/%7Ebryan/papers2/bitcoin/meh/hashimoto.pdf) adalah algoritma yang menambahkan ketahanan terhadap ASIC dengan menjadi terikat I/O (yaitu, pembacaan memori adalah faktor pembatas dalam proses penambangan). Teorinya adalah bahwa RAM lebih tersedia daripada komputasi; penelitian senilai miliaran dolar telah menyelidiki pengoptimalan RAM untuk berbagai kasus penggunaan, yang sering kali melibatkan pola akses yang hampir acak (karenanya disebut "random access memory"). Akibatnya, RAM yang ada kemungkinan cukup mendekati optimal untuk mengevaluasi algoritma tersebut. Hashimoto menggunakan rantai blok sebagai sumber data, yang secara bersamaan memenuhi (1) dan (3) di atas.

Dagger-Hashimoto menggunakan versi yang diubah dari algoritma Dagger dan Hashimoto. Perbedaan antara Dagger Hashimoto dan Hashimoto adalah bahwa, alih-alih menggunakan rantai blok sebagai sumber data, Dagger Hashimoto menggunakan kumpulan data yang dihasilkan secara khusus, yang diperbarui berdasarkan data blok setiap N blok. Kumpulan data ini dihasilkan menggunakan algoritma Dagger, yang memungkinkan penghitungan subset secara efisien yang spesifik untuk setiap nonce bagi algoritma verifikasi klien ringan. Perbedaan antara Dagger Hashimoto dan Dagger adalah bahwa, tidak seperti pada Dagger asli, kumpulan data yang digunakan untuk menanyakan blok bersifat semi-permanen, hanya diperbarui pada interval tertentu (misalnya, seminggu sekali). Ini berarti bahwa porsi upaya untuk menghasilkan kumpulan data mendekati nol, sehingga argumen Sergio Lerner mengenai percepatan memori bersama dapat diabaikan.
