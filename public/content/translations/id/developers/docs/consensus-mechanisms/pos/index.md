...
Menjalankan validator adalah sebuah komitmen. Validator diharapkan untuk memelihara perangkat keras dan konektivitas yang memadai untuk berpartisipasi dalam validasi blok dan proposal. Sebagai imbalannya, validator dibayar dalam bentuk ETH (saldo yang mereka stake meningkat). Di sisi lain, berpartisipasi sebagai validator juga membuka jalan baru bagi pengguna untuk menyerang jaringan demi keuntungan pribadi atau sabotase. Untuk mencegah hal ini, validator tidak akan mendapatkan hadiah ETH jika mereka gagal berpartisipasi saat dipanggil, dan stake mereka yang ada dapat dihancurkan jika mereka bertindak tidak jujur. Dua perilaku utama yang dapat dianggap tidak jujur: mengusulkan beberapa blok dalam satu slot (berdalih) dan mengirimkan atestasi yang bertentangan.

Jumlah ETH yang dipotong bergantung pada berapa banyak validator yang juga dipotong pada waktu yang hampir bersamaan. Ini dikenal sebagai ["penalti korelasi"](https://eth2book.info/latest/part2/incentives/slashing#the-correlation-penalty), dan ini bisa bersifat minor (kurang dari 0,1% stake untuk satu validator yang dipotong sendirian) atau dapat mengakibatkan 100% dari stake validator dihancurkan (peristiwa pemotongan massal). Penalti ini dikenakan di pertengahan periode keluar paksa yang dimulai dengan penalti langsung (1/4096 dari saldo efektif validator, hingga 0,5 ETH) pada Hari ke-1, penalti korelasi pada Hari ke-18, dan akhirnya, dikeluarkan dari jaringan pada Hari ke-36. Mereka menerima penalti atestasi minor setiap hari karena mereka hadir di jaringan tetapi tidak memberikan suara. Semua ini berarti serangan terkoordinasi akan memakan biaya yang sangat mahal bagi penyerang.
