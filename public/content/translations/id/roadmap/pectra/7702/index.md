...
Mengingat bahwa dompet akan memasukkan kontrak pendelegasian tertentu ke daftar putih (whitelist) untuk EIP-7702, dapp tidak boleh berharap untuk meminta otorisasi EIP-7702 secara langsung. Sebaliknya, integrasi harus terjadi melalui antarmuka dompet standar:
...
> Catatan: Tidak ada metode standar bagi dapp untuk meminta tanda tangan otorisasi EIP-7702 secara langsung. Dapp harus bergantung pada antarmuka dompet tertentu seperti ERC-6900 untuk memanfaatkan fitur EIP-7702.
...
- **Kemampuan Peningkatan (Upgradability)**: Memperbarui logika kontrak dengan mengarahkan proksi ke kontrak implementasi baru.

- **Logika Inisialisasi Kustom**: Menggabungkan fungsi inisialisasi di dalam proksi untuk mengatur variabel state yang diperlukan dengan aman.

Misalnya, [SafeEIP7702Proxy](https://docs.safe.global/advanced/eip-7702/7702-safe) menunjukkan bagaimana proksi dapat digunakan untuk menginisialisasi dan mengelola pendelegasian dengan aman di akun yang kompatibel dengan EIP-7702.
