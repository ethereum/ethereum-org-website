...
<ExpandableCard title="Mengapa Ethereum tidak bisa mengganti BLS dengan skema yang aman dari kuantum?" eventCategory="/roadmap/security/quantum-resistance" eventName="clicked why cant ethereum just replace BLS?">
...
<ExpandableCard title="Bisakah komputer kuantum mencuri ETH saya saat ini?" eventCategory="/roadmap/security/quantum-resistance" eventName="clicked can quantum computers steal my ETH today?">
...
<ExpandableCard title="Kapan komputer kuantum bisa menjadi ancaman?" eventCategory="/roadmap/security/quantum-resistance" eventName="clicked when could quantum computers become a threat?">
...
<ExpandableCard title="Apakah saya perlu melakukan sesuatu untuk melindungi dompet saya?" eventCategory="/roadmap/security/quantum-resistance" eventName="clicked will I need to do anything?">
...
<ExpandableCard title="Bagaimana dengan token, NFT, dan posisi DeFi saya?" eventCategory="/roadmap/security/quantum-resistance" eventName="clicked what about tokens NFTs DeFi?">
...
<ExpandableCard title="Apakah Ethereum tertinggal dari rantai blok lain dalam hal ini?" eventCategory="/roadmap/security/quantum-resistance" eventName="clicked is Ethereum behind?">
...
<ExpandableCard title="Apa itu 'panen sekarang, dekripsi nanti'?" eventCategory="/roadmap/security/quantum-resistance" eventName="clicked what is harvest now decrypt later?">
