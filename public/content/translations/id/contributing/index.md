---
title: "Berkontribusi pada ethereum.org 🦄"
metaTitle: Berkontribusi
description: Pelajari tentang berbagai cara Anda dapat berkontribusi pada ethereum.org
lang: id
---

Ethereum.org adalah proyek sumber terbuka dengan **12.000+** kontributor yang membantu menerjemahkan, menulis, mendesain, dan memelihara situs web ini.
...
**Terjemahan**
- [Laporkan kesalahan terjemahan](https://github.com/ethereum/ethereum-org-website/issues/new/choose) – [Program Terjemahan](/contributing/translation-program/) sedang dihentikan secara bertahap dan tidak lagi melakukan orientasi penerjemah baru

**Pengembangan**
- [Kerjakan masalah (issue) yang terbuka](https://github.com/ethereum/ethereum-org-website/issues) – Pekerjaan yang telah kami identifikasi dan perlu diselesaikan

**Desain**
- [Bantu mendesain situs web](/contributing/design/) – Desainer dari semua tingkatan dapat berkontribusi untuk meningkatkan situs web ini
...
- [Bagikan kisah Anda](/contributing/adding-community-stories/) - Kirimkan cerita tentang pengalaman pribadi Anda dengan teknologi sumber terbuka dan perlindungan (sanctuary), bagaimana ekosistem Ethereum telah memengaruhi hidup Anda, atau bagaimana Anda dan komunitas Anda menggunakan Ethereum
...
**Ide fitur**
- [Minta fitur](https://github.com/ethereum/ethereum-org-website/issues/new?assignees=&labels=Type%3A+Feature&template=feature_request.yaml&title=) – Beri tahu kami tentang ide apa pun yang Anda miliki untuk fitur atau desain baru
...
Ini adalah beberapa tugas saat ini yang dapat Anda bantu selesaikan dan ambil tanggung jawabnya. Untuk sebagian besar tugas, Anda akan memerlukan akun GitHub karena sebagian besar perubahan pada situs web dilakukan melalui GitHub.

<IssuesList my={8} />

<ButtonLink href="https://github.com/ethereum/ethereum-org-website/issues">Lihat semua tugas</ButtonLink>

## Cara bekerja di ethereum.org {#how-to-update-content}
...
Semua pembaruan dilakukan melalui proses PR GitHub. Ini berarti Anda membuat salinan lokal dari situs web, membuat perubahan, dan meminta untuk menggabungkan (merge) perubahan Anda. Jika Anda belum pernah melakukan ini sebelumnya, ikuti petunjuk di bagian bawah [repositori GitHub](https://github.com/ethereum/ethereum-org-website) kami.
...
Hanya gunakan karya asli Anda atau konten yang Anda miliki izin untuk menggunakannya saat menyumbangkan konten atau artefak apa pun ke ethereum.org. Banyak proyek dalam ekosistem Ethereum menggunakan lisensi sumber terbuka yang memungkinkan berbagi informasi secara bebas. Namun, jika Anda tidak dapat menemukan informasi ini, jangan mencoba menambahkannya ke ethereum.org. Setiap pull request yang dianggap sebagai plagiarisme akan ditolak.

## Baru mengenal sumber terbuka? {#new-to-open-source}

Kami memiliki masalah (issues) dengan hambatan masuk yang rendah di repositori GitHub kami yang dirancang khusus untuk pengembang yang baru mengenal sumber terbuka, berlabel [good first issue](https://github.com/ethereum/ethereum-org-website/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22).

## Klaim Onchain Achievement Token (OAT) Anda {#oat}

Jika kontribusi Anda digabungkan (merged) ke ethereum.org, Anda akan memiliki kesempatan untuk mengklaim lencana khusus di [Galxe](https://app.galxe.com/quest/ethereumorg). Onchain Achievement Token (OAT) adalah bukti bahwa Anda membantu membuat ekosistem ini menjadi sedikit lebih luar biasa.
...
Anda hanya boleh menggunakan dompet kustodian mandiri untuk mengklaim OAT. Jangan gunakan akun bursa atau akun lain yang kunci privatnya tidak Anda pegang, karena ini tidak akan memungkinkan Anda untuk mengakses dan mengelola OAT Anda.

## Klaim GitPOAP Anda {#claim-gitpoap}

GitPOAP juga akan secara otomatis mengenali kontribusi Anda yang telah digabungkan dan memungkinkan Anda mencetak POAP kontributor unik yang terpisah di platform mereka sendiri!


### Cara mengklaim {#how-to-claim-2}

1. Kunjungi [GitPOAP](https://www.gitpoap.io).
2. Hubungkan dengan dompet Anda atau bahkan dengan email Anda melalui opsi masuk (sign in).
3. Cari nama pengguna GitHub, alamat ETH, nama ENS, atau GitPOAP apa pun untuk memeriksa apakah Anda memenuhi syarat.
4. Jika akun GitHub Anda memenuhi syarat, maka Anda akan dapat mencetak GitPOAP!
