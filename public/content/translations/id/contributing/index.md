...
**Desain**
- [Bantu mendesain situs web](/contributing/design/) – Desainer dari semua tingkatan dapat berkontribusi untuk meningkatkan situs web
...
Hanya gunakan karya asli Anda atau konten yang Anda miliki izin untuk menggunakannya saat menyumbangkan konten atau artefak apa pun ke ethereum.org. Banyak proyek dalam ekosistem Ethereum menggunakan lisensi sumber terbuka yang memungkinkan berbagi informasi secara bebas. Namun, jika Anda tidak dapat menemukan informasi ini, jangan mencoba menambahkannya ke ethereum.org. Setiap permintaan tarik (pull request) yang dianggap sebagai plagiarisme akan ditolak.

## Baru mengenal sumber terbuka? {#new-to-open-source}

Kami memiliki masalah dengan hambatan masuk yang rendah di repositori GitHub kami yang dirancang khusus untuk pengembang yang baru mengenal sumber terbuka berlabel [good first issue](https://github.com/ethereum/ethereum-org-website/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22).
...
GitPOAP juga akan secara otomatis mengenali kontribusi Anda yang digabungkan dan memungkinkan Anda mencetak POAP kontributor unik yang terpisah di platform mereka sendiri!
