...
# Menambahkan lapisan ke-2 {#adding-layer-2}
...
Siapa saja bebas untuk mengusulkan menambahkan lapisan ke-2 ke dalam ethereum.org. Jika ada lapisan ke-2 yang kami lewatkan, **[silakan sarankan](https://github.com/ethereum/ethereum-org-website/issues/new?assignees=&labels=feature+%3Asparkles%3A%2Ccontent+%3Afountain_pen%3A&template=suggest_layer2.yaml)!**

Saat ini kami mencamtum daftar L2 pada halaman berikut:

- [Optimistic rollup](/developers/docs/scaling/optimistic-rollups/)
- [Zero-knowledge rollup](/developers/docs/scaling/zk-rollups/)
- [Lapisan ke-2](/layer-2/)
...
_Kami tidak menganggap solusi penskalaan lain yang tidak menggunakan Ethereum untuk ketersediaan data atau keamanan sebagai lapisan ke-2._

**Ethereum untuk ketersediaan data**

- Ketersediaan data merupakan faktor pembeda yang penting antara solusi pengukuran lain dengan lapisan ke-2. Sebuah proyek **harus** menggunakan Jaringan Utama Ethereum untuk ketersediaan data agar dapat dipertimbangkan untuk listing.
...
<ButtonLink href="https://github.com/ethereum/ethereum-org-website/issues/new?assignees=&labels=feature+%3Asparkles%3A%2Ccontent+%3Afountain_pen%3A&template=suggest_layer2.yaml">  Buat masalah</ButtonLink>
