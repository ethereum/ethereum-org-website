...
- **Jaringan lapisan 2** - dompet Anda mendukung pengguna untuk mengakses jaringan lapisan 2 (l2) secara default.
- **Menyesuaikan biaya gas** - dompet Anda memungkinkan pengguna untuk menyesuaikan biaya gas transaksi mereka (biaya dasar, biaya prioritas, biaya maksimum).
...
- **Beli kripto** - dompet Anda mendukung pengguna untuk membeli dan melakukan orientasi ke kripto secara langsung.
...
- **Multisig** - dompet Anda mendukung banyak tanda tangan untuk menandatangani sebuah transaksi.
- **Pemulihan sosial** - dompet Anda mendukung wali dan pengguna dapat memulihkan dompet mereka jika mereka kehilangan frasa benih mereka menggunakan wali ini.
