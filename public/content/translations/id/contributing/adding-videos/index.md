...
### Opsi 2: Buka sebuah pull request {#open-a-pull-request}

Jika Anda ingin menambahkan video itu sendiri, ikuti langkah-langkah berikut:
...
Gunakan tajuk (heading) `###` dengan stempel waktu untuk menandai bagian-bagian utama. Hal ini membuat transkrip mudah dipindai dan meningkatkan SEO.

Jika Anda tidak memiliki transkrip, Anda dapat membiarkan bagian isi kosong dan tim akan membuatnya.
...
Buka sebuah pull request dengan perubahan Anda ke cabang `dev`. Tim akan meninjau kiriman Anda dan memberikan umpan balik.
