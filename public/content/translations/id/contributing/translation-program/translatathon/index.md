...
<CardContainer>
  <EmojiCard
    ...
    description='Terjemahkan konten ethereum.org ke dalam bahasa Anda untuk membantu lebih banyak orang belajar tentang Ethereum'
  />
  <EmojiCard
    emoji=':trophy:'
    title='Menangkan hadiah'
    description='Menangkan bagian dari total hadiah berdasarkan posisi Anda di papan peringkat'
  />
  <EmojiCard
    emoji=':bulb:'
    title='Pelajari tentang Ethereum'
    description='Pelajari lebih lanjut tentang Ethereum sambil menerjemahkan dan bersaing untuk mendapatkan hadiah'
  />
</CardContainer>

## Pengantar {#introduction}

Kami percaya bahwa konten dan sumber daya orientasi [Ethereum](/) harus dapat diakses oleh semua orang, terlepas dari bahasa yang mereka gunakan.
...
<TwoColumnContent>
  <CardContent>
    <h3 className="mt-6 mb-3">Siapa yang dapat berpartisipasi?</h3>
  ...
  <CardContent>
    <h3 className="mt-6 mb-3">Apakah saya harus menjadi penerjemah?</h3>
...
<TwoColumnContent>
  ...
  <CardContent>
    <h3 className="mt-6 mb-3">Apakah saya harus familier dengan Ethereum?</h3>
