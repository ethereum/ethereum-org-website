...
<ExpandableCard title="Por que os dados aleatórios da KZG precisam permanecer secretos?" eventCategory="/roadmap/danksharding" eventName="clicked why does the KZG random data have to stay secret?">
