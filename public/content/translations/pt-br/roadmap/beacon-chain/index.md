...
E utilizar a prova de participação como mecanismo de consenso é um componente fundamental para [o Ethereum seguro, ecológico e dimensionável que temos agora](/roadmap/).

<Alert variant="update">
<AlertEmoji text=":money_bag:"/>
<AlertContent>
<AlertDescription>
  Se você estiver interessado em se tornar um validador e ajudar a manter o Ethereum seguro, [saiba mais sobre o conceito de participação](/staking/).
</AlertDescription>
</AlertContent>
</Alert>
