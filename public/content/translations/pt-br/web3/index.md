...
Web3 é a resposta para este dilema. Em vez de uma Web monopolizada por grandes empresas de tecnologia, a Web3 adota a descentralização e está sendo construída, operada e de propriedade de seus usuários. A Web3 coloca o poder nas mãos dos indivíduos e não das corporações.
Antes de falarmos sobre Web3, vamos explorar como chegamos aqui.

<Divider />

## A Web antiga {#early-internet}
...
![Arquitetura cliente-servidor, representando a Web 1.0](./web1.png)
...
![Arquitetura cliente-servidor, representando a Web 2.0](./web2.png)

<Divider />

## Web 3.0: Leitura-Escrita-Propriedade {#web3}

A premissa da 'Web 3.0' foi cunhada pelo cofundador do [Ethereum](/what-is-ethereum/), Gavin Wood, logo após o lançamento do Ethereum em 2014. Gavin colocou em palavras uma solução para um problema que muitos dos primeiros adeptos de criptomoedas sentiram: a Web exigia muita confiança. Ou seja, a maior parte da Web que as pessoas conhecem e usam hoje depende da confiança em um punhado de empresas privadas para agir no melhor interesse do público.

![Arquitetura de nós descentralizada, representando a Web3](./web3.png)

### O que é Web3? {#what-is-web3}

A Web 3 tornou-se um termo abrangente para a visão de uma Internet nova e melhor. Na sua essência, a Web3 usa blockchains, criptomoedas e NFTs para devolver poder aos usuários sob a forma de propriedade. [Uma publicação de 2020 no Twitter](https://twitter.com/himgajria/status/1266415636789334016) resumiu bem: a Web1 era somente leitura, a Web2 é leitura-escrita, a Web3 será leitura-escrita-propriedade.
...
- **A Web3 é descentralizada:** em vez de grandes porções da internet serem controladas e pertencentes a entidades centralizadas, a propriedade é distribuída entre seus construtores e usuários.
...
- **A Web3 não requer confiança:** ela opera usando incentivos e mecanismos econômicos, em vez de depender de terceiros confiáveis.
...
DAOs são tecnicamente definidos como [contratos inteligentes](/glossary/#smart-contract) acordados que automatizam a tomada de decisão descentralizada sobre um conjunto de recursos (tokens). Os usuários com tokens votam sobre como os recursos são gastos e o código executa automaticamente o resultado da votação.
...
A Web3 resolve esses problemas permitindo que você controle sua identidade digital com um endereço Ethereum e um perfil do [Serviço de Nomes Ethereum (ENS)](/glossary/#ens). O uso de um endereço Ethereum fornece um único login entre plataformas seguras, resistentes à censura e anônimas.

### Pagamentos nativos {#native-payments}

A infraestrutura de pagamento da Web2 depende de bancos e processadores de pagamento, excluindo pessoas sem contas bancárias ou aquelas que vivem dentro das fronteiras do país errado.
A Web3 usa tokens como [ETH](/glossary/#ether) para enviar dinheiro diretamente no navegador e não requer terceiros confiáveis.
...
Recursos importantes da Web3, como Entrar com Ethereum, ou seja, fazer login com o Ethereum, já estão disponíveis para qualquer pessoa usar a custo zero. Mas, o custo relativo das transações ainda é proibitivo para muitos. É menos provável que a Web3 seja utilizada em países menos ricos e em desenvolvimento devido às altas taxas de transação. No Ethereum, esses desafios estão sendo resolvidos através do [roteiro](/roadmap/) e de [soluções de escalabilidade de camada 2](/glossary/#layer-2). A tecnologia está pronta, mas precisamos de níveis mais altos de adoção na camada 2 para tornar a Web3 acessível a todos.

### Experiência do usuário {#user-experience}

A barreira técnica de entrada para o uso da Web3 é, atualmente, muito alta. Os usuários devem compreender as preocupações de segurança, entender a documentação técnica complexa e navegar por interfaces de usuário não intuitivas. [Provedores de carteiras](/wallets/find-wallet/), em particular, estão trabalhando para resolver isso, mas mais progresso é necessário antes que a Web3 seja adotada em massa.

### Educação {#education}

A Web3 introduz novos paradigmas que requerem o aprendizado de diferentes modelos mentais quando comparado com os usados na Web2.0. Uma iniciativa educacional semelhante aconteceu quando a Web1.0 estava ganhando popularidade no final dos anos 1990; os defensores da world wide web usaram uma série de técnicas educacionais para educar o público, desde metáforas simples (a superestrada da informação, navegadores, navegar na web) até [transmissões de televisão](https://www.youtube.com/watch?v=SzQLI7BxfYI). A Web3 não é difícil, mas é diferente. As iniciativas educacionais que informam os usuários da Web2 sobre esses paradigmas da Web3 são vitais para o seu sucesso.

O Ethereum.org contribui para a educação sobre a Web3 por meio do nosso [Programa de Tradução](/contributing/translation-program/), com o objetivo de traduzir conteúdo importante do Ethereum para o maior número possível de idiomas.
...
- [Explore os aplicativos Web3](/apps/)
- [Participe de uma DAO](/dao/)
- [Construa na Web3](/developers/)
...
- [O que é Web3? The Decentralized Internet of the Future Explained](https://www.freecodecamp.org/news/what-is-web3) – _Nader Dabit_
