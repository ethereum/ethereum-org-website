...
### <Emoji text=":one:" size={1} me="2" /> Forneça feedback sobre os primeiros protótipos de design {#design-critique}
...
### <Emoji text=":two:" size={1} me="2" /> Participe da pesquisa de levantamento {#answer-surveys}
...
### <Emoji text=":three:" size={1} me="2" /> Encontre problemas relacionados ao design no site e reporte-os {#report-design-issues}
...
### <Emoji text=":four:" size={1} me="2" /> Proponha mudanças de design {#propose-design-changes}
...
### <Emoji text=":five:" size={1} me="2" /> Construir o Sistema de Design juntos {#Contribute-to-design-system}
...
### <Emoji text=":six:" size={1} me="2" /> Escreva o conteúdo relacionado ao design no site {#write-design-articles}
...
### <Emoji text=":seven:" size={1} me="2" /> Desenhe novas ilustrações {#prepare-illustrations}
