---
title: "O que é um dapp? Aplicativo descentralizado na blockchain"
description: "Uma introdução aos aplicativos descentralizados (dapps) e como eles diferem dos aplicativos tradicionais."
lang: pt-br
...
*Esta transcrição é uma cópia acessível da [transcrição original do vídeo](https://www.youtube.com/watch?v=F50OrwV6Uk8) publicada pela district0x Network. Ela foi levemente editada para facilitar a leitura.*

#### O que é um dapp? (0:01) {#what-is-a-dapp-001}
...
#### Como os dapps funcionam (0:29) {#how-dapps-work-029}
...
#### Benefícios de segurança (1:10) {#security-benefits-110}
...
#### Construindo dapps no Ethereum (1:23) {#building-dapps-on-ethereum-123}
...
#### Exemplo: Ethlance (1:43) {#example-ethlance-143}
