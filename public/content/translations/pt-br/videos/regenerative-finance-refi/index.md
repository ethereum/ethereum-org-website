---
title: "As finanças regenerativas podem limpar a imagem suja da cripto?"
description: "A CNBC explora como as finanças regenerativas (ReFi) usam a tecnologia blockchain para financiar projetos ambientais e sociais."
lang: pt-br
...
breadcrumb: "Finanças Regenerativas"
---

Um vídeo explicativo da **CNBC Television** explorando o movimento de finanças regenerativas (ReFi), a interseção entre cripto e clima, como a blockchain está sendo usada para financiar projetos ambientais e se as ReFi podem limpar a reputação da cripto de ter um alto consumo de energia.
...
**Nirvaan Ranganathan:** O que é realmente legal sobre isso é que o que o Silvi está fazendo no Quênia pode ser feito em qualquer lugar do mundo porque é construído sobre trilhos de cripto, o que significa que as pessoas estão sendo incentivadas e pagas com tokens. Isso pode operar através de todas as fronteiras. Pode operar mesmo que alguém não tenha uma identidade reconhecida pelo governo e possa não ser capaz de receber dinheiro em uma conta bancária — eles ainda podem receber dinheiro em uma carteira de cripto de autocustódia, fazendo com que esse design funcione perfeitamente em qualquer lugar do mundo onde eles escolham implantar.
...
**Arlone** visitou a ReFi House em abril. Ele é o CEO da UpRight, uma plataforma de aceleração para fundadores da Web3. Seu principal programa, o Celo Camp, é uma aceleradora virtual para o ecossistema da Celo. O objetivo é ajudar fundadores de todo o mundo a lançar e escalar seus projetos. O Celo Camp recebe 800 inscrições por ano de startups em diferentes verticais, incluindo DeFi e NFTs. Executivos da UpRight dizem que no ano passado um número crescente de inscrições de ReFi chegou, destacando o crescente interesse de construtores globais entrando no espaço.
...
Romper com a indústria de energia é um objetivo bastante ambicioso, particularmente quando você está falando sobre uma base tecnológica que fará isso de forma diferente e uma base de governança via ReFi que fará isso de forma diferente. Há muitos incumbentes e muito em jogo. Estou muito animado com isso. Acho que é muito novo, e sempre hesito em colocar um rótulo em algo porque isso coloca muita pressão em algo que é realmente novo. Muitos desses experimentos vão falhar rápido — isso não significa que não haja algo muito valioso aqui e algo ao qual devamos dar crédito e espaço para que possa florescer, prosperar e, esperançosamente, criar mudanças que beneficiarão a todos nós.

**Repórter:** E, claro, ainda há aqueles que acreditam que a cripto é intrinsecamente ruim para o meio ambiente, mesmo após eventos como o The Merge do Ethereum em setembro do ano passado. O que você diria a essas pessoas?

**Nirvaan Ranganathan:** Em primeiro lugar, o mecanismo de consenso que é usado em uma blockchain pode realmente afetar sua eficiência energética. As redes de Prova de Participação (PoS) provaram ser muito eficientes em termos de energia. No momento, "refi" significa refinanciar sua casa para muitas pessoas no mundo, e as finanças regenerativas no último ano se tornaram um nome familiar dentro da comunidade cripto. Mas provavelmente levará mais um ano ou mais para realmente alcançar o público em geral. Os sistemas que as pessoas estão criando nessas comunidades de ReFi são tão grandes, tão empolgantes e tão ambiciosos que muitas pessoas agora estão começando a prestar atenção.