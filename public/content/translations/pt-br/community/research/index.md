...
# Áreas ativas de pesquisa sobre o Ethereum {#active-areas-of-ethereum-research}
...
Esse relatório publicado em maio de 2022 pela [DelphiDigital](https://members.delphidigital.io/reports/the-hitchhikers-guide-to-ethereum) fornece uma boa visão geral sobre o plano de ação do Ethereum.
...
A pesquisa sobre consenso está relacionada com o [mecanismo de prova de participação do Ethereum](/developers/docs/consensus-mechanisms/pos/). Alguns exemplos de tópicos de pesquisa sobre consenso são:
...
- [Explicando o Casper-FFG](https://medium.com/unitychain/intro-to-casper-ffg-9ed944d98b2d)
- [Artigo Gasper](https://arxiv.org/abs/2003.03052)

#### Pesquisa recente {#recent-research}

- [Consenso Ethresear.ch](https://ethresear.ch/c/consensus/29)
- [Dilema entre disponibilidade/finalidade](https://arxiv.org/abs/2009.04987)
- [Finalidade de slot único](https://ethresear.ch/t/a-model-for-cumulative-committee-based-finality/10259)
- [Separação proponente-construtor](https://notes.ethereum.org/@vbuterin/pbs_censorship_resistance)

### Execução {#execution}

A camada de execução é responsável pela execução de transações, pelo funcionamento da [Máquina Virtual Ethereum (EVM)](/developers/docs/evm/) e pela geração de cargas de execução para serem transferidas para a camada de consenso. Há muitas áreas ativas de pesquisa, incluindo:
...
- [Otimizações do banco de dados](https://github.com/ledgerwatch/erigon/blob/devel/docs/programmers_guide/db_faq.md)
...
- [Verkle e a proposta de expiração do estado](https://notes.ethereum.org/@vbuterin/verkle_and_state_expiry_proposal)
...
1. um cliente de consenso para manter o controle do início da blockchain, de propagar os blocos e processar a lógica de consenso
2. um cliente de execução para oferecer suporte à Máquina Virtual Ethereum e executar transações e contratos inteligentes

Consulte a [página de nós e clientes](/developers/docs/nodes-and-clients/) para obter mais detalhes sobre nós e clientes e para obter uma lista de todas as implementações de clientes atuais. Você também pode encontrar um histórico de todas as melhorias do Ethereum na página [página Histórico](/ethereum-forks/).
...
- [Vitalik: Sobre as pontes](https://old.reddit.com/r/ethereum/comments/rwojtk/ama_we_are_the_efs_research_team_pt_7_07_january/hrngyk8/)
- [Artigo sobre as pontes da blockchain](https://medium.com/1kxnetwork/blockchain-bridges-5db6afac44f8)
...
[Mais informações sobre a melhoria Dencun](/roadmap/dencun/)
...
[A execução de nós](/developers/docs/nodes-and-clients/run-a-node/) em hardware modesto é fundamental para manter a descentralização do Ethereum. Portanto, a pesquisa ativa para minimizar os requisitos de hardware para executar os nós é uma importante área de pesquisa.
...
- [Podcast da Zero Knowledge](https://zeroknowledge.fm/)
...
- [Três ataques à PoS Ethereum](https://arxiv.org/abs/2110.10086)
...
- [Staking líquido em Ethresear.ch](https://ethresear.ch/search?q=liquid%20staking)
...
- [Optimism: O caminho para transações por menos de um dólar](https://medium.com/ethereum-optimism/the-road-to-sub-dollar-transactions-part-2-compression-edition-6bb2890e3e92)
...
- [Canal de ferramentas de consenso do Discord Eth R&D](https://discordapp.com/channels/595666850260713488/746343380900118528)
...
- [Pilha Ethereum](/developers/docs/ethereum-stack/)
