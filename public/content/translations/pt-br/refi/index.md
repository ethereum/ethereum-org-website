...
summaryPoints:
  ...
  - "Uma tentativa de aproveitar o Ethereum para resolver crises de coordenação em nível global, como, por exemplo, a mudança climática"
  - "Uma ferramenta para dimensionar drasticamente ativos de benefícios ecológicos, como créditos de carbono verificados"
---

## O que é ReFi? {#what-is-refi}

**Finanças regenerativas (ReFi)** é um conjunto de ferramentas e ideias construídas com base em [blockchains](/glossary/#blockchain), que visam criar economias regenerativas, em vez de extrativistas ou exploradoras. No final das contas, os sistemas extrativistas esgotam os recursos disponíveis e entram em colapso; sem mecanismos regenerativos, eles não têm resiliência. O sistema ReFi opera com base no pressuposto de que a criação de valor monetário deve ser dissociada da extração insustentável dos recursos do nosso planeta e das nossas comunidades.
...
Um dos fundamentos da ReFi é o conceito de economia regenerativa criado por John Fullerton, do Capital Institute. Ele propôs [oito princípios interconectados](https://capitalinstitute.org/8-principles-regenerative-economy/) que fundamentam a saúde sistêmica:
...
Além do VCM, há também vários mercados de carbono exigidos pelo governo ('mercados de conformidade') que visam estabelecer um preço para o carbono por meio de leis ou regulamentos em uma jurisdição específica (por exemplo, país ou região), controlando a oferta de licenças a serem distribuídas. Os mercados de conformidade incentivam os poluidores na respectiva jurisdição a reduzir as emissões, mas não têm a capacidade de remover gases de efeito estufa que já foram emitidos.
...
- **O DCM é escalável** e pode atender às demandas de indivíduos e de corporações multinacionais.

### Componentes-chave do DCM {#key-components-dcm}

Quatro principais componentes compõem o cenário atual do DCM:

1. Registros como o [Verra](https://verra.org/project/vcs-program/registry-system/) e o [Gold Standard](https://www.goldstandard.org/) garantem que os projetos que criam créditos de carbono são confiáveis. Eles também podem operar os bancos de dados nos quias os créditos de carbono digitais se originam e podem ser transferidos ou utilizados (desativados).

Há uma nova onda de projetos inovadores baseados em blockchain que buscam desafiar os atores dominantes neste setor.

2. As carbon bridges ("pontes de carbono"), também conhecidas como tokenizadoras, oferecem tecnologia para representar ou transferir créditos de carbono de registros tradicionais para o DCM. Exemplos notáveis incluem [Toucan Protocol](https://toucan.earth/), [C3](https://c3.app/) e [Moss.Earth](https://moss.earth/).
...
- [Um relatório detalhado da Força-Tarefa para a Escalabilidade dos Mercados Voluntários de Carbono](https://www.iif.com/Portals/1/Files/TSVCM_Report.pdf)
- [Entrada do glossário da CoinMarketCap sobre ReFi, por Kevin Owocki e Evan Miyazono](https://coinmarketcap.com/academy/glossary/regenerative-finance-refi)
