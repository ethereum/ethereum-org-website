...
![Captura de tela do painel Grafana para monitoramento Geth (painel 1)](./grafana1.png)
...
![Captura de tela do painel Grafana para monitoramento Geth (painel 2)](./grafana2.png)

Ainda não existem data sources criados, clique em "Add data source" para definir um.

![Captura de tela do painel Grafana para monitoramento Geth (painel 3)](./grafana3.png)

Para esta configuração, selecione "InfluxDB" e prossiga.

![Captura de tela do painel Grafana para monitoramento Geth (painel 4)](./grafana4.png)
...
![Captura de tela do painel Grafana para monitoramento Geth (painel 5)](./grafana5.png)

Se tudo estiver completo e o InfluxDB estiver acessível, clique em "Save and test" e aguarde a confirmação aparecer.

![Captura de tela do painel Grafana para monitoramento Geth (painel 6)](./grafana6.png)
...
![Captura de tela do painel Grafana para monitoramento Geth (painel 7)](./grafana7.png)
...
![Captura de tela do painel Grafana para monitoramento Geth (painel 8)](./grafana8.png)
