...
Você deve entender os fundamentos do Ethereum e do [software cliente](/developers/docs/nodes-and-clients/). Recomenda-se familiaridade com a camada de rede e com [o whitepaper do Ethereum](/whitepaper/).

## Estruturas de dados {#data-structures}

### Tries Patricia Merkle {#patricia-merkle-tries}
...
[Mais sobre Tries Patricia Merkle](/developers/docs/data-structures-and-encoding/patricia-merkle-trie)

### Prefixo de Comprimento Recursivo {#recursive-length-prefix}
