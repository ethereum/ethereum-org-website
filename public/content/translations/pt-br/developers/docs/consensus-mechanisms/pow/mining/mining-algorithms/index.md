...
Para entender melhor esta página, recomendamos que você leia primeiro sobre o [consenso de prova de trabalho](/developers/docs/consensus-mechanisms/pow) e a [mineração](/developers/docs/consensus-mechanisms/pow/mining).
