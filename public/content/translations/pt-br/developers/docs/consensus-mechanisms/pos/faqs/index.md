...
- [Mais sobre como defender a prova de participação do Ethereum contra invasores](/developers/docs/consensus-mechanisms/pos/attack-and-defense)
- [Mais sobre o projeto da prova de participação](https://medium.com/@VitalikButerin/a-proof-of-stake-design-philosophy-506585978d51)
...
[Mais sobre remoção](/developers/docs/consensus-mechanisms/pos/rewards-and-penalties#slashing)
...
[Mais sobre stake grinding](https://eth2book.info/altair/part2/building_blocks/randomness/#randao-biasability)
...
- [Mais sobre remoção social](https://ercwl.medium.com/the-case-for-social-slashing-59277ff4d9c7)
...
[Mais sobre as condições de remoção](https://eth2book.info/altair/part2/incentives/slashing)
...
[Mais sobre o problema do 'nada em jogo'](https://vitalik.eth.limo/general/2017/12/31/pos_faq.html#what-is-the-nothing-at-stake-problem-and-how-can-it-be-fixed)
...
[Mais sobre a separação proponente-construtor](https://notes.ethereum.org/@fradamt/H1TsYRfJc#Original-basic-scheme)
...
[Mais sobre A Fusão](/roadmap/merge)
