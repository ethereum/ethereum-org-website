---
title: "O que acontece quando você financia a cultura, não apenas o código"
description: "O Ethereum provou que pode movimentar mais do que dinheiro. Agora, os fãs financiam, moldam e recebem créditos nos filmes que amam."
author: "Emily Yang"
team: "Shibuya"
tags:
  - "produção de filmes"
...
breadcrumb: Movimentando a cultura
lang: pt-br
---

> *Esta história foi originalmente publicada como [uma thread convidada no perfil @Ethereum no X](https://x.com/ethereum/status/1928462812554072540?s=20) em 30 de maio de 2025. Ela foi levemente editada para facilitar a leitura.*

## Jornada para a disrupção {#journey-to-disruption}
...
Meu primeiro momento viral aconteceu quando fiz o [vídeo de anúncio do Uniswap v3](https://x.com/Uniswap/status/1374069664297406467?s=20) em 2021, que teve mais de 500.000 visualizações em 24 horas.
...
## PleasrDAO e a ascensão da propriedade coletiva {#pleasrdao-and-the-rise-of-collective-ownership}

Não foi uma baleia. Foram 23 endereços de carteira que criaram uma DAO na hora para reunir fundos e vencer o leilão. Eles se autodenominaram [@PleasrDAO](https://x.com/PleasrDAO).
...
Mais tarde naquele verão, fiz os NFTs que financiaram coletivamente o [Ethereum: The Infinite Garden](https://ethereumfilm.xyz/watch-the-film/), o primeiro documentário em longa-metragem sobre o Ethereum.
...
## Construindo um estúdio sem intermediários {#building-a-studio-without-gatekeepers}

Comecei a [Shibuya](https://www.shibuya.film/) com [Maciej Kuciara](https://www.kuciara.com/). Nosso sonho: uma plataforma onde os criadores possam financiar coletivamente, publicar e evoluir histórias diretamente com suas comunidades. Sem intermediários. Apenas história, comunidade e código.

Nosso primeiro experimento foi uma série de anime chamada [White Rabbit](https://www.shibuya.film/series/white-rabbit). Arrecadamos >400 ETH com uma experiência interativa no estilo escolha-sua-própria-aventura:
...
## White Rabbit: Quando as histórias do Ethereum movimentam a cultura {#white-rabbit-when-ethereum-stories-move-culture}
...
*(Nota do editor: Após a publicação deste artigo, White Rabbit ganhou o [prêmio Emmy de Inovação Excepcional em Programação de Mídia Emergente - 2025](https://www.televisionacademy.com/shows/white-rabbit).)*
...
Se você amar um deles, pode financiar o próximo episódio e fazer parte dos créditos. Eles estão no ar e podem ser assistidos gratuitamente em [shibuya.film](https://www.shibuya.film/).
...
## Provando que o sistema funciona {#proving-the-system-works}
