...
### التصيّد الاحتيالي عبر إعلانات تويتر {#ad-phishing}

![تصيّد احتيالي عبر رابط على تويتر](./twitterPhishingScam.png)

هناك طريقة لتزييف ميزة معاينة الرابط (المعروفة أيضًا باسم X) على موقع تويتر (الكشف عنها) لخداع المستخدمين وإيهامهم بأنهم يزورون موقعًا ويب شرعيًا. تستغل هذه التقنية آلية تويتر لتوليد معاينات لعناوين URL التي تتم مشاركتها في التغريدات، وتُظهر _from ethereum.org_ على سبيل المثال (كما هو موضح أعلاه)، بينما في الواقع، تتم إعادة توجيههم إلى موقع خبيث.
...
![عملية احتيال على تويتر](./appleTwitterScam.png)
...
![عملية احتيال على يوتيوب](./youtubeScam.png)
...
![عملية احتيال دعم فني على ديسكورد](./discordScam.png)
...
<AlertContent>
<AlertDescription>
    تنبيه: على الرغم من أن عمليات الاحتيال التي تنتحل صفة الدعم الفني تحدث بشكل شائع على ديسكورد، إلا أنها يمكن أن تكون منتشرة أيضًا في أي تطبيقات دردشة تُجرى فيها نقاشات حول العملات الرقمية، بما في ذلك البريد الإلكتروني.
</AlertDescription>
</AlertContent>
</Alert>
...
_ملاحظة: هناك رموز/مؤشرات أسعار مشتقة قد تمثل عملة ETH المُجمَّدة (مثل rETH من روكيت بول، وstETH من Lido، وETH2 من كوين بيز)، ولكن هذه ليست أشياء تحتاج إلى "الترحيل إليها"._
...
![عملية احتيال وسيط تداول على يوتيوب](./brokerScam.png)
...
- [إصابة ما يصل إلى 3 ملايين جهاز ببرامج ضارة عبر إضافات كروم و Edge](https://arstechnica.com/information-technology/2020/12/up-to-3-million-devices-infected-by-malware-laced-chrome-and-edge-add-ons/) - _Dan Goodin_
...
- [سلسلة تغريدات على تويتر حول رسائل البريد الإلكتروني والرسائل الاحتيالية الشائعة في مجال العملات الرقمية](https://twitter.com/tayvano_/status/1516225457640787969) - _Taylor Monahan_
