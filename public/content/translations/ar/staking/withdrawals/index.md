...
lang: ar
template: staking
image: /images/saging/leslie-withdrawal.png
...
<AlertEmoji text="⚠️"/>
<AlertContent>
<AlertDescription><strong>يمكن تعيين عنوان سحب واحد فقط لكل حساب مدقق، لمرة واحدة فقط.</strong> بمجرد اختيار عنوان وتقديمه إلى طبقة الإجماع، لا يمكن التراجع عن هذا الإجراء أو تغييره مرة أخرى. تحقق جيدًا من ملكية ودقة العنوان الذي تم تقديمه قبل الإرسال.
</AlertDescription>
</AlertContent>
</Alert>
...
eventName="read more">
لا، إن عملية تقديم بيانات اعتماد السحب هي عملية يتم إجراؤها مرة واحدة، ولا يمكن تغييرها بمجرد إرسالها. </ExpandableCard>
...
يتعذَّر طلب سحب كميات مُحدّدة من ETH يدويًّا. </ExpandableCard>
...
eventName="read more">
لا. بمجرد خروج برنامج المدقق وسحب الرصيد بالكامل، سيتم تحويل أي أموال إضافية تم إيداعها في برنامج المدقق هذا تلقائيًّا إلى عنوان السحب أثناء عملية فحص المدقق التالية. لإعادة مراهنة عملة ETH، يجب تفعيل مدقق جديد. </ExpandableCard>
