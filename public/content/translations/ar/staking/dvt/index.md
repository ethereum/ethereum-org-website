...
# تقنية المدقق الموزع {#distributed-validator-technology}
...
تقوم بذلك من خلال **فصل المفتاح الخاص** المستخدم لتأمين مدقق **عبر عدة أجهزة كمبيوتر** منظمة في "مجموعة". وتتمثل ميزة ذلك في أن تجعل من الصعب للغاية على المهاجمين الوصول إلى المفتاح، لأنه لا يتم تخزينه بالكامل على جهاز واحد. كما تسمح لبعض العُقد بإيقاف الاتصال بالإنترنت، حيث يمكن إجراء التوقيع اللازم بواسطة مجموعة فرعية من الأجهزة في كل مجموعة. وهذا يقلل من نقاط العطل الفردية من الشبكة ويجعل مجموعة برنامج المدقق كلها أكثر قوة.

![رسم تخطيطي يوضح كيفية تقسيم مفتاح مدقق واحد إلى حصص مفاتيح وتوزيعها على عُقد متعددة بمكونات مختلفة.](./dvt-cluster.png)
...
1. **لامركزية** إجماع إثبات الحصة في إيثريوم
2. تضمن **حيوية** الشبكة
3. تخلق **قدرة على تحمل الأخطاء** للمدقق
4. تشغيل المدقق **بحد أدنى من الثقة**
5. **تقليل مخاطر الشطب** وفترة التعطل
6. **تحسين التنوع** (العميل، مركز البيانات، الموقع، التنظيم، إلخ.)
7. **أمان مُعزَّز** لإدارة مفاتيح المدقق

## ما آلية عمل تقنية برنامج المدقق الموزع؟ {#how-does-dvt-work}

تتضمن حلول تقنية برنامج المدقق الموزع المكونات التالية:

- **[مشاركة شامير السرية](https://medium.com/@keylesstech/a-beginners-guide-to-shamir-s-secret-sharing-e864efbf3648)** - يستخدم المدققون [مفاتيح BLS](https://en.wikipedia.org/wiki/BLS_digital_signature). يمكن جمع "حصص مفاتيح" ("حصص المفاتيح") BLS الفردية لتشكيل مفتاح واحد (توقيع). في تقنية برنامج المدقق الموزع، المفتاح الخاص لبرنامج المدقق هو توقيعات BLS لكل مشغّل في المجموعة.
- **[مخطط توقيع العتبة](https://medium.com/nethermind-eth/threshold-signature-schemes-36f40bc42aca)** - يحدد عدد حصص المفاتيح الفردية المطلوبة لمهام التوقيع، على سبيل المثال، 3 من أصل 4.
- **[توليد المفاتيح الموزع (DKG)](https://medium.com/toruslabs/what-distributed-key-generation-is-866adc79620)** - عملية تشفير تولّد حصص المفاتيح وتستخدم لتوزيع حصص مفتاح مدقق حالي أو جديد على العُقد في مجموعة.
- **[الحوسبة متعددة الأطراف (MPC)](https://messari.io/report/applying-multiparty-computation-to-the-world-of-blockchains)** - يتم إنشاء مفتاح المدقق الكامل سرًا باستخدام الحوسبة متعددة الأطراف. لا يعرف أي من المشغلات الفردية المفتاح الكامل - فكل مشغل فردي لا يعرف إلا الجزء ("الحصة") الخاص به من المفتاح.
- **بروتوكول الإجماع** - يختار بروتوكول الإجماع عقدة واحدة لتكون مقترح الكتل. تشارك العُقدة المختارة الكتلة مع بقية العُقد في المجموعة، التي تساهم بحصتها من المفتاح كي تتمكن من التوقيع الكلي. عندما يتم تجميع عدد كافٍ من حصص المفاتيح، يتم اقتراح الكتلة على إيثريوم.
...
## العيوب المحتملة لاستخدام تقنية DVT {#potential-drawbacks-of-using-dvt}

- **مكون إضافي** - تضيف إضافة عقدة DVT جزءًا آخر يمكن أن يكون معيبًا أو عرضة للاختراق. تتمثل إحدى طرق التقليل من هذا الخطر في السعي إلى إجراء عمليات تنفيذ متعددة لعقدة تقنية برنامج المدقق الموزع، وهو ما يعني وجود العديد من عملاء هذه التقنية (مثلما يوجد عملاء متعددون لطبقات إجماع الآراء والتنفيذ).
- **التكاليف التشغيلية** - بما أن تقنية DVT توزع المدقق على عدة أطراف، فهناك حاجة إلى المزيد من العُقد للتشغيل بدلاً من عقدة واحدة فقط، مما يؤدي إلى زيادة تكاليف التشغيل.
- **زيادة محتملة في زمن الاستجابة** - بما أن تقنية DVT تستخدم بروتوكول إجماع للوصول إلى إجماع بين العُقد المتعددة التي تشغل مدققًا، فمن المحتمل أن يؤدي ذلك إلى زيادة زمن الاستجابة.

## قراءة إضافية {#further-reading}

- [مواصفات مدقق إيثريوم الموزع (مستوى عالٍ)](https://github.com/ethereum/distributed-validator-specs)
- [المواصفات التقنية لمدقق إيثريوم الموزع](https://github.com/ethereum/distributed-validator-specs/tree/dev/src/dvspec)
- [تطبيق توضيحي لمشاركة شامير السرية](https://iancoleman.io/shamir/)
