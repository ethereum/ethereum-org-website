...
بالإضافة إلى المزايا التي أوضحناها في [مقدمة عن التحصيص](/staking/)، يأتي التحصيص مع مجمّع بعدد من المزايا المتميزة.
...
[المزيد عن مخاطر التحصيص الرمزية](https://notes.ethereum.org/@djrtwo/risks-of-lsd).
...
## استكشف مجمّعات التحصيص {#explore-staking-pools}
...
هناك العديد من أوجه التشابه بين خيارات التحصيص المجمَّعة هذه ومنصات التداول المركزية، مثل القدرة على تجميد مبالغ صغيرة من ETH وتجميعها معًا لتفعيل المدققين.
...
- [التحصيص مع روكيت بول - نظرة عامة على التحصيص](https://docs.rocketpool.net/guides/staking/overview.html) - _وثائق RocketPool_
