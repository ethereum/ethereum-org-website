...
"الحالة" في البيتكوين هي مجموعة جميع العملات المعدنية (تقنياً،"نواتج المعاملات غير المنفذه في الشبكه" أو UTXO) التي تم استخراجها ولم يتم إنفاقها بعدمع كل UTXO لديه تسمية ومالك (معرف بـ20 بايت عنوان والذي هو أساسا مفتاح التشفير العام <sup>[fn. تحتوي المعاملة على مدخل واحد أو أكثر، حيث يحتوي كل مدخل على مرجع إلى UTXO موجود وتوقيع تشفيري تم إنتاجه بواسطة المفتاح الخاص المرتبط بعنوان المالك، ومخرج واحد أو أكثر، حيث يحتوي كل مخرج على UTXO جديد لإضافته إلى الحالة.
