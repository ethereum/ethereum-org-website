...
إذا كانت لديك أي أسئلة أو اقتراحات أو ملاحظات، فلا تتردد في التواصل معنا عبر translations@ethereum.org، أو إرسال رسالة إلى @ethdotorg على كراودين، أو [الانضمام إلى ديسكورد الخاص بنا](https://discord.gg/ethereum-org)، حيث يمكنك مراسلتنا في قناة #translations أو التواصل مع أي من أعضاء الفريق.

## استخدام كراودين {#using-crowdin}

يمكنك العثور على التعليمات الأساسية حول كيفية الانضمام إلى المشروع في كراودين وكيفية استخدام محرر كراودين عبر الإنترنت على [صفحة برنامج الترجمة](/contributing/translation-program/#how-to-translate).

إذا كنت ترغب في معرفة المزيد عن كراودين واستخدام بعض ميزاته المتقدمة، فإن [قاعدة معارف كراودين](https://support.crowdin.com/online-editor/) تحتوي على الكثير من الأدلة المتعمقة والنظرات العامة على جميع وظائف كراودين.
...
## تحذيرات كراودين {#crowdin-warnings}
...
مثال على تحذير كراودين عند نسيان إضافة علامة إلى ترجمتك:
![مثال على تحذير كراودين](./crowdin-warning-example.png)
...
قد لا يكون هنالك ترجمات ثابتة لبعض المصطلحات في لغات أخرى, و تعرف عامة بشكلها الأصلي الإنجليزي. تتمثل هذه المصطلحات في المفاهيم الجديدة, مثل دليل على العمل (proof-of-work), إثبات الملكية (proof-of-stake), سلسلة المنارة (بيكون تشين), تجميد العملات (staking), الخ.
