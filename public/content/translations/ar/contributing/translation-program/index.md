...
برنامج الترجمة هو جهد تعاوني لترجمة موقع <span dir="ltr">ethereum.org</span> إلى لغات مختلفة من أجل جعل الموقع أكثر سهولة في الوصول إليه لمليارات الأشخاص غير الناطقين باللغة الإنجليزية حول العالم.
...
يهدف برنامج ترجمة موقع <span dir="ltr">ethereum.org</span> إلى جعل إيثيريوم في متناول الجميع من خلال ترجمة موقع <span dir="ltr">ethereum.org</span> ومحتوى إيثيريوم الآخر إلى أكبر عدد ممكن من اللغات.

اقرأ المزيد حول [مهمة ورؤية](/contributing/translation-program/mission-and-vision) برنامج ترجمة موقع <span dir="ltr">ethereum.org</span>.
...
تتم ترجمة موقع <span dir="ltr">Ethereum.org</span> بواسطة الآلاف من أعضاء المجتمع وهم الجزء الأساسي من برنامج الترجمة.
...
المساهمون في برنامج الترجمة مؤهلون للحصول على رموز OAT (رموز الإنجاز على السلسلة) مختلفة بناءً على عدد الكلمات المترجمة في عام 2024. رموز OAT هي رموز غير قابلة للاستبدال (NFTs) تثبت مساهمتك في برنامج ترجمة موقع <span dir="ltr">ethereum.org</span>. [المزيد حول رموز OAT](/contributing/translation-program/acknowledgements/#oats)
...
هل ترغب في المزيد من التعاون أو استخدام بعض موارد الترجمة لدينا؟ هل لديك أي ملاحظات حول الدليل؟ نود أن نسمع منك على <span dir="ltr">translations@ethereum.org</span>.
