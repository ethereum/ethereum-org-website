...
تُعد zkEVM للتحقق من L1 تقنية تكميلية يمكن أن تعزز التحقق عديم الحالة. بدلاً من مجرد فحص الشهود، يمكن للمُدقِّقين التحقق من برهان معرفة صفرية على أن البلوك بالكامل قد تم تنفيذه بشكل صحيح -- مما يوفر يقينًا تشفيريًا دون إعادة تنفيذ المعاملات.
