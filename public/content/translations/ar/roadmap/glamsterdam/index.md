...
إذا كنت ترغب في إضافة مقترح تحسين إيثريوم (EIP) قيد الدراسة لترقية جلامستردام، ولكن لم تتم إضافته إلى هذه الصفحة بعد، [تعرف على كيفية المساهمة في ethereum.org هنا](/contributing/). </AlertDescription> </AlertContent> </Alert>
