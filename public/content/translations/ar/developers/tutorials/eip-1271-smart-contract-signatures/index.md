...
description: "نظرة عامة على إنشاء توقيعات العقد الذكي والتحقق منها باستخدام EIP-1271. نستعرض أيضًا تنفيذ EIP-1271 المستخدم في Safe (المعروف سابقًا باسم غنوسيس Safe) لتقديم مثال عملي يمكن لمبرمجي العقود الذكية البناء عليه."
...
في هذا البرنامج التعليمي، نقدم نظرة عامة على التوقيعات الرقمية، وخلفية EIP-1271، والتنفيذ المحدد لـ EIP-1271 الذي يستخدمه [Safe](https://safe.global/) (المعروف سابقًا باسم غنوسيس Safe). كل ذلك معًا، يمكن أن يكون بمثابة نقطة انطلاق لتنفيذ EIP-1271 في عقودك الخاصة.
