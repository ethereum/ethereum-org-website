...
### SAML لمستخدمي إيثريوم {#saml-for-ethereum-people}
...
### إيثريوم لمستخدمي SAML {#ethereum-for-saml-people}
...
## استخدام توقيعات إيثريوم {#using-ethereum-signatures}
...
أسهل طريقة للحصول على المصادقات هي استخدام [واجهة برمجة تطبيقات جراف كيو إل](https://docs.attest.org/docs/developer-tools/api). نستخدم هذا الاستعلام:
...
- أضف مصادقة لعنوان بريدك الإلكتروني الخاص:
  ...
  4. وافق على المعاملة في محفظتك. ستحتاج إلى بعض ETH على [بلوكتشين أوبتيميزم](https://app.optimism.io/bridge/deposit) لدفع ثمن الغاز.
...
- `id`: معرف المصادقة. يمكنك استخدام هذه القيمة [لقراءة المصادقة على السلسلة](https://optimism.blockscout.com/address/0x4200000000000000000000000000000000000021?tab=read_proxy&source_address=0x4E0275Ea5a89e7a3c1B58411379D1a0eDdc5b088#0xa3112a64) للتحقق من صحة المعلومات من استعلام جراف كيو إل.
