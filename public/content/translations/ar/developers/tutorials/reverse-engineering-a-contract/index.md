...
![عرض كود التشغيل من إيثرسكان](opcode-view.png)
...
| الإزاحة | كود التشغيل | المكدس (بعد كود التشغيل)                                             |
| ------: | ----------- | --------------------------------------------------------------------------------------- |
|      64 | CALLVALUE   | [Wei](/glossary/#wei) المقدم من الاستدعاء. تسمى `msg.value` في سوليديتي |
...
يخبرنا إيثرسكان أن `1C` هو كود تشغيل غير معروف، لأنه [تمت إضافته بعد أن كتب إيثرسكان هذه الميزة](https://eips.ethereum.org/EIPS/eip-145) ولم يتم تحديثها. يُظهر لنا [جدول أكواد تشغيل محدث](https://github.com/wolflo/evm-opcodes) أن هذا هو إزاحة لليمين
...
|                                                                    الإزاحة | كود التشغيل  | كومة                                                                            |
| -------------------------------------------------------------------------: | ------------ | ------------------------------------------------------------------------------- |
| <span dir="ltr">99.63+40\*1.1018 = 143.702</span> | JUMPDEST     |                                                                                 |
|                                                                        145 | POP          |                                                                                 |
