---
title: "إعداد web3.js لاستخدام بلوكتشين إيثريوم في جافا سكريبت"
description: "تعرف على كيفية إعداد وتهيئة مكتبة web3.js للتفاعل مع بلوكتشين إيثريوم من تطبيقات جافا سكريبت."
author: "jdourlens"
...
في هذا البرنامج التعليمي، سنرى كيفية البدء في استخدام [web3.js](https://web3js.readthedocs.io/) للتفاعل مع بلوكتشين إيثريوم. يمكن استخدام ويب3.جي إس في كل من الواجهات الأمامية والخلفية لقراءة البيانات من البلوكتشين أو إجراء المعاملات وحتى نشر العقود الذكية.
...
لاختبار أننا قمنا بتهيئة مثيل ويب3 الخاص بنا بشكل صحيح، سنحاول استرداد رقم أحدث كتلة باستخدام دالة `getBlockNumber`. تقبل هذه الدالة رد اتصال كمعلمة وتُرجع رقم الكتلة كرقم صحيح.
...
يمكنك رؤية جميع الدوال المتاحة في مثيل ويب3 في [توثيق web3.js الرسمي](https://docs.web3js.org/).
...
توجد بدائل لـ web3.js مثل [إيثرز.جي إس](https://docs.ethers.io/) وهي شائعة الاستخدام أيضًا. في البرنامج التعليمي التالي، سنرى [كيفية الاستماع بسهولة إلى الكتل الواردة الجديدة على البلوكتشين ومعرفة ما تحتويه](https://ethereumdev.io/listening-to-new-transactions-happening-on-the-blockchain/).
