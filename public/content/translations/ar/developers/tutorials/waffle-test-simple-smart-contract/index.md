---
title: "اختبار عقد ذكي بسيط باستخدام مكتبة وافل"
description: "دليل تعليمي للمبتدئين"
author: "إيفا كوفالسكا"
tags: [ "العقود الذكيه ", "سوليديتي", "Waffle", "الاختبار" ]
skill: beginner
lang: ar
...
- يمكنك إنشاء مشروع جافا سكريبت أو تايب سكريبت جديد
- لديك بعض الخبرة الأساسية في الاختبارات في جافا سكريبت
- لقد استخدمت بعض مديري الحزم مثل yarn أو npm
- لديك معرفة أساسية جدًا بالعقود الذكية وسوليديتي
...
بعد ذلك، قم بإنشاء ملف تكوين وافل في الدليل الجذر للمشروع - `waffle.json` - ثم الصق التكوين التالي هناك:
...
أولاً، سنتحقق مما إذا كانت دالة التقسيم تغير بالفعل أرصدة محافظ المستلمين. إذا قسمنا 50 wei من حساب المرسل، فإننا نتوقع أن تزيد أرصدة كلا المستلمين بمقدار 25 wei. سنستخدم متطابق `changeBalances` الخاص بـ وافل:
...
بعد ذلك، سنختبر ما إذا كان حدث التحويل قد تم إصداره بعد كل عملية تحويل لـ wei. سنتحول إلى متطابق آخر من وافل:
...
لقد خطوت خطوتك الأولى الكبيرة نحو اختبار العقود الذكية باستخدام وافل!
