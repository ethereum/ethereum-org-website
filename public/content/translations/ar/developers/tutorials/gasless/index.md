...
## الخاتمة {#conclusion}
في هذه المرحلة، يجب أن تكون قادرًا على إنشاء تجربة خالية من الغاز لمستخدمي التطبيق اللامركزي (dapp) الخاص بك، على حساب بعض المركزية.

ومع ذلك، يعمل هذا فقط مع العقود الذكية التي تدعم <span dir="ltr">ERC-712</span>. لتحويل رمز مميز من نوع <span dir="ltr">ERC-20</span>، على سبيل المثال، من الضروري أن يتم توقيع المعاملة من قبل المالك بدلاً من مجرد رسالة. الحل الأبسط هو أن تكون الأصول مملوكة لعقد منفصل وليس لعنوان <span dir="ltr">EOA</span> (شكل بسيط من أشكال [تجريد الحساب](/roadmap/account-abstraction/)). يمكنك قراءة المزيد حول هذا الموضوع [في البرنامج التعليمي التكميلي](/developers/tutorials/gasless-token).
