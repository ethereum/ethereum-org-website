...
في هذه المرحلة، يجب أن تكون قادرًا على إنشاء تجربة خالية من الغاز لمستخدمي تطبيقك اللامركزي (dapp)، على حساب بعض المركزية.

ومع ذلك، لا يعمل هذا إلا مع العقود الذكية التي تدعم <span dir="ltr">ERC-712</span>. لتحويل رمز مميز من نوع <span dir="ltr">ERC-20</span>، على سبيل المثال، من الضروري أن يتم توقيع المعاملة من قبل المالك بدلاً من مجرد رسالة. أبسط حل هو ألا تكون الأصول مملوكة لعنوان <span dir="ltr">EOA</span>، بل لعقد منفصل (وهو شكل بسيط من أشكال [تجريد الحساب](/roadmap/account-abstraction/)). يمكنك قراءة المزيد عن ذلك [في البرنامج التعليمي التكميلي](/developers/tutorials/gasless-token).
