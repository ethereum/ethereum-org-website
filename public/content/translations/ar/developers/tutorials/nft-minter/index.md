...
[إليك رابط](https://ropsten.etherscan.io/address/0x4C4a07F737Bf57F6632B6CAB089B78f62385aCaE) للعقد الذكي ERC-721 لـ ⁦NFT⁩ الذي سنستدعيه في هذا البرنامج التعليمي. إذا كنت ترغب في معرفة كيف صنعناه، نوصي بشدة بالاطلاع على برنامجنا التعليمي الآخر، ["كيفية إنشاء ⁦NFT⁩"](https://www.alchemy.com/docs/how-to-create-an-nft).
