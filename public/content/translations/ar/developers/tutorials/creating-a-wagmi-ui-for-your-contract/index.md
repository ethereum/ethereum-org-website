...
هنا لدينا علامتان من هذا القبيل، `<Greeter />` (والتي تحتوي فعليًا على كود HTML الذي يتحدث إلى العقد) و[`<HTML-PLACEHOLDER-HTMLTAG-8d9513 />` لخط أفقي](https://www.w3schools.com/tags/tag_hr.asp).
