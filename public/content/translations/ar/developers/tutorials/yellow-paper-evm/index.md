...
| Parameter       | رمز التشغيل للوصول إلى البيانات                                                                       | نص سوليديتي البرمجي للوصول إلى البيانات                  |
| --------------- | ----------------------------------------------------------------------------------------------------- | -------------------------------------------------------- |
...
ربما لهذه الأسباب، كُتبت [مواصفات طبقة الإجماع](https://github.com/ethereum/consensus-specs/blob/dev/tests/core/pyspec/README.md) الأحدث بلغة بايثون. هناك [مواصفات طبقة التنفيذ بلغة بايثون](https://ethereum.github.io/execution-specs)، لكنها ليست كاملة. إلى أن تتم ترجمة الورقة الصفراء بأكملها أيضًا إلى لغة بايثون أو لغة مشابهة، ستستمر الورقة الصفراء في الخدمة، ومن المفيد أن تكون قادرًا على قراءتها.
