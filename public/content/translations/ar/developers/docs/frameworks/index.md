...
- تكوين للاتصال بشبكات Ethereum ونشر العقود، سواء إلى مثيل يعمل محليًا أو إحدى شبكات Ethereum العامة.
- توزيع التطبيقات اللامركزية - التكامل مع خيارات التخزين مثل IPFS.

## المتطلبات الأساسية {#prerequisites}

قبل الخوض في أطر العمل، نوصيك أولاً بقراءة مقدمتنا عن [التطبيقات اللامركزية](/developers/docs/dapps/) و[مكدس Ethereum](/developers/docs/ethereum-stack/).

## أطر العمل المتاحة {#available-frameworks}

**Foundry** - **_Foundry هي مجموعة أدوات سريعة للغاية ومحمولة ومعيارية لتطوير تطبيقات Ethereum_**

- [تثبيت Foundry](https://book.getfoundry.sh/)
- [كتاب Foundry](https://book.getfoundry.sh/)
- [دردشة مجتمع Foundry على Telegram](https://t.me/foundry_support)
...
**The Graph -** **_The Graph للاستعلام عن بيانات البلوكتشين بكفاءة._**
...
**Catapulta -** **_أداة نشر العقود الذكية متعددة السلاسل، وأتمتة عمليات التحقق في مستكشفات الكتل، وتتبع العقود الذكية المنشورة ومشاركة تقارير النشر، والتوصيل والتشغيل لمشاريع Foundry وHardhat._**

- [موقع الويب](https://catapulta.sh/)
- [الوثائق](https://catapulta.sh/docs)
- [Github](https://github.com/catapulta-sh)

**GoldRush (بدعم من Covalent) -** **_تقدم GoldRush مجموعة واجهات برمجة التطبيقات (API) الأكثر شمولاً لبيانات البلوكتشين للمطورين والمحللين والمؤسسات._** سواء كنت تبني لوحة معلومات للتمويل اللامركزي (DeFi)، أو محفظة، أو روبوت تداول، أو وكيل ذكاء اصطناعي، أو منصة امتثال، فإن واجهات برمجة التطبيقات للبيانات توفر وصولاً سريعًا ودقيقًا وسهل الاستخدام للمطورين إلى بيانات على السلسلة الأساسية التي تحتاجها_\*\*
