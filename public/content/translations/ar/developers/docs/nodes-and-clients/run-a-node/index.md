...
- [eth-docker](https://eth-docker.net/) - إعداد آلي باستخدام دوكر يركز على تجميد العملات السهل والآمن، ويتطلب معرفة أساسية بالمحطة الطرفية و دوكر، ويوصى به للمستخدمين الأكثر تقدمًا.
