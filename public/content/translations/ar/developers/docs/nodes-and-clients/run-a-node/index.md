...
#### حلول التوصيل والتشغيل (Plug-and-play) {#automatized-setup}
...
تحتاج إلى تحديث برنامج العميل الخاص بك بأحدث تصحيحات الأمان والميزات و[EIPs](/eips/). خاصة قبل [الشوكات الصلبة (hard forks)](/ethereum-forks/)، تأكد من أنك تقوم بتشغيل إصدارات العميل الصحيحة.
