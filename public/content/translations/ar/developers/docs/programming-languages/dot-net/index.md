...
description: "تعرف على كيفية التطوير لصالح إثيريوم باستخدام مشروعات وأدوات قائمة على دوت نت"
lang: ar
incomplete: true
---

<FeaturedText>تعلّم كيفية التطوير على إيثريوم باستخدام مشاريع وأدوات قائمة على دوت نت</FeaturedText>
...
قم بإنشاء تطبيقات لامركزية في مقدمة إثيريوم وتفاعل مع العقود الذكية باستخدام أدوات ولغات من حزمة تكنولوجيا مايكروسوفت - تدعم لغات C # و# Visual Basic دوت نت وF #، على أدوات مثل في إس كود وVisual Studio، في إطار عمل دوت نت Framework/.NET Core/.NET Standard. وانشر سلسلة كتل إثيريوم على Azure باستخدام سلسلة كتل مايكروسوفت Azure في غضون دقائق. اجلب عشق دوت نت إلى إثيريوم!

## بدء العمل مع العقود الذكية ولغة سوليديتي {#getting-started-with-smart-contracts-and-the-solidity-language}

**اخط خطواتك الأولي لدمج دوت نت مع إثيريوم**
...
**مقدمة إلى مكتبة نثيريوم وVS Code سوليديتي**

- [نيثيريوم، الشروع في العمل](https://docs.nethereum.com/en/latest/getting-started/)
- [تثبيت سوليديتي في VS Code](https://marketplace.visualstudio.com/items?itemName=JuanBlanco.solidity)
- [سير عمل مبرمج دوت نت لإنشاء واستدعاء عقود إيثريوم الذكية](https://medium.com/coinmonks/a-net-developers-workflow-for-creating-and-calling-ethereum-smart-contracts-44714f191db2)
- [تكامل العقود الذكية مع نيثيريوم](https://kauri.io/#collections/Getting%20Started/smart-contracts-integration-with-nethereum/#smart-contracts-integration-with-nethereumm)
- [ربط عقود دوت نت وبلوكتشين إيثريوم الذكية مع نيثيريوم](https://medium.com/my-blockchain-development-daily-journey/interfacing-net-and-ethereum-blockchain-smart-contracts-with-nethereum-2fa3729ac933)، متوفر أيضًا بـ [中文版](https://medium.com/my-blockchain-development-daily-journey/%E4%BD%BF%E7%94%A8nethereum%E9%80%A3%E6%8E%A5-net%E5%92%8C%E4%BB%A5%E5%A4%AA%E7%B6%B2%E5%8D%80%E5%A1%8A%E9%8F%88%E6%99%BA%E8%83%BD%E5%90%88%E7%B4%84-4a96d35ad1e1)
- [نيثيريوم - مكتبة تكامل دوت نت مفتوحة المصدر للبلوكتشين](https://kauri.io/#collections/a%20hackathon%20survival%20guide/nethereum-an-open-source-.net-integration-library/)
- [كتابة معاملات إيثريوم في قاعدة بيانات SQL باستخدام نيثيريوم](https://medium.com/coinmonks/writing-ethereum-transactions-to-sql-database-using-nethereum-fd94e0e4fa36)
...
- [Azure Key Vault ونيثيريوم](https://github.com/Azure-Samples/bc-community-samples/tree/master/akv-nethereum)
- [نيثيريوم.DappHybrid](https://github.com/Nethereum/Nethereum.DappHybrid)
- [البنية المرجعية للواجهة الخلفية لـ Ujo نيثيريوم](https://docs.nethereum.com/en/latest/nethereum-ujo-backend-sample/)
...
- [نيذرمايند](https://github.com/NethermindEth/nethermind) - _عميل إيثريوم دوت نت Core لأنظمة لينكس، وويندوز، وMacOS_
- [eth-utils](https://github.com/ethereum/eth-utils/) - _وظائف مساعدة للعمل مع قواعد التعليمات البرمجية المتعلقة بإيثريوم_
- [TestChains](https://github.com/Nethereum/TestChains) - _سلاسل تطوير دوت نت مهيأة مسبقًا للاستجابة السريعة (PoA)_

تبحث عن المزيد من المصادر؟ اطّلع على [ethereum.org/developers](/developers/).

## المساهمون في مجتمع دوت نت {#dot-net-community-contributors}
...
[الموقع الرسمي لـ نيثيريوم](https://nethereum.com/)  
[الموقع الرسمي لـ نيذرمايند](https://nethermind.io/)
