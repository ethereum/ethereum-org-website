...
- [ربط <span dir="ltr">.NET</span> والعقود الذكية على سلسلة كتل إيثيريوم باستخدام Nethereum](https://medium.com/my-blockchain-development-daily-journey/interfacing-net-and-ethereum-blockchain-smart-contracts-with-nethereum-2fa3729ac933)، متوفر أيضًا باللغة [الصينية](https://medium.com/my-blockchain-development-daily-journey/%E4%BD%BF%E7%94%A8nethereum%E9%80%A3%E6%8E%A5-net%E5%92%8C%E4%BB%A5%E5%A4%AA%E7%B6%B2%E5%8D%80%E5%A1%8A%E9%8F%88%E6%99%BA%E8%83%BD%E5%90%88%E7%B4%84-4a96d35ad1e1)
...
- [تعرف على كيفية نشر العقود الذكية على إيثيريوم بسهولة باستخدام <span dir="ltr">C#</span> و<span dir="ltr">VisualStudio</span>](https://koukia.ca/deploy-ethereum-smart-contracts-using-c-and-visualstudio-5be188ae928c)

**هل ترغب في تخطي الإعداد في الوقت الحالي والانتقال مباشرة إلى الأمثلة؟**

- [Nethereum Playground](https://playground.nethereum.com/) - تفاعل مع إيثيريوم وتعلم كيفية استخدام Nethereum من خلال المتصفح.
...
- [توليد الكود باستخدام Nethereum وVS Code](https://docs.nethereum.com/docs/smart-contracts/code-generation/)
- [Unity وإيثيريوم: لماذا وكيف](https://www.raywenderlich.com/5509-unity-and-ethereum-why-and-how)
...
- [إطار عمل Nethereum MUD للتطبيقات المهيكلة على السلسلة](https://docs.nethereum.com/docs/mud-framework/overview/)
- [معالجة سلسلة الكتل في Nethereum](https://docs.nethereum.com/docs/data-and-indexing/guide-blockchain-processing)
...
- [Nethereum Blazor](https://github.com/Nethereum/NethereumBlazor) - _مستكشف سلسلة كتل خفيف ومحفظة بسيطة بتطبيق صفحة واحدة (SPA) باستخدام <span dir="ltr">.NET Wasm</span>_
- [Wonka Business Rules Engine](https://github.com/Nethereum/Wonka) - _محرك قواعد أعمال (لكل من منصة <span dir="ltr">.NET</span> ومنصة إيثيريوم) يعتمد بشكل أساسي على البيانات الوصفية_
...
- [eth-utils](https://github.com/ethereum/eth-utils/) - _دوال مساعدة للعمل مع قواعد الأكواد المتعلقة بإيثيريوم_
- [TestChains](https://github.com/Nethereum/TestChains) - _سلاسل تطوير <span dir="ltr">.NET</span> معدة مسبقًا لاستجابة سريعة (إثبات السلطة)_
