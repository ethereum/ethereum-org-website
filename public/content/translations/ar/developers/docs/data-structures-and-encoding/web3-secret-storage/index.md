---
title: "تعريف التخزين السري لـ ويب3"
description: "التعريف الرسمي لتخزين البيانات السرية على الويب 3"
lang: ar
sidebarDepth: 2
---

لجعل تطبيقك يعمل على إيثريوم، يمكنك استخدام كائن web3 الذي توفره مكتبة web3.js. تحت الغطاء، يتواصل مع عقدة محلية من خلال مكالمات RPC. يعمل [web3](https://github.com/ethereum/web3.js/) مع أي عقدة إيثريوم تعرض طبقة RPC.
