---
title: "آليات الاجماع"
description: "شرحٌ لبروتوكولات التوافق في النُظم الموزعة ودورها في إيثريوم."
lang: ar
---
...
تستخدم إيثريوم آلية إجماع تعتمد على إثبات الحصة والتي تستمد أمنها الاقتصادي المشفر من مجموعة من المكافآت والعقوبات المطبقة على رأس المال المحبوس من قبل المشاركين. يشجع هيكل الحوافز هذا المشاركين الأفراد على تشغيل محققين صادقين، ويعاقب أولئك الذين لا يفعلون ذلك، ويخلق تكلفة عالية للغاية لمهاجمة الشبكة.
...
المحققون يقومون بإنشاء الكتل. يتم اختيار أحد المحققين بشكل عشوائي في كل فتحة ليكون مقترح الكتلة. يطلب عميل الإجماع الخاص بهم مجموعة من المعاملات باعتبارها "حمولة تنفيذ" من عميل التنفيذ المقترن بهم. يقومون بتغليف هذا في بيانات الإجماع لتشكيل كتلة، والتي يرسلونها إلى العقد الأخرى على شبكة إيثريوم. يتم مكافأة إنتاج هذه الكتلة بعملة ETH. في حالات نادرة عندما توجد كتل متعددة محتملة لفتحة واحدة، أو عندما تسمع العقد عن الكتل في أوقات مختلفة، تختار خوارزمية اختيار الشوكة الكتلة التي تشكل السلسلة ذات الوزن الأكبر من الشهادات (حيث يكون الوزن هو عدد المحققين الذين يثبتون حسب رصيد ETH الخاص بهم).
...
شاهد المزيد حول أنواع آليات الإجماع المختلفة المستخدمة في إيثريوم:
...
**مقاومة سيبيل** تقيس مدى قدرة البروتوكول على التصدي لهجوم سيبيل. إن مقاومة هذا النوع من الهجوم أمر ضروري لسلسلة الكتل اللامركزية وتمكن عمال المناجم والمحققين من الحصول على مكافأة متساوية بناءً على الموارد المستخدمة. <a href="https://openethereum.github.io/">عميل راست إيثريوم</a> \* <strong x-id="1">لاحظ أن OpenEthereum <a href="https://medium.com/openethereum/gnosis-joins-erigon-formerly-turbo-geth-to-release-next-gen-ethereum-client-c6708dd06dd">قد أصبح قديمًا</a> ولم يعد قيد الصيانة.</strong> استخدمه بحذر ويفضل التبديل إلى تنفيذ عميل آخر. تشكل هذه الحماية رادعًا اقتصاديًا لهجمات Sybil.
...
يستخدم إيثريوم آلية إجماع تُعرف باسم [جاسبر](/developers/docs/consensus-mechanisms/pos/gasper/) والتي تجمع بين [كاسبر FFG لإثبات الحصة](https://arxiv.org/abs/1710.09437) مع [قاعدة اختيار الانقسام GHOST](https://arxiv.org/abs/2003.03052).
...
- [كيف يعمل كاسبر؟](https://medium.com/unitychain/intro-to-casper-ffg-9ed944d98b2d)
