...
##### إنشاء الإثبات {#entries-and-exits}
...
##### التحقق من الإثبات {#zk-rollups-and-evm-compatibility}
...
### الدخول والخروج {#how-do-zk-rollup-fees-work}
...
## How do ZK-rollup fees work? {#transaction-data-compression}
...
## How do ZK-rollups scale Ethereum? {#recursive-proofs}

### ضغط بيانات المعاملة {#zk-rollups-pros-and-cons}
...
### إيجابيات وسلبيات تجميعات المعرفة الصفرية {#zkevm-projects}
...
### شرح مرئي لتجميعات المعرفة الصفرية {#further-reading-on-zk-rollups}
...
## Who is working on a zkEVM? {#tutorials}
...
- [استخدام العناوين المخفية](/developers/tutorials/stealth-addr/) _– كيف تتيح العناوين المخفية لـ ERC-5564 تحويلات ETH مجهولة باستخدام اشتقاق مفتاح التشفير._
