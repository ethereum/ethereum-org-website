...
يجب عليها أيضًا تقديم إثبات ميركل للتحقق من أن المعاملة التي أنشأت أموالها على سلسلة بلازما قد تم تضمينها في كتلة. هذا ضروري لتكرارات بلازما، مثل <span dir="ltr">Plasma MVP</span>، التي تستخدم نموذج [مخرجات المعاملات غير المنفقة (<span dir="ltr">UTXO</span>)](https://en.wikipedia.org/wiki/Unspent_transaction_output).

تمثل تكرارات أخرى، مثل <span dir="ltr">Plasma Cash</span>، الأموال كـ [رموز مميزة غير قابلة للاستبدال](/developers/docs/standards/tokens/erc-721/) بدلاً من <span dir="ltr">UTXOs</span>. يتطلب السحب، في هذه الحالة، إثبات ملكية الرموز المميزة على سلسلة بلازما. يتم ذلك عن طريق إرسال أحدث معاملتين تتضمنان الرمز المميز وتقديم إثبات ميركل للتحقق من تضمين تلك المعاملات في كتلة.
