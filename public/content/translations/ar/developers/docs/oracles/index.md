...
description: "توفر الأوراك يل عقود إيثريوم الذكية بإمكانية الوصول إلى البيانات الواقعية، مما يفتح المزيد من حالات الاستخدام ويزيد من القيمة للمستخدمين."
lang: ar
---
...
تسمح تطبيقات [التمويل اللامركزي](/defi/) (دي فاي) بالإقراض والاقتراض وتداول الأصول من نظير إلى نظير. غالبًا ما يتطلب ذلك الحصول على معلومات مالية مختلفة، بما في ذلك بيانات أسعار الصرف (لحساب القيمة النقدية للعملات المشفرة أو لمقارنة أسعار الرموز المميزة) وبيانات الأسواق المالية (لحساب قيمة الأصول المرمزة، مثل الذهب أو الدولار الأمريكي).
...
تشمل "أوراكل الأسعار" الشائعة (كما يطلق عليها غالبًا) في التمويل اللامركزي (دي فاي) تشين لينك Price Feeds، و[Open Price Feed](https://compound.finance/docs/prices) من Compound Protocol، و[الأسعار المتوسطة المرجحة بالوقت (TWAPs)](https://docs.uniswap.org/contracts/v2/concepts/core-concepts/oracles) من يوني سواب، و[Maker Oracles](https://docs.makerdao.com/smart-contract-modules/oracle-module).
...
ولكن هناك أيضًا _دوال خاصة_ داخل العقد لا يمكن للآخرين الوصول إليها، ولكنها ضرورية للوظائف العامة للتطبيق اللامركزي. تشمل الأمثلة دالة `mintERC721Token()` التي تسك بشكل دوري رموز إن إف تي جديدة للمستخدمين، أو دالة لمنح المدفوعات في سوق التنبؤات، أو دالة لفتح الرموز المجمّدة في بورصة لامركزية (DEX).
...
توفر [شبكة Keeper](https://chain.link/keepers) من تشين لينك خيارات للعقود الذكية للاستعانة بمصادر خارجية لمهام الصيانة الدورية بطريقة لامركزية ومُقلَّصة الثقة. اقرأ [توثيق Keeper الرسمي](https://docs.chain.link/docs/chainlink-keepers/introduction/) للحصول على معلومات حول جعل عقدك متوافقًا مع Keeper واستخدام خدمة Upkeep.
...
**[تشين لينك](https://chain.link/)** - _توفر شبكات أوراكل تشين لينك اللامركزية مدخلات ومخرجات وحسابات مقاومة للتلاعب لدعم العقود الذكية المتقدمة على أي سلسلة كتل._
...
**[تيلور](https://tellor.io/)** - _Tellor هو بروتوكول أوراكل شفاف وغير مسموح به لعقدك الذكي للحصول بسهولة على أي بيانات كلما احتاج إليها._
...
**[API3 داو](https://www.api3.org/)** - _تقدم API3 داو حلول أوراكل من الطرف الأول التي توفر شفافية وأمانًا وقابلية أكبر للتوسع في المصدر في حل لامركزي للعقود الذكية._
...
- [كيفية جلب السعر الحالي لإيثريوم في سوليديتي](https://blog.chain.link/fetch-current-crypto-price-data-solidity/) — _Chainlink_
- [استهلاك بيانات أوراكل](https://docs.chroniclelabs.org/Developers/tutorials/Remix) — _Chronicle_

\*\*
مثال للمشاريع\*\*

- [مشروع تشين لينك كامل للمبتدئين لإيثريوم في سوليديتي](https://github.com/hackbg/chainlink-fullstack) — _HackBG_
