...
تفترض هذه الصفحة أن القارئ على دراية بأساسيات [إيثريوم](/)، بما في ذلك [العُقَد](/developers/docs/nodes-and-clients/) و[آليات الإجماع](/developers/docs/consensus-mechanisms/) و[آلة إيثريوم الافتراضية (EVM)](/developers/docs/evm/) يجب أن يكون لديك أيضًا فهم جيد [للعقود الذكية](/developers/docs/smart-contracts/) و[تشريح العقود الذكية](/developers/docs/smart-contracts/anatomy/)، وخاصة [الأحداث](/glossary/#events).
...
كانت إحدى الأفكار المبكرة لهذا هي [SchellingCoin](https://blog.ethereum.org/2014/03/28/schellingcoin-a-minimal-trust-universal-data-feed)، وهي مصدر بيانات مقترح يقدم فيه المشاركون إجابات على أسئلة "عددية" (أسئلة توصف إجاباتها بالمقدار، على سبيل المثال "ما هو سعر ETH؟")، إلى جانب وديعة. تتم مكافأة المستخدمين الذين يقدمون قيمًا بين [الشريحة المئوية](https://en.wikipedia.org/wiki/Percentile) 25 و 75، بينما تتم معاقبة أولئك الذين تنحرف قيمهم بشكل كبير عن القيمة الوسيطة.
...
**[DIA](https://www.diadata.org/)** - شبكة خدمة أوراكل عبر السلاسل تقدم موجزات بيانات قابلة للتحقق لأكثر من 20,000 أصل عبر جميع فئات الأصول الرئيسية. تستمد DIA بيانات التداول الأولية مباشرة من أكثر من 100 سوق أولي وتحسبها على السلسلة، مما يضمن الشفافية الكاملة للبيانات وقابليتها للتحقق مع تكوينات مخصصة لأي حالة استخدام.

**[Stork](https://stork.network)** - تقدم Stork بيانات الأسعار بزمن انتقال منخفض للغاية، مما يدعم مجموعة واسعة من حالات الاستخدام بما في ذلك أسواق العقود الدائمة وبروتوكولات الإقراض والأنظمة البيئية لدي فاي، مع دعم الأصول الجديدة بسرعة عند إدراجها.
