...
### شبكات اختبار الطبقة 2 {#development-networks}
...
#### أربيتروم Sepolia {#consortium-networks}
...
##### الصنابير {#common-and-legacy-testnets}
...
#### أوبتيميزم Sepolia {#other-testnets}

شبكة اختبار لـ [أوبتيميزم](https://www.optimism.io/).

##### الموارد {#related-tools}

- [Etherscan](https://sepolia-optimistic.etherscan.io/)
- [Blockscout](https://optimism-sepolia.blockscout.com/)

##### الصنابير {#further-reading}
...
## <Emoji text="🚉" /> لماذا تمت تسمية شبكات اختبار إيثيريوم بأسماء محطات المترو؟
...
### <Emoji text="🚧" /> شبكات الاختبار الشائعة الاستخدام والقديمة
...
### <Emoji text="🧪" /> شبكات اختبار متخصصة أخرى
