...
يوضح المثال التالي كيفية استخدام أداة توقيع تسمى [Clef](https://geth.ethereum.org/docs/tools/clef/introduction) لإنشاء حساب جديد. Clef هي أداة لإدارة الحسابات والتوقيع تأتي مدمجة مع عميل إيثريوم، [غيث](https://geth.ethereum.org). يقوم الأمر `clef newaccount` بإنشاء زوج مفاتيح جديد وحفظه في ملف مخزن مفاتيح مشفر.
...
[توثيق غيث](https://geth.ethereum.org/docs)
