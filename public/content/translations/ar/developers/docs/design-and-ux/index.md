...
هل أنت جديد في التصميم باستخدام Ethereum؟ هذا هو المكان المناسب لك. لقد كتب مجتمع Ethereum موارد لتعريفك بأساسيات تصميم وبحث web3. ستتعرف على المفاهيم الأساسية التي قد تختلف عن تصميمات التطبيقات الأخرى التي تعرفها.
...
- [Web3 بحاجة إلى المزيد من باحثي ومصممي تجربة المستخدم](https://blog.akasha.org/akasha-conversations-9-web3-needs-more-ux-researchers-and-designers) - نظرة عامة على نضج التصميم الحالي
- [دليل بسيط لأبحاث تجربة المستخدم في Web3](https://uxplanet.org/a-complete-guide-to-ux-research-for-web-3-0-products-d6bead20ebb1) - دليل بسيط لكيفية إجراء الأبحاث
- [كيفية اتخاذ قرارات تجربة المستخدم في Web3](https://archive.devcon.org/archive/watch/6/data-empathy-how-to-approach-ux-decisions-in-web3/) - نظرة عامة موجزة عن البحث الكمي والنوعي والاختلافات بينهما (فيديو، 6 دقائق)
- [كونك باحث تجربة مستخدم في Web3](https://medium.com/@georgia.rakusen/what-its-like-being-a-user-researcher-in-web3-6a4bcc096849) - وجهة نظر شخصية حول ما يعنيه أن تكون باحث تجربة مستخدم في Web3
...
| <Tag variant="solid" status="success">تجهيز العملات الرقمية</Tag> | [Consensys: حالة تصور Web3 حول العالم 2023](https://consensys.io/insight-report/web3-and-crypto-global-survey-2023)                                                                                      |
...
| <Tag status="tag">تجميد العملات</Tag>                             | [OpenUX: تجربة مستخدم مشغل عقدة Rocket Pool](https://storage.googleapis.com/rocketpool/RocketPool-NodeOperator-UX-Report-Jan-2024.pdf)                                                                   |
| <Tag status="tag">تجميد العملات</Tag>                             | [تجميد العملات: الاتجاهات الرئيسية، والاستنتاجات، والتنبؤات - Eth Staker](https://lookerstudio.google.com/u/0/reporting/cafcee00-e1af-4148-bae8-442a88ac75fa/page/p_ja2srdhh2c?s=hmbTWDh9hJo)            |
| <Tag status="tag">تجميد العملات</Tag>                             | [تجميد العملات متعدد التطبيقات](https://github.com/threshold-network/UX-User-Research/blob/main/Multi-App%20Staking%20\(MAS\)/iterative-user-study/MAS%20Iterative%20User%20Study.pdf)                                   |
| <Tag variant="solid" status="error">DAO</Tag>                     | [تحديث أبحاث DAO لعام 2022: ما الذي يحتاجه منشئو DAO؟](https://blog.aragon.org/2022-dao-research-update/)                                                                                                |
...
- [كتيب تصميم تجربة المستخدم لـ Web3](https://web3ux.design/) - دليل عملي لتصميم تطبيقات Web3
- [مبادئ تصميم Web3](https://medium.com/@lyricalpolymath/web3-design-principles-f21db2f240c1) - إطار عمل لقواعد تجربة المستخدم للتطبيقات اللامركزية القائمة على البلوك تشين
...
- [أزمة قابلية استخدام Web3: ما تحتاج إلى معرفته!](https://www.youtube.com/watch?v=oBSXT_6YDzg) - حلقة نقاش حول مخاطر بناء المشاريع التي تركز على المطورين (فيديو، 34 دقيقة)

## بدء الاستخدام {#getting-started}

- [الاستدلالات لـ Web3](/developers/docs/design-and-ux/heuristics-for-web3/) - 7 استدلالات لتصميم واجهة Web3
- [أفضل ممارسات تصميم DEX](/developers/docs/design-and-ux/dex-design-best-practice/) - دليل لتصميم المنصات اللامركزية

## دراسات حالة تصميم Web3 {#design-case-studies}

- [Deep Work Studio](https://www.deepwork.studio/case-studies)
- [بيع رمز غير قابل للاستبدال (NFT) على OpenSea](https://builtformars.com/case-studies/opensea)
...
## منظمات DAO والمجتمعات التصميمية {#design-daos-and-communities}
...
- [تصميم Optimism](https://www.figma.com/@optimism) (Figma)
- [نظام تصميم Ethereum.org](https://www.figma.com/@ethdotorg) (Figma)
- [Finity، نظام تصميم من Polygon](https://www.figma.com/community/file/1073921725197233598/finity-design-system) (Figma)
...
نضيف الروابط إلى هذه الصفحة بناءً على المعايير الموجودة في [سياسة الإدراج](/contributing/design/adding-design-resources) الخاصة بنا. إذا كنت ترغب في أن نضيف مشروعًا/مقالة، فقم بتحرير هذه الصفحة على [GitHub](https://github.com/ethereum/ethereum-org-website/blob/dev/public/content/developers/docs/design-and-ux/index.md).
