...
على الرغم من اختلاف الأرقام، فمن المقدر أن المبلغ الإجمالي للقيمة المسروقة أو المفقودة بسبب العيوب الأمنية في العقود الذكية يزيد بسهولة عن مليار دولار. وهذا يشمل الحوادث البارزة، مثل [اختراق داو](https://hackingdistributed.com/2016/06/18/analysis-of-the-dao-exploit/) (تمت سرقة 3.6 مليون ETH، بقيمة تزيد عن مليار دولار بأسعار اليوم)، و[اختراق محفظة باريتي متعددة التوقيع](https://www.coindesk.com/markets/2017/07/19/30-million-ether-reported-stolen-due-to-parity-wallet-breach) (خسارة 30 مليون دولار للمخترقين)، و[مشكلة محفظة باريتي المجمدة](https://www.theguardian.com/technology/2017/nov/08/cryptocurrency-300m-dollars-stolen-bug-ether) (تم قفل أكثر من 300 مليون دولار من ETH إلى الأبد).
...
عند استخدامها بشكل صحيح، تمنح مكافآت الأخطاء أعضاء مجتمع المتسللين حافزًا لفحص التعليمات البرمجية الخاصة بك بحثًا عن العيوب الخطيرة. مثال من واقع الحياة هو "ثغرة الأموال اللانهائية" التي كانت ستسمح لمهاجم بإنشاء كمية غير محدودة من الإيثر على [أوبتيميزم](https://www.optimism.io/)، وهو بروتوكول [الطبقة الثانية](/layer-2/) يعمل على إيثريوم. لحسن الحظ، اكتشف مخترق ذو قبعة بيضاء (whitehat) [الثغرة](https://www.saurik.com/optimism.html) وأبلغ الفريق، [وحصل على مكافأة كبيرة في هذه العملية](https://cryptoslate.com/critical-bug-in-ethereum-l2-optimism-2m-bounty-paid/).
...
- قم بتشغيل الكود الخاص بك من خلال أدوات تحليل الكود الأساسية، مثل [Cyfrin Aderyn](https://github.com/Cyfrin/aderyn) و ميثريل و سليذر. من الناحية المثالية، يجب عليك القيام بذلك قبل دمج كل طلب سحب ومقارنة الاختلافات في المخرجات

- تأكد من تجميع التعليمات البرمجية الخاصة بك دون أخطاء، وأن برنامج التحويل البرمجي سوليديتي لا يصدر أي تحذيرات

- وثق الكود الخاص بك بشكل صحيح (باستخدام [نات سبيك](https://solidity.readthedocs.io/en/develop/natspec-format.html)) وصف تفاصيل بنية العقد بلغة سهلة الفهم. سيؤدي ذلك إلى تسهيل قيام الآخرين بتدقيق ومراجعة التعليمات البرمجية الخاصة بك.
...
المزيد عن [تصميم أنظمة حوكمة آمنة](https://blog.openzeppelin.com/smart-contract-security-guidelines-4-strategies-for-safer-governance-systems/)، [آليات التصويت المختلفة في المنظمات المستقلة اللامركزية (دي إيه أوز)](https://hackernoon.com/governance-is-the-holy-grail-for-daos)، و[متجهات الهجوم الشائعة على المنظمات المستقلة اللامركزية (دي إيه أوز) التي تستفيد من دي فاي](https://dacian.me/dao-governance-defi-attacks) في الروابط المشتركة.
...
الملخص هو أنه نظرًا لأن رصيد المتصل لم يتم تعيينه على 0 حتى اكتمال تنفيذ الوظيفة، فإن الاستدعاءات اللاحقة ستنجح وتسمح للمتصل بسحب رصيده عدة مرات. يمكن استخدام هذا النوع من الهجوم لاستنزاف أموال عقد ذكي، كما حدث في [اختراق داو عام 2016](https://www.coindesk.com/learn/understanding-the-dao-attack). لا تزال هجمات إعادة الدخول (reentrancy) مشكلة حرجة للعقود الذكية اليوم كما تظهر [القوائم العامة لاستغلالات إعادة الدخول](https://github.com/pcaversaccio/reentrancy-attacks).
...
يحدث تجاوز عدد صحيح عندما تقع نتائج عملية حسابية خارج النطاق المقبول للقيم، مما يؤدي إلى "تدحرجها" إلى أدنى قيمة قابلة للتمثيل. على سبيل المثال، يمكن لـ `uint8` تخزين قيم تصل إلى <span dir="ltr">2^8-1=255</span> فقط. العمليات الحسابية التي تؤدي إلى قيم أعلى من `255` سوف تفيض (overflow) وتعيد تعيين `uint` إلى `0`، على غرار كيفية إعادة تعيين عداد المسافات في السيارة إلى 0 بمجرد وصوله إلى الحد الأقصى لعدد الأميال (999999).
...
وتتمثل إحدى المخاوف الأمنية ذات الصلة في استخدام أوراكل على السلسلة، مثل البورصة اللامركزية، للحصول على السعر الفوري للأصل. غالبًا ما تفعل منصات الإقراض في صناعة [التمويل اللامركزي (دي فاي)](/defi/) ذلك لتحديد قيمة ضمانات المستخدم لتحديد المبلغ الذي يمكنه اقتراضه.
...
- **[ABI Encoder](https://abi.hashex.org/)** - _خدمة مجانية عبر الإنترنت لتشفير وظائف عقد سوليديتي ووسيطات المنشئ._

- **[Aderyn](https://github.com/Cyfrin/aderyn)** - _محلل سوليديتي ثابت، يتنقل عبر أشجار بناء الجملة المجردة (AST) لتحديد الثغرات المشتبه بها وطباعة المشكلات بتنسيق markdown سهل الاستخدام._

### أدوات لمراقبة العقود الذكية {#smart-contract-monitoring-tools}

- **[تنبيهات تيندرلي في الوقت الفعلي](https://tenderly.co/monitoring)** - _أداة للحصول على إشعارات في الوقت الفعلي عند حدوث أحداث غير عادية أو غير متوقعة في عقودك الذكية أو محافظك._
...
- **[عقود أوبن زبلين](https://docs.openzeppelin.com/contracts/5.x/)** - _مكتبات عقود لتنفيذ الميزات الإدارية، بما في ذلك ملكية العقد، والترقيات، وضوابط الوصول، والحوكمة، وإمكانية الإيقاف المؤقت، والمزيد._

### خدمات تدقيق العقود الذكية {#smart-contract-auditing-services}

- **[كونسنسيس Diligence](https://diligence.consensys.io/)** - _خدمة تدقيق العقود الذكية التي تساعد المشاريع في نظام البلوك تشين البيئي على ضمان جاهزية بروتوكولاتها للإطلاق وبنائها لحماية المستخدمين._
...
- **[تريل أوف بيتس](https://www.trailofbits.com/)** - _شركة أمن سيبراني تجمع بين أبحاث الأمن وعقلية المهاجم لتقليل المخاطر وتحصين الكود._
...
- **[أوبن زبلين](https://www.openzeppelin.com/security-audits)** - _شركة أمن عقود ذكية تقدم عمليات تدقيق أمنية للأنظمة الموزعة._

- **[Runtime Verification](https://runtimeverification.com/)** - _شركة أمنية متخصصة في النمذجة الرسمية والتحقق من العقود الذكية._

- **[Hacken](https://hacken.io)** - _مدقق أمن سيبراني ويب3 يطبق نهج 360 درجة على أمن البلوك تشين._

- **[نيذرمايند](https://www.nethermind.io/smart-contract-audits)** - _خدمات تدقيق سوليديتي و Cairo، تضمن سلامة العقود الذكية وأمان المستخدمين عبر إيثريوم و ستارك نت._
...
- **[Code4rena](https://code4rena.com/)** - _منصة تدقيق تنافسية تحفز خبراء أمن العقود الذكية على إيجاد الثغرات والمساعدة في جعل ويب3 أكثر أمانًا._

- **[CodeHawks](https://codehawks.com/)** - _منصة تدقيق تنافسية تستضيف مسابقات تدقيق العقود الذكية للباحثين الأمنيين._

- **[Cyfrin](https://cyfrin.io)** - _مركز قوي لأمن ويب3، يحتضن أمن العملات الرقمية من خلال المنتجات وخدمات تدقيق العقود الذكية._

- **[ImmuneBytes](https://immunebytes.com/smart-contract-audit/)** - _شركة أمن ويب3 تقدم عمليات تدقيق أمنية لأنظمة البلوك تشين من خلال فريق من المدققين ذوي الخبرة وأفضل الأدوات في فئتها._

- **[Oxorio](https://oxor.io/)** - _خدمات تدقيق العقود الذكية وأمن البلوك تشين مع خبرة في EVM و سوليديتي و ZK وتقنية السلاسل المتقاطعة (Cross-chain) لشركات العملات الرقمية ومشاريع التمويل اللامركزي (دي فاي)._
...
- **[Immunefi](https://immunefi.com/)** - _منصة مكافآت الأخطاء للعقود الذكية ومشاريع التمويل اللامركزي (دي فاي)، حيث يراجع الباحثون الأمنيون الكود، ويفصحون عن الثغرات، ويتقاضون أجرًا، ويجعلون العملات الرقمية أكثر أمانًا._
...
- **[HackenProof](https://hackenproof.com/)** - _منصة مكافآت أخطاء متخصصة لمشاريع العملات الرقمية (دي فاي، العقود الذكية، المحافظ، CEX والمزيد)، حيث يقدم متخصصو الأمن خدمات الفرز ويتقاضى الباحثون أجرًا مقابل تقارير الأخطاء ذات الصلة والمتحقق منها._

- **[Sherlock](https://www.sherlock.xyz/)** - _ضامن في ويب3 لأمن العقود الذكية، مع مدفوعات للمدققين تدار عبر العقود الذكية لضمان دفع أجور عادلة للأخطاء ذات الصلة._
...
- **[كونسنسيس: هجمات العقود الذكية المعروفة](https://consensysdiligence.github.io/smart-contract-best-practices/attacks/)** - _شرح سهل للمبتدئين لأهم ثغرات العقود، مع كود نموذجي لمعظم الحالات._
...
- **[Damn Vulnerable دي فاي](https://www.damnvulnerabledefi.xyz/)** - _لعبة حرب (Wargame) لتعلم الأمن الهجومي لعقود التمويل اللامركزي (دي فاي) الذكية وبناء المهارات في صيد الأخطاء والتدقيق الأمني._

- **[Ethernaut](https://ethernaut.openzeppelin.com/)** - _لعبة حرب (wargame) قائمة على ويب3/سوليديتي حيث يكون كل مستوى عبارة عن عقد ذكي يحتاج إلى "اختراقه"._
...
- **[كونسنسيس: أفضل ممارسات أمان عقود إيثريوم الذكية](https://consensys.github.io/smart-contract-best-practices/)** - _قائمة شاملة من الإرشادات لتأمين عقود إيثريوم الذكية._
...
- **[سوليديتي Patterns](https://fravoll.github.io/solidity-patterns/)** - _تجميع مفيد للأنماط الآمنة وأفضل الممارسات للغة برمجة العقود الذكية سوليديتي._

- **[مستندات سوليديتي: اعتبارات أمنية](https://docs.soliditylang.org/en/v0.8.16/security-considerations.html)** - _إرشادات لكتابة عقود ذكية آمنة باستخدام سوليديتي._
...
- [سيفرين أب درافت - دورة كاملة في أمان وتدقيق العقود الذكية](https://updraft.cyfrin.io/courses/security)
