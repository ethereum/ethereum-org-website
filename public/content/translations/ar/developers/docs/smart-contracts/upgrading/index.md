...
3. تقليل افتراضات الثقة من خلال اللامركزية في عملية تنفيذ الترقيات. تتضمن الاستراتيجيات المحتملة استخدام [عقد محفظة متعدد التوقيع](/developers/docs/smart-contracts/#multisig) للتحكم في عمليات التطوير، أو مطالبة [أعضاء داو](/dao/) بالتصويت على الموافقة على التطوير.
...
**ملحقات تطوير أوبن زبلين - _مجموعة من الأدوات لنشر وتأمين العقود الذكية القابلة للتطوير._**

- [غيت هاب](https://github.com/OpenZeppelin/openzeppelin-upgrades)
...
- [دليل ويب3 التعليمي: كتابة عقد ذكي قابل للتطوير (وكيل) باستخدام أوبن زبلين](https://dev.to/yakult/tutorial-write-upgradeable-smart-contract-proxy-contract-with-openzeppelin-1916) بقلم fangjun.eth
...
- [تعلَّم: تطوير العقود الذكية](https://docs.openzeppelin.com/learn/upgrading-smart-contracts) - توثيق أوبن زبلين
