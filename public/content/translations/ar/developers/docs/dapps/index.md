...
يمكن للتطبيق اللامركزي أن يحتوي على كود للواجهة الأمامية وواجهات مستخدم مكتوبة بأي لغة (تمامًا مثل أي تطبيق) لإجراء استدعاءات لواجهته الخلفية. علاوة على ذلك، يمكن استضافة واجهته الأمامية على وحدات تخزين لامركزية مثل [آي بي إف إس](https://ipfs.io/).
...
**سكافولد-إيث _- قم بالتجربة بسرعة مع سوليديتي باستخدام واجهة أمامية تتكيف مع عقدك الذكي._**
...
- [غيت هاب](https://github.com/oneclickdapp/oneclickdapp-v1)
...
- [غيت هاب](https://github.com/abunsen/etherflow)
...
**Crossmint _- منصة تطوير ويب3 على مستوى المؤسسات لنشر العقود الذكية، وتمكين الدفع ببطاقات الائتمان والدفع عبر السلاسل، واستخدام واجهات برمجة التطبيقات لإنشاء الرموز غير القابلة للاستبدال (إن إف تيز) وتوزيعها وبيعها وتخزينها وتحريرها._**
