...
## ما الذي يمكنك أن تفعله بالتمويل اللامركزي دي فاي (DeFi)؟ حالات استخدام التمويل اللامركزي (DeFi) {#defi-use-cases}
...
يعمل الإقراض اللامركزي دون أن يضطر أي من الطرفين إلى تحديد هويته. بدلاً من ذلك، يجب على المقترض تقديم ضمان إضافي يحصل عليه المقرض تلقائيًا في حالة عدم سداد القرض. يقبل بعض المقرضين حتى [NFTs](/glossary/#nft) كضمان إضافي. NFTs هي صكوك لأصل فريد، لوحة فنية مثلًا. [المزيد عن الرموز غير القابلة للاستبدال (NFTs)](/nft/)
...
- لنفترض أنك أقرضت 100 Dai، وهي [عملة مستقرة](/stablecoins/)، لمنتج مثل Aave.
...
مثال جيد هو [صندوق مؤشر DeFi Pulse ‏(DPI)](https://defipulse.com/blog/defi-pulse-index/). هذا تمويل يعيد توازن الرصيد تلقائيًا لضمان أن محفظتك تحتوى دائمًا على أعلى رموز التمويل اللامركزي دي فاي (DeFi) في رأسمالية السوق. لا تحتاج أبدًا إلى إدارة أي من التفاصيل ويمكنك السحب من الأموال متى ما رغبت.
...
## إيثريوم والتمويل اللامركزي (DeFi) {#ethereum-and-defi}
...
ملاحظة: يستخدم جزء كبير من التمويل اللامركزي (DeFi) [معيار ERC-20](/glossary/#erc-20). تستخدم التطبيقات في DeFi غلافًا لـ ETH يسمى Wrapped ether (WETH).
[تعرف على المزيد عن الإيثر المغلف (wrapped ether)](/wrapped-eth).

## بناء تطبيقات التمويل اللامركزي (DeFi) {#build-defi}
...
### مقالات عن التمويل اللامركزي (DeFi) {#defi-articles}

- [دليل المبتدئين إلى التمويل اللامركزي (DeFi)](https://blog.coinbase.com/a-beginners-guide-to-decentralized-finance-defi-574c68ff43c4) – _Sid Coelho-Prabhu, 6 يناير، 2020_
- [إرشادات تقييم مخاطر التمويل اللامركزي (DeFi) الصادرة عن EEA](https://entethalliance.org/specs/defi-risks/) – نظرة عامة مدعومة من القطاع حول كيفية تحديد وتقييم المخاطر الرئيسية في بروتوكولات التمويل اللامركزي (DeFi).

### مقاطع فيديو {#videos}

- [Finematics - تعليم التمويل اللامركزي](https://finematics.com/) – _مقاطع فيديو عن التمويل اللامركزي (DeFi)_
- [The Defiant](https://www.youtube.com/playlist?list=PLaDcID4s1KronHMKojfjwiHL0DdQEPDcq) - _أساسيات التمويل اللامركزي (DeFi): كل ما تحتاج إلى معرفته للبدء في هذا المجال المحيّر أحيانًا._
- [Whiteboard Crypto](https://youtu.be/17QRFlml4pA) _ما هو التمويل اللامركزي (DeFi)؟_

### المجتمعات {#communities}

- [خادم DeFi Llama على Discord](https://discord.defillama.com/)
- [خادم DeFi Pulse على Discord](https://discord.gg/Gx4TCTk)
