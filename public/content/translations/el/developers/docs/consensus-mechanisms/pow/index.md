...
<InfoBanner emoji=":wave:">
    Η απόδειξη εργασίας έχει πλέον καταργηθεί. Το Ethereum δε χρησιμοποιεί πλέον την απόδειξη εργασίας ως μέρος του μηχανισμού συναίνεσής του. Αντίθετα, χρησιμοποιεί την απόδειξη συμμετοχής. Δείτε περισσότερα στο άρθρο [απόδειξη συμμετοχής](/developers/docs/consensus-mechanisms/pos/) και το [αποθήκευση κεφαλαίου](/staking/).
</InfoBanner>
