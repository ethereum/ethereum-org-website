...
Το [αποθετήριο στο Github των Προτάσεων Βελτίωσης του Ethereum (EIP)](https://eips.ethereum.org) δημιουργήθηκε τον Οκτώβριο του 2015. Η διαδικασία EIP βασίζεται στις [Προτάσεις Βελτίωσης του Bitcoin (BIP)](https://github.com/bitcoin/bips), οι οποίες βασίζονται στις διαδικασίες [Προχωρημένων Προτάσεων Βελτίωσης της Python (PEP)](https://www.python.org/dev/peps/).
