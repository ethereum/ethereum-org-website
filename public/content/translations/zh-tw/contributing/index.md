...
- [新增開發者工具](/contributing/adding-developer-tools/) – 在相關頁面新增開發者工具
...
以下是一些你可以協助我們解決並負責的當前任務。對於大多數任務，你需要一個 GitHub 帳戶，因為網站的大多數變更都是透過 GitHub 進行的。
...
你應該只使用自行託管錢包來申領 OAT。請勿使用交易所帳戶或其他你不持有私鑰的帳戶，因為這些帳戶將不允許你存取和管理你的 OAT。

## 申領你的 GitPOAP {#claim-gitpoap}

GitPOAP 也會自動識別你已合併的貢獻，並讓你能在他們的平台上鑄造一個獨立且獨特的貢獻者 POAP！
