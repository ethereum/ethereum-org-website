...
**開發**
- [處理未解決的議題 (issue)](https://github.com/ethereum/ethereum-org-website/issues) – 處理我們已確認需要完成的工作
...
- [新增社群資源](/contributing/content-resources/) – 在相關頁面新增實用的文章或資源
- [建議設計資源](/contributing/design/adding-design-resources/) – 新增、更新和刪除實用的設計資源
- [測驗](/contributing/quizzes/) – 為相關頁面新增、更新和刪除測驗題庫
- [建議影片](/contributing/adding-videos/) – 為影片庫建議具教育意義的影片
...
- [新增產品](/contributing/adding-products/) – 將去中心化應用程式 (dapp) 或錢包新增至相關頁面
- [新增開發者工具](/contributing/adding-developer-tools/) – 將開發者工具新增至相關頁面
- [新增第二層 (L2)](/contributing/adding-layer-2s/) – 將第二層 (L2) 新增至相關頁面
...
- [為我們的去中心化科學 (DeSci) 頁面建議專案](/contributing/adding-desci-projects/) – 新增建立在以太坊上且對去中心化科學 (DeSci) 有貢獻的專案
- [新增資源](/contributing/adding-resources/) – 將實用資源新增至任何相關頁面
