...
![顯示如何透過螢幕擷取畫面為字串提供上下文](./source-string.png)
...
![顯示在 Crowdin 中詞彙表標籤位置的螢幕擷取畫面](./glossary-tab.png)

- 如果仍舊找不到該術語，可以藉此機會添加新術語！ 我們建議你在搜尋引擎上進行搜尋，並將描述新增到詞彙表。 這將非常有助於其他譯者更好地理解該術語。

![顯示如何將詞彙表術語新增至 Crowdin 的螢幕擷取畫面](./add-glossary-term.png)
