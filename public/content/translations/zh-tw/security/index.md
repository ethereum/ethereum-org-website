...
![Twitter 連結釣魚](./twitterPhishingScam.png)
...
![Twitter 上的詐騙](./appleTwitterScam.png)
...
![Discord 上的技術支援詐騙](./discordScam.png)
...
![YouTube 上的交易經紀人詐騙](./brokerScam.png)
...
<AlertContent>
<AlertDescription>
    使用密碼管理員可以替您建立並記住高強度、獨一無二的密碼！ 我們<strong>強烈</strong>建議您使用，而且大部分都是免費的！
</AlertDescription>
</AlertContent>
</Alert>
...
<AlertContent>
<AlertDescription>
    注意：使用基於簡訊的雙重驗證容易受到 <a href="https://www.vice.com/en/article/3kx4ej/sim-jacking-mobile-phone-fraud">SIM 卡挾持</a>攻擊，並不安全。 為了獲得最佳安全性，請使用 <a href="https://mashable.com/article/how-to-set-up-google-authenticator">Google Authenticator</a> 或 <a href="https://authy.com/">Authy</a> 等服務。
</AlertDescription>
</AlertContent>
</Alert>
