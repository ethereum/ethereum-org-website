...
<ExpandableCard
title="質押節點營運者與提供者"
contentPreview="如果您是執行自己節點設定的質押者，或是節點基礎設施提供者，在合併之後有幾件事需要注意。"
...
<ExpandableCard
title="非驗證節點營運者與基礎設施提供者"
contentPreview="如果您正在營運非驗證的以太坊節點，合併帶來最顯著的改變是要求同時執行執行層和共識層的客戶端。"
id="node-operators">
...
<ExpandableCard
title="迷思：&quot;執行節點需要質押 32 ETH。&quot;"
contentPreview="錯誤。任何人都可以自由同步自己驗證的以太坊副本（即執行節點）。不需要任何 ETH——合併前不需要，合併後不需要，永遠都不需要。">
...
<ExpandableCard
title="迷思：&quot;合併未能降低燃料費。&quot;"
contentPreview="錯誤。合併是共識機制的改變，而不是網路容量的擴張，且從未打算用來降低燃料費。">
...
<ExpandableCard
title="迷思：&quot;合併大幅加快了交易速度。&quot;"
contentPreview="錯誤。雖然存在一些微小的變化，但現在第一層的交易速度與合併前幾乎相同。">
...
<ExpandableCard
title="迷思：&quot;合併啟用了質押提款。&quot;"
contentPreview="錯誤，但質押提款後來已透過上海/Capella 升級啟用。">
...
<ExpandableCard
title="迷思：&quot;既然合併已完成且提款已啟用，質押者可以一次全部退出。&quot;"
contentPreview="錯誤。基於安全考量，驗證者退出有速率限制。">
