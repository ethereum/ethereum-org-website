...
使用 `合併請求` 的域名分隔[簽名根](https://github.com/ethereum/consensus-specs/blob/master/specs/phase0/beacon-chain.md#compute_signing_root)。
...
- [Electra 共識規範](https://github.com/ethereum/consensus-specs/tree/master/specs/electra/beacon-chain.md)：這是您應該參照的最權威的版本。 當您感到疑惑的時候，請閱讀這些規範
