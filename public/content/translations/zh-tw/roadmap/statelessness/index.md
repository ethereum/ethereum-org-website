...
<ButtonLink variant="outline-color" href="https://notes.ethereum.org/WUUUXBKWQXORxpFMlLWy-w#So-why-is-it-ok-to-have-expensive-proposers">深入閱讀 Dankrad 的筆記</ButtonLink>
</ExpandableCard>
...
用於 L1 驗證的 zkEVM 是一項補充技術，可以進一步增強無狀態驗證。驗證者不僅可以檢查見證數據 (witnesses)，還可以驗證整個區塊已正確執行的零知識證明 -- 在不重新執行交易的情況下提供加密確定性。
