...
- **區塊建構與抗審查性**：ePBS 和區塊層級存取清單正在格蘭斯特丹開發網上運行。FOCIL 計畫用於 Hegotá，目標為 2027 年。
- **最終性**：Minimmit 和更廣泛的精簡以太坊 (Lean Ethereum) 共識工作仍在積極研究中，尚未分配到任何分叉。
- **抗量子性**：每週的後量子互通性開發網正在運行，核心基礎設施里程碑的目標大約在 2029 年。
- **簡化**：佩克特拉和富薩卡已發布；格蘭斯特丹和 Hegotá 將進行下一輪的清理工作。

這項工作尚未全部完成，所有時間表均為估計值，可能會有所變動。
