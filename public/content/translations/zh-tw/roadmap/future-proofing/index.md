...
### 正在採取什麼措施？ {#what-is-being-done}

以太坊目前是區塊鏈生態系統中最積極防禦量子威脅的防禦者。以太坊基金會於 2026 年 1 月成立了專門的**後量子安全團隊**，積極的工作跨越多個客戶端團隊和研究小組。以太坊基金會後量子團隊的工作在 [pq.ethereum.org](https://pq.ethereum.org) 上公開追蹤。
...
過渡策略的一個關鍵部分是 **EIP-8141**，它引入了原生的[帳戶抽象化](/roadmap/account-abstraction/)。這允許個別帳戶選擇自己的簽章驗證，這意味著使用者可以切換到量子安全簽章，**而無需等待單一的、全協定範圍的遷移**。EIP-8141 正在考慮納入 Hegotá 硬分叉（計畫於 2026 年下半年進行）。

以太坊基金會已經概述了結構化的分叉里程碑，目標是大約在 2029 年完成核心後量子基礎設施。這些是規劃目標，而非保證的承諾。

[閱讀我們關於以太坊後量子密碼學的詳細指南](/roadmap/future-proofing/quantum-resistance/)
