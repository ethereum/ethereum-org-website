...
### Prague-Electra (「佩克特拉」) {#pectra}

<NetworkUpgradeSummary name="pectra" />

Prague-Electra (「佩克特拉」) 升級包含了對以太坊協定的幾項改進，旨在提升所有使用者、第二層 (L2) 網路、質押者和節點營運者的體驗。

質押功能得到了升級，引入了複利驗證者帳戶，並透過執行提款地址改善了對質押資金的控制。EIP-7251 將單一驗證者的最大有效餘額增加到 2048，提高了質押者的資金效率。EIP-7002 允許執行帳戶安全地觸發驗證者操作，包括退出或提取部分資金，從而改善了 ETH 質押者的體驗，同時有助於加強節點營運者的當責性。

升級的其他部分則著重於改善一般使用者的體驗。EIP-7702 為一般的非智能合約帳戶 ([EOA](/glossary/#eoa)) 帶來了執行類似智能合約程式碼的能力。這為傳統的以太坊帳戶解鎖了無限的新功能，例如交易批次處理、燃料贊助、替代身分驗證、可程式化支出控制、帳戶復原機制等。
...
<ul>
  ...
  <li><a href="https://eips.ethereum.org/EIPS/eip-7840">EIP-7840</a> - <em>將資料塊排程新增至執行層設定檔</em></li>
</ul>
...
- [Prague-Electra (「佩克特拉」) 常見問題](/roadmap/pectra/)
