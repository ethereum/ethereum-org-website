...
![如何在 MetaMask Mobile 上將 Sepolia 設定為您的網路](./goerliMetamask.gif)
...
![如何找到您的交易哈希和 ERC-721 代幣 ID](./findNFTEtherscan.png)

您可能需要重新整理幾次才能檢視您的 NFT — 但它會在那裡 <Emoji text="😄" size={1} />！

![如何將您的 NFT 上傳到 MetaMask](./findNFTMetamask.gif)
