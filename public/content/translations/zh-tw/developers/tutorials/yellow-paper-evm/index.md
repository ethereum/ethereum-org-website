...
也許是出於這些原因，較新的[共識層規範](https://github.com/ethereum/consensus-specs/blob/master/tests/core/pyspec/README.md)是用 Python 編寫的。 雖然有 [Python 版本的執行層規範](https://ethereum.github.io/execution-specs)，但它們並不完整。 除非且直到整個黃皮書也被翻譯成 Python 或類似的語言，否則黃皮書將繼續使用，能夠閱讀它會很有幫助。
