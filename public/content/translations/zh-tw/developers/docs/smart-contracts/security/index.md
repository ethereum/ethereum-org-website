...
##### 使用多重簽名錢包 {#use-require-assert-revert}
...
### 2. 使用 require()、assert() 和 revert() 語句來保護合約操作 {#test-smart-contracts-and-verify-code-correctness}
...
### 3. 測試智能合約並驗證程式碼正確性 {#get-independent-code-reviews}
...
#### 漏洞賞金 {#follow-smart-contract-development-best-practices}
...
### 5. 在智能合約開發期間遵循最佳實踐 {#implement-disaster-recovery-plans}
...
#### 事件監控 {#design-secure-governance-systems}
...
### 7. 設計安全的治理系統 {#reduce-code-complexity}
...
### 8. 將程式碼複雜性降至最低 {#mitigate-common-smart-contract-vulnerabilities}
...
#### 整數下溢和溢位 {#smart-contract-security-resources-for-developers}
...
##### 如何防止整數下溢和溢位 {#code-analysis-tools}
...
#### 預言機操縱 {#smart-contract-monitoring-tools}
...
##### 如何防止預言機操縱 {#smart-contract-administration-tools}
...
## 開發者智能合約安全資源 {#smart-contract-auditing-services}

### 分析智能合約與驗證程式碼正確性的工具 {#bug-bounty-platforms}
...
### 監控智能合約的工具 {#common-smart-contract-vulnerabilities-and-exploits}

- **[Tenderly 即時警報](https://tenderly.co/monitoring)** - _當你的智能合約或錢包發生異常或非預期事件時，用於獲取即時通知的工具。_

### 安全管理智能合約的工具 {#challenges-for-learning-smart-contract-security}
...
### 智能合約審計服務 {#smart-contract-security-best-practices}
...
### 漏洞賞金平台 {#tutorials-on-smart-contract-security}
