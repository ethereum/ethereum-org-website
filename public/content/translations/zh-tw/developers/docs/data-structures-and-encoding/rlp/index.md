...
- 3 的[集合論表示法](https://en.wikipedia.org/wiki/Set-theoretic_definition_of_natural_numbers)，`[ [], [[]], [ [], [[]] ] ] = [ 0xc7, 0xc0, 0xc1, 0xc0, 0xc3, 0xc0, 0xc1, 0xc0 ]`
...
2. 如果第一個位元組的範圍是 [0x80, 0xb7]，則資料為字串，並且第一個位元組后跟長度等於第一個位元組減去 0x80 的字串；
