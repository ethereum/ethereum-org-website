...
然而，鏈下資料可用性導致了一個問題：建立或驗證默克爾證明所需的資料可能不可用。 這意味著，如果營運者採取惡意行爲，使用者就可能無法從鏈上合約中提取資金。
...
| 這適用於特定用例，例如優先考慮交易隱私和可擴展性的交易或區塊鏈遊戲。   | 可能會阻止使用者提取資金，因爲生成所有權的默克爾證明需要鏈下資料始終可用。                   |
...
- [Rollup、Validium 和 Volition：了解最熱門的以太坊擴張解決方案](https://medium.com/coinmonks/rollups-vs-validiums-vs-volitions-d76300170f4a)
