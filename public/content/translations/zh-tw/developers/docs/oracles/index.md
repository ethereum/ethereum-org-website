...
##### 謝林點機制 {#good-incentive-compatibility}
...
### 良好的誘因相容性 {#retrieving-financial-data}
...
## 預言機在智能合約中的應用 {#generating-verifiable-randomness}

以下是預言機在以太坊中的常見使用案例：

### 擷取金融資料 {#getting-outcomes-for-events}
...
### 產生可驗證的隨機性 {#automating-smart-contracts}
