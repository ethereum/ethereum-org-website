---
title: "適合 .NET 開發人員的以太坊"
description: "了解如何使用基於 .NET 的專案與工具在以太坊上進行開發"
lang: zh-tw
incomplete: true
---

<FeaturedText>了解如何使用基於 .NET 的專案與工具在以太坊上進行開發</FeaturedText>
...
- [Nethereum 入門](https://docs.nethereum.com/docs/getting-started/welcome/)
...
如果你是奈瑟邁 (Nethermind) 的新手並需要入門協助，請加入我們的 [Discord](https://discord.gg/PaCMRFdvWT)。我們的開發人員隨時準備回答你的問題。請隨時在 [Nethermind GitHub 儲存庫](https://github.com/NethermindEth/nethermind) 上提交 PR 或提出任何 issue。
