...
- <strong>強大的鏈上功能：</strong>使 AI 代理能夠執行交易、與智慧合約互動、提供流動性，並跨協定進行協作。
...
- **鏈上不可竄改性**確保這些證明和憑證可以被任何合約或代理參考、重播和信任
...
- [智慧帳戶 (EIP-4337)](https://eips.ethereum.org/EIPS/eip-4337)讓開發人員能夠強制執行支出限制、白名單、工作階段金鑰和精細的權限
- 智慧合約中的程式化約束可以限制代理被允許執行的操作
