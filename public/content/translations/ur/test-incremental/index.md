...
ہر Solidity کنٹریکٹ ایک ورژن پراگما (version pragma) اور کنٹریکٹ کے اعلان سے شروع ہوتا ہے۔ یہاں ایک مختصر مثال ہے:
...
```python
# اپنے کنٹریکٹس کے لیے ٹیسٹ کوریج رپورٹ تیار کریں
import subprocess
...
2. پیچیدہ ریاضیاتی آپریشنز کے لیے **فزنگ (fuzzing) کا استعمال کریں**۔
...
### تعیناتی کی چیک لسٹ {#deployment-checklist}

| مرحلہ | ٹول | حیثیت |
| --- | --- | --- |
| کمپائل | `solc` یا [Hardhat](https://hardhat.org/docs) | لازمی |
| ٹیسٹ | [Foundry](https://book.getfoundry.sh/forge/tests) | لازمی |
| تعینات | [Remix](https://remix.ethereum.org/) | اختیاری |
| تصدیق | [Blockscout](https://eth.blockscout.com/) | تجویز کردہ |
...
<AlertContent className="justify-between flex-row items-center">
  ...
  <ButtonLink href="/developers/tutorials/hello-world-smart-contract/">
    ہمارے مرحلہ وار ٹیوٹوریل کی پیروی کریں
  </ButtonLink>
</AlertContent>
</Alert>

## کمیونٹی کے وسائل {#community-resources}
