...
<AlertContent>
<AlertDescription>
<strong>ہر ویلیڈیٹر اکاؤنٹ کو صرف ایک بار، ایک ہی وڈرال ایڈریس تفویض کیا جا سکتا ہے۔</strong> ایک بار جب کوئی ایڈریس منتخب کر کے کنسینسس لیئر میں جمع کر دیا جاتا ہے، تو اسے دوبارہ واپس نہیں کیا جا سکتا یا تبدیل نہیں کیا جا سکتا۔ جمع کرنے سے پہلے فراہم کردہ ایڈریس کی ملکیت اور درستگی کو دو بار چیک کریں۔
</AlertDescription>
</AlertContent>
</Alert>
