...
جب ایتھیریم [پروف-آف-ورک](/developers/docs/consensus-mechanisms/pow/) استعمال کر رہا تھا، تو ایک مکمل ایتھیریم نوڈ چلانے کے لیے ایک ایگزیکیوشن کلائنٹ کافی تھا۔ تاہم، [پروف-آف-اسٹیک](/developers/docs/consensus-mechanisms/pos/) کو نافذ کرنے کے بعد سے، ایگزیکیوشن کلائنٹ کو ایک دوسرے سافٹ ویئر کے ساتھ استعمال کیا جانا چاہیے جسے [کنسینسس کلائنٹ](/developers/docs/nodes-and-clients/#consensus-clients) کہا جاتا ہے۔
...
![ایتھریم نوڈ آرکیٹیکچر کا خاکہ جس میں عمل درآمد اور اتفاق کی تہوں کو دکھایا گیا ہے۔](node-architecture-text-background.png)
