...
<span dir="ltr">`units of gas used * (base fee + priority fee)`</span>
...
مثال کے طور پر، <span dir="ltr">`21,000 * (10 + 2) = 252,000 gwei`</span> (0.000252 ETH)۔
...
اوپر دیے گئے جدول میں، 36 ملین کو گیس کی حد کے طور پر استعمال کرتے ہوئے ایک مثال پیش کی گئی ہے۔ اس مثال کی پیروی کرتے ہوئے، بلاک نمبر 9 پر ٹرانزیکشن بنانے کے لیے، ایک والیٹ صارف کو یقین کے ساتھ بتائے گا کہ اگلے بلاک میں شامل کی جانے والی **زیادہ سے زیادہ بنیادی فیس** <span dir="ltr">`current base fee * 112.5%`</span> یا <span dir="ltr">`202.7 gwei * 112.5% = 228.1 gwei`</span> ہے۔
...
اگرچہ ایک ٹرانزیکشن میں ایک حد شامل ہوتی ہے، لیکن ٹرانزیکشن میں استعمال نہ ہونے والی کوئی بھی گیس صارف کو واپس کر دی جاتی ہے (مثال کے طور پر، <span dir="ltr">`max fee - (base fee + tip)`</span> واپس کر دی جاتی ہے)۔
