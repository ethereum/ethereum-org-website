...
<span dir="ltr">enode</span> ایک <span dir="ltr">URL</span> پتہ کے فارمیٹ کا استعمال کرتے ہوئے ایتھیریم نوڈ کی شناخت کرنے کا ایک طریقہ ہے۔ ہیکساڈیسیمل <span dir="ltr">node-ID</span> کو <span dir="ltr">URL</span> کے یوزر نیم والے حصے میں انکوڈ کیا جاتا ہے جسے <span dir="ltr">@</span> کے نشان کا استعمال کرتے ہوئے ہوسٹ سے الگ کیا جاتا ہے۔ تفصیلات ہوسٹ نیم کو صرف ایک <span dir="ltr">IP</span> پتہ کے طور پر بیان کرتی ہیں؛ تاہم، زیادہ تر کلائنٹس (جیسے <span dir="ltr">Geth</span> اور بیسو) یہاں ایک <span dir="ltr">DNS</span> نام بھی قبول کرتے ہیں اور اسٹارٹ اپ پر اسے ایک <span dir="ltr">IP</span> پتہ میں تبدیل کر دیتے ہیں۔ یہ معیار کا حصہ ہونے کے بجائے کلائنٹ کے لیے مخصوص رویہ ہے۔ ہوسٹ نیم کے حصے میں موجود پورٹ <span dir="ltr">TCP</span> لسننگ پورٹ ہے۔ اگر <span dir="ltr">TCP</span> اور <span dir="ltr">UDP</span> (دریافت) پورٹس مختلف ہوں، تو <span dir="ltr">UDP</span> پورٹ کو ایک کوئری پیرامیٹر <span dir="ltr">"discport"</span> کے طور پر بیان کیا جاتا ہے۔

درج ذیل مثال میں، نوڈ کا <span dir="ltr">URL</span> ایک ایسے نوڈ کو بیان کرتا ہے جس کا <span dir="ltr">IP</span> پتہ `10.3.58.6`، <span dir="ltr">TCP</span> پورٹ `30303` اور <span dir="ltr">UDP</span> دریافت پورٹ `30301` ہے۔
