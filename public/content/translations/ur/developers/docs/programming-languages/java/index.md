---
title: "⁦Java⁩ ڈیولپرز کے لیے ایتھیریم"
description: "⁦Java⁩ پر مبنی پروجیکٹس اور ٹولنگ کا استعمال کرتے ہوئے ایتھیریم کے لیے ڈیولپ کرنے کا طریقہ سیکھیں۔"
lang: ur
incomplete: true
---

<FeaturedText><span dir="ltr">Java</span> پر مبنی پروجیکٹس اور ٹولنگ کا استعمال کرتے ہوئے ایتھیریم کے لیے ڈیولپ کرنے کا طریقہ سیکھیں</FeaturedText>
...
- [<span dir="ltr">IPFS</span> کے ساتھ <span dir="ltr">Java</span> ایپلی کیشن میں اسٹوریج کا انتظام کرنا](https://kauri.io/article/3e8494f4f56f48c4bb77f1f925c6d926/managing-storage-in-a-java-application-with-ipfs)
- [<span dir="ltr">Web3j</span> کے ساتھ <span dir="ltr">Java</span> میں <span dir="ltr">ERC-20</span> ٹوکنز کا نظم کریں](https://kauri.io/article/d13e911bbf624108b1d5718175a5e0a0/manage-erc20-tokens-in-java-with-web3j)
- [<span dir="ltr">Web3j</span> ٹرانزیکشن مینیجرز](https://kauri.io/article/4cb780bb4d0846438d11885a25b6d7e7/web3j-transaction-managers)

## اعلی درجے کے استعمال کے پیٹرنز {#advanced-use-patterns}

- [<span dir="ltr">Java</span> سمارٹ کنٹریکٹ ڈیٹا کیشے بنانے کے لیے <span dir="ltr">Eventeum</span> کا استعمال](https://kauri.io/article/fe81ee9612eb4e5a9ab72790ef24283d/using-eventeum-to-build-a-java-smart-contract-data-cache)

## <span dir="ltr">Java</span> پروجیکٹس اور ٹولز {#java-projects-and-tools}

- [<span dir="ltr">Web3j</span> (ایتھیریم کلائنٹس کے ساتھ تعامل کے لیے لائبریری)](https://github.com/web3j/web3j)
- [<span dir="ltr">ethers-kt</span> (<span dir="ltr">EVM</span> پر مبنی بلاک چینز کے لیے غیر مطابقت پذیر، اعلی کارکردگی والی <span dir="ltr">Kotlin/Java/Android</span> لائبریری۔)](https://github.com/Kr1ptal/ethers-kt)
