...
جب ایک نوڈ کا حوالہ دوسرے نوڈ کے اندر دیا جاتا ہے، تو اس میں `keccak256(rlp.encode(node))` شامل ہوتا ہے، اگر <span dir="ltr">`len(rlp.encode(node)) >= 32`</span> بصورت دیگر `node` جہاں `rlp.encode` [RLP](/developers/docs/data-structures-and-encoding/rlp) انکوڈنگ فنکشن ہے۔
