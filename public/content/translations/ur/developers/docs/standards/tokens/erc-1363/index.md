...
description: ERC-1363، ERC-20 ٹوکنز کے لیے ایک ایکسٹینشن انٹرفیس ہے جو ٹرانسفرز کے بعد وصول کنندہ (recipient) کنٹریکٹ پر، یا منظوریوں (approvals) کے بعد خرچ کرنے والے (spender) کنٹریکٹ پر کسٹم لاجک کو ایک ہی ٹرانزیکشن میں چلانے کی سہولت فراہم کرتا ہے۔
lang: ur
---
...
ERC-1363، ERC-20 ٹوکنز کے لیے ایک ایکسٹینشن انٹرفیس ہے جو ٹرانسفرز کے بعد وصول کنندہ (recipient) کنٹریکٹ پر، یا منظوریوں (approvals) کے بعد خرچ کرنے والے (spender) کنٹریکٹ پر کسٹم لاجک کو ایک ہی ٹرانزیکشن میں چلانے کی سہولت فراہم کرتا ہے۔

### ERC-20 سے اختلافات {#erc20-differences}

معیاری ERC-20 آپریشنز جیسے `transfer`، `transferFrom` اور `approve`، ایک الگ ٹرانزیکشن کے بغیر وصول کنندہ یا خرچ کرنے والے کنٹریکٹ پر کوڈ چلانے کی اجازت نہیں دیتے۔
یہ UI ڈیولپمنٹ میں پیچیدگی اور اپنانے میں رکاوٹ پیدا کرتا ہے کیونکہ صارفین کو پہلی ٹرانزیکشن کے مکمل ہونے کا انتظار کرنا پڑتا ہے اور پھر دوسری جمع کرانی پڑتی ہے۔
انہیں دو بار GAS بھی ادا کرنی پڑتی ہے۔

ERC-1363 فنجیبل ٹوکنز کو زیادہ آسانی سے ایکشنز انجام دینے اور کسی آف چین لسنر (off-chain listener) کے استعمال کے بغیر کام کرنے کے قابل بناتا ہے۔
یہ ٹرانسفر یا منظوری کے بعد، ایک ہی ٹرانزیکشن میں وصول کنندہ یا خرچ کرنے والے کنٹریکٹ پر کال بیک (callback) کرنے کی اجازت دیتا ہے۔
...
ERC-1363، ERC-20 ٹوکنز کے لیے ایک معیاری API متعارف کراتا ہے تاکہ وہ `transfer`، `transferFrom` یا `approve` کے بعد اسمارٹ کنٹریکٹس کے ساتھ تعامل کر سکیں۔

یہ اسٹینڈرڈ ٹوکنز کو ٹرانسفر کرنے کی بنیادی فعالیت فراہم کرتا ہے، اور ساتھ ہی ٹوکنز کو منظور کرنے کی اجازت دیتا ہے تاکہ انہیں کسی دوسری آن چین تھرڈ پارٹی کے ذریعے خرچ کیا جا سکے، اور پھر وصول کنندہ یا خرچ کرنے والے کنٹریکٹ پر کال بیک کیا جا سکے۔
...
ان وجوہات کی بنا پر اسے اصل میں **"پے ایبل ٹوکن (Payable Token)"** کا نام دیا گیا تھا۔
...
ERC-1363 ٹوکنز کو ان تمام صورتوں میں مخصوص افادیت کے لیے استعمال کیا جا سکتا ہے جن میں ٹرانسفر یا منظوری ملنے کے بعد کال بیک کو چلانے کی ضرورت ہوتی ہے۔
ERC-1363 وصول کنندہ کی ٹوکنز کو سنبھالنے کی صلاحیت کی تصدیق کر کے اسمارٹ کنٹریکٹس میں ٹوکن کے نقصان یا ٹوکن کے لاک ہونے سے بچنے کے لیے بھی مفید ہے۔

دیگر ERC-20 ایکسٹینشن تجاویز کے برعکس، ERC-1363، ERC-20 کے `transfer` اور `transferFrom` میتھڈز کو اوور رائیڈ نہیں کرتا اور ERC-20 کے ساتھ بیک ورڈ کمپیٹیبلٹی (backward compatibility) کو برقرار رکھتے ہوئے لاگو کیے جانے والے انٹرفیس IDs کی وضاحت کرتا ہے۔
