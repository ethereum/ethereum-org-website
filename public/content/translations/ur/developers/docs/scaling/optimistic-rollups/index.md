...
##### رول اپ میں داخل ہونا {#evm-compatibility}

آپٹمسٹک رول اپ استعمال کرنے کے لیے، صارفین ETH، ERC-20 ٹوکنز، اور دیگر منظور شدہ اثاثے لیئر ۱ (l1) پر رول اپ کے [پل](/developers/docs/bridges/) کنٹریکٹ میں جمع کراتے ہیں۔ پل کنٹریکٹ ٹرانزیکشن کو لیئر ۲ (l2) پر بھیجے گا، جہاں اثاثوں کی مساوی مقدار کو ڈھالا جاتا ہے اور آپٹمسٹک رول اپ پر صارف کے منتخب کردہ پتے پر بھیجا جاتا ہے۔
...
##### رول اپ سے خروج {#cross-chain-contract-calls}
...
#### 2. EVM کی مطابقت {#how-do-optimistic-rollup-fees-work}
...
#### 3. کراس چین کنٹریکٹ کالز {#scaling-ethereum-with-optimistic-rollups}
...
## آپٹمسٹک رول اپ فیس کیسے کام کرتی ہے؟ {#optimistic-rollups-pros-and-cons}
...
## آپٹمسٹک رول اپس ایتھیریم کو کیسے اسکیل کرتے ہیں؟ {#optimistic-video}
...
### آپٹمسٹک رول اپس کے فوائد اور نقصانات {#further-reading-on-optimistic-rollups}
...
### آپٹمسٹک رول اپس کی بصری وضاحت {#tutorials}
