...
**[API3 DAO](https://api3.org/)** - _API3 DAO فرسٹ-پارٹی اوریکل حل فراہم کر رہا ہے جو اسمارٹ کنٹریکٹس کے لیے ایک غیر مرکزی حل میں زیادہ ماخذ کی شفافیت، سیکیورٹی اور اسکیل ایبلٹی فراہم کرتے ہیں_
