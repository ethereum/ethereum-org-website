...
## سمارٹ کنٹریکٹس میں اوریکلز کی ایپلی کیشنز {#applications-of-oracles-in-smart-contracts}
...
### قابل تصدیق بے ترتیبی پیدا کرنا {#generating-verifiable-randomness}
...
### سمارٹ کنٹریکٹس کو خودکار بنانا {#automating-smart-contracts}
...
**[Supra](https://supra.com/)** - کراس چین سلوشنز کی ایک عمودی طور پر مربوط ٹول کٹ جو تمام بلاک چینز، پبلک (L<span dir="ltr">1s</span> اور L<span dir="ltr">2s</span>) یا پرائیویٹ (انٹرپرائزز) کو آپس میں جوڑتی ہے، لامركزی اوریکل پرائس فیڈز فراہم کرتی ہے جنہیں آن چین اور آف چین استعمال کے کیسز کے لیے استعمال کیا جا سکتا ہے۔

**[Gas Network](https://gas.network/)** - ایک تقسیم شدہ اوریکل پلیٹ فارم جو بلاک چین میں ریئل ٹائم گیس کی قیمت کا ڈیٹا فراہم کرتا ہے۔ معروف گیس کی قیمت کا ڈیٹا فراہم کرنے والوں سے ڈیٹا آن چین لا کر، Gas Network باہمی عمل پذیری کو آگے بڑھانے میں مدد کر رہا ہے۔ Gas Network 35 سے زیادہ چینز کے لیے ڈیٹا کو سپورٹ کرتا ہے، بشمول ایتھیریم مین نیٹ اور بہت سے معروف L<span dir="ltr">2s</span>۔
