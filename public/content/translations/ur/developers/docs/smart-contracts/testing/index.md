...
##### 1. اپنے کنٹریکٹ کی بزنس لاجک اور ورک فلو کو سمجھیں {#integration-testing-for-smart-contracts}
...
##### 2. کنٹریکٹ کے عمل درآمد سے متعلق تمام مفروضوں کا جائزہ لیں {#property-based-testing-for-smart-contracts}
...
##### 3. کوڈ کوریج کی پیمائش کریں {#static-analysis}
...
##### 4. اچھی طرح سے تیار کردہ ٹیسٹنگ فریم ورکس کا استعمال کریں {#dynamic-analysis}
...
### انٹیگریشن ٹیسٹنگ {#running-property-based-tests}
...
### پراپرٹی پر مبنی ٹیسٹنگ {#manual-testing-for-smart-contracts}
...
#### سٹیٹک تجزیہ {#testing-on-local-blockchain}
...
#### متحرک تجزیہ {#testing-contracts-on-testnets}
...
### سمارٹ کنٹریکٹس کے لیے پراپرٹی پر مبنی ٹیسٹنگ چلانے کے لیے رہنما خطوط {#testing-vs-formal-verification}
...
## سمارٹ کنٹریکٹس کے لیے دستی ٹیسٹنگ {#testing-vs-audits-bug-bounties}
...
### مقامی بلاک چین پر کنٹریکٹس کی ٹیسٹنگ {#testing-tools-and-libraries}
...
### آزمائشی نیٹ ورکس پر کنٹریکٹس کی ٹیسٹنگ {#unit-testing-tools}
...
## ٹیسٹنگ بمقابلہ رسمی تصدیق {#property-based-testing-tools}
...
## ٹیسٹنگ بمقابلہ آڈٹ اور بگ باؤنٹیز {#static-analysis-tools}
...
## ٹیسٹنگ ٹولز اور لائبریریاں {#dynamic-analysis-tools}

### یونٹ ٹیسٹنگ ٹولز {#related-tutorials}
...
### پراپرٹی پر مبنی ٹیسٹنگ ٹولز {#further-reading}

#### سٹیٹک تجزیہ ٹولز {#tutorials}
