...
##### کثیر دستخطی والیٹس کا استعمال {#use-require-assert-revert}
...
### 2. کنٹریکٹ کی کارروائیوں کی حفاظت کے لیے require()، assert()، اور revert() اسٹیٹمنٹس کا استعمال کریں {#test-smart-contracts-and-verify-code-correctness}
...
### 3. سمارٹ کنٹریکٹس کی جانچ کریں اور کوڈ کی درستگی کی تصدیق کریں {#get-independent-code-reviews}
...
### 4. اپنے کوڈ کے آزادانہ جائزے کے لیے کہیں {#audits}
...
#### بگ باؤنٹیز {#follow-smart-contract-development-best-practices}
...
### 5. سمارٹ کنٹریکٹ کی ترقی کے دوران بہترین طریقوں پر عمل کریں {#implement-disaster-recovery-plans}
...
### 6. تباہی سے بحالی کے مضبوط منصوبے نافذ کریں {#contract-upgrades}
...
#### کنٹریکٹ اپ گریڈز {#emergency-stops}
...
#### ہنگامی اسٹاپس {#event-monitoring}
...
#### ایونٹ کی نگرانی {#design-secure-governance-systems}
...
### 7. محفوظ گورننس سسٹمز ڈیزائن کریں {#reduce-code-complexity}
...
### 8. کوڈ میں پیچیدگی کو کم سے کم کریں {#mitigate-common-smart-contract-vulnerabilities}
...
### 9. عام سمارٹ کنٹریکٹ کی کمزوریوں کے خلاف دفاع کریں {#reentrancy}

#### مکرر داخلہ {#integer-underflows-and-overflows}
...
##### مکرر داخلہ کے حملوں کو کیسے روکا جائے {#oracle-manipulation}
...
#### انٹیجر انڈر فلوز اور اوور فلوز {#smart-contract-security-resources-for-developers}
...
##### انٹیجر انڈر فلوز اور اوور فلوز کو کیسے روکا جائے {#code-analysis-tools}
...
#### اوریکل میں ہیرا پھیری {#smart-contract-monitoring-tools}
...
##### اوریکل میں ہیرا پھیری کو کیسے روکا جائے {#smart-contract-administration-tools}
...
## ڈیولپرز کے لیے سمارٹ کنٹریکٹ سیکیورٹی کے وسائل {#smart-contract-auditing-services}

### سمارٹ کنٹریکٹس کا تجزیہ کرنے اور کوڈ کی درستگی کی تصدیق کرنے کے ٹولز {#bug-bounty-platforms}
...
### سمارٹ کنٹریکٹس کی نگرانی کے ٹولز {#common-smart-contract-vulnerabilities-and-exploits}
...
### سمارٹ کنٹریکٹس کے محفوظ انتظام کے ٹولز {#challenges-for-learning-smart-contract-security}
...
### سمارٹ کنٹریکٹ آڈیٹنگ سروسز {#smart-contract-security-best-practices}
...
### بگ باؤنٹی پلیٹ فارمز {#tutorials-on-smart-contract-security}
...
### سمارٹ کنٹریکٹ سیکیورٹی پر ٹیوٹوریلز
