---
title: "آپٹیمزم (Optimism) سٹینڈرڈ برج کنٹریکٹ کا جائزہ"
description: "آپٹیمزم کا سٹینڈرڈ برج کیسے کام کرتا ہے؟ اور یہ اس طرح کیوں کام کرتا ہے؟"
...
آپٹیمسٹک رول اپس ایتھیریم مین نیٹ (جسے لیئر 1 یا L1 بھی کہا جاتا ہے) کی نسبت بہت کم قیمت پر ٹرانزیکشنز پروسیس کر سکتے ہیں کیونکہ ٹرانزیکشنز نیٹ ورک کے ہر نوڈ کے بجائے صرف چند نوڈز کے ذریعے پروسیس کی جاتی ہیں۔
ایک ہی وقت میں، تمام ڈیٹا L1 پر لکھا جاتا ہے تاکہ مین نیٹ کی تمام انٹیگریٹی اور دستیابی کی ضمانتوں کے ساتھ ہر چیز کو ثابت اور دوبارہ تشکیل دیا جا سکے۔

آپٹیمزم (یا کسی دوسرے L2) پر L1 اثاثے استعمال کرنے کے لیے، اثاثوں کو [برج](/bridges/#prerequisites) کرنے کی ضرورت ہوتی ہے۔
...
[آپٹیمزم سٹینڈرڈ برج](https://docs.optimism.io/app-developers/bridging/standard-bridge) اسی طرح کام کرتا ہے۔
...
1. اگر ERC-20 ڈپازٹ کر رہے ہیں، تو ڈپازٹ کرنے والا برج کو جمع کی جانے والی رقم خرچ کرنے کا الاؤنس دیتا ہے
...
3. L1 برج برج کیے گئے اثاثے کا قبضہ لے لیتا ہے
   - ETH: اثاثہ کال کے حصے کے طور پر ڈپازٹ کرنے والے کے ذریعے ٹرانسفر کیا جاتا ہے
   - ERC-20: اثاثہ ڈپازٹ کرنے والے کے فراہم کردہ الاؤنس کا استعمال کرتے ہوئے برج کے ذریعے خود کو ٹرانسفر کیا جاتا ہے
...
3. L2 برج L1 برج پر `finalizeETHWithdrawal` یا `finalizeERC20Withdrawal` کو کال کرنے کے لیے کراس ڈومین میسج میکانزم کا استعمال کرتا ہے
...
4. L1 برج تصدیق کرتا ہے کہ `finalizeETHWithdrawal` یا `finalizeERC20Withdrawal` کی کال جائز ہے:
   ...
   - اصل میں L2 پر برج سے تھی
5. L1 برج مناسب اثاثہ (ETH یا ERC-20) مناسب ایڈریس پر ٹرانسفر کرتا ہے
...
آپٹیمزم برج کی اصطلاح میں _ڈپازٹ_ کا مطلب L1 سے L2 میں ٹرانسفر ہے، اور _ودڈراول_ کا مطلب L2 سے L1 میں ٹرانسفر ہے۔
...
اس فنکشن کی واقعی ضرورت نہیں ہے، کیونکہ L2 پر یہ پہلے سے ڈیپلائے کیا گیا کنٹریکٹ ہے، اس لیے یہ ہمیشہ ایڈریس `0x4200000000000000000000000000000000000010` پر ہوتا ہے۔
...
[ایک خاص (اعلی) حد تک، یہ مفت ہے](https://community.optimism.io/docs/developers/bridge/messaging/#for-l1-%E2%87%92-l2-transactions-2)، لہذا جب تک کہ ERC-20 کنٹریکٹ منٹنگ کے وقت کچھ واقعی عجیب نہ کرے، یہ کوئی مسئلہ نہیں ہونا چاہیے۔
یہ فنکشن عام صورتحال کا خیال رکھتا ہے، جہاں ایک صارف اثاثوں کو مختلف بلاک چین پر اسی ایڈریس پر برج کرتا ہے۔
...
آپٹیمزم میں ودڈراولز (اور L2 سے L1 تک کے دیگر پیغامات) دو مراحل کا عمل ہیں:
...
برج انٹرفیس کو دو فائلوں کے درمیان تقسیم کیا گیا ہے کیونکہ کچھ ERC-20 ٹوکنز کو کسٹم پروسیسنگ کی ضرورت ہوتی ہے اور انہیں سٹینڈرڈ برج کے ذریعے ہینڈل نہیں کیا جا سکتا۔
اس طرح کسٹم برج جو ایسے ٹوکن کو ہینڈل کرتا ہے وہ `IL1ERC20Bridge` کو لاگو کر سکتا ہے اور اسے ETH کو بھی برج کرنے کی ضرورت نہیں ہوتی۔
...
[یہ کنٹریکٹ](https://github.com/ethereum-optimism/optimism/blob/develop/packages/contracts/contracts/libraries/bridge/CrossDomainEnabled.sol) دونوں برجز ([L1](#the-l1-bridge-contract) اور [L2](#the-l2-bridge-contract)) کے ذریعے دوسری لیئر پر پیغامات بھیجنے کے لیے وراثت میں ملا ہے۔
...
[یہ انٹرفیس](https://github.com/ethereum-optimism/optimism/blob/develop/packages/contracts/contracts/libraries/bridge/ICrossDomainMessenger.sol) کنٹریکٹ کو بتاتا ہے کہ کراس ڈومین میسنجر کا استعمال کرتے ہوئے دوسری لیئر پر پیغامات کیسے بھیجنے ہیں۔
...
کراس ڈومین میسجنگ اس بلاک چین پر کسی بھی کنٹریکٹ کے ذریعے قابل رسائی ہے جہاں یہ چل رہا ہے (یا تو ایتھیریم مین نیٹ یا آپٹیمزم)۔
...
ہمیں یہ یقینی بنانے کی ضرورت ہے کہ ہمیں موصول ہونے والا پیغام دوسرے برج سے آیا ہے۔
...
ہم متغیر `messenger` کے بجائے ایک فنکشن استعمال کرتے ہیں تاکہ اس سے وراثت میں ملنے والے کنٹریکٹس کو یہ بتانے کے لیے ایک الگورتھم استعمال کرنے کی اجازت دی جا سکے کہ کون سا کراس ڈومین میسنجر استعمال کرنا ہے۔
...
آخر میں، وہ فنکشن جو دوسری لیئر پر پیغام بھیجتا ہے۔
...
[Slither](https://github.com/crytic/slither) ایک سٹیٹک اینالائزر ہے جسے آپٹیمزم ہر کنٹریکٹ پر کمزوریوں اور دیگر ممکنہ مسائل کو تلاش کرنے کے لیے چلاتا ہے۔
...
2. [بنائن ری اینٹرنسی (Benign reentrancy)](https://github.com/crytic/slither/wiki/Detector-Documentation#reentrancy-vulnerabilities-2)
...
اس صورت میں ہم ری اینٹرنسی کے بارے میں پریشان نہیں ہیں، ہم جانتے ہیں کہ `getCrossDomainMessenger()` ایک قابل اعتماد ایڈریس واپس کرتا ہے، یہاں تک کہ اگر Slither کے پاس یہ جاننے کا کوئی طریقہ نہیں ہے۔
...
[یہ انٹرفیس](https://github.com/ethereum-optimism/optimism/blob/develop/packages/contracts/contracts/L2/messaging/IL2ERC20Bridge.sol) ہمیں L2 پر سٹینڈرڈ برج کو کنٹرول کرنے کے لیے پیغامات بنانے کی اجازت دیتا ہے۔

```solidity
import { IERC20 } from "@openzeppelin/contracts/token/ERC20/IERC20.sol";
```

[یہ انٹرفیس](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/token/ERC20/IERC20.sol) ہمیں ERC-20 کنٹریکٹس کو کنٹرول کرنے کی اجازت دیتا ہے۔
...
[`Lib_PredeployAddresses`](https://github.com/ethereum-optimism/optimism/blob/develop/packages/contracts/contracts/libraries/constants/Lib_PredeployAddresses.sol) میں L2 کنٹریکٹس کے ایڈریسز ہیں جن کا ہمیشہ ایک ہی ایڈریس ہوتا ہے۔ اس میں L2 پر سٹینڈرڈ برج شامل ہے۔

```solidity
import { Address } from "@openzeppelin/contracts/utils/Address.sol";
```

[OpenZeppelin کی Address یوٹیلیٹیز](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/utils/Address.sol)۔ یہ کنٹریکٹ ایڈریسز اور ایکسٹرنلی اونڈ اکاؤنٹس (EOA) سے تعلق رکھنے والے ایڈریسز کے درمیان فرق کرنے کے لیے استعمال ہوتا ہے۔

نوٹ کریں کہ یہ کوئی مکمل حل نہیں ہے، کیونکہ ڈائریکٹ کالز اور کنٹریکٹ کے کنسٹرکٹر سے کی گئی کالز کے درمیان فرق کرنے کا کوئی طریقہ نہیں ہے، لیکن کم از کم یہ ہمیں صارف کی کچھ عام غلطیوں کی نشاندہی کرنے اور انہیں روکنے کی اجازت دیتا ہے۔

```solidity
import { SafeERC20 } from "@openzeppelin/contracts/token/ERC20/utils/SafeERC20.sol";
```

[ERC-20 سٹینڈرڈ](https://eips.ethereum.org/EIPS/eip-20) کنٹریکٹ کے لیے ناکامی کی اطلاع دینے کے دو طریقوں کو سپورٹ کرتا ہے:
...
اس طرح کی ڈبل [میپنگ (mapping)](https://www.tutorialspoint.com/solidity/solidity_mappings.htm) وہ طریقہ ہے جس سے آپ [دو جہتی سپارس ایرے (two-dimensional sparse array)](https://en.wikipedia.org/wiki/Sparse_matrix) کی وضاحت کرتے ہیں۔
اس ڈیٹا سٹرکچر میں ویلیوز کی شناخت `deposit[L1 token addr][L2 token addr]` کے طور پر کی جاتی ہے۔
ڈیفالٹ ویلیو صفر ہے۔
صرف وہ سیلز جو مختلف ویلیو پر سیٹ ہوتے ہیں انہیں سٹوریج میں لکھا جاتا ہے۔
...
اس کنٹریکٹ کو سٹوریج میں موجود تمام متغیرات کو کاپی کیے بغیر اپ گریڈ کرنے کے قابل ہونا۔
ایسا کرنے کے لیے ہم ایک [`Proxy`](https://docs.openzeppelin.com/contracts/3.x/api/proxy) استعمال کرتے ہیں، ایک ایسا کنٹریکٹ جو کالز کو ایک الگ کنٹریکٹ میں ٹرانسفر کرنے کے لیے [`delegatecall`](https://solidity-by-example.org/delegatecall/) کا استعمال کرتا ہے جس کا ایڈریس پراکسی کنٹریکٹ کے ذریعے سٹور کیا جاتا ہے (جب آپ اپ گریڈ کرتے ہیں تو آپ پراکسی کو وہ ایڈریس تبدیل کرنے کے لیے کہتے ہیں)۔
جب آپ `delegatecall` استعمال کرتے ہیں تو سٹوریج _کال کرنے والے_ کنٹریکٹ کی سٹوریج ہی رہتی ہے، اس لیے تمام کنٹریکٹ سٹیٹ متغیرات کی ویلیوز متاثر نہیں ہوتیں۔

اس پیٹرن کا ایک اثر یہ ہے کہ اس کنٹریکٹ کی سٹوریج جو `delegatecall` کا _کالڈ (called)_ ہے استعمال نہیں ہوتی اور اس لیے اسے پاس کی گئی کنسٹرکٹر ویلیوز سے کوئی فرق نہیں پڑتا۔
یہی وجہ ہے کہ ہم `CrossDomainEnabled` کنسٹرکٹر کو ایک بے معنی ویلیو فراہم کر سکتے ہیں۔
یہ بھی وجہ ہے کہ نیچے دی گئی انیشلائزیشن کنسٹرکٹر سے الگ ہے۔
...
`external` فنکشنز کی گیس لاگت کم ہو سکتی ہے، کیونکہ انہیں کال ڈیٹا میں پیرامیٹرز فراہم کیے جا سکتے ہیں۔
...
ایسا ہونے کا امکان نہیں ہے سوائے اس کے کہ جب پورا سسٹم اپ گریڈ ہو، جو کہ بہت کم ہوتا ہے۔

نوٹ کریں کہ اس فنکشن میں کوئی ایسا میکانزم نہیں ہے جو اس بات کو محدود کرے کہ اسے _کون_ کال کر سکتا ہے۔
اس کا مطلب یہ ہے کہ نظریاتی طور پر ایک حملہ آور اس وقت تک انتظار کر سکتا ہے جب تک کہ ہم پراکسی اور برج کا پہلا ورژن ڈیپلائے نہ کر دیں اور پھر جائز صارف سے پہلے `initialize` فنکشن تک پہنچنے کے لیے [فرنٹ رن (front-run)](https://solidity-by-example.org/hacks/front-running/) کرے۔ لیکن اسے روکنے کے دو طریقے ہیں:

1. اگر کنٹریکٹس براہ راست EOA کے ذریعے ڈیپلائے نہیں کیے جاتے بلکہ [ایک ایسی ٹرانزیکشن میں جس میں کوئی دوسرا کنٹریکٹ انہیں بناتا ہے](https://medium.com/upstate-interactive/creating-a-contract-with-a-smart-contract-bdb67c5c8595) تو پورا عمل ایٹامک (atomic) ہو سکتا ہے، اور کسی بھی دوسری ٹرانزیکشن کے عمل میں آنے سے پہلے ختم ہو سکتا ہے۔
2. اگر `initialize` کی جائز کال ناکام ہو جاتی ہے تو ہمیشہ یہ ممکن ہے کہ نئے بنائے گئے پراکسی اور برج کو نظر انداز کر دیا جائے اور نئے بنائے جائیں۔
...
Solidity کنٹریکٹس ہمیشہ اپنے کال ڈیٹا کی تشریح [ABI کی خصوصیات](https://docs.soliditylang.org/en/v0.8.12/abi-spec.html) کے مطابق کرتے ہیں۔
...
یہاں پیغام یہ ہے کہ ان پیرامیٹرز کے ساتھ [`finalizeDeposit` فنکشن](https://github.com/ethereum-optimism/optimism/blob/develop/packages/contracts/contracts/L2/messaging/L2StandardBridge.sol#L141-L148) کو کال کیا جائے:

| پیرامیٹر | ویلیو                          | مطلب                                                                                                                                      |
| --------- | ------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------- |
| \_l1Token | address(0)                     | L1 پر ETH (جو کہ ERC-20 ٹوکن نہیں ہے) کی نمائندگی کرنے کے لیے خاص ویلیو                                                                           |
| \_l2Token | Lib_PredeployAddresses.OVM_ETH | L2 کنٹریکٹ جو آپٹیمزم پر ETH کو مینیج کرتا ہے، `0xDeadDeAddeAddEAddeadDEaDDEAdDeaDDeAD0000` (یہ کنٹریکٹ صرف اندرونی آپٹیمزم کے استعمال کے لیے ہے) |
...
ETH کے معاملے میں برج کی کال میں پہلے ہی برج اکاؤنٹ (`msg.value`) میں اثاثے کی منتقلی شامل ہوتی ہے۔
...
1. صارف (`_from`) برج کو مناسب ٹوکنز ٹرانسفر کرنے کا الاؤنس دیتا ہے۔
2. صارف ٹوکن کنٹریکٹ کے ایڈریس، رقم وغیرہ کے ساتھ برج کو کال کرتا ہے۔
3. برج ڈپازٹ کے عمل کے حصے کے طور پر ٹوکنز (خود کو) ٹرانسفر کرتا ہے۔
...
ٹوکنز کی جمع شدہ رقم کو `deposits` ڈیٹا سٹرکچر میں شامل کریں۔
...
اس بات کو یقینی بنائیں کہ یہ ایک _جائز_ پیغام ہے، جو کراس ڈومین میسنجر سے آ رہا ہے اور L2 ٹوکن برج سے شروع ہو رہا ہے۔
...
ETH ٹرانسفر کرنے کا طریقہ یہ ہے کہ وصول کنندہ کو `msg.value` میں wei کی مقدار کے ساتھ کال کیا جائے۔
...
`deposits` ڈیٹا سٹرکچر کو اپ ڈیٹ کریں۔
...
برج کی ایک ابتدائی امپلیمنٹیشن تھی۔
جب ہم اس امپلیمنٹیشن سے اس پر منتقل ہوئے، تو ہمیں تمام اثاثوں کو منتقل کرنا پڑا۔
ERC-20 ٹوکنز کو صرف منتقل کیا جا سکتا ہے۔
تاہم، کسی کنٹریکٹ میں ETH ٹرانسفر کرنے کے لیے آپ کو اس کنٹریکٹ کی منظوری کی ضرورت ہوتی ہے، جو کہ `donateETH` ہمیں فراہم کرتا ہے۔

## L2 پر ERC-20 ٹوکنز {#erc-20-tokens-on-l2}

کسی ERC-20 ٹوکن کو سٹینڈرڈ برج میں فٹ ہونے کے لیے، اسے سٹینڈرڈ برج، اور _صرف_ سٹینڈرڈ برج کو ٹوکن منٹ کرنے کی اجازت دینے کی ضرورت ہے۔
یہ ضروری ہے کیونکہ برجز کو یہ یقینی بنانے کی ضرورت ہے کہ آپٹیمزم پر گردش کرنے والے ٹوکنز کی تعداد L1 برج کنٹریکٹ کے اندر لاک کیے گئے ٹوکنز کی تعداد کے برابر ہے۔
اگر L2 پر بہت زیادہ ٹوکنز ہیں تو کچھ صارفین اپنے اثاثوں کو واپس L1 پر برج کرنے سے قاصر ہوں گے۔
...
اگر L1 پر بہت زیادہ ٹوکنز ہیں، تو ان میں سے کچھ ٹوکنز ہمیشہ کے لیے برج کنٹریکٹ کے اندر لاک رہیں گے کیونکہ L2 ٹوکنز کو برن کیے بغیر انہیں جاری کرنے کا کوئی طریقہ نہیں ہے۔

### IL2StandardERC20 {#il2standarderc20}

L2 پر ہر ERC-20 ٹوکن جو سٹینڈرڈ برج استعمال کرتا ہے اسے [یہ انٹرفیس](https://github.com/ethereum-optimism/optimism/blob/develop/packages/contracts/contracts/standards/IL2StandardERC20.sol) فراہم کرنے کی ضرورت ہے، جس میں وہ فنکشنز اور ایونٹس ہیں جن کی سٹینڈرڈ برج کو ضرورت ہے۔
...
[سٹینڈرڈ ERC-20 انٹرفیس](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/token/ERC20/IERC20.sol) میں `mint` اور `burn` فنکشنز شامل نہیں ہیں۔
ان طریقوں کی [ERC-20 سٹینڈرڈ](https://eips.ethereum.org/EIPS/eip-20) کے ذریعہ ضرورت نہیں ہے، جو ٹوکن بنانے اور تباہ کرنے کے میکانزم کو غیر متعین چھوڑ دیتا ہے۔

```solidity
import { IERC165 } from "@openzeppelin/contracts/utils/introspection/IERC165.sol";
```

[ERC-165 انٹرفیس](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/utils/introspection/IERC165.sol) یہ بتانے کے لیے استعمال ہوتا ہے کہ کنٹریکٹ کون سے فنکشنز فراہم کرتا ہے۔
[آپ سٹینڈرڈ کو یہاں پڑھ سکتے ہیں](https://eips.ethereum.org/EIPS/eip-165)۔
...
ہمیں کسی بھی L1 ٹوکن کو برج کرنے کے قابل ہونے کی ضرورت ہے، قطع نظر اس کے کہ جب اسے لاگو کیا گیا تھا تو L2 سپورٹ کی منصوبہ بندی کی گئی تھی یا نہیں۔
...
برج واحد ہستی ہونی چاہیے جو ان فنکشنز کو چلا سکے تاکہ یہ یقینی بنایا جا سکے کہ ٹوکنز کی تعداد درست ہے (L1 پر لاک کیے گئے ٹوکنز کی تعداد کے برابر)۔

### L2StandardERC20 {#L2StandardERC20}

[یہ `IL2StandardERC20` انٹرفیس کی ہماری امپلیمنٹیشن ہے](https://github.com/ethereum-optimism/optimism/blob/develop/packages/contracts/contracts/standards/L2StandardERC20.sol)۔
...
یہ وہ دو اضافی کنفیگریشن پیرامیٹرز ہیں جن کی ہمیں ضرورت ہے اور ERC-20 کو عام طور پر نہیں ہوتی۔
...
ہر انٹرفیس سپورٹڈ فنکشنز کی ایک تعداد ہے، اور ان فنکشنز کے [ABI فنکشن سلیکٹرز](https://docs.soliditylang.org/en/v0.8.12/abi-spec.html#function-selector) کے [ایکسکلوسیو اور (exclusive or)](https://en.wikipedia.org/wiki/Exclusive_or) کے طور پر پہچانا جاتا ہے۔
...
**نوٹ:** کسی بدمعاش کنٹریکٹ کو `supportsInterface` کے غلط جوابات فراہم کرنے سے روکنے کے لیے کچھ نہیں ہے، اس لیے یہ ایک سینیٹی چیک میکانزم ہے، سیکیورٹی میکانزم _نہیں_۔
...
وہ کنٹریکٹ انہیں بیرونی طور پر ظاہر نہیں کرتا، کیونکہ ٹوکنز کو منٹ اور برن کرنے کی شرائط اتنی ہی مختلف ہیں جتنی کہ ERC-20 کو استعمال کرنے کے طریقوں کی تعداد۔
...
2. L1 پر ETH اور ERC-20 ٹوکنز کے درمیان فرق کرنا ضروری ہے۔ L2 پر ہم دونوں کے لیے ایک ہی فنکشنز استعمال کر سکتے ہیں کیونکہ اندرونی طور پر آپٹیمزم پر ETH بیلنسز کو ایڈریس [0xDeadDeAddeAddEAddeadDEaDDEAdDeaDDeAD0000](https://explorer.optimism.io/address/0xDeadDeAddeAddEAddeadDEaDDEAdDeaDDeAD0000) کے ساتھ ERC-20 ٹوکن کے طور پر ہینڈل کیا جاتا ہے۔
...
اس بات کو یقینی بنائیں کہ پیغام کا ذریعہ جائز ہے۔
یہ اہم ہے کیونکہ یہ فنکشن `_mint` کو کال کرتا ہے اور اسے ایسے ٹوکنز دینے کے لیے استعمال کیا جا سکتا ہے جو ان ٹوکنز کے ذریعے کور نہیں ہوتے جو برج L1 پر رکھتا ہے۔
...
اگر کسی صارف نے غلط L2 ٹوکن ایڈریس استعمال کر کے کوئی قابل شناخت غلطی کی ہے، تو ہم ڈپازٹ کو منسوخ کرنا اور L1 پر ٹوکنز واپس کرنا چاہتے ہیں۔
...
سٹینڈرڈ برج اثاثوں کی منتقلی کے لیے سب سے لچکدار میکانزم ہے۔
تاہم، چونکہ یہ بہت عام ہے اس لیے یہ ہمیشہ استعمال کرنے کے لیے سب سے آسان میکانزم نہیں ہوتا۔
...
یہ برجز عام طور پر L1 پر اثاثے رکھ کر کام کرتے ہیں، جو وہ فوری طور پر ایک چھوٹی سی فیس کے عوض فراہم کرتے ہیں (اکثر سٹینڈرڈ برج ودڈراول کے لیے گیس کی لاگت سے کم)۔
جب برج (یا اسے چلانے والے لوگ) L1 اثاثوں کی کمی کی توقع کرتے ہیں تو یہ L2 سے کافی اثاثے منتقل کرتا ہے۔ چونکہ یہ بہت بڑے ودڈراولز ہیں، اس لیے ودڈراول کی لاگت ایک بڑی رقم پر تقسیم ہو جاتی ہے اور یہ بہت کم فیصد ہوتی ہے۔
