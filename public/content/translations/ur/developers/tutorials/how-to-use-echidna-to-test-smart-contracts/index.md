...
## پراپرٹی پر مبنی فزنگ (property-based fuzzing) کا تعارف {#introduction-to-property-based-fuzzing}
...
### فزنگ (Fuzzing) {#fuzzing}

[فزنگ](https://wikipedia.org/wiki/Fuzzing) سیکیورٹی کمیونٹی میں ایک مشہور تکنیک ہے۔ یہ پروگرام میں بگز (bugs) تلاش کرنے کے لیے کم و بیش بے ترتیب (random) ان پٹس تیار کرنے پر مشتمل ہے۔ روایتی سافٹ ویئر کے لیے فزرز (جیسے [AFL](http://lcamtuf.coredump.cx/afl/) یا [LibFuzzer](https://llvm.org/docs/LibFuzzer.html)) بگز تلاش کرنے کے لیے موثر ٹولز کے طور پر جانے جاتے ہیں۔

ان پٹس کی خالصتاً بے ترتیب جنریشن کے علاوہ، اچھے ان پٹس تیار کرنے کے لیے بہت سی تکنیکیں اور حکمت عملیاں ہیں، جن میں شامل ہیں:

- ہر ایگزیکیوشن سے فیڈ بیک حاصل کریں اور اس کا استعمال کرتے ہوئے جنریشن کی رہنمائی کریں۔ مثال کے طور پر، اگر نیا تیار کردہ ان پٹ کسی نئے راستے کی دریافت کا باعث بنتا ہے، تو اس کے قریب نئے ان پٹس تیار کرنا سمجھ میں آتا ہے۔
...
- نئے ان پٹس تیار کرنے کے لیے معلوم ان پٹس کا استعمال: اگر آپ کو درست ان پٹ کے بڑے ڈیٹاسیٹ تک رسائی حاصل ہے، تو آپ کا فزر شروع سے جنریشن شروع کرنے کے بجائے ان سے نئے ان پٹس تیار کر سکتا ہے۔ انہیں عام طور پر _سیڈز (seeds)_ کہا جاتا ہے۔

### پراپرٹی پر مبنی فزنگ {#property-based-fuzzing}

Echidna فزر کے ایک مخصوص خاندان سے تعلق رکھتا ہے: پراپرٹی پر مبنی فزنگ جو [QuickCheck](https://wikipedia.org/wiki/QuickCheck) سے بہت زیادہ متاثر ہے۔ کلاسک فزر کے برعکس جو کریشز (crashes) تلاش کرنے کی کوشش کرے گا، Echidna صارف کے بیان کردہ انویرینٹس (invariants) کو توڑنے کی کوشش کرے گا۔

اسمارٹ کانٹریکٹس میں، انویرینٹس Solidity فنکشنز ہوتے ہیں، جو کسی بھی غلط یا نامانوس اسٹیٹ (state) کی نمائندگی کر سکتے ہیں جہاں کانٹریکٹ پہنچ سکتا ہے، بشمول:
...
- کوئی آرگومنٹ (argument) نہیں ہونا چاہیے
...
- کسی بھی ایسی ٹرانزیکشن کی اطلاع دے گا جس کی وجہ سے پراپرٹی `false` واپس کرے یا کوئی ایرر (error) دے۔
...
درج ذیل پراپرٹی چیک کرتی ہے کہ کالر کے پاس 1000 سے زیادہ ٹوکنز نہیں ہیں:
...
Echidna کو بغیر آرگومنٹ کے ایک [کنسٹرکٹر (constructor)](/developers/docs/smart-contracts/anatomy/#constructor-functions) کی ضرورت ہوتی ہے۔ اگر آپ کے کانٹریکٹ کو مخصوص ابتداء (initialization) کی ضرورت ہے، تو آپ کو اسے کنسٹرکٹر میں کرنے کی ضرورت ہے۔
...
ہمیں اپنی موجودہ مثال میں کسی خاص ابتداء کی ضرورت نہیں ہے، جس کے نتیجے میں ہمارا کنسٹرکٹر خالی ہے۔
...
اگر contract.sol میں متعدد کانٹریکٹس ہیں، تو آپ ہدف کی وضاحت کر سکتے ہیں:
...
یہ ایک فزر کے لیے مشکل ہے (یہ تجویز کیا جاتا ہے کہ [Manticore](https://github.com/trailofbits/manticore) جیسا علامتی ایگزیکیوشن (symbolic execution) ٹول استعمال کریں)۔
...
### ایک اسیرشن (assertion) لکھیں {#write-an-assertion}
...
اسیرشنز کو واضح پراپرٹیز کے متبادل کے طور پر استعمال کیا جا سکتا ہے، خاص طور پر اگر چیک کی جانے والی شرائط کا براہ راست تعلق کسی آپریشن `f` کے درست استعمال سے ہو۔ کچھ کوڈ کے بعد اسیرشنز شامل کرنے سے یہ نافذ ہوگا کہ چیک اس کے ایگزیکیوٹ ہونے کے فوراً بعد ہوگا۔
...
اس کے برعکس، ایک واضح echidna پراپرٹی کا استعمال تصادفی طور پر ٹرانزیکشنز کو ایگزیکیوٹ کرے گا اور یہ نافذ کرنے کا کوئی آسان طریقہ نہیں ہے کہ اسے کب چیک کیا جائے گا۔ یہ ورک اراؤنڈ (workaround) کرنا اب بھی ممکن ہے:
...
عام طور پر، ہم اسیرشنز کو استعمال کرنے کے طریقے پر [John Regehr کی سفارش](https://blog.regehr.org/archives/1091) پر عمل کرنے کی تجویز کرتے ہیں:
...
Echidna نے پایا کہ `inc` میں اسیرشن ناکام ہو سکتا ہے اگر اس فنکشن کو بڑے آرگومنٹس کے ساتھ متعدد بار کال کیا جائے۔

## Echidna کارپس (corpus) کو جمع کرنا اور اس میں ترمیم کرنا {#collecting-and-modifying-an-echidna-corpus}

ہم دیکھیں گے کہ Echidna کے ساتھ ٹرانزیکشنز کا کارپس کیسے جمع کیا جائے اور استعمال کیا جائے۔ ہدف درج ذیل اسمارٹ کانٹریکٹ [`magic.sol`](https://github.com/crytic/building-secure-contracts/blob/master/program-analysis/echidna/example/magic.sol) ہے:
...
(یہ تجویز کیا جاتا ہے کہ [Manticore](https://github.com/trailofbits/manticore) جیسا علامتی ایگزیکیوشن ٹول استعمال کریں)۔
ہم اس کی تصدیق کے لیے Echidna چلا سکتے ہیں:
...
تاہم، ہم اس فزنگ مہم کو چلاتے وقت کارپس جمع کرنے کے لیے اب بھی Echidna کا استعمال کر سکتے ہیں۔
...
Echidna اب بھی درست جادوئی (magic) اقدار تلاش نہیں کر سکتا، لیکن ہم اس کے جمع کردہ کارپس پر ایک نظر ڈال سکتے ہیں۔
مثال کے طور پر، ان فائلوں میں سے ایک یہ تھی:
...
`magic` فنکشن سے نمٹنے کے لیے Echidna کو کچھ مدد کی ضرورت ہے۔ ہم اس کے لیے مناسب پیرامیٹرز استعمال کرنے کے لیے ان پٹ کو کاپی اور تبدیل کرنے جا رہے ہیں:
...
اس بار، اس نے پایا کہ پراپرٹی کی فوری طور پر خلاف ورزی کی گئی ہے۔
...
اس مثال میں، ہم نتائج کو سمجھنے میں آسان بنانے کے لیے ٹرانزیکشن کی ترتیب کے سائز کو بھی کم کریں گے:
