...
شاید ان وجوہات کی بنا پر، نئے [کنسنسس لیئر کی تفصیلات](https://github.com/ethereum/consensus-specs/blob/master/tests/core/pyspec/README.md) Python میں لکھی گئی ہیں۔ [Python میں ایگزیکیوشن لیئر کی تفصیلات](https://ethereum.github.io/execution-specs) ہیں، لیکن وہ مکمل نہیں ہیں۔ جب تک کہ پورا یلو پیپر بھی Python یا کسی ملتی جلتی زبان میں ترجمہ نہ ہو جائے، یلو پیپر سروس میں رہے گا، اور اسے پڑھنا مددگار ہے۔
