...
### ایتھیریم کے لوگوں کے لیے SAML {#saml-for-ethereum-people}
...
### SAML کے لوگوں کے لیے ایتھیریم {#ethereum-for-saml-people}
...
## ایتھیریم سگنیچرز کا استعمال {#using-ethereum-signatures}
...
## ای میل ایڈریس حاصل کرنا {#getting-the-email-address}
...
## غیر مرکزیت (decentralization) کے بارے میں کیا خیال ہے؟ {#what-about-decentralization}
