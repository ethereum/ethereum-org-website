...
ایسا لگتا ہے کہ `if` اسٹیٹمنٹ یہ چیک کرتی ہے کہ `_param1` صفر نہیں ہے، اور یہ کہ <span dir="ltr">`_param1 * _param2`</span> منفی نہیں ہے۔ یہ غالباً ریپ اراؤنڈ (wrap around) کے معاملات کو روکنے کے لیے ہے۔
