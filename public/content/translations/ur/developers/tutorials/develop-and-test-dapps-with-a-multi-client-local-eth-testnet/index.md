---
title: "ایک مقامی، ملٹی کلائنٹ ٹیسٹ نیٹ پر dApp کو کیسے تیار اور ٹیسٹ کریں"
description: "یہ گائیڈ آپ کو dApp کو تعینات اور ٹیسٹ کرنے کے لیے ٹیسٹ نیٹ استعمال کرنے سے پہلے ملٹی کلائنٹ مقامی Ethereum ٹیسٹ نیٹ کو شروع کرنے اور کنفیگر کرنے کا طریقہ بتائے گی۔"
author: "ٹیڈی میٹیکو"
tags:
  [
    "کلائنٹس",
...
skill: intermediate
breadcrumb: "ملٹی کلائنٹ ٹیسٹ نیٹ"
lang: ur
...
- [Kurtosis](https://www.kurtosis.com/) کا استعمال کرتے ہوئے [`eth-network-package`](https://github.com/kurtosis-tech/eth-network-package) کے ساتھ ایک مقامی Ethereum ٹیسٹ نیٹ شروع کریں گے،
...
[Kurtosis](https://www.kurtosis.com/) ایک کمپوزایبل بلڈ سسٹم ہے جسے ملٹی کنٹینر ٹیسٹ ماحول کو کنفیگر کرنے کے لیے ڈیزائن کیا گیا ہے۔ یہ خاص طور پر ڈیولپرز کو ایسے قابل تجدید ماحول بنانے کے قابل بناتا ہے جن کے لیے متحرک سیٹ اپ لاجک کی ضرورت ہوتی ہے، جیسے کہ بلاک چین ٹیسٹ نیٹس۔

اس گائیڈ میں، Kurtosis eth-network-package ایک مقامی Ethereum ٹیسٹ نیٹ کو اسپن اپ کرتا ہے جس میں [`geth`](https://geth.ethereum.org/) ایگزیکیوشن لیئر (EL) کلائنٹ کے ساتھ ساتھ [`teku`](https://consensys.io/teku)، [`lighthouse`](https://lighthouse.sigmaprime.io/)، اور [`lodestar`](https://lodestar.chainsafe.io/) کنسینسس لیئر (CL) کلائنٹس کی سپورٹ شامل ہے۔ یہ پیکج Hardhat Network، Ganache، اور Anvil جیسے فریم ورکس میں نیٹ ورکس کے لیے ایک قابل ترتیب اور کمپوزایبل متبادل کے طور پر کام کرتا ہے۔ Kurtosis ڈیولپرز کو ان کے استعمال کردہ ٹیسٹ نیٹس پر زیادہ کنٹرول اور لچک فراہم کرتا ہے، جو ایک بڑی وجہ ہے کہ [Ethereum Foundation نے مرج (Merge) کو ٹیسٹ کرنے کے لیے Kurtosis کا استعمال کیا](https://www.kurtosis.com/blog/testing-the-ethereum-merge) اور نیٹ ورک اپ گریڈز کی ٹیسٹنگ کے لیے اس کا استعمال جاری رکھے ہوئے ہے۔
...
- [Kurtosis CLI انسٹال کر لیا ہے](https://docs.kurtosis.com/install#ii-install-the-cli) (یا اگر آپ کے پاس پہلے سے ہی CLI انسٹال ہے تو اسے تازہ ترین ریلیز میں اپ گریڈ کر لیا ہے)
- [Node.js](https://nodejs.org/en)، [yarn](https://classic.yarnpkg.com/lang/en/docs/install/#mac-stable)، اور [npx](https://www.npmjs.com/package/npx) انسٹال کر لیا ہے (اپنے dApp ماحول کے لیے)

## ایک مقامی Ethereum ٹیسٹ نیٹ شروع کرنا {#instantiate-testnet}
...
اس سیکشن میں، آپ نے ایک کمانڈ چلائی جس نے Kurtosis کو ہدایت کی کہ وہ Kurtosis [Enclave](https://docs.kurtosis.com/advanced-concepts/enclaves/) کے اندر ایک مقامی Ethereum ٹیسٹ نیٹ کو اسپن اپ کرنے کے لیے [GitHub پر دور سے ہوسٹ کیے گئے `eth-network-package`](https://github.com/kurtosis-tech/eth-network-package) کا استعمال کرے۔ آپ کے انکلیو (enclave) کے اندر، آپ کو "فائل آرٹفیکٹس" (file artifacts) اور "یوزر سروسز" (user services) دونوں ملیں گے۔
...
### dApp ڈیولپمنٹ ماحول کو سیٹ اپ کریں {#set-up-dapp-env}
...
- [`contracts/`](https://github.com/kurtosis-tech/awesome-kurtosis/tree/main/smart-contract-example/contracts) میں بلیک جیک dApp کے لیے چند سادہ اسمارٹ کانٹریکٹس شامل ہیں
- [`scripts/`](https://github.com/kurtosis-tech/awesome-kurtosis/tree/main/smart-contract-example/scripts) میں آپ کے مقامی Ethereum نیٹ ورک پر ٹوکن کانٹریکٹ تعینات کرنے کے لیے ایک اسکرپٹ شامل ہے
- [`test/`](https://github.com/kurtosis-tech/awesome-kurtosis/tree/main/smart-contract-example/test) میں آپ کے ٹوکن کانٹریکٹ کے لیے ایک سادہ .js ٹیسٹ شامل ہے تاکہ اس بات کی تصدیق کی جا سکے کہ ہمارے بلیک جیک dApp میں ہر کھلاڑی کے لیے 1000 منٹ (mint) کیے گئے ہیں
...
```js
localnet: {
url: 'http://127.0.0.1:<$YOUR_PORT>', // TODO: $YOUR_PORT کو ETH NETWORK KURTOSIS PACKAGE کے ذریعے تیار کردہ نوڈ URI کے پورٹ سے تبدیل کریں

// یہ وہ پرائیویٹ کیز ہیں جو eth-network-package کے ذریعے بنائے گئے پہلے سے فنڈڈ ٹیسٹ اکاؤنٹس سے منسلک ہیں
...
### اپنے dApp کو مقامی طور پر تعینات اور ٹیسٹ کریں {#deploy-and-test-dapp}
...
ہم آپ کی حوصلہ افزائی کرتے ہیں کہ آپ ہمارا [کوئیک اسٹارٹ (quickstart)](https://docs.kurtosis.com/quickstart) (جہاں آپ ایک Postgres ڈیٹا بیس اور اس کے اوپر API بنائیں گے) اور ہماری [awesome-kurtosis ریپوزٹری](https://github.com/kurtosis-tech/awesome-kurtosis) میں ہماری دیگر مثالیں دیکھیں جہاں آپ کو کچھ بہترین مثالیں ملیں گی، بشمول ان کے پیکجز:

- [اسی مقامی Ethereum ٹیسٹ نیٹ کو اسپن اپ کرنا](https://github.com/kurtosis-tech/eth2-package)، لیکن اضافی سروسز کے ساتھ جیسے کہ ٹرانزیکشن اسپیمر (ٹرانزیکشنز کی نقل کرنے کے لیے)، ایک فورک مانیٹر، اور ایک منسلک Grafana اور Prometheus انسٹینس
