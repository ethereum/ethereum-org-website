...
আপনার যদি কোনো প্রশ্ন, পরামর্শ বা মতামত থাকে, তাহলে নির্দ্বিধায় translations@ethereum.org-এ আমাদের সাথে যোগাযোগ করুন, Crowdin-এ @ethdotorg-কে একটি বার্তা পাঠান, অথবা [আমাদের ডিসকর্ড-এ যোগ দিন](https://discord.gg/ethereum-org), যেখানে আপনি #translations চ্যানেলে আমাদের বার্তা পাঠাতে পারেন বা দলের যেকোনো সদস্যের সাথে যোগাযোগ করতে পারেন।

## Crowdin ব্যবহার করা {#using-crowdin}

ethereum.org Crowdin প্রজেক্টটি বন্ধ করা হচ্ছে এবং আর কোনো নতুন অবদান গ্রহণ করা হচ্ছে না ([অনুবাদ প্রোগ্রামের স্ট্যাটাস](/contributing/translation-program/#program-status) দেখুন)। নিচের নির্দেশিকাটি সেইসব অনুবাদ কমিউনিটিগুলোর জন্য রেফারেন্স হিসেবে রয়ে গেছে যারা তাদের নিজস্ব প্রজেক্টের জন্য Crowdin ব্যবহার করে।

আপনি যদি Crowdin এবং এর কিছু উন্নত বৈশিষ্ট্য ব্যবহার সম্পর্কে আরও জানতে চান, তবে [Crowdin নলেজ বেস](https://support.crowdin.com/online-editor/)-এ Crowdin-এর সমস্ত কার্যকারিতার অনেক বিস্তারিত গাইড এবং ওভারভিউ রয়েছে।
...
একটি সাধারণ ভুল ধারণা হলো যে ইথেরিয়াম সর্বদা ল্যাটিন ভাষায় লেখা উচিত। এটি বেশিরভাগ ক্ষেত্রেই ভুল, অনুগ্রহ করে আপনার ভাষার স্থানীয় ইথেরিয়াম বানানটি ব্যবহার করুন (যেমন, চীনা ভাষায় 以太坊, আরবিতে إيثيريوم ইত্যাদি)।
...
উৎস পাঠ্য 'en' এমন কোনো স্ট্রিং অনুবাদ করার সময় অনুগ্রহ করে বিশেষভাবে সতর্ক থাকুন। এটি সেই ভাষাকে উপস্থাপন করে যেটিতে পৃষ্ঠাটি উপলব্ধ এবং এটি [আপনার ভাষার জন্য ISO ভাষা কোডে](https://www.andiamo.co.uk/resources/iso-language-codes/) অনুবাদ করা উচিত। এই স্ট্রিংগুলো সর্বদা ল্যাটিন অক্ষর ব্যবহার করে অনুবাদ করা উচিত, লক্ষ্য ভাষার স্থানীয় লিখন লিপি নয়।
...
আপনি যদি এই ধরনের কোনো সতর্কতা দেখেন, তবে অনুগ্রহ করে ফিরে যান এবং প্রস্তাবিত অনুবাদটি দুবার চেক করুন।
...
এই বিকল্পটি নির্বাচন করার মাধ্যমে, সম্পূর্ণ ট্যাগ টেক্সট আর দেখানো হবে না এবং এটি একটি সংখ্যা দ্বারা প্রতিস্থাপিত হবে।
অনুবাদ করার সময়, এই ট্যাগে ক্লিক করলে স্বয়ংক্রিয়ভাবে সঠিক ট্যাগটি অনুবাদ ক্ষেত্রে কপি হয়ে যাবে।
...
`<code>` - _ওপেনিং ট্যাগ, যাতে একটি কোড স্নিপেট রয়েছে_
...
## প্রতিষ্ঠিত অনুবাদ নেই এমন পরিভাষা {#terms-without-established-translations}
...
## অন্তর্ভুক্তির জন্য অনুবাদ {#translating-for-inclusivity}
...
ethereum.org অনুবাদ করা ইথেরিয়াম-এর বিভিন্ন দিক সম্পর্কে জানার একটি দুর্দান্ত সুযোগ।

অনুবাদ করার সময়, তাড়াহুড়ো না করার চেষ্টা করুন। শান্ত থাকুন এবং উপভোগ করুন!

অনুবাদ প্রোগ্রামের সাথে জড়িত থাকার জন্য এবং ওয়েবসাইটটিকে আরও বৃহত্তর দর্শকদের কাছে অ্যাক্সেসযোগ্য করে তুলতে আমাদের সাহায্য করার জন্য আপনাকে ধন্যবাদ। ইথেরিয়াম কমিউনিটি বিশ্বব্যাপী, এবং আপনি এর একটি অংশ হওয়ায় আমরা আনন্দিত!
