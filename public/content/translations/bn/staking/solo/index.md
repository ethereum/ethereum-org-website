...
[ইথেরিয়াম নিরাপত্তা এবং স্ক্যাম প্রতিরোধ](/security/)
</ExpandableCard>
...
একক ভ্যালিডেটরের জন্য 32 ETH এর বেশি জমা করবেন না। এটা আপনার পুরস্কার বৃদ্ধি করবে না। যদি ভ্যালিডেটরের জন্য একটি উত্তোলনের ঠিকানা সেট করা থাকে, তাহলে পরবর্তী [ভ্যালিডেটর সুইপ](/staking/withdrawals/#validator-sweeping)-এর সময় 32 ETH-এর বেশি অতিরিক্ত তহবিল স্বয়ংক্রিয়ভাবে এই ঠিকানায় উত্তোলন করা হবে।

যদি সোলো স্টেকিং আপনার জন্য অনেক বেশি বলে মনে হয়, তাহলে একটি [স্টেকিং-অ্যাস-এ-সার্ভিস](/staking/saas/) প্রদানকারী ব্যবহার করার কথা বিবেচনা করুন, অথবা আপনি যদি 32 ETH-এর কম নিয়ে কাজ করেন, তাহলে [স্টেকিং পুলগুলো](/staking/pools/) চেক করুন।
</ExpandableCard>
