---
title: "ইন্টিগ্রেটেড ডেভেলপমেন্ট এনভায়রনমেন্টস (IDEs)"
description: "ইথেরিয়াম বিকাশের জন্য ওয়েব-ভিত্তিক এবং ডেস্কটপ IDEs সম্পর্কে জানুন, যার মধ্যে রয়েছে Remix, VS কোড, এবং জনপ্রিয় প্লাগইন।"
lang: bn
---

যখন একটি [ইন্টিগ্রেটেড ডেভেলপমেন্ট এনভায়রনমেন্ট (IDE)](https://wikipedia.org/wiki/Integrated_development_environment) সেট আপ করার কথা আসে, তখন ইথেরিয়াম-এ অ্যাপ্লিকেশন প্রোগ্রামিং করা অন্য যেকোনো সফ্টওয়্যার প্রজেক্ট প্রোগ্রামিং করার মতোই। বেছে নেওয়ার জন্য অনেক বিকল্প আছে, তাই দিনের শেষে, এমন IDE বা কোড এডিটর বেছে নিন যা আপনার পছন্দের জন্য সবচেয়ে উপযুক্ত। সম্ভবত আপনার ইথেরিয়াম বিকাশের জন্য সেরা IDE পছন্দ হলো সেই IDE যা আপনি ইতিমধ্যেই প্রথাগত সফ্টওয়্যার বিকাশের জন্য ব্যবহার করেন।

## ওয়েব-ভিত্তিক IDEs {#web-based-ides}

আপনি যদি একটি [লোকাল ডেভেলপমেন্ট এনভায়রনমেন্ট সেট আপ করার](/developers/local-environment/) আগে কোড নিয়ে নাড়াচাড়া করতে চান, তাহলে এই ওয়েব অ্যাপগুলি ইথেরিয়াম স্মার্ট কন্ট্র্যাক্ট বিকাশের জন্য বিশেষভাবে তৈরি করা হয়েছে।
...
**[EthFiddle](https://ethfiddle.com/)** - **_ওয়েব-ভিত্তিক IDE যা আপনাকে আপনার স্মার্ট কন্ট্র্যাক্ট লিখতে, কম্পাইল করতে এবং ডিবাগ করতে দেয়_**
...
**ভিজ্যুয়াল স্টুডিও কোড -** **_অফিসিয়াল ইথেরিয়াম সমর্থন সহ পেশাদার ক্রস-প্ল্যাটফর্ম IDE_**
