...
##### ডেটার সঠিকতার উপর ভোটিং/স্টেকিং {#availability}
...
##### শেলিং পয়েন্ট মেকানিজম {#good-incentive-compatibility}
...
### উপলব্ধতা {#applications-of-oracles-in-smart-contracts}
...
### ভালো ইনসেনটিভ সামঞ্জস্যতা {#retrieving-financial-data}
...
## স্মার্ট কন্ট্রাক্টে ওরাকলের প্রয়োগ {#generating-verifiable-randomness}

ইথেরিয়ামে ওরাকলের সাধারণ ব্যবহার-ক্ষেত্রগুলো নিচে দেওয়া হলো:

### আর্থিক ডেটা পুনরুদ্ধার করা {#getting-outcomes-for-events}
...
### যাচাইযোগ্য র‍্যান্ডমনেস তৈরি করা {#automating-smart-contracts}
...
### ইভেন্টগুলোর জন্য ফলাফল পাওয়া {#use-blockchain-oracles}
...
### স্মার্ট কন্ট্রাক্ট স্বয়ংক্রিয় করা {#further-reading}
