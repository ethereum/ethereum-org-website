---
title: "ডেলফি ডেভেলপারদের জন্য ইথেরিয়াম"
...
ডেলফি প্রোগ্রামিং ভাষা ব্যবহার করে ইথেরিয়ামের উপরে ডিসেন্ট্রালাইজড এপ্লিকেশন তৈরি করুন এবং স্মার্ট কন্ট্র্যাক্টগুলির সাথে ইন্টারঅ্যাক্ট করুন!

## স্মার্ট কন্ট্র্যাক্ট এবং সলিডিটি ভাষা দিয়ে শুরু করা {#getting-started-with-smart-contracts-and-the-solidity-language}

**ডেলফির সাথে ইথেরিয়ামকে একীভূত করার জন্য আপনার প্রথম পদক্ষেপ নিন**
...
- [ইথেরিয়াম মেইননেটের সাথে ডেলফিকে সংযুক্ত করা](https://medium.com/@svanas/connecting-delphi-to-the-ethereum-main-net-5faf1feffd83)
...
- [ডেলফিতে একটি ইথেরিয়াম-স্বাক্ষরিত মেসেজ সিগনেচার তৈরি করা](https://medium.com/@svanas/generating-an-ethereum-signed-message-signature-in-delphi-75661ce5031b)
...
- [ডেলফি এবং ইথেরিয়াম নেম সার্ভিস (ENS)](https://medium.com/@svanas/delphi-and-ethereum-name-service-ens-4443cd278af7)
- [কুইকনোড, ইথেরিয়াম এবং ডেলফি](https://medium.com/@svanas/quiknode-ethereum-and-delphi-f7bfc9671c23)
- [ডেলফি এবং ইথেরিয়াম ডার্ক ফরেস্ট](https://svanas.medium.com/delphi-and-the-ethereum-dark-forest-5b430da3ad93)
- [ডেলফিতে একটি টোকেনের বিনিময়ে অন্য টোকেন সোয়াপ করা](https://svanas.medium.com/swap-one-token-for-another-in-delphi-bcb999c47f7)
