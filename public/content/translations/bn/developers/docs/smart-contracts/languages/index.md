...
Remix ইন্টিগ্রেটেড ডেভেলপমেন্ট এনভায়রনমেন্ট (আইডিই) Solidity এবং Vyper উভয় ক্ষেত্রেই কন্ট্রাক্ট তৈরি এবং পরীক্ষা করার জন্য একটি বিস্তৃত ডেভেলপমেন্ট পরিবেশ প্রদান করে। কোডিং শুরু করতে [ইন-ব্রাউজার Remix আইডিই ব্যবহার করে দেখুন](https://remix.ethereum.org)।

আরও অভিজ্ঞ ডেভেলপাররা [ইথেরিয়াম ভার্চুয়াল মেশিন (EVM)](/developers/docs/evm/)-এর জন্য একটি ইন্টারমিডিয়েট ল্যাঙ্গুয়েজ Yul, অথবা Yul-এর একটি এক্সটেনশন Yul+ ব্যবহার করতে চাইতে পারেন।

আপনি যদি কৌতূহলী হন এবং এখনও ব্যাপকভাবে ডেভেলপমেন্টের অধীনে থাকা নতুন ল্যাঙ্গুয়েজগুলো পরীক্ষা করতে সাহায্য করতে চান, তবে আপনি Fe নিয়ে পরীক্ষা-নিরীক্ষা করতে পারেন, যা একটি উদীয়মান স্মার্ট কন্ট্রাক্ট ল্যাঙ্গুয়েজ এবং বর্তমানে এটি প্রাথমিক পর্যায়ে রয়েছে।

## পূর্বশর্ত {#prerequisites}

প্রোগ্রামিং ল্যাঙ্গুয়েজ, বিশেষ করে JavaScript বা Python-এর পূর্ব অভিজ্ঞতা আপনাকে স্মার্ট কন্ট্রাক্ট ল্যাঙ্গুয়েজগুলোর পার্থক্য বুঝতে সাহায্য করতে পারে। ল্যাঙ্গুয়েজগুলোর তুলনামূলক আলোচনায় গভীরভাবে প্রবেশ করার আগে আমরা আপনাকে একটি ধারণা হিসেবে স্মার্ট কন্ট্রাক্ট বুঝতে সুপারিশ করি। [স্মার্ট কন্ট্রাক্ট পরিচিতি](/developers/docs/smart-contracts/)।
...
contract Coin {
    ...
    // একটি ঠিকানায় নির্দিষ্ট পরিমাণ নতুন তৈরি করা কয়েন পাঠায়
    // শুধুমাত্র কন্ট্রাক্ট তৈরি কারী কল করতে পারেন
    ...
    // বিদ্যমান কয়েনের একটি নির্দিষ্ট পরিমাণ পাঠায়
...
- কন্ট্রাক্টগুলোকে আরও সুরক্ষিত এবং অডিট করা সহজ করার উদ্দেশ্যে ইচ্ছাকৃতভাবে Solidity-এর চেয়ে কম ফিচার রাখা হয়েছে। Vyper যা সমর্থন করে না:
  - মডিফায়ার
  - ইনহেরিট্যান্স
  - ইনলাইন অ্যাসেম্বলি
  - ফাংশন ওভারলোডিং
...
v0.4.0 থেকে, Vyper একটি [মডিউল সিস্টেম](https://docs.vyperlang.org/en/stable/using-modules.html) সমর্থন করে। ক্লাস ইনহেরিট্যান্সের পরিবর্তে কম্পোজিশনের মাধ্যমে কোড পুনরায় ব্যবহার করা যায়।
...
def bid():
    ...
    # আগের সর্বোচ্চ দরদাতার জন্য রিফান্ড ট্র্যাক করুন
...
@external
def endAuction():
    # ইন্টারঅ্যাক্ট করে এমন ফাংশনগুলো স্ট্রাকচার করার জন্য এটি একটি ভালো গাইডলাইন
    # অন্যান্য কন্ট্রাক্ট এর সাথে (অর্থাৎ, তারা ফাংশন কল করে বা ইথার পাঠায়)
    # তিনটি ধাপে:
    # ১. শর্ত চেক করা
    # ২. অ্যাকশন সম্পাদন করা (সম্ভাব্যভাবে শর্ত পরিবর্তন করা)
    # ৩. অন্যান্য কন্ট্রাক্ট এর সাথে ইন্টারঅ্যাক্ট করা
    # যদি এই ধাপগুলো মিশে যায়, তবে অন্য কন্ট্রাক্ট কল করতে পারে
    # বর্তমান কন্ট্রাক্ট এ ফিরে এসে স্টেট পরিবর্তন করতে পারে বা
    # ইফেক্ট (ইথার পেআউট) একাধিকবার সম্পাদন করতে পারে।
    # যদি অভ্যন্তরীণভাবে কল করা ফাংশনগুলোতে এক্সটার্নাল
    # কন্ট্রাক্ট এর সাথে ইন্টারঅ্যাকশন অন্তর্ভুক্ত থাকে, তবে সেগুলোকেও বিবেচনা করতে হবে
    # এক্সটার্নাল কন্ট্রাক্ট এর সাথে ইন্টারঅ্যাকশন হিসেবে।

    # ১. শর্তাবলী
    # নিলাম শেষ হওয়ার সময় হয়েছে কিনা তা চেক করুন
    assert block.timestamp >= self.auctionEnd
...
আপনি যদি ইথেরিয়ামে নতুন হয়ে থাকেন এবং এখনও স্মার্ট কন্ট্রাক্ট ল্যাঙ্গুয়েজ দিয়ে কোনো কোডিং না করে থাকেন, তবে আমরা Solidity বা Vyper দিয়ে শুরু করার পরামর্শ দিই। স্মার্ট কন্ট্রাক্ট নিরাপত্তার সর্বোত্তম অনুশীলন এবং ইথেরিয়াম ভার্চুয়াল মেশিন (EVM)-এর সাথে কাজ করার সুনির্দিষ্ট বিষয়গুলোর সাথে পরিচিত হওয়ার পরেই কেবল Yul বা Yul+ নিয়ে কাজ করুন।

**Yul**

- ইথেরিয়ামের জন্য ইন্টারমিডিয়েট ল্যাঙ্গুয়েজ।
- [EVM](/developers/docs/evm) এবং [Ewasm](https://github.com/ewasm) (একটি ইথেরিয়াম ফ্লেভারড WebAssembly) সমর্থন করে এবং এটি উভয় প্ল্যাটফর্মের একটি ব্যবহারযোগ্য সাধারণ ডিনোমিনেটর হিসেবে ডিজাইন করা হয়েছে।
...
আপনার যদি আগে থেকেই স্মার্ট কন্ট্রাক্টের ভালো অভিজ্ঞতা থাকে, তবে Yul-এ একটি সম্পূর্ণ ERC-20 ইমপ্লিমেন্টেশন [এখানে](https://solidity.readthedocs.io/en/latest/yul.html#complete-erc20-example) পাওয়া যাবে।

## Fe {#fe}

- ইথেরিয়াম ভার্চুয়াল মেশিন (EVM)-এর জন্য স্ট্যাটিক্যালি টাইপড ল্যাঙ্গুয়েজ।
- Python এবং Rust দ্বারা অনুপ্রাণিত।
- শেখা সহজ হওয়ার লক্ষ্য রাখে -- এমনকি ইথেরিয়াম ইকোসিস্টেমে নতুন ডেভেলপারদের জন্যও।
...
- আপনি যদি একজন শিক্ষানবিস হন, তবে অনেক টিউটোরিয়াল এবং শেখার টুল রয়েছে। [কোডিংয়ের মাধ্যমে শিখুন](/developers/learning-tools/) বিভাগে এ সম্পর্কে আরও দেখুন।
...
- স্মার্ট কন্ট্রাক্ট লিখতে চাওয়া Python ডেভেলপারদের জন্য শুরু করার দারুণ উপায়।
- Vyper-এ ফিচারের সংখ্যা কম, যা আইডিয়াগুলোর দ্রুত প্রোটোটাইপিংয়ের জন্য এটিকে দারুণ করে তোলে।
- Vyper-এর লক্ষ্য হলো অডিট করা সহজ হওয়া এবং সর্বাধিক মানব-পাঠযোগ্য হওয়া।
...
বেসিক সিনট্যাক্স, কন্ট্রাক্ট লাইফসাইকেল, ইন্টারফেস, অপারেটর, ডেটা স্ট্রাকচার, ফাংশন, কন্ট্রোল ফ্লো এবং আরও অনেক কিছুর তুলনার জন্য [Auditless-এর এই চিটশিটটি](https://reference.auditless.com/cheatsheet/) দেখুন।
