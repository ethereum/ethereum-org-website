...
### লেয়ার ২ (l2) টেস্টনেট {#development-networks}
...
#### আরবিট্রাম Sepolia {#consortium-networks}
...
##### ফসেট {#common-and-legacy-testnets}
...
#### অপটিমিস্টিক Sepolia {#other-testnets}

[অপটিমিজম](https://www.optimism.io/)-এর জন্য একটি টেস্টনেট।

##### রিসোর্স {#related-tools}

- [Etherscan](https://sepolia-optimistic.etherscan.io/)
- [Blockscout](https://optimism-sepolia.blockscout.com/)

##### ফসেট {#further-reading}
...
## <Emoji text="🚉" /> কেন ইথেরিয়াম টেস্টনেটগুলোর নামকরণ মেট্রো স্টেশনের নামে করা হয়েছে?
...
### <Emoji text="🚧" /> সাধারণত ব্যবহৃত এবং লিগ্যাসি টেস্টনেট
...
### <Emoji text="🧪" /> অন্যান্য বিশেষায়িত টেস্টনেট
