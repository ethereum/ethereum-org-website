...
##### প্রমাণ যাচাইকরণ {#zk-rollups-and-evm-compatibility}
...
### প্রবেশ এবং প্রস্থান {#how-do-zk-rollup-fees-work}
...
## ZK-রোলআপ এবং EVM সামঞ্জস্যতা {#scaling-ethereum-with-zk-rollups}
...
## ZK-রোলআপ ফি কীভাবে কাজ করে? {#transaction-data-compression}
...
## ZK-রোলআপ কীভাবে ইথেরিয়ামকে স্কেল করে? {#recursive-proofs}

### ট্রানজ্যাকশন ডেটা কম্প্রেশন {#zk-rollups-pros-and-cons}
...
### ZK-রোলআপের সুবিধা এবং অসুবিধা {#zkevm-projects}
...
### ZK-রোলআপের একটি ভিজ্যুয়াল ব্যাখ্যা {#further-reading-on-zk-rollups}
...
## কে zkEVM নিয়ে কাজ করছে? {#tutorials}
...
## টিউটোরিয়াল: ইথেরিয়ামে গোপনীয়তা এবং জিরো-নলেজ
