...
[Mobula](https://mobula.io/) হলো একটি হাই-পারফরম্যান্স ক্রিপ্টো ডেটা API যা 90+ ব্লকচেইন জুড়ে রিয়েল-টাইম এবং ঐতিহাসিক মার্কেট ডেটা, টোকেন মেটাডেটা, ওয়ালেট পোর্টফোলিও এবং অনচেইন অ্যানালিটিক্স প্রদান করে। ডেভেলপাররা তাদের নিজস্ব পরিকাঠামো না চালিয়েই টোকেন-এর দাম, মার্কেট ক্যাপ, ট্রেডিং ভলিউম, তারল্য ডেটা এবং মাল্টি-চেইন ওয়ালেট ব্যালেন্সের জন্য REST এবং GraphQL এন্ডপয়েন্টগুলো অ্যাক্সেস করতে পারেন। Mobula প্রোডাকশন অ্যাপ্লিকেশনগুলোর জন্য বিনামূল্যে (প্রতি মাসে 100K রিকোয়েস্ট) এবং পেইড উভয় প্ল্যান অফার করে।

শুরু করতে, [ডকুমেন্টেশন](https://docs.mobula.io) দেখুন, [API রেফারেন্স](https://docs.mobula.io/reference/) এক্সপ্লোর করুন, অথবা [ড্যাশবোর্ড](https://mobula.io/)-এ সাইন আপ করুন।
...
[Envio](https://envio.dev/) হলো একটি ইনডেক্সিং ফ্রেমওয়ার্ক যা অনচেইন ইভেন্টগুলোকে একটি কোয়েরিযোগ্য GraphQL API-তে পরিণত করে। এটি ইথেরিয়াম এবং যেকোনো EVM-সামঞ্জস্যপূর্ণ চেইন সমর্থন করে। ডেভেলপাররা রিয়েল-টাইম এবং ঐতিহাসিক ডেটা পরিবেশন করতে TypeScript, JavaScript, বা ReScript-এ ইভেন্ট হ্যান্ডলার লেখেন, যার সাথে রি-অর্গ সমর্থন, মাল্টিচেইন ইনডেক্সিং এবং Envio Cloud-এ ম্যানেজড হোস্টিং বা সেল্ফ-হোস্টিং-এর সুবিধা রয়েছে।

শুরু করতে, একটি ইনডেক্সার তৈরি, ডিপ্লয় করা এবং কোয়েরি করতে [HyperIndex কুইকস্টার্ট](https://docs.envio.dev/docs/HyperIndex/quickstart) অনুসরণ করুন।
