...
এখানে আমাদের এমন দুটি ট্যাগ রয়েছে, `<Greeter />` (যাতে আসলে কন্ট্রাক্টের সাথে কথা বলার HTML কোড থাকে) এবং [একটি অনুভূমিক রেখার জন্য `<HTML-PLACEHOLDER-HTMLTAG-8d9513 />`](https://www.w3schools.com/tags/tag_hr.asp)।
