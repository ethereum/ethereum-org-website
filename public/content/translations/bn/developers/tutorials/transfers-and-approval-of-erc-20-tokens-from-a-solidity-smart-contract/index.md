...
পূর্ববর্তী টিউটোরিয়ালে আমরা ইথেরিয়াম ব্লকচেইনে [Solidity-তে একটি ERC-20 টোকেনের গঠন](/developers/tutorials/understand-the-erc-20-token-smart-contract/) সম্পর্কে জেনেছি। এই নিবন্ধে আমরা দেখব কীভাবে Solidity ভাষা ব্যবহার করে একটি টোকেনের সাথে ইন্টারঅ্যাক্ট করার জন্য একটি স্মার্ট কন্ট্রাক্ট ব্যবহার করা যায়।

এই স্মার্ট কন্ট্রাক্টের জন্য, আমরা একটি বাস্তব ডামি বিকেন্দ্রীকৃত এক্সচেঞ্জ তৈরি করব যেখানে একজন ব্যবহারকারী আমাদের নতুন ডিপ্লয় করা [ERC-20 টোকেন](/developers/docs/standards/tokens/erc-20/)-এর বিনিময়ে ইথার ট্রেড করতে পারবেন।
...
```python
#### ইন্টারেক্টিভ Brownie কনসোলে Python...

# DEX ডিপ্লয় করুন
dex = DEX.deploy({'from':account1})

# ইথার দিয়ে টোকেন সোয়াপ করতে buy ফাংশনটি কল করুন
# 1e18 হলো Wei এককে 1 ইথার
dex.buy({'from': account2, 1e18})

# ERC-20 টোকেনের ডিপ্লয়মেন্ট ঠিকানা নিন
# যা DEX কন্ট্রাক্ট তৈরির সময় ডিপ্লয় করা হয়েছিল
# dex.token() টোকেনের ডিপ্লয় করা ঠিকানা রিটার্ন করে
token = ERC20Basic.at(dex.token())

# টোকেনের অনুমোদন করা ফাংশনটি কল করুন
# dex ঠিকানাকে স্পেন্ডার হিসেবে অনুমোদন করুন
# এবং এটি আপনার কতগুলো টোকেন খরচ করতে পারবে
...
একবার আপনি একটি ট্রানজ্যাকশন করলে, আপনার কন্ট্রাক্টে করা ট্রানজ্যাকশনগুলোর জন্য [অপেক্ষা করতে এবং বিস্তারিত জানতে](https://ethereumdev.io/waiting-for-a-transaction-to-be-mined-on-ethereum-with-js/) আমাদের একটি JavaScript টিউটোরিয়াল রয়েছে এবং যতক্ষণ আপনার কাছে ABI থাকে ততক্ষণ [টোকেন হস্তান্তর বা অন্য কোনো ইভেন্ট দ্বারা তৈরি ইভেন্টগুলো ডিকোড করার জন্য একটি টিউটোরিয়াল](https://ethereumdev.io/how-to-decode-event-logs-in-javascript-using-abi-decoder/) রয়েছে।
