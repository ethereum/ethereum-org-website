...
`mint-nft.js` রান করতে এবং আপনার ABI কনসোলে প্রিন্ট হওয়া দেখতে আপনার টার্মিনালে যান এবং রান করুন:
