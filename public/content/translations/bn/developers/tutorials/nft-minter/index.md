...
### মিন্টিং ফাংশন কল করুন
সাধারণত, এই মিন্টিং ফাংশনে আপনাকে প্যারামিটার হিসেবে দুটি ভেরিয়েবল পাস করতে হয়, প্রথমটি হলো `recipient`, যা সেই ঠিকানাকে নির্দিষ্ট করে যেখানে আপনার নতুন মিন্ট করা NFT গ্রহণ করা হবে এবং দ্বিতীয়টি হলো NFT-এর `tokenURI`, একটি স্ট্রিং যা NFT-এর মেটাডেটা বর্ণনা করে এমন একটি JSON ডকুমেন্টে রিজলভ হয়।

একটি NFT-এর মেটাডেটাই মূলত এটিকে প্রাণবন্ত করে তোলে, এটিকে নাম, বিবরণ, ছবি (বা ভিন্ন ডিজিটাল সম্পদ) এবং অন্যান্য বৈশিষ্ট্যের মতো প্রপার্টি রাখার অনুমতি দেয়। এখানে [একটি tokenURI-এর উদাহরণ](https://gateway.pinata.cloud/ipfs/QmSvBcb4tjdFpajGJhbFAWeK3JAxCdNQLQtr6ZdiSi42V2) দেওয়া হলো, যাতে একটি NFT-এর মেটাডেটা রয়েছে。

এই টিউটোরিয়ালে, আমরা অংশ 2-এর উপর ফোকাস করব, যা হলো আমাদের React UI ব্যবহার করে একটি NFT স্মার্ট কন্ট্রাক্ট মিন্টিং ফাংশন কল করা।

আপনার একটি ERC-721 NFT স্মার্ট কন্ট্রাক্ট প্রয়োজন হবে যা Sepolia-এর মতো একটি সমর্থিত টেস্টনেটে ডিপ্লয় করা হয়েছে। আপনি যদি নিজে একটি ডিপ্লয় করতে চান, তবে আমরা Alchemy-এর [Sepolia-তে একটি স্মার্ট কন্ট্রাক্ট ডিপ্লয় করার](https://www.alchemy.com/docs/how-to-deploy-a-smart-contract-to-the-sepolia-testnet) গাইডটি সুপারিশ করছি।
...
### আপনার Alchemy API কী তৈরি করুন
...
ন্যাভ বারে “Apps”-এর উপর হোভার করে এবং “Create App”-এ ক্লিক করে আপনার Alchemy ড্যাশবোর্ডের “Create App” পৃষ্ঠায় নেভিগেট করুন।

আপনার অ্যাপের নাম দিন, আমরা "My First NFT!" বেছে নিয়েছি, একটি সংক্ষিপ্ত বিবরণ দিন, আপনার অ্যাপ বুককিপিংয়ের জন্য ব্যবহৃত এনভায়রনমেন্টের জন্য “Staging” নির্বাচন করুন এবং আপনার নেটওয়ার্কের জন্য “Sepolia” বেছে নিন।
...
ব্যবহারকারীদের ইন্টারঅ্যাক্ট করার জন্য আপনার প্রজেক্টটি লাইভ করতে প্রস্তুত? একটি লাইভ ওয়েবসাইটে আপনার Minter ডিপ্লয় করার জন্য [React ডিপ্লয়মেন্ট ডকুমেন্টেশন](https://create-react-app.dev/docs/deployment/) দেখুন।
...
সম্ভবত, আপনি আপনার ওয়ালেটে আপনার dapp-এর মাধ্যমে মিন্ট করা NFT-গুলো দেখাতে সক্ষম হতে চাইবেন — তাই আমাদের দ্রুত টিউটোরিয়াল [How to View Your NFT in Your Wallet](/developers/tutorials/how-to-view-nft-in-metamask/) দেখতে ভুলবেন না!
