---
title: "গোপন ঠিকানা ব্যবহার করা"
description: "গোপন ঠিকানা ব্যবহারকারীদের বেনামে সম্পদ হস্তান্তর করার সুযোগ দেয়। এই নিবন্ধটি পড়ার পর, আপনি যা করতে পারবেন: গোপন ঠিকানা কী এবং কীভাবে কাজ করে তা ব্যাখ্যা করা, গোপনীয়তা বজায় রেখে কীভাবে গোপন ঠিকানা ব্যবহার করতে হয় তা বোঝা এবং গোপন ঠিকানা ব্যবহার করে এমন একটি ওয়েব-ভিত্তিক অ্যাপ্লিকেশন তৈরি করা।"
author: ওরি পোমেরান্টজ
tags: ["গোপন ঠিকানা", "গোপনীয়তা", "ক্রিপ্টোগ্রাফি", "rust", "wasm"]
skill: intermediate
breadcrumb: গোপন ঠিকানা
...
[ERC-5564](https://eips.ethereum.org/EIPS/eip-5564)-এ এর সমাধান রয়েছে। এই ERC ব্যাখ্যা করে কীভাবে বেনামে হস্তান্তর করার জন্য [গোপন ঠিকানা](https://nerolation.github.io/stealth-utils) ব্যবহার করতে হয়।

**সতর্কতা**: গোপন ঠিকানার পেছনের ক্রিপ্টোগ্রাফি, যতদূর আমরা জানি, বেশ সুরক্ষিত। তবে, সম্ভাব্য সাইড-চ্যানেল আক্রমণের ঝুঁকি রয়েছে। এই ঝুঁকি কমাতে আপনি কী করতে পারেন তা [নিচে](#go-wrong) দেখতে পাবেন।

## গোপন ঠিকানা কীভাবে কাজ করে {#how}

এই নিবন্ধটি দুটি উপায়ে গোপন ঠিকানা ব্যাখ্যা করার চেষ্টা করবে। প্রথমটি হলো [কীভাবে এগুলো ব্যবহার করতে হয়](#how-use)। নিবন্ধের বাকি অংশ বোঝার জন্য এই অংশটিই যথেষ্ট। এরপর রয়েছে [এর পেছনের গণিতের একটি ব্যাখ্যা](#how-math)। আপনি যদি ক্রিপ্টোগ্রাফি নিয়ে আগ্রহী হন, তবে এই অংশটিও পড়ুন। 

### সহজ সংস্করণ (কীভাবে গোপন ঠিকানা ব্যবহার করবেন) {#how-use}
...
### গণিত (কেন গোপন ঠিকানা এভাবে কাজ করে) {#how-math}

স্ট্যান্ডার্ড গোপন ঠিকানাগুলো একই স্তরের নিরাপত্তা বজায় রেখে কম কী বিট দিয়ে আরও ভালো পারফরম্যান্স পেতে [এলিপটিক-কার্ভ ক্রিপ্টোগ্রাফি (ECC)](https://blog.cloudflare.com/a-relatively-easy-to-understand-primer-on-elliptic-curve-cryptography/#elliptic-curves-building-blocks-of-a-better-trapdoor) ব্যবহার করে। তবে বেশিরভাগ ক্ষেত্রে আমরা এটি উপেক্ষা করতে পারি এবং ধরে নিতে পারি যে আমরা সাধারণ পাটিগণিত ব্যবহার করছি।

এমন একটি সংখ্যা আছে যা সবাই জানে, *G*। আপনি *G* দিয়ে গুণ করতে পারেন। কিন্তু ECC-এর প্রকৃতির কারণে, *G* দিয়ে ভাগ করা প্রায় অসম্ভব। ইথেরিয়াম-এ পাবলিক কী ক্রিপ্টোগ্রাফি সাধারণত যেভাবে কাজ করে তা হলো, আপনি ট্রানজ্যাকশন সাইন করতে একটি প্রাইভেট কী, *P<sub>priv</sub>* ব্যবহার করতে পারেন, যা পরে একটি পাবলিক কী, *P<sub>pub</sub> = GP<sub>priv</sub>* দ্বারা যাচাই করা হয়। 

অ্যালিস দুটি প্রাইভেট কী তৈরি করে, *K<sub>priv</sub>* এবং *V<sub>priv</sub>*। *K<sub>priv</sub>* ব্যবহার করা হবে গোপন ঠিকানা থেকে অর্থ খরচ করতে, এবং *V<sub>priv</sub>* ব্যবহার করা হবে অ্যালিসের ঠিকানাগুলো দেখতে। এরপর অ্যালিস পাবলিক কীগুলো প্রকাশ করে: *K<sub>pub</sub> = GK<sub>priv</sub>* এবং *V<sub>pub</sub> = GV<sub>priv</sub>*

বিল একটি তৃতীয় প্রাইভেট কী, *R<sub>priv</sub>* তৈরি করে এবং একটি কেন্দ্রীয় রেজিস্ট্রিতে *R<sub>pub</sub> = GR<sub>priv</sub>* প্রকাশ করে (বিল এটি অ্যালিসকেও পাঠাতে পারত, কিন্তু আমরা ধরে নিচ্ছি ক্যারল আড়ি পাতছে)।

বিল *R<sub>priv</sub>V<sub>pub</sub> = GR<sub>priv</sub>V<sub>priv</sub>* হিসাব করে, যা সে আশা করে অ্যালিসও জানবে (নিচে ব্যাখ্যা করা হয়েছে)। এই মানটিকে বলা হয় *S*, শেয়ার্ড সিক্রেট। এটি বিলকে একটি পাবলিক কী দেয়, *P<sub>pub</sub> = K<sub>pub</sub>+G\*hash(S)*। এই পাবলিক কী থেকে, সে একটি ঠিকানা হিসাব করতে পারে এবং সেখানে তার ইচ্ছামতো সম্পদ পাঠাতে পারে। ভবিষ্যতে, যদি অ্যালিস জেতে, বিল তাকে *R<sub>priv</sub>* বলতে পারে প্রমাণ করার জন্য যে সম্পদগুলো তার কাছ থেকেই এসেছে।

অ্যালিস *R<sub>pub</sub>V<sub>priv</sub> = GR<sub>priv</sub>V<sub>priv</sub>* হিসাব করে। এটি তাকে একই শেয়ার্ড সিক্রেট, *S* দেয়। যেহেতু সে প্রাইভেট কী, *K<sub>priv</sub>* জানে, তাই সে *P<sub>priv</sub> = K<sub>priv</sub>+hash(S)* হিসাব করতে পারে। এই কী তাকে সেই ঠিকানার সম্পদে অ্যাক্সেস দেয় যা *P<sub>pub</sub> = GP<sub>priv</sub> = GK<sub>priv</sub>+G\*hash(S) = K<sub>pub</sub>+G\*hash(S)* থেকে পাওয়া যায়।
...
যেহেতু দেখা এবং খরচ করার জন্য আলাদা কী ব্যবহার করা হয়, অ্যালিস ডেভকে *V<sub>priv</sub>* দিতে পারে। তখন ডেভ *S = R<sub>pub</sub>V<sub>priv</sub> = GR<sub>priv</sub>V<sub>priv</sub>* হিসাব করতে পারে এবং সেভাবে পাবলিক কীগুলো (*P<sub>pub</sub> = K<sub>pub</sub>+G\*hash(S)*) পেতে পারে। কিন্তু *K<sub>priv</sub>* ছাড়া ডেভ প্রাইভেট কী পেতে পারে না।
...
### একাধিক গোপন স্তর ব্যবহার করা {#multi-layer}
...
## একটি গোপন-ঠিকানা অ্যাপ্লিকেশন তৈরি করা {#write-app}

এই নিবন্ধটি [GitHub-এ উপলব্ধ](https://github.com/qbzzt/251022-stealth-addresses.git) একটি গোপন-ঠিকানা অ্যাপ্লিকেশন ব্যাখ্যা করে। 

### টুলস {#tools}

আমরা ব্যবহার করতে পারি এমন [একটি TypeScript গোপন ঠিকানা লাইব্রেরি](https://github.com/ScopeLift/stealth-address-sdk) রয়েছে। তবে, ক্রিপ্টোগ্রাফিক অপারেশনগুলো CPU-নিবিড় হতে পারে। আমি এগুলোকে একটি কম্পাইল করা ভাষায়, যেমন [Rust](https://rust-lang.org/)-এ প্রয়োগ করতে এবং ব্রাউজারে কোড চালানোর জন্য [WASM](https://webassembly.org/) ব্যবহার করতে পছন্দ করি।

আমরা [Vite](https://vite.dev/) এবং [React](https://react.dev/) ব্যবহার করতে যাচ্ছি। এগুলো হলো ইন্ডাস্ট্রি-স্ট্যান্ডার্ড টুল; আপনি যদি এগুলোর সাথে পরিচিত না হন, তবে আপনি [এই টিউটোরিয়ালটি](/developers/tutorials/creating-a-wagmi-ui-for-your-contract/) ব্যবহার করতে পারেন। Vite ব্যবহার করার জন্য, আমাদের Node প্রয়োজন।

### গোপন ঠিকানাগুলো কীভাবে কাজ করে তা দেখুন {#in-action}

1. প্রয়োজনীয় টুলগুলো ইনস্টল করুন: [Rust](https://rust-lang.org/tools/install/) এবং [Node](https://nodejs.org/en/download)।
...
5. [অ্যাপ্লিকেশনটিতে](http://localhost:5173/) ব্রাউজ করুন। এই অ্যাপ্লিকেশন পৃষ্ঠায় দুটি ফ্রেম রয়েছে: একটি অ্যালিসের ইউজার ইন্টারফেসের জন্য এবং অন্যটি বিলের জন্য। ফ্রেম দুটি একে অপরের সাথে যোগাযোগ করে না; সুবিধার জন্য এগুলো কেবল একই পৃষ্ঠায় রাখা হয়েছে।
...
9. প্রাইভেট কীটি ঠিকানার সাথে মিলে কি না তা নিশ্চিত করতে আপনি [একটি অনলাইন ক্যালকুলেটর](https://iancoleman.net/ethereum-private-key-to-address/) ব্যবহার করতে পারেন।
...
Rust-এ [`Cargo.toml`](https://doc.rust-lang.org/cargo/reference/manifest.html) হলো JavaScript-এর [`package.json`](https://docs.npmjs.com/cli/v9/configuring-npm/package-json)-এর সমতুল্য। এতে প্যাকেজের তথ্য, ডিপেন্ডেন্সি ডিক্লারেশন ইত্যাদি থাকে।
...
- মেটা-ঠিকানা (*K<sub>pub</sub>* এবং *V<sub>pub</sub>*)
- ভিউয়িং প্রাইভেট কী (*V<sub>priv</sub>*)
- স্পেন্ডিং প্রাইভেট কী (*K<sub>priv</sub>*)
...
- ভিউ প্রাইভেট কী (*V<sub>priv</sub>*)
- স্পেন্ড প্রাইভেট কী (*K<sub>priv</sub>*)
...
গোপন ঠিকানা কোনো সর্বরোগের ওষুধ নয়; এগুলোকে [সঠিকভাবে ব্যবহার করতে হবে](#go-wrong)। তবে সঠিকভাবে ব্যবহার করা হলে, এগুলো একটি পাবলিক ব্লকচেইন-এ গোপনীয়তা সক্ষম করতে পারে।
