...
- সাইনার আপনার প্রাইভেট কী ব্যবহার করে আপনার জন্য ট্রানজ্যাকশন স্বাক্ষরকরণ করবে। এই টিউটোরিয়ালে আমরা আমাদের ট্রানজ্যাকশন স্বাক্ষরকরণ করতে [Alchemy Web3](https://github.com/alchemyplatform/alchemy-web3) ব্যবহার করব, তবে আপনি অন্য যেকোনো Web3 লাইব্রেরিও ব্যবহার করতে পারেন।
...
- বিভিন্ন ভাষার জন্য অনেক Web3 লাইব্রেরি রয়েছে। এই টিউটোরিয়ালে আমরা [Alchemy Web3](https://github.com/alchemyplatform/alchemy-web3) ব্যবহার করব যা JavaScript-এ লেখা। আপনি [এখানে](/developers/docs/apis/javascript/) অন্যান্য বিকল্পগুলো দেখতে পারেন যেমন [Ethers.js](https://docs.ethers.org/v5/)।
...
- [Alchemy-এর ট্রানজ্যাকশন রিসোর্সের একটি সেট রয়েছে](https://www.alchemy.com/docs/sending-transactions)। আপনি এগুলো ব্যবহার করে ট্রানজ্যাকশন পাঠাতে, ট্রানজ্যাকশন ঘটার আগে সিমুলেট করতে, প্রাইভেট ট্রানজ্যাকশন পাঠাতে এবং গ্যাস-অপ্টিমাইজড ট্রানজ্যাকশন পাঠাতে পারেন।
- আপনার ট্রানজ্যাকশন মেমপুল থেকে টেনে নিয়ে চেইনে যুক্ত করার সময় সতর্ক হতে আপনি [Alchemy ওয়েবহুক](https://www.alchemy.com/docs/reference/webhooks-overview) ব্যবহার করতে পারেন।

**নোট:** এই গাইডের জন্য একটি Alchemy অ্যাকাউন্ট, একটি ইথেরিয়াম ঠিকানা বা মেটামাস্ক ওয়ালেট, Node.js এবং npm ইনস্টল করা প্রয়োজন। যদি না থাকে, তবে এই ধাপগুলো অনুসরণ করুন:

1.  [একটি বিনামূল্যের Alchemy অ্যাকাউন্ট তৈরি করুন](https://auth.alchemy.com/signup)
2.  [মেটামাস্ক অ্যাকাউন্ট তৈরি করুন](https://metamask.io/) (বা একটি ইথেরিয়াম ঠিকানা পান)
3.  [Node.js এবং npm ইনস্টল করুন](https://nodejs.org/en/download/)
...
**6 নম্বর লাইনে** থাকা ঠিকানাটি আপনার নিজস্ব পাবলিক ঠিকানা দিয়ে প্রতিস্থাপন করতে ভুলবেন না।
...
- `sendSignedTransaction`: একবার আমাদের কাছে একটি স্বাক্ষরিত ট্রানজ্যাকশন থাকলে, আমরা `sendSignedTransaction` ব্যবহার করে এটিকে পরবর্তী ব্লকে অন্তর্ভুক্ত করার জন্য পাঠাতে পারি।
...
_এই গাইড সম্পর্কে মতামত এবং পরামর্শের জন্য, অনুগ্রহ করে Alchemy-এর [ডিসকর্ডে](https://discord.gg/A39JVCM) Elan-কে মেসেজ করুন!_

_মূলত Alchemy দ্বারা প্রকাশিত।_
