...
## সারাংশ {#abstract}
EIP-7702 একটি EOA-তে কোড যোগ করার একটি মেকানিজম সংজ্ঞায়িত করে। এই প্রস্তাবটি EOA-গুলোকে, অর্থাৎ লিগ্যাসি ইথেরিয়াম অ্যাকাউন্টগুলোকে, স্বল্পমেয়াদী কার্যকারিতা উন্নতি গ্রহণ করার অনুমতি দেয়, যা অ্যাপ্লিকেশনগুলোর ব্যবহারযোগ্যতা বৃদ্ধি করে। এটি একটি নতুন ট্রানজ্যাকশন টাইপ: 4 ব্যবহার করে ইতিমধ্যে ডিপ্লয় করা কোডে একটি পয়েন্টার সেট করার মাধ্যমে করা হয়।

এই নতুন ট্রানজ্যাকশন টাইপটি একটি অনুমোদন তালিকা প্রবর্তন করে। তালিকার প্রতিটি অনুমোদন টুপল (tuple) নিম্নরূপ সংজ্ঞায়িত করা হয়েছে:
...
**chain_id** অনুমোদনটিকে একটি নির্দিষ্ট চেইনে লক করে (বা সমস্ত চেইনের জন্য 0)
**nonce** অনুমোদনটিকে একটি নির্দিষ্ট অ্যাকাউন্ট নন্সে লক করে
(**y_parity, r, s**) হলো অনুমোদন টুপলের স্বাক্ষর, যা EOA-এর প্রাইভেট কী দ্বারা keccak(0x05 || rlp ([chain_id ,address, nonce])) হিসেবে সংজ্ঞায়িত করা হয়, যার ওপর অনুমোদনটি প্রযোজ্য (যাকে অথরিটি বা কর্তৃপক্ষও বলা হয়)

নাল (null) ঠিকানায় অর্পণ করার মাধ্যমে একটি অর্পণ রিসেট করা যেতে পারে।

অর্পণের পরেও EOA-এর প্রাইভেট কী অ্যাকাউন্টের ওপর সম্পূর্ণ নিয়ন্ত্রণ বজায় রাখে। উদাহরণস্বরূপ, একটি Safe-এ অর্পণ করলে অ্যাকাউন্টটি মাল্টিসিগ হয়ে যায় না কারণ এখনও একটি একক কী রয়েছে যা যেকোনো স্বাক্ষরকরণ নীতিকে বাইপাস করতে পারে। ভবিষ্যতে, ডেভেলপারদের এই ধারণা নিয়ে ডিজাইন করা উচিত যে সিস্টেমের যেকোনো অংশগ্রহণকারী একটি স্মার্ট কন্ট্রাক্ট হতে পারে। স্মার্ট কন্ট্রাক্ট ডেভেলপারদের জন্য, `tx.origin` একটি EOA-কে নির্দেশ করে এমনটা ধরে নেওয়া আর নিরাপদ নয়।
## সর্বোত্তম অনুশীলন {#best-practices}
**অ্যাকাউন্ট বিমূর্তকরণ**: সামঞ্জস্যতা সর্বাধিক করার জন্য একটি অর্পণ কন্ট্রাক্ট ইথেরিয়ামের বৃহত্তর অ্যাকাউন্ট বিমূর্তকরণ (AA) মানগুলোর সাথে সামঞ্জস্যপূর্ণ হওয়া উচিত। বিশেষ করে, এটি আদর্শভাবে ERC-4337 অনুগত বা সামঞ্জস্যপূর্ণ হওয়া উচিত।

**পারমিশনলেস এবং সেন্সরশিপ-প্রতিরোধী ডিজাইন**: ইথেরিয়াম পারমিশনলেস অংশগ্রহণকে মূল্য দেয়। একটি অর্পণ কন্ট্রাক্টকে অবশ্যই কোনো একক "বিশ্বস্ত" রিলেয়ার বা পরিষেবার ওপর নির্ভর বা হার্ড-কোড করা উচিত নয়। রিলেয়ার অফলাইনে গেলে এটি অ্যাকাউন্টটিকে অকেজো করে দেবে। ব্যাচিং (যেমন, approve+transferFrom)-এর মতো বৈশিষ্ট্যগুলো রিলেয়ার ছাড়াই EOA নিজেই ব্যবহার করতে পারে। অ্যাপ্লিকেশন ডেভেলপার যারা EIP-7702 দ্বারা সক্ষম উন্নত বৈশিষ্ট্যগুলো (গ্যাস বিমূর্তকরণ, গোপনীয়তা-সংরক্ষণকারী উত্তোলন) ব্যবহার করতে চান, তাদের জন্য একটি রিলেয়ার প্রয়োজন হবে। যদিও বিভিন্ন রিলেয়ার আর্কিটেকচার রয়েছে, আমাদের সুপারিশ হলো [ERC-4337 বান্ডলার](https://www.erc4337.io/bundlers) ব্যবহার করা যা অন্তত [এন্ট্রি পয়েন্ট 0.8](https://github.com/eth-infinitism/account-abstraction/releases/tag/v0.8.0)-কে নির্দেশ করে, কারণ:
...
- একটি [পাবলিক মেমপুল](https://notes.ethereum.org/@yoav/unified-erc-4337-mempool)-এর মাধ্যমে সেন্সরশিপ প্রতিরোধের সমর্থন করতে পারে
- init ফাংশনটিকে শুধুমাত্র [EntryPoint](https://github.com/eth-infinitism/account-abstraction/releases/tag/v0.8.0) থেকে কল করার প্রয়োজন করতে পারে

অন্য কথায়, যে কেউ ট্রানজ্যাকশন স্পনসর/রিলেয়ার হিসেবে কাজ করতে সক্ষম হওয়া উচিত যতক্ষণ না তারা অ্যাকাউন্ট থেকে প্রয়োজনীয় বৈধ স্বাক্ষর বা ব্যবহারকারী অপারেশন প্রদান করে। এটি সেন্সরশিপ প্রতিরোধ নিশ্চিত করে: যদি কোনো কাস্টম পরিকাঠামোর প্রয়োজন না হয়, তবে একজন ব্যবহারকারীর ট্রানজ্যাকশনগুলো কোনো গেটকিপিং রিলে দ্বারা ইচ্ছাকৃতভাবে ব্লক করা যাবে না। উদাহরণস্বরূপ, [মেটামাস্ক-এর ডেলিগেশন টুলকিট](https://github.com/MetaMask/delegation-framework/releases/tag/v1.3.0) মেটামাস্ক-নির্দিষ্ট সার্ভারের প্রয়োজন না করে যেকোনো চেইনে যেকোনো ERC-4337 বান্ডলার বা পেমাস্টারের সাথে স্পষ্টভাবে কাজ করে।

**ওয়ালেট ইন্টারফেসের মাধ্যমে বিকেন্দ্রীকৃত অ্যাপ্লিকেশন (dapp) ইন্টিগ্রেশন**:

যেহেতু ওয়ালেটগুলো EIP-7702-এর জন্য নির্দিষ্ট অর্পণ কন্ট্রাক্টগুলোকে হোয়াইটলিস্ট করবে, তাই dapp-গুলোর সরাসরি EIP-7702 অনুমোদনের অনুরোধ করার আশা করা উচিত নয়। এর পরিবর্তে, প্রমিত ওয়ালেট ইন্টারফেসের মাধ্যমে ইন্টিগ্রেশন হওয়া উচিত:

- **ERC-5792 (`wallet_sendCalls`)**: dapp-গুলোকে ওয়ালেটগুলোকে ব্যাচ করা কলগুলো কার্যকর করার অনুরোধ করতে সক্ষম করে, যা ট্রানজ্যাকশন ব্যাচিং এবং গ্যাস বিমূর্তকরণের মতো কার্যকারিতাগুলোকে সহজতর করে।

- **ERC-6900**: dapp-গুলোকে ওয়ালেট-পরিচালিত মডিউলগুলোর মাধ্যমে সেশন কী এবং অ্যাকাউন্ট পুনরুদ্ধারের মতো মডুলার স্মার্ট অ্যাকাউন্ট ক্ষমতাগুলো ব্যবহার করার অনুমতি দেয়।

এই ইন্টারফেসগুলো ব্যবহার করে, dapp-গুলো সরাসরি অর্পণ পরিচালনা না করেই EIP-7702 দ্বারা প্রদত্ত স্মার্ট অ্যাকাউন্ট কার্যকারিতাগুলো অ্যাক্সেস করতে পারে, যা বিভিন্ন ওয়ালেট বাস্তবায়ন জুড়ে সামঞ্জস্যতা এবং নিরাপত্তা নিশ্চিত করে।

> দ্রষ্টব্য: dapp-গুলোর সরাসরি EIP-7702 অনুমোদন স্বাক্ষরের অনুরোধ করার কোনো প্রমিত পদ্ধতি নেই। EIP-7702 বৈশিষ্ট্যগুলোর সুবিধা নিতে dapp-গুলোকে অবশ্যই ERC-6900-এর মতো নির্দিষ্ট ওয়ালেট ইন্টারফেসের ওপর নির্ভর করতে হবে।
...
**ভেন্ডর লক-ইন এড়ানো**: ওপরের কথার সাথে সামঞ্জস্য রেখে, একটি ভালো বাস্তবায়ন হলো ভেন্ডর-নিরপেক্ষ এবং আন্তঃক্রিয়াশীল। এর অর্থ প্রায়শই স্মার্ট অ্যাকাউন্টগুলোর জন্য উদীয়মান মানগুলো মেনে চলা। উদাহরণস্বরূপ, [Alchemy-এর মডুলার অ্যাকাউন্ট](https://github.com/alchemyplatform/modular-account) মডুলার স্মার্ট অ্যাকাউন্টগুলোর জন্য ERC-6900 মান ব্যবহার করে এবং এটি "পারমিশনলেস আন্তঃক্রিয়াশীল ব্যবহার"-এর কথা মাথায় রেখে ডিজাইন করা হয়েছে।

**গোপনীয়তা সংরক্ষণ**: যদিও অনচেইন গোপনীয়তা সীমিত, একটি অর্পণ কন্ট্রাক্টের উচিত ডেটা এক্সপোজার এবং লিংকেবিলিটি কমানোর চেষ্টা করা। এটি ERC-20 টোকেনে গ্যাস পেমেন্ট (যাতে ব্যবহারকারীদের একটি পাবলিক ETH ব্যালেন্স বজায় রাখার প্রয়োজন না হয়, যা গোপনীয়তা এবং UX উন্নত করে) এবং ওয়ান-টাইম সেশন কী (যা একটি একক দীর্ঘমেয়াদী কী-এর ওপর নির্ভরতা কমায়)-এর মতো বৈশিষ্ট্যগুলো সমর্থন করার মাধ্যমে অর্জন করা যেতে পারে। উদাহরণস্বরূপ, EIP-7702 স্পনসর করা ট্রানজ্যাকশনগুলোর মাধ্যমে টোকেনে গ্যাস প্রদান করতে সক্ষম করে, এবং একটি ভালো বাস্তবায়ন প্রয়োজনের চেয়ে বেশি তথ্য ফাঁস না করে এই ধরনের পেমাস্টারগুলোকে একীভূত করা সহজ করে তুলবে। উপরন্তু, নির্দিষ্ট অনুমোদনগুলোর অফচেইন অর্পণ (অনচেইনে যাচাই করা স্বাক্ষরগুলো ব্যবহার করে) মানে ব্যবহারকারীর প্রাথমিক কী-এর সাথে কম অনচেইন ট্রানজ্যাকশন, যা গোপনীয়তায় সহায়তা করে। যে অ্যাকাউন্টগুলোতে রিলেয়ার ব্যবহার করার প্রয়োজন হয় সেগুলো ব্যবহারকারীদের তাদের IP ঠিকানা প্রকাশ করতে বাধ্য করে। পাবলিক মেমপুলগুলো এটিকে উন্নত করে, যখন একটি ট্রানজ্যাকশন/ব্যবহারকারী অপারেশন মেমপুলের মাধ্যমে প্রচারিত হয় তখন আপনি বলতে পারবেন না যে এটি যে IP থেকে পাঠানো হয়েছিল সেখান থেকে উদ্ভূত হয়েছে, নাকি p2p প্রোটোকলের মাধ্যমে এটি কেবল রিলে করা হয়েছে।

**প্রসারণযোগ্যতা এবং মডুলার নিরাপত্তা**: অ্যাকাউন্ট বাস্তবায়নগুলো প্রসারণযোগ্য হওয়া উচিত যাতে সেগুলো নতুন বৈশিষ্ট্য এবং নিরাপত্তা উন্নতির সাথে বিকশিত হতে পারে। EIP-7702-এর সাথে আপগ্রেডযোগ্যতা স্বভাবতই সম্ভব (যেহেতু একটি EOA সর্বদা তার লজিক আপগ্রেড করতে ভবিষ্যতে একটি নতুন কন্ট্রাক্টে অর্পণ করতে পারে)। আপগ্রেডযোগ্যতার বাইরে, একটি ভালো ডিজাইন মডুলারিটির অনুমতি দেয় – যেমন, বিভিন্ন স্বাক্ষর স্কিম বা ব্যয়ের নীতিগুলোর জন্য প্লাগ-ইন মডিউল – সম্পূর্ণভাবে পুনরায় ডিপ্লয় করার প্রয়োজন ছাড়াই। Alchemy-এর অ্যাকাউন্ট কিট হলো একটি প্রধান উদাহরণ, যা ডেভেলপারদের কাস্টম লজিকের জন্য ভ্যালিডেশন মডিউল (ECDSA, BLS ইত্যাদির মতো বিভিন্ন স্বাক্ষরের প্রকারের জন্য) এবং এক্সিকিউশন মডিউল ইনস্টল করতে দেয়। EIP-7702-সক্ষম অ্যাকাউন্টগুলোতে বৃহত্তর নমনীয়তা এবং নিরাপত্তা অর্জন করতে, ডেভেলপারদের সরাসরি কোনো নির্দিষ্ট বাস্তবায়নের পরিবর্তে একটি প্রক্সি চুক্তিতে অর্পণ করতে উৎসাহিত করা হয়। এই পদ্ধতিটি প্রতিটি পরিবর্তনের জন্য অতিরিক্ত EIP-7702 অনুমোদনের প্রয়োজন ছাড়াই নির্বিঘ্ন আপগ্রেড এবং মডুলারিটির অনুমতি দেয়।

প্রক্সি প্যাটার্নের সুবিধা:

- **আপগ্রেডযোগ্যতা**: প্রক্সিটিকে একটি নতুন বাস্তবায়ন কন্ট্রাক্টে নির্দেশ করে কন্ট্রাক্ট লজিক আপডেট করুন।
...
উদাহরণস্বরূপ, [SafeEIP7702Proxy](https://docs.safe.global/advanced/eip-7702/7702-safe) প্রদর্শন করে যে কীভাবে EIP-7702-সামঞ্জস্যপূর্ণ অ্যাকাউন্টগুলোতে নিরাপদে ইনিশিয়ালাইজ করতে এবং অর্পণগুলো পরিচালনা করতে একটি প্রক্সি ব্যবহার করা যেতে পারে।

প্রক্সি প্যাটার্নের অসুবিধা:

- **বাহ্যিক অভিনেতাদের ওপর নির্ভরতা**: একটি অনিরাপদ কন্ট্রাক্টে আপগ্রেড না করার জন্য আপনাকে একটি বাহ্যিক দলের ওপর নির্ভর করতে হবে।
...
### পরিচিত বাস্তবায়ন {#known-implementations}
EIP-7702-এর প্রকৃতির কারণে, ব্যবহারকারীদের কোনো তৃতীয় পক্ষের কন্ট্রাক্টে অর্পণ করতে সাহায্য করার সময় ওয়ালেটগুলোকে সতর্কতা অবলম্বন করার পরামর্শ দেওয়া হয়। নিচে পরিচিত বাস্তবায়নগুলোর একটি সংগ্রহ তালিকাভুক্ত করা হলো যা অডিট করা হয়েছে:
...
হার্ডওয়্যার প্রদানকারী পরিচিত অর্পণ কন্ট্রাক্টগুলোকে হোয়াইটলিস্ট করে এবং সফ্টওয়্যার কম্প্যানিয়নে সেগুলোর সমর্থন বাস্তবায়ন করে। সম্পূর্ণ ERC-4337 সমর্থনসহ একটি কন্ট্রাক্ট বেছে নেওয়ার পরামর্শ দেওয়া হয়。

ভিন্ন কোনোটিতে অর্পিত EOA-গুলোকে স্ট্যান্ডার্ড EOA হিসেবে পরিচালনা করা হবে।
#### কাস্টম অর্পণ {#custom-delegation}
হার্ডওয়্যার প্রদানকারী নিজস্ব অর্পণ কন্ট্রাক্ট বাস্তবায়ন করে এবং এটিকে তালিকায় যুক্ত করে সফ্টওয়্যার কম্প্যানিয়নে এর সমর্থন বাস্তবায়ন করে। সম্পূর্ণ ERC-4337 সমর্থনসহ একটি কন্ট্রাক্ট তৈরি করার পরামর্শ দেওয়া হয়。
