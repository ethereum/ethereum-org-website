...
اسناد Nethermind یک [راهنمای کامل](https://docs.nethermind.io/get-started/running-node/) در مورد اجرای Nethermind با کلاینت اجماع ارائه می دهد.
...
شما باید نرم‌افزار کلاینت خود را با آخرین پچ‌های امنیتی، ویژگی‌ها و [EIPها](/eips/) به‌روز نگه‌دارید. به‌ویژه قبل از [فورک سخت](/ethereum-forks/)، مطمئن شوید که نسخه‌های کلاینت صحیح را اجرا می‌کنید.
