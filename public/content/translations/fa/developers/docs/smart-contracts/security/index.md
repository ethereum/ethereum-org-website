...
- **[قراردادهای اوپن زپلین](https://docs.openzeppelin.com/contracts/5.x/)** - _کتابخانه‌ها را برای اجرای ویژگی‌های اداری، از جمله مالکیت قرارداد، ارتقاء، کنترل‌های دسترسی، حاکمیت، قابلیت توقف موقت و موارد دیگر مدیریت می‌کند._
...
- **[Nethermind](https://www.nethermind.io/smart-contract-audits)** - _ خدمات حسابرسی سالیدیتی و کایرو، تضمین یکپارچگی قراردادهای هوشمند و ایمنی کاربران در سراسر اتریوم و استارک نت را ارائه می‌دهد._
...
- قماله **[کانسنسیس: حملات شناخته شده قرارداد هوشمند](https://consensysdiligence.github.io/smart-contract-best-practices/attacks/)** - _توضیحات مبتدی مهم ترین آسیب پذیری های قرارداد، با کد نمونه برای اکثر موارد._
