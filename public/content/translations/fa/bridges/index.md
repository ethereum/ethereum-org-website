...
<AlertContent>
<AlertDescription>
  البته مي توانيد تمام كارهاي فوق را توسط [صرافي متمركز](/get-eth/) انجام دهيد. با این حال، در این صورت با انجام چند مرحله می توانید بهتر از پل مورد نظر استفاده کنید، مگر آن که پول‌هایتان از قبل در صرافی باشد.
</AlertDescription>
</AlertContent>
</Alert>
