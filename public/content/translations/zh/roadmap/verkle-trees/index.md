...
Verkle 树是 `(key,value)` 对，其中的密钥是 32 字节的元素，由 31 字节的_词干_和一个字节的_后缀_组成。 这些密钥被组织成_扩展_节点和_内部_节点。 扩展节点代表一个单一的词干，包含 256 个不同后缀的子节点。 内部节点也有 256 个子节点，但它们可以是其他扩展节点。 沃克尔树和默克尔树结构的主要区别在于，沃克尔树更扁平，这意味着连接叶子和根的中间节点更少，因此生成证明所需的数据也更少。

![Verkle 树数据结构图](./verkle.png)

[阅读更多关于 Verkle 树结构的信息](https://blog.ethereum.org/2021/12/02/verkle-tree-structure)

## 当前进展 {#current-progress}

沃克尔树测试网已经启动并运行，但要支持沃克尔树，还需要对客户端进行大量更新。 你可以通过在测试网部署智能合约或运行测试网客户端来帮助加速这一进程。

[观看 Guillaume Ballet 讲解 Condrieu Verkle 测试网](https://www.youtube.com/watch?v=cPLHFBeC0Vg)（注意，Condrieu 测试网是工作量证明，现已被 Verkle Gen Devnet 6 测试网取代）。

## 扩展阅读{#further-reading}

- [Verkle 树与无状态性](https://verkle.info/)
- [Dankrad Feist 在 PEEPanEIP 上讲解 Verkle 树](https://www.youtube.com/watch?v=RGJOQHzg3UQ)
- [写给普通人看的 Verkle 树](https://web.archive.org/web/20250124132255/https://research.2077.xyz/verkle-trees)
- [Verkle 证明剖析](https://ihagopian.com/posts/anatomy-of-a-verkle-proof)
- [Guillaume Ballet 在 ETHGlobal 上讲解 Verkle 树](https://www.youtube.com/watch?v=f7bEtX3Z57o)
- [Guillaume Ballet 在 Devcon 6 演讲：“Verkle 树如何让以太坊变得精简高效”](https://www.youtube.com/watch?v=Q7rStTKwuYs)
- [Piper Merriam 在 ETHDenver 2020 谈无状态客户端](https://www.youtube.com/watch?v=0yiZJNciIJ4)
- [Dankrad Fiest 在 Zero Knowledge 播客上讲解 Verkle 树和无状态性](https://zeroknowledge.fm/podcast/202/)
- [Vitalik Buterin 谈 Verkle 树](https://vitalik.eth.limo/general/2021/06/18/verkle.html)
- [Dankrad Feist 谈 Verkle 树](https://dankradfeist.de/ethereum/2021/06/18/verkle-trie-for-eth1.html)
- [Verkle 树 EIP 文档](https://notes.ethereum.org/@vbuterin/verkle_tree_eip#Illustration)
