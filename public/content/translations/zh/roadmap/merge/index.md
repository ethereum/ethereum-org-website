...
<ExpandableCard
title="质押节点运营商与提供商"
contentPreview="如果你是运行自己节点设置的质押者，或者是节点基础设施提供商，在合并之后你需要注意一些事项。"
...
<ExpandableCard
title="非验证节点运营商与基础设施提供商"
contentPreview="如果你正在运营一个非验证以太坊节点，合并带来的最重大变化是要求同时运行执行层和共识层的客户端。"
id="node-operators">
...
<ExpandableCard
title="Dapp 与智能合约开发者"
contentPreview="合并的设计旨在对智能合约和 dapp 开发者产生最小的影响。"
id="developers">
...
<ExpandableCard
title="误解：&quot;运行节点需要质押 32 个 ETH。&quot;"
contentPreview="错误。任何人都可以自由同步自己自我验证的以太坊副本（即运行节点）。不需要任何 ETH——合并前不需要，合并后不需要，永远都不需要。">
...
<ExpandableCard
title="误解：&quot;合并未能降低 Gas 费用。&quot;"
contentPreview="错误。合并是共识机制的改变，而不是网络容量的扩展，并且从未打算降低 Gas 费用。">
...
contentPreview="错误。虽然存在一些微小的变化，但现在一层网络上的交易速度与合并前基本相同。">
...
<ExpandableCard
title="误解：&quot;合并启用了质押提款。&quot;"
contentPreview="错误，但质押提款随后已通过上海/Capella 升级启用。">
...
<ExpandableCard
title="误解：&quot;既然合并已完成，并且提款已启用，质押者可以一次性全部退出。&quot;"
contentPreview="错误。出于安全原因，验证者退出受到速率限制。">
