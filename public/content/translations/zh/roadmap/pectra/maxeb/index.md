...
使用 `合并请求` 的域名分隔[签名根](https://github.com/ethereum/consensus-specs/blob/master/specs/phase0/beacon-chain.md#compute_signing_root)。
...
- 【Electra 共识规范】（https://github.com/ethereum/consensus-specs/blob/master/specs/electra/beacon-chain.md）这是您应该参照的最权威的版本。 当您感到疑惑的时候，请阅读这些规范
