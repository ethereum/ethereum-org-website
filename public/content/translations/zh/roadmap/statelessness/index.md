...
<ExpandableCard title="为什么可以依赖更少的区块提议者？" eventCategory="/roadmap/statelessness" eventName="clicked why is it OK to rely on fewer block proposers?">
...
<ButtonLink variant="outline-color" href="https://notes.ethereum.org/WUUUXBKWQXORxpFMlLWy-w#So-why-is-it-ok-to-have-expensive-proposers">阅读 Dankrad 的笔记</ButtonLink>
</ExpandableCard>
...
用于 L1 验证的 zkEVM 是一项补充技术，可以进一步增强无状态验证。验证者不仅可以检查见证数据 (witnesses)，还可以验证整个区块已正确执行的零知识证明 -- 在不重新执行交易的情况下提供加密确定性。
