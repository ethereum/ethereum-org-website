...
**如今没有任何量子计算机能够破解以太坊的密码学。**所需的硬件尚未大规模存在。但最近的研究表明，这一差距缩小的速度比之前预期的要快。2026 年 3 月，Google Quantum AI 发表了一篇论文，估计破解 256 位椭圆曲线密码学（以太坊用于账户签名的类型）可能需要大约 1,200 个逻辑量子比特，比早期的估计少了约 20 倍。
