...
[关于质押代币风险的更多信息](https://notes.ethereum.org/@djrtwo/risks-of-lsd)。
...
请注意，选择重视[客户端多样性](/developers/docs/nodes-and-clients/client-diversity/)的服务非常重要，因为这可以提高网络安全性并限制您的风险。 <em style={{ textTransform: "uppercase" }}>“执行客户端多样性”</em>和<em style={{ textTransform: "uppercase" }}>“共识客户端多样性”</em>能够表明服务可证明其在限制使用主流客户端。
