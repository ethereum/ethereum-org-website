...
此时，你应该能够为你的 dapp 用户创建无 Gas 体验，代价是某种程度的中心化。

然而，这仅适用于支持 ERC-712 的智能合约。例如，要转账 ERC-20 代币，必须由所有者签署交易，而不仅仅是消息。解决方案是[账户抽象 (ERC-4337)](https://docs.erc4337.io/index.html)。我希望在未来写一篇关于它的教程。
