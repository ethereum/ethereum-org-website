...
##### 退出 Rollup {#cross-chain-contract-calls}
...
#### 2. EVM 兼容性 {#how-do-optimistic-rollup-fees-work}
...
#### 3. 跨链合约调用 {#scaling-ethereum-with-optimistic-rollups}
...
## 乐观 Rollup 费用是如何运作的？ {#optimistic-rollups-pros-and-cons}
...
## 乐观 Rollup 如何扩展以太坊？ {#optimistic-video}
...
### 乐观 Rollup 的优缺点 {#further-reading-on-optimistic-rollups}
