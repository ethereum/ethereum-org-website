...
**Ape -** **_面向 Python 开发者、数据科学家和安全专业人士的智能合约开发工具。_**

- [文档](https://docs.apeworx.io/ape/stable/)
- [GitHub](https://github.com/ApeWorX/ape)

**Web3j -** **_在 JVM 上开发区块链应用的平台。_**
...
**thirdweb SDK -** **_使用我们强大的 SDK 和 CLI 构建可与你的智能合约交互的 Web3 应用。_**
...
**Crossmint -** **_企业级 Web3 开发平台，允许你在所有主要链、EVM 链（及其他链）上构建 NFT 应用。_**
...
**Catapulta -** **_多链智能合约部署工具，在区块浏览器中自动验证，跟踪已部署的智能合约并共享部署报告，支持 Foundry 和 Hardhat 项目即插即用。_**
...
**Veramo -** **_开源、模块化且与平台无关的框架，使去中心化应用开发者能够轻松地将去中心化身份和可验证凭证构建到其应用中。_**
...
**Moccasin -** **_一个基于 Titanoboa 构建的、快速且具有 Python 风格的 Vyper 智能合约开发和测试框架。_**

- [文档](https://cyfrin.github.io/moccasin/)
