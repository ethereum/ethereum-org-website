...
##### 谢林点机制 {#good-incentive-compatibility}
...
### 良好的激励相容性 {#retrieving-financial-data}
...
## 预言机在智能合约中的应用 {#generating-verifiable-randomness}

以下是预言机在以太坊中的常见用例：

### 检索金融数据 {#getting-outcomes-for-events}
...
### 生成可验证的随机性 {#automating-smart-contracts}
