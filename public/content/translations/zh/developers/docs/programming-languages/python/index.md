...
<FeaturedText>了解如何使用基于 Python 的项目和工具为以太坊进行开发</FeaturedText>
...
- [面向 Python 程序员的去中心化应用程序开发](https://www.youtube.com/watch?v=tE-8bG35VNw)
...
- [Alpha Venture DAO](https://alphaventuredao.io/)（因 Alpha Homora 而闻名）使用 [Brownie 来测试和部署智能合约](https://github.com/AlphaFinanceLab/alpha-staking-contract)
