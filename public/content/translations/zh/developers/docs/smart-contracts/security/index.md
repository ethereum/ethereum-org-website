...
### 4. 寻求对你的代码进行独立审查 {#get-independent-code-reviews}
...
### 5. 在智能合约开发期间遵循最佳实践 {#follow-smart-contract-development-best-practices}
...
### 9. 防御常见的智能合约漏洞 {#mitigate-common-smart-contract-vulnerabilities}
...
## 开发者智能合约安全资源 {#smart-contract-security-resources-for-developers}

### 分析智能合约和验证代码正确性的工具 {#code-analysis-tools}
...
### 监控智能合约的工具 {#smart-contract-monitoring-tools}

- **[Tenderly 实时警报](https://tenderly.co/monitoring)** - _一个在你的智能合约或钱包发生异常或意外事件时获取实时通知的工具。_

### 智能合约安全管理工具 {#smart-contract-administration-tools}
...
### 已知智能合约漏洞和漏洞利用的出版物 {#common-smart-contract-vulnerabilities-and-exploits}
...
### 智能合约安全教程 {#tutorials-on-smart-contract-security}
