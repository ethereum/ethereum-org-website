...
### 选项 1：开启一个议题 (Issue) {#open-an-issue}
...
### 选项 2：开启一个拉取请求 (Pull request) {#open-a-pull-request}

如果你想自己添加视频，请按照以下步骤操作：
...
别名 (slug) 应该是 URL 安全的、小写的，并使用连字符（例如，`blockchain-101-visual-demo`）。
...
开启一个拉取请求，将你的更改提交到 `dev` 分支。团队将审查你的提交并提供反馈。
