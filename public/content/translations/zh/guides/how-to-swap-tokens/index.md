...
是否厌倦了寻找一个上架了所有你喜欢的代币的交易所？ 你可以使用[去中心化交易所](/glossary/#dex)兑换大多数代币。

代币兑换是指在以太坊网络上交换两种不同的资产，例如将 ETH 兑换成 DAI（一种 [ERC-20](/glossary/#erc-20) 代币）。 兑换过程非常快，也很便宜。 要进行代币兑换，你需要有一个加密货币钱包。

**前提条件：**

- 有一个[加密货币钱包](/glossary/#wallet)；如果没有，可以按照本指南[创建一个以太坊帐户](/guides/how-to-create-an-ethereum-account/)
- 把资金添加到你的钱包
...
例如，以太币和 DAI 稳定币。 请确认你在这两种代币中拥有资金
![通用兑换界面](./swap1.png)
