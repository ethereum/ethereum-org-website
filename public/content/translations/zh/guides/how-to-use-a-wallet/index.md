...
学习如何使用钱包的基本功能。 如果你还没有帐户，请查看我们的[如何创建以太坊帐户](/guides/how-to-create-an-ethereum-account/)。
...
![允许用户使用钱包连接网站的按钮](./connect1.png)

4. 从可用选项列表中，选择你的钱包。 如果看不到你的钱包，它可能隐藏在“WalletConnect”（连接钱包）选项下。

![从钱包列表中选择要连接的钱包](./connect2.png)

5. 请在钱包中，确认签名请求以建立连接。 **签署此消息不应花费任何 ETH**。
6. 这样就完成了！ 开始使用这个应用程序吧。 你可以在我们的[去中心化应用程序页面](/apps/#explore)上找到一些有趣的项目。 <br />
...
在与以太坊虚拟机兼容的所有区块链上，你可以使用相同的地址（如果你的钱包带有助记词）。 此[列表](https://chainlist.org/)会显示你可以使用相同地址的区块链。 有一些区块链，如比特币，实施了完全独立的一组网络规则，你需要一个不同格式的地址。 如果你有一个智能合约钱包，你应该查看它的产品网站，详细了解它所支持的区块链。
...
你可以使用[区块浏览器](/developers/docs/data-and-analytics/block-explorers/)来实时查看任何交易的状态。 你仅需搜索你的钱包地址或交易 ID。
