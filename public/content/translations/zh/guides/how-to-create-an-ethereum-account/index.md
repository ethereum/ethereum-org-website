...
\*\*任何人都可以免费创建以太坊帐户。\*\*你只需要安装加密钱包应用。 钱包可创建并管理你的以太坊帐户。 它们可以发送交易，检查你的余额，并连接到其他基于以太坊构建的应用程序。

有了钱包，你还可以即时登录任何代币交易所、游戏和 [NFT](/glossary/#nft) 市场。 不需要单独注册，基于以太坊构建的所有应用程序共享一个帐户。
...
<AlertContent className="flex-row justify-between items-center">
  <div><b>钱包安装好了吗？</b><br/>了解如何使用它。</div>
...
不可以。 比特币和以太币存在于两个独立的网络（即不同的区块链），每个网络都有各自的记账和地址格式。 为了桥接这两个不同的网络，已经有了多种尝试，其中目前最活跃的是[包装比特币或 WBTC](https://www.bitcoin.com/get-started/what-is-wbtc/)。 这并不是背书，因为包装比特币是一种受监管的解决方案（这意味着由一群人控制某些重要功能），包装比特币在此处仅供参考。

### 如果我已经拥有了一个以太币地址，在其他区块链上，我会拥有相同的地址吗？

你可以在所有使用与以太坊类似的底层软件的区块链（称为“兼容以太坊虚拟机”）上使用相同的[地址](/glossary/#address)。 此[列表](https://chainlist.org/)会显示你可以使用相同地址的区块链。 有一些区块链，如比特币，实施了完全独立的一组网络规则，你需要一个不同格式的地址。 如果你有智能合约钱包，你应该查看其产品网站，详细了解它所支持的区块链，因为这些区块链的范围通常有限但更安全。
