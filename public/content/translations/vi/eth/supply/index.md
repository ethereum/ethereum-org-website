...
Bài viết này nhắm đến những người mới chưa có nhiều kiến thức. Tuy nhiên, để hiểu tường tận chủ đề, sẽ rất hữu ích nếu hiểu về các khái niệm như [Đề xuất Cải tiến Ethereum (EIPs)](/eips/#introduction-to-ethereum-improvement-proposals), [Bằng chứng công việc (PoW)](/developers/docs/consensus-mechanisms/pow/), [Bằng chứng cổ phần (PoS)](/developers/docs/consensus-mechanisms/pos/) và [Bản cập nhật London](/ethereum-forks/#london).
