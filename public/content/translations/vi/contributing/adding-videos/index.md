...
Nếu bạn nhận thấy vấn đề với một video được niêm yết, hãy [tạo một issue](https://github.com/ethereum/ethereum-org-website/issues/new?assignees=&labels=feature+✨,content+🖋️&template=suggest_video.yaml) hoặc gửi email đến [website@ethereum.org](mailto:website@ethereum.org).
## Bảo trì {#maintenance}
