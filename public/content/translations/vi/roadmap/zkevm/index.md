...
Việc xác minh zkEVM biến đổi quá trình xác thực khối thành mô hình "1-trên-N":

1. **Thực thi**: Một trình chứng minh thực thi tất cả các giao dịch trong một khối, theo dõi mọi thay đổi trạng thái
2. **Chứng minh**: Trình chứng minh tạo ra một bằng chứng mật mã học (một [SNARK hoặc STARK](/zero-knowledge-proofs/#types-of-zero-knowledge-proofs)) chứng thực cho tính chính xác của việc thực thi
...
Đảm bảo bảo mật vẫn giữ nguyên: nếu việc thực thi không chính xác, sẽ không có bằng chứng hợp lệ nào có thể được tạo ra. Nhưng giờ đây, thay vì mọi nút phải thực hiện tính toán tốn kém, chỉ có trình chứng minh làm điều đó—và việc xác minh đủ rẻ để không hạn chế giới hạn gas.
...
Khi việc xác minh trở nên rẻ, giới hạn gas có thể tăng lên một cách an toàn. Điều này mở rộng dung lượng mạng lưới và giúp ổn định phí trong các giai đoạn nhu cầu cao. Giới hạn gas hiện tại bị hạn chế một phần bởi phần cứng của trình xác thực—zkEVM loại bỏ hạn chế này.
...
### Tính chung cuộc có thể dự đoán được {#predictable-finality}

Việc xác minh bằng chứng hoạt động trong thời gian không đổi bất kể độ phức tạp của khối. Điều này làm cho thời gian chứng thực dễ dự đoán hơn và giảm thiểu các chứng thực bị bỏ lỡ có thể xảy ra khi các trình xác thực gặp khó khăn trong việc xử lý các khối phức tạp kịp thời.
...
- **Khuyến khích kinh tế**: Thiết kế các thị trường trình chứng minh và cấu trúc phí bền vững
...
- **[Tách biệt người đề xuất và người xây dựng (PBS)](/roadmap/pbs/)**: Những người xây dựng khối có khả năng tích hợp việc tạo bằng chứng, hoặc một thị trường trình chứng minh riêng biệt có thể xuất hiện
- **[Tính chung cuộc trong một slot](/roadmap/single-slot-finality/)**: Việc tạo bằng chứng nhanh hơn có thể cho phép tính chung cuộc trong một slot với các đảm bảo mật mã học
