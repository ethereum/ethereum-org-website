...
Đây là một số thông tin thêm, hãy xem thêm bài viết của Tim Beiko về <a href="https://blog.ethereum.org/2021/11/29/how-the-merge-impacts-app-layer/">Cách mà sự kiện hợp nhất tác động lên lớp ứng dụng của Ethereum</a>.
</ExpandableCard>
...
Việc vận hành một nút không đề xuất là khả thi cho mọi người thực hiện dù cho là theo cơ chế đồng thuận nào (đồng thuận công việc hay đồng thuận cổ phần); điều này <em>rất khuyến nghị</em> cho mọi người dùng nếu họ có nguồn lực. Vận hành nút đóng góp giá trị to lớn với Ethereum và mang lại lợi ích cho cá nhân vận hành, chẳng hạn như tăng cường bảo mật, riêng tư và chống kiểm duyệt.

Khả năng để bất kì ai chạy node của họ là <em>thực sự cần thiết</em> để duy trì tính phi tập trung mạng Ethereum.
