...
<AlertContent>
<AlertDescription>
 <p className="mt-0"><strong>Lợi ích bổ sung của việc đặt cọc lại</strong>
...
<AlertContent>
<AlertDescription>
 <p className="mt-0"><strong>Cảnh báo nhầm lẫn</strong>
...
<AlertContent>
<AlertDescription>
 <p className="mt-0"><strong>Nhà đồng sáng lập Ethereum đang gõ…</strong>
  <p className="mt-2">
...
<AlertContent>
<AlertDescription>
 <p className="mt-0"><strong>Đặt cọc Ethereum:</strong> Nó hoạt động như thế nào?
