...
![Cách đặt Sepolia làm mạng của bạn trên MetaMask Mobile](./goerliMetamask.gif)
...
![Cách tìm băm giao dịch và ID token ERC-721 của bạn](./findNFTEtherscan.png)

Bạn có thể cần phải làm mới một vài lần để xem NFT của mình — nhưng nó sẽ ở đó <Emoji text="😄" size={1} />!

![Cách tải NFT của bạn lên MetaMask](./findNFTMetamask.gif)
