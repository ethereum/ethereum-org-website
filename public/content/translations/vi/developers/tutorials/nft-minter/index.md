...
[Đây là liên kết](https://www.alchemy.com/docs/how-to-create-an-nft) đến hợp đồng thông minh NFT ERC-721 mà chúng ta sẽ gọi trong hướng dẫn này. Nếu bạn muốn tìm hiểu cách chúng tôi đã tạo ra nó, chúng tôi thực sự khuyên bạn nên xem hướng dẫn khác của chúng tôi, ["Cách tạo một NFT"](https://www.alchemy.com/docs/how-to-create-an-nft).
...
Như chúng ta đã đề cập trước đó, trong hướng dẫn này, chúng ta sẽ sử dụng [hợp đồng thông minh NFT hiện có này](https://www.alchemy.com/docs/how-to-create-an-nft); tuy nhiên, nếu bạn muốn tìm hiểu cách chúng tôi đã tạo ra nó, hoặc tự tạo một cái, chúng tôi thực sự khuyên bạn nên xem hướng dẫn khác của chúng tôi, ["Cách tạo một NFT."](https://www.alchemy.com/docs/how-to-create-an-nft).
...
try {
  ...
  return {
    success: true,
    status:
      "✅ Kiểm tra giao dịch của bạn trên Etherscan: https://sepolia.etherscan.io/tx/" +
      txHash,
  }
} catch (error) {
  return {
