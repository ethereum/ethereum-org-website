...
##### 1. Hiểu logic nghiệp vụ và quy trình làm việc của hợp đồng {#integration-testing-for-smart-contracts}
...
##### 2. Đánh giá tất cả các giả định liên quan đến việc thực thi hợp đồng {#property-based-testing-for-smart-contracts}
...
##### 3. Đo lường mức độ bao phủ mã {#static-analysis}
...
##### 4. Sử dụng các khuôn khổ thử nghiệm được phát triển tốt {#dynamic-analysis}
...
### Thử nghiệm tích hợp {#running-property-based-tests}
...
### Thử nghiệm dựa trên thuộc tính {#manual-testing-for-smart-contracts}
...
#### Phân tích tĩnh {#testing-on-local-blockchain}
...
#### Phân tích động {#testing-contracts-on-testnets}
...
### Hướng dẫn chạy thử nghiệm dựa trên thuộc tính cho hợp đồng thông minh {#testing-vs-formal-verification}

Việc chạy thử nghiệm dựa trên thuộc tính thường bắt đầu bằng việc xác định một thuộc tính (ví dụ: không có [tràn số nguyên](https://github.com/ConsenSys/mythril/wiki/Integer-Overflow)) hoặc tập hợp các thuộc tính mà bạn muốn xác minh trong một hợp đồng thông minh. Bạn cũng có thể cần xác định một phạm vi giá trị mà trong đó chương trình có thể tạo dữ liệu cho các đầu vào giao dịch khi viết các thử nghiệm thuộc tính.
...
- **[Thực thi tượng trưng hợp đồng thông minh với Mythril](https://mythril-classic.readthedocs.io/en/master/tutorial.html)**

## Thử nghiệm thủ công cho hợp đồng thông minh {#testing-vs-audits-bug-bounties}
...
### Thử nghiệm hợp đồng trên một Chuỗi khối cục bộ {#testing-tools-and-libraries}
...
### Thử nghiệm hợp đồng trên các mạng thử nghiệm {#unit-testing-tools}
...
## Thử nghiệm so với xác minh hình thức {#property-based-testing-tools}
...
## Thử nghiệm so với kiểm toán và tiền thưởng tìm lỗi (bug bounties) {#static-analysis-tools}
...
## Các công cụ và Thư viện thử nghiệm {#dynamic-analysis-tools}

### Các công cụ thử nghiệm đơn vị {#related-tutorials}
...
### Các công cụ thử nghiệm dựa trên thuộc tính {#further-reading}

#### Các công cụ phân tích tĩnh {#tutorials}
...
- **[Mythril](https://github.com/ConsenSys/mythril-classic)** - _Công cụ đánh giá mã byte EVM để phát hiện các lỗ hổng của hợp đồng bằng cách sử dụng phân tích taint, phân tích concolic và kiểm tra luồng điều khiển._
...
## Hướng dẫn: Thử nghiệm hợp đồng thông minh trên Ethereum
