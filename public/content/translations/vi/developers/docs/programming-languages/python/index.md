...
## Bài viết đã lưu trữ {#archived-articles}

- [Triển khai token ERC-20 của riêng bạn với Python và Brownie](https://betterprogramming.pub/python-blockchain-token-deployment-tutorial-create-an-erc20-77a5fd2e1a58)
...
- [Tạo NFT trên OpenSea với Brownie](https://www.freecodecamp.org/news/how-to-make-an-nft-and-render-on-opensea-marketplace/)
...
- [Sushi](https://sushi.com/) sử dụng [Python trong việc quản lý và triển khai các hợp đồng sự phân bổ theo thời gian của họ](https://github.com/sushiswap/sushi-vesting-protocols)
- [Alpha Finance](https://alphaventuredao.io/), nổi tiếng với Alpha Homora, sử dụng [Brownie để kiểm thử và triển khai các hợp đồng thông minh](https://github.com/AlphaFinanceLab/alpha-staking-contract)
...
Wiki của Vyper có một [danh sách tài nguyên tuyệt vời cho Vyper](https://github.com/vyperlang/vyper/wiki/Vyper-tools-and-resources)