...
<FeaturedText>Tìm hiểu cách phát triển cho Ethereum bằng cách sử dụng các dự án và công cụ dựa trên Ruby.</FeaturedText>
...
- [Cuối cùng cũng xác thực được người dùng Rails bằng MetaMask](https://dev.to/q9/finally-authenticating-rails-users-with-metamask-3fj)
- [Cách kết nối với mạng lưới Ethereum bằng Ruby](https://www.quicknode.com/guides/web3-sdks/how-to-connect-to-the-ethereum-network-using-ruby)
- [Cách tạo một địa chỉ Ethereum mới trong Ruby](https://www.quicknode.com/guides/web3-sdks/how-to-generate-a-new-ethereum-address-in-ruby)
...
- [Sử dụng Ruby, kết nối với Ethereum, để thực thi hợp đồng thông minh](https://titanwolf.org/Network/Articles/Article?AID=87285822-9b25-49d5-ba2a-7ad95fff7ef9)

## Các dự án và công cụ Ruby {#ruby-projects-and-tools}

### Đang hoạt động {#active}

- [eth.rb](https://github.com/q9f/eth.rb) - _Thư viện Ruby và máy khách RPC để xử lý các tài khoản, tin nhắn và giao dịch Ethereum_
- [keccak.rb](https://github.com/q9f/keccak.rb) - _Mã băm Keccak (SHA3) được sử dụng bởi Ethereum_
- [siwe-ruby](https://github.com/signinwithethereum/siwe-ruby) - _Bản triển khai Ruby của Đăng nhập bằng Ethereum (Sign-In with Ethereum)_
- [siwe-rails](https://github.com/signinwithethereum/siwe-rails) - _Gem Rails bổ sung các tuyến đăng nhập cục bộ SIWE_
- [siwe-rails-examples](https://github.com/signinwithethereum/siwe-rails-examples) - _Ví dụ SIWE sử dụng Ruby on Rails với bộ điều khiển tùy chỉnh_
- [omniauth-siwe](https://github.com/signinwithethereum/omniauth-siwe) - _Chiến lược OmniAuth cho Đăng nhập bằng Ethereum (SIWE)_
- [omniauth-nft](https://github.com/valthon/omniauth-nft) - _Chiến lược OmniAuth để xác thực thông qua quyền sở hữu NFT_
- [ethereum-on-rails](https://github.com/q9f/ethereum-on-rails) - _Mẫu Ethereum on Rails cho phép kết nối MetaMask với Ruby on Rails_
...
- [ethereum_tree](https://github.com/longhoangwkm/ethereum_tree) - _Thư viện Ruby để tạo các địa chỉ ETH từ một ví Xác định phân cấp (Hierarchical Deterministic) theo tiêu chuẩn BIP32_
- [etherlite](https://github.com/budacom/etherlite) - _Tích hợp Ethereum cho Ruby on Rails_
- [ethereum.rb](https://github.com/EthWorks/ethereum.rb) - _Máy khách Ethereum bằng Ruby sử dụng giao diện JSON-RPC để gửi giao dịch, tạo và tương tác với các hợp đồng cũng như bộ công cụ hữu ích để làm việc với nút Ethereum_
...
## Những người đóng góp trong cộng đồng Ruby {#ruby-community-contributors}

[Nhóm Telegram Ethereum Ruby](https://t.me/ruby_eth) là nơi tập hợp một cộng đồng đang phát triển nhanh chóng và là tài nguyên chuyên dụng để thảo luận về bất kỳ dự án nào ở trên và các chủ đề liên quan.