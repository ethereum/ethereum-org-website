...
##### Proof generation {#entries-and-exits}
...
##### Proof verification {#zk-rollups-and-evm-compatibility}
...
### Entries and exits {#how-do-zk-rollup-fees-work}
...
## ZK-rollups and EVM compatibility {#scaling-ethereum-with-zk-rollups}
...
## Phí ZK-rollup hoạt động như thế nào? {#transaction-data-compression}
...
## Các ZK-rollup mở rộng quy mô Ethereum như thế nào? {#recursive-proofs}

### Transaction data compression {#zk-rollups-pros-and-cons}
...
### Ưu điểm và nhược điểm của ZK-rollup {#zkevm-projects}
...
### Giải thích trực quan về ZK-rollup {#further-reading-on-zk-rollups}
...
## Ai đang làm việc trên zkEVM? {#tutorials}
...
## Hướng dẫn: Quyền riêng tư & không tri thức trên Ethereum
