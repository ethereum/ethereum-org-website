...
## Phí Rollup lạc quan hoạt động như thế nào? {#how-do-optimistic-rollup-fees-work}
...
## Rollup lạc quan mở rộng quy mô Ethereum như thế nào? {#scaling-ethereum-with-optimistic-rollups}
...
### Ưu điểm và nhược điểm của Rollup lạc quan {#optimistic-rollups-pros-and-cons}
...
### Giải thích trực quan về Rollup lạc quan {#optimistic-video}
