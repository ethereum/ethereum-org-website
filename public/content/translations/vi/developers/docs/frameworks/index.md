...
**Ape -** **_Công cụ phát triển hợp đồng thông minh dành cho các lập trình viên Python, Nhà khoa học dữ liệu và Chuyên gia bảo mật._**
...
**thirdweb SDK -** **_Xây dựng các ứng dụng Web3 có thể tương tác với các hợp đồng thông minh của bạn bằng cách sử dụng các SDK và CLI mạnh mẽ của chúng tôi._**
