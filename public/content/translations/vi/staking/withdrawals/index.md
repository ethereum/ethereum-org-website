...
<ExpandableCard
title="Sau khi đã cung cấp một địa chỉ rút tiền, tôi có thể thay đổi nó sang một địa chỉ rút tiền khác không?"
eventCategory="FAQ"
...
<ExpandableCard
title="Làm thế nào để tôi rút từ việc đặt cọc nếu tôi đặt cọc thông qua một nhà cung cấp, nhóm đặt cọc, hoặc tham gia với token đặt cọc thanh khoản?"
eventCategory="FAQ"
...
<ExpandableCard
title="Tôi có thể kích hoạt lại trình xác thực của mình sau khi thoát bằng cách gửi thêm ETH không?"
eventCategory="FAQ"
...
<ExpandableCard
title="Sự khác biệt giữa các trình xác thực cũ và trình xác thực gộp là gì?"
eventCategory="FAQ"
...
<ExpandableCard
title="Làm thế nào để chuyển đổi sang trình xác thực gộp?"
eventCategory="FAQ"
...
<ExpandableCard
title="Việc rút tiền đặt cọc được kích hoạt khi nào?"
eventCategory="FAQ"
