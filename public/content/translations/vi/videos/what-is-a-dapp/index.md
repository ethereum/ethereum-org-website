---
title: "Dapp là gì? Ứng dụng phi tập trung trên chuỗi khối"
description: "Giới thiệu về các ứng dụng phi tập trung (dapp) và sự khác biệt của chúng so với các ứng dụng truyền thống."
lang: vi
...
*Bản ghi này là một bản sao dễ tiếp cận của [bản ghi video gốc](https://www.youtube.com/watch?v=F50OrwV6Uk8) được xuất bản bởi district0x Network. Nó đã được chỉnh sửa đôi chút để dễ đọc hơn.*

#### Dapp là gì? (0:01) {#what-is-a-dapp-001}
...
#### Cách các dapp hoạt động (0:29) {#how-dapps-work-029}
...
#### Lợi ích bảo mật (1:10) {#security-benefits-110}
...
#### Xây dựng dapp trên Ethereum (1:23) {#building-dapps-on-ethereum-123}
...
#### Ví dụ: Ethlance (1:43) {#example-ethlance-143}
