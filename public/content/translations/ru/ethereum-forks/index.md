...
Программное обеспечение, которое лежит в основе Эфиpиума, состоит из двух половин, известных как [исполнительный слой](/glossary/#execution-layer) и [слой согласия](/glossary/#consensus-layer).
