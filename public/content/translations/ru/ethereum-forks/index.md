...
<ul>
  ...
  <li><a href="https://eips.ethereum.org/EIPS/eip-7002">EIP-7002</a> - <em>Выходы, инициируемые на уровне исполнения</em></li>
  <li><a href="https://eips.ethereum.org/EIPS/eip-7685">EIP-7685</a> - <em>Запросы общего назначения на уровне исполнения</em></li>
...
<ul>
  <li><a href="https://eips.ethereum.org/EIPS/eip-2537">EIP-2537</a> - <em>Прекомпилированный контракт для операций с эллиптической кривой BLS12-381</em></li>
...
- [Ознакомьтесь со спецификациями обновления Electra](https://github.com/ethereum/consensus-specs/tree/master/specs/electra/)
- [Часто задаваемые вопросы о Prague-Electra («Пектра»)](/roadmap/pectra/)
