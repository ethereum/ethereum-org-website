...
## Зачем нам нужны DAO? Зачем нужны DAO {#why-dao}
...
#### Известный пример {#governance-example}[ENS](https://claim.ens.domains/delegate-ranking) — владельцы ENS могут делегировать свои голоса активным участникам сообщества, которые будут их представлять.
