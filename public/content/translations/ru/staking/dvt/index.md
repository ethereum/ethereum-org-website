...
summaryPoints:
  ...
  - Производственная инфраструктура, используемая сегодня соло-стейкерами, сервисами стейкинга и пулами для совместного стейкинга
---
...
## DVT в производстве {#dvt-in-production}
...
Еще одним преимуществом минимизации доверия к одному оператору является то, что пулы для совместного стейкинга могут обеспечить более открытое и общедоступное участие операторов. Некоторые пулы для совместного стейкинга делают это в производстве уже сегодня. Многооператорные кластеры DVT позволяют протоколам объединять домашних стейкеров и мелких операторов с более крупными профессиональными, комбинируя курируемые и общедоступные наборы операторов.
