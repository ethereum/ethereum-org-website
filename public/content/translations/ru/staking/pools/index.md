...
<Grid>
  <Card title="Низкий порог входа" icon={<Fish />} description="Не кит? Не проблема. Большинство стейкинг-пулов позволяют стейкать практически любую сумму ETH, объединяя усилия с другими стейкерами, в отличие от соло-стейкинга, который требует 32 ETH." />
  <Card title="Стейкайте сегодня" icon={<Clock />} description="Стейкинг в пуле так же прост, как обмен токенов. Не нужно беспокоиться о настройке оборудования и обслуживании узла. Пулы позволяют вам внести свои ETH, что дает возможность операторам узлов запускать валидаторы. Затем вознаграждения распределяются между участниками за вычетом комиссии за работу узла." />
  <Card title="Токены ликвидного стейкинга" icon={<Droplets />} description="Многие стейкинг-пулы предоставляют токен, который представляет собой право требования на ваши застейканные ETH и генерируемые ими вознаграждения. Это позволяет вам использовать ваши застейканные ETH, например, в качестве залога в приложениях децентрализованных финансов (DeFi)." />
</Grid>
