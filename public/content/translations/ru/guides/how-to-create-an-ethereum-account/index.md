...
С кошельком вы также можете мгновенно входить на любые биржи токенов, в игры и на маркетплейсы [NFT](/glossary/#nft). Вам не потребуется каждый раз проходить отдельную регистрацию, один аккаунт может быть использован для всех приложений, созданных на базе Ethereum.
...
**Любой человек, знающий эту фразу, может получить контроль над всеми средствами. Никогда и никому не сообщайте ее.** Эта фраза должна содержать от 12 до 24 случайно сгенерированных слов (их порядок важен).
...
Заинтересованы в других руководствах? Ознакомьтесь с нашими: [Пошаговые руководства](/guides/)
