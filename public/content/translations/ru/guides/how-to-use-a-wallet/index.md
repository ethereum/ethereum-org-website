...
![Поле отправки для криптоадреса](./send.png) <br/>
...
![Кнопка, позволяющая пользователю подключиться к сайту с помощью кошелька](./connect1.png)
...
5. Подтвердите запрос на подпись в вашем кошельке, чтобы установить соединение. **Подписание этого сообщения не должно требовать траты ETH**.
6. Вот и все! Начните пользоваться приложением. Вы можете найти некоторые интересные проекты на нашей [странице децентрализованных приложений](/apps/#explore). <br />
...
Вы можете использовать [инструменты изучения блоков](/developers/docs/data-and-analytics/block-explorers/), чтобы видеть статус любой транзакции в реальном времени. Все, что вам нужно сделать, — это найти адрес вашего кошелька или идентификатор транзакции.
