...
Вы можете использовать [chainlist.org](https://chainlist.org), чтобы найти RPC-данные сети. После добавления сети и завершения транзакции вы увидите токены в своем кошельке. <br />
