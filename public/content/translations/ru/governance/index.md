...
Предлагающие EIP пользователи должны ознакомиться с предварительной работой и предложениями перед созданием EIP, которые могут быть серьезно рассмотрены для развертывания в основной сети Ethereum. EIP должен приносить что-то новое и еще не отклоненное в прошлом. Три основных места для исследования — это [репозиторий EIP](https://eips.ethereum.org), [сообщество Ethereum Magicians](https://ethereum-magicians.org/) и [ethresearch.ch](https://ethresear.ch/).
