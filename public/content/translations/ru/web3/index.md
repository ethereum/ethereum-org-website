...
Web3 представляет новые парадигмы, которые требуют освоения иных ментальных моделей, нежели те, что используются в Веб 2.0. Похожая образовательная кампания проводилась, когда Web 1.0 набирал популярность в конце 1990-х годов; сторонники Всемирной паутины использовали множество образовательных методов для просвещения общественности: от простых метафор (информационная магистраль, браузеры, серфинг в сети) до [телевизионных передач](https://www.youtube.com/watch?v=SzQLI7BxfYI). Web3 не сложен, но он другой. Образовательные инициативы, знакомящие пользователей Веб2 с этими парадигмами Web3, жизненно важны для его успеха.

Ethereum.org внес свой вклад в образование в сфере Web3 с помощью [Программы переводов](/contributing/translation-program/), благодаря которой важный контент об Эфириуме стал доступен на десятках языков.
