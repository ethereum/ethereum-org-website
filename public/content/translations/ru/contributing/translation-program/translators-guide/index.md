...
- Перевод валют может быть сложной задачей из-за различных форматов, условностей и конвертаций. Как правило, пожалуйста, оставляйте валюты такими же, как в исходном тексте. Вы можете добавить свою местную валюту и конвертацию в скобках для удобства читателя.
