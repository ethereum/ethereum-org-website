...
Руководство по стилю перевода ethereum.org содержит некоторые из наиболее важных правил, инструкций и советов для переводчиков, которые помогают нам локализовать веб-сайт.
...
Проект ethereum.org в Crowdin закрывается и больше не принимает новые переводы (см. [статус Программы переводов](/contributing/translation-program/#program-status)). Приведенное ниже руководство остается в качестве справочного материала для сообществ переводчиков, использующих Crowdin для своих собственных проектов.
...
В разных языках существуют разные грамматические правила, условности и порядок слов. При переводе, пожалуйста, обращайте внимание на то, как строятся предложения в целевых языках, и избегайте дословного перевода английского оригинала, так как это может привести к плохой структуре предложений и снижению читабельности.
...
Мы используем формальное обращение (на «вы»), которое всегда вежливо и уместно для всех посетителей.
...
Ethereum.org доступен на ряде языков, использующих системы письма (или шрифты), отличные от латиницы.

Весь контент должен быть переведен с использованием правильной системы письма для вашего языка и не должен содержать слов, написанных латинскими буквами.

При переводе контента вы должны убедиться, что переводы последовательны и не содержат латинских символов.

Распространенным заблуждением является то, что Эфириум всегда должен писаться латиницей. В большинстве случаев это неверно, пожалуйста, используйте написание слова Эфириум, родное для вашего языка (например, 以太坊 на китайском, إيثيريوم на арабском и т. д.).
...
Если вы не уверены, какой код языка использовать, вы можете проверить память переводов в Crowdin или найти код для вашего языка в URL-адресе страницы в онлайн-редакторе Crowdin.

Некоторые примеры кодов для наиболее распространенных языков:
...
Некоторые строки содержат заголовки внешних статей. Большинство страниц нашей документации для разработчиков содержат ссылки на внешние статьи для дополнительного чтения. Строки, содержащие заголовки статей, должны быть переведены независимо от языка статьи, чтобы обеспечить более единообразный пользовательский опыт для посетителей, просматривающих страницу на своем языке.
...
В Crowdin есть встроенная функция, которая предупреждает переводчиков, когда они собираются совершить ошибку. Crowdin автоматически предупредит вас об этом перед сохранением перевода, если вы забудете включить тег из исходного текста, переведете элементы, которые не следует переводить, добавите несколько пробелов подряд, забудете знаки препинания в конце и т. д.
Если вы видите подобное предупреждение, пожалуйста, вернитесь и перепроверьте предложенный перевод.
...
Много исходного контента содержит теги и переменные, которые выделены желтым цветом в редакторе Crowdin. Они выполняют разные функции, и к ним следует подходить правильно.

**Настройки Crowdin**

Чтобы упростить управление тегами и копировать их непосредственно из исходного текста, мы рекомендуем изменить настройки в редакторе Crowdin.
...
Они должны быть идентичны исходным и не должны изменяться или переводиться. Если вы переведете ссылку или измените ее каким-либо образом, даже просто удалив ее часть, например косую черту (/), это приведет к неработающим и непригодным для использования ссылкам.

Лучший способ работы со ссылками — копировать их непосредственно из исходного текста, либо нажав на них, либо используя кнопку «Копировать исходный текст» (Copy Source) (`Alt+C`).
...
Очень важно копировать ссылки из исходного текста и не менять их порядок.
...
Исходный текст содержит множество различных типов тегов, которые всегда следует копировать из исходного текста и никогда не изменять. Аналогично сказанному выше, порядок этих тегов в переводе также должен оставаться таким же, как в исходном тексте.
...
В приведенном ниже примере вы можете видеть, что при наведении курсора на тег `<0>` отображается, что он представляет собой `<code>` и содержит фрагмент кода, поэтому содержимое внутри этих тегов не должно переводиться.
...
При их переводе не стесняйтесь проявлять творческий подход, использовать описательные переводы или просто переводить их дословно.

**Причина, по которой большинство терминов следует переводить, а не оставлять некоторые на английском языке, заключается в том, что эта новая терминология получит более широкое распространение в будущем, поскольку все больше людей начнут использовать Эфириум и связанные с ним технологии. Если мы хотим привлечь в это пространство больше людей со всего мира, нам необходимо предоставить понятную терминологию на как можно большем количестве языков, даже если нам придется создавать ее самим.**
...
Посетители ethereum.org приходят со всего мира и имеют разный опыт. Поэтому язык на веб-сайте должен быть нейтральным, приветливым для всех и не исключающим кого-либо.

Важным аспектом этого является гендерная нейтральность. Этого можно легко достичь, используя формальное обращение и избегая любых гендерно-специфичных слов в переводах.

Еще одна форма инклюзивности — попытка переводить для глобальной аудитории, не привязываясь к какой-либо стране, расе или региону.
...
При переводе важно следовать грамматическим правилам, условностям и форматированию, используемым в вашем языке, а не копировать из исходного текста. Исходный текст следует правилам и условностям английской грамматики, что неприменимо ко многим другим языкам.
...
- В английском языке принято писать с заглавной буквы все слова в заголовках и названиях, месяцах и днях, названиях языков, праздниках и т. д. Во многих других языках это грамматически неверно, так как в них действуют другие правила использования заглавных букв.
...
- В некоторых языках первое слово каждой новой строки должно начинаться с заглавной буквы, в то время как в других новые строки должны начинаться со строчных букв. Во многих языках также существуют разные правила использования заглавных букв в списках в зависимости от длины каждой строки.
- То же самое относится и к пунктуации элементов списка. Знаком препинания в конце списков может быть точка (**.**), запятая (**,**) или точка с запятой (**;**), в зависимости от языка.

**Кавычки**

- В языках используется множество различных кавычек. Простое копирование английских кавычек из исходного текста часто бывает неверным.
...
- В английском языке дефис (-) используется для соединения слов или различных частей слова, в то время как тире (–) используется для обозначения диапазона или паузы.
...
- Перевод валют может быть сложной задачей из-за различных форматов, условностей и конвертаций. Как правило, пожалуйста, оставляйте валюты такими же, как в исходном текстом. Вы можете добавить свою местную валюту и конвертацию в скобках для удобства читателя.
- Основные различия в написании валют в разных языках включают размещение символа, десятичные запятые в сравнении с десятичными точками, пробелы и аббревиатуры в сравнении с символами.
...
- Как правило, пожалуйста, сохраняйте единицы измерения в соответствии с исходным текстом. Если в вашей стране используется другая система, вы можете указать конвертацию в скобках.
- Помимо локализации единиц измерения, также важно отметить различия в том, как языки подходят к этим единицам. Основное отличие заключается в пробеле между числом и единицей измерения, который может быть разным в зависимости от языка. Примеры этого включают 100kB в сравнении с 100 kB или 50ºF в сравнении с 50 ºF.
