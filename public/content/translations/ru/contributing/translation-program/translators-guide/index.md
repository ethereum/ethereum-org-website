...
Если у вас есть какие-либо вопросы, предложения или отзывы, не стесняйтесь обращаться к нам по адресу translations@ethereum.org, отправьте сообщение @ethdotorg в Crowdin или [присоединяйтесь к нашему Дискорду](/discord/), где вы можете написать нам в канале #translations или связаться с любым из членов команды.
