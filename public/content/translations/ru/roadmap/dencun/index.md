...
## Как Cancun-Deneb (Dencun) влияет на тестовые сети Ethereum? {#testnet-impact}

- Девнеты, Sepolia и Holesky прошли апгрейд Dencun, и в них полностью функционирует протоданкшардинг.
