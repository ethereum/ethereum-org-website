...
# Разделение предлагающих и сборщиков {#proposer-builder-separation}
...
<ExpandableCard title="С какими видами цензуры борется PBS?" eventCategory="/roadmap/pbs" eventName="clicked what kinds of censorship does PBS solve?">
...
<ExpandableCard title="Почему централизовать построение блоков — это нормально?" eventCategory="/roadmap/pbs" eventName="clicked why is it OK to centralize block building?">
