...
<ExpandableCard title="Почему Эфириум не может просто заменить BLS на квантово-устойчивую схему?" eventCategory="/roadmap/security/quantum-resistance" eventName="clicked why cant ethereum just replace BLS?">
...
<ExpandableCard title="Могут ли квантовые компьютеры украсть мой ETH уже сегодня?" eventCategory="/roadmap/security/quantum-resistance" eventName="clicked can quantum computers steal my ETH today?">
...
<ExpandableCard title="Когда квантовые компьютеры могут стать угрозой?" eventCategory="/roadmap/security/quantum-resistance" eventName="clicked when could quantum computers become a threat?">
...
<ExpandableCard title="Нужно ли мне будет что-то делать для защиты своего кошелька?" eventCategory="/roadmap/security/quantum-resistance" eventName="clicked will I need to do anything?">
...
<ExpandableCard title="А как насчет моих токенов, NFT и позиций в DeFi?" eventCategory="/roadmap/security/quantum-resistance" eventName="clicked what about tokens NFTs DeFi?">
...
<ExpandableCard title="Отстает ли Эфириум от других блокчейнов в этом вопросе?" eventCategory="/roadmap/security/quantum-resistance" eventName="clicked is Ethereum behind?">
...
<ExpandableCard title="Что такое «собирай сейчас, расшифровывай потом»?" eventCategory="/roadmap/security/quantum-resistance" eventName="clicked what is harvest now decrypt later?">
