...
<AlertDescription>
На этой странице обсуждается использование zkEVM для верификации исполнения блоков L1 Ethereum. Информацию о zkEVM-роллапах, которые используют доказательства 0-знания для масштабирования Ethereum в качестве решений уровня 2, см. в разделе [нулевые роллапы](/developers/docs/scaling/zk-rollups/).
</AlertDescription>
</AlertContent>
</Alert>
