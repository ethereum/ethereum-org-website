...
# О ethereum.org {#about-ethereumorg}
...
**Никто из ethereum.org никогда не будет связываться с вами. Не отвечайте.**

## Примечание о названиях {#a-note-on-names}
...
### 2. Развитие, укрепление и расширение прав и возможностей нашего сообщества соавторов {#community}
...
Ethereum и сообщество постоянно развиваются, и ethereum.org тоже. Именно поэтому сайт имеет простую систему дизайна и модульную структуру. Мы последовательно вносим изменения сразу, как узнаем больше о том, как люди используют сайт и что сообщество хочет от него.
Сайт работает на основе открытого исходного кода и имеет сообщество помощников, поэтому вы можете предлагать изменения или помогать нам.
[Узнайте, как внести свой вклад](/contributing/)

### 3. ethereum.org — это не обычный сайт продукта 🦄 {#core-principles-3}

Ethereum включает сообщество, технологии, набор идей и идеологий и другие компоненты.
Это означает, что сайт должен быть полезен для различных пользователей: от разработчика, которому нужен определенный инструмент до новичка, который только что купил немного ETH и не знает, что такое кошелек.
Вопрос "Какой сайт лучше всего подойдет для блокчейн-платформы?" остается открытым — мы первопроходцы. Для его создания нужно экспериментировать.

## Дорожная карта продукта {#roadmap}

Чтобы сделать нашу работу более доступной и способствовать более тесному сотрудничеству с сообществом, основная команда ethereum.org публикует обзор наших целей дорожной карты [цикла Shape Up](https://www.productplan.com/glossary/shape-up-method/).
...
**Хотите принять участие?** [Узнайте больше о том, как внести свой вклад](/contributing/), [напишите нам в Twitter](https://x.com/ethdotorg) или присоединяйтесь к обсуждениям сообщества на [нашем сервере Discord](https://discord.gg/ethereum-org).

## Принципы дизайна {#design-principles}

Мы используем набор [принципов дизайна](/contributing/design-principles/), которыми руководствуемся при принятии решений по контенту и дизайну сайта.

## Система дизайна {#design-system}

Мы создали и выпустили [систему дизайна](https://www.figma.com/file/NrNxGjBL0Yl1PrNrOT8G2B/ethereum.org-Design-System?node-id=0%3A1&t=QBt9RkhpPqzE3Aa6-1), чтобы быстрее выпускать новые функции и позволить участникам сообщества участвовать в открытом дизайне ethereum.org.

Хотите поучаствовать?[Отслеживайте прогресс в Figma](https://www.figma.com/file/NrNxGjBL0Yl1PrNrOT8G2B/ethereum.org-Design-System), в соответствующей [задаче на GitHub](https://github.com/ethereum/ethereum-org-website/issues/6284) и присоединяйтесь к обсуждению на нашем [Discord-канале #design](https://discord.gg/ethereum-org).

## Руководство по стилю {#style-guide}

У нас есть [руководство по стилю](/contributing/style-guide/) для стандартизации некоторых аспектов написания контента, чтобы упростить процесс участия.

Если вы хотите [внести свой вклад в развитие сайта](/contributing/), обязательно прочтите [наши принципы](/contributing/design-principles/) и [наше руководство по стилю](/contributing/style-guide/).
...
Веб-сайт ethereum.org имеет открытый исходный код и распространяется по [лицензии MIT](https://github.com/ethereum/ethereum-org-website/blob/dev/LICENSE), если не указано иное. Подробнее об [условиях использования](/terms-of-use/) ethereum.org.
...
Мы будем размещать здесь разные вакансии. Если вы не нашли здесь подходящей для вас роли, перейдите на [наш сервер Discord](https://discord.gg/ethereum-org) и расскажите нам, как бы вы хотели с нами сотрудничать!

Не ограничиваетесь командой ethereum.org? [Посмотрите другие вакансии, связанные с Ethereum](/community/get-involved/#ethereum-jobs/).
