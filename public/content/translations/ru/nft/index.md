...
| NFT уникальны в **цифровой форме**, не существует двух NFT, которые были бы одинаковыми.                                                                                              | **Копия зачастую не отличима** от оригинала.                                                                                                                                                                                         |
| Информация о праве собственности на NFT хранится непосредственно на блокчейне, **проверить ее может каждый**.                                                                         | Доступ к записям о владении цифровыми объектами **контролируется учреждениями**: вы доверяете предоставляемой ими информации.                                                                                                        |
| NFT — [умные контракты](/glossary/#smart-contract) в сети Ethereum. Это значит, что они **с легкостью могут быть использованы другими умными контрактами** и приложениями в Ethereum! | Компаниям, работающим с цифровыми объектами, **необходима их собственная «защищенная» инфраструктура**.                                                                                                                              |
...
На ethereum.org **NFT используются, чтобы отметить людей, которые внесли значимый вклад** в наш репозиторий Github (разрабатывали сайт, написали или усовершенствовали статью...), перевели контент или посетили сборы сообщества, у нас даже есть собственное доменное имя NFT. Внеся свой вклад в работу ethereum.org, вы можете запросить NFT [POAP](/glossary/#poap). Некоторые криптографические мероприятия использовали POAP в качестве билетов. [Подробнее об участии в работе](/contributing/#poap).
