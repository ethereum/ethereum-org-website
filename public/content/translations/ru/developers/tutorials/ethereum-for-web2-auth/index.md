...
### SAML для пользователей Ethereum {#saml-for-ethereum-people}
...
### Ethereum для пользователей SAML {#ethereum-for-saml-people}
...
## Использование подписей Ethereum {#using-ethereum-signatures}
...
## Что насчет децентрализации? {#what-about-decentralization}
