...
### Тестовые сети уровня 2 {#development-networks}
...
##### Краны {#common-and-legacy-testnets}
...
##### Ресурсы {#related-tools}

- [Etherscan](https://sepolia-optimistic.etherscan.io/)
- [Blockscout](https://optimism-sepolia.blockscout.com/)

##### Краны {#further-reading}
...
## <Emoji text="🚉" /> Почему тестовые сети Эфириума названы в честь станций метро?
...
### <Emoji text="🚧" /> Часто используемые и устаревшие тестовые сети
...
### <Emoji text="🧪" /> Другие специализированные тестовые сети
