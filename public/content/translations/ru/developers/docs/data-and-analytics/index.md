...
[Mobula](https://mobula.io/) — это высокопроизводительный API криптовалютных данных, предоставляющий рыночные данные в реальном времени и исторические данные, метаданные токенов, портфели кошельков и ончейн-аналитику для более чем 90 блокчейнов. Разработчики могут получить доступ к конечным точкам REST и GraphQL для получения цен на токены, рыночной капитализации, объемов торгов, данных о ликвидности и балансов мультичейн-кошельков без запуска собственной инфраструктуры. Mobula предлагает как бесплатные (100 000 запросов в месяц), так и платные тарифные планы для рабочих приложений.
