...
##### Голосование/стейкинг за точность данных {#availability}
...
##### Механизмы фокальной точки (точки Шеллинга) {#good-incentive-compatibility}
...
### Доступность {#applications-of-oracles-in-smart-contracts}
...
### Хорошая совместимость стимулов {#retrieving-financial-data}
...
## Применение оракулов в смарт-контрактах {#generating-verifiable-randomness}

Ниже приведены распространенные варианты использования оракулов в Эфириуме:

### Извлечение финансовых данных {#getting-outcomes-for-events}
...
### Генерация доказуемой случайности {#automating-smart-contracts}
...
### Получение результатов событий {#use-blockchain-oracles}
...
### Автоматизация смарт-контрактов {#further-reading}
