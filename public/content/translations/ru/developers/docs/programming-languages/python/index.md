---
title: Эфириум для разработчиков на Python
description: Узнайте, как разрабатывать для Эфириума, используя проекты и инструменты на базе Python
lang: ru
incomplete: true
---

<FeaturedText>Узнайте, как разрабатывать для Эфириума, используя проекты и инструменты на базе Python</FeaturedText>

Используйте Эфириум для создания децентрализованных приложений (dapp), которые используют преимущества криптовалюты и технологии блокчейн. Эти децентрализованные приложения могут быть надежными, что означает, что после того, как они будут развернуты в Эфириуме, они всегда будут работать так, как запрограммировано. Они могут управлять цифровыми активами для создания новых видов финансовых приложений. Они могут быть децентрализованными, что означает, что ни одна организация или человек не контролирует их, и их практически невозможно подвергнуть цензуре.

## Начало работы со смарт-контрактами и языком Solidity {#getting-started-with-smart-contracts-and-solidity}

**Сделайте первые шаги по интеграции Python с Эфириумом**
...
- [Обзор экосистемы Python в Эфириуме](https://snakecharmers.ethereum.org/python-ecosystem/)
- [Руководство разработчика (на Python) по Эфириуму](https://snakecharmers.ethereum.org/a-developers-guide-to-ethereum-pt-1/)
- [Достойно приза: руководство по хакатонам Эфириума на Python](https://snakecharmers.ethereum.org/prize-worthy/)
...
- [Как разработать контракт Эфириума с использованием Python Flask?](https://medium.com/coinmonks/how-to-develop-ethereum-contract-using-python-flask-9758fe65976e)
- [Введение в Web3.py · Эфириум для разработчиков на Python](https://www.dappuniversity.com/articles/web3-py-intro)
- [Как вызвать функцию смарт-контракта с помощью Python и Web3.py](https://stackoverflow.com/questions/57580702/how-to-call-a-smart-contract-function-using-python-and-web3-py)
...
- [Создание интерфейса Эфириума на Python: часть 1](https://hackernoon.com/creating-a-python-ethereum-interface-part-1-4d2e47ea0f4d)
- [Смарт-контракты Эфириума на Python: (почти) исчерпывающее руководство](https://hackernoon.com/ethereum-smart-contracts-in-python-a-comprehensive-ish-guide-771b03990988)
...
- [Компиляция, развертывание и вызов смарт-контракта Эфириума с помощью Python](https://yohanes.gultom.id/2018/11/28/compiling-deploying-and-calling-ethereum-smartcontract-using-python/)
...
- [Разверните свой собственный токен ERC-20 с помощью Python и Brownie](https://betterprogramming.pub/python-blockchain-token-deployment-tutorial-create-an-erc20-77a5fd2e1a58)
- [Использование Brownie и Python для развертывания смарт-контрактов](https://dev.to/patrickalphac/using-brownie-for-to-deploy-smart-contracts-1kkp)
...
- [Mamba](https://github.com/arjunaskykok/mamba) — _фреймворк для написания, компиляции и развертывания смарт-контрактов, написанных на языке Vyper_
- [Brownie](https://github.com/eth-brownie/brownie) — _фреймворк Python для развертывания, тестирования и взаимодействия со смарт-контрактами Эфириума_
- [pydevp2p](https://github.com/ethereum/pydevp2p) — _реализация P2P-стека Эфириума_
...
## Проекты, использующие инструменты Python {#projects-using-python-tooling}

Следующие проекты на базе Эфириума используют инструменты, упомянутые на этой странице. Связанные репозитории с открытым исходным кодом служат хорошим справочником для примеров кода и передовых практик.

- [Yearn Finance](https://yearn.finance/) и [репозиторий контрактов хранилища Yearn](https://github.com/yearn/yearn-vaults)
- [Curve](https://www.curve.finance/) и [репозиторий смарт-контрактов Curve](https://github.com/curvefi/curve-contract)
- [BadgerDAO](https://badger.com/) и [смарт-контракты, использующие набор инструментов Brownie](https://github.com/Badger-Finance/badger-system)
...
- [Alpha Finance](https://alphaventuredao.io/), известная по Alpha Homora, использует [Brownie для тестирования и развертывания смарт-контрактов](https://github.com/AlphaFinanceLab/alpha-staking-contract)

## Обсуждения в сообществе Python {#python-community-contributors}

- [Дискорд сообщества Python в Эфириуме](https://discord.gg/9zk7snTfWe) для обсуждения Web3.py и других фреймворков Python
- [Дискорд Vyper](https://discord.gg/SdvKC79cJk) для обсуждения программирования смарт-контрактов на Vyper

## Другие агрегированные списки {#other-aggregated-lists}

В вики Vyper есть [невероятный список ресурсов для Vyper](https://github.com/vyperlang/vyper/wiki/Vyper-tools-and-resources)