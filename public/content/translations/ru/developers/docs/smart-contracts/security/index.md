...
### 3. Тестируйте смарт-контракты и проверяйте правильность кода {#test-smart-contracts-and-verify-code-correctness}
...
#### Программы bug bounty {#bug-bounties}
...
### 5. Следуйте передовым практикам при разработке смарт-контрактов {#follow-smart-contract-development-best-practices}
...
### 6. Реализуйте надежные планы аварийного восстановления {#implement-disaster-recovery-plans}
...
### 7. Разработайте безопасные системы управления {#design-secure-governance-systems}
...
### 9. Защищайтесь от распространенных уязвимостей смарт-контрактов {#mitigate-common-smart-contract-vulnerabilities}
...
#### Целочисленные переполнения (underflow и overflow) {#integer-underflows-and-overflows}
...
#### Манипулирование оракулом {#oracle-manipulation}
...
## Ресурсы по безопасности смарт-контрактов для разработчиков {#smart-contract-security-resources-for-developers}

### Инструменты для анализа смарт-контрактов и проверки правильности кода {#code-analysis-tools}
...
### Инструменты для мониторинга смарт-контрактов {#smart-contract-monitoring-tools}
...
### Инструменты для безопасного администрирования смарт-контрактов {#smart-contract-administration-tools}
...
### Сервисы аудита смарт-контрактов {#smart-contract-auditing-services}
...
### Платформы bug bounty {#bug-bounty-platforms}
...
### Публикации об известных уязвимостях и эксплойтах смарт-контрактов {#common-smart-contract-vulnerabilities-and-exploits}
...
### Задачи для изучения безопасности смарт-контрактов {#challenges-for-learning-smart-contract-security}
...
### Лучшие практики по обеспечению безопасности смарт-контрактов {#smart-contract-security-best-practices}
...
### Руководства по безопасности смарт-контрактов {#tutorials-on-smart-contract-security}
