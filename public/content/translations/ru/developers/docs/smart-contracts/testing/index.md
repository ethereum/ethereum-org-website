...
##### 1. Поймите бизнес-логику и рабочий процесс вашего контракта {#integration-testing-for-smart-contracts}
...
##### 2. Оцените все допущения, связанные с выполнением контракта {#property-based-testing-for-smart-contracts}
...
##### 3. Измеряйте покрытие кода {#static-analysis}
...
##### 4. Используйте хорошо проработанные фреймворки для тестирования {#dynamic-analysis}
...
### Интеграционное тестирование {#running-property-based-tests}
...
### Тестирование на основе свойств {#manual-testing-for-smart-contracts}
...
#### Статический анализ {#testing-on-local-blockchain}
...
#### Динамический анализ {#testing-contracts-on-testnets}
...
### Рекомендации по проведению тестирования на основе свойств для смарт-контрактов {#testing-vs-formal-verification}
...
## Ручное тестирование смарт-контрактов {#testing-vs-audits-bug-bounties}
...
### Тестирование контрактов в локальном блокчейне {#testing-tools-and-libraries}
...
### Тестирование контрактов в тестовых сетях {#unit-testing-tools}
...
## Тестирование и формальная верификация {#property-based-testing-tools}
...
## Тестирование, аудиты и программы bug bounty {#static-analysis-tools}
...
## Инструменты и библиотеки для тестирования {#dynamic-analysis-tools}

### Инструменты для модульного тестирования {#related-tutorials}
...
### Инструменты для тестирования на основе свойств {#further-reading}

#### Инструменты статического анализа {#tutorials}
