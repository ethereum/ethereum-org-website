...
**Ape -** **_Инструмент разработки смарт-контрактов для Python-разработчиков, специалистов по данным и безопасности._**
...
**Crossmint -** **_Платформа разработки Web3 корпоративного уровня, которая позволяет создавать NFT-приложения во всех основных сетях, сетях EVM (и других)._**
...
**Catapulta -** **_Инструмент для развертывания смарт-контрактов в нескольких сетях, автоматизации проверок в обозревателях блоков, отслеживания развернутых смарт-контрактов и обмена отчетами о развертывании, работающий по принципу plug-n-play для проектов Foundry и Hardhat._**
...
**Wake -** **_Универсальный Python-фреймворк для тестирования контрактов, фаззинга, развертывания, сканирования уязвимостей и навигации по коду._**
...
**Veramo -** **_Модульный и независимый фреймворк с открытым исходным кодом, который позволяет разработчикам децентрализованных приложений легко встраивать децентрализованные идентификаторы и проверяемые учетные данные в свои приложения._**
...
**Moccasin -** **_Быстрый Python-фреймворк для разработки и тестирования смарт-контрактов на Vyper, созданный на базе Titanoboa._**

- [Документация](https://cyfrin.github.io/moccasin/)
