...
#### Решения Plug-and-play {#automatized-setup}
...
### Управляемая настройка {#client-setup}
...
##### Запуск Незермайнда {#running-additional-services}
...
##### Запуск Рета {#monitoring-the-node}
