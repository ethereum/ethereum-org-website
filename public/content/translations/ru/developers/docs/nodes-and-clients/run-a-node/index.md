...
##### Минимальные требования {#ethereum-on-a-single-board-computer}
...
##### Рекомендуемые характеристики {#spinning-up-node}
...
#### Готовые решения (plug-and-play) {#automatized-setup}
...
#### Эфириум на одноплатном компьютере {#manual-setup}
...
## Запуск узла {#getting-the-client}
...
### Пошаговая настройка {#client-setup}
...
### Ручная настройка клиентов {#starting-the-execution-client}
...
#### Получение клиентского программного обеспечения {#running-an-execution-client}
...
##### Клиенты исполнения {#starting-the-consensus-client}
...
##### Клиенты консенсуса {#running-a-consensus-client}
...
##### Проверка программного обеспечения {#adding-validators}
...
#### Настройка клиента {#using-the-node}
...
#### Запуск клиента исполнения {#reaching-rpc}
...
#### Запуск клиента исполнения {#operating-the-node}
...
##### Запуск Эригона {#creating-client-services}
...
#### Запуск клиента консенсуса {#further-reading}
...
#### Запуск клиента консенсуса {#related-topics}
