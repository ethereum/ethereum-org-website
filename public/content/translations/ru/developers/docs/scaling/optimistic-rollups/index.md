...
##### Вход в роллап {#evm-compatibility}
...
##### Выход из роллапа {#cross-chain-contract-calls}
...
#### 2. Совместимость с EVM {#how-do-optimistic-rollup-fees-work}
...
#### 3. Кроссчейн-вызовы контрактов {#scaling-ethereum-with-optimistic-rollups}
...
## Как работают комиссии оптимистичных роллапов? {#optimistic-rollups-pros-and-cons}
...
## Как оптимистичные роллапы масштабируют Эфириум? {#optimistic-video}
...
### Плюсы и минусы оптимистичных роллапов {#further-reading-on-optimistic-rollups}
...
### Визуальное объяснение оптимистичных роллапов {#tutorials}
