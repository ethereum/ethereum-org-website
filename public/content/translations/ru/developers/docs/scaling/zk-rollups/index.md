...
## ZK-роллапы и совместимость с EVM {#zk-rollups-and-evm-compatibility}
...
## Как работают комиссии в ZK-роллапах? {#how-do-zk-rollup-fees-work}
...
## Как ZK-роллапы масштабируют Эфириум? {#scaling-ethereum-with-zk-rollups}
...
### Плюсы и минусы ZK-роллапов {#zk-rollups-pros-and-cons}
...
### Визуальное объяснение ZK-роллапов {#zk-video}
...
## Дополнительная литература о ZK-роллапах {#further-reading-on-zk-rollups}
...
## Руководства: Приватность и нулевое разглашение в Эфириуме {#tutorials}
