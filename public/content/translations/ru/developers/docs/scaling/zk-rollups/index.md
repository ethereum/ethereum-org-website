...
<AlertEmoji text="💡" />
<AlertContent>
<AlertTitle>zkEVM для L2 против L1</AlertTitle>
<AlertDescription>
Проекты ниже используют технологию zkEVM для создания роллапов уровня 2. Также ведутся исследования по использованию zkEVM для проверки блоков L1, что позволит валидаторам проверять блоки Ethereum без повторного выполнения транзакций.
</AlertDescription>
</AlertContent>
</Alert>
