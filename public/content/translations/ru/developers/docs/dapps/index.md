...
## Инструменты для создания децентрализованных приложений (dapps) {#dapp-tools}

**Scaffold-ETH 2 _— быстро экспериментируйте с Solidity, используя фронтенд, который адаптируется к вашему смарт-контракту._**
...
**One Click Dapp _— инструмент с открытым исходным кодом (FOSS) для создания фронтендов dapps на основе [ABI](/glossary/#abi)._**

- [oneclickdapp.com](https://oneclickdapp.com)
- [GitHub](https://github.com/oneclickdapp/oneclickdapp-v1)

**Etherflow _— инструмент с открытым исходным кодом (FOSS) для разработчиков Эфириума, позволяющий тестировать свой узел, а также составлять и отлаживать RPC-вызовы из браузера._**
...
**Crossmint _— платформа корпоративного уровня для разработки Web3, позволяющая развертывать смарт-контракты, принимать платежи по кредитным картам и кроссчейн-платежи, а также использовать API для создания, распространения, продажи, хранения и редактирования NFT._**
