...
<AlertContent>
<AlertDescription>
 <p className="mt-0"><strong>リステーキングの追加のメリット</strong></p>
...
<AlertContent>
<AlertDescription>
 <p className="mt-0"><strong>誤称に注意</strong></p>
...
<AlertContent>
<AlertDescription>
 <p className="mt-0"><strong>イーサリアムの共同創設者の見解…</strong></p>
  <p className="mt-2">
...
<AlertContent>
<AlertDescription>
 <p className="mt-0"><strong>イーサリアムのステーキング：</strong> どのような仕組みですか？</p>
