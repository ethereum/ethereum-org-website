...
世界中の人々が、スマートコントラクトに[ether(ETH)](/what-is-ether/)をロック(または「ステーク」)して、イーサリアムのトランザクションを処理し、イーサリアムネットワークを保護するソフトウェアを実行しています。 その見返りとして、より多くのETHで報酬を得ます。
...
<AlertDescription>
  ...
  <p className="mt-2">
 イーサリアムの共同創設者であるヴィタリックは、2021年のブログ投稿「<a href="https://vitalik.eth.limo/general/2023/05/21/dont_overload.html">コンセンサスに過負荷をかけるな</a>」で、リステーキングの潜在的なリスクについて警告しました。
</p>
</AlertDescription>
</AlertContent>
</Alert>
