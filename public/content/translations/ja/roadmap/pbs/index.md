...
<ExpandableCard title="PBSはどのような検閲を解決する？" eventCategory="/roadmap/pbs" eventName="clicked what kinds of censorship does PBS solve?">
...
<ExpandableCard title="ブロック構築を中央集権化しても問題ないのはなぜ？" eventCategory="/roadmap/pbs" eventName="clicked why is it OK to centralize block building?">
...
- [インクルージョンリスト](https://notes.ethereum.org/@fradamt/H1ZqdtrBF)
