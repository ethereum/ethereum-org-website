...
`ConsolidationRequest`オブジェクトのドメイン分離された[署名ルート](https://github.com/ethereum/consensus-specs/blob/master/specs/phase0/beacon-chain.md#compute_signing_root)が使用されます。
