...
<ExpandableCard title="なぜステートレスクライアントを目指すのか？" eventCategory="/roadmap/verkle-trees" eventName="clicked why do we want stateless clients?">
...
<ExpandableCard title="バークルツリーでウィットネスのサイズはどれくらい小さくなる？" eventCategory="/roadmap/verkle-trees" eventName="clicked exactly how much can Verkle trees reduce witness size?">
