...
<ExpandableCard title="なぜステートレスクライアントが必要なのか？" eventCategory="/roadmap/verkle-trees" eventName="clicked why do we want stateless clients?">
...
<ExpandableCard title="バークルツリーでウィットネスサイズは具体的にどのくらい小さくなりますか？" eventCategory="/roadmap/verkle-trees" eventName="clicked exactly how much can Verkle trees reduce witness size?">
...
- [一般人のためのバークルツリー](https://web.archive.org/web/20250124132255/https://research.2077.xyz/verkle-trees)
- [バークル証明の構造](https://ihagopian.com/posts/anatomy-of-a-verkle-proof)
- [ETHGlobalでのGuillaume Balletによるバークルツリーの解説](https://www.youtube.com/watch?v=f7bEtX3Z57o)
- [Devcon 6でのGuillaume Balletによる「バークルツリーがイーサリアムを効率的にする仕組み」](https://www.youtube.com/watch?v=Q7rStTKwuYs)
- [ETHDenver 2020でのPiper Merriamによるステートレスクライアントについての講演](https://www.youtube.com/watch?v=0yiZJNciIJ4)
- [Dankrad FiestによるZero Knowledgeポッドキャストでのバークルツリーとステートレス性についての解説](https://zeroknowledge.fm/podcast/202/)
- [Vitalik Buterinによるバークルツリーについての解説](https://vitalik.eth.limo/general/2021/06/18/verkle.html)
- [Dankrad Feistによるバークルツリーについての解説](https://dankradfeist.de/ethereum/2021/06/18/verkle-trie-for-eth1.html)
- [バークルツリーEIPドキュメント](https://notes.ethereum.org/@vbuterin/verkle_tree_eip#Illustration)
