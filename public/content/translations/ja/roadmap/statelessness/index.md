...
<ExpandableCard title="ブロック提案者が少なくても問題ないのはなぜ？" eventCategory="/roadmap/statelessness" eventName="clicked why is it OK to rely on fewer block proposers?">
...
L1検証用のzkEVMは、ステートレス検証をさらに強化できる補完的なテクノロジーです。バリデータはウィットネスをチェックするだけでなく、ブロック全体が正しく実行されたというゼロ知識証明を検証できます -- トランザクションを再実行することなく、暗号学的な確実性を提供します。
