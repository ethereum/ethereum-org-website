...
![Geth モニタリング用の Grafana ダッシュボードのスクリーンショット (パネル 1)](./grafana1.png)

Grafanaのホームページに転送されます。 まず、ソースデータを設定します。 左のバーにある設定アイコンをクリックし、「Data sources」を選択します。

![Geth モニタリング用の Grafana ダッシュボードのスクリーンショット (パネル 2)](./grafana2.png)

まだデータソースは作成されていません。「Add data source」をクリックして定義します。

![Geth モニタリング用の Grafana ダッシュボードのスクリーンショット (パネル 3)](./grafana3.png)

この設定では、「InfluxDB」を選択して続行します。

![Geth モニタリング用の Grafana ダッシュボードのスクリーンショット (パネル 4)](./grafana4.png)
