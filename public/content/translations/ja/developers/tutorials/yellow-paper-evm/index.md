...
おそらくこれらの理由から、新しい[コンセンサスレイヤー仕様](https://github.com/ethereum/consensus-specs/blob/master/tests/core/pyspec/README.md)はPythonで書かれています。 [Pythonで書かれた実行レイヤー仕様](https://ethereum.github.io/execution-specs)がありますが、完全ではありません。 イエローペーパー全体がPythonまたは同様の言語に翻訳されるまで、イエローペーパーは使用され続けるため、読めるようにしておくと便利です。
