...
Solidityのテストでは得られないものの1つは、自分のアプリケーションにコピー＆ペーストできるJavaScriptコードです。 そのコードを書くために、WORMを[Optimism](https://www.optimism.io/)の新しいテストネットである[Optimism Goerli](https://docs.optimism.io/op-stack/introduction/op-stack)にデプロイしました。 アドレスは[`0xd34335b1d818cee54e3323d3246bd31d94e6a78a`](https://testnet-explorer.optimism.io/address/0xd34335b1d818cee54e3323d3246bd31d94e6a78a)です。
...
4. `.env`を編集して設定を行います。
   ...
   | パラメータ                                                         | 値                                                                                                               |
   | ------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- |
   | MNEMONIC                                                      | トランザクションの支払いに十分なETHを持っているアカウントのニーモニック。 [こちらでOptimismのGoerliネットワークの無料ETHを手に入れられます](https://docs.optimism.io/app-developers/tools/faucets)。 |
   | OPTIMISM_GOERLI_URL | Optimism GoerliのURL。 公開エンドポイント`https://sepolia.optimism.io`は、レート制限がありますが、ここで必要な用途には十分です。                         |
