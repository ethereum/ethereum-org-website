...
- [VSCode Solidityのインストール](https://marketplace.visualstudio.com/items?itemName=JuanBlanco.solidity)
- [イーサリアムのスマート・コントラクトを作成および呼び出すための.NET開発者のワークフロー](https://medium.com/coinmonks/a-net-developers-workflow-for-creating-and-calling-ethereum-smart-contracts-44714f191db2)
...
- [C#とVisual Studioを使用してイーサリアムのスマート・コントラクトを簡単にデプロイする方法を見る](https://koukia.ca/deploy-ethereum-smart-contracts-using-c-and-visualstudio-5be188ae928c)

**今のところセットアップをスキップして、すぐにサンプルを見たいですか？**

- [Playground](https://playground.nethereum.com/) - ブラウザを通じてイーサリアムと対話し、Nethereumの使用方法を学びます。
...
- [独自の開発用テストチェーンをデプロイする](https://github.com/Nethereum/Testchains)
- [Solidity用VSCode Codegenプラグイン](https://docs.nethereum.com/docs/aspire-templates/guide-codegen)
- [Unityとイーサリアム: その理由と方法](https://www.raywenderlich.com/5509-unity-and-ethereum-why-and-how)
- [イーサリアムdapp用のASP.NET Core Web APIを作成する](https://tech-mint.com/blockchain/create-asp-net-core-web-api-for-ethereum-dapps/)
- [Nethereum Web3を使用してサプライチェーン追跡システムを実装する](http://blog.pomiager.com/post/using-nethereum-web3-to-implement-a-supply-chain-traking-system4)
...
- [Nethereum Codegen Blazor](https://github.com/Nethereum/Nethereum.CodeGen.Blazor) - _BlazorのUIを備えたNethereumコードジェネレーター_
...
- [TestChains](https://github.com/Nethereum/TestChains) - _高速な応答のための事前構成済み.NET開発チェーン (PoA)_
