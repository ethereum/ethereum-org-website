...
<FeaturedText>.NETベースのプロジェクトとツールを使用してイーサリアムを開発する方法を学びましょう</FeaturedText>
...
- [Playground](https://playground.nethereum.com/) - ブラウザを介してイーサリアムとやり取りし、Nethereumの使用方法を学びます。
  - アカウント残高の照会 [C#](https://playground.nethereum.com/csharp/id/1001) [VB.NET](https://playground.nethereum.com/vb/id/2001)
  - ERC20スマートコントラクトの残高照会 [C#](https://playground.nethereum.com/csharp/id/1005) [VB.NET](https://playground.nethereum.com/vb/id/2004)
  - アカウントへのEtherの送金 [C#](https://playground.nethereum.com/csharp/id/1003) [VB.NET](https://playground.nethereum.com/vb/id/2003)
  - ... などなど！

## 中級者向けの記事 {#intermediate-articles}

- [Nethereum ワークブック/サンプルリスト](https://docs.nethereum.com/en/latest/Nethereum.Workbooks/docs/)
...
- [Nethereumブロック処理](https://nethereum.readthedocs.io/en/latest/nethereum-block-processing-detail/)、[C# Playgroundサンプル](https://playground.nethereum.com/csharp/id/1025)付き
...
- [Nethereum Playground](https://playground.nethereum.com/) - _ブラウザでNethereumコードスニペットをコンパイル、作成、実行_
...
Nethermindが初めてで、使い始めるのにヘルプが必要な場合は、私たちの[Discord](https://discord.gg/PaCMRFdvWT)に参加してください。 デベロッパーが常駐しており、ご質問に回答します。 [Nethermind GitHubリポジトリ](https://github.com/NethermindEth/nethermind)でPRを作成したり、issueを提起したりすることも、ご自由にどうぞ。
