...
### 優れたインセンティブの互換性 {#good-incentive-compatibility}
...
## スマート・コントラクトにおけるオラクルのアプリケーション {#applications-of-oracles-in-smart-contracts}

以下は、イーサリアムにおけるオラクルの一般的なユースケースです。

### 財務データの取得 {#retrieving-financial-data}
...
### イベントの結果の取得 {#getting-outcomes-for-events}
...
### スマート・コントラクトの自動化 {#automating-smart-contracts}
...
## ブロックチェーン・オラクルの使用方法 {#use-blockchain-oracles}
