...
![Ethereum コンセンサス クライアント ネットワーキング層の図](cons_client_net_layer.png)
![Ethereum 実行クライアント ネットワーキング層の図](exe_client_net_layer.png)
...
[コンセンサスレイヤーのネットワーク仕様](https://github.com/ethereum/consensus-specs/blob/master/specs/phase0/p2p-interface.md#enr-structure)
...
[eth1とeth2の関係](https://ethresear.ch/t/eth1-eth2-client-relationship/7248)
