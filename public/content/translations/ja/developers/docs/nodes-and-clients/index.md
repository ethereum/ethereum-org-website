...
ethrexは、Rustで記述され、LambdaClassによって開発された、ミニマリストでモジュール式のイーサリアム実行クライアントです。ゼロ知識証明を念頭に置いて構築されており、同じコードベースをL1実行クライアントとしても、マルチプルーバーのZKロールアップ (L2) としても実行できます。Apache 2.0およびMITライセンスの下でデュアルライセンスされています。

詳細については、[ethrexのドキュメント](https://docs.ethrex.xyz/)を読むか、[ethrexのGitHubリポジトリ](https://github.com/lambdaclass/ethrex)を確認してください。
### ゴー・イーサリアム（ゲス） {#geth}
