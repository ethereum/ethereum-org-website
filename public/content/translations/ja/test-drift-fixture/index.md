...
<ExpandableCard title="NFTの送金はなぜもっと費用がかかるの？" eventCategory="/test-drift" eventName="clicked Why do NFT transfers cost more?">
...
<ExpandableCard title="ガス代を削減する方法" eventCategory="/test-drift" eventName="clicked How to reduce gas costs">
