...
<CardGrid>
  <Card title="新しいETHを獲得" emoji="💸" description="バリデータがオンラインであれば、仲介者なしでプロトコルから直接ETH建ての報酬を獲得できます。" />
  <Card title="完全にコントロール" emoji="🎛️" description="自身のキーを管理し、リスクを最小化してネットワークに貢献できるクライアントとハードウェアを自由に選べます。サードパーティのサービスはあなたに代わって決定を下しますが、その選択が常に安全とは限りません。" />
  <Card title="ネットワークセキュリティ" emoji="🔐" description="ホームステーキングは、最もインパクトの大きいステーキング方法です。自宅のハードウェアでバリデータを実行することで、イーサリアムプロトコルの堅牢性、分散化、セキュリティを強化できます。" />
</CardGrid>
...
<ExpandableCard title="コンピュータ操作への習熟" eventCategory="SoloStaking" eventName="clicked comfortable with computers">
...
<ExpandableCard title="オフラインになるとスラッシングされますか？(答え：いいえ)">
...
<ExpandableCard title="どうすればスラッシングを避けられますか？">
...
<a href="https://mirror.xyz/jmcook.eth/S7ONEka_0RgtKTZ3-dakPmAHQNPvuj15nh0YGKPFriA">クライアントの多様性がなぜ重要なのかについての詳細</a>
</ExpandableCard>

<ExpandableCard title="VPS (仮想プライベートサーバー) は使えますか？">
...
<ExpandableCard title="報酬やETHを引き出すには？">
