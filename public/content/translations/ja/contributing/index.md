...
**開発**
- [オープンなIssueに取り組む](https://github.com/ethereum/ethereum-org-website/issues) – 私たちが特定した、対応が必要な作業です
...
- [コミュニティリソースの追加](/contributing/content-resources/) – 関連するページに役立つ記事やリソースを追加します
- [デザインリソースの提案](/contributing/design/adding-design-resources/) – 役立つデザインリソースを追加、更新、削除します
- [クイズ](/contributing/quizzes/) – 関連するページのクイズ問題バンクを追加、更新、削除します
- [動画の提案](/contributing/adding-videos/) – 動画ギャラリー用の教育動画を提案します

**機能のアイデア**
- [機能のリクエスト](https://github.com/ethereum/ethereum-org-website/issues/new?assignees=&labels=Type%3A+Feature&template=feature_request.yaml&title=) – 新しい機能やデザインに関するアイデアがあれば教えてください

**プロダクトの掲載**
- [取引所の追加](/contributing/adding-exchanges/) – [取引所検索](/get-eth/#country-picker)に取引所を追加します
- [プロダクトの追加](/contributing/adding-products/) – 関連するページに分散型アプリケーション (dapp)やウォレットを追加します
- [開発者ツールの追加](/contributing/adding-developer-tools/) – 関連するページに開発者ツールを追加します
- [レイヤー2 (L2)の追加](/contributing/adding-layer-2s/) – 関連するページにレイヤー2 (L2)を追加します
- [ステーキングプロダクトまたはサービスの追加](/contributing/adding-staking-products/) – ソロ・ステーキング、プール・ステーキング、またはステーキング・アズ・ア・サービスを促進するプロジェクトを追加します
- [ウォレットの追加](/contributing/adding-wallets/) – [ウォレット検索ページ](/wallets/find-wallet/)にウォレットを追加します
- [DeSciページへのプロジェクトの提案](/contributing/adding-desci-projects/) – 分散型科学に貢献する、イーサリアム上に構築されたプロジェクトを追加します
- [リソースの追加](/contributing/adding-resources/) – 関連するページに役立つリソースを追加します
