...
metaTitle: "貢献"
description: "ethereum.orgに貢献するさまざまな方法について学ぶ"
lang: ja
---

ethereum.orgは、ウェブサイトの翻訳、執筆、デザイン、保守を支援する**12,000人以上**の貢献者によって運営されているオープンソースプロジェクトです。

私たちは歓迎的なコミュニティであり、あなたが[イーサリアム](/)エコシステムで成長し学ぶのを支援すると同時に、有意義な貢献をして関連する実践的な経験を得られるようにします！

## 貢献する方法 {#ways-to-contribute}

**翻訳**
- [翻訳エラーを報告する](https://github.com/ethereum/ethereum-org-website/issues/new/choose) – [翻訳プログラム](/contributing/translation-program/)は縮小しており、新規翻訳者のオンボーディングは行っていません

**開発**
- [オープンなIssueに取り組む](https://github.com/ethereum/ethereum-org-website/issues) – 私たちが特定した、対応が必要な作業

**デザイン**
- [ウェブサイトのデザインを支援する](/contributing/design/) – あらゆるレベルのデザイナーがウェブサイトの改善に貢献できます
...
- [動画を提案する](/contributing/adding-videos/) – 動画ギャラリーに教育的な動画を提案します

**機能のアイデア**
- [機能をリクエストする](https://github.com/ethereum/ethereum-org-website/issues/new?assignees=&labels=Type%3A+Feature&template=feature_request.yaml&title=) – 新しい機能やデザインに関するアイデアがあればお知らせください

**プロダクトの掲載**
- [取引所を追加する](/contributing/adding-exchanges/) – [取引所検索](/get-eth/#country-picker)に取引所を追加します
...
- [レイヤー2 (L2) を追加する](/contributing/adding-layer-2s/) – 関連するページにレイヤー2 (L2) を追加します
...
これらは、あなたが解決を支援し、責任を持つことができる現在のいくつかのタスクです。ウェブサイトへの変更のほとんどはGitHubを通じて行われるため、ほとんどのタスクでGitHubアカウントが必要になります。
...
貢献する（ウェブサイトへのコンテンツやビジュアルの追加・編集、バグの修正、オープンなタスクへの取り組み）には、[GitHub](https://github.com/)アカウントが必要です。
...
個々のPR、デザインの進化、および主要なアップグレードに関する決定は、イーサリアムエコシステム全体のチームによって行われます。このチームには、プロジェクトマネージャー、開発者、デザイナー、マーケティングおよびコミュニケーション担当者、そして専門家が含まれます。コミュニティからの意見はすべての決定に反映されます。そのため、Issueで質問を提起したり、PRを提出したり、チームに連絡したりしてください：
...
## オンチェーン・アチーブメント・トークン (OAT) を請求する {#oat}

あなたの貢献がethereum.orgにマージされると、[Galxe](https://app.galxe.com/quest/ethereumorg)で特別なバッジを請求する機会が得られます。オンチェーン・アチーブメント・トークン (OAT) は、あなたがエコシステムを少しでも素晴らしいものにするのに貢献したことの証明です。
...
OATの請求には、セルフカストディウォレットのみを使用してください。秘密鍵を保持していない取引所のアカウントやその他のアカウントは使用しないでください。これらを使用すると、OATにアクセスして管理することができなくなります。

## GitPOAPを請求する {#claim-gitpoap}

GitPOAPもマージされた貢献を自動的に認識し、プラットフォーム上で独自の貢献者POAPをミントできるようにします！
...
4. GitHubアカウントに資格がある場合は、GitPOAPをミントできます！
