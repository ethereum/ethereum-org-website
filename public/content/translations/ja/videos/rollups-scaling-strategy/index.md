...
**ファインマティクス**による、イーサリアムの主要なスケーリング・ストラテジーとしてのロールアップに関する解説です。この動画では、オプティミスティック・ロールアップ（Arbitrum、Optimism）とZKロールアップを比較し、なぜロールアップがイーサリアムをスケーリングするための主要な方法になったのかを考察します。
