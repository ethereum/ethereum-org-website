...
<strong>ファインマティクス</strong>による解説動画です。イーサリアム上のスマート・コントラクトを通じて「コードは法である」という概念を探求し、スマート・コントラクトとは何か、その仕組み、従来のコントラクトに対する利点、そしてなぜそれが分散型金融 (DeFi) の構成要素であるのかを解説します。
