...
<strong>オースティン・グリフィス</strong>による、ビジュアルプログラミングツールETH.BUILDを使用してブロックチェーンのマイニングの仕組みを実演するチュートリアルです。オースティンは、プルーフ・オブ・ワーク (PoW) のコンセンサス、ブロックのチェーン化、マイニングの難易度、ブロック・リワード、およびチェーンの不変性について解説します。
