...
<ExpandableCard title="WETHトークンに種類が複数あるのはなぜですか？" eventCategory="/wrapped-eth" eventName="clicked Why am I seeing different WETH tokens?">
...
<ExpandableCard title="他のネットワークにおけるWETHコントラクトは？" eventCategory="/wrapped-eth" eventName="clicked What are the WETH contracts on other networks?">
