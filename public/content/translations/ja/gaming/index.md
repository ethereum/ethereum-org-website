...
イーサリアムのエコシステムには、イーサリアム・メインネットのセキュリティ保証を継承しつつ、イーサリアムの規模を拡張し、特殊なユースケースをサポートする[レイヤー2 (L2)ブロックチェーン](/layer-2/learn/)も含まれています。L2ネットワークは、確認時間が短く手数料が低いため、オンチェーンゲームとそのコミュニティにさらなるメリットをもたらし、ゲームプレイをよりアクセスしやすくします。

[レイヤー1 (L1)がスケーリングする](/roadmap/scaling/)につれて、ゲームはイーサリアム・メインネットに戻り始めています。その一例が、2026年7月にイーサリアムL1でローンチされたフルオンチェーンゲームである[Asphodel: Prologue](https://play.asphodel.io/)です。しかし、ほとんどのゲームは依然としてL2ソリューションを利用して、より低い手数料の恩恵を受けています。
...
- **ゲームジャンル:** 特定のゲームジャンルは、イーサリアムのブロックチェーンの独自の特性である**永続的な状態**、**検証可能なロジック**、**プレイヤー主導の経済**と自然に一致します。開発者の統合へのアプローチは異なります。すべてのロジックと状態がブロックチェーン上に存在するフルオンチェーンゲームを構築する人もいれば、NFTの装飾アイテムのような資産の所有権のためにブロックチェーンを最小限に使用する人もいます。開発者は、次のようなオンチェーンアーキテクチャから最も恩恵を受けるゲームプレイの種類を発見しています。
   1. **ダンジョンクローラーとローグライク:** 検証可能なハイスコアを備えたLoot Survivorのフルオンチェーンのパーマデスダンジョン、Onchain HeroesのMaze of Gains、および迷路探索と分散型金融 (DeFi)のメカニズムを組み合わせたAxieをテーマにしたスキン変更版であるAxie: Den of Mysteries。
   2. **MMO:** CambriaのGold Rushは、PvPとエクストラクションメカニズムを備えたシーズン制のリスク・トゥ・アーンMMOであり、安全地帯の外でのすべての一歩に実際のステークが伴います。ForTheKingdomのフルオンチェーンMMOストラテジーゲームは、大規模な派閥戦争を特徴としています。Axie Infinity: Atia's Legacyは、Ronin上のオンチェーンMMOであり、プレイヤーは実際のステークを伴うPvEダンジョンやPvPバトルを通じて戦います。 
   3. **4Xストラテジーとグランドストラテジー:** Conquest.ethは、宇宙征服と外交のパーミッションレスなゲームであり、プレイヤーは惑星にトークンをステークして艦隊を生産し、同盟を結びます。このゲームはオンチェーンで永遠に実行されます。Realmsは、[Eternum](/apps/eternum/)の4Xメカニズムをファンタジー設定にもたらし、プレイヤーはRealms（土地NFT）を制御してリソースを採掘し、軍隊を構築し、完全にプレイヤー主導の経済の中で複雑な外交に従事します。Dark Forestは、ZK証明による戦場の霧（fog of war）メカニズムでこのジャンルを開拓し、現在はDFArchonによってコミュニティのフォークとして維持されています。
   4. **ストラテジーとタクティカル:** Realmsには、Blitzの激しい1時間のバイインベースのストラテジーマッチが含まれており、Asphodel: Prologueのオートバトラーは最近イーサリアム・メインネットでローンチされました。
   ...
   6. **対戦アリーナ:** CambriaのDuel Arenaでは、プレイヤーはペースの速い1対1のデスマッチにETHをステークします。AveForgeは、プレイヤーがカスタマイズ可能なメカを操縦する対戦型メカバトルアリーナです。
## 試してみたいゲーム {#games}
