...
# How to bridge tokens to layer 2 {#how-to-bridge-tokens-to-layer-2}
...
## 2. Go to the selected bridge {#2-go-to-the-selected-bridge}
...
## 4. Specify the amount and move the funds {#4-specify-the-amount-and-move-the-funds}
...
## 6. Wait for your funds to be moved {#6-wait-for-your-funds-to-be-moved}
...
### What if I have funds on an exchange? {#what-if-i-have-funds-on-an-exchange}
