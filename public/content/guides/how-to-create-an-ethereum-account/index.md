...
## Step 1: Choose a wallet {#step-1-choose-a-wallet}
...
## Step 2: Download and install your wallet app {#step-2-download-and-install-your-wallet-app}
...
## Step 3: Open the app and create your Ethereum account {#step-3-open-the-app-and-create-your-ethereum-account}
...
## Step 4: Store your recovery phrase {#step-4-store-your-recovery-phrase}
...
### Are my wallet and my Ethereum account the same? {#are-my-wallet-and-my-ethereum-account-the-same}
...
### Can I send bitcoin to an Ethereum address, or ether to a Bitcoin address? {#can-i-send-bitcoin-to-an-ethereum-address-or-ether-to-a-bitcoin-address}
...
### Is having my own wallet safer than keeping my funds on an exchange? {#is-having-my-own-wallet-safer-than-keeping-my-funds-on-an-exchange}
...
### If I lose my phone/hardware wallet, do I need to use the same wallet app again to recover the lost funds? {#if-i-lose-my-phonehardware-wallet-do-i-need-to-use-the-same-wallet-app-again-to-recover-the-lost-funds}
