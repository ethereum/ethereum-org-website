...
#### Transaction fees and miner incentives (0:00)
...
#### Anatomy of an Ethereum transaction (1:10)
...
#### Setting up the transaction (2:25)
...
#### Sending data with a transaction (9:54)
...
#### Transaction pool and gas bumping (12:43)
