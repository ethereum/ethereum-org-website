...
#### The case for decentralized social networks (0:00) {#the-case-for-decentralized-social-networks-000}
...
#### Interoperability and user control (3:08) {#interoperability-and-user-control-308}
