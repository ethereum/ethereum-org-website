...
- [Ethereum Developer Portal - Everything you need to get started building on Ethereum](https://ethereum.consensys.net/ethereum-dev-portal) *Ενημερώνεται συχνά - ConsenSys*
...
- [Λίστα αναπαραγωγής όλων των συναντήσεων των Ethereum Core Dev](https://www.youtube.com/playlist?list=PLaM7G4Llrb7zfMXCZVEXEABT8OSnd4-7w) *(YouTube Playlist)*

Ορισμένες EIP αφορούν πρότυπα σε επίπεδο εφαρμογών (π.χ. μια τυποποιημένη μορφή smart contract), τα οποία εισάγονται ως [ Αιτήματα για Σχόλια (Ethereum Requests for Comment - ERC) ](https://eips.ethereum.org/erc). Πολλά ERC είναι κρίσιμα πρότυπα που χρησιμοποιούνται ευρέως σε ολόκληρο το οικοσύστημα του Ethereum.

- [Λίστα ERCs](http://eips.ethereum.org/erc)
