...
const translations = {
  ...
  'el-GR': {
    ...
    'page-home-button': 'Εγγραφείτε στο ενημερωτικό μας δελτίο',
  ...
  'es-ES': {
    ...
    'page-home-button': 'Suscríbete a nuestro boletín',
  ...
  'fr-FR': {
    ...
    'page-home-button': 'Abonnez-vous à notre newsletter',
  ...
  'it-IT': {
    ...
    'page-home-button': 'Iscriviti alla nostra Newsletter',
  ...
  'sk-SK': {
    ...
    'page-home-button': 'Prihlásiť sa ku odberu noviniek',
  ...
  'ru-RU': {
    ...
    'page-home-button': 'Подписывайтесь на нашу новостную рассылку',
