...
const translations = {
  ...
  'fa-IR': {
    ...
    'page-home-section-use-item-one': 'امروز با اتریوم چه کاری می توان انجام داد؟',
    'page-home-section-use-item-one-link': '/fa/use/#_1-use-an-application-built-on-ethereum',
    'page-home-section-use-item-two': 'چگونه اتریوم بدست بیاورید؟',
    'page-home-section-use-item-two-link': '/fa/use/#_2-what-is-eth-and-how-do-i-get-it',
    'page-home-section-use-item-three': 'کیف پول (والت) چیست؟',
    'page-home-section-use-item-three-link': '/fa/use/#_3-what-is-a-wallet-and-which-one-should-i-use',
