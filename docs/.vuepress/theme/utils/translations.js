...
const translations = {
  ...
  'nl': {
    ...
    ethereum: 'Ethereum',
    'page-home': 'Ethereum',
    'page-home-title': 'Ethereum is een wereldwijd, open-source platform voor gedecentraliseerde toepassingen.',
    'page-home-subtitle': 'Op Ethereum kunt u code schrijven die digitale waarde beheert, precies werkt zoals het is geprogrammeerd, en overal ter wereld toegankelijk is.',
    'page-home-section-beginners-title': 'Beginners',
    ...
    'page-home-section-use-item-two-link': '/use/#_2-what-is-eth-and-how-do-i-get-it',
    'page-home-section-use-item-three': 'Wat is een \'wallet\' of digitale portemonnee?',
    'page-home-section-use-item-three-link': '/use/#_3-what-is-a-wallet-and-which-one-should-i-use',
    ...
    'page-home-section-developers-item-one-link': '/developers/#getting-started',
    'page-home-section-developers-item-two': 'Leer slimme contracten te programmeren',
    'page-home-section-developers-item-two-link': '/developers/#smart-contract-languages',
    'page-home-section-developers-item-three': 'Vind de nieuwste tools voor ontwikkelaars',
    'page-home-section-developers-item-three-link': '/developers/#developer-tools',
    'page-home-section-enterprise-title': '',
    'page-home-section-enterprise-item-one': '',
    'page-home-section-enterprise-item-one-link': '',
  ...
  'pl': {
    ...
    ethereum: 'Ethereum',
    'page-home': 'Ethereum',
    'page-home-title': 'Ethereum to globalna platforma open source dla zdecentralizowanych aplikacji.',
    'page-home-subtitle': 'Dzięki Ethereum, możesz tworzyć kod który pozwala utrzymać cyfrową jakość, działa dokładnie tak jak został zaprogramowany i jest dostępny na całym świecie.',
    ...
    'page-home-section-developers-item-one-link': '/developers/#getting-started',
    'page-home-section-developers-item-two': 'Jak tworzyć inteligentne kontrakty?',
    'page-home-section-developers-item-two-link': '/developers/#smart-contract-languages',
