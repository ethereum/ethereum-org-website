...
expect(encodeType('Mail')).to.equal(
...
expect(
  ethUtil.bufferToHex(encodeData(typedData.primaryType, typedData.message))
).to.equal(
...
expect(
  ethUtil.bufferToHex(structHash(typedData.primaryType, typedData.message))
).to.equal('0xc52c0ee5d84264471806290a3f2c4cecfc5490626bf912d01f240d7a274b371e')
expect(
  ethUtil.bufferToHex(structHash('EIP712Domain', typedData.domain))
).to.equal('0xf2cee375fa42b42143804025fc449deafd50cc031ca257e0b194a650a912090f')
expect(ethUtil.bufferToHex(signHash())).to.equal(
  '0xbe609aee343fb3c4b28e1df9e632fca64fcfaede20f02e86244efddf30957bd2'
)
expect(ethUtil.bufferToHex(address)).to.equal(
  '0xcd2a3d9f938e13cd947ec05abc7fe734df8dd826'
)
expect(sig.v).to.equal(28)
expect(ethUtil.bufferToHex(sig.r)).to.equal(
  '0x4355c47d63924e8a72e509b65029052eb6c299d53a04e167c5775fd466751c9d'
)
expect(ethUtil.bufferToHex(sig.s)).to.equal(
