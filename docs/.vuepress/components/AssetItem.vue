<template>
  <div class="asset-item">
    <a :href="imagePath('png')" target="_blank">
      <img class="asset-image" :src="imagePath('png')"/>
    </a>
    <div class="asset-download">
      Download:
      <span v-if="hasFileType('png') === true">
        <a :href="imagePath('png')" target="_blank">PNG</a>
      </span>
      <span v-if="hasFileType('svg') === true">
        /
        <a :href="imagePath('svg')" target="_blank">SVG</a>
      </span>
      <span v-if="hasFileType('jpg') === true">
        /
        <a :href="imagePath('jpg')" target="_blank">JPG</a>
      </span>
    </div>
  </div>
</template>
