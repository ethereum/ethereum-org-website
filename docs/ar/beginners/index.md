...
**ولكن على عكس سلاسل الكُتل الأخرى، يمكن لإيثريوم عمل الكثير.** إيثريوم قابلة للبرمجة، مما يعني أنه يمكن للمطورين استخدامها [لإنشاء أنواع جديدة من التطبيقات](/fa/use/#1-use-an-application-built-on-ethereum) .
...
- [**محافظ عملات مشفرة**](/fa/use/#3-what-is-a-wallet-and-which-one-should-i-use)، تتيح لك إجراء مدفوعات فورية رخيصة باستخدام ETH أو الأصول الأخرى
