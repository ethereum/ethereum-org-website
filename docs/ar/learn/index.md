...
**مرحبا بك في [ethereum.org/ar/learn](/ar/learn/), مجموعة موارد لمساعدتك في تعرف على المزيد عن إيثريوم.** تحتوي هذه الصفحة علي مقالات وإرشادات وموارد تقنية **و** غير تقنية. إذا كنت جديد تمامًا على إيثريوم ، [نقترح عليك أن تبدأ هنا](/ar/beginners/).
