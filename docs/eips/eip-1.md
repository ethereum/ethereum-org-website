...
type: Meta
author:
  Martin Becze <mb@ethereum.org>, Hudson Jameson <hudson@ethereum.org>, and others
...
`eip:` _EIP number_ (this is determined by the EIP editor)
...
`status:` _Draft | Last Call | Accepted | Final | Active | Abandoned | Rejected | Superseded_

`* review-period-end:` _date review period ends_

`type:` _Standards Track | Informational | Meta_

`* category:` _Core | Networking | Interface | ERC_ (Standards Track EIPs only)
