...
좀 더 준비운동이 필요하시다고요? 그럼 [ethereum.org/learn](/learn/)로 들어와 주세요.
...
### 트러플(Truffle) _개발 환경, 테스팅 프레임워크, 빌드 파이프라인(pipeline)과 각종 개발 도구들_

- [홈페이지](https://truffleframework.com/)
- [깃허브](https://github.com/trufflesuite/truffle)

### 엠바크(Embark) _개발환경, 테스트 프레임워크, 이더리움, IPFS, Whisper와 통합된 각종 개발 도구들_
...
### 스릿터(Slither) _파이썬3으로 작성된 솔리디티 정적분석 프레임워크_
...
### 패리티(Parity) _러스트(Rust)언어로 작성된 이더리움 클라이언트_
