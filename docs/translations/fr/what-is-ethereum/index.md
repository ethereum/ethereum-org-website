...
**Mais contrairement aux autres blockchains, Ethereum peut faire beaucoup plus.** Ethereum est programmable, ce qui signifie que les développeurs peuvent l’utiliser pour [construire de nouveaux types d'applications](/use/#1-use-an-application-built-on-ethereum).
...
- [**Portefeuilles de cryptomonnaies**](/use/#3-what-is-a-wallet-and-which-one-should-i-use) qui vous donnent accès à des paiements instantanés et peu coûteux avec ETH ou d'autres actifs&nbsp;
...
- Vous voulez commencer à utiliser Ethereum&nbsp;? [ethereum.org/use](/use/)
- Vous avez envie d'en savoir plus sur Ethereum et sa technologie&nbsp;? [ethereum.org/learn](/learn/)
- Vous êtes un développeur qui cherchez à créer sur Ethereum&nbsp;? [ethereum.org/developers](/developers/)
