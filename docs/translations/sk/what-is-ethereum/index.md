...
**Ethereum však dokáže oveľa viac ako iné blockchainy.** Ethereum je programovateľný, čo znamená, že vývojárom umožňuje [vytvárať nové druhy aplikácií](/use/#1-use-an-application-built-on-ethereum).
...
- [**Kryptomenové peňaženky**](/use/#3-what-is-a-wallet-and-which-one-should-i-use), ktoré umožňujú uskutočňovať lacné a okamžité platby pomocou ETH alebo iných aktív
...
- Chcete začať používať Ethereum? [ethereum.org/use](/use/)
- Chcete sa dozvedieť o Ethereu a jeho technológii viac? [ethereum.org/learn](/learn/)
- Ste vývojárom a chcete programovať na Ethereu? [ethereum.org/developers](/developers/)
