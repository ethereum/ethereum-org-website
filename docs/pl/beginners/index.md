...
** Ale w przeciwieństwie do innych systemów, Ethereum może znacznie więcej. ** Ethereum jest programowalny, co oznacza, że programiści mogą go używać do [budowania nowego rodzaju aplikacji](/use/#1-use-an-application-built-on-ethereum).
...
- [**Portfele z kryptowalutą**](/use/#_3-what-is-a-wallet-and-which-one-should-i-use) które umożliwiają dokonywanie tanich, natychmiastowych płatności za pomocą ETH lub innych aktywów
...
- Chcesz zacząć korzystać z Ethereum? [ethereum.org/pl/use](/use/)
- Chcesz dowiedzieć się więcej o Ethereum i o tym, jak działa? [ethereum.org/pl/learn](/learn/)
- Czy jesteś programistą zainteresowanym budowaniem na ethereum? [ethereum.org/pl/developers](/developers/)
