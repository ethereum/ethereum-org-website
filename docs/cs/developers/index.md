...
### Solidity, _nejpopulárnější jazyk pro Ethereum inspirovaný C++, Pythonem a Javascriptem_
...
### Web3.js, _Javascriptové API pro Ethereum_
...
### Ropsten _Proof of Work blockchain, test-ether can be mined_
