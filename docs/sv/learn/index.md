...
meta:
  - name: description
    content: En uppsättning tekniska och icke-tekniska artiklar, guider och resurser för att lära dig om Ethereum.
  - property: og:title
...
**Välkommen till [ethereum.org/learn](/learn/), en uppsättning resurser som hjälper dig att lära dig mer om Ethereum.** Den här sidan innehåller tekniska **och** icke-tekniska artiklar, guider och resurser. Om du är helt ny inom Ethereum [rekommenderar vi att du börjar här](/beginners/).
...
Förutom informationen på denna sida finns det många gemensamt byggda resurser som är värda att utforska:
...
Nyhet med Ethereum? Dessa artiklar och resurser är ett bra ställe att komma igång.
...
- Vill du lära dig att programmera på Ethereum med smarta kontrakt? [ethereum.org/developers](/developers/)
...
## Bevis på arbete och gruvdrift (mining)
...
## Klienter och noder
Ethereum-nätverket består av många noder, som alla har kompatibel klientprogramvara. Det finns två klienter som används av en majoritet av noder: [Geth](https://geth.ethereum.org/) (skrivet i Go) och [Parity](https://www.parity.io/ethereum/ ) (skriven i Rust).
...
Enterprise Ethereum hänvisar till privata, konsortium och hybridimplementeringar av Ethereum codebase för affärsapplikationer. Företag över hela världen använder redan Enterprise Ethereum för att effektivisera finansmarknaderna, hantera leveranskedjor och skapa nya affärsmodeller.

Läs mer om [Enterprise Ethereum](/enterprise).


## Förbättra Ethereums skalbarhet

Det finns många ansträngningar för att göra Ethereum mer "skalbar" genom att förbättra dess hastighet och totala transaktionsgenomströmning. I allmänhet sorteras dessa i ”Layer 1” och “Layer 2” -lösningar.

"Skikt 1" avser förbättring av det centrala Ethereum-protokollet. Det primära projektet för att förbättra Ethereums kärnprotokoll är [ETH 2.0](./#eth-2-0).

"Layer 2" avser tekniker som är byggda "på toppen" av basen Ethereum-protokollet, vilket möjliggör större skalbarhet utan att äventyra säkerheten. Det finns också "off-chain" -teknologier som sidokedjor, som möjliggör större skalbarhet genom att göra en annan uppsättning säkerhetsutbyten.- [Making Sense of Layer 2](https://medium.com/l4-media/making-sense-of-ethereums-layer-2-scaling-solutions-state-channels-plasma-and-truebit-22cb40dcc2f4) *Feb 12, 2018 - Josh Stark*
...
### Betalning och statliga kanaler
...
ETH 2.0 (även känd som "Serenity") hänvisar till nästa stora uppgradering av kärnan Ethereum-protokollet. Den kombinerar flera förbättringar av Ethereums kärnprotokoll, eller "Layer 1".
...
Kritiska åsikter om Ethereum och krytovalutor.
