...
StorybookJS is a UI tool for isolating UI components their styles and states.
...
> 🚨 NOTE: This will be specified ahead of time by the team which stories should not receive snapshots.
