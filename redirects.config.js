...
module.exports = [
  ...
  ["/developers/learning-tools", "/developers/tools/education-standards/"],
  ["/developers/local-environment", "/developers/tools/"],
  [
    "/developers/tools/interoperability",
    "/developers/tools/network-infrastructure/",
  ],
  ["/developers/tools/transactions", "/developers/tools/app-integration/"],
  ["/developers/tools/analytics", "/developers/tools/network-infrastructure/"],
  ["/developers/tools/education", "/developers/tools/education-standards/"],
  ["/developers/tools/sdks", "/developers/tools/app-integration/"],
  ["/developers/tools/contracts", "/developers/tools/contract-tooling/"],
  ["/developers/tools/security", "/developers/tools/security-testing/"],
