...
module.exports = [
  ...
  ["/developers/docs/scaling/rollups", "/developers/docs/scaling/#rollups", false],
  ["/eth2/get-involved/staking-community-grants", "/staking/"],
  ["/developers/docs/zk", "/zero-knowledge-proofs/", false],
  ...
  ["/%20wallets", "/wallets/", false],
  ["/developers/docs/zk-snarks", "/zero-knowledge-proofs/", false],
  ["/developers/docs/standards/erc-4337", "/roadmap/account-abstraction/", false],
  ["/developers/docs/accounts/aa", "/roadmap/account-abstraction/", false],
  ["/developers/docs/scaling/layer-2", "/developers/docs/scaling/#layer-2-scaling", false],
  ["/developers/docs/account-abstraction", "/roadmap/account-abstraction/", false],
  ["/developers/docs/accounts/abstraction", "/roadmap/account-abstraction/", false],
  ["/developers/docs/rollups", "/developers/docs/scaling/#rollups", false],
  ["/roadmap/future-proofing/:path+", "/roadmap/future-proofing/", false],
  ["/eth2/what-is-eth2", "/roadmap/", false],
  ["/developers/docs/accounts/account-abstraction", "/roadmap/account-abstraction/", false],
  [
    "/developers/docs/consensus-mechanisms/proof-of-stake",
    "/developers/docs/consensus-mechanisms/pos/",
    false,
  ],
  ["/zero-knowledge", "/zero-knowledge-proofs/", false],
  ["/developers/docs/smart-contracts/account-abstraction", "/roadmap/account-abstraction/", false],
  ["/developers/docs/ides/%23web-based-ides", "/developers/docs/", false],
  ["/developers/docs/daos", "/dao/", false],
  [
    "/developers/docs/consensus-mechanisms/pos/slashing",
    "/developers/docs/consensus-mechanisms/pos/rewards-and-penalties/",
    false,
  ],
  ["/wallets/security", "/security/", false],
  ["/developers/docs/sharding", "/developers/docs/data-availability/", false],
  ["/layer-2-scaling", "/layer-2/", false],
  ["/layer-2-scaling/rollups", "/developers/docs/scaling/", false],
  ["/layer-1-scaling/sidechains", "/developers/docs/scaling/sidechains/", false],
  ["/layer-2-scaling/state-channels", "/developers/docs/scaling/state-channels/", false],
  ["/developers/docs/privacy-enhancements", "/privacy/", false],
  ["/developers/docs/wallets", "/wallets/", false],
  ["/blog", "https://blog.ethereum.org", false]
]
