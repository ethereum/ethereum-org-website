...
- **`references/i18n-rtl.md`** -- Load when adding user-facing text, formatting numbers/dates, working with directional spacing, writing translation keys, or authoring an `app/[locale]/` page or `generateMetadata`.
