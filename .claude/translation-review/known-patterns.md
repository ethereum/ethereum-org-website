...
Long transcripts show contiguous blocks of `**Speaker Name:**` bylines left in Latin while surrounding prose is fully translated — a chunk-boundary artifact of the name-substitution pass. Counts from PR #18925 `eip-7805-focil-explained` (85 labels): ja 45 Latin, ko 46, bn 11, ru 10, mr 4, uk 4, hi 3.
...
- **English line 58 is a fleet-wide weak spot:** the FOCIL/`block proposer` sentence drew criticals in ja/tr/uk/zh-tw and warnings in pt-br/sw/mr — 7 of 24 locales fumbled the same sentence.
