    ...
    nextConfig = {
      ...
      outputFileTracingExcludes: {
        "*": [
          ...
          "public/images",
          "public/content",
          // Velite's precompiled MDX output is build-time only -- all pages
          // are statically rendered into .next/server/app/, so the runtime
          // function never reads from .velite/. Excluding it keeps the
          // ~250 MB of per-entry JSONs out of the Netlify function bundle.
          ".velite/**/*",
