    ...
    nextConfig = {
      ...
      outputFileTracingExcludes: {
        "*": [
          ...
          "public/fonts",
          "public/images",
          // Re-exclude public/content here: the .md/.mdx files needed at
          // runtime are added back via netlify.toml [functions].included_files
          // (not via Next tracing), so the function bundle stays within the
          // 250 MB limit even if Next's automatic tracer would otherwise
          // pull additional non-.md assets in.
          "public/content",
