...
const walletMnemonic: ethers.Wallet = ethers.Wallet.fromMnemonic(mnemonic)

// ...or from a private key
const walletPrivateKey: ethers.Wallet = new ethers.Wallet(
  walletMnemonic.privateKey
)

// ...or create a wallet from a random private key
const randomWallet: ethers.Wallet = ethers.Wallet.createRandom()
...
const wallet: ethers.Wallet = walletMnemonic.connect(provider)
