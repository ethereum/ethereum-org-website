    ...
    <Page>
      ...
      <GrayContainer>
        ...
        <ThreeColumnContent>
          <Column>
            <h3>Introductions</h3>
            <Link to="/en/edn/learn/blockchain-basics/">Blockchain basics</Link>
            <p>An introduction to blockchain and Ethereum</p>

            <Link to="/en/edn/learn/dapps/">Intro to dapps</Link>
            <p>An introduction to decentralized applications</p>

            <Link to="/en/edn/learn/web2-vs-web3/">Web2 vs Web3</Link>
            <p>How the web3 world of development is different</p>

            <Link to="/en/edn/learn/programming-languages/">
          ...
          <Column>
            <h3>Fundamentals</h3>
            <Link to="/en/edn/learn/accounts/">Accounts</Link>
            <p>Contracts or people on the network</p>

            <Link to="/en/edn/learn/Transactions/">Transactions</Link>
            <p>The way Ethereum state changes</p>

            <Link to="/en/edn/learn/evm/">
              The Ethereum virtual machine (EVM)
            </Link>
            <p>The computer that processes transactions</p>

            <Link to="/en/edn/learn/gas/">Gas</Link>
            <p>Ether needed to power transactions</p>

            <Link to="/en/edn/learn/blocks/">Blocks</Link>
            <p>Batches of transactions added to the blockchain</p>

            <Link to="/en/edn/learn/block-explorers/">Block explorers</Link>
            <p>Your portal to Ethereum data</p>

            <Link to="/en/edn/learn/mining/">Mining</Link>
            <p>How new blocks are created and consensus is reached</p>

            <Link to="/en/edn/learn/networks/">Networks</Link>
            <p>An overview of mainnet and the test networks</p>

            <Link to="/en/edn/learn/nodes-and-clients/">Nodes and clients</Link>
            <p>How blocks and transactions are verified in the network</p>
          </Column>
          <Column>
            <h3>The stack</h3>
            <Link to="/en/edn/learn/intro-to-stack/">Intro to the stack</Link>
            <p>An introduction to the Ethereum stack</p>

            <Link to="/en/edn/learn/smart-contracts/">Smart contracts</Link>
            <p>The logic behind dapps – self-executing agreements</p>

            <Link to="/en/edn/learn/javascript-client-libraries/">
              Javascript libraries
            </Link>
            <p>Using javascript to interact with smart contracts</p>

            <Link to="/en/edn/learn/security/">Security</Link>
            <p>Security measures to consider during development</p>

            <Link to="/en/edn/learn/storage/">Storage</Link>
            <p>How to handle dapp storage</p>

            <Link to="/en/edn/learn/frameworks/">Development frameworks</Link>
            <p>Tools for helping speed up development</p>

            <Link to="/en/edn/learn/IDEs/">Development environments</Link>
            <p>IDEs that are suitable for dapp development</p>

            <h3>Advanced</h3>
            <Link to="/en/edn/learn/tokens/">Token standards</Link>
            <p>An overview of accepted token standards</p>

            <Link to="/en/edn/learn/oracles/">Oracles</Link>
            <p>Getting off-chain data into your smart contracts</p>

            <Link to="/en/edn/learn/scaling/">Scaling</Link>
