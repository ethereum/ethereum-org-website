...
const BugBountiesPage = ({
  ...
  // It actually works anyway but with this type assertion you can override typescript
  // complaining, since the gatsby autogenerated type is a readonly array and seems like sort method
  // needs write access to the array
