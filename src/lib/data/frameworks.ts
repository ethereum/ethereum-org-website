...
/**
 * Static list of local environment frameworks.
 * This data is combined with dynamic GitHub repo data (starCount, languages)
 * from the data layer to create the full framework information.
 */
