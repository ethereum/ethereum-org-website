...
const getPostSlugs = (dir: string, files: string[] = []) => {
  ...
  const temporalAllowedPages = [
    ...
    "/developers/docs/scaling/optimiums",
    "/developers/docs/scaling/optimiums/architecture",
    "/developers/docs/scaling/optimiums/building",
    "/developers/docs/scaling/optimiums/faq",
    "/developers/docs/scaling/optimiums/comparison",
