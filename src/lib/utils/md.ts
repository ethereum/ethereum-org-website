...
const getPostSlugs = (dir: string, files: string[] = []) => {
  ...
  const temporalAllowedPages = [
    ...
    "/developers/docs/data-and-analytics/extraction-tranformation-example",
    "/developers/docs/data-and-analytics/data-flow",
    "/developers/docs/data-and-analytics/outsourcing-data",
    "/developers/docs/data-and-analytics/data-stacks",
