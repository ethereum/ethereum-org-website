...
- [VMware]([url](https://www.vmware.com/products/blockchain.html))_is bringing Ethereum to the enterprise with VMware Blockchain for Ethereum. VMware is addressing several gaps that make Ethereum platforms difficult to use for enterprise use cases, such as the lack of robust privacy and scalability for complex workloads, governance mechanisms, and enterprise-class operational support characteristics._
