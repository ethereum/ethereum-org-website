...
- [EIP-161](https://eips.ethereum.org/EIPS/eip-161) – _allows for removal of empty accounts addded via the DOS attacks._
...
The DAO fork was in response to the [2016 DAO attack](https://www.coindesk.com/understanding-dao-hack-journalists). A [DAO](/glossary/#dao) contract was drained of over 3.6 million ETH and the fork was implemented to return funds to the accounts that lost them. Some miners refused to fork, out of principle, because it wasn't a defect in the protocol. They went on to form [Ethereum Classic](https://ethereumclassic.org/).
...
Frontier was a live, but barebone implementation of the Ethereum project. It followe the successful Olympic testing phase. It was intended for technical users, specifically developers. [Blocks](/glossary/#block) had a [gas](/glossary/#gas) limit of 5,000. This ‘thawing’ period enabled miners to start their operations and for early adopters to install their clients without having to ‘rush’.
