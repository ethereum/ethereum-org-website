...
Creating and transferring NFTs are just Ethereum transactions - minting, buying, swapping or otherwise interacting with NFTs does not directly consume energy. Since [The Merge](/upgrades/merge), Ethereum is a low-energy blockchain, meaning the environmental impact of using NFTs is negligible.
