...
Decentralized science allows for more diverse funding sources (from [DAOs](/dao/), [quadratic donations](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=2003531) to [crowdfunding](https://mirror.xyz/0xa84C69597C5aF912523a76A66d55f76a3f2FFc84/gUyt_o1KkZH-c3OHU85a8mfmLioNg4_uPHbtoAhcrR8) and more), more accessible access data and methods, and by providing incentives for reproducibility.
...
| ----------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| Distribution of funds is determined by the public using mechanisms such as [quadratic donations](https://twitter.com/Molecule_dao/status/1564133014925361153) or DAOs such as [VitaDAO](http://vitadao.com/).           | Small, closed, centralized groups control the distribution of funds.                                           |
...
| Funding decisions are made online, transparently and in short time. New funding mechanisms are explored.                         | Funding decisions are made with a long turnaround time and limited transparency. Few funding mechanisms exist. |
| Sharing laboratory services is made easier and more transparent using Web3 primitives such as [LabDAO](http://labdao.xyz/).                            | Sharing laboratory resources is often slow and opaque.                                                         |
| New models for publishing can be developed that use Web3 primitives for trust, transparency and universal access. (eg. [ResearchHub](https://www.researchhub.com/), [DeSci Nodes](https://desci.com/nodes)) | You publish through established pathways frequently acknowledged as inefficient, biased and exploitative.      |
| You can earn tokens and reputation for peer-reviewing work (eg. [ResearchHub](https://www.researchhub.com/), [longevity.review](https://longevity.review/))                                                       | Your peer-review work is unpaid, benefiting for-profit publishers.                                             |
| You own the intellectual property (IP) you generate and distribute it according to transparent terms through [IP-NFTs](https://www.molecule.to/blog/molecules-biopharma-ip-nfts-a-technical-description).             | Your home institution owns the IP you generate. Access to the IP is not transparent.                           |
...
- [Dework: Decentralized science bounty board with tasks and rewards from multiple projects](https://app.dework.xyz/hubs/desci)
