...
Aplicațiile blockchain pentru întreprinderi pot fi construite pe <GlossaryTooltip termKey="mainnet">Mainnet-ul</GlossaryTooltip> Ethereum, care este un sistem public fără autorizare sau pe blockchain-uri private bazate pe tehnologia Ethereum. Aflaţi mai multe informații despre [lanțurile private Ethereum pentru întreprinderi](/enterprise/private-ethereum/).
