...
meta:
  - name: description
    content: Guide, risorse e strumenti per lo sviluppo basato su Ethereum.
  - property: og:title
    content: Ethereum per sviluppatori
...
Vuoi iniziare subito a programmare? [Inizia da qui](/build/).

Hai prima bisogno di nozioni di base? Consulta le nostre [risorse per la formazione](/learn/).
...
- [Ethereum per sviluppatori Java](/java/)
- [Ethereum per sviluppatori Python](/python/)
- [Ethereum per sviluppatori JavaScript](/javascript/)
- [Ethereum per sviluppatori Go](/golang/)
- [Ethereum per sviluppatori Rust](/rust/)
- [Ethereum per sviluppatori .NET](/dot-net/)
...
**OneClick Dapp -** **_Genera un frontend direttamente da ABI per sviluppo e test rapidi_**
...
La rete Ethereum è composta da molti nodi che eseguono software client compatibile. La maggior parte di questi nodi usa [Geth](https://geth.ethereum.org/) o [Parity](https://www.parity.io/ethereum/), e in entrambi i casi è possibile modificare le configurazioni in base alle esigenze.
...
**DappUniversity -** **_Imparare a programmare applicazioni decentralizzate sulla blockchain Ethereum_**
