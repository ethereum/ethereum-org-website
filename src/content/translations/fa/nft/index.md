...
مالکیت از طریق شناسه‌ی منحصربه‌فرد (uniqueID) و فراداده مدیریت می‌شود، به طوری‌که هیچ توکن دیگری نمی‌تواند آن را کپی کند. NFTها از طریق قراردادهای هوشمند ضرب می‌شوند که امکان تخصیص مالکیت و مدیریت انتقال مالکیت NFTها را در اختیار ما قرار می‌دهند. هنگامی که شخصی یک NFT ایجاد یا ضرب می‌کند، کد ذخیره شده در قراردادهای هوشمند را اجرا می‌کند که با استانداردهای مختلف مانند [ERC-721](/developers/docs/standards/tokens/erc-721/) مطابقت دارد. این اطلاعات به زنجیره‌ی بلوکی افزوده می‌شود که NFT در آنجا مدیریت می‌شود. فرایند ضرب کردن، از دید کلان، شامل مراحل زیر است:
...
- ایجاد و انتقال NFTها فقط تراکنش‌های اتریوم هستند - آن‌ها هیچ تأثیر مستقیمی بر انرژی مصرف‌شده توسط اتریوم ندارند و به طور مستقل انرژی خود را مصرف نمی‌کنند.
- اتریوم یک زنجیره‌‌ی بلوکی کم‌انرژی است، به این معنی که تأثیر زیست‌محیطی ایجاد کردن، خریدن و انتقال دادن NFT بسیار کم است.

بخش‌های بعدی با کمی جزئیات فنی در این باره بیشتر توضیح می‌دهند...
