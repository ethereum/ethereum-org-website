...
3. پروتکل‌ها – <GlossaryTooltip termKey="smart-contract">قراردادهای هوشمند</GlossaryTooltip> که عملکرد را امکان‌پذیر می‌کنند؛ مثلاً خدمتی که امکان قرض دادن دارایی‌ها را به صورت غیرمتمرکز فراهم می‌کند.
