...
_اگر هیچ‌کس مالک اتریوم نیست، تصمیمات درباره‌ی گذشته و آینده‌ی اتریوم چگونه گرفته می‌شوند؟ حاکمیت اتریوم به فرایندی اطلاق می‌شود که امکان اتخاذ چنین تصمیماتی را فراهم می‌سازد_
