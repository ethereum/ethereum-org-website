...
Kripto para birimi ve blok zinciri teknolojisinin faydalarını kullanan merkezi olmayan uygulamalar (veya "dapp'ler") oluşturmak için Ethereum'u kullanın. Bu dapp'ler güvenilir olabilir, yani Ethereum'a dağıtıldıktan sonra her zaman programlandığı gibi çalışırlar. Yeni tür finansal uygulamalar oluşturmak için dijital varlıkları kontrol edebilirler. Merkeziyetsiz olabilirler, yani tek bir varlık veya kişi onları kontrol etmez ve sansürlemenin neredeyse imkansız olduğu anlamına gelir.
...
## Başlangıç ​​makaleleri {#beginner-articles}
...
- [Ruby ile Blockchain Uygulaması](https://www.nopio.com/blog/blockchain-app-ruby/)
...
- [eth.rb](https://github.com/q9f/eth.rb) - _Ethereum hesaplarını, mesajları işlemek için Ruby kitaplığı ve RPC istemcisi, ve işlemler_
- [keccak.rb](https://github.com/q9f/keccak.rb) - _Ethereum tarafından kullanılan Keccak (SHA3) karma değeri_
...
Daha fazla kaynak mı arıyorsunuz? [Geliştiricilerimizin anasayfasına](/developers/) göz atın.

## Ruby topluluğu katkıda bulunanlar {#ruby-community-contributors}
