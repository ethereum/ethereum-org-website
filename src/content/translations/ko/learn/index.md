...
- [암호경제학을 통한 블록체인 입문서 - Part 1](https://medium.com/blockchain-at-berkeley/introduction-to-blockchain-through-cryptoeconomics-part-1-bitcoin-369f245067f9) _Jan 26, 2018 - Zubin Koticha_
...
- 이더리움 스마트 컨트랙트를 직접 코드로 작성하고 싶다면 다음 링크를 방문해주세요. [ethereum.org/developers](/ko/developers/)
...
- 이더리움 노드를 운영하고 싶으신가요? → [ethereum.org/developers](/ko/developers/#clients-running-your-own-node/)
...
Read more about [Enterprise Ethereum](/ko/enterprise/).
