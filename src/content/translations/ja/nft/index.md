...
NFT の作成と移管は、単なるイーサリアムトランザクションに過ぎず、NFT の作成、購入、スワップ、あるいは NFT の取引が直接エネルギーを消費することはありません。 [マージ](/upgrades/merge)以降、イーサリアムは低エネルギーなブロックチェーンであり、NFT の使用が環境に与える影響はほんのわずかです。
