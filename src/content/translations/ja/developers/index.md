...
すぐにでもコーディングを始めたいですか？ [ここで開発を始めましょう](/build/)。

先により基礎的なことを学びたい人は [学習リソース](/learn/)をチェックしてください。
...
- [Java 開発者のためのイーサリアム](/java/)
- [Python 開発者のためのイーサリアム](/python/)
- [JavaScript 開発者のためのイーサリアム](/javascript/)
- [Go 開発者のためのイーサリアム](/golang/)
- [Rust 開発者のためのイーサリアム](/rust/)
- [.NET 開発者のためのイーサリアム](/dot-net/)
