...
description: Une introduction au Web3 – la prochaine évolution de l’internet – et les raisons de son importance.
lang: fr
---

# Introduction au Web3 {#introduction}

La centralisation a permis à des milliards de personnes d'accéder à Internet et de créer l'infrastructure stable et robuste sur laquelle il repose. Dans le même temps, une poignée d'entités centralisées ont la mainmise sur de larges pans d'Internet, décidant de manière unilatérale de ce qui peut être autorisé ou non.

Le Web3 est la réponse à ce dilemme. Au lieu d'un internet monopolisé par les grandes entreprises technologiques, le Web3 s'inscrit dans une logique de décentralisation et est conçu, exploité et géré par ses utilisateurs. Le Web3 donne le pouvoir aux individus plutôt qu'aux entreprises. Avant de parler du Web3, il faut comprendre comment nous en sommes arrivés là.

<Divider />

## Les débuts d'Internet {#early-internet}

La plupart des gens considèrent l’internet comme un pilier continu de la vie moderne – il a été inventé et existe depuis lors. Cependant, l'internet que la plupart d'entre nous connaissons aujourd'hui est tout à fait différent de ce qui était initialement imaginé. Pour mieux le comprendre, nous pouvons séparer la courte histoire d'internet en deux périodes distinctes — Web 1.0 et Web 2.0.
...
La première mise en place d'Internet, maintenant connu sous le nom de "Web 1.0", a eu lieu à peu près entre 1990 et 2004. Internet Web 1.0 était principalement constitué de sites web statiques appartenant à des entreprises sans aucune interaction entre les utilisateurs. Ces sites produisaient rarement du contenu d'où le nom web en lecture seule.
...
Les prémisses du « Web 3.0 » ont été élaborés par le co-fondateur d'[Ethereum](/what-is-ethereum/) Gavin Wood, peu après le lancement d'Ethereum en 2014. Gavin a mis en mots une solution à un problème que de nombreux premiers crypto-adoptants percevaient : l'internet nécessite trop de confiance. C'est-à-dire que l'essentiel de l'internet que les gens connaissent et utilisent aujourd'hui repose sur la confiance que nous donnons à une poignée de sociétés privées à agir dans l'intérêt du public.
...
L'infrastructure de paiement du Web2 repose sur les banques et les processeurs de paiement, excluant les personnes sans compte bancaire ou des personnes qui vivent dans le mauvais pays. Le Web3 utilise des jetons comme [ETH](/eth/) pour envoyer de l'argent directement depuis un navigateur et ne nécessite pas de tiers de confiance.
...
Des fonctionnalités importantes du Web3, comme Sign-in with Ethereum (siwe), sont déjà disponibles gratuitement pour tout le monde. Mais le coût relatif des transactions reste encore élevé pour beaucoup de personnes. Le Web3 est moins susceptible d'être utilisé dans les pays moins riches et en développement, en raison de frais de transaction élevés. Sur Ethereum, ces défis sont résolus grâce aux [mises à niveau du réseau](/upgrades/) et aux [solutions de passage à l'échelle de niveau 2](/developers/docs/scaling/). La technologie est prête, mais nous avons besoin de plus d'adoption des solutions de niveau 2 pour rendre le Web3 accessible à tous.

### Expérience utilisateur {#user-experience}

La barrière technique à l'entrée dans Web3 est actuellement trop élevée. Les utilisateurs doivent comprendre les problèmes de sécurité, comprendre la documentation technique complexe et naviguer dans des interfaces utilisateur non intuitives. Les [éditeurs de portefeuilles](/wallets/find-wallet/), en particulier, y travaillent, mais davantage d'avancées seront nécessaires pour que le Web3 soit adopté massivement.

### Formation {#education}

Web3 introduit de nouveaux paradigmes qui nécessitent l'apprentissage de modèles mentaux différents de ceux utilisés dans le Web2.0. Un effort éducatif similaire s'est produit alors que le Web1.0 gagnait en popularité à la fin des années 1990. Les partisans de la toile mondiale ont utilisé tout un tas de techniques pour éduquer le public, allant de simples métaphores (autoroutes de l'information, navigateurs, surfer sur le web) jusqu'à des [programmes télévisés](https://www.youtube.com/watch?v=SzQLI7BxfYI). Le Web3 n'est pas difficile, mais il est différent. Les initiatives éducatives informant les utilisateurs du Web2 de ces paradigmes Web3 sont vitales pour son succès.
...
L'écosystème Web3 est jeune et évolue rapidement. En conséquence, il dépend actuellement principalement de l'infrastructure centralisée (GitHub, Twitter, Discord, etc.). De nombreuses entreprises Web3 se précipitent pour combler ces lacunes, mais la construction d'infrastructures fiables et de haute qualité prend du temps.

## Un avenir décentralisé {#decentralized-future}

Web3 est un écosystème jeune et en pleine évolution. Gavin Wood a inventé le terme en 2014, mais bon nombre de ces idées ne sont devenues une réalité que récemment. Par exemple, l'année dernière a connu une augmentation considérable de l'intérêt pour la cryptomonnaie, des améliorations des solutions de passage à l'échelle de niveau 2, des expériences massives avec de nouvelles formes de gouvernance et des révolutions de l'identité numérique.

Nous sommes seulement au début de la création d'un meilleur internet avec Web3, mais grâce aux améliorations continues de son infrastructure, l'avenir d'Internet est très prometteur.
...
Le Web3 n’est pas strictement défini. Plusieurs participants de la Communauté ont des points de vue différents à ce sujet. En voici quelques-uns :
