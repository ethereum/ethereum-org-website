...
description: Apprendre à développer sur Ethereum avec des projets et des outils basés sur Ruby.
lang: fr
sidebar: true
incomplete: false
---

<div class="featured">Apprendre à développer sur Ethereum avec des projets et des outils basés sur Ruby.</div>
...
- [Comprendre les comptes Ethereum](https://dev.to/q9/finally-understanding-ethereum-accounts-1kpe)
- [Authentifier les utilisateurs Rails avec MetaMask](https://dev.to/q9/finally-authenticating-rails-users-with-metamask-3fj)
- [Connexion avec Ethereum - La bibliothèque Ruby et version d'exemples de Rails](https://blog.spruceid.com/sign-in-with-ethereum-ruby-library-release-and-rails-examples/)
...
- [Comment générer une nouvelle adresse Ethereum avec Ruby](https://www.quicknode.com/guides/web3-sdks/how-to-generate-a-new-ethereum-address-in-ruby)
...
- [keccak.rb](https://github.com/q9f/keccak.rb) - _Le hachage de Keccak (SHA3) utilisé par Ethereum_
...
- [siwe-rails-examples](https://github.com/spruceid/siwe-rails-examples) - _Exemple SIWE utilisant Ruby sur Rails avec contrôleur personnalisé_
- [omniauth-siwe](https://github.com/spruceid/omniauth-siwe) - _Stratégie OmniAuth pour se connecter avec Ethereum (SIWE)_
- [omniauth-nft](https://github.com/valthon/omniauth-nft) - _Stratégie OmniAuth pour l'authentification via NFT_
- [ethereum-on-rails](https://github.com/q9f/ethereum-on-rails) - _Template Ethereum sur le modèle Rails qui permet la connexion de MetaMask à Ruby on Rails_
...
- [ethereum_tree](https://github.com/longhoangwkm/ethereum_tree) - _Bibliothèque Ruby pour générer des adresses ETH à partir d'un portefeuille Hierarchical Deterministic selon le standard BIP32_
- [etherlite](https://github.com/budacom/etherlite) - _Intégration Ethereum pour Ruby on Rails_
- [ethereum. b](https://github.com/EthWorks/ethereum.rb) - _Client Ruby Ethereum utilisant l'interface JSON-RPC pour envoyer des transactions, la création et l'interaction avec les contrats ainsi que la boîte à outils utile pour travailler avec les nœuds Ethereum_
...
Le groupe [Telegram Ethereum Ruby](https://t.me/ruby_eth) héberge une Communauté en pleine croissance et est la ressource dédiée aux discussions sur les projets énoncés ci-dessus et sur des sujets connexes.
