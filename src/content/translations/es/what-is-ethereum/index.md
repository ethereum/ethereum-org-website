...
**Pero a diferencia de otros blockchains, Ethereum puede hacer mucho más.**Ethereum es programable, lo que significa que los desarrolladores pueden usarlo para [construir nuevos tipos de aplicaciones.](/es/dapps/).
...
- [**Billeteras de criptomonedas**](/es/wallets/) que te permiten hacer pagos baratos e instantáneos con ETH u otros activos
...
- ¿Quieres empezar a usar Ethereum? [ethereum.org/dapps](/es/dapps/)
- ¿Tienes curiosidad de aprender más acerca de Ethereum y su tecnología? [ethereum.org/learn](/es/learn/)
- ¿Eres un desarrollador interesado en construir sobre Ethereum? [ethereum.org/developers](/es/developers/)
