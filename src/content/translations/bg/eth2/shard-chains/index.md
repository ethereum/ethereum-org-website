...
summaryPoint1: Разделянето на компоненти представлява многоетапна надстройка за подобряване на мащабирумостта и възможностите на Ethereum.
...
С времето се добавят допълнителни компоненти, а основната мрежа на Ethereum вече ще бъде осигурена от Сигналната верига чрез употребата на доказателство за залог. Това дава възможност на една ползотворна основна мрежа да изгражда вериги от компоненти, захранвана от решенията на ниво 2, които допълнително зареждат разширяването.
