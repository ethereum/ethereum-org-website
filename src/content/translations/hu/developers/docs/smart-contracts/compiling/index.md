...
Ahhoz, hogy az [EVM](/developers/docs/evm/) le tudja futtatni a szerződésedet, **bytecode-ban** kell lennie. A fordítás ezt:
...
## Web alkalmazások {#web-applications}

A fordító ezenkívül létrehozza az **Application Binary Interface-t (ABI)**, amire szükséged lesz, hogy az alkalmazásod megértse a szerződést és meg tudja hívni a szerződés függvényeit.
