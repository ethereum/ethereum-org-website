...
3. Протоколы: <GlossaryTooltip termKey="smart-contract">умные контракты</GlossaryTooltip>, которые предоставляют функциональные возможности, например сервис, позволяющий децентрализовать кредитование активов.
