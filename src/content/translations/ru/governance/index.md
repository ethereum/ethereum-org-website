...
Когда Beacon Chain объединится с исполнительным уровнем Ethereum, процесс управления предложениями изменений будет гармонизирован. Этот процесс реализации слияния [уже идет](https://github.com/ethereum/EIPs/pull/3675).
