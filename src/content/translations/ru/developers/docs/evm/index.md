...
Физический инстанс EVM нельзя описать также, как другие физические объекты вроде облака или океанской волны. Виртуальная машина Ethereum _существует_ как единое целое благодаря тысячам компьютеров, подключенных к клиенту Ethereum.
