...
- Создание и передача NFT — это просто транзакции Ethereum, они не оказывают прямого влияния на энергию, израсходованную Ethereum, или же они самостоятельно расходуют собственную энергию.
- Ethereum является блокчейном с низким энергопотреблением, то есть влияние NFT на окружающую среду очень невелико.

В следующих разделах приведено дальнейшее объяснение с небольшими техническими подробностями...
...
Все эти задачи выполняются производителями блоков и валидаторами. Блокирующие предложения добавляют NFT-транзакцию в блок и транслируют ее в остальную сеть. Валидаторы проверяют корректность транзакции и добавляют ее в свои базы данных. Существует множество криптовалютных стимулов, чтобы убедиться, что валидаторы действуют честно. В противном случае любой может просто заявить, что владеет NFT, который вы только что отчеканили, и обманным путем передать право собственности.

#### Безопасность NFT {#nft-security}

Безопасность Ethereum исходит из доказательства владения. Система подразумевает экономическое сдерживание злонамеренных действий, что обеспечивает неуязвимость Ethereum. Благодаря этому NFT могут существовать. Как только блок, содержащий вашу NFT-транзакцию, будет закончен, его изменение потребует от злоумышленника миллионов ETH. Любой, кто использует программное обеспечение Ethereum, сразу же сможет обнаружить нечестную подделку NFT, и плохая сторона будет наказана экономически и будет удалена.
