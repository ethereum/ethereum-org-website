...
Это будет означать конец доказательства работы для Ethereum и начало эры более устойчивого, экологически чистого Ethereum. Learn more about [Ethereum energy consumption](/energy-consumption/).
...
После объединения Eth1 и Eth2 в единую цепочку больше не будет двух отдельных сетей Ethereum; Ethereum станет единым.
...
### Слияние и Beacon Chain {#merge-and-beacon-chain}
