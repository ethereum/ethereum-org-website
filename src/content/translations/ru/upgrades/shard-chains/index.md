...
<UpgradeStatus dateKey="page-upgrades-shards-date">
    Цепочки-осколки должны быть запущены где-то в 2023 году в зависимости от того, как быстро продвигается работа после запуска <a href="/upgrades/beacon-chain/">Beacon Chain</a>. Эти осколки дадут Ethereum больше возможностей для хранения и доступа к данным, но они не будут использоваться для выполнения кода. Подробности пока прорабатываются.
</UpgradeStatus>
...
[Подробнее о сворачивании](/developers/docs/scaling/#rollups)
</InfoBanner>
