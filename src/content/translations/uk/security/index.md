...
![Шахрайство, пов’язане зі службою підтримки в Discord](./discordScam.png)
...
### Шахрайство, пов’язане з пулом для майнингу {#mining-pool-scams}
...
Оскільки у 2022 році відбудеться [об’єднання](/roadmap/merge/), шахраї користуються плутаниною навколо терміна «Eth2» і намагаються змусити користувачів обміняти ETH на токен «ETH2». Жодних «ETH2» або будь-яких інших нових токенів не буде представлено після об’єднання. Токени ETH, якими ви володієте сьогодні, залишаться такими самими ETH після об’єднання. Вам не потрібно обмінювати ETH через об’єднання.
