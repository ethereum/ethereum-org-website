...
- Створення та передача NFT є лише транзакціями Ethereum — вони не мають прямого впливу на енергію, що витрачається Ethereum, і самостійно не витрачають власну енергію.
- Ethereum є низькоенергетичним блокчейном, що означає, що вплив на навколишнє середовище при створенні, купівлі та передачі NFT дуже малий.

Наступні розділи пояснюють далі з трохи більшою технічною деталізацією...
...
Всі ці завдання виконують виробники та валідатори блоків. Організатори блоку додають вашу NFT-транзакцію в блок і транслюють решті мережі. Валідатори перевіряють, чи є транзакція дійсною, а потім додають її до своїх баз даних. Існує багато криптоекономічних стимулів, щоб переконатися, що валідатори діють чесно. Інакше будь-хто може заявити, що він володіє щойно викарбуваними вами NFT, і шахрайським шляхом передати право власності.

#### Безпека NFT {#nft-security}

Безпека Ethereum ґрунтується на доказі частки. Система покликана економічно дестимулювати зловмисні дії, роблячи Ethereum стійкою до підробок. Це те, що робить NFT можливими. Після того як блок, що містить вашу NFT-транзакцію, стане фіналізованим, зловмиснику буде коштувати мільйони ETH, щоб змінити його. Кожен, хто працює з програмним забезпеченням Ethereum, зможе негайно виявити нечесне втручання в NFT, а зловмисник буде економічно покараний і викинутий.

Проблеми безпеки, пов’язані з NFT, найчастіше пов’язані із фішинговими шахрайствами, вразливістю смартконтрактів або помилками користувачів (наприклад, ненавмисне розкриття приватних ключів), що робить належну безпеку гаманців критично важливою для власників NFT.
