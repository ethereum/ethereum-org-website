...
Створення та передавання NFT — це просто транзакції Ethereum; карбування, купівля, обмін токенів NFT або взаємодія з ними безпосередньо не споживає енергію. З моменту [об’єднання](/upgrades/merge) Ethereum є блокчейном із низьким споживанням енергії. Це означає, що вплив використання токенів NFT на довкілля є незначним.
