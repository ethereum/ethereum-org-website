...
3. Протоколи. <GlossaryTooltip termKey="smart-contract">Розумні контракти</GlossaryTooltip> забезпечують надання послуг, як-от децентралізоване вкладення активів.
