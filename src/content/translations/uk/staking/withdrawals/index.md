...
<ExpandableCard
title="Що буде, якщо я беру участь у деривативах із ліквідним стейкінгом або в об’єднаному стейкінгу"
eventCategory="FAQ"
eventAction="What if I participate in liquid staking derivatives or pooled staking"
eventName="read more">

Якщо ви є частиною <a href="/staking/pools/">пулу стейкінгу</a> чи маєте ліквідні деривативи стейкінгу, вам слід звернутися до свого постачальника для отримання докладнішої інформації про те, як відбуваються виведення стейкінгу, оскільки кожна послуга працює по-різному.
