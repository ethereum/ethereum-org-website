...
箭形冰川网络升级将[难度炸弹](/glossary/#difficulty-bomb)延迟数月。 这是此次升级中唯一的更改，其性质类似于 [缪尔冰川](#muir-glacier) 升级。 [拜占庭](#byzantium)、[君士坦丁堡](#constantinople)和[伦敦](#london)网络升级也做了类似的更改。
...
<ExpandableCard title="箭形冰川升级以太坊改进提案" contentPreview="Official improvements included in this upgrade.">

- [EIP-4345](https://eips.ethereum.org/EIPS/eip-4345) – _将难度炸弹推迟到 2022 年 6 月_

</ExpandableCard>

#### <Emoji text=":police_car_light:" size={1} mr="0.5rem" />节点操作 {#arrow-glacier-node-operators}

请务必在 2021 年 12 月 5 日之前将您的客户端软件升级到最新版本，以应对可变的区块时间。 这将有助于避免您的客户端同步到预分叉链，从而导致无法发起付款或者正确验证交易。

---

### 天鹰座 {#altair}

<Emoji text=":calendar:" size={1} mr={"0.5rem"} mb={"0.5rem"} /><code>世界标准时间 2021 年 10 月 27 日上午 10 点 56 分 23 秒</code><br /> <Emoji text=":bricks:" size={1} mr={"0.5rem"} mb={"0.5rem"} />时段号：<a href="https://etherscan.io/block/11052984">74,240</a><br /> <Emoji text=":money_bag:" size={1} mr={"0.5rem"} mb={"0.5rem"} />以太币价格：4024 美元<br /> <Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <a href="https://web.archive.org/web/20201104235727/https://ethereum.org/en/">网站时光机上的 ethereum.org</a>

#### 概览 {#altair-summary}

天鹰座升级是对[信标链](/upgrades/beacon-chain)按计划进行的第一次升级。 该升级增加了对“同步委员会”的支持 — 启用轻客户端，并将验证器的不活跃的削减处罚提高到其全部价值。
...
天鹰座升级是第一个有确切发布时间的重大网络升级。 之前的每次升级都基于工作量证明链上声明的一个区块编号，区块时间各不相同。 信标链不需要解析工作量证明，而是在一个基于时间的时段系统上工作，该系统由 32 个 12 秒的“时隙”组成，验证者可以在其中推举区块。 如此我们就能确切知道何时能达到时段 74,240，以及天鹰座升级何时生效！
...
- [您是去中心化应用的开发者吗？ 请务必升级您的库和工具包。](https://github.com/ethereum/execution-specs/blob/master/network-upgrades/london-ecosystem-readiness.md)
- [请阅读以太坊基金会公告](https://blog.ethereum.org/2021/07/15/london-mainnet-announcement/)
- [请阅读以太坊牧猫人组织的解释](https://medium.com/ethereum-cat-herders/london-upgrade-overview-8eccb0041b41)
...
- [请阅读以太坊牧猫人组织的解释](https://medium.com/ethereum-cat-herders/the-berlin-upgrade-overview-2f7ad710eb80)

<ExpandableCard title="柏林升级以太坊改进提案" contentPreview="Official improvements included in this upgrade.">
...
<Emoji text=":calendar:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <code>世界标准时间 2020 年 10 月 14 日上午 9 点 22 分 52 秒 </code><br /> <Emoji text=":bricks:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> 区块号：<a href="https://etherscan.io/block/11052984">11,052,984</a><br /> <Emoji text=":money_bag:" size={1} mr={"0.5rem"} mb={"0.5rem"} />以太币价格：379.04 美元<br /> <Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /><a href="https://web.archive.org/web/20201104235727/https://ethereum.org/en/">网站时光机上的 ethereum.org</a>

#### 概览 {#deposit-contract-summary}

质押合约将[质押](/glossary/#staking)引入以太坊生态系统。 虽然这是一个[主网](/glossary/#mainnet)合约，但它直接影响了[信标链](/upgrades/beacon-chain/)的发布时间，这是[以太坊升级](/upgrades/)的重要部分。
...
<Emoji text=":calendar:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <code>世界标准时间 2020 年 1 月 2 日上午 8 点 30 分 49 秒 </code><br /> <Emoji text=":bricks:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> 区块号：<a href="https://etherscan.io/block/9200000">9,200,000 </a><br /> <Emoji text=":money_bag:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> 以太币价格：127.18 美元<br /> <Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <a href="https://web.archive.org/web/20200103093618/https://ethereum.org/">网站时光机上的 ethereum.org</a>

#### 概览 {#muir-glacier-summary}

缪尔冰川分叉使[难度炸弹](/glossary/#difficulty-bomb)延迟。 增加[工作量证明](/developers/docs/consensus-mechanisms/pow/)共识机制的区块难度可能会增加发送交易和使用去中心化应用的等待时间，从而降低以太坊的可用性。

- [请阅读以太坊基金会公告](https://blog.ethereum.org/2019/12/23/ethereum-muir-glacier-upgrade-announcement/)
- [请阅读以太坊牧猫人组织的解释](https://medium.com/ethereum-cat-herders/ethereum-muir-glacier-upgrade-89b8cea5a210)

<ExpandableCard title="缪尔冰川升级以太坊改进提案" contentPreview="Official improvements included in this fork.">

- [EIP-2384](https://eips.ethereum.org/EIPS/eip-2384) – _将难度炸弹再推迟 4,000,000 个区块或 ~611 天。_
...
- 提高拒绝服务攻击的弹性。
- 使基于简洁的非交互式知识论证和可扩展的透明知识论证的[第二层扩容](/developers/docs/scaling/#layer-2-scaling)解决方案性能更佳。
- 使以太坊和 Zcash 能够互用。
- 让合约能够引入更具创造性的功能。

[请阅读以太坊基金会公告](https://blog.ethereum.org/2019/11/20/ethereum-istanbul-upgrade-announcement/)

<ExpandableCard title="伊斯坦布尔升级以太坊改进提案" contentPreview="Official improvements included in this fork.">

- [EIP-152](https://eips.ethereum.org/EIPS/eip-152) – _使以太坊能够和 Zcash 之类的隐私币互操作._
- [EIP-1108](https://eips.ethereum.org/EIPS/eip-1108) – _使用更高效的算法来优化 (/glossary/#gas) 费用._
- [EIP-1344](https://eips.ethereum.org/EIPS/eip-1344) – _通过增加 `CHAINID` [opcode](/developers/docs/ethereum-stack/#ethereum-virtual-machine)来保护以太坊免受中继攻击._
- [EIP-1884](https://eips.ethereum.org/EIPS/eip-1884) – _通过优化操作码来平衡 [gas](/glossary/#gas) 费用和资源消耗._
- [EIP-2028](https://eips.ethereum.org/EIPS/eip-2028) – _减少 CallData 的 (/glossary/#gas) 费用，使区块中可容纳更多数据 – 有益于 [二层的扩展](/developers/docs/scaling/#layer-2-scaling)._
- [EIP-2200](https://eips.ethereum.org/EIPS/eip-2200) – _一种新的 (/glossary/#gas) 费用的测量方式._
...
- 使[难度炸弹](/glossary/#difficulty-bomb)延迟一年。
- 增加了调用其他合约，但不改变状态的能力。
- 增加了某些加密方法，可实现[第二层扩容](/developers/docs/scaling/#layer-2-scaling)。
...
- [EIP-658](https://eips.ethereum.org/EIPS/eip-658) – _为交易收据添加状态字段，以指明成功还是失败。_
...
- [EIP-649](https://eips.ethereum.org/EIPS/eip-649) – _使 [难度炸弹](/glossary/#difficulty-bomb) 延迟 1 年，并将区块奖励从 5 ETH 削减为 3 ETH。_
...
- [EIP-170](https://eips.ethereum.org/EIPS/eip-170) – _将区块链上合约可以具有的最大代码大小更改为 24576 个字节。_
...
- [EIP-158](https://eips.ethereum.org/EIPS/eip-158) – _通过移除大量空帐户来减小状态大小，由于早期版本以太坊协议中的缺陷，这些帐户以非常低的成本置于相应状态。_
...
<Emoji text=":calendar:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <code>世界标准时间 2016 年 7 月 20 日下午 1 点 20 分 40 秒</code><br /> <Emoji text=":bricks:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> 区块号：<a href="https://etherscan.io/block/1920000">1,920,000</a><br /> <Emoji text=":money_bag:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> 以太币价格：12.54 美元<br /> <Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <a href="https://web.archive.org/web/20160803215306/https://ethereum.org/">网站时光机上的 ethereum.org</a>

#### 概览 {#dao-fork-summary}

去中心化自治组织分叉是为了解决 [2016 去中心化自治组织攻击](https://www.coindesk.com/markets/2016/06/25/understanding-the-dao-attack/)，当时，一个不安全的[去中心化自治组织](/glossary/#dao)合约被黑客盗走了超 360 万 ETH。 此分叉将资金从有问题的合约转移到一个[新的合约](https://etherscan.io/address/0xbf4ed7b27f1d666546e30d74d50d173d20bca754)，新合约只有一个功能：取款。 任何损失资金的人都可以从他们的钱包取款，每 100 个 DAO 代币提取 1 ETH。

此操作是由以太坊社区投票决定的。 任何 ETH 持有人都能够通过一个交易在[一个投票平台](http://v1.carbonvote.com/)进行投票。 分叉的决定获得了 85% 以上的投票。

部分矿工拒绝分叉，因为 DAO 事件并不是协议中的一个缺陷。 他们继续组建[以太坊经典](https://ethereumclassic.org/)。
...
<Emoji text=":calendar:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <code>世界标准时间 2016 年 3 月 14 日下午 6 点 49 分 53 秒</code><br /> <Emoji text=":bricks:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> 区块号：<a href="https://etherscan.io/block/1150000">1,150,000</a><br /> <Emoji text=":money_bag:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> 以太币价格：12.50 美元<br /> <Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <a href="https://web.archive.org/web/20160313203843/https://www.ethereum.org/">网站时光机上的 ethereum.org</a>

#### 概览 {#homestead-summary}

展望未来的“家园”分叉。 其中包括几项协议修改和网络变更，使以太坊能够进一步进行网络升级。

[请阅读以太坊基金会公告](https://blog.ethereum.org/2016/02/29/homestead-release/)

<ExpandableCard title="家园升级以太坊改进提案" contentPreview="Official improvements included in this fork.">

- [EIP-2](https://eips.ethereum.org/EIPS/eip-2) – _编辑合约创建流程_
- [EIP-7](https://eips.ethereum.org/EIPS/eip-7) – _添加新的操作码：“DELEGATECALL”_
- [EIP-8](https://eips.ethereum.org/EIPS/eip-8) – _介绍 devp2p 向前兼容性要求_
...
<Emoji text=":calendar:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <code>世界标准时间 2015 年 7 月 30 日下午 3 点 26 分 13 秒</code><br /> <Emoji text=":bricks:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> 区块号：<a href="https://etherscan.io/block/0">0</a><br /> <Emoji text=":money_bag:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> 以太币价格：不适用<br /> <Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <a href="https://web.archive.org/web/20150802035735/https://www.ethereum.org/">网站时光机上的 ethereum.org</a>

#### 概览 {#frontier-summary}

"边境"是以太坊项目的最初版本，但在上面能做的事情很少。 它在成功完成“奥林匹克”测试阶段之后发布。 它面向技术用户，特别是开发者。 每个[区块](/glossary/#block)有 5,000 的[燃料](/glossary/#gas)限制。 该“解冻”期使矿工能够开始工作，并使早期采用者能够从容安装客户端，无需“匆忙”行事。
...
<Emoji text=":calendar:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> 2014 年 7 月 22 日 - 9 月 2 日<br /> <Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <a href="https://web.archive.org/web/20140804235628/https://www.ethereum.org/">返回 ethereum.org</a>

以太币预售期为 42 天。 您可以使用比特币进行购买。
...
Gavin Wood 博士撰写的黄皮书，是以太坊协议的技术定义。
