...
非同质化代币一次只能有一个所有者。 通过唯一的 ID 和其他代币无法复制的元数据管理所有权。 非同质化代币通过智能合约铸造，智能合约分配非同质化代币的所有权并管理它们的可转让性。 有人创建或铸造非同质化代币时，他们会执行存储在符合不同标准的智能合约中的代码，如 ERC-721。 此信息会添加到正在管理非同质化代币的区块链中。 从高层次来看，铸造过程具有以下步骤：
...
非同质化代币越来越受欢迎，这意味着它们受到的监管也日益增强 - 特别是碳足迹。
...
### 不要将其归咎于非同质化代币 {#nft-qualities}

整个非同质化代币生态系统行之有效，得归功于以太坊的去中心化特性与安全性。

去中心化意味着您和其他任何人都可以证明您拥有某件东西。 所有这些都不需要信任或将监管权授予可以随意强加规则的第三方。 这也意味着您的非同质化代币可在许多不同的产品和市场间流通。

安全性意味着任何人都不能复制/粘贴或偷窃您的非同质化代币。
...
所有这些任务都由矿工完成。 他们让整个网络上的其他人了解您的非同质化代币并知道谁拥有它。 这意味着采矿需要有足够的难度，否则任何人都可以声称他们拥有您刚刚铸造的非同质化代币，并利用欺诈手段转移所有权。 有很多激励措施可以确保矿工诚实行事。
...
这对于以太坊的防篡改机制来说至关重要，这是使非同质化代币成为现实的特性之一。 区块越多越安全。 如果您的非同质化代币是在第 600 个区块中创建的，而黑客试图通过修改其数据来窃取您的非同质化代币，那么所有后续区块的数字指纹将发生变化。 这意味着任何运行以太坊软件的人都能够立即发现并阻止其发生。

然而，这也意味着我们需要持续不断地消耗算力。 这也意味着，一个包含 0 个非同质化代币交易的区块仍会产生大致相同的碳足迹，因为创建它仍会消耗算力。 其他非非同质化代币交易将填充区块。

#### 区块链现在属于能源密集度型 {#blockchains-intensive}

是的，通过挖矿创造区块会产生碳足迹，这对比特币等链来说也是一个问题，但直接责任并不在非同质化代币。

大量挖矿使用可再生能源或边远地区未开发的能源。 还有一种说法，非同质化代币和加密货币所颠覆的行业本身也有巨大的碳足迹。 但我们不能仅仅因为现有产业的糟糕表现就放弃自身努力。

我们也是如此。 以太坊正在不断发展，使自身（凭借非同质化代币）更加节能。 而这一直是我们计划的一部分。
...
我们可以用这个来对比未来的以太坊和 Visa 这样的全球服务。 100,000 次 Visa 交易使用的能量为 149 千瓦时<sup>[^2]</sup>。 在 PoS 中，相同数量的交易会消耗 17.4 千瓦时的能量，约占总能量的 11%<sup>[^3]</sup>。 这还没有考虑到共识层与分片链同时进行的许多优化工作，比如[卷叠](/glossary/#rollups)。 100,000 笔交易的能耗可能只有 0.16666667 千瓦时。
...
这个过程已经开始了。 [信标链](/upgrades/beacon-chain/)，在 2020 年 12 月上线。 这允许质押人能够参与网络，为权益质押奠定了基础。 与能效有关的下一步措施便是把当前的链合并，从当前由矿工保护的链，合并到不需要挖矿的信标链中。 目前还不能明确具体的时间节点，但估计这将在 2022 年的某个时候发生。 这个过程被称为合并（以前称为对接）。 [关于合并的更多信息](/upgrades/merge/)。
...
大多数非同质化代币使用同一套标准建立，那就是 [ERC-721](/developers/docs/standards/tokens/erc-721/)。 然而，还有其他的标准，您可能也想研究一下。 [ERC-1155](https://blog.enjincoin.io/erc-1155-the-crypto-item-standard-ac9cf1c5a226) 标准允许半同质化代币，这在游戏领域特别有用。 最近还提出了 [EIP-2309](https://eips.ethereum.org/EIPS/eip-2309)，这使得制作非同质化代币更高效。 这个标准让您在一次交易中尽情铸币！
...
这解释了我们如何得出上述能源估算。 这些估算值适用于整个网络，而不仅仅是保留给创建、购买或出售非同质化代币的流程。
