...
有机会在[在技术栈的所有级别](/developers/docs/ethereum-stack/)（或接近）使用 JavaScript。

## Javascript 和以太坊的交互 {#interact-with-ethereum}

### JavaScript API 库 {#javascript-api-libraries}

如果您想要写入 JavaScript 来查询区块链，发送交易和更多 最方便的方法是使用 [JavaScript API 库](/developers/docs/apis/javascript/)。 这些 API 允许开发者方便地与[以太坊网络节点](/developers/docs/nodes-and-clients/)交互。
...
发掘最让你感兴趣的： [EthereumJS repo](https://github.com/ethereumjs)
