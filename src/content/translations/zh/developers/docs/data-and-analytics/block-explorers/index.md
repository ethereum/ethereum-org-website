...
你应该理解以太坊的基本概念，以便你能够理解区块浏览器向您展示的数据。 从这开始[介绍以太坊](/developers/docs/intro-to-ethereum/)。
...
如果你不熟悉 Eth2，请查看[我们 Eth2 升级概述](/eth2/) 。
...
- [Etherscan](https://etherscan.io/) - 一个你可以用来获取以太坊主网、Ropsten Testnet、Kovan Testnet、Rinkeby Testnet 和 Goerli Testnet 数据的区块浏览器。
