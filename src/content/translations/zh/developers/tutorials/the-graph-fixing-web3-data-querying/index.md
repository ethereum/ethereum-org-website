...
![GraphQL API与REST API](./graphql.jpg)<!-- TODO gif embed not working: --><!-- Need additional plugin? https://github.com/gatsbyjs/gatsby/issues/7317#issuecomment-412984851 --><!-- !\[GraphQL example query GIF\](./graphql-query.gif) --><img src="" width="100%" />
