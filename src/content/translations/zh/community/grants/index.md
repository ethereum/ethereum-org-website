...
- [DAO 资助](https://docs.google.com/spreadsheets/d/1XHc-p_MHNRdjacc8uOEjtPoWL86olP4GyxAJOFO0zxY/edit#gid=0) - _提供赠款的组织的 Google 电子表单_

## 特定项目 {#project-specific}

这些项目为旨在开发和实验自己技术的项目建立了自己的资助。

- [Aave 资助计划](https://aavegrants.org/) – _[Aave](https://aave.com/)赠款 DAO_
- [Balancer](https://forms.gle/c68e4fM7JHCQkPkN7) – _[Balancer](https://balancer.fi/) 生态系统基金_
- [Compound 补助计划](https://compoundgrants.org/) – _[Compound](https://compound.finance/) 金融生态系统_
- [Consensys 资助计划](https://consensys.net/grants/) – _[ Consensys](https://consensys.net/) 区块链融资& 以太坊赠款_
- [dYdX 资助计划](https://dydxgrants.com/) – _[dYdX](https://dydx.exchange/) 去中心化交易所_
- [Lido Ecosystem 生态系统资助组织 (LEGO)](https://lego.lido.fi/) – _[Lido](https://lido.fi/) 金融生态系统_
