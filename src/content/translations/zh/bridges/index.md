...
_Web3 已经发展成为一个由一层网络区块链和二层网络扩展解决方案组成的生态系统，每个解决方案都具有独特的功能和权衡。 随着区块链协议的增加，[跨链转移资产的需求](<https://dune.xyz/eliasimos/Bridge-Away-(from-Ethereum)>)也随之增加。为了满足这一要求，我们需要桥梁。_
...
你来自美国，正计划去欧洲旅行。 你有美元，但你需要欧元去消费。 为了将你的美元兑换成欧元，你可以使用货币汇兑并支付少量费用。

但是，如果你想使用不同的区块链进行类似的兑换，您会怎么做？ 假设你想用以太坊主网的以太币兑换 [Arbitrum](https://arbitrum.io/) 上的以太币。 就像我们为获得欧元进行的货币兑换一样，我们需要一种机制将我们的以太币从以太坊转移到 Arbitrum。 桥梁使这种交易成为可能。 在本例中，[Arbitrum 有一个原生桥梁](https://bridge.arbitrum.io/)，可以将以太币从主网转移到 Arbitrum。
...
假设你想拥有原生比特币 (BTC)，但你只有以太坊主网上的资金。 要在以太坊上接触比特币，你可以购买包装以太币 (WBTC)。 然而，包装以太币是以太坊网络原生的 ERC-20 代币，这意味着它是比特币的以太坊版本，而不是比特币区块链上的原始资产。 要拥有原生以太币，你必须使用桥梁将你的资产从以太坊连接到比特币。 这将连接你的包装以太币并将其转换为原生以太币。 或者，你可能拥有以太币并希望在以太坊去中心化金融协议中使用。 这将需要以另一种方式桥接，从比特币到包装比特币，然后可以将其作为以太坊上的资产使用。
...
- **信任假设**：通过在系统中添加外部验证节点来摆脱底层域的安全性，从加密经济学的角度来说，这降低了安全性。
