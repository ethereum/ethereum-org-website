...
假设你想拥有原生比特币 (BTC)，但你只有以太坊主网上的资金。 要在以太坊上接触比特币，你可以购买包装比特币 (WBTC)。 然而，包装比特币是以太坊网络原生的 ERC-20 代币，这意味着它是比特币的以太坊版本，而不是比特币区块链上的原始资产。 要拥有原生比特币，你必须使用桥梁将你的资产从以太坊连接到比特币。 这将连接你的包装比特币并将其转换为原生比特币。 或者，你可能拥有比特币并希望在以太坊去中心化金融协议中使用。 这将需要以另一种方式桥接，从比特币到包装比特币，然后可以将其作为以太坊上的资产使用。
