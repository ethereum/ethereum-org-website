...
This is a limited glossary of technical and non-technical terms that relate to the Ethereum ecosystem.
...
## Contract account {#contract-accounts}
...
## Re-entrancy attack {#reentrancy-attacks}
...
<cite class="citation">
Page content provided in part from [Mastering Ethereum](https://github.com/ethereumbook/ethereumbook) by [Andreas M. Antonopoulos, Gavin Wood](https://ethereumbook.info)
</cite>
