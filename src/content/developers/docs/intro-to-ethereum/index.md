...
Requests for computation are called transaction requests; the record of all transactions and the EVM's present state gets stored in the blockchain, which in turn is stored and agreed upon by all nodes.
