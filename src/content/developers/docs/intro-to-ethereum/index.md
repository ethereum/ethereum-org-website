...
**Ether (ETH)** is the native cryptocurrency of Ethereum. The purpose of ether is to allow for computation in a market. Such a market provides an economic incentive for participants to verify and execute transaction requests and provide computational resources to the network.
