...
- [The Beacon Chain Ethereum 2.0 explainer you need to read first](https://ethos.dev/beacon-chain/) _Ethos.dev_
  ethereum-2-0-blockchain-roadmap-proof-of-stake-pos#section-ethereum-2-0-building-a-more-secure-user-friendly-and-scalable-blockchain)
...
- [Ethereum 2.0](/content/eth2)
- [Beacon Chain](/content/eth2/beacon-chain)
