...
Most contracts are written in Solidity and interpret their data field in accordance with the <GlossaryTooltip termKey="abi">application binary interface (ABI)</GlossaryTooltip>.
