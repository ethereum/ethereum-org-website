...
Tokens can virtually represent anything in Ethereum, from reputation points in an online platform, to skills of a character
in a game, lottery tickets, financial assets like a share in a company, a fiat currency like USD, an ounce of
gold and so on.

Such a powerful feature of Ethereum deserves and must be handled by a robust standard, right? That's exactly
