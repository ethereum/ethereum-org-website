...
- [Sending transactions using web3 and Alchemy](https://ethereum.org/en/developers/tutorials/sending-transactions-using-web3-and-alchemy/) _– Step by step walkthrough for sending transactions from the backend._
