...
To follow and verify current data in the network, Ethereum client needs to sync with latest network state. This is done by downloading data from peers, cryptographically verifying their integrity, and building a local blockchain database. 
