...
Running your own node lets you use services that require direct access to Ethereum client RPC. These are services built on top of Ethereum like [layer 2 solutions](/developers/docs/scaling/layer-2-rollups), [Eth2 clients](/upgrades/get-involved/#clients), and other Ethereum infrastructure.
