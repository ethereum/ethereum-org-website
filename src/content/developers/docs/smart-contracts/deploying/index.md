...
Deploying a contract also costs ether (ETH) since they are using the storage on the blockchain, so you should be familiar with [gas and fees](/developers/docs/gas/) on Ethereum.
