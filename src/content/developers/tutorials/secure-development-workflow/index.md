...
- [ ] Learn to [document security properties for your code](/developers/tutorials/testing-products-overview/). It's tough as first, but it's the single most important activity for achieving a good outcome. It's also a prerequisite for using any of the advanced techniques in this tutorial.
