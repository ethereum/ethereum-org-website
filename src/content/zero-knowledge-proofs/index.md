...
A zero-knowledge proof is a way of proving the validity of a statement without revealing anything else other than the fact that the statement is indeed true. The ‘prover’ is the party trying to prove a claim, while the ‘verifier’ is responsible for validating the claim.
