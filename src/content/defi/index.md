...
Created a system where the rules can't change. The government can't print dollars and devalue your savings.
...
As a blockchain, Ethereum is designed for sending transactions in a secure and global way. It makes sending money around the world as easy as sending an email. Payments go directly from one account to another in a matter of minutes (usually). To send/receive payments you'll need a wallet.
...
There are thousands of tokens on Ethereum. Decentralized exchanges let you trade your tokens while always having control of your assets.
...
[Like when I go on holiday, I want to exchange my dollars for pounds]

[AMM: pulls in market price, allows you to trade based on that price, so there's always a trade available. Guarantees that there's always someone to accept a trade. Markets are 24/7/365 for every token.]
...
TokenSets, a popular investment product, tokenises investment strategies and calls them sets. A set represents a portfolio with a strategy. For example, their "ETH 26 Day EMA Crossover" set will aim to accumulate as much ETH as possible by rebalancing the portfolio between ETH and USDC. You don't have to manually handle any portfolio rebalancing – it's a passive investment that does the work for you. As long as you have the Set token in your wallet, you can withraw the portfolio as individual tokens whenever you like.

[defi pulse index: takes largest defi products by market cap and buys them. get exposure to an array of investments. top ten biggest projects and gives you a weighting of each. Buy index and diversify your portfolio. Anyone can buy the DEFI pulse index.]
...
This is a new space, there have been hacks. However defi has its own insurance... Protect against risk.
...
Coordinate all your accounts
All systems are open
Can see everything in one place due to the nature of Ethereum.
...
- DeFi products all speak the same language behind the scenes: Ethereum. This means many of the products work together seamlessly. You can lend tokens on one platform, and exchange the interest-bearing token in a different market on an entirely different application. This is like being able to cash your Starbucks loyalty points in at your bank.
