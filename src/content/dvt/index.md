...
- **[(I)BFT Consensus Protocol](https://www.naukri.com/learning/articles/byzantine-fault-tolerance-in-blockchain/)** - It is responsible for the coordination process of the machines performing validator duties in a distributed validator "cluster." Implementations may vary but at its core the protocol selects a node responsible for block proposal and shares the information with the other participants. Once the predefined threshold of key shares deems the block valid, it is added to the chain.
