...
import { getVideosByCategory, type VIDEO_CATEGORIES } from "@/lib/utils/videos"
...
const VideoGalleryFilter = ({
  ...
  const searchFiltered = useMemo(() => {
    ...
    return categoryFiltered.filter((video) => {
      ...
      const topicMatch = video.topic.toLowerCase().includes(query)
...
VideoGalleryFilter.displayName = "VideoGalleryFilter"
