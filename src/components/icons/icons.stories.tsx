...
const iconsDefinitions = [
  ...
  { label: "BenefitBetterSecurityIcon", Icon: BenefitBetterSecurityIcon },
  { label: "BenefitEarnRewardsIcon", Icon: BenefitEarnRewardsIcon },
  { label: "BenefitMoreSustainableIcon", Icon: BenefitMoreSustainableIcon },
  ...
  { label: "EtherFiGlyphIcon", Icon: EtherFiGlyphIcon },
  ...
  { label: "SerenitaGlyphIcon", Icon: SerenitaGlyphIcon },
