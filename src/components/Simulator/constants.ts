...
export const ETH_TRANSFER_GAS_UNITS = 21_000
// Used when the live gas price fetch fails. Reflects typical post-Pectra base fee.
export const FALLBACK_GAS_PRICE_GWEI = 1
