...
/**
 * Client half of the standalone widget; requires an i18n context with this
 * quiz's strings. Pages should render the self-provisioning server wrapper
 * exported from this directory's index instead of using this directly.
 */
export const StandaloneQuizClient = (
