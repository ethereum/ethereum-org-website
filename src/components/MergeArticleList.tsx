  ...
  const reads: Array<CardListItem> = [
    {
      ...
      description: translateMessageId("page-upgrade-article-author-ethmerge", intl),
      link: "https://ethmerge.com/",
    },
    {
      title: translateMessageId("page-upgrade-article-title-merge-is-coming", intl),
      description: translateMessageId("page-upgrade-article-author-alchemy", intl),
      link: "https://www.alchemy.com/the-merge",
    },
    {
      title: translateMessageId("page-upgrade-article-title-state-of-the-merge", intl),
      description: translateMessageId("page-upgrade-article-author-consensys", intl),
      link: "https://consensys.net/blog/news/the-state-of-the-merge-an-update-on-ethereums-merge-to-proof-of-stake-in-2022/",
    },
    {
      title: translateMessageId("page-upgrade-article-title-ropsten-merge-testnet", intl),
    ...
    {
      title: translateMessageId("page-upgrade-article-title-execution-layer-specs", intl),
      description: translateMessageId("page-upgrade-article-author-ethereum-foundation", intl),
      link: "https://github.com/ethereum/execution-specs/",
    },
    {
      title: translateMessageId("page-upgrade-article-title-consensus-layer-specs", intl),
      description: translateMessageId("page-upgrade-article-author-ethereum-foundation", intl),
      link: "https://github.com/ethereum/consensus-specs/tree/dev/specs/bellatrix",
    },
    {
      title: translateMessageId("page-upgrade-article-title-engine-api-specs", intl),
      description: translateMessageId("page-upgrade-article-author-ethereum-foundation", intl),
