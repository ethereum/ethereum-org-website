...
import { type LocaleTranslationManifest } from "./manifest-adapter"
...
// Note: detectInertChanges removed in v5. Inert propagation will be
// re-implemented with pipeline-side tree walking when v0.2.0's
// structuralDrift classification is integrated.
...
// CLI entry point removed in v5. Inert propagation is handled
// through the orchestrator (main-incremental.ts) or will be
// re-implemented as pipeline-side tree walking in a future version.
