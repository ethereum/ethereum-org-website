    ...
    <>
      ...
      >
        ...
        <Section aria-labelledby={getId(tocItems[5].url)}>
          ...
          <p>
            {t.rich("page-what-is-ether-what-is-the-eth-supply-description-5", {
              strong: Strong,
            })}
          </p>
          <p>
            {t.rich("page-what-is-ether-what-is-the-eth-supply-description-6", {
              etherscan: (chunks) => (
        ...
        <Section id={getId(tocItems[8].url)}>
          ...
          <UnorderedList>
            <ListItem>
              {t.rich("page-what-is-ether-what-is-wrapping-eth-description-3", {
                strong: Strong,
                uniswap: (chunks) => (
            ...
            <ListItem>
              {t.rich("page-what-is-ether-what-is-wrapping-eth-description-4", {
                strong: Strong,
                aave: (chunks) => (
            ...
            <ListItem>
              {t.rich("page-what-is-ether-what-is-wrapping-eth-description-5", {
                strong: Strong,
                opensea: (chunks) => (
