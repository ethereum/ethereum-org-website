...
/**
 * Presentational tool detail (banner, name, tags, description, links).
 * Content flows naturally so it can be reused by both the full-page route
 * (`[category]/[tool]`) and the intercepting modal slot — the modal shell owns
 * the height constraint and scrolling, not this component.
 */
const ToolDetail = ({
  locale,
  tool,
