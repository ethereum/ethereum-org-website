...
export default async function EnterprisePrivacyPageJsonLD({
  locale,
  contributors,
}: {
  locale: string
  ...
  const jsonLd = {
    ...
    "@graph": [
      ...BASE_GRAPH_NODES,
      {
        "@type": "WebPage",
        "@id": url,
        name: t("page-organizations-enterprise-privacy-meta-title"),
        description: t(
          "page-organizations-enterprise-privacy-meta-description"
        ),
        url,
        inLanguage: locale,
