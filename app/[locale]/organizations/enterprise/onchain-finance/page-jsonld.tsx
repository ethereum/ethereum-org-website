...
export default async function OnchainFinancePageJsonLD({
  locale,
  contributors,
}: {
  locale: string
  ...
  const jsonLd = {
    ...
    "@graph": [
      ...BASE_GRAPH_NODES,
      {
        "@type": "WebPage",
        "@id": url,
        name: t("page-organizations-enterprise-onchain-finance-meta-title"),
        description: t(
        ...
        breadcrumb: {
          ...
          itemListElement: [
            ...
            },
            {
              ...
              position: 4,
              name: t(
                "page-organizations-enterprise-onchain-finance-meta-title"
              ),
              item: url,
            },
          ],
