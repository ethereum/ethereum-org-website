...
export default async function SmallBusinessPageJsonLD({
  locale,
  contributors,
}: {
  locale: string
  ...
  const url = normalizeUrlForJsonLd(locale, "/organizations/small-business/")
  ...
  const jsonLd = {
    ...
    "@graph": [
      ...BASE_GRAPH_NODES,
      {
        "@type": "WebPage",
        "@id": url,
        name: t("page-organizations-small-business-meta-title"),
