...
const WalletsPage = ({
  ...
  const webPageJsonLd = {
    ...
    "@type": "WebPage",
    "@id": `https://ethereum.org/${locale}/wallets/`,
    name: t("page-wallets-meta-title"),
    description: t("page-wallets-meta-description"),
    url: `https://ethereum.org/${locale}/wallets/`,
    inLanguage: locale,
    breadcrumb: {
      "@type": "BreadcrumbList",
      itemListElement: [
  ...
  return (
    <>
      ...
      <script
        id="jsonld-wallet-types"
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(walletTypesJsonLd),
        }}
      />
