    ...
    <>
      ...
      >
        ...
        <Section aria-labelledby={getId(tocItems[1].url)}>
          ...
          />
          <p>
            {t.rich("page-what-is-ethereum-network-gas-section-description-4", {
              strong: Strong,
            })}
          </p>
          <p>
            {t.rich("page-what-is-ethereum-network-gas-section-description-5", {
              strong: Strong,
            })}
          </p>
          <p>
            {t.rich("page-what-is-ethereum-network-gas-section-description-6", {
              blog: (chunks) => (
          ...
          <p>{t("page-what-is-ethereum-network-gas-section-description-7")}</p>
          <p>
            {t.rich("page-what-is-ethereum-network-gas-section-description-8", {
              strong: Strong,
            })}
          </p>
          <p>{t("page-what-is-ethereum-network-gas-section-description-9")}</p>
        ...
        <Section>
          <h2>{t("page-what-is-ethereum-network-read-next-title")}</h2>
