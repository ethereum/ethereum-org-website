    ...
    <>
      ...
      >
        ...
        <Section aria-labelledby={getId(tocItems[1].url)}>
          ...
          <HighlightStack data-label="ethereum-network-table">
            ...
            <HighlightCard>
              ...
              <CardContent spacing="md">
                ...
                <CardParagraph>
                  {t.rich("page-what-is-ethereum-network-reliability-desc-1", {
                    a: (chunks) => <Link href="#">{chunks}</Link>,
                  })}
                </CardParagraph>
                <CardParagraph>
          ...
          <h3>{t("page-what-is-ethereum-network-layer2-title")}</h3>
          ...
          <HighlightStack data-label="what-is-table">
            <HighlightCard>
              ...
              <CardContent spacing="md">
                ...
                <UnorderedList>
                  <ListItem>
                    {t.rich("page-what-is-ethereum-what-consumers-benefit-1", {
                      strong: Strong,
                    })}
                  </ListItem>
                  <ListItem>
                    {t.rich("page-what-is-ethereum-what-consumers-benefit-2", {
                      strong: Strong,
                    })}
                  </ListItem>
                  <ListItem>
                    {t.rich("page-what-is-ethereum-what-consumers-benefit-3", {
                      strong: Strong,
                    })}
                  </ListItem>
                  <ListItem>
            ...
            <HighlightCard>
              ...
              <CardContent spacing="md">
                ...
                <UnorderedList>
                  ...
                  <ListItem>
                    {t.rich("page-what-is-ethereum-what-businesses-benefit-2", {
                      strong: Strong,
                    })}
                  </ListItem>
                  <ListItem>
            ...
            <HighlightCard>
              ...
              <CardContent spacing="md">
                ...
                <CardParagraph>
                  {t.rich("page-what-is-ethereum-what-governments-example-1", {
                    a: (chunks) => (
          ...
          <Card variant="header-bar" size="lg">
            ...
            <CardContent>
              ...
              <UnorderedList>
                ...
                <ListItem>
                  {t.rich("page-what-is-ethereum-start-individuals-step-3", {
                    zora: (chunks) => (
        ...
        <Section id={getId(tocItems[6].url)}>
          ...
          <h3>{t("page-what-is-ethereum-bitcoin-comparison-1-title")}</h3>
          <p>{t("page-what-is-ethereum-bitcoin-comparison-1-desc")}</p>

          <h3>{t("page-what-is-ethereum-bitcoin-comparison-2-title")}</h3>
          <p>{t("page-what-is-ethereum-bitcoin-comparison-2-desc")}</p>

          <h3>{t("page-what-is-ethereum-bitcoin-comparison-3-title")}</h3>
          <p>{t("page-what-is-ethereum-bitcoin-comparison-3-desc-1")}</p>
          <p>{t("page-what-is-ethereum-bitcoin-comparison-3-desc-2")}</p>

          <h3>{t("page-what-is-ethereum-bitcoin-comparison-4-title")}</h3>
          <p>
            {t.rich("page-what-is-ethereum-bitcoin-comparison-4-desc-1", {
              strong: Strong,
            })}
          </p>
          <p>{t("page-what-is-ethereum-bitcoin-comparison-4-desc-2")}</p>
          <p>{t("page-what-is-ethereum-bitcoin-comparison-4-desc-3")}</p>
        ...
        <Section aria-labelledby={getId(tocItems[7].url)}>
          ...
          <h3>{t("page-what-is-ethereum-when-who-history-title")}</h3>
          ...
          <h3>{t("page-what-is-ethereum-when-who-contributors-title")}</h3>
          <UnorderedList>
            <ListItem>
        ...
        <Section id={getId(tocItems[8].url)}>
          ...
          <UnorderedList>
            <ListItem>{t("page-what-is-ethereum-roadmap-priority-1")}</ListItem>
            <ListItem>{t("page-what-is-ethereum-roadmap-priority-2")}</ListItem>
          </UnorderedList>
        ...
        <Section id="further-reading">
          <h2>{t("page-what-is-ethereum-further-reading-title")}</h2>
